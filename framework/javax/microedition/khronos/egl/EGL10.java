...
public interface EGL10 extends javax.microedition.khronos.egl.EGL {
    ...
    public boolean eglChooseConfig(javax.microedition.khronos.egl.EGLDisplay p0, int[] p1, javax.microedition.khronos.egl.EGLConfig[] p2, int p3, int[] p4);
    public boolean eglCopyBuffers(javax.microedition.khronos.egl.EGLDisplay p0, javax.microedition.khronos.egl.EGLSurface p1, java.lang.Object p2);
    public javax.microedition.khronos.egl.EGLContext eglCreateContext(javax.microedition.khronos.egl.EGLDisplay p0, javax.microedition.khronos.egl.EGLConfig p1, javax.microedition.khronos.egl.EGLContext p2, int[] p3);
    public javax.microedition.khronos.egl.EGLSurface eglCreatePbufferSurface(javax.microedition.khronos.egl.EGLDisplay p0, javax.microedition.khronos.egl.EGLConfig p1, int[] p2);
    @java.lang.Deprecated
    public javax.microedition.khronos.egl.EGLSurface eglCreatePixmapSurface(javax.microedition.khronos.egl.EGLDisplay p0, javax.microedition.khronos.egl.EGLConfig p1, java.lang.Object p2, int[] p3);
    public javax.microedition.khronos.egl.EGLSurface eglCreateWindowSurface(javax.microedition.khronos.egl.EGLDisplay p0, javax.microedition.khronos.egl.EGLConfig p1, java.lang.Object p2, int[] p3);
    public boolean eglDestroyContext(javax.microedition.khronos.egl.EGLDisplay p0, javax.microedition.khronos.egl.EGLContext p1);
    public boolean eglDestroySurface(javax.microedition.khronos.egl.EGLDisplay p0, javax.microedition.khronos.egl.EGLSurface p1);
    public boolean eglGetConfigAttrib(javax.microedition.khronos.egl.EGLDisplay p0, javax.microedition.khronos.egl.EGLConfig p1, int p2, int[] p3);
    public boolean eglGetConfigs(javax.microedition.khronos.egl.EGLDisplay p0, javax.microedition.khronos.egl.EGLConfig[] p1, int p2, int[] p3);
    ...
    public javax.microedition.khronos.egl.EGLSurface eglGetCurrentSurface(int p0);
    public javax.microedition.khronos.egl.EGLDisplay eglGetDisplay(java.lang.Object p0);
    public int eglGetError();
    public boolean eglInitialize(javax.microedition.khronos.egl.EGLDisplay p0, int[] p1);
    public boolean eglMakeCurrent(javax.microedition.khronos.egl.EGLDisplay p0, javax.microedition.khronos.egl.EGLSurface p1, javax.microedition.khronos.egl.EGLSurface p2, javax.microedition.khronos.egl.EGLContext p3);
    public boolean eglQueryContext(javax.microedition.khronos.egl.EGLDisplay p0, javax.microedition.khronos.egl.EGLContext p1, int p2, int[] p3);
    public java.lang.String eglQueryString(javax.microedition.khronos.egl.EGLDisplay p0, int p1);
    public boolean eglQuerySurface(javax.microedition.khronos.egl.EGLDisplay p0, javax.microedition.khronos.egl.EGLSurface p1, int p2, int[] p3);
    public boolean eglReleaseThread();
    public boolean eglSwapBuffers(javax.microedition.khronos.egl.EGLDisplay p0, javax.microedition.khronos.egl.EGLSurface p1);
    public boolean eglTerminate(javax.microedition.khronos.egl.EGLDisplay p0);
    public boolean eglWaitGL();
    public boolean eglWaitNative(int p0, java.lang.Object p1);
}
