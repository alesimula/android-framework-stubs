...
public interface ITaskOrganizerController extends android.os.IInterface {
    ...
    public void createRootTask(int p0, int p1, android.os.IBinder p2, boolean p3) throws android.os.RemoteException;
    ...
    public void setInterceptBackPressedOnTaskRoot(android.window.WindowContainerToken p0, boolean p1) throws android.os.RemoteException;
    ...
    public void updateCameraCompatControlState(android.window.WindowContainerToken p0, int p1) throws android.os.RemoteException;
    public void setOrientationRequestPolicy(boolean p0, int[] p1, int[] p2) throws android.os.RemoteException;
