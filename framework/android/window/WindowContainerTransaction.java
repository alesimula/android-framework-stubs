...
public final class WindowContainerTransaction implements android.os.Parcelable {
    ...
    public android.window.WindowContainerTransaction setAdjacentRoots(android.window.WindowContainerToken p0, android.window.WindowContainerToken p1, boolean p2) { return null; }
    ...
    public android.window.WindowContainerTransaction deleteTaskFragment(android.window.WindowContainerToken p0) { return null; }
    ...
    public android.window.WindowContainerTransaction reparentChildren(android.window.WindowContainerToken p0, android.window.WindowContainerToken p1) { return null; }
    ...
    public android.window.WindowContainerTransaction addRectInsetsProvider(android.window.WindowContainerToken p0, android.graphics.Rect p1, int[] p2) { return null; }
    public android.window.WindowContainerTransaction removeInsetsProvider(android.window.WindowContainerToken p0, int[] p1) { return null; }
    ...
    public android.window.WindowContainerTransaction setTaskFragmentOperation(android.os.IBinder p0, android.window.TaskFragmentOperation p1) { return null; }
    ...
    public static final class HierarchyOp implements android.os.Parcelable {
        ...
        public int[] getInsetsTypes() { return null; }
        public android.graphics.Rect getInsetsProviderFrame() { return null; }
        public android.os.IBinder getContainer() { return null; }
        public android.os.IBinder getAdjacentRoot() { return null; }
        public android.os.IBinder getCompanionContainer() { return null; }
        public android.os.IBinder getCallingActivity() { return null; }
        ...
        public android.window.TaskFragmentCreationParams getTaskFragmentCreationOptions() { return null; }
        ...
        private static class Builder {
            ...
            android.window.WindowContainerTransaction.HierarchyOp.Builder setInsetsTypes(int[] p0) { return null; }
            android.window.WindowContainerTransaction.HierarchyOp.Builder setInsetsProviderFrame(android.graphics.Rect p0) { return null; }
            ...
            android.window.WindowContainerTransaction.HierarchyOp.Builder setTaskFragmentCreationOptions(android.window.TaskFragmentCreationParams p0) { return null; }
