...
public final class WindowContainerTransaction implements android.os.Parcelable {
    ...
    public static class HierarchyOp implements android.os.Parcelable {
        ...
        private final int[] mWindowingModes = null;
        private final int[] mActivityTypes = null;
        private final android.os.Bundle mLaunchOptions = null;
        ...
        public static android.window.WindowContainerTransaction.HierarchyOp createForChildrenTasksReparent(android.os.IBinder p0, android.os.IBinder p1, int[] p2, int[] p3, boolean p4) { return null; }
        ...
        private HierarchyOp(int p0, android.os.IBinder p1, android.os.IBinder p2, int[] p3, int[] p4, boolean p5, android.os.Bundle p6) {}
