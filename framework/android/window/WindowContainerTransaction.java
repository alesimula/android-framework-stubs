...
public final class WindowContainerTransaction implements android.os.Parcelable {
    ...
    @android.annotation.NonNull
    public android.window.WindowContainerTransaction addInsetsSource(android.window.WindowContainerToken p0, android.os.IBinder p1, int p2, int p3, android.graphics.Rect p4, android.graphics.Rect[] p5) { return null; }
    @android.annotation.NonNull
    ...
    public static final class HierarchyOp implements android.os.Parcelable {
        ...
        @android.annotation.Nullable
        public android.os.IBinder getInsetsFrameOwner() { return null; }
        @android.annotation.NonNull
        ...
        private static class Builder {
            ...
            android.window.WindowContainerTransaction.HierarchyOp.Builder setInsetsFrameOwner(android.os.IBinder p0) { return null; }
