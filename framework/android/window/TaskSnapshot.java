...
public class TaskSnapshot implements android.os.Parcelable {
    ...
    public TaskSnapshot(long p0, android.content.ComponentName p1, android.hardware.HardwareBuffer p2, android.graphics.ColorSpace p3, int p4, int p5, android.graphics.Point p6, android.graphics.Rect p7, android.graphics.Rect p8, boolean p9, boolean p10, int p11, int p12, boolean p13, boolean p14) {}
