...
public class TaskSnapshot implements android.os.Parcelable {
    ...
    public TaskSnapshot(long p0, long p1, android.content.ComponentName p2, android.hardware.HardwareBuffer p3, android.graphics.ColorSpace p4, int p5, int p6, android.graphics.Point p7, android.graphics.Rect p8, android.graphics.Rect p9, boolean p10, boolean p11, int p12, int p13, boolean p14, boolean p15) {}
    ...
    static @interface ReferenceFlags {
    }
}
