...
public class SnapshotDrawerUtils {
    ...
    public static void drawSnapshotOnSurface(android.window.StartingWindowInfo p0, android.view.WindowManager.LayoutParams p1, android.view.SurfaceControl p2, android.window.TaskSnapshot p3, android.graphics.Rect p4, android.view.InsetsState p5, boolean p6) {}
    ...
    public static class SnapshotSurface {
        public SnapshotSurface(android.view.SurfaceControl p0, android.window.TaskSnapshot p1, java.lang.CharSequence p2) {}
        public void initiateSystemBarPainter(int p0, int p1, int p2, android.app.ActivityManager.TaskDescription p3, int p4) {}
        public void setFrames(android.graphics.Rect p0, android.graphics.Rect p1) {}
        public android.graphics.Rect calculateSnapshotCrop(android.graphics.Rect p0) { return null; }
        public android.graphics.Rect calculateSnapshotFrame(android.graphics.Rect p0) { return null; }
        public void drawBackgroundAndBars(android.graphics.Canvas p0, android.graphics.Rect p1) {}
        public void drawStatusBarBackground(android.graphics.Canvas p0, android.graphics.Rect p1) {}
        public void drawNavigationBarBackground(android.graphics.Canvas p0) {}
    }
