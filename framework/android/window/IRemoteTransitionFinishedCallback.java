...
public interface IRemoteTransitionFinishedCallback extends android.os.IInterface {
    ...
    public void onTransitionFinished(android.window.WindowContainerTransaction p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.window.IRemoteTransitionFinishedCallback {
        ...
        public Stub() { super(); }
        public static android.window.IRemoteTransitionFinishedCallback asInterface(android.os.IBinder p0) { return null; }
        public android.os.IBinder asBinder() { return null; }
        public static java.lang.String getDefaultTransactionName(int p0) { return null; }
        public java.lang.String getTransactionName(int p0) { return null; }
        public boolean onTransact(int p0, android.os.Parcel p1, android.os.Parcel p2, int p3) throws android.os.RemoteException { return false; }
        public static boolean setDefaultImpl(android.window.IRemoteTransitionFinishedCallback p0) { return false; }
        public static android.window.IRemoteTransitionFinishedCallback getDefaultImpl() { return null; }

        private static class Proxy implements android.window.IRemoteTransitionFinishedCallback {
            private android.os.IBinder mRemote;
            public static android.window.IRemoteTransitionFinishedCallback sDefaultImpl;
