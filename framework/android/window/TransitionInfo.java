...
public final class TransitionInfo implements android.os.Parcelable {
    ...
    public static final class AnimationOptions implements android.os.Parcelable {
        ...
        @android.annotation.NonNull
        public static android.window.TransitionInfo.AnimationOptions makeCustomAnimOptions(java.lang.String p0, int p1, int p2, int p3, int p4, boolean p5) { return null; }
        @android.annotation.NonNull
