...
public interface IWindowOrganizerController extends android.os.IInterface {
    ...
    public int startLegacyTransition(int p0, android.view.RemoteAnimationAdapter p1, android.window.IWindowContainerTransactionCallback p2, android.window.WindowContainerTransaction p3) throws android.os.RemoteException;
    ...
    public static class Default implements android.window.IWindowOrganizerController {
        ...
        public void startTransition(android.os.IBinder p0, android.window.WindowContainerTransaction p1) throws android.os.RemoteException {}
        public int startLegacyTransition(int p0, android.view.RemoteAnimationAdapter p1, android.window.IWindowContainerTransactionCallback p2, android.window.WindowContainerTransaction p3) throws android.os.RemoteException { return 0; }
