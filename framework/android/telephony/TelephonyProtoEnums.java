...
public final class TelephonyProtoEnums {
    ...
    public static final int APP_OP_MODE_ALLOWED = 1;
    public static final int APP_OP_MODE_IGNORED = 2;
    public static final int APP_OP_MODE_UNKNOWN = 0;
    ...
    public static final int CONTENT_PROVIDER_MMS_PROVIDER = 2;
    public static final int CONTENT_PROVIDER_SMS_PROVIDER = 1;
    public static final int CONTENT_PROVIDER_UNKNOWN = 0;
    ...
    public static final int DEACTIVATE_REASON_DEVICE_SHUT_DOWN = 37;
    ...
    public static final int DEACTIVATE_REASON_UNSUPPORTED_NETWORK_CAPABILITIES = 38;
    ...
    public static final int DEVICE_TELEPHONY_FEATURES_CALLING = 1;
    public static final int DEVICE_TELEPHONY_FEATURES_DATA = 2;
    public static final int DEVICE_TELEPHONY_FEATURES_EUICC = 8;
    public static final int DEVICE_TELEPHONY_FEATURES_EUICC_MEP = 9;
    public static final int DEVICE_TELEPHONY_FEATURES_IMS = 7;
    public static final int DEVICE_TELEPHONY_FEATURES_MESSAGING = 3;
    public static final int DEVICE_TELEPHONY_FEATURES_RADIO_ACCESS = 4;
    public static final int DEVICE_TELEPHONY_FEATURES_SATELLITE = 10;
    public static final int DEVICE_TELEPHONY_FEATURES_SUBSCRIPTION = 5;
    public static final int DEVICE_TELEPHONY_FEATURES_TELEPHONY = 6;
    public static final int DEVICE_TELEPHONY_FEATURES_UNSPECIFIED = 0;
    ...
    public static final int MESSAGING_READ_RESTRICTION_EVENT_TYPE_UNKNOWN = 0;
    ...
    public static final int ORIGINAL_MESSAGE_TYPE_MMS = 3;
    public static final int ORIGINAL_MESSAGE_TYPE_SMS = 1;
    public static final int ORIGINAL_MESSAGE_TYPE_SMS_MULTIPART = 2;
    public static final int ORIGINAL_MESSAGE_TYPE_UNKNOWN = 0;
    public static final int QUERY_RESTRICTED_MESSAGES = 4;
    ...
    public static final int REDACTION_ALGORITHM_ENGLISH_REGEX = 2;
    public static final int REDACTION_ALGORITHM_ML_MODEL = 3;
    public static final int REDACTION_ALGORITHM_OTHER = 4;
    public static final int REDACTION_ALGORITHM_SMS_RETRIEVER = 1;
    public static final int REDACTION_ALGORITHM_UNSPECIFIED = 0;
    public static final int REDACTION_LOCATION_SMS_BROADCAST = 1;
    public static final int REDACTION_LOCATION_SMS_QUERY = 2;
    public static final int REDACTION_LOCATION_UNSPECIFIED = 0;
    ...
    public static final int RESTRICTED_MESSAGE_INSERTED = 1;
    ...
    public static final int SMS_SEND_ERROR_FAIL_AFTER_MAX_RETRY = 138;
    ...
    public static final int SOURCE_TYPE_BLUETOOTH = 1;
    public static final int SOURCE_TYPE_DEFAULT_APP = 3;
    public static final int SOURCE_TYPE_THIRD_PARTY_APP = 2;
    ...
    public static final int UNRESTRICTED_MESSAGE_INSERTED = 2;
    public static final int UPDATED_MESSAGE_TO_UNRESTRICTED = 3;
