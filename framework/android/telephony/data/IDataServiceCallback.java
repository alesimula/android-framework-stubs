...
public interface IDataServiceCallback extends android.os.IInterface {
    public void onApnUnthrottled(java.lang.String p0) throws android.os.RemoteException;
    ...
    public void onDataCallListUpdated(java.util.List<android.telephony.data.DataCallResponse> p0) throws android.os.RemoteException;
    public void onDataProfileUnthrottled(android.telephony.data.DataProfile p0) throws android.os.RemoteException;
    public void onDeactivateDataCallComplete(int p0) throws android.os.RemoteException;
    public void onHandoverCancelled(int p0) throws android.os.RemoteException;
    public void onHandoverStarted(int p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.telephony.data.IDataServiceCallback {
        ...
        static final int TRANSACTION_onDataCallListUpdated = 11;
        ...
        private static final class Proxy implements android.telephony.data.IDataServiceCallback {
