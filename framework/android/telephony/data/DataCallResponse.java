...
public final class DataCallResponse implements android.os.Parcelable {
    ...
    private final int mPhysicalNetworkSlotIndex = 0;
    private final int mPhysicalNetworkTransportType = 0;
    ...
    private DataCallResponse(int p0, long p1, int p2, int p3, int p4, java.lang.String p5, java.util.List<android.net.LinkAddress> p6, java.util.List<java.net.InetAddress> p7, java.util.List<java.net.InetAddress> p8, java.util.List<java.net.InetAddress> p9, int p10, int p11, int p12, int p13, int p14, android.telephony.data.Qos p15, java.util.List<android.telephony.data.QosBearerSession> p16, android.telephony.data.NetworkSliceInfo p17, java.util.List<android.telephony.data.TrafficDescriptor> p18, int p19, int p20, int p21) {}
    ...
    public int getPhysicalNetworkSlotIndex() { return 0; }
    public int getPhysicalNetworkTransportType() { return 0; }
    ...
    public static final class Builder {
        ...
        private int mPhysicalNetworkSlotIndex;
        private int mPhysicalNetworkTransportType;
        ...
        public android.telephony.data.DataCallResponse.Builder setPhysicalNetworkSlotIndex(int p0) { return null; }
        public android.telephony.data.DataCallResponse.Builder setPhysicalNetworkTransportType(int p0) { return null; }
