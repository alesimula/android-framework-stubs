...
public interface IDataService extends android.os.IInterface {
    ...
    public void notifyImsDataNetwork(int p0, int p1, int p2, int p3, int p4, com.android.internal.telephony.IIntegerConsumer p5) throws android.os.RemoteException;
    public void notifyUserDataEnabled(int p0, boolean p1, com.android.internal.telephony.IIntegerConsumer p2) throws android.os.RemoteException;
    public void notifyUserDataRoamingEnabled(int p0, boolean p1, com.android.internal.telephony.IIntegerConsumer p2) throws android.os.RemoteException;
    ...
    public void requestNetworkValidation(int p0, int p1, com.android.internal.telephony.IIntegerConsumer p2) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.telephony.data.IDataService {
        ...
        static final int TRANSACTION_notifyImsDataNetwork = 17;
        static final int TRANSACTION_notifyUserDataEnabled = 15;
        static final int TRANSACTION_notifyUserDataRoamingEnabled = 16;
        ...
        private static final class Proxy implements android.telephony.data.IDataService {
