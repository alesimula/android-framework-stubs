...
public abstract class DataService extends android.app.Service {
    ...
    public abstract class DataServiceProvider implements java.lang.AutoCloseable {
        ...
        @android.annotation.FlaggedApi("com.android.internal.telephony.flags.data_service_user_data_toggle_notify")
        public void notifyUserDataEnabled(boolean p0, java.util.concurrent.Executor p1, java.util.function.Consumer<java.lang.Integer> p2) {}
        @android.annotation.FlaggedApi("com.android.internal.telephony.flags.data_service_user_data_toggle_notify")
        public void notifyUserDataRoamingEnabled(boolean p0, java.util.concurrent.Executor p1, java.util.function.Consumer<java.lang.Integer> p2) {}
        ...
        @android.annotation.FlaggedApi("com.android.internal.telephony.flags.data_service_notify_ims_data_network")
        public void notifyImsDataNetwork(int p0, int p1, int p2, int p3, java.util.concurrent.Executor p4, java.util.function.Consumer<java.lang.Integer> p5) {}
    ...
    private class IDataServiceWrapper extends android.telephony.data.IDataService.Stub {
        ...
        public void notifyUserDataEnabled(int p0, boolean p1, com.android.internal.telephony.IIntegerConsumer p2) {}
        public void notifyUserDataRoamingEnabled(int p0, boolean p1, com.android.internal.telephony.IIntegerConsumer p2) {}
        public void notifyImsDataNetwork(int p0, int p1, int p2, int p3, int p4, com.android.internal.telephony.IIntegerConsumer p5) {}
    }
