...
public abstract class DataService extends android.app.Service {
    ...
    private class IDataServiceWrapper extends android.telephony.data.IDataService.Stub {
        ...
        public void setupDataCall(int p0, int p1, android.telephony.data.DataProfile p2, boolean p3, boolean p4, int p5, android.net.LinkProperties p6, android.telephony.data.IDataServiceCallback p7) {}
    ...
    private static final class SetupDataCallRequest {
        ...
        public final android.telephony.data.IDataServiceCallback callback = null;
        SetupDataCallRequest(int p0, android.telephony.data.DataProfile p1, boolean p2, boolean p3, int p4, android.net.LinkProperties p5, android.telephony.data.IDataServiceCallback p6) {}
    }
