...
public class AccessNetworkUtils {
    ...
    public static int getDuplexModeForNgranBandPCell(int p0) { return 0; }
    ...
    public static int getOperatingBand(int p0, int p1) { return 0; }
    public static int getOperatingBandForArfcn(int p0) { return 0; }
    public static int getOperatingBandForEarfcn(int p0) { return 0; }
    public static int getOperatingBandForNrarfcn(int p0) { return 0; }
