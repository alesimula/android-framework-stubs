...
public final class SmsCbMessage implements android.os.Parcelable {
    ...
    private final int mMaximumWaitTimeSec = 0;
    private final long mReceivedTimeMillis = 0L;
    private final java.util.List<android.telephony.CbGeoUtils.Geometry> mGeometries = null;
