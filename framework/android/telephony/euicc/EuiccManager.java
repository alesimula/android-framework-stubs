...
public class EuiccManager {
    ...
    @android.annotation.FlaggedApi("com.android.internal.telephony.flags.esim_available_memory")
    ...
    public long getAvailableMemoryInBytes() { return 0L; }
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission("android.permission.WRITE_EMBEDDED_SUBSCRIPTIONS")
    public int getOtaStatus() { return 0; }
    @android.annotation.RequiresPermission(anyOf={"android.permission.WRITE_EMBEDDED_SUBSCRIPTIONS", "android.permission.MANAGE_DEVICE_POLICY_MANAGED_SUBSCRIPTIONS"})
    ...
    public boolean isSimPortAvailable(int p0) { return false; }
    @android.annotation.SystemApi
    @android.annotation.FlaggedApi("com.android.internal.telephony.flags.support_psim_to_esim_conversion")
    @android.annotation.RequiresPermission("android.permission.WRITE_EMBEDDED_SUBSCRIPTIONS")
    public void setPsimConversionSupportedCarriers(java.util.Set<java.lang.Integer> p0) {}
    @android.annotation.SystemApi
    @android.annotation.FlaggedApi("com.android.internal.telephony.flags.support_psim_to_esim_conversion")
    @android.annotation.RequiresPermission("android.permission.WRITE_EMBEDDED_SUBSCRIPTIONS")
    public boolean isPsimConversionSupported(int p0) { return false; }
