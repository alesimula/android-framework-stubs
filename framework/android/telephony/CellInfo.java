...
public abstract class CellInfo implements android.os.Parcelable {
    ...
    protected CellInfo(android.hardware.radio.V1_0.CellInfo p0) {}
    protected CellInfo(android.hardware.radio.V1_2.CellInfo p0) {}
    protected CellInfo(android.hardware.radio.V1_4.CellInfo p0, long p1) {}
    protected CellInfo(android.hardware.radio.V1_5.CellInfo p0, long p1) {}
    protected CellInfo(android.hardware.radio.V1_6.CellInfo p0, long p1) {}
    public static android.telephony.CellInfo create(android.hardware.radio.V1_0.CellInfo p0) { return null; }
    public static android.telephony.CellInfo create(android.hardware.radio.V1_2.CellInfo p0) { return null; }
    public static android.telephony.CellInfo create(android.hardware.radio.V1_4.CellInfo p0, long p1) { return null; }
    public static android.telephony.CellInfo create(android.hardware.radio.V1_5.CellInfo p0, long p1) { return null; }
    public static android.telephony.CellInfo create(android.hardware.radio.V1_6.CellInfo p0, long p1) { return null; }
