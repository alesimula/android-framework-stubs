...
public class SubscriptionManager {
    ...
    public static final java.lang.String ACTION_ENROLLABLE_SUBSCRIPTION_PLANS_CHANGED = "android.telephony.action.ENROLLABLE_SUBSCRIPTION_PLANS_CHANGED";
    public static final java.lang.String ACTION_MANAGE_SUBSCRIPTION_PLANS = "android.telephony.action.MANAGE_SUBSCRIPTION_PLANS";
    @android.annotation.SystemApi
    public static final java.lang.String ACTION_REFRESH_ENROLLABLE_SUBSCRIPTION_PLANS = "android.telephony.action.REFRESH_ENROLLABLE_SUBSCRIPTION_PLANS";
    ...
    @android.annotation.SystemApi
    public static final java.lang.String ACTION_SHOW_ENROLLABLE_SUBSCRIPTION_PLANS = "android.telephony.action.SHOW_ENROLLABLE_SUBSCRIPTION_PLANS";
    @android.annotation.SystemApi
    ...
    @android.annotation.SystemApi
    public static final java.lang.String EXTRA_PLAN_TYPES = "android.telephony.extra.PLAN_TYPES";
    @android.annotation.SystemApi
    public static final java.lang.String EXTRA_REFRESH_PLANS = "android.telephony.extra.REFRESH_PLANS";
    ...
    public static final java.lang.String IS_ONLY_NTN = "is_only_ntn";
    public static final java.lang.String IS_OPPORTUNISTIC = "is_opportunistic";
    public static final java.lang.String IS_PRIVATE_NETWORK = "is_private_network";
    public static final java.lang.String IS_REMOVABLE = "is_removable";
    public static final java.lang.String IS_SATELLITE_PROVISIONED_FOR_NON_IP_DATAGRAM = "is_satellite_provisioned_for_non_ip_datagram";
    ...
    public static final java.lang.String SATELLITE_ENTITLEMENT_BARRED_PLMNS = "satellite_entitlement_barred_plmns";
    public static final java.lang.String SATELLITE_ENTITLEMENT_DATA_PLAN_PLMNS = "satellite_entitlement_data_plan_plmns";
    public static final java.lang.String SATELLITE_ENTITLEMENT_DATA_SERVICE_POLICY = "satellite_entitlement_data_service_policy";
    public static final java.lang.String SATELLITE_ENTITLEMENT_PLMNS = "satellite_entitlement_plmns";
    public static final java.lang.String SATELLITE_ENTITLEMENT_SERVICE_TYPE_MAP = "satellite_entitlement_service_type_map";
    public static final java.lang.String SATELLITE_ENTITLEMENT_STATUS = "satellite_entitlement_status";
    public static final java.lang.String SATELLITE_ENTITLEMENT_VOICE_SERVICE_POLICY = "satellite_entitlement_voice_service_policy";
    public static final java.lang.String SATELLITE_ESOS_SUPPORTED = "satellite_esos_supported";
    ...
    public static final int SERVICE_CAPABILITY_DATA_BITMASK = Integer.valueOf(0);
    public static final int SERVICE_CAPABILITY_MAX = 3;
    public static final int SERVICE_CAPABILITY_SMS = 2;
    public static final int SERVICE_CAPABILITY_SMS_BITMASK = Integer.valueOf(0);
    public static final int SERVICE_CAPABILITY_VOICE = 1;
    public static final int SERVICE_CAPABILITY_VOICE_BITMASK = Integer.valueOf(0);
    ...
    public static final java.lang.String STREAMING_APP_MAX_DOWNLINK_KBPS = "streaming_app_max_downlink_kbps";
    public static final java.lang.String STREAMING_APP_MAX_UPLINK_KBPS = "streaming_app_max_uplink_kbps";
    ...
    private static android.telephony.SubscriptionManager.VoidPropertyInvalidatedCache<java.lang.Integer> sGetActiveDataSubscriptionIdCache;
    private static android.telephony.SubscriptionManager.VoidPropertyInvalidatedCache<java.lang.Integer> sGetDefaultDataSubIdCache;
    private static android.telephony.SubscriptionManager.IntegerPropertyInvalidatedCache<java.lang.Integer> sGetDefaultSmsSubIdCacheAsUser;
    private static android.telephony.SubscriptionManager.IntegerPropertyInvalidatedCache<java.lang.Integer> sGetDefaultSubIdCacheAsUser;
    private static android.telephony.SubscriptionManager.IntegerPropertyInvalidatedCache<java.lang.Integer> sGetPhoneIdCache;
    private static android.telephony.SubscriptionManager.IntegerPropertyInvalidatedCache<java.lang.Integer> sGetSlotIndexCache;
    private static android.telephony.SubscriptionManager.IntegerPropertyInvalidatedCache<java.lang.Integer> sGetSubIdCache;
    private static final android.util.LruCache<android.util.Pair<java.lang.String, android.content.res.Configuration>, android.content.res.Resources> sResourcesCache = null;
    private final android.content.Context mContext = null;
    private final boolean mIsForAllUserProfiles = false;
    public SubscriptionManager(android.content.Context p0) {}
    private SubscriptionManager(android.content.Context p0, boolean p1) {}
    ...
    private android.content.Context getContextAsUser(android.os.UserHandle p0) { return null; }
    ...
    public static java.util.Set<java.lang.Integer> getServiceCapabilitiesSet(int p0) { return null; }
    public static int getSlotIndex(int p0) { return 0; }
    private static java.lang.String getStringSubscriptionProperty(android.content.Context p0, int p1, java.lang.String p2) { return null; }
    @java.lang.Deprecated
    ...
    private static boolean isValidOrRemoteSlotIndex(int p0) { return false; }
    ...
    public static void putPhoneIdAndMaybeSubIdExtra(android.content.Intent p0, int p1, int p2) {}
    ...
    public static int serviceCapabilityToBitmask(int p0) { return 0; }
    ...
    public boolean canManageSubscriptionAsUser(android.telephony.SubscriptionInfo p0, java.lang.String p1, android.os.UserHandle p2) { return false; }
    @android.annotation.SystemApi
    public void clearDisplayName(int p0, int p1) {}
    public android.telephony.SubscriptionManager createForAllUserProfiles() { return null; }
    ...
    public byte[] getAllPlatformManagedPins() { return null; }
    @android.annotation.SystemApi
    ...
    @android.annotation.SystemApi
    public java.util.List<android.telephony.SubscriptionPlan> getEnrollableSubscriptionPlans(int p0) { return null; }
    public java.lang.String getLastKnownPhoneNumber(int p0) { return null; }
    ...
    public boolean isSubscriptionAssociatedWithUser(int p0) { return false; }
    ...
    public void restorePlatformManagedSimPinsFromBackup(byte[] p0) {}
    ...
    @android.annotation.SystemApi
    public void setDisplayName(int p0, java.lang.String p1, int p2) {}
    public int setDisplayNumber(java.lang.String p0, int p1) { return 0; }
    @android.annotation.SystemApi
    public void setEnrollableSubscriptionPlans(int p0, java.util.List<android.telephony.SubscriptionPlan> p1, long p2) {}
    ...
    public void setTs43PhoneNumber(int p0, java.lang.String p1) {}
    @android.annotation.SystemApi
    ...
    public static class OnSubscriptionsChangedListener {
        ...
        private void log(java.lang.String p0) {}
        public android.os.Looper getCreatorLooper() { return null; }
