...
public class SubscriptionManager {
    ...
    private static java.util.List<android.net.Uri> getContactsFromSubscriptionProperty(int p0, java.lang.String p1, android.content.Context p2) { return null; }
    ...
    @android.annotation.RequiresPermission("android.permission.MODIFY_PHONE_STATE")
    public void restoreSimSpecificSettingsForIccIdFromBackup(java.lang.String p0) {}
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission("android.permission.MODIFY_PHONE_STATE")
