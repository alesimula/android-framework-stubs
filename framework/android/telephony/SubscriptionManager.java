...
public class SubscriptionManager {
    ...
    @android.annotation.FlaggedApi("com.android.internal.telephony.flags.enforce_subscription_user_filter")
    @android.annotation.RequiresPermission("android.permission.INTERACT_ACROSS_PROFILES")
    @android.annotation.NonNull
    ...
    @android.annotation.RequiresPermission("android.permission.READ_PHONE_STATE")
    @android.annotation.FlaggedApi("com.android.internal.telephony.flags.subscription_user_association_query")
