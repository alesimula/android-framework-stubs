...
public final class DataFailCause {
    ...
    private static final java.util.Map<java.lang.Integer, java.lang.String> sFailCauseMap = null;
    private static final java.util.HashMap<java.lang.Integer, java.util.Set<java.lang.Integer>> sPermanentFailureCache = null;
    private DataFailCause() {}
    public static int getFailCause(int p0) { return 0; }
    public static boolean isEventLoggable(int p0) { return false; }
    public static boolean isFailCauseExisting(int p0) { return false; }
    public static boolean isPermanentFailure(android.content.Context p0, int p1, int p2) { return false; }
    public static boolean isRadioRestartFailure(android.content.Context p0, int p1, int p2) { return false; }
