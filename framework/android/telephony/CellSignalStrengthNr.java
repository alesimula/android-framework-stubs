...
public final class CellSignalStrengthNr extends android.telephony.CellSignalStrength implements android.os.Parcelable {
    ...
    public CellSignalStrengthNr(int p0, int p1, int p2, int p3, java.util.List<java.lang.Byte> p4, int p5, int p6, int p7) { super(); }
    ...
    public CellSignalStrengthNr(android.hardware.radio.V1_6.NrSignalStrength p0) { super(); }
