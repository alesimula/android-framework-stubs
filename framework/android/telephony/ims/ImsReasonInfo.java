...
public final class ImsReasonInfo implements android.os.Parcelable {
    ...
    private static final java.util.Map<java.lang.Integer, java.lang.String> sImsCodeMap = null;
    ...
    public static final android.os.Parcelable.Creator<android.telephony.ims.ImsReasonInfo> CREATOR = null;
    public ImsReasonInfo() {}
    private ImsReasonInfo(android.os.Parcel p0) {}
    public ImsReasonInfo(int p0, int p1) {}
    public ImsReasonInfo(int p0, int p1, java.lang.String p2) {}
    public int getCode() { return 0; }
    public int getExtraCode() { return 0; }
    public java.lang.String getExtraMessage() { return null; }
    public java.lang.String toString() { return null; }
    public int describeContents() { return 0; }
    public void writeToParcel(android.os.Parcel p0, int p1) {}

    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
    public static @interface ImsCode {
    }

    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
    public static @interface UtReason {
    }
}
