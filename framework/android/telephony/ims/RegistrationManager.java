...
public interface RegistrationManager {
    ...
    @android.annotation.SystemApi
    public static final int SUGGESTED_ACTION_TRIGGER_THROTTLE_TIME = 5;
    ...
    public static class RegistrationCallback {
        ...
        public void onUnregistered(android.telephony.ims.ImsReasonInfo p0, int p1, int p2) {}
        public void onUnregistered(android.telephony.ims.ImsReasonInfo p0, int p1, int p2, int p3) {}
        @android.annotation.SystemApi
        public void onUnregistered(android.telephony.ims.ImsReasonInfo p0, android.telephony.ims.SipDetails p1) {}
        ...
        private static class RegistrationBinder extends android.telephony.ims.aidl.IImsRegistrationCallback.Stub {
            ...
            private final android.telephony.ims.RegistrationManager.RegistrationCallback mLocalCallback = null;
            ...
            public void onDeregistered(android.telephony.ims.ImsReasonInfo p0, int p1, int p2) {}
            public void onDeregisteredWithDetails(android.telephony.ims.ImsReasonInfo p0, int p1, int p2, android.telephony.ims.SipDetails p3) {}
            public void onDeregisteredWithTime(android.telephony.ims.ImsReasonInfo p0, int p1, int p2, int p3) {}
            public void onRegistered(android.telephony.ims.ImsRegistrationAttributes p0) {}
            public void onRegistering(android.telephony.ims.ImsRegistrationAttributes p0) {}
            public void onSubscriberAssociatedUriChanged(android.net.Uri[] p0) {}
            public void onTechnologyChangeFailed(int p0, android.telephony.ims.ImsReasonInfo p1) {}
