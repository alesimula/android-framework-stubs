...
public interface IImsSmsListener extends android.os.IInterface {
    public void onSendSmsResult(int p0, int p1, int p2, int p3) throws android.os.RemoteException;
    public void onSmsStatusReportReceived(int p0, int p1, java.lang.String p2, byte[] p3) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.telephony.ims.aidl.IImsSmsListener {
        ...
        public static boolean setDefaultImpl(android.telephony.ims.aidl.IImsSmsListener p0) { return false; }
        public static android.telephony.ims.aidl.IImsSmsListener getDefaultImpl() { return null; }
