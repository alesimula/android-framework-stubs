...
public interface IImsSmsListener extends android.os.IInterface {
    ...
    public void onMemoryAvailableResult(int p0, int p1, int p2) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.telephony.ims.aidl.IImsSmsListener {
        ...
        private static final class Proxy implements android.telephony.ims.aidl.IImsSmsListener {
