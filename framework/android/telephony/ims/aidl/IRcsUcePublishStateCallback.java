...
public interface IRcsUcePublishStateCallback extends android.os.IInterface {
    ...
    public void onPublishUpdated(android.telephony.ims.PublishAttributes p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.telephony.ims.aidl.IRcsUcePublishStateCallback {
        ...
        private static final class Proxy implements android.telephony.ims.aidl.IRcsUcePublishStateCallback {
