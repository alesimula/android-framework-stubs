...
public class ProvisioningManager {
    ...
    public boolean getRcsProvisioningStatusForCapability(int p0, int p1) { return false; }
    public boolean isProvisioningRequiredForCapability(int p0, int p1) { return false; }
    public boolean isRcsProvisioningRequiredForCapability(int p0, int p1) { return false; }
    @android.annotation.SystemApi
    ...
    public void registerFeatureProvisioningChangedCallback(java.util.concurrent.Executor p0, android.telephony.ims.ProvisioningManager.FeatureProvisioningCallback p1) throws android.telephony.ims.ImsException {}
    @android.annotation.SystemApi
    ...
    public void setRcsProvisioningStatusForCapability(int p0, int p1, boolean p2) {}
    @android.annotation.SystemApi
    @java.lang.Deprecated
    ...
    public static abstract class FeatureProvisioningCallback {
        private final android.telephony.ims.ProvisioningManager.FeatureProvisioningCallback.CallbackBinder mBinder = null;
        public FeatureProvisioningCallback() {}
        public final android.telephony.ims.aidl.IFeatureProvisioningCallback getBinder() { return null; }
        public abstract void onFeatureProvisioningChanged(int p0, int p1, boolean p2);
        public abstract void onRcsFeatureProvisioningChanged(int p0, int p1, boolean p2);
        public void setExecutor(java.util.concurrent.Executor p0) {}

        private static class CallbackBinder extends android.telephony.ims.aidl.IFeatureProvisioningCallback.Stub {
            private java.util.concurrent.Executor mExecutor;
            private final android.telephony.ims.ProvisioningManager.FeatureProvisioningCallback mFeatureProvisioningCallback = null;
            private CallbackBinder(android.telephony.ims.ProvisioningManager.FeatureProvisioningCallback p0) { super(); }
            private void setExecutor(java.util.concurrent.Executor p0) {}
