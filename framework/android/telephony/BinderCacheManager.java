...
public class BinderCacheManager<T extends android.os.IInterface> {
    private final android.telephony.BinderCacheManager.BinderInterfaceFactory<T> mBinderInterfaceFactory = null;
    private final java.util.concurrent.atomic.AtomicReference<android.telephony.BinderCacheManager<T>.BinderDeathTracker> mCachedConnection = null;
    ...
    private android.telephony.BinderCacheManager<T>.BinderDeathTracker getTracker() { return null; }
