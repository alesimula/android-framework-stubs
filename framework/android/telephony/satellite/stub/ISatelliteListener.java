...
public interface ISatelliteListener extends android.os.IInterface {
    ...
    public void prioritizedScanModeChanged(boolean p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.telephony.satellite.stub.ISatelliteListener {
        ...
        static final int TRANSACTION_prioritizedScanModeChanged = 10;
        public Stub() { super(); }
        ...
        private static final class Proxy implements android.telephony.satellite.stub.ISatelliteListener {
