...
public class SatelliteImplBase extends android.telephony.satellite.stub.SatelliteService {
    ...
    private android.telephony.satellite.stub.ISatelliteListener mSatelliteListener;
    public SatelliteImplBase(java.util.concurrent.Executor p0) { super(); }
    private void runWithExecutor(com.android.internal.util.FunctionalUtils.ThrowingRunnable p0) {}
    public void abortSendingSatelliteDatagrams(android.telephony.IIntegerConsumer p0) {}
    public void disablePrioritizedNetworkScan(int p0, android.telephony.IIntegerConsumer p1) {}
    public void enablePrioritizedNetworkScan(int p0, android.telephony.satellite.stub.PrioritizedNetworkScanRequest p1, android.telephony.IIntegerConsumer p2) {}
    ...
    public void requestSatelliteSuspended(boolean p0, android.telephony.IIntegerConsumer p1) {}
    ...
    public void setSatelliteNetworkInfo(int p0, android.telephony.satellite.stub.SatelliteNetworkInfo p1, android.telephony.IIntegerConsumer p2) {}
    @java.lang.Deprecated
