...
public final class SatelliteManager {
    ...
    public static final java.lang.String KEY_ENABLE_RESPONSE = "enable_response";
    public static final java.lang.String KEY_NTN_SIGNAL_STRENGTH = "ntn_signal_strength";
    public static final java.lang.String KEY_POINTING_UI_APP_LAUNCH_INTENT = "pointing_ui_app_launch_intent";
    ...
    private static final java.util.concurrent.ConcurrentHashMap<android.telephony.satellite.SatelliteCommunicationAccessStateCallback, android.telephony.satellite.ISatelliteCommunicationAccessStateCallback> sSatelliteCommunicationAccessStateCallbackMap = null;
    private static final java.util.concurrent.ConcurrentHashMap<android.telephony.satellite.SatelliteDatagramCallback, android.telephony.satellite.ISatelliteDatagramCallback> sSatelliteDatagramCallbackMap = null;
    private static final java.util.concurrent.ConcurrentHashMap<android.telephony.satellite.SatelliteDisallowedReasonsCallback, android.telephony.satellite.ISatelliteDisallowedReasonsCallback> sSatelliteDisallowedReasonsCallbackMap = null;
    private static final java.util.concurrent.ConcurrentHashMap<android.telephony.satellite.SatelliteModemStateCallback, android.telephony.satellite.ISatelliteModemStateCallback> sSatelliteModemStateCallbackMap = null;
    private static final java.util.concurrent.ConcurrentHashMap<android.telephony.satellite.SatelliteProvisionStateCallback, android.telephony.satellite.ISatelliteProvisionStateCallback> sSatelliteProvisionStateCallbackMap = null;
    private static final java.util.concurrent.ConcurrentHashMap<java.util.function.Consumer<java.lang.Boolean>, com.android.internal.telephony.IBooleanConsumer> sSatelliteSupportedStateCallbackMap = null;
    private static final java.util.concurrent.ConcurrentHashMap<android.telephony.satellite.SatelliteTransmissionUpdateCallback, android.telephony.satellite.ISatelliteTransmissionUpdateCallback> sSatelliteTransmissionUpdateCallbackMap = null;
    private static final java.util.concurrent.ConcurrentHashMap<android.telephony.satellite.SelectedNbIotSatelliteSubscriptionCallback, android.telephony.satellite.ISelectedNbIotSatelliteSubscriptionCallback> sSelectedNbIotSatelliteSubscriptionCallbackMap = null;
    ...
    private SatelliteManager(android.content.Context p0, int p1) {}
    ...
    @android.annotation.SystemApi
    public int[] getCarrierRoamingNtnAvailableServices(int p0) { return null; }
    @android.annotation.SystemApi
    public android.telephony.satellite.PlmnSatelliteConfig getPlmnSatelliteConfig(int p0, java.lang.String p1) { return null; }
    @android.annotation.SystemApi
    ...
    public java.lang.String getSatelliteEntitlementServerUrl(int p0) { return null; }
    public int getSatelliteNtnConnectType(int p0) { return 0; }
    @android.annotation.SystemApi
    public java.util.List<java.lang.String> getSatellitePlmnsForCarrier(int p0) { return null; }
    @android.annotation.SystemApi
    public boolean isInCarrierRoamingNtnMode(int p0) { return false; }
    public boolean isSatelliteAttachSupported(int p0) { return false; }
    public boolean isSatelliteEntitlementSupported(int p0) { return false; }
    @android.annotation.SystemApi
    ...
    @android.annotation.SystemApi
    public void requestEnabled(int p0, android.telephony.satellite.EnableRequestAttributes p1, java.util.concurrent.Executor p2, java.util.function.Consumer<java.lang.Integer> p3) {}
    @android.annotation.SystemApi
    ...
    public void requestEntitlementRefresh(int p0, java.util.concurrent.Executor p1, java.util.function.Consumer<java.lang.Integer> p2) {}
    @android.annotation.SystemApi
    ...
    @android.annotation.SystemApi
    public void requestIsEnabled(int p0, int p1, java.util.concurrent.Executor p2, android.os.OutcomeReceiver<android.telephony.satellite.EnableResponse, android.telephony.satellite.SatelliteManager.SatelliteException> p3) {}
    @android.annotation.SystemApi
    @java.lang.Deprecated
    ...
    @android.annotation.SystemApi
    public void requestPointingUiAppLaunchIntent(android.telephony.satellite.PointingUiAppLaunchIntentAttributes p0, java.util.concurrent.Executor p1, android.os.OutcomeReceiver<android.app.PendingIntent, android.telephony.satellite.SatelliteManager.SatelliteException> p2) {}
    @android.annotation.SystemApi
    ...
    public static @interface CarrierRoamingSatelliteEmergencyMessagingProvider {
    }
