...
public abstract class CellSignalStrength {
    ...
    public static final int getRssiDbmFromAsu(int p0) { return 0; }
    protected static final int getAsuFromRssiDbm(int p0) { return 0; }
    public static final int getRscpDbmFromAsu(int p0) { return 0; }
    protected static final int getAsuFromRscpDbm(int p0) { return 0; }
    public static final int getEcNoDbFromAsu(int p0) { return 0; }
    ...
    public static int getNumSignalStrengthLevels() { return 0; }
}
