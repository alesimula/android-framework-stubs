...
public final class SmsManager {
    ...
    private static final java.util.List<java.lang.String> SMS_OTP_READING_ROLES = null;
    ...
    private static final int SYSTEM_APP_FLAGS = 6070784;
    ...
    private static java.util.Set<java.lang.String> sSystemPkgs;
    ...
    private static java.util.List<android.companion.AssociationInfo> getAllCdmAssociations(android.content.Context p0) { return null; }
    ...
    private static java.util.Set<java.lang.String> getPackagesWithCarrierPrivileges(android.content.Context p0) { return null; }
    ...
    private static java.util.List<java.lang.String> getSmsOtpAppOpPackages(android.content.Context p0) { return null; }
    public static java.util.Set<java.lang.String> getSmsOtpTrustedPackages(android.content.Context p0, android.os.UserHandle p1) { return null; }
    private static java.util.Set<java.lang.String> getTrustedOtpSmsRolePackages(android.content.Context p0, android.os.UserHandle p1) { return null; }
    private static boolean hasSmsOtpAppOp(android.content.Context p0, java.lang.String p1, int p2) { return false; }
    public static boolean isAppTrustedForSmsOtp(android.content.Context p0, java.lang.String p1, int p2) { return false; }
    private static boolean isSystemApp(android.content.Context p0, java.lang.String p1) { return false; }
    private static boolean isTrustedOtpSmsRoleHolder(android.content.Context p0, java.lang.String p1, int p2) { return false; }
    ...
    @android.annotation.SystemApi
    public android.net.Uri getSmscIdentity() { return null; }
    public int getSubscriptionId() { return 0; }
    public long getWapMessageSize(java.lang.String p0) { return 0L; }
    ...
    @android.annotation.SystemApi
    public void sendStoredMultipartTextMessage(android.net.Uri p0, java.util.List<android.app.PendingIntent> p1, java.util.List<android.app.PendingIntent> p2) {}
    @android.annotation.SystemApi
    public void sendStoredTextMessage(android.net.Uri p0, android.app.PendingIntent p1, android.app.PendingIntent p2) {}
    ...
    public void setStorageMonitorMemoryStatusOverride(boolean p0) {}
