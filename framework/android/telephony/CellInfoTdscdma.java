...
public final class CellInfoTdscdma extends android.telephony.CellInfo implements android.os.Parcelable {
    ...
    public CellInfoTdscdma(android.hardware.radio.V1_0.CellInfo p0) { super(); }
    public CellInfoTdscdma(android.hardware.radio.V1_2.CellInfo p0) { super(); }
    public CellInfoTdscdma(android.hardware.radio.V1_4.CellInfo p0, long p1) { super(); }
    public CellInfoTdscdma(android.hardware.radio.V1_5.CellInfo p0, long p1) { super(); }
    public CellInfoTdscdma(android.hardware.radio.V1_6.CellInfo p0, long p1) { super(); }
