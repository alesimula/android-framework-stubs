...
public class TelephonyManager {
    ...
    @android.annotation.RequiresPermission(anyOf={"android.permission.ACCESS_NETWORK_STATE", "android.permission.MODIFY_PHONE_STATE", "android.permission.READ_PHONE_STATE"})
    public boolean isDataEnabled() { return false; }
    @android.annotation.RequiresPermission(anyOf={"android.permission.ACCESS_NETWORK_STATE", "android.permission.READ_PHONE_STATE"})
    ...
    @android.annotation.RequiresPermission(anyOf={"android.permission.ACCESS_NETWORK_STATE", "android.permission.READ_PHONE_STATE", "android.permission.READ_PRIVILEGED_PHONE_STATE"})
