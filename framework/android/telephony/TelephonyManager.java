...
public class TelephonyManager {
    public static final java.lang.String ACTION_2G_DISABLED_BY_CARRIER = "android.telephony.action.2G_DISABLED_BY_CARRIER";
    public static final java.lang.String ACTION_2G_ENABLED_FOR_EMERGENCY_CALLING = "android.telephony.action.2G_ENABLED_FOR_EMERGENCY_CALLING";
    ...
    @android.annotation.SystemApi
    public static final java.lang.String ACTION_STK_SETUP_EVENT_LIST = "android.telephony.action.STK_SETUP_EVENT_LIST";
    ...
    public static final java.lang.String EXTRA_CALL_CREATED_EPOCH_TIME_MILLIS = "android.telephony.extra.CALL_CREATED_EPOCH_TIME_MILLIS";
    ...
    public static final java.lang.String KEY_MANAGED_SIM_PIN_ENROLLMENT_ATTEMPTS = "managed_sim_pin_enrollment_attempts";
    public static final java.lang.String KEY_MANAGED_SIM_PIN_ENROLLMENT_GENERATED_PIN = "managed_sim_pin_enrollment_generated_pin";
    ...
    public static final java.lang.String KEY_UICC_IARI_EXCEPTION = "uicc_iari_exception";
    public static final java.lang.String KEY_UICC_IARI_LIST = "uicc_iari_list";
    ...
    private static final java.lang.String MULTI_SIM_VARIANT_DSDA = "dsda";
    private static final java.lang.String MULTI_SIM_VARIANT_DSDS = "dsds";
    private static final java.lang.String MULTI_SIM_VARIANT_TSTS = "tsts";
    ...
    private int getFirstActivePortIndex(int p0) { return 0; }
    ...
    private int getLocationData() { return 0; }
    private int getLogicalSlotIndex(int p0, int p1) { return 0; }
    @android.annotation.SystemApi
    ...
    private android.telephony.ServiceState getServiceStateForSlot(int p0, boolean p1, boolean p2) { return null; }
    ...
    private static boolean isSlotMappingValid(java.util.Collection<android.telephony.UiccSlotMapping> p0) { return false; }
    public static boolean isValidAllowedNetworkTypesReason(int p0) { return false; }
    private android.content.Context mergeAttributionAndRenouncedPermissions(android.content.Context p0, android.content.Context p1) { return null; }
    ...
    private static void runOnBackgroundThread(java.lang.Runnable p0) {}
    private void setDataEnabledForReason(int p0, int p1, boolean p2) {}
    ...
    @android.annotation.SystemApi
    public void enrollSimInAutoPinManagement(java.lang.String p0, java.util.concurrent.Executor p1, android.os.OutcomeReceiver<java.lang.String, android.telephony.TelephonyManager.SimAutoPinManagementException> p2) {}
    ...
    @android.annotation.SystemApi
    public void getAutoManagedPinForSim(java.util.concurrent.Executor p0, android.os.OutcomeReceiver<java.lang.String, android.telephony.TelephonyManager.SimAutoPinManagementException> p1) {}
    ...
    @android.annotation.SystemApi
    public int getSimAutoPinManagementEnrollmentStatus() { return 0; }
    @android.annotation.SystemApi
    ...
    @android.annotation.SystemApi
    public int[] getSupportedNetworkAlertCategories() { return null; }
    ...
    @android.annotation.SystemApi
    public void notifyEntitlementStatusChanged(int p0, java.util.List<java.lang.String> p1, java.time.ZonedDateTime p2) {}
    @android.annotation.SystemApi
    ...
    public void requestSignalStrengthUpdate(java.util.concurrent.Executor p0, android.os.OutcomeReceiver<android.telephony.SignalStrength, java.lang.Exception> p1) {}
    @android.annotation.SystemApi
    public void requestUiccIari(java.util.concurrent.Executor p0, android.os.OutcomeReceiver<java.util.Set<java.lang.String>, java.lang.Exception> p1) {}
    @android.annotation.SystemApi
    ...
    public static class CallComposerException extends java.lang.Exception {
        ...
        private final java.io.IOException mIOException = null;
    ...
    public static final class EmergencyCallDiagnosticData {
        private static long sUnsetLogcatStartTime;
        ...
        private EmergencyCallDiagnosticData(boolean p0, boolean p1, long p2) {}
