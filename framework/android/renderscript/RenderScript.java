...
public class RenderScript {
    ...
    static java.lang.String getCachePath() { return null; }
    ...
    long nAllocationAdapterCreate(long p0, long p1) { return 0L; }
    void nAllocationAdapterOffset(long p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9) {}
    void nAllocationCopyFromBitmap(long p0, android.graphics.Bitmap p1) {}
    void nAllocationCopyToBitmap(long p0, android.graphics.Bitmap p1) {}
    long nAllocationCreateBitmapBackedAllocation(long p0, int p1, android.graphics.Bitmap p2, int p3) { return 0L; }
    long nAllocationCreateFromBitmap(long p0, int p1, android.graphics.Bitmap p2, int p3) { return 0L; }
    long nAllocationCreateTyped(long p0, int p1, int p2, long p3) { return 0L; }
    long nAllocationCubeCreateFromBitmap(long p0, int p1, android.graphics.Bitmap p2, int p3) { return 0L; }
    void nAllocationData1D(long p0, int p1, int p2, int p3, java.lang.Object p4, int p5, android.renderscript.Element.DataType p6, int p7, boolean p8) {}
    void nAllocationData2D(long p0, int p1, int p2, int p3, int p4, int p5, int p6, long p7, int p8, int p9, int p10, int p11) {}
    void nAllocationData2D(long p0, int p1, int p2, int p3, int p4, int p5, int p6, java.lang.Object p7, int p8, android.renderscript.Element.DataType p9, int p10, boolean p11) {}
    void nAllocationData2D(long p0, int p1, int p2, int p3, int p4, android.graphics.Bitmap p5) {}
    void nAllocationData3D(long p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, long p8, int p9, int p10, int p11, int p12) {}
    void nAllocationData3D(long p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, java.lang.Object p8, int p9, android.renderscript.Element.DataType p10, int p11, boolean p12) {}
    void nAllocationElementData(long p0, int p1, int p2, int p3, int p4, int p5, byte[] p6, int p7) {}
    void nAllocationElementRead(long p0, int p1, int p2, int p3, int p4, int p5, byte[] p6, int p7) {}
    void nAllocationGenerateMipmaps(long p0) {}
    java.nio.ByteBuffer nAllocationGetByteBuffer(long p0, long[] p1, int p2, int p3, int p4) { return null; }
    android.view.Surface nAllocationGetSurface(long p0) { return null; }
    long nAllocationGetType(long p0) { return 0L; }
    long nAllocationIoReceive(long p0) { return 0L; }
    void nAllocationIoSend(long p0) {}
    void nAllocationRead(long p0, java.lang.Object p1, android.renderscript.Element.DataType p2, int p3, boolean p4) {}
    void nAllocationRead1D(long p0, int p1, int p2, int p3, java.lang.Object p4, int p5, android.renderscript.Element.DataType p6, int p7, boolean p8) {}
    void nAllocationRead2D(long p0, int p1, int p2, int p3, int p4, int p5, int p6, java.lang.Object p7, int p8, android.renderscript.Element.DataType p9, int p10, boolean p11) {}
    void nAllocationRead3D(long p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, java.lang.Object p8, int p9, android.renderscript.Element.DataType p10, int p11, boolean p12) {}
    void nAllocationResize1D(long p0, int p1) {}
    void nAllocationSetSurface(long p0, android.view.Surface p1) {}
    void nAllocationSetupBufferQueue(long p0, int p1) {}
    void nAllocationShareBufferQueue(long p0, long p1) {}
    void nAllocationSyncAll(long p0, int p1) {}
    void nAssignName(long p0, byte[] p1) {}
    long nClosureCreate(long p0, long p1, long[] p2, long[] p3, int[] p4, long[] p5, long[] p6) { return 0L; }
    void nClosureSetArg(long p0, int p1, long p2, int p3) {}
    void nClosureSetGlobal(long p0, long p1, long p2, int p3) {}
    void nContextBindProgramFragment(long p0) {}
    void nContextBindProgramRaster(long p0) {}
    void nContextBindProgramStore(long p0) {}
    void nContextBindProgramVertex(long p0) {}
    void nContextBindRootScript(long p0) {}
    void nContextBindSampler(int p0, int p1) {}
    long nContextCreate(long p0, int p1, int p2, int p3) { return 0L; }
    long nContextCreateGL(long p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, int p10, int p11, int p12, float p13, int p14) { return 0L; }
    native void nContextDeinitToClient(long p0);
    void nContextDestroy() {}
    void nContextDump(int p0) {}
    void nContextFinish() {}
    ...
    void nContextResume() {}
    void nContextSendMessage(int p0, int[] p1) {}
    void nContextSetCacheDir(java.lang.String p0) {}
    void nContextSetPriority(int p0) {}
    void nContextSetSurface(int p0, int p1, android.view.Surface p2) {}
    void nContextSetSurfaceTexture(int p0, int p1, android.graphics.SurfaceTexture p2) {}
    native long nDeviceCreate();
    native void nDeviceDestroy(long p0);
    native void nDeviceSetConfig(long p0, int p1, int p2);
    long nElementCreate(long p0, int p1, boolean p2, int p3) { return 0L; }
    long nElementCreate2(long[] p0, java.lang.String[] p1, int[] p2) { return 0L; }
    void nElementGetNativeData(long p0, int[] p1) {}
    void nElementGetSubElements(long p0, long[] p1, java.lang.String[] p2, int[] p3) {}
    long nFileA3DCreateFromAsset(android.content.res.AssetManager p0, java.lang.String p1) { return 0L; }
    long nFileA3DCreateFromAssetStream(long p0) { return 0L; }
    long nFileA3DCreateFromFile(java.lang.String p0) { return 0L; }
    long nFileA3DGetEntryByIndex(long p0, int p1) { return 0L; }
    void nFileA3DGetIndexEntries(long p0, int p1, int[] p2, java.lang.String[] p3) {}
    int nFileA3DGetNumIndexEntries(long p0) { return 0; }
    long nFontCreateFromAsset(android.content.res.AssetManager p0, java.lang.String p1, float p2, int p3) { return 0L; }
    long nFontCreateFromAssetStream(java.lang.String p0, float p1, int p2, long p3) { return 0L; }
    long nFontCreateFromFile(java.lang.String p0, float p1, int p2) { return 0L; }
    java.lang.String nGetName(long p0) { return null; }
    long nInvokeClosureCreate(long p0, byte[] p1, long[] p2, long[] p3, int[] p4) { return 0L; }
    long nMeshCreate(long[] p0, long[] p1, int[] p2) { return 0L; }
    int nMeshGetIndexCount(long p0) { return 0; }
    void nMeshGetIndices(long p0, long[] p1, int[] p2, int p3) {}
    int nMeshGetVertexBufferCount(long p0) { return 0; }
    void nMeshGetVertices(long p0, long[] p1, int p2) {}
    void nObjDestroy(long p0) {}
    void nProgramBindConstants(long p0, int p1, long p2) {}
    void nProgramBindSampler(long p0, int p1, long p2) {}
    void nProgramBindTexture(long p0, int p1, long p2) {}
    long nProgramFragmentCreate(java.lang.String p0, java.lang.String[] p1, long[] p2) { return 0L; }
    long nProgramRasterCreate(boolean p0, int p1) { return 0L; }
    long nProgramStoreCreate(boolean p0, boolean p1, boolean p2, boolean p3, boolean p4, boolean p5, int p6, int p7, int p8) { return 0L; }
    long nProgramVertexCreate(java.lang.String p0, java.lang.String[] p1, long[] p2) { return 0L; }
    long nSamplerCreate(int p0, int p1, int p2, int p3, int p4, float p5) { return 0L; }
    void nScriptBindAllocation(long p0, long p1, int p2) {}
    long nScriptCCreate(java.lang.String p0, java.lang.String p1, byte[] p2, int p3) { return 0L; }
    long nScriptFieldIDCreate(long p0, int p1) { return 0L; }
    void nScriptForEach(long p0, int p1, long[] p2, long p3, byte[] p4, int[] p5) {}
    double nScriptGetVarD(long p0, int p1) { return 0.0; }
    float nScriptGetVarF(long p0, int p1) { return 0.0f; }
    int nScriptGetVarI(long p0, int p1) { return 0; }
    long nScriptGetVarJ(long p0, int p1) { return 0L; }
    void nScriptGetVarV(long p0, int p1, byte[] p2) {}
    long nScriptGroup2Create(java.lang.String p0, java.lang.String p1, long[] p2) { return 0L; }
    void nScriptGroup2Execute(long p0) {}
    long nScriptGroupCreate(long[] p0, long[] p1, long[] p2, long[] p3, long[] p4) { return 0L; }
    void nScriptGroupExecute(long p0) {}
    void nScriptGroupSetInput(long p0, long p1, long p2) {}
    void nScriptGroupSetOutput(long p0, long p1, long p2) {}
    void nScriptIntrinsicBLAS_BNNM(long p0, int p1, int p2, int p3, long p4, int p5, long p6, int p7, long p8, int p9, int p10) {}
    void nScriptIntrinsicBLAS_Complex(long p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, float p10, float p11, long p12, long p13, float p14, float p15, long p16, int p17, int p18, int p19, int p20) {}
    void nScriptIntrinsicBLAS_Double(long p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, double p10, long p11, long p12, double p13, long p14, int p15, int p16, int p17, int p18) {}
    void nScriptIntrinsicBLAS_Single(long p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, float p10, long p11, long p12, float p13, long p14, int p15, int p16, int p17, int p18) {}
    void nScriptIntrinsicBLAS_Z(long p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, double p10, double p11, long p12, long p13, double p14, double p15, long p16, int p17, int p18, int p19, int p20) {}
    long nScriptIntrinsicCreate(int p0, long p1) { return 0L; }
    void nScriptInvoke(long p0, int p1) {}
    long nScriptInvokeIDCreate(long p0, int p1) { return 0L; }
    void nScriptInvokeV(long p0, int p1, byte[] p2) {}
    long nScriptKernelIDCreate(long p0, int p1, int p2) { return 0L; }
    void nScriptReduce(long p0, int p1, long[] p2, long p3, int[] p4) {}
    void nScriptSetTimeZone(long p0, byte[] p1) {}
    void nScriptSetVarD(long p0, int p1, double p2) {}
    void nScriptSetVarF(long p0, int p1, float p2) {}
    void nScriptSetVarI(long p0, int p1, int p2) {}
    void nScriptSetVarJ(long p0, int p1, long p2) {}
    void nScriptSetVarObj(long p0, int p1, long p2) {}
    void nScriptSetVarV(long p0, int p1, byte[] p2) {}
    void nScriptSetVarVE(long p0, int p1, byte[] p2, long p3, int[] p4) {}
    long nTypeCreate(long p0, int p1, int p2, int p3, boolean p4, boolean p5, int p6) { return 0L; }
    void nTypeGetNativeData(long p0, long[] p1) {}
    ...
    native void rsnAllocationCopyFromBitmap(long p0, long p1, android.graphics.Bitmap p2);
    native void rsnAllocationCopyToBitmap(long p0, long p1, android.graphics.Bitmap p2);
    native long rsnAllocationCreateBitmapBackedAllocation(long p0, long p1, int p2, android.graphics.Bitmap p3, int p4);
    native long rsnAllocationCreateFromBitmap(long p0, long p1, int p2, android.graphics.Bitmap p3, int p4);
    native long rsnAllocationCreateTyped(long p0, long p1, int p2, int p3, long p4);
    native long rsnAllocationCubeCreateFromBitmap(long p0, long p1, int p2, android.graphics.Bitmap p3, int p4);
