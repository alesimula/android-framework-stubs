...
public class InsetDrawable extends android.graphics.drawable.DrawableWrapper {
    ...
    private final android.graphics.Rect mTmpInsetRect = null;
    ...
    private android.graphics.drawable.InsetDrawable.InsetValue getInset(android.content.res.TypedArray p0, int p1, android.graphics.drawable.InsetDrawable.InsetValue p2) { return null; }
    private void getInsets(android.graphics.Rect p0) {}
    ...
    private InsetDrawable(android.graphics.drawable.InsetDrawable.InsetState p0, android.content.res.Resources p1) { super((android.graphics.drawable.Drawable)null); }
