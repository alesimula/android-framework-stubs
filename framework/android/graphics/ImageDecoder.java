...
public final class ImageDecoder implements java.lang.AutoCloseable {
    ...
    private static android.graphics.ImageDecoder createFromFile(java.io.File p0, android.graphics.ImageDecoder.Source p1) throws java.io.IOException { return null; }
    private static android.graphics.ImageDecoder createFromStream(java.io.InputStream p0, boolean p1, android.graphics.ImageDecoder.Source p2) throws java.io.IOException { return null; }
    private static android.graphics.ImageDecoder createFromAssetFileDescriptor(android.content.res.AssetFileDescriptor p0, android.graphics.ImageDecoder.Source p1) throws java.io.IOException { return null; }
    private static android.graphics.ImageDecoder createFromAsset(android.content.res.AssetManager.AssetInputStream p0, android.graphics.ImageDecoder.Source p1) throws java.io.IOException { return null; }
    ...
    private static native android.graphics.ImageDecoder nCreate(long p0, android.graphics.ImageDecoder.Source p1) throws java.io.IOException;
    private static native android.graphics.ImageDecoder nCreate(java.nio.ByteBuffer p0, int p1, int p2, android.graphics.ImageDecoder.Source p3) throws java.io.IOException;
    private static native android.graphics.ImageDecoder nCreate(byte[] p0, int p1, int p2, android.graphics.ImageDecoder.Source p3) throws java.io.IOException;
    private static native android.graphics.ImageDecoder nCreate(java.io.InputStream p0, byte[] p1, android.graphics.ImageDecoder.Source p2) throws java.io.IOException;
    private static native android.graphics.ImageDecoder nCreate(java.io.FileDescriptor p0, android.graphics.ImageDecoder.Source p1) throws java.io.IOException;
    ...
    private static class ResourceSource extends android.graphics.ImageDecoder.Source {
        ...
        public android.graphics.ImageDecoder createImageDecoder() throws java.io.IOException { return null; }
    }
