...
public final class RenderNode {
    ...
    public static interface PositionUpdateListener {
        public void positionChanged(long p0, int p1, int p2, int p3, int p4);
        default public void positionChanged(long p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, int p10) {}
        ...
        public static boolean callPositionChanged2(java.lang.ref.WeakReference<android.graphics.RenderNode.PositionUpdateListener> p0, long p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, int p10, int p11) { return false; }
