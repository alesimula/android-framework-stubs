...
public class Canvas extends android.graphics.BaseCanvas {
    ...
    private static boolean sCompatibilityRestore;
    private static boolean sCompatibilitySetBitmap;
    ...
    private static native void nClipShader(long p0, long p1, int p2);
    private static native void nConcat(long p0, long p1);
    private static native void nConcat(long p0, float[] p1);
    ...
    private static native boolean nIsHighContrastText(long p0);
    ...
    private static native int nSaveLayer(long p0, float p1, float p2, float p3, float p4, long p5);
    private static native int nSaveLayerAlpha(long p0, float p1, float p2, float p3, float p4, int p5);
    ...
    static void setCompatibilityVersion(int p0) {}
    ...
    public boolean quickReject(android.graphics.Path p0) { return false; }
    @java.lang.Deprecated
    public boolean quickReject(android.graphics.Path p0, android.graphics.Canvas.EdgeType p1) { return false; }
    public boolean quickReject(android.graphics.RectF p0) { return false; }
    @java.lang.Deprecated
