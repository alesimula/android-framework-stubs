...
public class Matrix {
    ...
    private final long native_instance = 0L;
    public Matrix() {}
    ...
    private void toShortString(java.lang.StringBuilder p0) {}
    ...
    public static enum ScaleToFit {
        ...
        FILL,
        START;
        private static final android.graphics.Matrix.ScaleToFit[] $VALUES = null;
