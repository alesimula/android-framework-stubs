...
public final class BLASTBufferQueue {
    ...
    public boolean syncNextTransaction(boolean p0, java.util.function.Consumer<android.view.SurfaceControl.Transaction> p1) { return false; }
    ...
    public static interface TransactionHangCallback {
        public void onTransactionHang(java.lang.String p0);
    }
}
