...
public final class BitmapRegionDecoder {
    ...
    private static native android.graphics.BitmapRegionDecoder nativeNewInstance(byte[] p0, int p1, int p2, boolean p3);
    private static native android.graphics.BitmapRegionDecoder nativeNewInstance(java.io.FileDescriptor p0, boolean p1);
    private static native android.graphics.BitmapRegionDecoder nativeNewInstance(java.io.InputStream p0, byte[] p1, boolean p2);
    private static native android.graphics.BitmapRegionDecoder nativeNewInstance(long p0, boolean p1);
}
