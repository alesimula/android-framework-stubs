...
public class RuntimeXfermode extends android.graphics.Xfermode {
    ...
    private java.lang.Runnable mXfermodeCleaner;
    private long mXfermodeNativeInstance;
    public RuntimeXfermode(java.lang.String p0) { super(); }
    private void invalidateXfermode() {}
    private static native long nativeCreateBlenderBuilder(java.lang.String p0);
    private static native long nativeCreateNativeInstance(long p0);
