...
public abstract class BaseCanvas {
    private boolean mAllowHwFeaturesInSwMode;
    ...
    private static native void nDrawMesh(long p0, long p1, int p2, long p3);
    ...
    private static native void nPunchHole(long p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7);
    private void throwIfHasHwFeaturesInSwMode(android.graphics.Paint p0) {}
    private void throwIfHasHwFeaturesInSwMode(android.graphics.Shader p0) {}
