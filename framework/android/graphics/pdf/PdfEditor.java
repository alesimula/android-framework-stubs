...
public final class PdfEditor {
    ...
    private static native boolean nativeGetPageCropBox2(long p0, int p1, android.graphics.pdf.RectCart p2);
    private static native boolean nativeGetPageMediaBox(long p0, int p1, android.graphics.Rect p2);
    private static native boolean nativeGetPageMediaBox2(long p0, int p1, android.graphics.pdf.RectCart p2);
    ...
    private static native void nativeSetPageCropBox2(long p0, int p1, int p2, int p3, int p4, int p5);
    private static native void nativeSetPageMediaBox(long p0, int p1, android.graphics.Rect p2);
    private static native void nativeSetPageMediaBox2(long p0, int p1, int p2, int p3, int p4, int p5);
    private static native void nativeSetTransformAndClip(long p0, int p1, long p2, int p3, int p4, int p5, int p6);
    private static native void nativeSetTransformAndClip2(long p0, int p1, long p2, int p3, int p4, int p5, int p6);
    private static native void nativeWrite(long p0, int p1);
    private void throwIfClippingBoxNull(android.graphics.pdf.RectCart p0) {}
    private void throwIfClosed() {}
    private void throwIfCropBoxNull(android.graphics.Rect p0) {}
    private void throwIfCropBoxNull(android.graphics.pdf.RectCart p0) {}
    private void throwIfMediaBoxNull(android.graphics.Rect p0) {}
    private void throwIfMediaBoxNull(android.graphics.pdf.RectCart p0) {}
    private void throwIfNotNullAndNotAffine(android.graphics.Matrix p0) {}
    private void throwIfOutCropBoxNull(android.graphics.Rect p0) {}
    private void throwIfOutCropBoxNull(android.graphics.pdf.RectCart p0) {}
    private void throwIfOutMediaBoxNull(android.graphics.Rect p0) {}
    private void throwIfOutMediaBoxNull(android.graphics.pdf.RectCart p0) {}
    ...
    public boolean getPageCropBox(int p0, android.graphics.pdf.RectCart p1) { return false; }
    public boolean getPageMediaBox(int p0, android.graphics.Rect p1) { return false; }
    public boolean getPageMediaBox(int p0, android.graphics.pdf.RectCart p1) { return false; }
    ...
    public void setPageCropBox(int p0, android.graphics.pdf.RectCart p1) {}
    public void setPageMediaBox(int p0, android.graphics.Rect p1) {}
    public void setPageMediaBox(int p0, android.graphics.pdf.RectCart p1) {}
    public void setTransformAndClip(int p0, android.graphics.Matrix p1, android.graphics.Rect p2) {}
    public void setTransformAndClip(int p0, android.graphics.Matrix p1, android.graphics.pdf.RectCart p2) {}
