...
public final class PdfRenderer implements java.lang.AutoCloseable {
    ...
    @android.annotation.FlaggedApi("android.graphics.pdf.flags.enable_pdf_viewer")
    public PdfRenderer(android.os.ParcelFileDescriptor p0, android.graphics.pdf.LoadParams p1) throws java.io.IOException {}
    public void close() {}
    @android.annotation.FlaggedApi("android.graphics.pdf.flags.enable_pdf_viewer")
    ...
    public final class Page implements java.lang.AutoCloseable {
        ...
        Page(android.graphics.pdf.PdfRenderer p0) {}
