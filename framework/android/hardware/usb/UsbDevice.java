...
public class UsbDevice implements android.os.Parcelable {
    ...
    private final boolean mHasAudioCapture = false;
    private final boolean mHasAudioPlayback = false;
    private final boolean mHasMidi = false;
    private final boolean mHasVideoCapture = false;
    private final boolean mHasVideoPlayback = false;
    ...
    private UsbDevice(java.lang.String p0, int p1, int p2, int p3, int p4, int p5, java.lang.String p6, java.lang.String p7, java.lang.String p8, android.hardware.usb.UsbConfiguration[] p9, android.hardware.usb.IUsbSerialReader p10, boolean p11, boolean p12, boolean p13, boolean p14, boolean p15) {}
    private static android.util.Pair<java.lang.Integer, java.lang.Integer> getBusAndDeviceNumber(int p0) { return null; }
    ...
    public static java.lang.String getDeviceName(int p0, int p1) { return null; }
    ...
    public android.util.Pair<java.lang.Integer, java.lang.Integer> getBusAndDeviceNumber() { return null; }
