...
public final class DisplayPortAltModeInfo implements android.os.Parcelable {
    ...
    private final int mCableStatus = 0;
    private final boolean mHotPlugDetect = false;
    private final int mLinkTrainingStatus = 0;
    private final int mNumLanes = 0;
    private final int mPartnerSinkStatus = 0;
    public DisplayPortAltModeInfo() {}
    public DisplayPortAltModeInfo(int p0, int p1, int p2, boolean p3, int p4) {}
    private java.lang.String displayPortAltModeStatusToString(int p0) { return null; }
    private java.lang.String linkTrainingStatusToString(int p0) { return null; }
