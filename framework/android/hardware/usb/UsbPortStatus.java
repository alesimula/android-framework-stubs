...
public final class UsbPortStatus implements android.os.Parcelable {
    ...
    @android.annotation.FlaggedApi("android.hardware.usb.flags.enable_usb_data_compliance_warning")
    ...
    @android.annotation.FlaggedApi("android.hardware.usb.flags.enable_is_pd_compliant_api")
