...
public interface IOemHookResponse extends android.internal.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.radio.deprecated@1.0::IOemHookResponse";
    public static android.hardware.radio.deprecated.V1_0.IOemHookResponse asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.radio.deprecated.V1_0.IOemHookResponse castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.radio.deprecated.V1_0.IOemHookResponse getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.radio.deprecated.V1_0.IOemHookResponse getService(boolean p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.radio.deprecated.V1_0.IOemHookResponse getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.radio.deprecated.V1_0.IOemHookResponse getService() throws android.os.RemoteException { return null; }
    public void sendRequestRawResponse(android.hardware.radio.V1_0.RadioResponseInfo p0, java.util.ArrayList<java.lang.Byte> p1) throws android.os.RemoteException;
    public void sendRequestStringsResponse(android.hardware.radio.V1_0.RadioResponseInfo p0, java.util.ArrayList<java.lang.String> p1) throws android.os.RemoteException;
    ...
    public static final class Proxy implements android.hardware.radio.deprecated.V1_0.IOemHookResponse {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.radio.deprecated.V1_0.IOemHookResponse {
        public Stub() { super(); }
        public android.os.IHwBinder asBinder() { return null; }
