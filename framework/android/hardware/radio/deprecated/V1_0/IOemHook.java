...
public interface IOemHook extends android.internal.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.radio.deprecated@1.0::IOemHook";
    public static android.hardware.radio.deprecated.V1_0.IOemHook asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.radio.deprecated.V1_0.IOemHook castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.radio.deprecated.V1_0.IOemHook getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.radio.deprecated.V1_0.IOemHook getService(boolean p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.radio.deprecated.V1_0.IOemHook getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.radio.deprecated.V1_0.IOemHook getService() throws android.os.RemoteException { return null; }
    public void setResponseFunctions(android.hardware.radio.deprecated.V1_0.IOemHookResponse p0, android.hardware.radio.deprecated.V1_0.IOemHookIndication p1) throws android.os.RemoteException;
    public void sendRequestRaw(int p0, java.util.ArrayList<java.lang.Byte> p1) throws android.os.RemoteException;
    public void sendRequestStrings(int p0, java.util.ArrayList<java.lang.String> p1) throws android.os.RemoteException;
    ...
    public static final class Proxy implements android.hardware.radio.deprecated.V1_0.IOemHook {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.radio.deprecated.V1_0.IOemHook {
        public Stub() { super(); }
        public android.os.IHwBinder asBinder() { return null; }
