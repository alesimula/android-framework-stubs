...
public interface ITuner extends android.os.IInterface {
    ...
    public java.util.Map<java.lang.String, java.lang.String> getParameters(java.util.List<java.lang.String> p0) throws android.os.RemoteException;
    ...
    public java.util.Map<java.lang.String, java.lang.String> setParameters(java.util.Map<java.lang.String, java.lang.String> p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.hardware.radio.ITuner {
        ...
        private static final class Proxy implements android.hardware.radio.ITuner {
