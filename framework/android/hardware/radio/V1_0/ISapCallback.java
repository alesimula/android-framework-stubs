...
public interface ISapCallback extends android.internal.hidl.base.V1_0.IBase {
    ...
    public static android.hardware.radio.V1_0.ISapCallback asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.radio.V1_0.ISapCallback castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.radio.V1_0.ISapCallback getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.radio.V1_0.ISapCallback getService(boolean p0) throws android.os.RemoteException { return null; }
    public static android.hardware.radio.V1_0.ISapCallback getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    public static android.hardware.radio.V1_0.ISapCallback getService() throws android.os.RemoteException { return null; }
    public void connectResponse(int p0, int p1, int p2) throws android.os.RemoteException;
    public void disconnectResponse(int p0) throws android.os.RemoteException;
    public void disconnectIndication(int p0, int p1) throws android.os.RemoteException;
    public void apduResponse(int p0, int p1, java.util.ArrayList<java.lang.Byte> p2) throws android.os.RemoteException;
    public void transferAtrResponse(int p0, int p1, java.util.ArrayList<java.lang.Byte> p2) throws android.os.RemoteException;
    public void powerResponse(int p0, int p1) throws android.os.RemoteException;
    public void resetSimResponse(int p0, int p1) throws android.os.RemoteException;
    public void statusIndication(int p0, int p1) throws android.os.RemoteException;
    public void transferCardReaderStatusResponse(int p0, int p1, int p2) throws android.os.RemoteException;
    public void errorResponse(int p0) throws android.os.RemoteException;
    public void transferProtocolResponse(int p0, int p1) throws android.os.RemoteException;
