...
public interface IRadioConfig extends android.hardware.radio.config.V1_1.IRadioConfig {
    public static final java.lang.String kInterfaceName = "android.hardware.radio.config@1.3::IRadioConfig";
    public static android.hardware.radio.config.V1_3.IRadioConfig asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.radio.config.V1_3.IRadioConfig castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.radio.config.V1_3.IRadioConfig getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.radio.config.V1_3.IRadioConfig getService(boolean p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.radio.config.V1_3.IRadioConfig getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.radio.config.V1_3.IRadioConfig getService() throws android.os.RemoteException { return null; }
    ...
    public static final class Proxy implements android.hardware.radio.config.V1_3.IRadioConfig {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.radio.config.V1_3.IRadioConfig {
        public Stub() { super(); }
        public android.os.IHwBinder asBinder() { return null; }
