...
public interface IRadioConfigIndication extends android.internal.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.radio.config@1.0::IRadioConfigIndication";
    public static android.hardware.radio.config.V1_0.IRadioConfigIndication asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.radio.config.V1_0.IRadioConfigIndication castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.radio.config.V1_0.IRadioConfigIndication getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.radio.config.V1_0.IRadioConfigIndication getService(boolean p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.radio.config.V1_0.IRadioConfigIndication getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.radio.config.V1_0.IRadioConfigIndication getService() throws android.os.RemoteException { return null; }
    ...
    public static final class Proxy implements android.hardware.radio.config.V1_0.IRadioConfigIndication {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.radio.config.V1_0.IRadioConfigIndication {
        public Stub() { super(); }
        public android.os.IHwBinder asBinder() { return null; }
