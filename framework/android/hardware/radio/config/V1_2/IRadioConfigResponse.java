...
public interface IRadioConfigResponse extends android.hardware.radio.config.V1_1.IRadioConfigResponse {
    public static final java.lang.String kInterfaceName = "android.hardware.radio.config@1.2::IRadioConfigResponse";
    public static android.hardware.radio.config.V1_2.IRadioConfigResponse asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.radio.config.V1_2.IRadioConfigResponse castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.radio.config.V1_2.IRadioConfigResponse getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.radio.config.V1_2.IRadioConfigResponse getService(boolean p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.radio.config.V1_2.IRadioConfigResponse getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.radio.config.V1_2.IRadioConfigResponse getService() throws android.os.RemoteException { return null; }
    ...
    public static final class Proxy implements android.hardware.radio.config.V1_2.IRadioConfigResponse {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.radio.config.V1_2.IRadioConfigResponse {
        public Stub() { super(); }
        public android.os.IHwBinder asBinder() { return null; }
