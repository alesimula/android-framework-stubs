...
public interface IRadioConfigIndication extends android.hardware.radio.config.V1_1.IRadioConfigIndication {
    public static final java.lang.String kInterfaceName = "android.hardware.radio.config@1.2::IRadioConfigIndication";
    public static android.hardware.radio.config.V1_2.IRadioConfigIndication asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.radio.config.V1_2.IRadioConfigIndication castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.radio.config.V1_2.IRadioConfigIndication getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.radio.config.V1_2.IRadioConfigIndication getService(boolean p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.radio.config.V1_2.IRadioConfigIndication getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.radio.config.V1_2.IRadioConfigIndication getService() throws android.os.RemoteException { return null; }
    public void simSlotsStatusChanged_1_2(int p0, java.util.ArrayList<android.hardware.radio.config.V1_2.SimSlotStatus> p1) throws android.os.RemoteException;
    ...
    public static final class Proxy implements android.hardware.radio.config.V1_2.IRadioConfigIndication {
        public Proxy(android.os.IHwBinder p0) {}
        public android.os.IHwBinder asBinder() { return null; }
        public java.lang.String toString() { return null; }
        public final boolean equals(java.lang.Object p0) { return false; }
        public final int hashCode() { return 0; }
        public void simSlotsStatusChanged(int p0, java.util.ArrayList<android.hardware.radio.config.V1_0.SimSlotStatus> p1) throws android.os.RemoteException {}
        public void simSlotsStatusChanged_1_2(int p0, java.util.ArrayList<android.hardware.radio.config.V1_2.SimSlotStatus> p1) throws android.os.RemoteException {}
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.radio.config.V1_2.IRadioConfigIndication {
        public Stub() { super(); }
        public android.os.IHwBinder asBinder() { return null; }
