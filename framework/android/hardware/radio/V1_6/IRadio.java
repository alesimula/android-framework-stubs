...
public interface IRadio extends android.hardware.radio.V1_5.IRadio {
    ...
    public static android.hardware.radio.V1_6.IRadio asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.radio.V1_6.IRadio castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.radio.V1_6.IRadio getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.radio.V1_6.IRadio getService(boolean p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.radio.V1_6.IRadio getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.radio.V1_6.IRadio getService() throws android.os.RemoteException { return null; }
    public void setRadioPower_1_6(int p0, boolean p1, boolean p2, boolean p3) throws android.os.RemoteException;
    public void getDataCallList_1_6(int p0) throws android.os.RemoteException;
    public void setupDataCall_1_6(int p0, int p1, android.hardware.radio.V1_5.DataProfileInfo p2, boolean p3, int p4, java.util.ArrayList<android.hardware.radio.V1_5.LinkAddress> p5, java.util.ArrayList<java.lang.String> p6, int p7, android.hardware.radio.V1_6.OptionalSliceInfo p8, android.hardware.radio.V1_6.OptionalTrafficDescriptor p9, boolean p10) throws android.os.RemoteException;
    public void sendSms_1_6(int p0, android.hardware.radio.V1_0.GsmSmsMessage p1) throws android.os.RemoteException;
    public void sendSmsExpectMore_1_6(int p0, android.hardware.radio.V1_0.GsmSmsMessage p1) throws android.os.RemoteException;
    public void sendCdmaSms_1_6(int p0, android.hardware.radio.V1_0.CdmaSmsMessage p1) throws android.os.RemoteException;
    public void sendCdmaSmsExpectMore_1_6(int p0, android.hardware.radio.V1_0.CdmaSmsMessage p1) throws android.os.RemoteException;
    public void setSimCardPower_1_6(int p0, int p1) throws android.os.RemoteException;
    ...
    public void emergencyDial_1_6(int p0, android.hardware.radio.V1_0.Dial p1, int p2, java.util.ArrayList<java.lang.String> p3, int p4, boolean p5, boolean p6) throws android.os.RemoteException;
    public void getSystemSelectionChannels(int p0) throws android.os.RemoteException;
    public void getCellInfoList_1_6(int p0) throws android.os.RemoteException;
    public void getVoiceRegistrationState_1_6(int p0) throws android.os.RemoteException;
    public void getSignalStrength_1_6(int p0) throws android.os.RemoteException;
    public void getDataRegistrationState_1_6(int p0) throws android.os.RemoteException;
    public void getCurrentCalls_1_6(int p0) throws android.os.RemoteException;
    public void getSlicingConfig(int p0) throws android.os.RemoteException;
    public void setCarrierInfoForImsiEncryption_1_6(int p0, android.hardware.radio.V1_6.ImsiEncryptionInfo p1) throws android.os.RemoteException;
    ...
    public void updateSimPhonebookRecords(int p0, android.hardware.radio.V1_6.PhonebookRecordInfo p1) throws android.os.RemoteException;
    ...
    public static final class Proxy implements android.hardware.radio.V1_6.IRadio {
        ...
        public void setSystemSelectionChannels(int p0, boolean p1, java.util.ArrayList<android.hardware.radio.V1_1.RadioAccessSpecifier> p2) throws android.os.RemoteException {}
        ...
        public void setupDataCall_1_4(int p0, int p1, android.hardware.radio.V1_4.DataProfileInfo p2, boolean p3, int p4, java.util.ArrayList<java.lang.String> p5, java.util.ArrayList<java.lang.String> p6) throws android.os.RemoteException {}
        public void setInitialAttachApn_1_4(int p0, android.hardware.radio.V1_4.DataProfileInfo p1) throws android.os.RemoteException {}
        public void setDataProfile_1_4(int p0, java.util.ArrayList<android.hardware.radio.V1_4.DataProfileInfo> p1) throws android.os.RemoteException {}
        public void emergencyDial(int p0, android.hardware.radio.V1_0.Dial p1, int p2, java.util.ArrayList<java.lang.String> p3, int p4, boolean p5, boolean p6) throws android.os.RemoteException {}
        public void startNetworkScan_1_4(int p0, android.hardware.radio.V1_2.NetworkScanRequest p1) throws android.os.RemoteException {}
        public void getPreferredNetworkTypeBitmap(int p0) throws android.os.RemoteException {}
        public void setPreferredNetworkTypeBitmap(int p0, int p1) throws android.os.RemoteException {}
        public void setAllowedCarriers_1_4(int p0, android.hardware.radio.V1_4.CarrierRestrictionsWithPriority p1, int p2) throws android.os.RemoteException {}
        public void getAllowedCarriers_1_4(int p0) throws android.os.RemoteException {}
        public void getSignalStrength_1_4(int p0) throws android.os.RemoteException {}
        public void setSignalStrengthReportingCriteria_1_5(int p0, android.hardware.radio.V1_5.SignalThresholdInfo p1, int p2) throws android.os.RemoteException {}
        public void setLinkCapacityReportingCriteria_1_5(int p0, int p1, int p2, int p3, java.util.ArrayList<java.lang.Integer> p4, java.util.ArrayList<java.lang.Integer> p5, int p6) throws android.os.RemoteException {}
        ...
        public void setSystemSelectionChannels_1_5(int p0, boolean p1, java.util.ArrayList<android.hardware.radio.V1_5.RadioAccessSpecifier> p2) throws android.os.RemoteException {}
        public void startNetworkScan_1_5(int p0, android.hardware.radio.V1_5.NetworkScanRequest p1) throws android.os.RemoteException {}
        public void setupDataCall_1_5(int p0, int p1, android.hardware.radio.V1_5.DataProfileInfo p2, boolean p3, int p4, java.util.ArrayList<android.hardware.radio.V1_5.LinkAddress> p5, java.util.ArrayList<java.lang.String> p6) throws android.os.RemoteException {}
        public void setInitialAttachApn_1_5(int p0, android.hardware.radio.V1_5.DataProfileInfo p1) throws android.os.RemoteException {}
        public void setDataProfile_1_5(int p0, java.util.ArrayList<android.hardware.radio.V1_5.DataProfileInfo> p1) throws android.os.RemoteException {}
        public void setRadioPower_1_5(int p0, boolean p1, boolean p2, boolean p3) throws android.os.RemoteException {}
        public void setIndicationFilter_1_5(int p0, int p1) throws android.os.RemoteException {}
        public void getBarringInfo(int p0) throws android.os.RemoteException {}
        public void getVoiceRegistrationState_1_5(int p0) throws android.os.RemoteException {}
        public void getDataRegistrationState_1_5(int p0) throws android.os.RemoteException {}
        public void setNetworkSelectionModeManual_1_5(int p0, java.lang.String p1, int p2) throws android.os.RemoteException {}
        public void sendCdmaSmsExpectMore(int p0, android.hardware.radio.V1_0.CdmaSmsMessage p1) throws android.os.RemoteException {}
