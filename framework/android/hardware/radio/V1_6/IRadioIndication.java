...
public interface IRadioIndication extends android.hardware.radio.V1_5.IRadioIndication {
    ...
    public static android.hardware.radio.V1_6.IRadioIndication asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.radio.V1_6.IRadioIndication castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.radio.V1_6.IRadioIndication getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.radio.V1_6.IRadioIndication getService(boolean p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.radio.V1_6.IRadioIndication getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.radio.V1_6.IRadioIndication getService() throws android.os.RemoteException { return null; }
    public void dataCallListChanged_1_6(int p0, java.util.ArrayList<android.hardware.radio.V1_6.SetupDataCallResult> p1) throws android.os.RemoteException;
    public void unthrottleApn(int p0, java.lang.String p1) throws android.os.RemoteException;
    public void currentLinkCapacityEstimate_1_6(int p0, android.hardware.radio.V1_6.LinkCapacityEstimate p1) throws android.os.RemoteException;
    public void currentSignalStrength_1_6(int p0, android.hardware.radio.V1_6.SignalStrength p1) throws android.os.RemoteException;
    public void cellInfoList_1_6(int p0, java.util.ArrayList<android.hardware.radio.V1_6.CellInfo> p1) throws android.os.RemoteException;
    public void networkScanResult_1_6(int p0, android.hardware.radio.V1_6.NetworkScanResult p1) throws android.os.RemoteException;
    public void currentPhysicalChannelConfigs_1_6(int p0, java.util.ArrayList<android.hardware.radio.V1_6.PhysicalChannelConfig> p1) throws android.os.RemoteException;
    public void simPhonebookChanged(int p0) throws android.os.RemoteException;
    public void simPhonebookRecordsReceived(int p0, byte p1, java.util.ArrayList<android.hardware.radio.V1_6.PhonebookRecordInfo> p2) throws android.os.RemoteException;
    ...
    public static final class Proxy implements android.hardware.radio.V1_6.IRadioIndication {
        ...
        public void registrationFailed(int p0, android.hardware.radio.V1_5.CellIdentity p1, java.lang.String p2, int p3, int p4, int p5) throws android.os.RemoteException {}
        public void barringInfoChanged(int p0, android.hardware.radio.V1_5.CellIdentity p1, java.util.ArrayList<android.hardware.radio.V1_5.BarringInfo> p2) throws android.os.RemoteException {}
        public void cellInfoList_1_5(int p0, java.util.ArrayList<android.hardware.radio.V1_5.CellInfo> p1) throws android.os.RemoteException {}
        public void networkScanResult_1_5(int p0, android.hardware.radio.V1_5.NetworkScanResult p1) throws android.os.RemoteException {}
        public void dataCallListChanged_1_5(int p0, java.util.ArrayList<android.hardware.radio.V1_5.SetupDataCallResult> p1) throws android.os.RemoteException {}
        public void dataCallListChanged_1_6(int p0, java.util.ArrayList<android.hardware.radio.V1_6.SetupDataCallResult> p1) throws android.os.RemoteException {}
        public void unthrottleApn(int p0, java.lang.String p1) throws android.os.RemoteException {}
        public void currentLinkCapacityEstimate_1_6(int p0, android.hardware.radio.V1_6.LinkCapacityEstimate p1) throws android.os.RemoteException {}
        public void currentSignalStrength_1_6(int p0, android.hardware.radio.V1_6.SignalStrength p1) throws android.os.RemoteException {}
