...
public interface IGnssConfiguration extends android.hardware.gnss.V1_1.IGnssConfiguration {
    ...
    public static android.hardware.gnss.V2_0.IGnssConfiguration asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.gnss.V2_0.IGnssConfiguration castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.gnss.V2_0.IGnssConfiguration getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.gnss.V2_0.IGnssConfiguration getService(boolean p0) throws android.os.RemoteException { return null; }
    public static android.hardware.gnss.V2_0.IGnssConfiguration getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    public static android.hardware.gnss.V2_0.IGnssConfiguration getService() throws android.os.RemoteException { return null; }
    public boolean setEsExtensionSec(int p0) throws android.os.RemoteException;
