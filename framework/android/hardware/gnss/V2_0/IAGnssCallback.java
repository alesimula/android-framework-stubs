...
public interface IAGnssCallback extends android.internal.hidl.base.V1_0.IBase {
    ...
    public static android.hardware.gnss.V2_0.IAGnssCallback asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.gnss.V2_0.IAGnssCallback castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.gnss.V2_0.IAGnssCallback getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.gnss.V2_0.IAGnssCallback getService(boolean p0) throws android.os.RemoteException { return null; }
    public static android.hardware.gnss.V2_0.IAGnssCallback getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    public static android.hardware.gnss.V2_0.IAGnssCallback getService() throws android.os.RemoteException { return null; }
    public void agnssStatusCb(byte p0, byte p1) throws android.os.RemoteException;
