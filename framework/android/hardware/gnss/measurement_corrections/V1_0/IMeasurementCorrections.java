...
public interface IMeasurementCorrections extends android.internal.hidl.base.V1_0.IBase {
    ...
    public static android.hardware.gnss.measurement_corrections.V1_0.IMeasurementCorrections asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.gnss.measurement_corrections.V1_0.IMeasurementCorrections castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.gnss.measurement_corrections.V1_0.IMeasurementCorrections getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.gnss.measurement_corrections.V1_0.IMeasurementCorrections getService(boolean p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.gnss.measurement_corrections.V1_0.IMeasurementCorrections getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.gnss.measurement_corrections.V1_0.IMeasurementCorrections getService() throws android.os.RemoteException { return null; }
    public boolean setCorrections(android.hardware.gnss.measurement_corrections.V1_0.MeasurementCorrections p0) throws android.os.RemoteException;
    public boolean setCallback(android.hardware.gnss.measurement_corrections.V1_0.IMeasurementCorrectionsCallback p0) throws android.os.RemoteException;
