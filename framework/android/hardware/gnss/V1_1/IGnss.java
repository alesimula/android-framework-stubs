...
public interface IGnss extends android.hardware.gnss.V1_0.IGnss {
    ...
    public static android.hardware.gnss.V1_1.IGnss asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.gnss.V1_1.IGnss castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.gnss.V1_1.IGnss getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.gnss.V1_1.IGnss getService(boolean p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.gnss.V1_1.IGnss getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.gnss.V1_1.IGnss getService() throws android.os.RemoteException { return null; }
    public boolean setCallback_1_1(android.hardware.gnss.V1_1.IGnssCallback p0) throws android.os.RemoteException;
    public boolean setPositionMode_1_1(byte p0, int p1, int p2, int p3, int p4, boolean p5) throws android.os.RemoteException;
    ...
    public boolean injectBestLocation(android.hardware.gnss.V1_0.GnssLocation p0) throws android.os.RemoteException;
