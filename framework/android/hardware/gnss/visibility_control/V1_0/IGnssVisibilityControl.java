...
public interface IGnssVisibilityControl extends android.internal.hidl.base.V1_0.IBase {
    ...
    public static android.hardware.gnss.visibility_control.V1_0.IGnssVisibilityControl asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.gnss.visibility_control.V1_0.IGnssVisibilityControl castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.gnss.visibility_control.V1_0.IGnssVisibilityControl getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.gnss.visibility_control.V1_0.IGnssVisibilityControl getService(boolean p0) throws android.os.RemoteException { return null; }
    public static android.hardware.gnss.visibility_control.V1_0.IGnssVisibilityControl getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    public static android.hardware.gnss.visibility_control.V1_0.IGnssVisibilityControl getService() throws android.os.RemoteException { return null; }
    public boolean enableNfwLocationAccess(java.util.ArrayList<java.lang.String> p0) throws android.os.RemoteException;
    public boolean setCallback(android.hardware.gnss.visibility_control.V1_0.IGnssVisibilityControlCallback p0) throws android.os.RemoteException;
    ...
    public static final class Proxy implements android.hardware.gnss.visibility_control.V1_0.IGnssVisibilityControl {
        ...
        public boolean enableNfwLocationAccess(java.util.ArrayList<java.lang.String> p0) throws android.os.RemoteException { return false; }
        public boolean setCallback(android.hardware.gnss.visibility_control.V1_0.IGnssVisibilityControlCallback p0) throws android.os.RemoteException { return false; }
