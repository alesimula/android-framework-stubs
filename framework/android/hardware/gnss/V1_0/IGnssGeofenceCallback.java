...
public interface IGnssGeofenceCallback extends android.internal.hidl.base.V1_0.IBase {
    ...
    public static android.hardware.gnss.V1_0.IGnssGeofenceCallback asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.gnss.V1_0.IGnssGeofenceCallback castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.gnss.V1_0.IGnssGeofenceCallback getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.gnss.V1_0.IGnssGeofenceCallback getService(boolean p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.gnss.V1_0.IGnssGeofenceCallback getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.gnss.V1_0.IGnssGeofenceCallback getService() throws android.os.RemoteException { return null; }
    public void gnssGeofenceTransitionCb(int p0, android.hardware.gnss.V1_0.GnssLocation p1, int p2, long p3) throws android.os.RemoteException;
    public void gnssGeofenceStatusCb(int p0, android.hardware.gnss.V1_0.GnssLocation p1) throws android.os.RemoteException;
