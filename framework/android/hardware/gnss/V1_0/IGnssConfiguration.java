...
public interface IGnssConfiguration extends android.internal.hidl.base.V1_0.IBase {
    ...
    public static android.hardware.gnss.V1_0.IGnssConfiguration asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.gnss.V1_0.IGnssConfiguration castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.gnss.V1_0.IGnssConfiguration getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.gnss.V1_0.IGnssConfiguration getService(boolean p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.gnss.V1_0.IGnssConfiguration getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.gnss.V1_0.IGnssConfiguration getService() throws android.os.RemoteException { return null; }
    public boolean setSuplEs(boolean p0) throws android.os.RemoteException;
    public boolean setSuplVersion(int p0) throws android.os.RemoteException;
    public boolean setSuplMode(byte p0) throws android.os.RemoteException;
    public boolean setGpsLock(byte p0) throws android.os.RemoteException;
    public boolean setLppProfile(byte p0) throws android.os.RemoteException;
    public boolean setGlonassPositioningProtocol(byte p0) throws android.os.RemoteException;
    public boolean setEmergencySuplPdn(boolean p0) throws android.os.RemoteException;
