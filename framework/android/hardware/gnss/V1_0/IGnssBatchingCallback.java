...
public interface IGnssBatchingCallback extends android.internal.hidl.base.V1_0.IBase {
    ...
    public static android.hardware.gnss.V1_0.IGnssBatchingCallback asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.gnss.V1_0.IGnssBatchingCallback castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.gnss.V1_0.IGnssBatchingCallback getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.gnss.V1_0.IGnssBatchingCallback getService(boolean p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.gnss.V1_0.IGnssBatchingCallback getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.gnss.V1_0.IGnssBatchingCallback getService() throws android.os.RemoteException { return null; }
    public void gnssLocationBatchCb(java.util.ArrayList<android.hardware.gnss.V1_0.GnssLocation> p0) throws android.os.RemoteException;
