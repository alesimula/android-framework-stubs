...
public interface IGnssBatching extends android.internal.hidl.base.V1_0.IBase {
    ...
    public static android.hardware.gnss.V1_0.IGnssBatching asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.gnss.V1_0.IGnssBatching castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.gnss.V1_0.IGnssBatching getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.gnss.V1_0.IGnssBatching getService(boolean p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.gnss.V1_0.IGnssBatching getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.gnss.V1_0.IGnssBatching getService() throws android.os.RemoteException { return null; }
    public boolean init(android.hardware.gnss.V1_0.IGnssBatchingCallback p0) throws android.os.RemoteException;
    public short getBatchSize() throws android.os.RemoteException;
    public boolean start(android.hardware.gnss.V1_0.IGnssBatching.Options p0) throws android.os.RemoteException;
    ...
    public static final class Options {
        ...
        public static final java.util.ArrayList<android.hardware.gnss.V1_0.IGnssBatching.Options> readVectorFromParcel(android.os.HwParcel p0) { return null; }
        public final void readEmbeddedFromParcel(android.os.HwParcel p0, android.os.HwBlob p1, long p2) {}
        public final void writeToParcel(android.os.HwParcel p0) {}
        public static final void writeVectorToParcel(android.os.HwParcel p0, java.util.ArrayList<android.hardware.gnss.V1_0.IGnssBatching.Options> p1) {}
    ...
    public static final class Proxy implements android.hardware.gnss.V1_0.IGnssBatching {
        ...
        public final boolean equals(java.lang.Object p0) { return false; }
        public final int hashCode() { return 0; }
        public boolean init(android.hardware.gnss.V1_0.IGnssBatchingCallback p0) throws android.os.RemoteException { return false; }
        public short getBatchSize() throws android.os.RemoteException { return 0; }
        public boolean start(android.hardware.gnss.V1_0.IGnssBatching.Options p0) throws android.os.RemoteException { return false; }
        public void flush() throws android.os.RemoteException {}
