...
public interface IGnssNavigationMessage extends android.internal.hidl.base.V1_0.IBase {
    ...
    public static android.hardware.gnss.V1_0.IGnssNavigationMessage asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.gnss.V1_0.IGnssNavigationMessage castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.gnss.V1_0.IGnssNavigationMessage getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.gnss.V1_0.IGnssNavigationMessage getService(boolean p0) throws android.os.RemoteException { return null; }
    public static android.hardware.gnss.V1_0.IGnssNavigationMessage getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    public static android.hardware.gnss.V1_0.IGnssNavigationMessage getService() throws android.os.RemoteException { return null; }
    public int setCallback(android.hardware.gnss.V1_0.IGnssNavigationMessageCallback p0) throws android.os.RemoteException;
    ...
    public static final class GnssNavigationMessageStatus {
        ...
        public GnssNavigationMessageStatus() {}
    ...
    public static final class Proxy implements android.hardware.gnss.V1_0.IGnssNavigationMessage {
        ...
        public int setCallback(android.hardware.gnss.V1_0.IGnssNavigationMessageCallback p0) throws android.os.RemoteException { return 0; }
        public void close() throws android.os.RemoteException {}
