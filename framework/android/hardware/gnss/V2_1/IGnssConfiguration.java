...
public interface IGnssConfiguration extends android.hardware.gnss.V2_0.IGnssConfiguration {
    ...
    public static android.hardware.gnss.V2_1.IGnssConfiguration asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.gnss.V2_1.IGnssConfiguration castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.gnss.V2_1.IGnssConfiguration getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.gnss.V2_1.IGnssConfiguration getService(boolean p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.gnss.V2_1.IGnssConfiguration getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.gnss.V2_1.IGnssConfiguration getService() throws android.os.RemoteException { return null; }
    public boolean setBlacklist_2_1(java.util.ArrayList<android.hardware.gnss.V2_1.IGnssConfiguration.BlacklistedSource> p0) throws android.os.RemoteException;
    ...
    public static final class BlacklistedSource {
        ...
        public static final java.util.ArrayList<android.hardware.gnss.V2_1.IGnssConfiguration.BlacklistedSource> readVectorFromParcel(android.os.HwParcel p0) { return null; }
        public final void readEmbeddedFromParcel(android.os.HwParcel p0, android.os.HwBlob p1, long p2) {}
        public final void writeToParcel(android.os.HwParcel p0) {}
        public static final void writeVectorToParcel(android.os.HwParcel p0, java.util.ArrayList<android.hardware.gnss.V2_1.IGnssConfiguration.BlacklistedSource> p1) {}
    ...
    public static final class Proxy implements android.hardware.gnss.V2_1.IGnssConfiguration {
        ...
        public boolean setEsExtensionSec(int p0) throws android.os.RemoteException { return false; }
        public boolean setBlacklist_2_1(java.util.ArrayList<android.hardware.gnss.V2_1.IGnssConfiguration.BlacklistedSource> p0) throws android.os.RemoteException { return false; }
