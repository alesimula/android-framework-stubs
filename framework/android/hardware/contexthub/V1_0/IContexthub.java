...
public interface IContexthub extends android.internal.hidl.base.V1_0.IBase {
    ...
    public static android.hardware.contexthub.V1_0.IContexthub asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.contexthub.V1_0.IContexthub castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.contexthub.V1_0.IContexthub getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.contexthub.V1_0.IContexthub getService(boolean p0) throws android.os.RemoteException { return null; }
    public static android.hardware.contexthub.V1_0.IContexthub getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    public static android.hardware.contexthub.V1_0.IContexthub getService() throws android.os.RemoteException { return null; }
    public java.util.ArrayList<android.hardware.contexthub.V1_0.ContextHub> getHubs() throws android.os.RemoteException;
    public int registerCallback(int p0, android.hardware.contexthub.V1_0.IContexthubCallback p1) throws android.os.RemoteException;
    public int sendMessageToHub(int p0, android.hardware.contexthub.V1_0.ContextHubMsg p1) throws android.os.RemoteException;
    public int loadNanoApp(int p0, android.hardware.contexthub.V1_0.NanoAppBinary p1, int p2) throws android.os.RemoteException;
    public int unloadNanoApp(int p0, long p1, int p2) throws android.os.RemoteException;
    public int enableNanoApp(int p0, long p1, int p2) throws android.os.RemoteException;
    public int disableNanoApp(int p0, long p1, int p2) throws android.os.RemoteException;
    public int queryApps(int p0) throws android.os.RemoteException;
