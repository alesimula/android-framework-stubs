...
public interface IContexthubCallback extends android.hardware.contexthub.V1_0.IContexthubCallback {
    ...
    public static android.hardware.contexthub.V1_2.IContexthubCallback asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.contexthub.V1_2.IContexthubCallback castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.contexthub.V1_2.IContexthubCallback getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.contexthub.V1_2.IContexthubCallback getService(boolean p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.contexthub.V1_2.IContexthubCallback getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.contexthub.V1_2.IContexthubCallback getService() throws android.os.RemoteException { return null; }
    public void handleClientMsg_1_2(android.hardware.contexthub.V1_2.ContextHubMsg p0, java.util.ArrayList<java.lang.String> p1) throws android.os.RemoteException;
    public void handleAppsInfo_1_2(java.util.ArrayList<android.hardware.contexthub.V1_2.HubAppInfo> p0) throws android.os.RemoteException;
    ...
    public static final class Proxy implements android.hardware.contexthub.V1_2.IContexthubCallback {
        ...
        public void handleClientMsg(android.hardware.contexthub.V1_0.ContextHubMsg p0) throws android.os.RemoteException {}
        public void handleTxnResult(int p0, int p1) throws android.os.RemoteException {}
        public void handleHubEvent(int p0) throws android.os.RemoteException {}
        public void handleAppAbort(long p0, int p1) throws android.os.RemoteException {}
        public void handleAppsInfo(java.util.ArrayList<android.hardware.contexthub.V1_0.HubAppInfo> p0) throws android.os.RemoteException {}
        public void handleClientMsg_1_2(android.hardware.contexthub.V1_2.ContextHubMsg p0, java.util.ArrayList<java.lang.String> p1) throws android.os.RemoteException {}
        public void handleAppsInfo_1_2(java.util.ArrayList<android.hardware.contexthub.V1_2.HubAppInfo> p0) throws android.os.RemoteException {}
