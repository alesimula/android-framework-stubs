...
public @interface SimpleActionType {
    public static final int ASSIST = 21;
    public static final int BACK = 1;
    public static final int BRIGHTNESS_DOWN = 2;
    public static final int BRIGHTNESS_UP = 3;
    public static final int CALCULATOR = 4;
    public static final int CLOSE_WINDOW = 19;
    ...
    public static final int MEDIA_NEXT = 9;
