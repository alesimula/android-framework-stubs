...
public final class VirtualStylusConfig extends android.hardware.input.VirtualTouchDeviceConfig implements android.os.Parcelable {
    ...
    private VirtualStylusConfig(android.hardware.input.VirtualStylusConfig.Builder p0) { super((android.hardware.input.VirtualTouchDeviceConfig.Builder)null); }
    private VirtualStylusConfig(android.os.Parcel p0) { super((android.hardware.input.VirtualTouchDeviceConfig.Builder)null); }
