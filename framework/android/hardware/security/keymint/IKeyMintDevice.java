...
public interface IKeyMintDevice extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.hardware.security.keymint.IKeyMintDevice {
        ...
        public static boolean setDefaultImpl(android.hardware.security.keymint.IKeyMintDevice p0) { return false; }
        public static android.hardware.security.keymint.IKeyMintDevice getDefaultImpl() { return null; }
