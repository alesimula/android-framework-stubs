...
public class FaceAuthenticateOptions implements android.hardware.biometrics.AuthenticateOptions, android.os.Parcelable {
    ...
    private final int mAuthenticateReason = 0;
    private final int mDisplayState = 0;
    private boolean mIsMandatoryBiometrics;
    private java.lang.String mOpPackageName;
    private int mSensorId;
    private final int mUserId = 0;
    private final int mWakeReason = 0;
    FaceAuthenticateOptions(int p0, int p1, int p2, int p3, int p4, java.lang.String p5, java.lang.String p6, boolean p7) {}
    ...
    private static int defaultWakeReason() { return 0; }
    ...
    public static class Builder {
        ...
        public android.hardware.face.FaceAuthenticateOptions.Builder setIsMandatoryBiometrics(boolean p0) { return null; }
