...
public class FaceManager implements android.hardware.biometrics.BiometricAuthenticator, android.hardware.biometrics.BiometricFaceConstants {
    ...
    private final android.hardware.face.IFaceServiceReceiver mServiceReceiver = null;
    ...
    private void sendFaceDetected(int p0, int p1, boolean p2) {}
    ...
    private void sendAuthenticationFrame(android.hardware.face.FaceAuthenticationFrame p0) {}
    private void sendEnrollmentFrame(android.hardware.face.FaceEnrollFrame p0) {}
    ...
    private class OnAuthenticationCancelListener implements android.os.CancellationSignal.OnCancelListener {
        private final android.hardware.biometrics.CryptoObject mCrypto = null;
    ...
    private class OnFaceDetectionCancelListener implements android.os.CancellationSignal.OnCancelListener {
        private OnFaceDetectionCancelListener(android.hardware.face.FaceManager p0) {}
        public void onCancel() {}
    }
