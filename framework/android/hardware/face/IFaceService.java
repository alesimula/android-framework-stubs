...
public interface IFaceService extends android.os.IInterface {
    ...
    public long authenticate(android.os.IBinder p0, long p1, int p2, android.hardware.face.IFaceServiceReceiver p3, java.lang.String p4, boolean p5) throws android.os.RemoteException;
    public long detectFace(android.os.IBinder p0, int p1, android.hardware.face.IFaceServiceReceiver p2, java.lang.String p3) throws android.os.RemoteException;
    public void prepareForAuthentication(int p0, boolean p1, android.os.IBinder p2, long p3, int p4, android.hardware.biometrics.IBiometricSensorReceiver p5, java.lang.String p6, long p7, int p8, boolean p9) throws android.os.RemoteException;
    ...
    public static class Default implements android.hardware.face.IFaceService {
        ...
        public long authenticate(android.os.IBinder p0, long p1, int p2, android.hardware.face.IFaceServiceReceiver p3, java.lang.String p4, boolean p5) throws android.os.RemoteException { return 0L; }
        public long detectFace(android.os.IBinder p0, int p1, android.hardware.face.IFaceServiceReceiver p2, java.lang.String p3) throws android.os.RemoteException { return 0L; }
        public void prepareForAuthentication(int p0, boolean p1, android.os.IBinder p2, long p3, int p4, android.hardware.biometrics.IBiometricSensorReceiver p5, java.lang.String p6, long p7, int p8, boolean p9) throws android.os.RemoteException {}
        public void startPreparedClient(int p0, int p1) throws android.os.RemoteException {}
        public void cancelAuthentication(android.os.IBinder p0, java.lang.String p1, long p2) throws android.os.RemoteException {}
        public void cancelFaceDetect(android.os.IBinder p0, java.lang.String p1, long p2) throws android.os.RemoteException {}
