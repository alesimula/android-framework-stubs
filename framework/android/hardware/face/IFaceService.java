...
public interface IFaceService extends android.os.IInterface {
    ...
    public long enroll(int p0, android.os.IBinder p1, byte[] p2, android.hardware.face.IFaceServiceReceiver p3, java.lang.String p4, int[] p5, android.view.Surface p6, boolean p7, android.hardware.face.FaceEnrollOptions p8) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.hardware.face.IFaceService {
        ...
        private static final class Proxy implements android.hardware.face.IFaceService {
