...
public interface IContextHubClient extends android.os.IInterface {
    ...
    public void reliableMessageCallbackFinished(int p0, byte p1) throws android.os.RemoteException;
    public int sendMessageToNanoApp(android.hardware.location.NanoAppMessage p0) throws android.os.RemoteException;
    public int sendReliableMessageToNanoApp(android.hardware.location.NanoAppMessage p0, android.hardware.location.IContextHubTransactionCallback p1) throws android.os.RemoteException;
    ...
    public static class Default implements android.hardware.location.IContextHubClient {
        ...
        public int sendReliableMessageToNanoApp(android.hardware.location.NanoAppMessage p0, android.hardware.location.IContextHubTransactionCallback p1) throws android.os.RemoteException { return 0; }
    }
    ...
    public static abstract class Stub extends android.os.Binder implements android.hardware.location.IContextHubClient {
        ...
        private static final class Proxy implements android.hardware.location.IContextHubClient {
