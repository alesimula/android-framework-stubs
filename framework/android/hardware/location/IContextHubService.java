...
public interface IContextHubService extends android.os.IInterface {
    ...
    public android.hardware.location.IContextHubClient createClient(int p0, android.hardware.location.IContextHubClientCallback p1) throws android.os.RemoteException;
    public android.hardware.location.IContextHubClient createPendingIntentClient(int p0, android.app.PendingIntent p1, long p2) throws android.os.RemoteException;
    ...
    public static class Default implements android.hardware.location.IContextHubService {
        ...
        public android.hardware.location.IContextHubClient createClient(int p0, android.hardware.location.IContextHubClientCallback p1) throws android.os.RemoteException { return null; }
        public android.hardware.location.IContextHubClient createPendingIntentClient(int p0, android.app.PendingIntent p1, long p2) throws android.os.RemoteException { return null; }
