...
public interface ICasListener extends android.hardware.cas.V1_0.ICasListener {
    ...
    public static android.hardware.cas.V1_1.ICasListener asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.cas.V1_1.ICasListener castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.cas.V1_1.ICasListener getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.cas.V1_1.ICasListener getService(boolean p0) throws android.os.RemoteException { return null; }
    public static android.hardware.cas.V1_1.ICasListener getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    public static android.hardware.cas.V1_1.ICasListener getService() throws android.os.RemoteException { return null; }
    public void onSessionEvent(java.util.ArrayList<java.lang.Byte> p0, int p1, int p2, java.util.ArrayList<java.lang.Byte> p3) throws android.os.RemoteException;
    ...
    public static final class Proxy implements android.hardware.cas.V1_1.ICasListener {
        ...
        public void onEvent(int p0, int p1, java.util.ArrayList<java.lang.Byte> p2) throws android.os.RemoteException {}
        public void onSessionEvent(java.util.ArrayList<java.lang.Byte> p0, int p1, int p2, java.util.ArrayList<java.lang.Byte> p3) throws android.os.RemoteException {}
