...
public interface ICas extends android.hardware.cas.V1_0.ICas {
    ...
    public static android.hardware.cas.V1_1.ICas asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.cas.V1_1.ICas castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.cas.V1_1.ICas getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.cas.V1_1.ICas getService(boolean p0) throws android.os.RemoteException { return null; }
    public static android.hardware.cas.V1_1.ICas getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    public static android.hardware.cas.V1_1.ICas getService() throws android.os.RemoteException { return null; }
    public int sendSessionEvent(java.util.ArrayList<java.lang.Byte> p0, int p1, int p2, java.util.ArrayList<java.lang.Byte> p3) throws android.os.RemoteException;
