...
public interface IMediaCasService extends android.hardware.cas.V1_0.IMediaCasService {
    ...
    public static android.hardware.cas.V1_1.IMediaCasService asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.cas.V1_1.IMediaCasService castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.cas.V1_1.IMediaCasService getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.cas.V1_1.IMediaCasService getService(boolean p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.cas.V1_1.IMediaCasService getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.cas.V1_1.IMediaCasService getService() throws android.os.RemoteException { return null; }
    public android.hardware.cas.V1_1.ICas createPluginExt(int p0, android.hardware.cas.V1_1.ICasListener p1) throws android.os.RemoteException;
    ...
    public static final class Proxy implements android.hardware.cas.V1_1.IMediaCasService {
        ...
        public android.hardware.cas.V1_1.ICas createPluginExt(int p0, android.hardware.cas.V1_1.ICasListener p1) throws android.os.RemoteException { return null; }
