...
public interface ICas extends android.internal.hidl.base.V1_0.IBase {
    ...
    public static android.hardware.cas.V1_0.ICas asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.cas.V1_0.ICas castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.cas.V1_0.ICas getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.cas.V1_0.ICas getService(boolean p0) throws android.os.RemoteException { return null; }
    public static android.hardware.cas.V1_0.ICas getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    public static android.hardware.cas.V1_0.ICas getService() throws android.os.RemoteException { return null; }
    public int setPrivateData(java.util.ArrayList<java.lang.Byte> p0) throws android.os.RemoteException;
    public void openSession(android.hardware.cas.V1_0.ICas.openSessionCallback p0) throws android.os.RemoteException;
    public int closeSession(java.util.ArrayList<java.lang.Byte> p0) throws android.os.RemoteException;
    public int setSessionPrivateData(java.util.ArrayList<java.lang.Byte> p0, java.util.ArrayList<java.lang.Byte> p1) throws android.os.RemoteException;
    public int processEcm(java.util.ArrayList<java.lang.Byte> p0, java.util.ArrayList<java.lang.Byte> p1) throws android.os.RemoteException;
    public int processEmm(java.util.ArrayList<java.lang.Byte> p0) throws android.os.RemoteException;
    public int sendEvent(int p0, int p1, java.util.ArrayList<java.lang.Byte> p2) throws android.os.RemoteException;
    public int provision(java.lang.String p0) throws android.os.RemoteException;
    public int refreshEntitlements(int p0, java.util.ArrayList<java.lang.Byte> p1) throws android.os.RemoteException;
