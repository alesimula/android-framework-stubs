...
public interface ICameraService extends android.os.IInterface {
    ...
    public android.hardware.ICamera connect(android.hardware.ICameraClient p0, int p1, int p2, android.content.res.CameraCompatibilityInfo p3, boolean p4, android.content.AttributionSourceState p5, int p6) throws android.os.RemoteException;
    public android.hardware.camera2.ICameraDeviceUser connectDevice(android.hardware.camera2.ICameraDeviceCallbacks p0, java.lang.String p1, int p2, int p3, android.content.res.CameraCompatibilityInfo p4, android.content.AttributionSourceState p5, int p6, boolean p7) throws android.os.RemoteException;
    ...
    public android.hardware.camera2.impl.CameraMetadataNative getCameraCharacteristics(java.lang.String p0, int p1, android.content.res.CameraCompatibilityInfo p2, android.content.AttributionSourceState p3, int p4) throws android.os.RemoteException;
    public android.hardware.CameraInfo getCameraInfo(int p0, android.content.res.CameraCompatibilityInfo p1, android.content.AttributionSourceState p2, int p3) throws android.os.RemoteException;
    ...
    public void warmUp(java.lang.String p0, android.content.AttributionSourceState p1, int p2) throws android.os.RemoteException;
    ...
    public static class Default implements android.hardware.ICameraService {
        ...
        public android.hardware.ICamera connect(android.hardware.ICameraClient p0, int p1, int p2, android.content.res.CameraCompatibilityInfo p3, boolean p4, android.content.AttributionSourceState p5, int p6) throws android.os.RemoteException { return null; }
        public android.hardware.camera2.ICameraDeviceUser connectDevice(android.hardware.camera2.ICameraDeviceCallbacks p0, java.lang.String p1, int p2, int p3, android.content.res.CameraCompatibilityInfo p4, android.content.AttributionSourceState p5, int p6, boolean p7) throws android.os.RemoteException { return null; }
        ...
        public android.hardware.camera2.impl.CameraMetadataNative getCameraCharacteristics(java.lang.String p0, int p1, android.content.res.CameraCompatibilityInfo p2, android.content.AttributionSourceState p3, int p4) throws android.os.RemoteException { return null; }
        public android.hardware.CameraInfo getCameraInfo(int p0, android.content.res.CameraCompatibilityInfo p1, android.content.AttributionSourceState p2, int p3) throws android.os.RemoteException { return null; }
    ...
    public static abstract class Stub extends android.os.Binder implements android.hardware.ICameraService {
        ...
        private static final class Proxy implements android.hardware.ICameraService {
