...
public interface ICameraService extends android.os.IInterface {
    ...
    public int getNumberOfCameras(int p0, android.content.AttributionSourceState p1, int p2) throws android.os.RemoteException;
    public android.hardware.CameraInfo getCameraInfo(int p0, int p1, android.content.AttributionSourceState p2, int p3) throws android.os.RemoteException;
    public android.hardware.ICamera connect(android.hardware.ICameraClient p0, int p1, int p2, int p3, boolean p4, android.content.AttributionSourceState p5, int p6) throws android.os.RemoteException;
    public android.hardware.camera2.ICameraDeviceUser connectDevice(android.hardware.camera2.ICameraDeviceCallbacks p0, java.lang.String p1, int p2, int p3, int p4, android.content.AttributionSourceState p5, int p6, boolean p7) throws android.os.RemoteException;
    ...
    public android.hardware.camera2.impl.CameraMetadataNative getCameraCharacteristics(java.lang.String p0, int p1, int p2, android.content.AttributionSourceState p3, int p4) throws android.os.RemoteException;
    ...
    public void setTorchMode(java.lang.String p0, boolean p1, android.os.IBinder p2, android.content.AttributionSourceState p3, int p4) throws android.os.RemoteException;
    public void turnOnTorchWithStrengthLevel(java.lang.String p0, int p1, android.os.IBinder p2, android.content.AttributionSourceState p3, int p4) throws android.os.RemoteException;
    ...
    public android.hardware.camera2.impl.CameraMetadataNative createDefaultRequest(java.lang.String p0, int p1, android.content.AttributionSourceState p2, int p3) throws android.os.RemoteException;
    ...
    public android.hardware.camera2.impl.CameraMetadataNative getSessionCharacteristics(java.lang.String p0, int p1, int p2, android.hardware.camera2.params.SessionConfiguration p3, android.content.AttributionSourceState p4, int p5) throws android.os.RemoteException;

    public static class Default implements android.hardware.ICameraService {
        public Default() {}
        public int getNumberOfCameras(int p0, android.content.AttributionSourceState p1, int p2) throws android.os.RemoteException { return 0; }
        public android.hardware.CameraInfo getCameraInfo(int p0, int p1, android.content.AttributionSourceState p2, int p3) throws android.os.RemoteException { return null; }
        public android.hardware.ICamera connect(android.hardware.ICameraClient p0, int p1, int p2, int p3, boolean p4, android.content.AttributionSourceState p5, int p6) throws android.os.RemoteException { return null; }
        public android.hardware.camera2.ICameraDeviceUser connectDevice(android.hardware.camera2.ICameraDeviceCallbacks p0, java.lang.String p1, int p2, int p3, int p4, android.content.AttributionSourceState p5, int p6, boolean p7) throws android.os.RemoteException { return null; }
        ...
        public void injectSessionParams(java.lang.String p0, android.hardware.camera2.impl.CameraMetadataNative p1) throws android.os.RemoteException {}
        public void removeListener(android.hardware.ICameraServiceListener p0) throws android.os.RemoteException {}
        public android.hardware.camera2.impl.CameraMetadataNative getCameraCharacteristics(java.lang.String p0, int p1, int p2, android.content.AttributionSourceState p3, int p4) throws android.os.RemoteException { return null; }
        ...
        public android.hardware.camera2.impl.CameraMetadataNative createDefaultRequest(java.lang.String p0, int p1, android.content.AttributionSourceState p2, int p3) throws android.os.RemoteException { return null; }
        ...
        public android.hardware.camera2.impl.CameraMetadataNative getSessionCharacteristics(java.lang.String p0, int p1, int p2, android.hardware.camera2.params.SessionConfiguration p3, android.content.AttributionSourceState p4, int p5) throws android.os.RemoteException { return null; }
