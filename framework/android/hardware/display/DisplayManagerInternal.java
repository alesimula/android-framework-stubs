...
public abstract class DisplayManagerInternal {
    ...
    public abstract android.view.SurfaceControl.ScreenshotHardwareBuffer systemScreenshot(int p0);
    public abstract android.view.SurfaceControl.ScreenshotHardwareBuffer userScreenshot(int p0);
    ...
    public abstract void setDisplayProperties(int p0, boolean p1, float p2, int p3, float p4, float p5, boolean p6, boolean p7);
    ...
    public abstract android.hardware.display.DisplayManagerInternal.RefreshRateRange getRefreshRateForDisplayAndSensor(int p0, java.lang.String p1, java.lang.String p2);
    ...
    public static final class RefreshRateLimitation {
        public int type;
        public android.hardware.display.DisplayManagerInternal.RefreshRateRange range;
