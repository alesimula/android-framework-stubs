...
public abstract class DisplayManagerInternal {
    ...
    public abstract android.view.SurfaceControl.ScreenshotGraphicBuffer screenshot(int p0);
    ...
    public abstract void setDisplayProperties(int p0, boolean p1, float p2, int p3, boolean p4);
