...
public interface IDisplayManager extends android.os.IInterface {
    ...
    @android.annotation.EnforcePermission("android.permission.MODIFY_HDR_CONVERSION_MODE")
    ...
    public static abstract class Stub extends android.os.Binder implements android.hardware.display.IDisplayManager {
        ...
        static final int TRANSACTION_setBrightnessByUnit = 37;
        static final int TRANSACTION_getBrightness = 38;
        static final int TRANSACTION_getBrightnessByUnit = 39;
        static final int TRANSACTION_setTemporaryAutoBrightnessAdjustment = 40;
        static final int TRANSACTION_getMinimumBrightnessCurve = 41;
        static final int TRANSACTION_getBrightnessInfo = 42;
        static final int TRANSACTION_getPreferredWideGamutColorSpaceId = 43;
        static final int TRANSACTION_setUserPreferredDisplayMode = 44;
        static final int TRANSACTION_resetUserPreferredDisplayMode = 45;
        static final int TRANSACTION_getUserPreferredDisplayMode = 46;
        static final int TRANSACTION_getSystemPreferredDisplayMode = 47;
        static final int TRANSACTION_setHdrConversionMode = 48;
        static final int TRANSACTION_getHdrConversionModeSetting = 49;
        static final int TRANSACTION_getHdrConversionMode = 50;
        static final int TRANSACTION_getSupportedHdrOutputTypes = 51;
        static final int TRANSACTION_setShouldAlwaysRespectAppRequestedMode = 52;
        static final int TRANSACTION_shouldAlwaysRespectAppRequestedMode = 53;
        static final int TRANSACTION_setRefreshRateSwitchingType = 54;
        static final int TRANSACTION_getRefreshRateSwitchingType = 55;
        static final int TRANSACTION_getDisplayDecorationSupport = 56;
        static final int TRANSACTION_setDisplayIdToMirror = 57;
        static final int TRANSACTION_getOverlaySupport = 58;
        static final int TRANSACTION_enableConnectedDisplay = 59;
        static final int TRANSACTION_disableConnectedDisplay = 60;
        static final int TRANSACTION_requestDisplayPower = 61;
        static final int TRANSACTION_requestDisplayModes = 62;
        static final int TRANSACTION_getHighestHdrSdrRatio = 63;
        static final int TRANSACTION_getDozeBrightnessSensorValueToBrightness = 64;
        static final int TRANSACTION_getDefaultDozeBrightness = 65;
        static final int TRANSACTION_getDisplayTopology = 66;
        static final int TRANSACTION_setDisplayTopology = 67;
        ...
        protected void getDisplayTopology_enforcePermission() throws java.lang.SecurityException {}
