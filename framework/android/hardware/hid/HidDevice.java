...
public final class HidDevice implements java.lang.AutoCloseable {
    private static final int MAX_REPORT_PAYLOAD_SIZE_BYTES = 16384;
    private static final long READER_THREAD_JOIN_TIMEOUT_MS = 2000L;
    ...
    private final java.util.List<android.util.Pair<java.util.concurrent.Executor, android.hardware.hid.HidEventListener>> mEventListeners = null;
    private android.hardware.hid.HidFmqSession mFmqReader;
    ...
    private java.lang.Thread mReaderThread;
    private android.hardware.hid.IHidManager mService;
    private boolean mServiceDied;
    private final android.hardware.hid.HidFmqSessionFactory mSessionFactory = null;
    ...
    public HidDevice(android.content.Context p0, android.hardware.hid.HidDeviceInfo p1, android.hardware.hid.IHidManager p2, android.hardware.hid.HidFmqSessionFactory p3) {}
    private void cleanupAndNotifyStrandedListeners(android.hardware.hid.HidEventListener p0, java.lang.RuntimeException p1) {}
    ...
    private void notifyListenersOfError(java.lang.Exception p0) {}
    private void notifyListenersOfInputReport(android.hardware.hid.Report p0) {}
    ...
    private void teardownFmqSession() {}
    ...
    public int getRegisteredListenerCount() { return 0; }
    ...
    public void registerEventListener(java.util.concurrent.Executor p0, android.hardware.hid.HidEventListener p1) {}
    ...
    public void unregisterEventListener(android.hardware.hid.HidEventListener p0) {}
