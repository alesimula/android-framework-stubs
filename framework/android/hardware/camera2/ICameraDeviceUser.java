...
public interface ICameraDeviceUser extends android.os.IInterface {
    ...
    public int[] endConfigure(int p0, android.hardware.camera2.impl.CameraMetadataNative p1) throws android.os.RemoteException;
    ...
    public int createInputStream(int p0, int p1, int p2) throws android.os.RemoteException;
    ...
    public static class Default implements android.hardware.camera2.ICameraDeviceUser {
        ...
        public void beginConfigure() throws android.os.RemoteException {}
        public int[] endConfigure(int p0, android.hardware.camera2.impl.CameraMetadataNative p1) throws android.os.RemoteException { return null; }
        ...
        public int createInputStream(int p0, int p1, int p2) throws android.os.RemoteException { return 0; }
