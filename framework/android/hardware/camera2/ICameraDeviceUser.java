...
public interface ICameraDeviceUser extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.hardware.camera2.ICameraDeviceUser {
        ...
        static final int TRANSACTION_getCaptureResultMetadataQueue = 22;
        static final int TRANSACTION_setCameraAudioRestriction = 23;
        static final int TRANSACTION_getGlobalAudioRestriction = 24;
        static final int TRANSACTION_switchToOffline = 25;
        static final int TRANSACTION_isPrimaryClient = 26;
        public Stub() { super(); }
