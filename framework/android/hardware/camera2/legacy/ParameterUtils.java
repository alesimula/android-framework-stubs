...
public class ParameterUtils {
    ...
    public static android.hardware.camera2.legacy.ParameterUtils.ZoomData convertToLegacyZoom(android.graphics.Rect p0, android.graphics.Rect p1, java.lang.Float p2, android.util.Size p3, android.hardware.Camera.Parameters p4) { return null; }
    public static android.hardware.camera2.legacy.ParameterUtils.ZoomData convertZoomRatio(android.graphics.Rect p0, float p1, android.util.Size p2, android.hardware.Camera.Parameters p3) { return null; }
    ...
    public static class ZoomData {
        ...
        public final float reportedZoomRatio = 0.0f;
        public ZoomData(int p0, android.graphics.Rect p1, android.graphics.Rect p2, float p3) {}
    }
}
