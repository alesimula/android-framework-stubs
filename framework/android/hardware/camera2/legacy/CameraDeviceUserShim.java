...
public class CameraDeviceUserShim implements android.hardware.camera2.ICameraDeviceUser {
    ...
    public int[] endConfigure(int p0, android.hardware.camera2.impl.CameraMetadataNative p1) { return null; }
    ...
    public void setCameraAudioRestriction(int p0) {}
    public int getGlobalAudioRestriction() { return 0; }
    public android.hardware.camera2.ICameraOfflineSession switchToOffline(android.hardware.camera2.ICameraDeviceCallbacks p0, int[] p1) { return null; }
