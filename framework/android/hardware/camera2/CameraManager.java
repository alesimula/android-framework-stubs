...
public final class CameraManager {
    ...
    private java.util.Map<java.lang.String, android.hardware.camera2.CameraCharacteristics> getPhysicalIdToCharsMap(android.hardware.camera2.CameraCharacteristics p0) throws android.hardware.camera2.CameraAccessException { return null; }
    private android.hardware.camera2.CameraDevice openCameraDeviceUserAsync(java.lang.String p0, android.hardware.camera2.CameraDevice.StateCallback p1, java.util.concurrent.Executor p2, int p3, int p4) throws android.hardware.camera2.CameraAccessException { return null; }
    @android.annotation.RequiresPermission("android.permission.CAMERA")
    ...
    public void openCameraForUid(java.lang.String p0, android.hardware.camera2.CameraDevice.StateCallback p1, java.util.concurrent.Executor p2, int p3, int p4) throws android.hardware.camera2.CameraAccessException {}
