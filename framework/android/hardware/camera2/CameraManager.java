...
public final class CameraManager {
    ...
    @android.annotation.FlaggedApi("com.android.window.flags.camera_compat_for_freeform")
    ...
    public void openCameraForUid(java.lang.String p0, android.hardware.camera2.CameraDevice.StateCallback p1, java.util.concurrent.Executor p2, int p3, int p4, int p5) throws android.hardware.camera2.CameraAccessException {}
    ...
    private static final class CameraManagerGlobal extends android.hardware.ICameraServiceListener.Stub implements android.os.IBinder.DeathRecipient {
        ...
        public boolean isConcurrentSessionConfigurationSupported(java.util.Map<java.lang.String, android.hardware.camera2.params.SessionConfiguration> p0, int p1, int p2, int p3) throws android.hardware.camera2.CameraAccessException { return false; }
        public boolean cameraIdHasConcurrentStreamsLocked(java.lang.String p0, int p1, int p2) { return false; }
        public void setTorchMode(java.lang.String p0, boolean p1, int p2, int p3) throws android.hardware.camera2.CameraAccessException {}
        public void turnOnTorchWithStrengthLevel(java.lang.String p0, int p1, int p2, int p3) throws android.hardware.camera2.CameraAccessException {}
        public int getTorchStrengthLevel(java.lang.String p0, int p1, int p2) throws android.hardware.camera2.CameraAccessException { return 0; }
