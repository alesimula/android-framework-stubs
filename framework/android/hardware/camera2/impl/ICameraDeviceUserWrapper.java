...
public class ICameraDeviceUserWrapper {
    ...
    public int[] endConfigure(int p0, android.hardware.camera2.impl.CameraMetadataNative p1) throws android.hardware.camera2.CameraAccessException { return null; }
    ...
    public int createInputStream(int p0, int p1, int p2) throws android.hardware.camera2.CameraAccessException { return 0; }
