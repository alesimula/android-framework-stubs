...
public final class CameraExtensionSessionImpl extends android.hardware.camera2.CameraExtensionSession {
    ...
    public static android.hardware.camera2.impl.CameraExtensionSessionImpl createCameraExtensionSession(android.hardware.camera2.CameraDevice p0, android.content.Context p1, android.hardware.camera2.params.ExtensionSessionConfiguration p2, int p3) throws android.hardware.camera2.CameraAccessException, android.os.RemoteException { return null; }
    public CameraExtensionSessionImpl(android.hardware.camera2.extension.IImageCaptureExtenderImpl p0, android.hardware.camera2.extension.IPreviewExtenderImpl p1, java.util.List<android.util.Size> p2, long p3, android.hardware.camera2.CameraDevice p4, android.view.Surface p5, android.view.Surface p6, android.hardware.camera2.CameraExtensionSession.StateCallback p7, java.util.concurrent.Executor p8, int p9, java.util.Set<android.hardware.camera2.CaptureRequest.Key> p10, java.util.Set<android.hardware.camera2.CaptureResult.Key> p11) { super(); }
