...
public class CameraMetadataNative implements android.os.Parcelable {
    ...
    private android.hardware.camera2.params.MandatoryStreamCombination[] getMandatoryStreamCombinationsHelper(boolean p0) { return null; }
    ...
    private static synchronized native void nativeWriteToParcel(android.os.Parcel p0, long p1);
    private static synchronized native void nativeReadFromParcel(android.os.Parcel p0, long p1);
    private static synchronized native void nativeSwap(long p0, long p1) throws java.lang.NullPointerException;
    private static synchronized native void nativeClose(long p0);
    private static synchronized native boolean nativeIsEmpty(long p0);
    private static synchronized native int nativeGetEntryCount(long p0);
    private static synchronized native byte[] nativeReadValues(int p0, long p1);
    private static synchronized native void nativeWriteValues(int p0, byte[] p1, long p2);
    private static synchronized native void nativeDump(long p0) throws java.io.IOException;
    private static synchronized native java.util.ArrayList nativeGetAllVendorKeys(long p0, java.lang.Class p1);
    private static synchronized native int nativeGetTagFromKeyLocal(long p0, java.lang.String p1) throws java.lang.IllegalArgumentException;
    private static synchronized native int nativeGetTypeFromTagLocal(long p0, int p1) throws java.lang.IllegalArgumentException;
