...
public class CameraMetadataNative implements android.os.Parcelable {
    ...
    public synchronized void writeToParcel(android.os.Parcel p0, int p1) {}
    ...
    public synchronized void readFromParcel(android.os.Parcel p0) {}
    ...
    public synchronized void swap(android.hardware.camera2.impl.CameraMetadataNative p0) {}
    public synchronized void setVendorId(long p0) {}
    public synchronized int getEntryCount() { return 0; }
    public synchronized boolean isEmpty() { return false; }
    public long getMetadataPtr() { return 0L; }
    public synchronized <K extends java.lang.Object> java.util.ArrayList<K> getAllVendorKeys(java.lang.Class<K> p0) { return null; }
    ...
    public synchronized void writeValues(int p0, byte[] p1) {}
    public synchronized byte[] readValues(int p0) { return null; }
