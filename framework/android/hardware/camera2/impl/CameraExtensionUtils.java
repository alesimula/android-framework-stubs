...
public final class CameraExtensionUtils {
    ...
    public static java.util.HashSet<java.lang.Integer> SUPPORTED_CAPTURE_OUTPUT_FORMATS;
    ...
    public static android.view.Surface getPostviewSurface(android.hardware.camera2.params.OutputConfiguration p0, java.util.HashMap<java.lang.Integer, java.util.List<android.util.Size>> p1, int p2) { return null; }
    ...
    public static java.util.Map<java.lang.String, android.hardware.camera2.impl.CameraMetadataNative> getCharacteristicsMapNative(java.util.Map<java.lang.String, android.hardware.camera2.CameraCharacteristics> p0) { return null; }
