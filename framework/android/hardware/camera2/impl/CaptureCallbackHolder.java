...
public class CaptureCallbackHolder {
    ...
    private final android.hardware.camera2.impl.CaptureCallback mCallback = null;
    ...
    CaptureCallbackHolder(android.hardware.camera2.impl.CaptureCallback p0, java.util.List<android.hardware.camera2.CaptureRequest> p1, java.util.concurrent.Executor p2, boolean p3, int p4) {}
    public boolean isRepeating() { return false; }
    public android.hardware.camera2.impl.CaptureCallback getCallback() { return null; }
