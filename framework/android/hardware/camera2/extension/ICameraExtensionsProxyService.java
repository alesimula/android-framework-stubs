...
public interface ICameraExtensionsProxyService extends android.os.IInterface {
    ...
    public long registerClient() throws android.os.RemoteException;
    public void unregisterClient(long p0) throws android.os.RemoteException;
    ...
    public static class Default implements android.hardware.camera2.extension.ICameraExtensionsProxyService {
        public Default() {}
        public long registerClient() throws android.os.RemoteException { return 0L; }
        public void unregisterClient(long p0) throws android.os.RemoteException {}
    ...
    public static abstract class Stub extends android.os.Binder implements android.hardware.camera2.extension.ICameraExtensionsProxyService {
        ...
        public static boolean setDefaultImpl(android.hardware.camera2.extension.ICameraExtensionsProxyService p0) { return false; }
        public static android.hardware.camera2.extension.ICameraExtensionsProxyService getDefaultImpl() { return null; }

        private static class Proxy implements android.hardware.camera2.extension.ICameraExtensionsProxyService {
            private android.os.IBinder mRemote;
            public static android.hardware.camera2.extension.ICameraExtensionsProxyService sDefaultImpl;
