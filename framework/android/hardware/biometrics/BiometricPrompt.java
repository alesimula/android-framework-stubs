...
public class BiometricPrompt implements android.hardware.biometrics.BiometricAuthenticator, android.hardware.biometrics.BiometricConstants {
    ...
    private BiometricPrompt(android.content.Context p0, android.hardware.biometrics.PromptInfo p1, android.hardware.biometrics.BiometricPrompt.ButtonInfo p2) {}
    ...
    @android.annotation.RequiresPermission("android.permission.USE_BIOMETRIC_INTERNAL")
    public void authenticateUserForOperation(android.os.CancellationSignal p0, java.util.concurrent.Executor p1, android.hardware.biometrics.BiometricPrompt.AuthenticationCallback p2, int p3, long p4) {}
    ...
    private void authenticateInternal(long p0, android.os.CancellationSignal p1, java.util.concurrent.Executor p2, android.hardware.biometrics.BiometricPrompt.AuthenticationCallback p3, int p4) {}
    ...
    public static class Builder {
        private android.hardware.biometrics.PromptInfo mPromptInfo;
