...
public interface IBiometricServiceReceiverInternal extends android.os.IInterface {
    public void onAuthenticationSucceeded(boolean p0, byte[] p1) throws android.os.RemoteException;
    public void onAuthenticationFailed(int p0, boolean p1) throws android.os.RemoteException;
    public void onError(int p0, int p1, java.lang.String p2) throws android.os.RemoteException;
