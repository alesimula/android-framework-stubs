...
public interface IInvalidationCallback extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.hardware.biometrics.IInvalidationCallback {
        ...
        public Stub() { super(); }
        public static android.hardware.biometrics.IInvalidationCallback asInterface(android.os.IBinder p0) { return null; }
        public android.os.IBinder asBinder() { return null; }
        public static java.lang.String getDefaultTransactionName(int p0) { return null; }
        public java.lang.String getTransactionName(int p0) { return null; }
        public boolean onTransact(int p0, android.os.Parcel p1, android.os.Parcel p2, int p3) throws android.os.RemoteException { return false; }
        public static boolean setDefaultImpl(android.hardware.biometrics.IInvalidationCallback p0) { return false; }
        public static android.hardware.biometrics.IInvalidationCallback getDefaultImpl() { return null; }

        private static class Proxy implements android.hardware.biometrics.IInvalidationCallback {
            private android.os.IBinder mRemote;
            public static android.hardware.biometrics.IInvalidationCallback sDefaultImpl;
