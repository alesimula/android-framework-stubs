...
public interface IAuthService extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.hardware.biometrics.IAuthService {
        ...
        static final int TRANSACTION_getAuthenticatorIds = 19;
        static final int TRANSACTION_getBiometricSensorStrengths = 12;
        static final int TRANSACTION_getButtonLabel = 22;
        static final int TRANSACTION_getEnrollmentStatusList = 11;
        static final int TRANSACTION_getLastAuthenticationTime = 9;
        static final int TRANSACTION_getPromptMessage = 23;
        static final int TRANSACTION_getSensorProperties = 4;
        static final int TRANSACTION_getSettingName = 24;
        static final int TRANSACTION_getUiPackage = 5;
        static final int TRANSACTION_hasEnrolledBiometrics = 10;
        static final int TRANSACTION_invalidateAuthenticatorIds = 18;
        static final int TRANSACTION_registerAuthenticationStateListener = 14;
        static final int TRANSACTION_registerEnabledOnKeyguardCallback = 13;
        static final int TRANSACTION_registerIdentityCheckStateListener = 16;
        static final int TRANSACTION_resetLockout = 21;
        static final int TRANSACTION_resetLockoutTimeBound = 20;
        static final int TRANSACTION_setIdentityCheckTestStatus = 2;
        static final int TRANSACTION_setLastAuthenticationTimeForTest = 3;
        static final int TRANSACTION_unregisterAuthenticationStateListener = 15;
        static final int TRANSACTION_unregisterIdentityCheckStateListener = 17;
