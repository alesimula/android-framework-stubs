...
public interface IUdfpsHbmListener extends android.os.IInterface {
    ...
    public void onHbmEnabled(int p0, int p1) throws android.os.RemoteException;
    public void onHbmDisabled(int p0, int p1) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.hardware.fingerprint.IUdfpsHbmListener {
        ...
        public static boolean setDefaultImpl(android.hardware.fingerprint.IUdfpsHbmListener p0) { return false; }
        public static android.hardware.fingerprint.IUdfpsHbmListener getDefaultImpl() { return null; }

        private static class Proxy implements android.hardware.fingerprint.IUdfpsHbmListener {
            private android.os.IBinder mRemote;
            public static android.hardware.fingerprint.IUdfpsHbmListener sDefaultImpl;
