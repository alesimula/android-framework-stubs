...
public interface IFingerprintService extends android.os.IInterface {
    ...
    public void prepareForAuthentication(android.os.IBinder p0, long p1, android.hardware.biometrics.IBiometricSensorReceiver p2, android.hardware.fingerprint.FingerprintAuthenticateOptions p3, long p4, int p5, boolean p6) throws android.os.RemoteException;
    @android.annotation.EnforcePermission("android.permission.MANAGE_BIOMETRIC")
    ...
    @android.annotation.EnforcePermission("android.permission.USE_BIOMETRIC_INTERNAL")
    public void setUdfpsOverlay(android.hardware.fingerprint.IUdfpsOverlay p0) throws android.os.RemoteException;
    @android.annotation.EnforcePermission("android.permission.USE_BIOMETRIC_INTERNAL")
    ...
    public static abstract class Stub extends android.os.Binder implements android.hardware.fingerprint.IFingerprintService {
        ...
        protected void onUiReady_enforcePermission() throws java.lang.SecurityException {}
        ...
        protected void setUdfpsOverlay_enforcePermission() throws java.lang.SecurityException {}
