...
public class Camera {
    ...
    Camera() {}
    Camera(int p0, android.content.Context p1, android.content.res.CameraCompatibilityInfo p2) {}
    private final native void _addCallbackBuffer(byte[] p0, int p1);
    private final native boolean _enableShutterSound(boolean p0);
    private static native void _getCameraInfo(int p0, android.content.res.CameraCompatibilityInfo p1, android.os.Parcel p2, int p3, android.hardware.Camera.CameraInfo p4);
    private static native int _getNumberOfCameras(android.os.Parcel p0, int p1);
    ...
    private int cameraInit(int p0, android.content.Context p1, android.content.res.CameraCompatibilityInfo p2) { return 0; }
    ...
    private static int getDevicePolicyFromContext(android.content.Context p0) { return 0; }
    ...
    private native int native_setup(java.lang.Object p0, int p1, android.content.res.CameraCompatibilityInfo p2, boolean p3, android.os.Parcel p4, int p5);
    ...
    public static android.hardware.Camera open(int p0, android.content.Context p1, android.content.res.CameraCompatibilityInfo p2) { return null; }
