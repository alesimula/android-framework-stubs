...
public class Camera {
    ...
    @android.annotation.SuppressLint("UnflaggedApi")
    public static void getCameraInfo(int p0, android.content.Context p1, int p2, android.hardware.Camera.CameraInfo p3) {}
    public static android.hardware.Camera open(int p0) { return null; }
    @android.annotation.SuppressLint("UnflaggedApi")
    public static android.hardware.Camera open(int p0, android.content.Context p1, int p2) { return null; }
    ...
    Camera(int p0, android.content.Context p1, int p2) {}
