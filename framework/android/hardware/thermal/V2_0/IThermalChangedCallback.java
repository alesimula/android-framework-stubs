...
public interface IThermalChangedCallback extends android.internal.hidl.base.V1_0.IBase {
    ...
    public static android.hardware.thermal.V2_0.IThermalChangedCallback asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.thermal.V2_0.IThermalChangedCallback castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.thermal.V2_0.IThermalChangedCallback getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.thermal.V2_0.IThermalChangedCallback getService(boolean p0) throws android.os.RemoteException { return null; }
    public static android.hardware.thermal.V2_0.IThermalChangedCallback getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    public static android.hardware.thermal.V2_0.IThermalChangedCallback getService() throws android.os.RemoteException { return null; }
    public void notifyThrottling(android.hardware.thermal.V2_0.Temperature p0) throws android.os.RemoteException;
