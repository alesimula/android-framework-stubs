...
class ConversionUtil {
    ...
    public static android.hardware.soundtrigger.SoundTrigger.RecognitionEvent aidl2apiRecognitionEvent(int p0, int p1, android.media.soundtrigger.RecognitionEvent p2) { return null; }
    public static android.hardware.soundtrigger.SoundTrigger.RecognitionEvent aidl2apiPhraseRecognitionEvent(int p0, int p1, android.media.soundtrigger.PhraseRecognitionEvent p2) { return null; }
