...
public interface IVibrator extends android.internal.hidl.base.V1_0.IBase {
    ...
    public static android.hardware.vibrator.V1_0.IVibrator asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.vibrator.V1_0.IVibrator castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.vibrator.V1_0.IVibrator getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.vibrator.V1_0.IVibrator getService(boolean p0) throws android.os.RemoteException { return null; }
    public static android.hardware.vibrator.V1_0.IVibrator getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    public static android.hardware.vibrator.V1_0.IVibrator getService() throws android.os.RemoteException { return null; }
    public int on(int p0) throws android.os.RemoteException;
    ...
    public int setAmplitude(byte p0) throws android.os.RemoteException;
