...
public interface IVibrator extends android.hardware.vibrator.V1_2.IVibrator {
    ...
    public static android.hardware.vibrator.V1_3.IVibrator asInterface(android.os.IHwBinder p0) { return null; }
    public static android.hardware.vibrator.V1_3.IVibrator castFrom(android.os.IHwInterface p0) { return null; }
    public android.os.IHwBinder asBinder();
    public static android.hardware.vibrator.V1_3.IVibrator getService(java.lang.String p0, boolean p1) throws android.os.RemoteException { return null; }
    public static android.hardware.vibrator.V1_3.IVibrator getService(boolean p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.vibrator.V1_3.IVibrator getService(java.lang.String p0) throws android.os.RemoteException { return null; }
    @java.lang.Deprecated
    public static android.hardware.vibrator.V1_3.IVibrator getService() throws android.os.RemoteException { return null; }
    public boolean supportsExternalControl() throws android.os.RemoteException;
    public int setExternalControl(boolean p0) throws android.os.RemoteException;
    public void perform_1_3(int p0, byte p1, android.hardware.vibrator.V1_3.IVibrator.perform_1_3Callback p2) throws android.os.RemoteException;
    ...
    public static final class Proxy implements android.hardware.vibrator.V1_3.IVibrator {
        ...
        public boolean supportsExternalControl() throws android.os.RemoteException { return false; }
        public int setExternalControl(boolean p0) throws android.os.RemoteException { return 0; }
        public void perform_1_3(int p0, byte p1, android.hardware.vibrator.V1_3.IVibrator.perform_1_3Callback p2) throws android.os.RemoteException {}
