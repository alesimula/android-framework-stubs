...
public class TranslatingCursor extends android.database.CrossProcessCursorWrapper {
    private final android.database.TranslatingCursor.Config mConfig = null;
    private final android.database.TranslatingCursor.Translator mTranslator = null;
    private final boolean mDropLast = false;
    private final int mAuxiliaryColumnIndex = 0;
    private final android.util.ArraySet<java.lang.Integer> mTranslateColumnIndices = null;
