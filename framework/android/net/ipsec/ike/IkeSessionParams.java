...
public final class IkeSessionParams {
    ...
    @android.annotation.FlaggedApi("com.android.ipsec.flags.dpd_disable_api")
    public static final int IKE_DPD_DELAY_SEC_DISABLED = 2147483647;
    ...
    @android.annotation.FlaggedApi("com.android.ipsec.flags.enabled_ike_options_api")
    @android.annotation.NonNull
    public java.util.Set<java.lang.Integer> getIkeOptions() { return null; }
    @android.annotation.NonNull
    ...
    @android.annotation.NonNull
    public int[] getLivenessRetransmissionTimeoutsMillis() { return null; }
    @android.annotation.NonNull
    ...
    public static final class Builder {
        ...
        @android.annotation.FlaggedApi("com.android.ipsec.flags.liveness_check_api")
        @android.annotation.NonNull
        public android.net.ipsec.ike.IkeSessionParams.Builder setLivenessRetransmissionTimeoutsMillis(int[] p0) { return null; }
        @android.annotation.NonNull
