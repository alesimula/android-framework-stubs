...
public class NetworkPolicyManager {
    ...
    private final java.util.Map<android.net.NetworkPolicyManager.SubscriptionCallback, android.net.NetworkPolicyManager.SubscriptionCallbackProxy> mSubscriptionCallbackMap = null;
    private final java.util.Map<android.net.NetworkPolicyManager.NetworkPolicyCallback, android.net.NetworkPolicyManager.NetworkPolicyCallbackProxy> mNetworkPolicyCallbackMap = null;
    ...
    private static void dispatchOnUidBlockedReasonChanged(java.util.concurrent.Executor p0, android.net.NetworkPolicyManager.NetworkPolicyCallback p1, int p2, int p3) {}
    ...
    public static class NetworkPolicyCallbackProxy extends android.net.NetworkPolicyManager.Listener {
        ...
        private final android.net.NetworkPolicyManager.NetworkPolicyCallback mCallback = null;
    ...
    public static final class UidState {
        ...
        public UidState(int p0, int p1, int p2) {}
