...
public class EthernetManager {
    ...
    private final java.util.ArrayList<android.net.EthernetManager.ListenerInfo> mListeners = null;
    ...
    public void addListener(android.net.EthernetManager.Listener p0, java.util.concurrent.Executor p1) {}
    ...
    @android.annotation.RequiresPermission(anyOf={"android.permission.NETWORK_STACK", "android.permission.MAINLINE_NETWORK_STACK"})
    ...
    private static class ListenerInfo {
        ...
        public final android.net.EthernetManager.Listener listener = null;
        private ListenerInfo(java.util.concurrent.Executor p0, android.net.EthernetManager.Listener p1) {}
    }
