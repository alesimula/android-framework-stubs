...
public class VpnService extends android.app.Service {
    ...
    private static void check(java.net.InetAddress p0, int p1) {}
    private static void checkNonPrefixBytes(java.net.InetAddress p0, int p1) {}
    private static android.net.IVpnManager getService() { return null; }
    ...
    public class Builder {
        ...
        private final com.android.internal.net.VpnConfig mConfig = null;
        private final java.util.List<android.net.RouteInfo> mRoutes = null;
        public Builder(android.net.VpnService p0) {}
        private android.net.VpnService.Builder addRoute(android.net.IpPrefix p0, int p1) { return null; }
        private int findRouteIndexByDestination(android.net.RouteInfo p0) { return 0; }
        private void verifyApp(java.lang.String p0) throws android.content.pm.PackageManager.NameNotFoundException {}
    ...
    private class Callback extends android.os.Binder {
        private Callback(android.net.VpnService p0) { super(); }
