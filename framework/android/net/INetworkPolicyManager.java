...
public interface INetworkPolicyManager extends android.os.IInterface {
    ...
    public void onTetheringChanged(java.lang.String p0, boolean p1) throws android.os.RemoteException;
    ...
    @android.annotation.UnsupportedAppUsage
    public android.net.NetworkQuotaInfo getNetworkQuotaInfo(android.net.NetworkState p0) throws android.os.RemoteException;
    ...
    public void setSubscriptionOverride(int p0, int p1, int p2, long p3, java.lang.String p4) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.net.INetworkPolicyManager {
        ...
        private static class Proxy implements android.net.INetworkPolicyManager {
            ...
            public void setDeviceIdleMode(boolean p0) throws android.os.RemoteException {}
            public void setWifiMeteredOverride(java.lang.String p0, int p1) throws android.os.RemoteException {}
            public android.net.NetworkQuotaInfo getNetworkQuotaInfo(android.net.NetworkState p0) throws android.os.RemoteException { return null; }
