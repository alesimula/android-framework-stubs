...
public class ConnectivityManager {
    ...
    private final android.net.TetheringManager mTetheringManager = null;
    ...
    private final android.util.ArrayMap<android.net.ConnectivityManager.OnTetheringEventCallback, android.net.TetheringManager.TetheringEventCallback> mTetheringEventCallbacks = null;
    @android.annotation.SystemApi
    @java.lang.Deprecated
    ...
    public android.net.Network registerNetworkAgent(android.os.Messenger p0, android.net.NetworkInfo p1, android.net.LinkProperties p2, android.net.NetworkCapabilities p3, int p4, android.net.NetworkAgentConfig p5) { return null; }
    public android.net.Network registerNetworkAgent(android.os.Messenger p0, android.net.NetworkInfo p1, android.net.LinkProperties p2, android.net.NetworkCapabilities p3, int p4, android.net.NetworkAgentConfig p5, int p6) { return null; }
