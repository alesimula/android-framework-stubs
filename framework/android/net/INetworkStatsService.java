...
public interface INetworkStatsService extends android.os.IInterface {
    ...
    public void notifyNetworkStatus(android.net.Network[] p0, android.net.NetworkStateSnapshot[] p1, java.lang.String p2, android.net.UnderlyingNetworkInfo[] p3) throws android.os.RemoteException;
    ...
    public android.net.netstats.provider.INetworkStatsProviderCallback registerNetworkStatsProvider(java.lang.String p0, android.net.netstats.provider.INetworkStatsProvider p1) throws android.os.RemoteException;
    ...
    public static class Default implements android.net.INetworkStatsService {
        ...
        public android.net.netstats.provider.INetworkStatsProviderCallback registerNetworkStatsProvider(java.lang.String p0, android.net.netstats.provider.INetworkStatsProvider p1) throws android.os.RemoteException { return null; }
        public android.os.IBinder asBinder() { return null; }
    }

    public static abstract class Stub extends android.os.Binder implements android.net.INetworkStatsService {
        public static final java.lang.String DESCRIPTOR = "android.net.INetworkStatsService";
