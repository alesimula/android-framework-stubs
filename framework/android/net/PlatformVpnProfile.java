...
public abstract class PlatformVpnProfile {
    ...
    protected final boolean mExcludeLocalRoutes = false;
    protected final boolean mRequiresInternetValidation = false;
    PlatformVpnProfile(int p0, boolean p1, boolean p2) {}
    public final int getType() { return 0; }
    public final boolean areLocalRoutesExcluded() { return false; }
    public final boolean isInternetValidationRequired() { return false; }
