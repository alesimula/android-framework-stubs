...
public final class NetworkStats implements java.lang.Iterable<android.net.NetworkStats.Entry>, android.os.Parcelable {
    ...
    @android.annotation.FlaggedApi("com.android.net.flags.netstats_add_entries")
    @android.annotation.NonNull
    public android.net.NetworkStats addEntries(java.util.List<android.net.NetworkStats.Entry> p0) { return null; }
    @android.annotation.NonNull
