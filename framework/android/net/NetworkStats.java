...
public final class NetworkStats implements android.os.Parcelable {
    ...
    public void migrateTun(int p0, java.lang.String p1, java.util.List<java.lang.String> p2) {}
    private void tunAdjustmentInit(int p0, java.lang.String p1, java.util.List<java.lang.String> p2, android.net.NetworkStats.Entry p3, android.net.NetworkStats.Entry[] p4, android.net.NetworkStats.Entry p5) {}
    private android.net.NetworkStats.Entry[] addTrafficToApplications(int p0, java.lang.String p1, java.util.List<java.lang.String> p2, android.net.NetworkStats.Entry p3, android.net.NetworkStats.Entry[] p4, android.net.NetworkStats.Entry p5) { return null; }
    private void deductTrafficFromVpnApp(int p0, java.util.List<java.lang.String> p1, android.net.NetworkStats.Entry[] p2) {}
