...
public final class DnsResolver {
    ...
    private static class DnsAddressAnswer extends com.android.net.module.util.DnsPacket {
        private static final java.lang.String TAG = "DnsResolver.DnsAddressAnswer";
        private static final boolean DBG = false;
        private final int mQueryType = 0;
        DnsAddressAnswer(byte[] p0) throws com.android.net.module.util.DnsPacket.ParseException { super(null); }
