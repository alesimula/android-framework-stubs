...
public final class VpnProfileState implements android.os.Parcelable {
    ...
    private final boolean mLockdown = false;
    private final java.lang.String mSessionKey = null;
    private final int mState = 0;
    public VpnProfileState(int p0, java.lang.String p1, boolean p2, boolean p3) {}
    private VpnProfileState(android.os.Parcel p0) {}
    private java.lang.String convertStateToString(int p0) { return null; }
