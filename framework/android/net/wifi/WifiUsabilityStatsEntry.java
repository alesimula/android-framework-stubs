...
public final class WifiUsabilityStatsEntry implements android.os.Parcelable {
    ...
    @android.annotation.NonNull
    public android.net.wifi.WifiUsabilityStatsEntry.ContentionTimeStats getContentionTimeStats(int p0, int p1) { return null; }
    @android.annotation.Nullable
    public int[] getLinkIds() { return null; }
    public int getLinkSpeedMbps() { return 0; }
    public int getLinkState(int p0) { return 0; }
    ...
    public long getRadioId(int p0) { return 0L; }
    @android.annotation.NonNull
    public java.util.List<android.net.wifi.WifiUsabilityStatsEntry.RateStats> getRateStats() { return null; }
    @android.annotation.NonNull
    public java.util.List<android.net.wifi.WifiUsabilityStatsEntry.RateStats> getRateStats(int p0) { return null; }
    public int getRssi() { return 0; }
    public int getRssi(int p0) { return 0; }
    public int getRxLinkSpeedMbps() { return 0; }
    public int getRxLinkSpeedMbps(int p0) { return 0; }
    public int getTimeSliceDutyCycleInPercent() { return 0; }
    public int getTimeSliceDutyCycleInPercent(int p0) { return 0; }
    ...
    public long getTotalBeaconRx(int p0) { return 0L; }
    ...
    public long getTotalCcaBusyFreqTimeMillis(int p0) { return 0L; }
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public long getTotalRadioOnFreqTimeMillis(int p0) { return 0L; }
    ...
    public long getTotalRxSuccess(int p0) { return 0L; }
    public long getTotalScanTimeMillis() { return 0L; }
    public long getTotalTxBad() { return 0L; }
    public long getTotalTxBad(int p0) { return 0L; }
    public long getTotalTxRetries() { return 0L; }
    public long getTotalTxRetries(int p0) { return 0L; }
    public long getTotalTxSuccess() { return 0L; }
    public long getTotalTxSuccess(int p0) { return 0L; }
    public int getTxLinkSpeedMbps(int p0) { return 0; }
    @android.annotation.NonNull
