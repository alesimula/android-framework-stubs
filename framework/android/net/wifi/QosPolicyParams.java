...
public final class QosPolicyParams implements android.os.Parcelable {
    ...
    @android.annotation.Nullable
    public android.net.wifi.QosCharacteristics getQosCharacteristics() { return null; }
    @android.annotation.Nullable
    ...
    public static final class Builder {
        ...
        @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
        @android.annotation.NonNull
        public android.net.wifi.QosPolicyParams.Builder setQosCharacteristics(android.net.wifi.QosCharacteristics p0) { return null; }
        @android.annotation.NonNull
