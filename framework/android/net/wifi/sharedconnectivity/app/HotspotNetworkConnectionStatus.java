...
public final class HotspotNetworkConnectionStatus implements android.os.Parcelable {
    ...
    private final android.net.wifi.sharedconnectivity.app.HotspotNetwork mHotspotNetwork = null;
    private final int mStatus = 0;
    private HotspotNetworkConnectionStatus(int p0, android.net.wifi.sharedconnectivity.app.HotspotNetwork p1, android.os.Bundle p2) {}
