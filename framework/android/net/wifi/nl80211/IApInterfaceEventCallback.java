...
public interface IApInterfaceEventCallback extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.net.wifi.nl80211.IApInterfaceEventCallback {
        private static final java.lang.String DESCRIPTOR = "android.net.wifi.nl80211.IApInterfaceEventCallback";
        ...
        public static boolean setDefaultImpl(android.net.wifi.nl80211.IApInterfaceEventCallback p0) { return false; }
        public static android.net.wifi.nl80211.IApInterfaceEventCallback getDefaultImpl() { return null; }

        private static class Proxy implements android.net.wifi.nl80211.IApInterfaceEventCallback {
            private android.os.IBinder mRemote;
            public static android.net.wifi.nl80211.IApInterfaceEventCallback sDefaultImpl;
