...
public interface IScanEvent extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.net.wifi.nl80211.IScanEvent {
        private static final java.lang.String DESCRIPTOR = "android.net.wifi.nl80211.IScanEvent";
        ...
        public static boolean setDefaultImpl(android.net.wifi.nl80211.IScanEvent p0) { return false; }
        public static android.net.wifi.nl80211.IScanEvent getDefaultImpl() { return null; }

        private static class Proxy implements android.net.wifi.nl80211.IScanEvent {
            private android.os.IBinder mRemote;
            public static android.net.wifi.nl80211.IScanEvent sDefaultImpl;
