...
public interface IWifiScannerImpl extends android.os.IInterface {
    ...
    public int scanRequest(android.net.wifi.nl80211.SingleScanSettings p0) throws android.os.RemoteException;
    ...
    public static class Default implements android.net.wifi.nl80211.IWifiScannerImpl {
        ...
        public int scanRequest(android.net.wifi.nl80211.SingleScanSettings p0) throws android.os.RemoteException { return 0; }
    ...
    public static abstract class Stub extends android.os.Binder implements android.net.wifi.nl80211.IWifiScannerImpl {
        ...
        private static final class Proxy implements android.net.wifi.nl80211.IWifiScannerImpl {
