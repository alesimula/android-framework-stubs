...
public class WifiManager {
    ...
    public static final java.lang.String CHANNEL_DATA_KEY_FREQUENCY_MHZ = "CHANNEL_DATA_KEY_FREQUENCY_MHZ";
    public static final java.lang.String CHANNEL_DATA_KEY_NUM_AP = "CHANNEL_DATA_KEY_NUM_AP";
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.local_only_connection_optimization")
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public static final java.lang.String TWT_CAPABILITIES_KEY_BOOLEAN_TWT_REQUESTER = "key_requester";
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public static final java.lang.String TWT_CAPABILITIES_KEY_INT_MAX_WAKE_DURATION_MICROS = "key_max_wake_duration";
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public static final java.lang.String TWT_CAPABILITIES_KEY_INT_MIN_WAKE_DURATION_MICROS = "key_min_wake_duration";
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public static final java.lang.String TWT_CAPABILITIES_KEY_LONG_MAX_WAKE_INTERVAL_MICROS = "key_max_wake_interval";
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public static final java.lang.String TWT_CAPABILITIES_KEY_LONG_MIN_WAKE_INTERVAL_MICROS = "key_min_wake_interval";
    ...
    public void addLocalOnlyConnectionFailureListener(java.util.concurrent.Executor p0, android.net.wifi.WifiManager.LocalOnlyConnectionFailureListener p1) {}
    @java.lang.Deprecated
    ...
    public void addQosPolicies(java.util.List<android.net.wifi.QosPolicyParams> p0, java.util.concurrent.Executor p1, java.util.function.Consumer<java.util.List<java.lang.Integer>> p2) {}
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void addWifiLowLatencyLockListener(java.util.concurrent.Executor p0, android.net.wifi.WifiManager.WifiLowLatencyLockListener p1) {}
    public void addWifiNetworkStateChangedListener(java.util.concurrent.Executor p0, android.net.wifi.WifiManager.WifiNetworkStateChangedListener p1) {}
    @android.annotation.FlaggedApi("com.android.wifi.flags.wifi_state_changed_listener")
    public void addWifiStateChangedListener(java.util.concurrent.Executor p0, android.net.wifi.WifiManager.WifiStateChangedListener p1) {}
    ...
    public void disallowCurrentSuggestedNetwork(android.net.wifi.BlockingOption p0) {}
    @java.lang.Deprecated
    public boolean disconnect() { return false; }
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void enableMscs(android.net.wifi.MscsParams p0) {}
    @java.lang.Deprecated
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.autojoin_restriction_security_types_api")
    public void getAutojoinDisallowedSecurityTypes(java.util.concurrent.Executor p0, java.util.function.Consumer<int[]> p1) {}
    @android.annotation.FlaggedApi("android.security.aapm_api")
    @android.annotation.NonNull
    public java.util.List<android.security.advancedprotection.AdvancedProtectionFeature> getAvailableAdvancedProtectionFeatures() { return null; }
    @android.annotation.FlaggedApi("com.android.wifi.flags.get_bssid_blocklist_api")
    public void getBssidBlocklist(java.util.List<android.net.wifi.WifiSsid> p0, java.util.concurrent.Executor p1, java.util.function.Consumer<java.util.List<android.net.MacAddress>> p2) {}
    @android.annotation.NonNull
    public java.util.List<android.net.wifi.WifiConfiguration> getCallerConfiguredNetworks() { return null; }
    public void getChannelData(java.util.concurrent.Executor p0, java.util.function.Consumer<java.util.List<android.os.Bundle>> p1) {}
    @java.lang.Deprecated
    ...
    public void getLinkLayerStatsPollingInterval(java.util.concurrent.Executor p0, java.util.function.Consumer<java.lang.Integer> p1) {}
    @android.annotation.NonNull
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void getMaxMloAssociationLinkCount(java.util.concurrent.Executor p0, java.util.function.Consumer<java.lang.Integer> p1) {}
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void getMaxMloStrLinkCount(java.util.concurrent.Executor p0, java.util.function.Consumer<java.lang.Integer> p1) {}
    public int getMaxNumberOfChannelsPerNetworkSpecifierRequest() { return 0; }
    public int getMaxNumberOfNetworkSuggestionsPerApp() { return 0; }
    public static int getMaxNumberOfPoliciesPerQosRequest() { return 0; }
    public int getMaxSignalLevel() { return 0; }
    public void getMaxSupportedConcurrentTdlsSessions(java.util.concurrent.Executor p0, java.util.function.Consumer<java.lang.Integer> p1) {}
    public void getMloMode(java.util.concurrent.Executor p0, java.util.function.Consumer<java.lang.Integer> p1) {}
    public void getNetworkSelectionConfig(java.util.concurrent.Executor p0, java.util.function.Consumer<android.net.wifi.WifiNetworkSelectionConfig> p1) {}
    @android.annotation.NonNull
    public java.util.List<android.net.wifi.WifiNetworkSuggestion> getNetworkSuggestions() { return null; }
    public void getNumberOfEnabledTdlsSessions(java.util.concurrent.Executor p0, java.util.function.Consumer<java.lang.Integer> p1) {}
    @android.annotation.NonNull
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void getPerSsidRoamingModes(java.util.concurrent.Executor p0, java.util.function.Consumer<java.util.Map<java.lang.String, java.lang.Integer>> p1) {}
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void getSupportedSimultaneousBandCombinations(java.util.concurrent.Executor p0, java.util.function.Consumer<java.util.List<int[]>> p1) {}
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void getTwtCapabilities(java.util.concurrent.Executor p0, java.util.function.Consumer<android.os.Bundle> p1) {}
    @android.annotation.NonNull
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public boolean isAggressiveRoamingModeSupported() { return false; }
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public boolean isD2dSupportedWhenInfraStaDisabled() { return false; }
    ...
    public boolean isDualBandSimultaneousSupported() { return false; }
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public boolean isLowLatencyModeSupported() { return false; }
    ...
    public void isTdlsOperationCurrentlyAvailable(java.util.concurrent.Executor p0, java.util.function.Consumer<java.lang.Boolean> p1) {}
    public boolean isTdlsSupported() { return false; }
    public boolean isThirdPartyAppEnablingWifiConfirmationDialogEnabled() { return false; }
    public boolean isTidToLinkMappingNegotiationSupported() { return false; }
    public boolean isTlsMinimumVersionSupported() { return false; }
    public boolean isTlsV13Supported() { return false; }
    public boolean isTrustOnFirstUseSupported() { return false; }
    @android.annotation.FlaggedApi("android.net.wifi.flags.usd")
    public boolean isUsdPublisherSupported() { return false; }
    @android.annotation.FlaggedApi("android.net.wifi.flags.usd")
    public boolean isUsdSubscriberSupported() { return false; }
    public boolean isVerboseLoggingEnabled() { return false; }
    public boolean isWapiSupported() { return false; }
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public boolean isWepSupported() { return false; }
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public boolean isWpaPersonalSupported() { return false; }
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void queryD2dAllowedWhenInfraStaDisabled(java.util.concurrent.Executor p0, java.util.function.Consumer<java.lang.Boolean> p1) {}
    @android.annotation.Nullable
    public void queryLastConfiguredTetheredApPassphraseSinceBoot(java.util.concurrent.Executor p0, java.util.function.Consumer<java.lang.String> p1) {}
    @android.annotation.FlaggedApi("com.android.wifi.flags.get_config_empty_reason")
    public void queryPrivilegedConfiguredNetworks(java.util.concurrent.Executor p0, android.os.OutcomeReceiver<java.util.List<android.net.wifi.WifiConfiguration>, java.lang.Error> p1) {}
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void querySendDhcpHostnameRestriction(java.util.concurrent.Executor p0, java.util.function.IntConsumer p1) {}
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void queryWepAllowed(java.util.concurrent.Executor p0, java.util.function.Consumer<java.lang.Boolean> p1) {}
    @java.lang.Deprecated
    ...
    public void removeLocalOnlyConnectionFailureListener(android.net.wifi.WifiManager.LocalOnlyConnectionFailureListener p0) {}
    @java.lang.Deprecated
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void removePerSsidRoamingMode(android.net.wifi.WifiSsid p0) {}
    public void removeQosPolicies(int[] p0) {}
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void removeWifiLowLatencyLockListener(android.net.wifi.WifiManager.WifiLowLatencyLockListener p0) {}
    public void removeWifiNetworkStateChangedListener(android.net.wifi.WifiManager.WifiNetworkStateChangedListener p0) {}
    @android.annotation.FlaggedApi("com.android.wifi.flags.wifi_state_changed_listener")
    public void removeWifiStateChangedListener(android.net.wifi.WifiManager.WifiStateChangedListener p0) {}
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void restoreWifiBackupData(byte[] p0) {}
    @android.annotation.NonNull
    public byte[] retrieveBackupData() { return null; }
    @android.annotation.NonNull
    public byte[] retrieveSoftApBackupData() { return null; }
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void retrieveWifiBackupData(java.util.concurrent.Executor p0, java.util.function.Consumer<byte[]> p1) {}
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.autojoin_restriction_security_types_api")
    public void setAutojoinDisallowedSecurityTypes(int[] p0) {}
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void setD2dAllowedWhenInfraStaDisabled(boolean p0) {}
    ...
    public void setLinkLayerStatsPollingInterval(int p0) {}
    public void setMacRandomizationSettingPasspointEnabled(java.lang.String p0, boolean p1) {}
    public void setMloMode(int p0, java.util.concurrent.Executor p1, java.util.function.Consumer<java.lang.Boolean> p2) {}
    public void setNetworkSelectionConfig(android.net.wifi.WifiNetworkSelectionConfig p0) {}
    public void setOneShotScreenOnConnectivityScanDelayMillis(int p0) {}
    public void setOverrideCountryCode(java.lang.String p0) {}
    public void setPasspointMeteredOverride(java.lang.String p0, int p1) {}
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void setPerSsidRoamingMode(android.net.wifi.WifiSsid p0, int p1) {}
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void setPnoScanState(int p0) {}
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void setSendDhcpHostnameRestriction(int p0) {}
    ...
    public void setTdlsEnabled(java.net.InetAddress p0, boolean p1, java.util.concurrent.Executor p2, java.util.function.Consumer<java.lang.Boolean> p3) {}
    public void setTdlsEnabledWithMacAddress(java.lang.String p0, boolean p1) {}
    public void setTdlsEnabledWithMacAddress(java.lang.String p0, boolean p1, java.util.concurrent.Executor p2, java.util.function.Consumer<java.lang.Boolean> p3) {}
    public void setThirdPartyAppEnablingWifiConfirmationDialogEnabled(boolean p0) {}
    public void setVerboseLoggingEnabled(boolean p0) {}
    public void setVerboseLoggingLevel(int p0) {}
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void setWepAllowed(boolean p0) {}
    @java.lang.Deprecated
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void setupTwtSession(android.net.wifi.twt.TwtRequest p0, java.util.concurrent.Executor p1, android.net.wifi.twt.TwtSessionCallback p2) {}
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.public_bands_for_lohs")
    public void startLocalOnlyHotspotWithConfiguration(android.net.wifi.SoftApConfiguration p0, java.util.concurrent.Executor p1, android.net.wifi.WifiManager.LocalOnlyHotspotCallback p2) {}
    ...
    @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
    public void startTetheredHotspot(android.net.TetheringManager.TetheringRequest p0, java.util.concurrent.Executor p1, android.net.wifi.WifiManager.SoftApCallback p2) {}
    @java.lang.Deprecated
    ...
    public boolean validateSoftApConfiguration(android.net.wifi.SoftApConfiguration p0) { return false; }
    ...
    public class MulticastLock {
        MulticastLock(android.net.wifi.WifiManager p0) {}
        public void acquire() {}
    ...
    public static interface SoftApCallback {
        ...
        default public void onClientsDisconnected(android.net.wifi.SoftApInfo p0, java.util.List<android.net.wifi.WifiClient> p1) {}
        ...
        @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
        default public void onStateChanged(android.net.wifi.SoftApState p0) {}
    ...
    public static interface WifiConnectedNetworkScorer {
        default public void onNetworkSwitchAccepted(int p0, int p1, java.lang.String p2) {}
        default public void onNetworkSwitchRejected(int p0, int p1, java.lang.String p2) {}
    ...
    public class WifiLock {
        WifiLock(android.net.wifi.WifiManager p0) {}
        public void acquire() {}
        public boolean isHeld() { return false; }
        public void release() {}
        public void setReferenceCounted(boolean p0) {}
    ...
    public static interface WifiLowLatencyLockListener {
        @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
        public void onActivatedStateChanged(boolean p0);
        @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
        default public void onActiveUsersChanged(int[] p0) {}
        @android.annotation.FlaggedApi("com.android.wifi.flags.android_v_wifi_api")
        default public void onOwnershipChanged(int[] p0) {}
    }
    ...
    public static interface WifiNetworkStateChangedListener {
        ...
        public void onWifiNetworkStateChanged(int p0, int p1);
    }
