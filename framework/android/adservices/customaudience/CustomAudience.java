...
public final class CustomAudience implements android.os.Parcelable {
    ...
    @android.annotation.FlaggedApi("com.android.adservices.flags.fledge_custom_audience_auction_server_request_flags_enabled")
    ...
    @android.annotation.NonNull
    public java.util.List<android.adservices.common.ComponentAdData> getComponentAds() { return null; }
    @android.annotation.NonNull
    ...
    public static final class Builder {
        ...
        @android.annotation.FlaggedApi("com.android.adservices.flags.fledge_enable_custom_audience_component_ads")
        @android.annotation.NonNull
        public android.adservices.customaudience.CustomAudience.Builder setComponentAds(java.util.List<android.adservices.common.ComponentAdData> p0) { return null; }
        @android.annotation.NonNull
