...
public abstract class BatteryConsumer {
    ...
    private static final android.util.IntArray SUPPORTED_POWER_COMPONENTS_PER_PROCESS_STATE = null;
    ...
    private static final java.lang.String[] sPowerStateNames = null;
    private static final java.lang.String[] sProcessStateNames = null;
    private static final java.lang.String[] sScreenStateNames = null;
    ...
    static android.os.BatteryConsumer.BatteryConsumerDataLayout createBatteryConsumerDataLayout(java.lang.String[] p0, boolean p1, boolean p2, boolean p3) { return null; }
    public static java.lang.String powerComponentIdToString(int p0) { return null; }
    public static int powerModelToProtoEnum(int p0) { return 0; }
    public static java.lang.String powerStateToString(int p0) { return null; }
    public static java.lang.String processStateToString(int p0) { return null; }
    public static java.lang.String screenStateToString(int p0) { return null; }
    ...
    public int[] getPowerComponentIds() { return null; }
    ...
    protected static abstract class BaseBuilder<T extends android.os.BatteryConsumer.BaseBuilder<?>> {
        ...
        public BaseBuilder(android.os.BatteryConsumer.BatteryConsumerData p0, int p1, double p2) {}
        public T addConsumedPower(int p0, double p1) { return null; }
        public T addConsumedPower(int p0, double p1, int p2) { return null; }
        public T addConsumedPower(android.os.BatteryConsumer.Key p0, double p1) { return null; }
        public T addUsageDurationMillis(int p0, long p1) { return null; }
        public T addUsageDurationMillis(android.os.BatteryConsumer.Key p0, long p1) { return null; }
        public android.os.BatteryConsumer.Key getKey(int p0, int p1) { return null; }
        public android.os.BatteryConsumer.Key getKey(int p0, int p1, int p2, int p3) { return null; }
        public android.os.BatteryConsumer.Key[] getKeys(int p0) { return null; }
    ...
    static class BatteryConsumerDataLayout {
        ...
        public final android.util.SparseArray<android.os.BatteryConsumer.Key> indexedKeys = null;
        public final android.os.BatteryConsumer.Key[] keys = null;
        private android.util.SparseArray<android.os.BatteryConsumer.Key[]> mPerComponentKeys;
        public final int[] powerComponentIds = null;
        public final boolean powerStateDataIncluded = false;
        public final boolean processStateDataIncluded = false;
        public final boolean screenStateDataIncluded = false;
        public final int totalConsumedPowerColumnIndex = 0;
        private BatteryConsumerDataLayout(int p0, java.lang.String[] p1, boolean p2, boolean p3, boolean p4) {}
        private int addKeys(java.util.List<android.os.BatteryConsumer.Key> p0, boolean p1, int p2, int p3, int p4, int p5) { return 0; }
        private int keyIndex(int p0, int p1, int p2, int p3) { return 0; }
        android.os.BatteryConsumer.Key getKey(int p0, int p1, int p2, int p3) { return null; }
        android.os.BatteryConsumer.Key getKeyOrThrow(int p0, int p1, int p2, int p3) { return null; }
        public android.os.BatteryConsumer.Key[] getKeys(int p0) { return null; }
        public java.lang.String getPowerComponentName(int p0) { return null; }
    }
    ...
    public static final class Key {
        ...
        public final int processState = 0;
        public final int screenState = 0;
        private Key(int p0, int p1, int p2, int p3, int p4, int p5) {}
        public static java.lang.String toString(int p0, int p1, int p2, int p3) { return null; }
