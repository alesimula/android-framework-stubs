...
public class Binder implements android.os.IBinder {
    ...
    public static final int getCallingPid$ravenwood() { return 0; }
    public static final native int getCallingUid();
    public static final int getCallingUid$ravenwood() { return 0; }
    public static final native boolean isDirectlyHandlingTransactionNative();
    public static final boolean isDirectlyHandlingTransactionNative$ravenwood() { return false; }
    ...
    public static final long clearCallingIdentity$ravenwood() { return 0L; }
    public static final native void restoreCallingIdentity(long p0);
    public static final void restoreCallingIdentity$ravenwood(long p0) {}
    ...
    private static class IdentitySupplier implements java.util.function.Supplier<com.android.internal.os.SomeArgs> {
        public com.android.internal.os.SomeArgs get() { return null; }
    }
