...
public abstract class VibrationEffectSegment implements android.os.Parcelable {
    ...
    VibrationEffectSegment(long p0) {}
    ...
    public abstract <T extends android.os.vibrator.VibrationEffectSegment> T applyAdaptiveScale(float p0);
    public abstract <T extends android.os.vibrator.VibrationEffectSegment> T applyEffectStrength(int p0);
    public abstract <T extends android.os.vibrator.VibrationEffectSegment> T applyStartTime(long p0);
