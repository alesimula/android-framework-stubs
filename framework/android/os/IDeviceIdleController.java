...
public interface IDeviceIdleController extends android.os.IInterface {
    ...
    public void addPowerSaveTempWhitelistApp(java.lang.String p0, long p1, int p2, java.lang.String p3) throws android.os.RemoteException;
    public long addPowerSaveTempWhitelistAppForMms(java.lang.String p0, int p1, java.lang.String p2) throws android.os.RemoteException;
    public long addPowerSaveTempWhitelistAppForSms(java.lang.String p0, int p1, java.lang.String p2) throws android.os.RemoteException;
    public void exitIdle(java.lang.String p0) throws android.os.RemoteException;
    public boolean registerMaintenanceActivityListener(android.os.IMaintenanceActivityListener p0) throws android.os.RemoteException;
    public void unregisterMaintenanceActivityListener(android.os.IMaintenanceActivityListener p0) throws android.os.RemoteException;
    public int setPreIdleTimeoutMode(int p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.os.IDeviceIdleController {
        ...
        public static boolean setDefaultImpl(android.os.IDeviceIdleController p0) { return false; }
        public static android.os.IDeviceIdleController getDefaultImpl() { return null; }
        ...
        private static class Proxy implements android.os.IDeviceIdleController {
            ...
            public void addPowerSaveTempWhitelistApp(java.lang.String p0, long p1, int p2, java.lang.String p3) throws android.os.RemoteException {}
            public long addPowerSaveTempWhitelistAppForMms(java.lang.String p0, int p1, java.lang.String p2) throws android.os.RemoteException { return 0L; }
            public long addPowerSaveTempWhitelistAppForSms(java.lang.String p0, int p1, java.lang.String p2) throws android.os.RemoteException { return 0L; }
            public void exitIdle(java.lang.String p0) throws android.os.RemoteException {}
            public boolean registerMaintenanceActivityListener(android.os.IMaintenanceActivityListener p0) throws android.os.RemoteException { return false; }
            public void unregisterMaintenanceActivityListener(android.os.IMaintenanceActivityListener p0) throws android.os.RemoteException {}
            public int setPreIdleTimeoutMode(int p0) throws android.os.RemoteException { return 0; }
            public void resetPreIdleTimeoutMode() throws android.os.RemoteException {}
        }
    }
