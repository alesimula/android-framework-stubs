...
public final class Parcel {
    ...
    private static final android.os.Parcel[] sOwnedPool = null;
    private static final android.os.Parcel[] sHolderPool = null;
    ...
    private static native long nativeSetDataSize(long p0, int p1);
    ...
    private static native void nativeWriteInt(long p0, int p1);
    private static native void nativeWriteLong(long p0, long p1);
    private static native void nativeWriteFloat(long p0, float p1);
    private static native void nativeWriteDouble(long p0, double p1);
    static native void nativeWriteString(long p0, java.lang.String p1);
    private static native void nativeWriteStrongBinder(long p0, android.os.IBinder p1);
    private static native long nativeWriteFileDescriptor(long p0, java.io.FileDescriptor p1);
    ...
    static native java.lang.String nativeReadString(long p0);
    ...
    private static native long nativeFreeBuffer(long p0);
    private static native void nativeDestroy(long p0);
    private static native byte[] nativeMarshall(long p0);
    private static native long nativeUnmarshall(long p0, byte[] p1, int p2, int p3);
    private static native int nativeCompareData(long p0, long p1);
    private static native long nativeAppendFrom(long p0, long p1, int p2, int p3);
    ...
    private void updateNativeSize(long p0) {}
