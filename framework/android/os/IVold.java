...
public interface IVold extends android.os.IInterface {
    ...
    public void setMaxLockElapsedTime(int p0) throws android.os.RemoteException;
    ...
    public void syncStorage() throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.os.IVold {
        ...
        static final int TRANSACTION_abortChanges = 57;
        ...
        static final int TRANSACTION_commitChanges = 58;
        ...
        static final int TRANSACTION_destroySandboxForApp = 52;
        static final int TRANSACTION_destroyStubVolume = 70;
        static final int TRANSACTION_destroyUserStorage = 50;
        ...
        static final int TRANSACTION_getStorageRemainingLifetime = 79;
        static final int TRANSACTION_getStorageSize = 78;
        static final int TRANSACTION_getUnlockedUsers = 46;
        static final int TRANSACTION_getWriteAmount = 35;
        static final int TRANSACTION_getWriteBoosterBufferAvailablePercent = 81;
        static final int TRANSACTION_getWriteBoosterBufferSize = 80;
        static final int TRANSACTION_getWriteBoosterLifeTimeEstimate = 84;
        static final int TRANSACTION_incFsEnabled = 72;
        static final int TRANSACTION_initUser0 = 39;
        static final int TRANSACTION_isCheckpointing = 56;
        static final int TRANSACTION_lockCeStorage = 48;
        ...
        static final int TRANSACTION_mountAppFuse = 36;
        ...
        static final int TRANSACTION_needsCheckpoint = 54;
        static final int TRANSACTION_needsRollback = 55;
        ...
        static final int TRANSACTION_prepareSandboxForApp = 51;
        static final int TRANSACTION_prepareUserStorage = 49;
        static final int TRANSACTION_refreshLatestWrite = 34;
        ...
        static final int TRANSACTION_setMaxLockElapsedTime = 33;
        static final int TRANSACTION_setStorageBindingSeed = 42;
        static final int TRANSACTION_setWriteBoosterBufferFlush = 82;
        static final int TRANSACTION_setWriteBoosterBufferOn = 83;
        static final int TRANSACTION_setupAppDir = 23;
        static final int TRANSACTION_shutdown = 5;
        static final int TRANSACTION_startCheckpoint = 53;
        ...
        static final int TRANSACTION_syncStorage = 59;
        static final int TRANSACTION_unlockCeStorage = 47;
        static final int TRANSACTION_unmount = 16;
        static final int TRANSACTION_unmountAppFuse = 37;
        ...
        private static final class Proxy implements android.os.IVold {
