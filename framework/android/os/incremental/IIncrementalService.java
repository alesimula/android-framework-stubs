...
public interface IIncrementalService extends android.os.IInterface {
    ...
    public int makeFile(int p0, java.lang.String p1, int p2, android.os.incremental.IncrementalNewFileParams p3, byte[] p4) throws android.os.RemoteException;
    ...
    public static class Default implements android.os.incremental.IIncrementalService {
        ...
        public int makeFile(int p0, java.lang.String p1, int p2, android.os.incremental.IncrementalNewFileParams p3, byte[] p4) throws android.os.RemoteException { return 0; }
    ...
    public static abstract class Stub extends android.os.Binder implements android.os.incremental.IIncrementalService {
        ...
        private static final class Proxy implements android.os.incremental.IIncrementalService {
