...
public interface IDumpstate extends android.os.IInterface {
    ...
    public android.os.IDumpstateToken setListener(java.lang.String p0, android.os.IDumpstateListener p1, boolean p2) throws android.os.RemoteException;
    public void startBugreport(int p0, java.lang.String p1, java.io.FileDescriptor p2, java.io.FileDescriptor p3, int p4, android.os.IDumpstateListener p5) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.os.IDumpstate {
        ...
        private static class Proxy implements android.os.IDumpstate {
            ...
            public android.os.IDumpstateToken setListener(java.lang.String p0, android.os.IDumpstateListener p1, boolean p2) throws android.os.RemoteException { return null; }
            public void startBugreport(int p0, java.lang.String p1, java.io.FileDescriptor p2, java.io.FileDescriptor p3, int p4, android.os.IDumpstateListener p5) throws android.os.RemoteException {}
            public void cancelBugreport() throws android.os.RemoteException {}
        }
    }
