...
public interface IDumpstate extends android.os.IInterface {
    ...
    public void startBugreport(int p0, java.lang.String p1, java.io.FileDescriptor p2, java.io.FileDescriptor p3, int p4, int p5, android.os.IDumpstateListener p6, boolean p7) throws android.os.RemoteException;
    public void cancelBugreport(int p0, java.lang.String p1) throws android.os.RemoteException;
    public void retrieveBugreport(int p0, java.lang.String p1, java.io.FileDescriptor p2, java.lang.String p3, android.os.IDumpstateListener p4) throws android.os.RemoteException;
