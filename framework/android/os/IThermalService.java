...
public interface IThermalService extends android.os.IInterface {
    ...
    public java.util.List<android.os.Temperature> getCurrentTemperaturesWithType(int p0) throws android.os.RemoteException;
    ...
    public java.util.List<android.os.CoolingDevice> getCurrentCoolingDevicesWithType(int p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.os.IThermalService {
        ...
        public static boolean setDefaultImpl(android.os.IThermalService p0) { return false; }
        public static android.os.IThermalService getDefaultImpl() { return null; }
        ...
        private static class Proxy implements android.os.IThermalService {
            ...
            public java.util.List<android.os.Temperature> getCurrentTemperatures() throws android.os.RemoteException { return null; }
            public java.util.List<android.os.Temperature> getCurrentTemperaturesWithType(int p0) throws android.os.RemoteException { return null; }
            ...
            public java.util.List<android.os.CoolingDevice> getCurrentCoolingDevices() throws android.os.RemoteException { return null; }
            public java.util.List<android.os.CoolingDevice> getCurrentCoolingDevicesWithType(int p0) throws android.os.RemoteException { return null; }
        }
    }
