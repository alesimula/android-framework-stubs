...
public abstract class CombinedVibration implements android.os.Parcelable {
    ...
    public static final class Sequential extends android.os.CombinedVibration {
        private final java.util.List<android.os.CombinedVibration> mEffects = null;
        private final java.util.List<java.lang.Integer> mDelays = null;
    ...
    public static final class SequentialCombination {
        private final java.util.ArrayList<android.os.CombinedVibration> mEffects = null;
        private final java.util.ArrayList<java.lang.Integer> mDelays = null;
