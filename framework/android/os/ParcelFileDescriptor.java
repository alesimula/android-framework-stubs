...
public class ParcelFileDescriptor implements android.os.Parcelable, java.io.Closeable {
    ...
    private final android.os.ParcelFileDescriptor mWrapped = null;
    ...
    public static android.os.ParcelFileDescriptor fromPfd(android.os.ParcelFileDescriptor p0, android.os.Handler p1, android.os.ParcelFileDescriptor.OnCloseListener p2) throws java.io.IOException { return null; }
    ...
    private static java.io.FileDescriptor openInternal(java.io.File p0, int p1) throws java.io.FileNotFoundException { return null; }
    ...
    private static java.io.FileDescriptor[] createCommSocketPair() throws java.io.IOException { return null; }
    @java.lang.Deprecated
    @android.annotation.UnsupportedAppUsage
    ...
    private void closeWithStatus(int p0, java.lang.String p1) {}
    public void releaseResources() {}
    private byte[] getOrCreateStatusBuffer() { return null; }
    private void writeCommStatusAndClose(int p0, java.lang.String p1) {}
    private static android.os.ParcelFileDescriptor.Status readCommStatus(java.io.FileDescriptor p0, byte[] p1) { return null; }
    ...
    private static boolean isAtLeastQ() { return false; }
    private static int ifAtLeastQ(int p0) { return 0; }
