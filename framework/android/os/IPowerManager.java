...
public interface IPowerManager extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.os.IPowerManager {
        ...
        static final int TRANSACTION_getFullPowerSavePolicy = 23;
        static final int TRANSACTION_setFullPowerSavePolicy = 24;
        static final int TRANSACTION_setDynamicPowerSaveHint = 25;
        static final int TRANSACTION_setAdaptivePowerSavePolicy = 26;
        static final int TRANSACTION_setAdaptivePowerSaveEnabled = 27;
        static final int TRANSACTION_getPowerSaveModeTrigger = 28;
        static final int TRANSACTION_setBatteryDischargePrediction = 29;
        static final int TRANSACTION_getBatteryDischargePrediction = 30;
        static final int TRANSACTION_isBatteryDischargePredictionPersonalized = 31;
        static final int TRANSACTION_isDeviceIdleMode = 32;
        static final int TRANSACTION_isLightDeviceIdleMode = 33;
        static final int TRANSACTION_isLowPowerStandbySupported = 34;
        static final int TRANSACTION_isLowPowerStandbyEnabled = 35;
        static final int TRANSACTION_setLowPowerStandbyEnabled = 36;
        static final int TRANSACTION_setLowPowerStandbyActiveDuringMaintenance = 37;
        static final int TRANSACTION_forceLowPowerStandbyActive = 38;
        static final int TRANSACTION_setLowPowerStandbyPolicy = 39;
        static final int TRANSACTION_getLowPowerStandbyPolicy = 40;
        static final int TRANSACTION_isExemptFromLowPowerStandby = 41;
        static final int TRANSACTION_isReasonAllowedInLowPowerStandby = 42;
        static final int TRANSACTION_isFeatureAllowedInLowPowerStandby = 43;
        static final int TRANSACTION_acquireLowPowerStandbyPorts = 44;
        static final int TRANSACTION_releaseLowPowerStandbyPorts = 45;
        static final int TRANSACTION_getActiveLowPowerStandbyPorts = 46;
        static final int TRANSACTION_reboot = 47;
        static final int TRANSACTION_rebootSafeMode = 48;
        static final int TRANSACTION_shutdown = 49;
        static final int TRANSACTION_crash = 50;
        static final int TRANSACTION_getLastShutdownReason = 51;
        static final int TRANSACTION_getLastSleepReason = 52;
        static final int TRANSACTION_setStayOnSetting = 53;
        static final int TRANSACTION_boostScreenBrightness = 54;
        static final int TRANSACTION_acquireWakeLockAsync = 55;
        static final int TRANSACTION_releaseWakeLockAsync = 56;
        static final int TRANSACTION_updateWakeLockUidsAsync = 57;
        static final int TRANSACTION_isScreenBrightnessBoosted = 58;
        static final int TRANSACTION_setAttentionLight = 59;
        static final int TRANSACTION_setDozeAfterScreenOff = 60;
        static final int TRANSACTION_isAmbientDisplayAvailable = 61;
        static final int TRANSACTION_suppressAmbientDisplay = 62;
        static final int TRANSACTION_isAmbientDisplaySuppressedForToken = 63;
        static final int TRANSACTION_isAmbientDisplaySuppressed = 64;
        static final int TRANSACTION_isAmbientDisplaySuppressedForTokenByApp = 65;
        static final int TRANSACTION_forceSuspend = 66;
        public Stub() { super(); }
