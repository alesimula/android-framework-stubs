...
public class Process {
    ...
    public static final boolean is64Bit$ravenwood() { return false; }
    public static void init$ravenwood(int p0, int p1) {}
    public static void reset$ravenwood() {}
    public static final int myPid() { return 0; }
    public static final int myPid$ravenwood() { return 0; }
    public static final int myPpid() { return 0; }
    public static final int myTid() { return 0; }
    public static final int myTid$ravenwood() { return 0; }
    public static final int myUid() { return 0; }
    public static final int myUid$ravenwood() { return 0; }
    ...
    @android.annotation.FlaggedApi("com.android.sdksandbox.flags.sdk_sandbox_uid_to_app_uid_api")
    ...
    public static final void setThreadPriority$ravenwood(int p0, int p1) {}
    public static final native void setCanSelfBackground(boolean p0);
    public static final void setCanSelfBackground$ravenwood(boolean p0) {}
    ...
    public static final void setThreadPriority$ravenwood(int p0) {}
    public static final native int getThreadPriority(int p0) throws java.lang.IllegalArgumentException;
    public static final int getThreadPriority$ravenwood(int p0) { return 0; }
