...
public class Process {
    ...
    public static final android.os.NativeZygoteProcess NATIVE_ZYGOTE_PROCESS = null;
    ...
    public static final int ZYGOTE_POLICY_FLAG_NATIVE_PROCESS = 8;
    ...
    public static final native int createProcessGroup(int p0, int p1, int p2);
    public static final native void freezeCgroupUid(int p0, boolean p1);
    public static final long getAdvertisedMem() { return 0L; }
    public static final int getAppUidForPrivateComputeCoreUid(int p0) { return 0; }
    public static final int getAppUidForSdkSandboxUid(int p0) { return 0; }
    ...
    public static final int getPrivateComputeCoreUidForAppUid(int p0) { return 0; }
    ...
    public static final native long[] getSchedAffinity(int p0);
    public static final int getSdkSandboxUidForAppUid(int p0) { return 0; }
    ...
    public static final boolean isIsolatedUid(int p0) { return false; }
    public static final boolean isPrivateComputeCoreUid(int p0) { return false; }
    public static final native boolean isProcessFrozen(int p0, int p1) throws java.lang.IllegalArgumentException;
    public static final boolean isSdkSandbox() { return false; }
    public static final boolean isSdkSandboxUid(int p0) { return false; }
    public static final boolean isThreadInProcess(int p0, int p1) { return false; }
    public static final void killProcess(int p0) {}
    public static final native boolean killProcessGroup(int p0, int p1);
    ...
    public static java.lang.String myProcessName() { return null; }
    public static java.lang.String myProcessName$ravenwood() { return null; }
    ...
    private static native void sendSignalThrows(int p0, int p1) throws java.lang.IllegalArgumentException, java.lang.SecurityException, java.util.NoSuchElementException;
    public static final native boolean sendSignalToProcessGroup(int p0, int p1, int p2);
    private static native void sendTgSignalThrows(int p0, int p1, int p2) throws java.lang.IllegalArgumentException, java.lang.SecurityException, java.util.NoSuchElementException;
    public static void setArgV0(java.lang.String p0) {}
    private static native void setArgV0Native(java.lang.String p0);
    @java.lang.Deprecated
    public static final void setCanSelfBackground(boolean p0) {}
    ...
    public static final void setThreadPriority(int p0) throws java.lang.IllegalArgumentException, java.lang.SecurityException {}
    public static final void setThreadPriority(int p0, int p1) throws java.lang.IllegalArgumentException, java.lang.SecurityException {}
    ...
    @android.annotation.SystemApi(client=android.annotation.SystemApi.Client.MODULE_LIBRARIES)
    public static final int toSdkSandboxUid(int p0) { return 0; }
