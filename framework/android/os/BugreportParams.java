...
public final class BugreportParams {
    ...
    @android.annotation.FlaggedApi("android.app.admin.flags.onboarding_bugreport_v2_enabled")
    ...
    @android.annotation.FlaggedApi("android.os.bugreport_multi_display_screenshot_enabled")
