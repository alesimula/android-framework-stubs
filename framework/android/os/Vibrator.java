...
public abstract class Vibrator {
    ...
    private void loadVibrationConfig(android.content.Context p0) {}
    private int loadDefaultIntensity(android.content.Context p0, int p1) { return 0; }
    private float loadFloat(android.content.Context p0, int p1, float p2) { return 0.0f; }
    ...
    public android.util.Range<java.lang.Float> getRelativeFrequencyRange() { return null; }
    public float getMaximumAmplitude(float p0) { return 0.0f; }
    ...
    @android.annotation.RequiresPermission("android.permission.VIBRATE")
    public final void vibrate(int p0, java.lang.String p1, android.os.VibrationEffect p2, java.lang.String p3, android.media.AudioAttributes p4) {}
    @android.annotation.RequiresPermission("android.permission.VIBRATE")
