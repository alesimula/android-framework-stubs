...
public interface IUserManager extends android.os.IInterface {
    ...
    public boolean canAddPrivateProfile(int p0) throws android.os.RemoteException;
    ...
    public static class Default implements android.os.IUserManager {
        ...
        public boolean canAddPrivateProfile(int p0) throws android.os.RemoteException { return false; }
    ...
    public static abstract class Stub extends android.os.Binder implements android.os.IUserManager {
        ...
        static final int TRANSACTION_getPreviousUserToEnterForeground = 20;
        ...
        static final int TRANSACTION_getCurrentAllowedNumberOfUsers = 25;
        static final int TRANSACTION_canAddMoreUsersOfType = 26;
        static final int TRANSACTION_getRemainingCreatableUserCount = 27;
        static final int TRANSACTION_getRemainingCreatableProfileCount = 28;
        static final int TRANSACTION_canAddMoreProfilesToUser = 29;
