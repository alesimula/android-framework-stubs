...
public interface ISystemConfig extends android.os.IInterface {
    ...
    public java.util.List<android.content.pm.SignedPackage> getEnhancedConfirmationTrustedInstallers() throws android.os.RemoteException;
    ...
    public static class Default implements android.os.ISystemConfig {
        ...
        public java.util.List<android.content.pm.SignedPackage> getEnhancedConfirmationTrustedInstallers() throws android.os.RemoteException { return null; }
    ...
    public static abstract class Stub extends android.os.Binder implements android.os.ISystemConfig {
        ...
        static final int TRANSACTION_getEnhancedConfirmationTrustedInstallers = 10;
        ...
        private static final class Proxy implements android.os.ISystemConfig {
