...
public class VolumeInfo implements android.os.Parcelable {
    ...
    private boolean isVisibleForRead() { return false; }
    private boolean isVisibleForWrite() { return false; }
    private boolean isVolumeSupportedForUser(int p0) { return false; }
