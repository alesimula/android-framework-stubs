...
public interface IStorageManager extends android.os.IInterface {
    ...
    public void addUserKeyAuth(int p0, int p1, byte[] p2) throws android.os.RemoteException;
    ...
    public void clearUserKeyAuth(int p0, int p1, byte[] p2) throws android.os.RemoteException;
