...
public interface IStorageManager extends android.os.IInterface {
    ...
    @android.annotation.EnforcePermission("android.permission.STORAGE_INTERNAL")
    public void unlockUserKey(int p0, int p1, byte[] p2) throws android.os.RemoteException;
    @android.annotation.EnforcePermission("android.permission.STORAGE_INTERNAL")
    ...
    @android.annotation.EnforcePermission("android.permission.STORAGE_INTERNAL")
    public void setUserKeyProtection(int p0, byte[] p1) throws android.os.RemoteException;
    @android.annotation.EnforcePermission("android.permission.MOUNT_FORMAT_FILESYSTEMS")
    ...
    public static abstract class Stub extends android.os.Binder implements android.os.storage.IStorageManager {
        ...
        protected void createUserKey_enforcePermission() throws java.lang.SecurityException {}
        protected void destroyUserKey_enforcePermission() throws java.lang.SecurityException {}
        protected void unlockUserKey_enforcePermission() throws java.lang.SecurityException {}
        protected void lockUserKey_enforcePermission() throws java.lang.SecurityException {}
        ...
        protected void setUserKeyProtection_enforcePermission() throws java.lang.SecurityException {}
