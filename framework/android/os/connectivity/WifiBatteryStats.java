...
public final class WifiBatteryStats implements android.os.Parcelable {
    private final long mLoggingDurationMillis = 0L;
    private final long mKernelActiveTimeMillis = 0L;
    ...
    private final long mSleepTimeMillis = 0L;
    private final long mScanTimeMillis = 0L;
    private final long mIdleTimeMillis = 0L;
    private final long mRxTimeMillis = 0L;
    private final long mTxTimeMillis = 0L;
    private final long mEnergyConsumedMaMillis = 0L;
    private final long mAppScanRequestCount = 0L;
    private final long[] mTimeInStateMillis = null;
    private final long[] mTimeInSupplicantStateMillis = null;
    private final long[] mTimeInRxSignalStrengthLevelMillis = null;
    private final long mMonitoredRailChargeConsumedMaMillis = 0L;
