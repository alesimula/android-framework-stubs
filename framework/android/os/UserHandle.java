...
public final class UserHandle implements android.os.Parcelable {
    ...
    private static final android.os.UserHandle[] CACHED_USER_HANDLES = null;
    ...
    public static final android.util.SparseArray<android.os.UserHandle> sExtraUserHandleCache = null;
    final int mHandle = 0;
    ...
    public static android.os.UserHandle getUserHandleFromExtraCache(int p0) { return null; }
    ...
    public static boolean isSameAppIdWithPcc(int p0, int p1) { return false; }
