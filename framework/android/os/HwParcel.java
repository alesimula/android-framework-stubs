...
public class HwParcel {
    ...
    private final native void writeBoolVector(boolean[] p0);
    private final native void writeInt8Vector(byte[] p0);
    private final native void writeInt16Vector(short[] p0);
    private final native void writeInt32Vector(int[] p0);
    private final native void writeInt64Vector(long[] p0);
    private final native void writeFloatVector(float[] p0);
    private final native void writeDoubleVector(double[] p0);
    private final native void writeStringVector(java.lang.String[] p0);
    private final native void writeNativeHandleVector(android.os.NativeHandle[] p0);
    ...
    private final native void native_setup(boolean p0);
