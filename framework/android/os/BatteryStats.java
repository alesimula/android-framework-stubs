...
public abstract class BatteryStats {
    ...
    private static final java.lang.String[] CHECKIN_POWER_COMPONENT_LABELS = null;
    ...
    public static final int NUM_ALL_NETWORK_TYPES = Integer.valueOf(0);
    ...
    public static final java.lang.String[] RADIO_ACCESS_TECHNOLOGY_NAMES = null;
    ...
    public static final java.lang.String[] SCREEN_BRIGHTNESS_NAMES = null;
    ...
    private void dumpCheckinLocked(android.content.Context p0, java.io.PrintWriter p1, java.util.List<android.content.pm.ApplicationInfo> p2, int p3, android.os.BatteryStats.BatteryStatsDumpHelper p4) {}
    ...
    private void dumpHistory(java.io.PrintWriter p0, int p1, long p2, boolean p3) {}
    private void dumpHistoryTagPoolLocked(java.io.PrintWriter p0, boolean p1) {}
    ...
    private void dumpLocked(android.content.Context p0, java.io.PrintWriter p1, int p2, int p3, boolean p4, android.os.BatteryStats.BatteryStatsDumpHelper p5) {}
    private void dumpProtoAppsLocked(android.util.proto.ProtoOutputStream p0, android.os.BatteryUsageStats p1, java.util.List<android.content.pm.ApplicationInfo> p2, android.os.BatteryStats.ProportionalAttributionCalculator p3) {}
    private void dumpProtoHistoryLocked(android.util.proto.ProtoOutputStream p0, int p1, long p2) {}
    private void dumpProtoSystemLocked(android.util.proto.ProtoOutputStream p0, android.os.BatteryUsageStats p1) {}
    ...
    private static java.lang.String formatValue(double p0) { return null; }
    public static int getAllNetworkTypesCount() { return 0; }
    public static int getAllNetworkTypesCount$ravenwood() { return 0; }
    protected static int getCellSignalStrengthLevelCount() { return 0; }
    protected static int getCellSignalStrengthLevelCount$ravenwood() { return 0; }
    protected static int getDisplayTransport(int[] p0) { return 0; }
    protected static int getDisplayTransport$ravenwood(int[] p0) { return 0; }
    protected static int getModemTxPowerLevelCount() { return 0; }
    protected static int getModemTxPowerLevelCount$ravenwood() { return 0; }
    private java.util.List<android.os.BatteryStats.UidMobileRadioStats> getUidMobileRadioStats(java.util.List<android.os.UidBatteryConsumer> p0) { return null; }
    protected static boolean isKernelStatsAvailable() { return false; }
    protected static boolean isKernelStatsAvailable$ravenwood() { return false; }
    protected static boolean isLowRamDevice() { return false; }
    protected static boolean isLowRamDevice$ravenwood() { return false; }
    public static int mapToInternalProcessState(int p0) { return 0; }
    public static int mapUidProcessStateToBatteryConsumerProcessState(int p0) { return 0; }
    ...
    private void printCellularPerRatBreakdown(java.io.PrintWriter p0, java.lang.StringBuilder p1, java.lang.String p2, long p3) {}
    ...
    private boolean shouldHidePowerComponent(int p0) { return false; }
    ...
    public void dump(android.content.Context p0, java.io.PrintWriter p1, int p2, int p3, long p4, android.os.BatteryStats.BatteryStatsDumpHelper p5) {}
    public void dumpCheckin(android.content.Context p0, java.io.PrintWriter p1, java.util.List<android.content.pm.ApplicationInfo> p2, int p3, long p4, android.os.BatteryStats.BatteryStatsDumpHelper p5) {}
    public final void dumpCheckinLocked(android.content.Context p0, java.io.PrintWriter p1, int p2, int p3, boolean p4, android.os.BatteryStats.BatteryStatsDumpHelper p5) {}
    public final void dumpLocked(android.content.Context p0, java.io.PrintWriter p1, java.lang.String p2, int p3, int p4, boolean p5, android.os.BatteryStats.BatteryStatsDumpHelper p6) {}
    public void dumpProtoLocked(android.content.Context p0, java.io.FileDescriptor p1, java.util.List<android.content.pm.ApplicationInfo> p2, int p3, long p4, android.os.BatteryStats.BatteryStatsDumpHelper p5) {}
    ...
    public abstract long getActiveRadioDurationMs(int p0, int p1, int p2, long p3);
    public abstract long getActiveRxRadioDurationMs(int p0, int p1, long p2);
    public abstract long getActiveTxRadioDurationMs(int p0, int p1, int p2, long p3);
    ...
    public abstract long getDisplayScreenBrightnessTime(int p0, int p1, long p2);
    public abstract long getDisplayScreenDozeTime(int p0, long p1);
    public abstract long getDisplayScreenOnTime(int p0, long p1);
    ...
    public abstract long getNrNsaTime(long p0);
    ...
    public static final class HistoryItem {
        ...
        public final android.os.BatteryStats.ProcessStateChange localProcessStateChange = null;
    ...
    public static abstract class Uid {
        ...
        public abstract long getCpuActiveTime(int p0);
        public abstract long[] getCpuClusterTimes();
        public abstract boolean getCpuFreqTimes(long[] p0, int p1);
        ...
        public abstract long getMobileRadioActiveTimeInProcessState(int p0);
        ...
        public abstract boolean getScreenOffCpuFreqTimes(long[] p0, int p1);
