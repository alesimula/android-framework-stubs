...
public final class AggregateBatteryConsumer extends android.os.BatteryConsumer {
    ...
    private static final java.lang.String TAG = "AggregateBatteryConsumer";
    private AggregateBatteryConsumer(android.os.AggregateBatteryConsumer.Builder p0) { super((android.os.BatteryConsumer.BatteryConsumerData)null); }
    ...
    public static final class Builder extends android.os.BatteryConsumer.BaseBuilder<android.os.AggregateBatteryConsumer.Builder> {
        ...
        public android.os.AggregateBatteryConsumer.Builder addConsumedPower(double p0) { return null; }
