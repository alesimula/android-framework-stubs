...
public interface IDynamicInstrumentationManager extends android.os.IInterface {
    ...
    public void getExecutableMethodFileOffsets(android.os.instrumentation.TargetProcess p0, android.os.instrumentation.MethodDescriptor p1, android.os.instrumentation.IOffsetCallback p2) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.os.instrumentation.IDynamicInstrumentationManager {
        ...
        public Stub() { super(); }
        public static android.os.instrumentation.IDynamicInstrumentationManager asInterface(android.os.IBinder p0) { return null; }
        public android.os.IBinder asBinder() { return null; }
