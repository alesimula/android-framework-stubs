...
public interface IInstalld extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.os.IInstalld {
        ...
        static final int TRANSACTION_cleanupInvalidPackageDirs = 33;
        static final int TRANSACTION_clearAppData = 8;
        static final int TRANSACTION_copyAppDataPath = 36;
        static final int TRANSACTION_createAppData = 4;
        static final int TRANSACTION_createAppDataBatched = 5;
        static final int TRANSACTION_createFsveritySetupAuthToken = 34;
        static final int TRANSACTION_createOatDirs = 22;
        static final int TRANSACTION_createUserData = 1;
        static final int TRANSACTION_destroyAppData = 9;
        static final int TRANSACTION_destroyAppDataSnapshot = 28;
        static final int TRANSACTION_destroyCeSnapshotsNotSpecified = 29;
        static final int TRANSACTION_destroyPccData = 10;
        static final int TRANSACTION_destroyUserData = 2;
        static final int TRANSACTION_enableFsverity = 35;
        static final int TRANSACTION_fixupAppData = 11;
        static final int TRANSACTION_freeCache = 20;
        ...
        static final int TRANSACTION_invalidateMounts = 24;
        static final int TRANSACTION_isQuotaSupported = 25;
        static final int TRANSACTION_linkFile = 23;
        static final int TRANSACTION_linkNativeLibraryDirectory = 21;
        static final int TRANSACTION_migrateAppData = 7;
        static final int TRANSACTION_migrateLegacyObbData = 32;
        static final int TRANSACTION_moveAppDataPath = 37;
        static final int TRANSACTION_moveCompleteApp = 18;
        static final int TRANSACTION_onPrivateVolumeRemoved = 31;
        static final int TRANSACTION_reconcileSdkData = 6;
        static final int TRANSACTION_restoreAppDataSnapshot = 27;
        static final int TRANSACTION_rmPackageDir = 19;
        static final int TRANSACTION_setAppQuota = 17;
        static final int TRANSACTION_setFirstBoot = 3;
        static final int TRANSACTION_snapshotAppData = 26;
        static final int TRANSACTION_tryMountDataMirror = 30;
        public Stub() { super(); }
