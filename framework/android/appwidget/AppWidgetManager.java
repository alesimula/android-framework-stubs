...
public class AppWidgetManager {
    ...
    static final java.lang.String EVENT_TYPE_WIDGET_INTERACTION = "widget_interaction";
    ...
    static final java.lang.String EXTRA_EVENT_CLICKED_VIEWS = "android.appwidget.extra.EVENT_CLICKED_VIEWS";
    static final java.lang.String EXTRA_EVENT_DURATION_MS = "android.appwidget.extra.EVENT_DURATION_MS";
    static final java.lang.String EXTRA_EVENT_END = "android.appwidget.extra.EVENT_END";
    static final java.lang.String EXTRA_EVENT_POSITION_RECT = "android.appwidget.extra.EVENT_POSITION_RECT";
    static final java.lang.String EXTRA_EVENT_SCROLLED_VIEWS = "android.appwidget.extra.EVENT_SCROLLED_VIEWS";
    static final java.lang.String EXTRA_EVENT_START = "android.appwidget.extra.EVENT_START";
    public static final java.lang.String EXTRA_HOST_ID = "hostId";
    public static final int INVALID_APPWIDGET_ID = 0;
    private static final long MAX_ADAPTER_CONVERSION_WAITING_TIME_MS = 20000L;
    public static final java.lang.String META_DATA_APPWIDGET_PROVIDER = "android.appwidget.provider";
    public static final java.lang.String OPTION_APPWIDGET_DISPLAY_ID = "appWidgetDisplayId";
    ...
    private boolean mHasPostedLegacyLists;
    private int mMaxBitmapMemory;
    private final java.lang.String mPackageName = null;
    private final com.android.internal.appwidget.IAppWidgetService mService = null;
    private final android.appwidget.AppWidgetManager.ServiceCollectionCache mServiceCollectionCache = null;
    public AppWidgetManager(android.content.Context p0, com.android.internal.appwidget.IAppWidgetService p1) {}
    private boolean bindAppWidgetIdIfAllowed(int p0, int p1, android.content.ComponentName p2, android.os.Bundle p3) { return false; }
    private static java.util.concurrent.ExecutorService createExecutorService(java.lang.String p0, int p1) { return null; }
    private static java.util.concurrent.Executor createUpdateExecutorIfNull() { return null; }
    public static android.appwidget.AppWidgetManager getInstance(android.content.Context p0) { return null; }
    private void notifyCollectionWidgetChange(int[] p0, int p1) {}
    private boolean shouldSkipListConversion(android.widget.RemoteViews p0, int[] p1) throws android.os.RemoteException { return false; }
    private void tryAdapterConversion(com.android.internal.util.FunctionalUtils.RemoteExceptionIgnoringConsumer<android.widget.RemoteViews> p0, android.widget.RemoteViews p1, int[] p2, java.lang.String p3) {}
    ...
    public void partiallyUpdateAppWidget(int[] p0, android.widget.RemoteViews p1) {}
    public java.util.List<android.appwidget.AppWidgetEvent> queryAppWidgetEvents(long p0, long p1) { return null; }
    ...
    public static class ServiceCollectionCache {
        private final java.util.Map<android.content.Intent.FilterComparison, android.appwidget.AppWidgetManager.ServiceCollectionCache.ConnectionTask> mActiveConnections = null;
        private final android.content.Context mContext = null;
        private final android.os.Handler mHandler = null;
        private final long mTimeOut = 0L;
        public ServiceCollectionCache(android.content.Context p0, long p1) {}
        private void connectAndConsumeInner(android.content.Intent p0, java.util.function.Consumer<android.os.IBinder> p1) {}
        ...
        private class ConnectionTask implements android.content.ServiceConnection {
            private java.util.concurrent.ExecutorService mBinderCallExecutor;
            private final java.lang.Runnable mConnectionTimeout = null;
            private java.lang.Object mCurrentTaskToken;
            private final java.lang.Runnable mDestroyAfterTimeout = null;
            private final java.lang.String mExecutorName = null;
            private android.os.IBinder mIBinder;
            private boolean mOnDestroyTimeout;
            private final java.util.ArrayDeque<java.util.function.Consumer<android.os.IBinder>> mTaskQueue = null;
            ...
            private void onBinderReceived(android.os.IBinder p0) {}
            private void onConnectionTimeout() {}
            private void onDestroyTimeout() {}
            private void onTaskComplete(java.lang.Object p0) {}
            private void onTaskTimeout(java.util.concurrent.Future p0, java.lang.Object p1) {}
