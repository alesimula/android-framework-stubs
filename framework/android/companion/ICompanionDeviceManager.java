...
public interface ICompanionDeviceManager extends android.os.IInterface {
    ...
    public void attachSystemDataTransport(java.lang.String p0, int p1, int p2, android.os.ParcelFileDescriptor p3, int p4) throws android.os.RemoteException;
    @android.annotation.EnforcePermission("android.permission.DELIVER_COMPANION_MESSAGES")
    ...
    @android.annotation.EnforcePermission("android.permission.ACCESS_COMPANION_INFO")
    ...
    public static abstract class Stub extends android.os.Binder implements android.companion.ICompanionDeviceManager {
        ...
        static final int TRANSACTION_removeBond = 39;
        static final int TRANSACTION_getAssociationByDeviceId = 40;
        static final int TRANSACTION_setDeviceId = 41;
