...
public interface IVirtualDeviceManager extends android.os.IInterface {
    ...
    @android.annotation.EnforcePermission("android.permission.ACCESS_COMPUTER_CONTROL")
    public android.companion.virtual.IVirtualDevice createLocalVirtualDevice(android.os.IBinder p0, android.content.AttributionSource p1, android.companion.virtual.VirtualDeviceParams p2, android.companion.virtual.IVirtualDeviceActivityListener p3, android.companion.virtual.IVirtualDeviceSoundEffectListener p4) throws android.os.RemoteException;
    ...
    public static class Default implements android.companion.virtual.IVirtualDeviceManager {
        ...
        public android.companion.virtual.IVirtualDevice createLocalVirtualDevice(android.os.IBinder p0, android.content.AttributionSource p1, android.companion.virtual.VirtualDeviceParams p2, android.companion.virtual.IVirtualDeviceActivityListener p3, android.companion.virtual.IVirtualDeviceSoundEffectListener p4) throws android.os.RemoteException { return null; }
    ...
    public static abstract class Stub extends android.os.Binder implements android.companion.virtual.IVirtualDeviceManager {
        ...
        protected void createLocalVirtualDevice_enforcePermission() throws java.lang.SecurityException {}
