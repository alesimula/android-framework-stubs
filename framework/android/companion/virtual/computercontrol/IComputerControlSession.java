...
public interface IComputerControlSession extends android.os.IInterface {
    ...
    public void addStabilityListener(long p0, android.companion.virtual.computercontrol.IStabilityListener p1) throws android.os.RemoteException;
    ...
    public android.os.ICancellationSignal handOverApplications(android.companion.virtual.computercontrol.IComputerControlSession.IInteractionResultReceiver p0) throws android.os.RemoteException;
    ...
    public void notifyFirstFrameReceived() throws android.os.RemoteException;
    ...
    public void removeStabilityListener(android.companion.virtual.computercontrol.IStabilityListener p0) throws android.os.RemoteException;
    ...
    public void requestUiSnapshot(android.companion.virtual.computercontrol.IComputerControlSession.IUiSnapshotResultReceiver p0) throws android.os.RemoteException;
    public void setPreviewIntent(android.app.PendingIntent p0) throws android.os.RemoteException;
    public android.os.ICancellationSignal startActivity(android.content.Intent p0, android.os.Bundle p1, android.companion.virtual.computercontrol.IComputerControlSession.IInteractionResultReceiver p2) throws android.os.RemoteException;
    public android.os.ICancellationSignal startShortcut(java.lang.String p0, java.lang.String p1, android.os.Bundle p2, android.companion.virtual.computercontrol.IComputerControlSession.IInteractionResultReceiver p3) throws android.os.RemoteException;
    ...
    public static interface IUiSnapshotResultReceiver extends android.os.IInterface {
        public static final java.lang.String DESCRIPTOR = "android.companion.virtual.computercontrol.IComputerControlSession.IUiSnapshotResultReceiver";
        public void onUiSnapshotResult(android.companion.virtual.computercontrol.ComputerControlUiSnapshot p0, int p1) throws android.os.RemoteException;

        public static abstract class Stub extends android.os.Binder implements android.companion.virtual.computercontrol.IComputerControlSession.IUiSnapshotResultReceiver {
            static final int TRANSACTION_onUiSnapshotResult = 1;
            public Stub() { super(); }
            public static android.companion.virtual.computercontrol.IComputerControlSession.IUiSnapshotResultReceiver asInterface(android.os.IBinder p0) { return null; }
            public static java.lang.String getDefaultTransactionName(int p0) { return null; }
            public android.os.IBinder asBinder() { return null; }
            public java.lang.String getTransactionName(int p0) { return null; }
            public boolean onTransact(int p0, android.os.Parcel p1, android.os.Parcel p2, int p3) throws android.os.RemoteException { return false; }

            private static final class Proxy implements android.companion.virtual.computercontrol.IComputerControlSession.IUiSnapshotResultReceiver {
                private android.os.IBinder mRemote;
                Proxy(android.os.IBinder p0) {}
                public android.os.IBinder asBinder() { return null; }
                public final java.lang.String getInterfaceDescriptor() { return null; }
        ...
        public static class Default implements android.companion.virtual.computercontrol.IComputerControlSession.IUiSnapshotResultReceiver {
            public Default() {}
            public android.os.IBinder asBinder() { return null; }
            public void onUiSnapshotResult(android.companion.virtual.computercontrol.ComputerControlUiSnapshot p0, int p1) throws android.os.RemoteException {}
        }
    ...
    public static class Default implements android.companion.virtual.computercontrol.IComputerControlSession {
        ...
        public android.os.ICancellationSignal handOverApplications(android.companion.virtual.computercontrol.IComputerControlSession.IInteractionResultReceiver p0) throws android.os.RemoteException { return null; }
        public void initialize(android.companion.virtual.computercontrol.IComputerControlLifecycleCallback p0, android.view.Surface p1) throws android.os.RemoteException {}
        ...
        public void requestUiSnapshot(android.companion.virtual.computercontrol.IComputerControlSession.IUiSnapshotResultReceiver p0) throws android.os.RemoteException {}
        public void setPreviewIntent(android.app.PendingIntent p0) throws android.os.RemoteException {}
        public android.os.ICancellationSignal startActivity(android.content.Intent p0, android.os.Bundle p1, android.companion.virtual.computercontrol.IComputerControlSession.IInteractionResultReceiver p2) throws android.os.RemoteException { return null; }
        public android.os.ICancellationSignal startShortcut(java.lang.String p0, java.lang.String p1, android.os.Bundle p2, android.companion.virtual.computercontrol.IComputerControlSession.IInteractionResultReceiver p3) throws android.os.RemoteException { return null; }
    ...
    public static abstract class Stub extends android.os.Binder implements android.companion.virtual.computercontrol.IComputerControlSession {
        static final int TRANSACTION_addPackagesForAutomation = 19;
        static final int TRANSACTION_addStabilityListener = 21;
        static final int TRANSACTION_attachNotificationInfo = 12;
        static final int TRANSACTION_close = 20;
        static final int TRANSACTION_createInteractiveMirror = 9;
        static final int TRANSACTION_handOverApplications = 5;
        static final int TRANSACTION_initialize = 1;
        static final int TRANSACTION_insertText = 10;
        static final int TRANSACTION_launchApplication = 2;
        static final int TRANSACTION_longPress = 8;
        static final int TRANSACTION_notifyBlocked = 16;
        static final int TRANSACTION_notifyFirstFrameReceived = 24;
        static final int TRANSACTION_notifyScreenshotResult = 15;
        static final int TRANSACTION_notifySuspend = 17;
        static final int TRANSACTION_performAction = 11;
        static final int TRANSACTION_removeStabilityListener = 22;
        static final int TRANSACTION_requestResume = 18;
        static final int TRANSACTION_requestScreenshot = 14;
        static final int TRANSACTION_requestUiSnapshot = 23;
        static final int TRANSACTION_setPreviewIntent = 13;
        static final int TRANSACTION_startActivity = 3;
        static final int TRANSACTION_startShortcut = 4;
