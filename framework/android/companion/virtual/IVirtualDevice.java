...
public interface IVirtualDevice extends android.os.IInterface {
    ...
    public void closeVirtualCameraSession(android.companion.virtual.camera.VirtualCameraConfig p0) throws android.os.RemoteException;
    ...
    public android.hardware.input.IVirtualDpad createVirtualDpad(android.hardware.input.VirtualDpadConfig p0, android.os.IBinder p1) throws android.os.RemoteException;
    public android.hardware.input.IVirtualKeyboard createVirtualKeyboard(android.hardware.input.VirtualKeyboardConfig p0, android.os.IBinder p1) throws android.os.RemoteException;
    public android.hardware.input.IVirtualMouse createVirtualMouse(android.hardware.input.VirtualMouseConfig p0, android.os.IBinder p1) throws android.os.RemoteException;
    public android.hardware.input.IVirtualNavigationTouchpad createVirtualNavigationTouchpad(android.hardware.input.VirtualNavigationTouchpadConfig p0, android.os.IBinder p1) throws android.os.RemoteException;
    public android.hardware.input.IVirtualRotaryEncoder createVirtualRotaryEncoder(android.hardware.input.VirtualRotaryEncoderConfig p0, android.os.IBinder p1) throws android.os.RemoteException;
    public android.hardware.input.IVirtualStylus createVirtualStylus(android.hardware.input.VirtualStylusConfig p0, android.os.IBinder p1) throws android.os.RemoteException;
    public android.hardware.input.IVirtualTouchscreen createVirtualTouchscreen(android.hardware.input.VirtualTouchscreenConfig p0, android.os.IBinder p1) throws android.os.RemoteException;
    ...
    public void notifyVirtualCameraRequestError(android.companion.virtual.camera.VirtualCameraConfig p0, long p1) throws android.os.RemoteException;
    ...
    public void setCurrentThermalStatus(int p0) throws android.os.RemoteException;
    ...
    public void setDisplayInTouchMode(int p0, boolean p1) throws android.os.RemoteException;
    ...
    public static class Default implements android.companion.virtual.IVirtualDevice {
        ...
        public android.hardware.input.IVirtualDpad createVirtualDpad(android.hardware.input.VirtualDpadConfig p0, android.os.IBinder p1) throws android.os.RemoteException { return null; }
        public android.hardware.input.IVirtualKeyboard createVirtualKeyboard(android.hardware.input.VirtualKeyboardConfig p0, android.os.IBinder p1) throws android.os.RemoteException { return null; }
        public android.hardware.input.IVirtualMouse createVirtualMouse(android.hardware.input.VirtualMouseConfig p0, android.os.IBinder p1) throws android.os.RemoteException { return null; }
        public android.hardware.input.IVirtualNavigationTouchpad createVirtualNavigationTouchpad(android.hardware.input.VirtualNavigationTouchpadConfig p0, android.os.IBinder p1) throws android.os.RemoteException { return null; }
        public android.hardware.input.IVirtualRotaryEncoder createVirtualRotaryEncoder(android.hardware.input.VirtualRotaryEncoderConfig p0, android.os.IBinder p1) throws android.os.RemoteException { return null; }
        public android.hardware.input.IVirtualStylus createVirtualStylus(android.hardware.input.VirtualStylusConfig p0, android.os.IBinder p1) throws android.os.RemoteException { return null; }
        public android.hardware.input.IVirtualTouchscreen createVirtualTouchscreen(android.hardware.input.VirtualTouchscreenConfig p0, android.os.IBinder p1) throws android.os.RemoteException { return null; }
    ...
    public static abstract class Stub extends android.os.Binder implements android.companion.virtual.IVirtualDevice {
        ...
        private static final class Proxy implements android.companion.virtual.IVirtualDevice {
