...
public class TextLine {
    ...
    private float handleText(android.text.TextPaint p0, int p1, int p2, int p3, int p4, boolean p5, android.graphics.Canvas p6, float p7, int p8, int p9, int p10, android.graphics.Paint.FontMetricsInt p11, boolean p12, int p13, java.util.ArrayList<android.text.TextLine.DecorationInfo> p14) { return 0.0f; }
    ...
    private float handleRun(int p0, int p1, int p2, boolean p3, android.graphics.Canvas p4, float p5, int p6, int p7, int p8, android.graphics.Paint.FontMetricsInt p9, boolean p10) { return 0.0f; }
