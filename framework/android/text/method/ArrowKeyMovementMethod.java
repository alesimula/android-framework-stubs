...
public class ArrowKeyMovementMethod extends android.text.method.BaseMovementMethod implements android.text.method.MovementMethod {
    private static final java.lang.Object LAST_TAP_DOWN = null;
    private static android.text.method.ArrowKeyMovementMethod sInstance;
    public ArrowKeyMovementMethod() { super(); }
    private static boolean isSelecting(android.text.Spannable p0) { return false; }
    private static int getCurrentLineTop(android.text.Spannable p0, android.text.Layout p1) { return 0; }
    private static int getPageHeight(android.widget.TextView p0) { return 0; }
