...
public class RelativeSizeSpan extends android.text.style.MetricAffectingSpan implements android.text.ParcelableSpan {
    private final float mProportion = 0.0f;
    public RelativeSizeSpan(float p0) { super(); }
    public RelativeSizeSpan(android.os.Parcel p0) { super(); }
    ...
    public float getSizeChange() { return 0.0f; }
