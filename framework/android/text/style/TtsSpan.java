...
public class TtsSpan implements android.text.ParcelableSpan {
    ...
    @android.annotation.FlaggedApi("com.android.text.flags.tts_span_duration")
    public static final java.lang.String TYPE_DURATION = "android.type.duration";
    ...
    @android.annotation.FlaggedApi("com.android.text.flags.tts_span_duration")
    public static final java.lang.String ARG_SECONDS = "android.arg.seconds";
