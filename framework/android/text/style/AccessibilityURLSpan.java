...
public class AccessibilityURLSpan extends android.text.style.URLSpan implements android.os.Parcelable {
    ...
    public AccessibilityURLSpan(android.os.Parcel p0) { super((android.os.Parcel)null); }
    public AccessibilityURLSpan(android.text.style.URLSpan p0) { super((android.os.Parcel)null); }
