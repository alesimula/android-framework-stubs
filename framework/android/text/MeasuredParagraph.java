...
public class MeasuredParagraph {
    ...
    public static android.text.MeasuredParagraph buildForStaticLayout(android.text.TextPaint p0, android.graphics.text.LineBreakConfig p1, java.lang.CharSequence p2, int p3, int p4, android.text.TextDirectionHeuristic p5, int p6, boolean p7, android.text.MeasuredParagraph p8, android.text.MeasuredParagraph p9) { return null; }
