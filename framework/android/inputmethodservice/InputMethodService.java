...
public class InputMethodService extends android.inputmethodservice.AbstractInputMethodService {
    ...
    public final boolean getShouldShowImeWithHardKeyboardForTesting() { return false; }
    ...
    @android.annotation.FlaggedApi("android.view.inputmethod.adaptive_handwriting_bounds")
    ...
    @android.annotation.FlaggedApi("android.view.inputmethod.verify_key_event")
    ...
    public class InputMethodImpl extends android.inputmethodservice.AbstractInputMethodService.AbstractInputMethodImpl {
        ...
        public void hideSoftInputWithToken(int p0, android.os.ResultReceiver p1, android.view.inputmethod.ImeTracker.Token p2) {}
        public void hideSoftInput(int p0, android.os.ResultReceiver p1) {}
        public void showSoftInputWithToken(int p0, android.os.ResultReceiver p1, android.view.inputmethod.ImeTracker.Token p2) {}
    ...
    private static final class SettingsObserver extends android.database.ContentObserver {
        SettingsObserver() { super((android.os.Handler)null); }
