...
public final class PrintManager {
    ...
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission("android.permission.READ_PRINT_SERVICES")
    ...
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission("android.permission.READ_PRINT_SERVICE_RECOMMENDATIONS")
    ...
    public boolean isPrintServiceEnabled(android.content.ComponentName p0) { return false; }
