...
public final class PrintAttributes implements android.os.Parcelable {
    ...
    PrintAttributes() {}
    private PrintAttributes(android.os.Parcel p0) {}
    ...
    public static final class Resolution {
        ...
        private final int mVerticalDpi = 0;
    ...
    public static final class MediaSize {
        ...
        private static final java.util.Map<java.lang.String, android.print.PrintAttributes.MediaSize> sIdToMediaSizeMap = null;
        ...
        private final int mWidthMils = 0;
        private final int mHeightMils = 0;
    ...
    public static final class Margins {
        ...
        private final int mLeftMils = 0;
        private final int mTopMils = 0;
        private final int mRightMils = 0;
