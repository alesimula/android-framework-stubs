...
public interface IPrintManager extends android.os.IInterface {
    ...
    public boolean isPrintServiceEnabled(android.content.ComponentName p0, int p1) throws android.os.RemoteException;
    ...
    public static class Default implements android.print.IPrintManager {
        ...
        public boolean isPrintServiceEnabled(android.content.ComponentName p0, int p1) throws android.os.RemoteException { return false; }
    ...
    public static abstract class Stub extends android.os.Binder implements android.print.IPrintManager {
        ...
        private static final class Proxy implements android.print.IPrintManager {
