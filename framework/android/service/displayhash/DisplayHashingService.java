...
public abstract class DisplayHashingService extends android.app.Service {
    ...
    private void verifyDisplayHash(byte[] p0, android.view.displayhash.DisplayHash p1, android.os.RemoteCallback p2) {}
    private void getDisplayHashAlgorithms(android.os.RemoteCallback p0) {}
    public abstract int onGetIntervalBetweenRequestsMillis();
    private void getDurationBetweenRequestsMillis(android.os.RemoteCallback p0) {}

    private final class DisplayHashingServiceWrapper extends android.service.displayhash.IDisplayHashingService.Stub {
        private DisplayHashingServiceWrapper(android.service.displayhash.DisplayHashingService p0) { super(); }
