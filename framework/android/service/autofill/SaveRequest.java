...
public final class SaveRequest implements android.os.Parcelable {
    ...
    private final java.util.List<java.lang.String> mDatasetIds = null;
    private final java.util.List<android.service.autofill.FillContext> mFillContexts = null;
    private SaveRequest(android.os.Parcel p0) {}
    public SaveRequest(java.util.List<android.service.autofill.FillContext> p0, android.os.Bundle p1, java.util.List<java.lang.String> p2) {}
