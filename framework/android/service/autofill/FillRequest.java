...
public final class FillRequest implements android.os.Parcelable {
    ...
    public FillRequest(int p0, java.util.List<android.service.autofill.FillContext> p1, android.os.Bundle p2, int p3, android.view.inputmethod.InlineSuggestionsRequest p4) {}
