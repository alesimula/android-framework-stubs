...
public abstract class AppPredictionService extends android.app.Service {
    ...
    private void doUpdatePredictions(android.app.prediction.AppPredictionSessionId p0, java.util.List<android.app.prediction.AppTarget> p1) {}
    ...
    private static final class RemoteCallbackWrapper implements java.util.function.Consumer<android.os.Bundle>, android.os.IBinder.DeathRecipient {
        ...
        private final java.util.function.Consumer<android.service.appprediction.AppPredictionService.RemoteCallbackWrapper> mOnBinderDied = null;
