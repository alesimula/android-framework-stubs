...
public interface IQuickAccessWalletServiceCallbacks extends android.os.IInterface {
    ...
    public void onGestureTargetActivityPendingIntentReceived(android.app.PendingIntent p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.service.quickaccesswallet.IQuickAccessWalletServiceCallbacks {
        ...
        private static final class Proxy implements android.service.quickaccesswallet.IQuickAccessWalletServiceCallbacks {
