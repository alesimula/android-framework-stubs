...
public final class TimeZoneProviderStatus implements android.os.Parcelable {
    ...
    private final int mConnectivityDependencyStatus = 0;
    private final int mLocationDetectionDependencyStatus = 0;
    private final int mTimeZoneResolutionOperationStatus = 0;
    private TimeZoneProviderStatus(int p0, int p1, int p2) {}
    ...
    private static int requireValidDependencyStatus(int p0) { return 0; }
    private static int requireValidOperationStatus(int p0) { return 0; }
