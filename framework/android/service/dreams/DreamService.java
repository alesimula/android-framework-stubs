...
public class DreamService extends android.app.Service implements android.view.Window.Callback {
    ...
    private final android.service.dreams.IDreamManager mSandman = null;
    ...
    public void setLowProfile(boolean p0) {}
    public boolean isLowProfile() { return false; }
    ...
    private final void attach(android.os.IBinder p0, boolean p1, android.os.IRemoteCallback p2) {}
    private boolean getWindowFlagValue(int p0, boolean p1) { return false; }
    private void applyWindowFlags(int p0, int p1) {}
    private boolean getSystemUiVisibilityFlagValue(int p0, boolean p1) { return false; }
    private void applySystemUiVisibilityFlags(int p0, int p1) {}
    ...
    private final class DreamServiceWrapper extends android.service.dreams.IDreamService.Stub {
        private DreamServiceWrapper(android.service.dreams.DreamService p0) { super(); }
