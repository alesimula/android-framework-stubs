...
public abstract class ContentCaptureService extends android.app.Service {
    ...
    private static final int METRICS_FLUSH_THRESHOLD = 10000;
    ...
    private final android.service.contentcapture.IContentProtectionService mContentProtectionServerInterface = null;
    ...
    public final void setContentCaptureVersions(java.util.Map<java.lang.String, java.lang.Integer> p0, java.util.Map<android.content.ComponentName, java.lang.Integer> p1) {}
    ...
    public static class PendingMetrics {
        private android.content.ComponentName activityComponent;
        private int flushReason;
        private final android.service.contentcapture.FlushMetrics metrics = null;
        private android.content.ContentCaptureOptions options;
        public PendingMetrics() {}
        private void update(android.content.ComponentName p0, android.content.ContentCaptureOptions p1, int p2) {}
        public android.service.contentcapture.FlushMetrics getMetrics() { return null; }
    }
}
