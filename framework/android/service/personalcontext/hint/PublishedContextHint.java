...
public final class PublishedContextHint {
    ...
    private final android.service.personalcontext.hint.ContextHintWrapper mContextHintWrapper = null;
    ...
    public PublishedContextHint(byte[] p0, android.service.personalcontext.hint.ContextHintWrapper p1, java.util.List<android.service.personalcontext.hint.PublishedContextHint> p2, java.lang.String p3, java.util.Set<android.service.personalcontext.RenderToken> p4) {}
    private static java.util.List<android.service.personalcontext.RenderToken> orderRenderTokens(java.util.Collection<android.service.personalcontext.RenderToken> p0) { return null; }
    private static byte[] signData(android.service.personalcontext.hint.ContextHintWrapper p0, java.util.List<android.service.personalcontext.hint.PublishedContextHint> p1, java.lang.String p2, java.util.Set<android.service.personalcontext.RenderToken> p3, javax.crypto.spec.SecretKeySpec p4) throws java.security.GeneralSecurityException { return null; }
