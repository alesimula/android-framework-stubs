...
public abstract class ConversationEvent {
    ...
    ConversationEvent(java.lang.String p0, java.time.Instant p1, java.time.Instant p2) {}
    public static android.service.personalcontext.hint.ConversationEvent fromBundle(android.os.Bundle p0) { return null; }
    public static android.service.personalcontext.hint.ConversationEvent fromContentCaptureConversationEvent(android.service.personalcontext.hint.ContentCaptureConversationEvent p0) { return null; }
    static android.service.personalcontext.hint.ConversationEvent readFromParcel(android.os.Parcel p0) { return null; }
    ...
    public android.service.personalcontext.hint.ContentCaptureConversationEvent toContentCaptureConversationEvent() { return null; }
    ...
    public static final class ConversationExitEvent extends android.service.personalcontext.hint.ConversationEvent {
    ...
    public static final class ConversationEnterEvent extends android.service.personalcontext.hint.ConversationEvent {
    ...
    public static final class ConversationUpdateEvent extends android.service.personalcontext.hint.ConversationEvent {
        ...
        ConversationUpdateEvent(java.lang.String p0, java.time.Instant p1, java.time.Instant p2, android.os.Parcel p3) { super(null, null, null); }
    ...
    public static final class ConversationProcessingEvent extends android.service.personalcontext.hint.ConversationEvent {
        ...
        ConversationProcessingEvent(java.lang.String p0, java.time.Instant p1, java.time.Instant p2, android.os.Parcel p3) { super(null, null, null); }
