...
public interface IInsightRenderer extends android.os.IInterface {
    ...
    public void getFilter(android.os.ParcelUuid p0, android.service.personalcontext.renderer.IGetFilterCallback p1, android.app.personalcontext.IOpCallback p2) throws android.os.RemoteException;
    public void render(android.os.ParcelUuid p0, android.service.personalcontext.insight.ContextInsightWrapper p1, android.app.personalcontext.RenderToken p2, android.app.personalcontext.IOpCallback p3) throws android.os.RemoteException;
    public void renderWithFeedback(android.os.ParcelUuid p0, android.service.personalcontext.insight.ContextInsightWrapper p1, android.app.personalcontext.RenderToken p2, android.app.PendingIntent p3, android.app.personalcontext.IOpCallback p4) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.service.personalcontext.renderer.IInsightRenderer {
        ...
        static final int TRANSACTION_renderWithFeedback = 4;
        public Stub() { super(); }
