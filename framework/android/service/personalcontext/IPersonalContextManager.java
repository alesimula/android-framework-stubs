...
public interface IPersonalContextManager extends android.os.IInterface {
    ...
    public java.util.List<android.content.ComponentName> getEnabledUnderstanders(android.service.personalcontext.PersonalContextManagerMetadata p0) throws android.os.RemoteException;
    public int getPersonalContextModeEnabledDefault(android.service.personalcontext.PersonalContextManagerMetadata p0) throws android.os.RemoteException;
    ...
    public void publishInsightSurfaceHints(android.service.personalcontext.PersonalContextManagerMetadata p0, java.util.List<android.app.personalcontext.hint.ContextHintWrapper> p1, android.service.personalcontext.embedded.InsightSurfaceClientInfo p2) throws android.os.RemoteException;
    public void publishRemoteAutofillHint(android.service.personalcontext.PersonalContextManagerMetadata p0, android.app.personalcontext.hint.ContextHintWrapper p1, android.view.autofill.AutofillId p2, android.os.IBinder p3, int p4) throws android.os.RemoteException;
    public void publishTriggeringHint(android.service.personalcontext.PersonalContextManagerMetadata p0, java.util.List<android.app.personalcontext.hint.ContextHintWrapper> p1, java.util.List<android.app.personalcontext.RenderToken> p2, java.util.List<android.app.personalcontext.hint.ContextHintWrapper> p3) throws android.os.RemoteException;
    ...
    public void requestUnderstanderEnabled(android.service.personalcontext.PersonalContextManagerMetadata p0, android.content.ComponentName p1, int p2) throws android.os.RemoteException;
    ...
    public void setPersonalContextModeEnabledDefault(android.service.personalcontext.PersonalContextManagerMetadata p0, int p1) throws android.os.RemoteException;
    public void setUnderstanderEnabled(android.service.personalcontext.PersonalContextManagerMetadata p0, android.content.ComponentName p1, int p2, boolean p3) throws android.os.RemoteException;
    ...
    public android.app.personalcontext.hint.PublishedContextHintWrapper signHint(android.service.personalcontext.PersonalContextManagerMetadata p0, android.app.personalcontext.hint.ContextHintWrapper p1, java.util.List<android.app.personalcontext.hint.ContextHintWrapper> p2) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.service.personalcontext.IPersonalContextManager {
        ...
        private static final class Proxy implements android.service.personalcontext.IPersonalContextManager {
            ...
            public android.os.IBinder asBinder() { return null; }
            public java.util.List<android.content.ComponentName> getEnabledUnderstanders(android.service.personalcontext.PersonalContextManagerMetadata p0) throws android.os.RemoteException { return null; }
            public final java.lang.String getInterfaceDescriptor() { return null; }
            public int getPersonalContextModeEnabledDefault(android.service.personalcontext.PersonalContextManagerMetadata p0) throws android.os.RemoteException { return 0; }
            ...
            public void setUnderstanderEnabled(android.service.personalcontext.PersonalContextManagerMetadata p0, android.content.ComponentName p1, int p2, boolean p3) throws android.os.RemoteException {}
            public void showAttribution(android.service.personalcontext.PersonalContextManagerMetadata p0, android.service.personalcontext.insight.ContextInsightWrapper p1) throws android.os.RemoteException {}
            public android.app.personalcontext.hint.PublishedContextHintWrapper signHint(android.service.personalcontext.PersonalContextManagerMetadata p0, android.app.personalcontext.hint.ContextHintWrapper p1, java.util.List<android.app.personalcontext.hint.ContextHintWrapper> p2) throws android.os.RemoteException { return null; }
            public void unregisterInsightSurfaceClient(android.service.personalcontext.PersonalContextManagerMetadata p0, android.os.ParcelUuid p1) throws android.os.RemoteException {}
            public void updateEmbeddedClientInfo(android.service.personalcontext.PersonalContextManagerMetadata p0, android.service.personalcontext.embedded.InsightSurfaceClientInfo p1, android.service.personalcontext.embedded.InsightSurfaceClientInfo p2) throws android.os.RemoteException {}
        }
    }
