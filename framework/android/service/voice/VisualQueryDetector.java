...
public class VisualQueryDetector {
    VisualQueryDetector(com.android.internal.app.IVoiceInteractionManagerService p0, java.util.concurrent.Executor p1, android.service.voice.VisualQueryDetector.Callback p2) {}
    ...
    private static class BinderCallback extends android.service.voice.IVisualQueryDetectionVoiceInteractionCallback.Stub {
        BinderCallback(java.util.concurrent.Executor p0, android.service.voice.VisualQueryDetector.Callback p1) { super(); }
    ...
    private static class InitializationStateListener extends com.android.internal.app.IHotwordRecognitionStatusCallback.Stub {
        InitializationStateListener(java.util.concurrent.Executor p0, android.service.voice.VisualQueryDetector.Callback p1) { super(); }
