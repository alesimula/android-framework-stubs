...
public interface IVoiceInteractionSession extends android.os.IInterface {
    ...
    public void notifyVisibleActivityInfoChanged(android.service.voice.VisibleActivityInfo p0, int p1) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.service.voice.IVoiceInteractionSession {
        ...
        private static final class Proxy implements android.service.voice.IVoiceInteractionSession {
