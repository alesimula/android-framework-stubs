...
public final class HotwordDetectedResult implements android.os.Parcelable {
    ...
    HotwordDetectedResult(int p0, android.media.MediaSyncEvent p1, int p2, int p3, int p4, boolean p5, int p6, int p7, int p8, java.util.List<android.service.voice.HotwordAudioStream> p9, android.os.PersistableBundle p10, int p11) {}
