...
public interface INotificationListener extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.service.notification.INotificationListener {
        ...
        static final int TRANSACTION_onNotificationRuleAdded = 24;
        static final int TRANSACTION_onNotificationRuleModified = 25;
        static final int TRANSACTION_onNotificationRuleRemoved = 26;
        ...
        static final int TRANSACTION_onSystemAdjustmentsReceived = 23;
        public Stub() { super(); }
        ...
        private static final class Proxy implements android.service.notification.INotificationListener {
