...
public class ZenModeConfig implements android.os.Parcelable {
    ...
    public static android.service.notification.ZenModeConfig readXml(android.util.TypedXmlPullParser p0) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException { return null; }
    public void writeXml(android.util.TypedXmlSerializer p0, java.lang.Integer p1) throws java.io.IOException {}
    public static android.service.notification.ZenModeConfig.ZenRule readRuleXml(android.util.TypedXmlPullParser p0) { return null; }
    public static void writeRuleXml(android.service.notification.ZenModeConfig.ZenRule p0, android.util.TypedXmlSerializer p1) throws java.io.IOException {}
    public static android.service.notification.Condition readConditionXml(android.util.TypedXmlPullParser p0) { return null; }
    public static void writeConditionXml(android.service.notification.Condition p0, android.util.TypedXmlSerializer p1) throws java.io.IOException {}
    public static android.service.notification.ZenPolicy readZenPolicyXml(android.util.TypedXmlPullParser p0) { return null; }
    public static void writeZenPolicyXml(android.service.notification.ZenPolicy p0, android.util.TypedXmlSerializer p1) throws java.io.IOException {}
    private static void writeZenPolicyState(java.lang.String p0, int p1, android.util.TypedXmlSerializer p2) throws java.io.IOException {}
    ...
    private static java.lang.Boolean unsafeBoolean(android.util.TypedXmlPullParser p0, java.lang.String p1) { return null; }
    private static boolean safeBoolean(android.util.TypedXmlPullParser p0, java.lang.String p1, boolean p2) { return false; }
    private static boolean safeBoolean(java.lang.String p0, boolean p1) { return false; }
    private static int safeInt(android.util.TypedXmlPullParser p0, java.lang.String p1, int p2) { return 0; }
    private static android.content.ComponentName safeComponentName(android.util.TypedXmlPullParser p0, java.lang.String p1) { return null; }
    private static android.net.Uri safeUri(android.util.TypedXmlPullParser p0, java.lang.String p1) { return null; }
    private static long safeLong(android.util.TypedXmlPullParser p0, java.lang.String p1, long p2) { return 0L; }
    ...
    private static int normalizePrioritySenders(int p0, int p1) { return 0; }
    private static int normalizeConversationSenders(boolean p0, int p1, int p2) { return 0; }
