...
public final class Condition implements android.os.Parcelable {
    ...
    public Condition(android.net.Uri p0, java.lang.String p1, int p2, int p3) {}
    public Condition(android.net.Uri p0, java.lang.String p1, java.lang.String p2, java.lang.String p3, int p4, int p5, int p6) {}
    public Condition(android.net.Uri p0, java.lang.String p1, java.lang.String p2, java.lang.String p3, int p4, int p5, int p6, int p7) {}
    public Condition(android.os.Parcel p0) {}
    private static int checkValidSource(int p0) { return 0; }
