...
public interface IWallpaperService extends android.os.IInterface {
    public void attach(android.service.wallpaper.IWallpaperConnection p0, android.os.IBinder p1, int p2, boolean p3, int p4, int p5, android.graphics.Rect p6, int p7, int p8) throws android.os.RemoteException;
