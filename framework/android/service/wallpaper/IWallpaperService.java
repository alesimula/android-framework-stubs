...
public interface IWallpaperService extends android.os.IInterface {
    public void attach(android.service.wallpaper.IWallpaperConnection p0, android.os.IBinder p1, int p2, boolean p3, int p4, int p5, android.graphics.Rect p6, int p7, int p8, android.app.WallpaperInfo p9, android.app.wallpaper.WallpaperDescription p10) throws android.os.RemoteException;
    public void detach(android.os.IBinder p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.service.wallpaper.IWallpaperService {
        ...
        private static final class Proxy implements android.service.wallpaper.IWallpaperService {
