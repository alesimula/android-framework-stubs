...
public abstract class WallpaperService extends android.app.Service {
    ...
    private final android.util.ArrayMap<android.os.IBinder, android.service.wallpaper.WallpaperService.IWallpaperEngineWrapper> mActiveEngines = null;
    ...
    public class Engine {
        ...
        private float mCustomPersistedDimAmount;
        ...
        private final android.util.ArraySet<android.graphics.RectF> mLocalColorAreas = null;
        private final android.util.ArraySet<android.graphics.RectF> mLocalColorsToAdd = null;
        ...
        android.view.WindowRelayoutResult mRelayoutResult;
        ...
        private void resizePreview(android.graphics.Rect p0) {}
        private void sendTransformSurfaceControl() {}
        private void setPrimaryWallpaperColors(android.app.WallpaperColors p0) {}
        private boolean showScreenshotOfWallpaper() { return false; }
        private void unfreeze() {}
        private void updateFrozenState(boolean p0) {}
        private void updatePageColors(android.service.wallpaper.EngineWindowPage p0, java.util.Set<android.graphics.RectF> p1, int p2, int p3, float p4) {}
        private void updateWallpaperDimming(float p0, float p1) {}
        ...
        public android.app.WallpaperColors computeColorsWithDim(float p0) { return null; }
        public void detach() {}
        ...
        public android.app.wallpaper.WallpaperDescription onApplyWallpaper(int p0) { return null; }
        ...
        public void onDestroy() {}
        public void onDimAmountChanged(float p0) {}
        ...
        void updateSurface(boolean p0, int p1, boolean p2) {}
    ...
    class IWallpaperEngineWrapper extends android.service.wallpaper.IWallpaperEngine.Stub implements com.android.internal.os.HandlerCaller.Callback {
        ...
        final android.app.wallpaper.WallpaperDescription mDescription = null;
        ...
        final android.app.WallpaperInfo mInfo = null;
        final boolean mIsPreview = false;
        final java.util.concurrent.atomic.AtomicInteger mPendingResizeCount = null;
        final java.util.concurrent.atomic.AtomicInteger mPendingSeqId = null;
        boolean mReportDraw;
        int mReqHeight;
        int mReqWidth;
