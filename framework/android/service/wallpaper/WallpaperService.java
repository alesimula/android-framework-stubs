...
public abstract class WallpaperService extends android.app.Service {
    ...
    public class Engine {
        ...
        @android.annotation.FlaggedApi("com.android.window.flags.offload_color_extraction")
    ...
    class IWallpaperEngineWrapper extends android.service.wallpaper.IWallpaperEngine.Stub implements com.android.internal.os.HandlerCaller.Callback {
        ...
        int mWhich;
        IWallpaperEngineWrapper(android.service.wallpaper.WallpaperService p0, android.service.wallpaper.WallpaperService p1, android.service.wallpaper.IWallpaperConnection p2, android.os.IBinder p3, int p4, boolean p5, int p6, int p7, android.graphics.Rect p8, int p9, int p10, android.app.WallpaperInfo p11) { super(); }
    ...
    class IWallpaperServiceWrapper extends android.service.wallpaper.IWallpaperService.Stub {
        ...
        public void attach(android.service.wallpaper.IWallpaperConnection p0, android.os.IBinder p1, int p2, boolean p3, int p4, int p5, android.graphics.Rect p6, int p7, int p8, android.app.WallpaperInfo p9) {}
