...
public class HealthConnectManager {
    ...
    @android.annotation.FlaggedApi("com.android.healthfitness.flags.cloud_backup_and_restore_intent_api")
    public static final java.lang.String ACTION_SHOW_HEALTH_CONNECT_BACKUP_SETTINGS = "android.health.connect.action.SHOW_HEALTH_CONNECT_BACKUP_SETTINGS";
    public static final java.lang.String ACTION_SHOW_MIGRATION_INFO = "android.health.connect.action.SHOW_MIGRATION_INFO";
    @android.annotation.FlaggedApi("com.android.healthfitness.flags.launch_onboarding_activity")
    public static final java.lang.String ACTION_SHOW_ONBOARDING = "android.health.connect.action.SHOW_ONBOARDING";
    ...
    public void canRestore(int p0, java.util.concurrent.Executor p1, android.os.OutcomeReceiver<java.lang.Boolean, android.health.connect.HealthConnectException> p2) {}
    @android.annotation.FlaggedApi("com.android.healthfitness.flags.personal_health_record")
    public void createMedicalDataSource(android.health.connect.CreateMedicalDataSourceRequest p0, java.util.concurrent.Executor p1, android.os.OutcomeReceiver<android.health.connect.datatypes.MedicalDataSource, android.health.connect.HealthConnectException> p2) {}
    @android.annotation.FlaggedApi("com.android.healthfitness.flags.personal_health_record")
    public void deleteMedicalDataSourceWithData(java.lang.String p0, java.util.concurrent.Executor p1, android.os.OutcomeReceiver<java.lang.Void, android.health.connect.HealthConnectException> p2) {}
    @android.annotation.FlaggedApi("com.android.healthfitness.flags.personal_health_record")
    public void deleteMedicalResources(android.health.connect.DeleteMedicalResourcesRequest p0, java.util.concurrent.Executor p1, android.os.OutcomeReceiver<java.lang.Void, android.health.connect.HealthConnectException> p2) {}
    @android.annotation.FlaggedApi("com.android.healthfitness.flags.personal_health_record")
    public void deleteMedicalResources(java.util.List<android.health.connect.MedicalResourceId> p0, java.util.concurrent.Executor p1, android.os.OutcomeReceiver<java.lang.Void, android.health.connect.HealthConnectException> p2) {}
    ...
    @android.annotation.FlaggedApi("com.android.healthfitness.flags.cloud_backup_and_restore")
    public void getChangesForBackup(java.lang.String p0, java.util.concurrent.Executor p1, android.os.OutcomeReceiver<android.health.connect.backuprestore.GetChangesForBackupResponse, android.health.connect.HealthConnectException> p2) {}
    ...
    @android.annotation.FlaggedApi("com.android.healthfitness.flags.cloud_backup_and_restore")
    public void getLatestMetadataForBackup(java.util.concurrent.Executor p0, android.os.OutcomeReceiver<android.health.connect.backuprestore.GetLatestMetadataForBackupResponse, android.health.connect.HealthConnectException> p1) {}
    @android.annotation.FlaggedApi("com.android.healthfitness.flags.personal_health_record")
    public void getMedicalDataSources(android.health.connect.GetMedicalDataSourcesRequest p0, java.util.concurrent.Executor p1, android.os.OutcomeReceiver<java.util.List<android.health.connect.datatypes.MedicalDataSource>, android.health.connect.HealthConnectException> p2) {}
    @android.annotation.FlaggedApi("com.android.healthfitness.flags.personal_health_record")
    public void getMedicalDataSources(java.util.List<java.lang.String> p0, java.util.concurrent.Executor p1, android.os.OutcomeReceiver<java.util.List<android.health.connect.datatypes.MedicalDataSource>, android.health.connect.HealthConnectException> p2) {}
    ...
    @android.annotation.FlaggedApi("com.android.healthfitness.flags.personal_health_record")
    public void queryAllMedicalResourceTypeInfos(java.util.concurrent.Executor p0, android.os.OutcomeReceiver<java.util.List<android.health.connect.MedicalResourceTypeInfo>, android.health.connect.HealthConnectException> p1) {}
    ...
    @android.annotation.FlaggedApi("com.android.healthfitness.flags.personal_health_record")
    public void readMedicalResources(android.health.connect.ReadMedicalResourcesRequest p0, java.util.concurrent.Executor p1, android.os.OutcomeReceiver<android.health.connect.ReadMedicalResourcesResponse, android.health.connect.HealthConnectException> p2) {}
    @android.annotation.FlaggedApi("com.android.healthfitness.flags.personal_health_record")
    public void readMedicalResources(java.util.List<android.health.connect.MedicalResourceId> p0, java.util.concurrent.Executor p1, android.os.OutcomeReceiver<java.util.List<android.health.connect.datatypes.MedicalResource>, android.health.connect.HealthConnectException> p2) {}
    ...
    @android.annotation.FlaggedApi("com.android.healthfitness.flags.cloud_backup_and_restore")
    public void restoreChanges(java.util.List<android.health.connect.backuprestore.RestoreChange> p0, java.util.concurrent.Executor p1, android.os.OutcomeReceiver<java.lang.Void, android.health.connect.HealthConnectException> p2) {}
    @android.annotation.FlaggedApi("com.android.healthfitness.flags.cloud_backup_and_restore")
    public void restoreLatestMetadata(android.health.connect.backuprestore.BackupMetadata p0, java.util.concurrent.Executor p1, android.os.OutcomeReceiver<java.lang.Void, android.health.connect.HealthConnectException> p2) {}
    ...
    @android.annotation.FlaggedApi("com.android.healthfitness.flags.personal_health_record")
    public void upsertMedicalResources(java.util.List<android.health.connect.UpsertMedicalResourceRequest> p0, java.util.concurrent.Executor p1, android.os.OutcomeReceiver<java.util.List<android.health.connect.datatypes.MedicalResource>, android.health.connect.HealthConnectException> p2) {}
