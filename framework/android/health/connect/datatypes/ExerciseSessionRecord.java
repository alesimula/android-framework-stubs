...
public final class ExerciseSessionRecord extends android.health.connect.datatypes.IntervalRecord {
    ...
    @android.annotation.Nullable
    public java.lang.String getPlannedExerciseSessionId() { return null; }
    ...
    public static final class Builder {
        ...
        @android.annotation.FlaggedApi("com.android.healthfitness.flags.exercise_segment_improvements")
        @android.annotation.NonNull
        public android.health.connect.datatypes.ExerciseSessionRecord.Builder clearRateOfPerceivedExertion() { return null; }
        @android.annotation.NonNull
        ...
        @android.annotation.FlaggedApi("com.android.healthconnect.flags.training_plans")
        @android.annotation.NonNull
        public android.health.connect.datatypes.ExerciseSessionRecord.Builder setPlannedExerciseSessionId(java.lang.String p0) { return null; }
        @android.annotation.FlaggedApi("com.android.healthfitness.flags.exercise_segment_improvements")
        @android.annotation.NonNull
        public android.health.connect.datatypes.ExerciseSessionRecord.Builder setRateOfPerceivedExertion(float p0) { return null; }
        @android.annotation.NonNull
