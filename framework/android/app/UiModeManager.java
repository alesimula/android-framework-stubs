...
public class UiModeManager {
    ...
    @android.annotation.FlaggedApi("android.app.enable_current_mode_type_binder_cache")
    ...
    @android.annotation.FlaggedApi("android.app.enable_night_mode_binder_cache")
    ...
    private static class Globals extends android.app.IUiModeManagerCallback.Stub {
        Globals(android.app.IUiModeManager p0) { super(); }
        public void notifyForceInvertStateChanged(int p0) {}
        public void notifyContrastChanged(float p0) {}
    }
