...
public interface IApplicationThread extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.IApplicationThread {
        ...
        static final int TRANSACTION_dumpBitmapsProto = 35;
        ...
        static final int TRANSACTION_scheduleLocalVoiceInteractionStarted = 49;
        static final int TRANSACTION_handleTrustStorageUpdate = 50;
        static final int TRANSACTION_attachAgent = 51;
        static final int TRANSACTION_attachStartupAgents = 52;
        static final int TRANSACTION_scheduleApplicationInfoChanged = 53;
        static final int TRANSACTION_setNetworkBlockSeq = 54;
        static final int TRANSACTION_scheduleTransaction = 55;
        static final int TRANSACTION_scheduleTaskFragmentTransaction = 56;
        ...
        static final int TRANSACTION_scheduleTimeoutServiceForType = 63;
        static final int TRANSACTION_schedulePing = 64;
        static final int TRANSACTION_getExecutableMethodFileOffsets = 65;
        public Stub() { super(); }
