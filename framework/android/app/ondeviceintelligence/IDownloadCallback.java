...
public interface IDownloadCallback extends android.os.IInterface {
    ...
    public void onDownloadStarted(long p0) throws android.os.RemoteException;
    public void onDownloadProgress(long p0) throws android.os.RemoteException;
    public void onDownloadFailed(int p0, java.lang.String p1, android.os.PersistableBundle p2) throws android.os.RemoteException;
    public void onDownloadCompleted(android.os.PersistableBundle p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.ondeviceintelligence.IDownloadCallback {
        ...
        public Stub() { super(); }
        public static android.app.ondeviceintelligence.IDownloadCallback asInterface(android.os.IBinder p0) { return null; }
        public android.os.IBinder asBinder() { return null; }
