...
public interface IAlarmManager extends android.os.IInterface {
    ...
    public long getPrioritizedAlarmDelay() throws android.os.RemoteException;
    ...
    public static class Default implements android.app.IAlarmManager {
        ...
        public long getPrioritizedAlarmDelay() throws android.os.RemoteException { return 0L; }
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.IAlarmManager {
        ...
        static final int TRANSACTION_getPrioritizedAlarmDelay = 11;
        ...
        private static final class Proxy implements android.app.IAlarmManager {
