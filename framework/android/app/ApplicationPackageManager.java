...
public class ApplicationPackageManager extends android.content.pm.PackageManager {
    ...
    private final java.util.Map<android.content.pm.PackageManager.OnPermissionsChangedListener, android.permission.IOnPermissionsChangeListener> mPermissionListeners = null;
    ...
    protected ApplicationPackageManager(android.app.ContextImpl p0, android.content.pm.IPackageManager p1, android.permission.IPermissionManager p2) { super(); }
    ...
    public class OnPermissionsChangeListenerDelegate extends android.permission.IOnPermissionsChangeListener.Stub implements android.os.Handler.Callback {
        private static final int MSG_PERMISSIONS_CHANGED = 1;
        private final android.content.pm.PackageManager.OnPermissionsChangedListener mListener = null;
        private final android.os.Handler mHandler = null;
        public OnPermissionsChangeListenerDelegate(android.app.ApplicationPackageManager p0, android.content.pm.PackageManager.OnPermissionsChangedListener p1, android.os.Looper p2) { super(); }
