...
public class ApplicationPackageManager extends android.content.pm.PackageManager {
    ...
    private static final java.lang.String CACHE_KEY_PACKAGES_FOR_UID_API = "get_packages_for_uid";
    private static final java.lang.String CACHE_KEY_QUERY_INTENT_ACTIVITIES_API = "query_intent_activities";
    ...
    private static final java.lang.String HAS_SYSTEM_FEATURE_API = "has_system_feature";
    ...
    public static final android.app.PropertyInvalidatedCache<java.lang.Integer, android.app.ApplicationPackageManager.GetPackagesForUidResult> sGetPackagesForUidCache = null;
    ...
    public static final android.app.PropertyInvalidatedCache<android.app.ApplicationPackageManager.IntentActivitiesQuery, java.util.List<android.content.pm.ResolveInfo>> sQueryIntentActivitiesCache = null;
    ...
    private final android.util.ArraySet<android.os.IRemoteCallback> mPackageMonitorCallbacks = null;
    ...
    private final boolean mUseSystemFeaturesCache = false;
    ...
    private static android.content.res.XmlResourceParser getAndroidManifestParser(android.os.ParcelFileDescriptor p0) throws java.io.IOException { return null; }
    private static android.content.res.XmlResourceParser getAndroidManifestParser(java.io.File p0) throws java.io.IOException { return null; }
    private android.graphics.drawable.Drawable getArchivedAppIcon(java.lang.String p0) { return null; }
    ...
    private android.graphics.drawable.Drawable getDefaultUserBadgeForDensity(android.os.UserHandle p0, int p1) { return null; }
    private android.graphics.drawable.Drawable getDefaultUserBadgeNoBackgroundForDensity(android.os.UserHandle p0, int p1) { return null; }
    private android.graphics.drawable.Drawable getDefaultUserIconBadge(android.os.UserHandle p0) { return null; }
    private android.graphics.drawable.Drawable getDrawableForDensity(int p0, int p1) { return null; }
    private android.content.pm.InstrumentationInfo getInstrumentationInfo$ravenwood(android.content.ComponentName p0, int p1) { return null; }
    ...
    private java.lang.String getUpdatableUserBadgeId(android.os.UserHandle p0) { return null; }
    ...
    private static boolean isSystemFeaturesCacheAvailable() { return false; }
    ...
    private static final class HasSystemFeatureQuery {
        ...
        private HasSystemFeatureQuery(java.lang.String p0, int p1) {}
    ...
    private static final class IntentActivitiesQuery {
        final long mFlags = 0L;
        final android.content.Intent mIntent = null;
        final java.lang.String mResolvedType = null;
        final int mUserId = 0;
        IntentActivitiesQuery(android.content.Intent p0, java.lang.String p1, long p2, int p3) {}
        public boolean equals(java.lang.Object p0) { return false; }
        public int hashCode() { return 0; }
    }
