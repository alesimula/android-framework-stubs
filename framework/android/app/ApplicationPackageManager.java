...
public class ApplicationPackageManager extends android.content.pm.PackageManager {
    ...
    public static final int[] CORP_BADGE_LABEL_RES_ID = null;
    ...
    private final java.util.Map<android.content.pm.PackageManager.OnPermissionsChangedListener, android.content.pm.IOnPermissionsChangeListener> mPermissionListeners = null;
    ...
    private int getUserBadgeColor(android.os.UserHandle p0) { return 0; }
    ...
    private android.graphics.drawable.Drawable getManagedProfileIconForDensity(android.os.UserHandle p0, int p1, int p2) { return null; }
