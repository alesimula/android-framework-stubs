...
public final class WearSettingsEnums {
    ...
    public static final int ADVANCE_PERMISSIONS_ALL_FILES_ACCESS = 541;
    ...
    public static final int APPS_NOTIFICATIONS = 569;
    public static final int APPS_NOTIF_APP_LIST = 572;
    public static final int APPS_NOTIF_DETAILS_CHANNEL = 573;
    public static final int APPS_NOTIF_DETAILS_CHANNEL_SWITCH = 574;
    public static final int APPS_NOTIF_DETAILS_LIVE_UPDATES_SWITCH = 575;
    public static final int APPS_NOTIF_DETAILS_PRIMARY = 576;
    public static final int APPS_SHOW_NEW_NOTIFICATIONS = 559;
    public static final int APPS_VIP_CONTACTS = 343;
    public static final int APP_APP_FILTER_LIST = 560;
    public static final int APP_APP_INFO = 561;
    public static final int APP_APP_INFO_DETAILS_ABOUT = 571;
    public static final int APP_APP_INFO_DETAILS_ABOUT_CACHE = 578;
    public static final int APP_APP_INFO_DETAILS_ABOUT_CLEAR_CACHE = 579;
    public static final int APP_APP_INFO_DETAILS_ABOUT_CLEAR_DATA = 580;
    public static final int APP_APP_INFO_DETAILS_ABOUT_CLEAR_DATA_MANAGED = 581;
    public static final int APP_APP_INFO_DETAILS_ABOUT_DATA = 582;
    public static final int APP_APP_INFO_DETAILS_ABOUT_LICENSES = 583;
    public static final int APP_APP_INFO_DETAILS_ABOUT_STORAGE = 584;
    public static final int APP_APP_INFO_DETAILS_ABOUT_VERSION = 585;
    public static final int APP_APP_STORAGE_SORT = 586;
    ...
    public static final int APP_UNUSED_APPS = 562;
    ...
    public static final int BATTERY_HEALTH_ASSISTANCE = 542;
    ...
    public static final int BATTERY_SHOW_PERCENTAGE = 531;
    public static final int BATTERY_STATUS = 588;
    ...
    public static final int BRIGHTNESS_BRIGHTNESS_SLIDER = 570;
    ...
    public static final int CELLULAR_SATELLITE_TOGGLE = 556;
    ...
    public static final int CHANGE_WATCH_FACE = 589;
    public static final int CHARGING_SOUNDS = 428;
    public static final int CONNECTIVITY_AIRPLANE_MODE = 120;
    public static final int CONNECTIVITY_AIRPLANE_MODE_SETTINGS = 543;
    public static final int CONNECTIVITY_AIRPLANE_MODE_SYNC = 544;
    ...
    public static final int DEVELOPER_NFC_SNOOP_LOG = 551;
    public static final int DEVELOPER_NFC_VERBOSE_VENDOR = 550;
    ...
    public static final int DISPLAY_NOTIFICATION_AFTER_WRIST_RAISE = 547;
    public static final int DISPLAY_NOTIFICATION_IMMEDIATELY = 548;
    ...
    public static final int DND_OPTIONS_ALARMS_SOUND = 552;
    public static final int DND_OPTIONS_ALARMS_VIBRATION = 553;
    ...
    public static final int ENABLE_SUPERVISION = 549;
    ...
    public static final int FIND_MY_DEVICE = 599;
    ...
    public static final int HEALTH_CALIBRATE = 590;
    public static final int HEALTH_CRANK_LENGTH = 591;
    public static final int HEALTH_DEVICE_TYPE = 592;
    public static final int HEALTH_DISCONNECT = 593;
    public static final int HEALTH_FORGET = 594;
    public static final int HEALTH_GENDER = 384;
    public static final int HEALTH_HEIGHT = 386;
    public static final int HEALTH_MAC_ADDRESS = 595;
    public static final int HEALTH_WEIGHT = 385;
    public static final int HEALTH_WHEEL_SIZE = 596;
    public static final int HIGH_BRIGHTNESS_KEY = 454;
    public static final int INPUT_ADD_VIRTUAL_KEYBOARD_SCREEN = 317;
    public static final int INPUT_AVAILABLE_VIRTUAL_KEYBOARDS = 597;
    public static final int INPUT_ENABLED_INPUT_METHODS_GROUP = 598;
    public static final int INPUT_PHYSICAL_KEYBOARD = 545;
    public static final int INPUT_SMART_REPLY = 253;
    public static final int LANGUAGE_PREFERENCE = 474;
    public static final int LE_ASSISTANT = 587;
    public static final int LOCALE_ON_DEVICE = 601;
    ...
    public static final int LOCATION_OPEN_ON_PHONE = 568;
    public static final int LOCATION_PERMISSION_APPS = 372;
    public static final int LOCATION_SERVICES = 577;
    ...
    public static final int ONE_HANDED_GESTURES = 532;
    public static final int ONE_HANDED_GESTURES_ALWAYS_ON_MEDIA = 606;
    public static final int ONE_HANDED_GESTURES_DISMISS_ACTION = 534;
    public static final int ONE_HANDED_GESTURES_EDUCATION = 535;
    public static final int ONE_HANDED_GESTURES_EDUCATION_GAME = 546;
    public static final int ONE_HANDED_GESTURES_EXTERNAL_DEVICE_CONTROL = 604;
    public static final int ONE_HANDED_GESTURES_HINTS_CADENCE_ALWAYS = 536;
    public static final int ONE_HANDED_GESTURES_HINTS_CADENCE_DAILY = 537;
    public static final int ONE_HANDED_GESTURES_HINTS_CADENCE_MONTHLY = 539;
    public static final int ONE_HANDED_GESTURES_HINTS_CADENCE_ONCE = 540;
    public static final int ONE_HANDED_GESTURES_HINTS_CADENCE_WEEKLY = 538;
    public static final int ONE_HANDED_GESTURES_HINTS_FREQUENCY = 605;
    public static final int ONE_HANDED_GESTURES_PRIMARY_ACTION = 533;
    ...
    public static final int PRIORITY_MODES_CUSTOMIZE_ALARMS_SOUND = 554;
    public static final int PRIORITY_MODES_CUSTOMIZE_ALARMS_VIBRATION = 555;
    public static final int PRIORITY_MODES_CUSTOMIZE_DISPLAY_CONTROL = 603;
    ...
    public static final int PRIORITY_MODES_DND_CUSTOMIZE_ALARM = 602;
    ...
    public static final int TRUST_AGENTS = 558;
    public static final int UNKNOWN = 0;
    public static final int USAGE_ACCESS = 470;
    public static final int USE_READ_SCREEN_CONTEXT = 557;
    ...
    public static final int VIBRATION_ALARM_VIBRATION = 566;
    public static final int VIBRATION_CALL_VIBRATION = 564;
    public static final int VIBRATION_LEVEL = 268;
    public static final int VIBRATION_MUTE_WHEN_OFF_BODY = 318;
    public static final int VIBRATION_NOTIFICATIONS_VIBRATION = 565;
    public static final int VIBRATION_SWITCH = 487;
    public static final int VIBRATION_TOUCH_VIBRATION = 567;
    public static final int VIBRATION_VIBRATE_FOR_CALLS = 267;
    public static final int VIBRATION_VIBRATE_FOR_RSB = 389;
    public static final int VIBRATION_WATCH_TYPE = 563;
