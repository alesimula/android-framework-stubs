...
public class DevicePolicyManager {
    ...
    @android.annotation.SystemApi
    @android.annotation.FlaggedApi("android.app.supervision.flags.enable_lock_task_feature_quick_settings")
    ...
    @android.annotation.FlaggedApi("android.app.admin.flags.set_auto_time_enabled_coexistence")
    ...
    @android.annotation.FlaggedApi("android.app.admin.flags.set_auto_time_zone_enabled_coexistence")
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_MTE", conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_CONTENT_PROTECTION", conditional=true)
    @android.annotation.FlaggedApi("android.view.contentprotection.flags.manage_device_policy_enabled")
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_APP_FUNCTIONS", conditional=true)
    @android.annotation.FlaggedApi("android.app.appfunctions.flags.enable_app_function_manager")
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_LOCK_CREDENTIALS", conditional=true)
    ...
    @android.annotation.RequiresPermission(anyOf={"android.permission.MANAGE_DEVICE_POLICY_LOCK_CREDENTIALS", "android.permission.REQUEST_PASSWORD_COMPLEXITY"}, conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_WIPE_DATA", conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_RESET_PASSWORD", conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_LOCK", conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.LOCK_DEVICE", conditional=true)
    public void lockNow() {}
    @android.annotation.RequiresPermission(value="android.permission.LOCK_DEVICE", conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_FACTORY_RESET", conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_CERTIFICATES", conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_CAMERA", conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_SCREEN_CAPTURE", conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.SET_TIME", conditional=true)
    public void setAutoTimeEnabled(android.content.ComponentName p0, boolean p1) {}
    @android.annotation.RequiresPermission(anyOf={"android.permission.SET_TIME", "android.permission.QUERY_ADMIN_POLICY"}, conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.SET_TIME_ZONE", conditional=true)
    public void setAutoTimeZoneEnabled(android.content.ComponentName p0, boolean p1) {}
    @android.annotation.RequiresPermission(anyOf={"android.permission.SET_TIME_ZONE", "android.permission.QUERY_ADMIN_POLICY"}, conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_KEYGUARD", conditional=true)
    ...
    @android.annotation.RequiresPermission(allOf={"android.permission.MANAGE_DEVICE_ADMINS", "android.permission.INTERACT_ACROSS_USERS_FULL"})
    @android.annotation.FlaggedApi("android.app.admin.flags.provisioning_context_parameter")
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_PACKAGE_STATE", conditional=true)
    @android.annotation.NonNull
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_LOCK_TASK", conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_DEFAULT_SMS", conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_PROFILE_INTERACTION", conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_INPUT_METHODS", conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_ACCOUNT_MANAGEMENT", conditional=true)
    ...
    @java.lang.Deprecated
    @android.annotation.SystemApi
    @android.annotation.FlaggedApi("android.app.admin.flags.secondary_lockscreen_api_enabled")
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_WIFI", conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_APPS_CONTROL", conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_SYSTEM_UPDATES", conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_STATUS_BAR", conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_QUERY_SYSTEM_UPDATES", conditional=true)
    @android.annotation.SuppressLint("RequiresPermission")
    @android.annotation.Nullable
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_RUNTIME_PERMISSIONS", conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_SUPPORT_MESSAGE", conditional=true)
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_SECURITY_LOGGING", conditional=true)
    ...
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission("android.permission.MANAGE_DEVICE_POLICY_AUDIT_LOGGING")
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_ORGANIZATION_IDENTITY", conditional=true)
    ...
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission("android.permission.MANAGE_DEVICE_POLICY_APP_EXEMPTIONS")
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_COMMON_CRITERIA_MODE", conditional=true)
    ...
    @android.annotation.SystemApi
    @android.annotation.FlaggedApi("android.app.admin.flags.remove_managed_profile_enabled")
    @android.annotation.RequiresPermission("android.permission.MANAGE_PROFILE_AND_DEVICE_OWNERS")
    ...
    @android.annotation.RequiresPermission(value="android.permission.MANAGE_DEVICE_POLICY_USB_DATA_SIGNALLING", conditional=true)
    ...
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission("android.permission.QUERY_DEVICE_STOLEN_STATE")
    ...
    @android.annotation.RequiresPermission("android.permission.MANAGE_DEVICE_POLICY_MANAGED_SUBSCRIPTIONS")
    @android.annotation.NonNull
    ...
    @android.annotation.RequiresPermission("android.permission.MANAGE_DEVICE_POLICY_STORAGE_LIMIT")
