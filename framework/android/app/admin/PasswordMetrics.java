...
public final class PasswordMetrics implements android.os.Parcelable {
    ...
    public static java.util.List<com.android.internal.widget.PasswordValidationError> validatePasswordMetrics(android.app.admin.PasswordMetrics p0, int p1, boolean p2, android.app.admin.PasswordMetrics p3) { return null; }
    ...
    private static enum ComplexityBucket {
        ...
        boolean allowsNumericPassword() { return false; }
