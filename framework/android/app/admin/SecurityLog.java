...
public class SecurityLog {
    ...
    @android.annotation.FlaggedApi("android.app.admin.flags.backup_service_security_log_event_enabled")
    ...
    @android.annotation.RequiresPermission("android.permission.WRITE_SECURITY_LOG")
    ...
    public static final class SecurityEvent implements android.os.Parcelable {
        ...
        public java.lang.String getStringData(int p0) { return null; }
        public void setId(long p0) {}
        public long getId() { return 0L; }
        public int getLogLevel() { return 0; }
        public android.app.admin.SecurityLog.SecurityEvent redact(int p0) { return null; }
