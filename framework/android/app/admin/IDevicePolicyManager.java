...
public interface IDevicePolicyManager extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.admin.IDevicePolicyManager {
        ...
        static final int TRANSACTION_setUserRestrictionForUser = 135;
        static final int TRANSACTION_setUserRestrictionGlobally = 136;
        static final int TRANSACTION_setUserRestrictionGloballyFromSystem = 137;
        static final int TRANSACTION_getUserRestrictions = 138;
        static final int TRANSACTION_getUserRestrictionsGlobally = 139;
        static final int TRANSACTION_addCrossProfileIntentFilter = 140;
        static final int TRANSACTION_clearCrossProfileIntentFilters = 141;
        static final int TRANSACTION_setPermittedAccessibilityServices = 142;
        static final int TRANSACTION_getPermittedAccessibilityServices = 143;
        static final int TRANSACTION_getPermittedAccessibilityServicesForUser = 144;
        static final int TRANSACTION_isAccessibilityServicePermittedByAdmin = 145;
        static final int TRANSACTION_setPermittedInputMethods = 146;
        static final int TRANSACTION_getPermittedInputMethods = 147;
        static final int TRANSACTION_getPermittedInputMethodsAsUser = 148;
        static final int TRANSACTION_isInputMethodPermittedByAdmin = 149;
        static final int TRANSACTION_setPermittedCrossProfileNotificationListeners = 150;
        static final int TRANSACTION_getPermittedCrossProfileNotificationListeners = 151;
        static final int TRANSACTION_isNotificationListenerServicePermitted = 152;
        static final int TRANSACTION_createAdminSupportIntent = 153;
        static final int TRANSACTION_getEnforcingAdminAndUserDetails = 154;
        static final int TRANSACTION_getEnforcingAdmin = 155;
        static final int TRANSACTION_setApplicationHidden = 156;
        static final int TRANSACTION_isApplicationHidden = 157;
        static final int TRANSACTION_createAndManageUser = 158;
        static final int TRANSACTION_removeUser = 159;
        static final int TRANSACTION_switchUser = 160;
        static final int TRANSACTION_startUserInBackground = 161;
        static final int TRANSACTION_stopUser = 162;
        static final int TRANSACTION_logoutUser = 163;
        static final int TRANSACTION_logoutUserInternal = 164;
        static final int TRANSACTION_getLogoutUserId = 165;
        static final int TRANSACTION_getSecondaryUsers = 166;
        static final int TRANSACTION_acknowledgeNewUserDisclaimer = 167;
        static final int TRANSACTION_isNewUserDisclaimerAcknowledged = 168;
        static final int TRANSACTION_enableSystemApp = 169;
        static final int TRANSACTION_enableSystemAppWithIntent = 170;
        static final int TRANSACTION_installExistingPackage = 171;
        static final int TRANSACTION_setAccountManagementDisabled = 172;
        static final int TRANSACTION_getAccountTypesWithManagementDisabled = 173;
        static final int TRANSACTION_getAccountTypesWithManagementDisabledAsUser = 174;
        static final int TRANSACTION_setSecondaryLockscreenEnabled = 175;
        static final int TRANSACTION_isSecondaryLockscreenEnabled = 176;
        static final int TRANSACTION_setPreferentialNetworkServiceConfigs = 177;
        static final int TRANSACTION_getPreferentialNetworkServiceConfigs = 178;
        static final int TRANSACTION_setLockTaskPackages = 179;
        static final int TRANSACTION_getLockTaskPackages = 180;
        static final int TRANSACTION_isLockTaskPermitted = 181;
        static final int TRANSACTION_setLockTaskFeatures = 182;
        static final int TRANSACTION_getLockTaskFeatures = 183;
        static final int TRANSACTION_setGlobalSetting = 184;
        static final int TRANSACTION_setSystemSetting = 185;
        static final int TRANSACTION_setSecureSetting = 186;
        static final int TRANSACTION_setConfiguredNetworksLockdownState = 187;
        static final int TRANSACTION_hasLockdownAdminConfiguredNetworks = 188;
        static final int TRANSACTION_setLocationEnabled = 189;
        static final int TRANSACTION_setTime = 190;
        static final int TRANSACTION_setTimeZone = 191;
        static final int TRANSACTION_setMasterVolumeMuted = 192;
        static final int TRANSACTION_isMasterVolumeMuted = 193;
        static final int TRANSACTION_notifyLockTaskModeChanged = 194;
        static final int TRANSACTION_setUninstallBlocked = 195;
        static final int TRANSACTION_isUninstallBlocked = 196;
        static final int TRANSACTION_setCrossProfileCallerIdDisabled = 197;
        static final int TRANSACTION_getCrossProfileCallerIdDisabled = 198;
        static final int TRANSACTION_getCrossProfileCallerIdDisabledForUser = 199;
        static final int TRANSACTION_setCrossProfileContactsSearchDisabled = 200;
        static final int TRANSACTION_getCrossProfileContactsSearchDisabled = 201;
        static final int TRANSACTION_getCrossProfileContactsSearchDisabledForUser = 202;
        static final int TRANSACTION_startManagedQuickContact = 203;
        static final int TRANSACTION_setManagedProfileCallerIdAccessPolicy = 204;
        static final int TRANSACTION_getManagedProfileCallerIdAccessPolicy = 205;
        static final int TRANSACTION_hasManagedProfileCallerIdAccess = 206;
        static final int TRANSACTION_setCredentialManagerPolicy = 207;
        static final int TRANSACTION_getCredentialManagerPolicy = 208;
        static final int TRANSACTION_setManagedProfileContactsAccessPolicy = 209;
        static final int TRANSACTION_getManagedProfileContactsAccessPolicy = 210;
        static final int TRANSACTION_hasManagedProfileContactsAccess = 211;
        static final int TRANSACTION_setBluetoothContactSharingDisabled = 212;
        static final int TRANSACTION_getBluetoothContactSharingDisabled = 213;
        static final int TRANSACTION_getBluetoothContactSharingDisabledForUser = 214;
        static final int TRANSACTION_setTrustAgentConfiguration = 215;
        static final int TRANSACTION_getTrustAgentConfiguration = 216;
        static final int TRANSACTION_addCrossProfileWidgetProvider = 217;
        static final int TRANSACTION_removeCrossProfileWidgetProvider = 218;
        static final int TRANSACTION_getCrossProfileWidgetProviders = 219;
        static final int TRANSACTION_setAutoTimeRequired = 220;
        static final int TRANSACTION_getAutoTimeRequired = 221;
        static final int TRANSACTION_setAutoTimeEnabled = 222;
        static final int TRANSACTION_getAutoTimeEnabled = 223;
        static final int TRANSACTION_setAutoTimePolicy = 224;
        static final int TRANSACTION_getAutoTimePolicy = 225;
        static final int TRANSACTION_setAutoTimeZoneEnabled = 226;
        static final int TRANSACTION_getAutoTimeZoneEnabled = 227;
        static final int TRANSACTION_setAutoTimeZonePolicy = 228;
        static final int TRANSACTION_getAutoTimeZonePolicy = 229;
        static final int TRANSACTION_setForceEphemeralUsers = 230;
        static final int TRANSACTION_getForceEphemeralUsers = 231;
        static final int TRANSACTION_isRemovingAdmin = 232;
        static final int TRANSACTION_setUserIcon = 233;
        static final int TRANSACTION_setSystemUpdatePolicy = 234;
        static final int TRANSACTION_getSystemUpdatePolicy = 235;
        static final int TRANSACTION_clearSystemUpdatePolicyFreezePeriodRecord = 236;
        static final int TRANSACTION_setKeyguardDisabled = 237;
        static final int TRANSACTION_setStatusBarDisabled = 238;
        static final int TRANSACTION_isStatusBarDisabled = 239;
        static final int TRANSACTION_getDoNotAskCredentialsOnBoot = 240;
        static final int TRANSACTION_notifyPendingSystemUpdate = 241;
        static final int TRANSACTION_getPendingSystemUpdate = 242;
        static final int TRANSACTION_setPermissionPolicy = 243;
        static final int TRANSACTION_getPermissionPolicy = 244;
        static final int TRANSACTION_setPermissionGrantState = 245;
        static final int TRANSACTION_getPermissionGrantState = 246;
        static final int TRANSACTION_isProvisioningAllowed = 247;
        static final int TRANSACTION_checkProvisioningPrecondition = 248;
        static final int TRANSACTION_setKeepUninstalledPackages = 249;
        static final int TRANSACTION_getKeepUninstalledPackages = 250;
        static final int TRANSACTION_isManagedProfile = 251;
        static final int TRANSACTION_getWifiMacAddress = 252;
        static final int TRANSACTION_reboot = 253;
        static final int TRANSACTION_setShortSupportMessage = 254;
        static final int TRANSACTION_getShortSupportMessage = 255;
        static final int TRANSACTION_setLongSupportMessage = 256;
        static final int TRANSACTION_getLongSupportMessage = 257;
        static final int TRANSACTION_getShortSupportMessageForUser = 258;
        static final int TRANSACTION_getLongSupportMessageForUser = 259;
        static final int TRANSACTION_setOrganizationColor = 260;
        static final int TRANSACTION_setOrganizationColorForUser = 261;
        static final int TRANSACTION_clearOrganizationIdForUser = 262;
        static final int TRANSACTION_getOrganizationColor = 263;
        static final int TRANSACTION_getOrganizationColorForUser = 264;
        static final int TRANSACTION_setOrganizationName = 265;
        static final int TRANSACTION_getOrganizationName = 266;
        static final int TRANSACTION_getDeviceOwnerOrganizationName = 267;
        static final int TRANSACTION_getOrganizationNameForUser = 268;
        static final int TRANSACTION_getUserProvisioningState = 269;
        static final int TRANSACTION_setUserProvisioningState = 270;
        static final int TRANSACTION_setAffiliationIds = 271;
        static final int TRANSACTION_getAffiliationIds = 272;
        static final int TRANSACTION_isCallingUserAffiliated = 273;
        static final int TRANSACTION_isAffiliatedUser = 274;
        static final int TRANSACTION_setSecurityLoggingEnabled = 275;
        static final int TRANSACTION_isSecurityLoggingEnabled = 276;
        static final int TRANSACTION_retrieveSecurityLogs = 277;
        static final int TRANSACTION_retrievePreRebootSecurityLogs = 278;
        static final int TRANSACTION_forceNetworkLogs = 279;
        static final int TRANSACTION_forceSecurityLogs = 280;
        static final int TRANSACTION_setAuditLogEnabled = 281;
        static final int TRANSACTION_isAuditLogEnabled = 282;
        static final int TRANSACTION_setAuditLogEventsCallback = 283;
        static final int TRANSACTION_isUninstallInQueue = 284;
        static final int TRANSACTION_uninstallPackageWithActiveAdmins = 285;
        static final int TRANSACTION_isDeviceProvisioned = 286;
        static final int TRANSACTION_isDeviceProvisioningConfigApplied = 287;
        static final int TRANSACTION_setDeviceProvisioningConfigApplied = 288;
        static final int TRANSACTION_forceUpdateUserSetupComplete = 289;
        static final int TRANSACTION_setBackupServiceEnabled = 290;
        static final int TRANSACTION_isBackupServiceEnabled = 291;
        static final int TRANSACTION_setNetworkLoggingEnabled = 292;
        static final int TRANSACTION_isNetworkLoggingEnabled = 293;
        static final int TRANSACTION_retrieveNetworkLogs = 294;
        static final int TRANSACTION_bindDeviceAdminServiceAsUser = 295;
        static final int TRANSACTION_getBindDeviceAdminTargetUsers = 296;
        static final int TRANSACTION_isEphemeralUser = 297;
        static final int TRANSACTION_getLastSecurityLogRetrievalTime = 298;
        static final int TRANSACTION_getLastBugReportRequestTime = 299;
        static final int TRANSACTION_getLastNetworkLogRetrievalTime = 300;
        static final int TRANSACTION_setResetPasswordToken = 301;
        static final int TRANSACTION_clearResetPasswordToken = 302;
        static final int TRANSACTION_isResetPasswordTokenActive = 303;
        static final int TRANSACTION_resetPasswordWithToken = 304;
        static final int TRANSACTION_isCurrentInputMethodSetByOwner = 305;
        static final int TRANSACTION_getOwnerInstalledCaCerts = 306;
        static final int TRANSACTION_clearApplicationUserData = 307;
        static final int TRANSACTION_setLogoutEnabled = 308;
        static final int TRANSACTION_isLogoutEnabled = 309;
        static final int TRANSACTION_getDisallowedSystemApps = 310;
        static final int TRANSACTION_transferOwnership = 311;
        static final int TRANSACTION_getTransferOwnershipBundle = 312;
        static final int TRANSACTION_setStartUserSessionMessage = 313;
        static final int TRANSACTION_setEndUserSessionMessage = 314;
        static final int TRANSACTION_getStartUserSessionMessage = 315;
        static final int TRANSACTION_getEndUserSessionMessage = 316;
        static final int TRANSACTION_setMeteredDataDisabledPackages = 317;
        static final int TRANSACTION_getMeteredDataDisabledPackages = 318;
        static final int TRANSACTION_addOverrideApn = 319;
        static final int TRANSACTION_updateOverrideApn = 320;
        static final int TRANSACTION_removeOverrideApn = 321;
        static final int TRANSACTION_getOverrideApns = 322;
        static final int TRANSACTION_setOverrideApnsEnabled = 323;
        static final int TRANSACTION_isOverrideApnEnabled = 324;
        static final int TRANSACTION_isMeteredDataDisabledPackageForUser = 325;
        static final int TRANSACTION_setGlobalPrivateDns = 326;
        static final int TRANSACTION_getGlobalPrivateDnsMode = 327;
        static final int TRANSACTION_getGlobalPrivateDnsHost = 328;
        static final int TRANSACTION_setProfileOwnerOnOrganizationOwnedDevice = 329;
        static final int TRANSACTION_installUpdateFromFile = 330;
        static final int TRANSACTION_setCrossProfileCalendarPackages = 331;
        static final int TRANSACTION_getCrossProfileCalendarPackages = 332;
        static final int TRANSACTION_isPackageAllowedToAccessCalendarForUser = 333;
        static final int TRANSACTION_getCrossProfileCalendarPackagesForUser = 334;
        static final int TRANSACTION_setCrossProfilePackages = 335;
        static final int TRANSACTION_getCrossProfilePackages = 336;
        static final int TRANSACTION_getAllCrossProfilePackages = 337;
        static final int TRANSACTION_getDefaultCrossProfilePackages = 338;
        static final int TRANSACTION_isManagedKiosk = 339;
        static final int TRANSACTION_isUnattendedManagedKiosk = 340;
        static final int TRANSACTION_startViewCalendarEventInManagedProfile = 341;
        static final int TRANSACTION_setKeyGrantForApp = 342;
        static final int TRANSACTION_getKeyPairGrants = 343;
        static final int TRANSACTION_setKeyGrantToWifiAuth = 344;
        static final int TRANSACTION_isKeyPairGrantedToWifiAuth = 345;
        static final int TRANSACTION_setUserControlDisabledPackages = 346;
        static final int TRANSACTION_getUserControlDisabledPackages = 347;
        static final int TRANSACTION_setCommonCriteriaModeEnabled = 348;
        static final int TRANSACTION_isCommonCriteriaModeEnabled = 349;
        static final int TRANSACTION_getPersonalAppsSuspendedReasons = 350;
        static final int TRANSACTION_setPersonalAppsSuspended = 351;
        static final int TRANSACTION_getManagedProfileMaximumTimeOff = 352;
        static final int TRANSACTION_setManagedProfileMaximumTimeOff = 353;
        static final int TRANSACTION_acknowledgeDeviceCompliant = 354;
        static final int TRANSACTION_isComplianceAcknowledgementRequired = 355;
        static final int TRANSACTION_canProfileOwnerResetPasswordWhenLocked = 356;
        static final int TRANSACTION_setNextOperationSafety = 357;
        static final int TRANSACTION_isSafeOperation = 358;
        static final int TRANSACTION_getEnrollmentSpecificId = 359;
        static final int TRANSACTION_setOrganizationIdForUser = 360;
        static final int TRANSACTION_createAndProvisionManagedProfile = 361;
        static final int TRANSACTION_createManagedProfile = 362;
        static final int TRANSACTION_finalizeCreateManagedProfile = 363;
        static final int TRANSACTION_provisionFullyManagedDevice = 364;
        static final int TRANSACTION_finalizeWorkProfileProvisioning = 365;
        static final int TRANSACTION_removeManagedProfile = 366;
        static final int TRANSACTION_setDeviceOwnerType = 367;
        static final int TRANSACTION_getDeviceOwnerType = 368;
        static final int TRANSACTION_resetDefaultCrossProfileIntentFilters = 369;
        static final int TRANSACTION_canAdminGrantSensorsPermissions = 370;
        static final int TRANSACTION_setUsbDataSignalingEnabled = 371;
        static final int TRANSACTION_isUsbDataSignalingEnabled = 372;
        static final int TRANSACTION_canUsbDataSignalingBeDisabled = 373;
        static final int TRANSACTION_setMinimumRequiredWifiSecurityLevel = 374;
        static final int TRANSACTION_getMinimumRequiredWifiSecurityLevel = 375;
        static final int TRANSACTION_setWifiSsidPolicy = 376;
        static final int TRANSACTION_getWifiSsidPolicy = 377;
        static final int TRANSACTION_isDevicePotentiallyStolen = 378;
        static final int TRANSACTION_listForegroundAffiliatedUsers = 379;
        static final int TRANSACTION_setDrawables = 380;
        static final int TRANSACTION_resetDrawables = 381;
        static final int TRANSACTION_getDrawable = 382;
        static final int TRANSACTION_isDpcDownloaded = 383;
        static final int TRANSACTION_setDpcDownloaded = 384;
        static final int TRANSACTION_setStrings = 385;
        static final int TRANSACTION_resetStrings = 386;
        static final int TRANSACTION_getString = 387;
        static final int TRANSACTION_resetShouldAllowBypassingDevicePolicyManagementRoleQualificationState = 388;
        static final int TRANSACTION_shouldAllowBypassingDevicePolicyManagementRoleQualification = 389;
        static final int TRANSACTION_getPolicyManagedProfiles = 390;
        static final int TRANSACTION_setApplicationExemptions = 391;
        static final int TRANSACTION_getApplicationExemptions = 392;
        static final int TRANSACTION_setMtePolicy = 393;
        static final int TRANSACTION_setMtePolicyBySystem = 394;
        static final int TRANSACTION_getMtePolicy = 395;
        static final int TRANSACTION_setManagedSubscriptionsPolicy = 396;
        static final int TRANSACTION_getManagedSubscriptionsPolicy = 397;
        static final int TRANSACTION_isSubscriptionEnterpriseManaged = 398;
        static final int TRANSACTION_getDevicePolicyState = 399;
        static final int TRANSACTION_triggerDevicePolicyEngineMigration = 400;
        static final int TRANSACTION_isDeviceFinanced = 401;
        static final int TRANSACTION_getFinancedDeviceKioskRoleHolder = 402;
        static final int TRANSACTION_calculateHasIncompatibleAccounts = 403;
        static final int TRANSACTION_setContentProtectionPolicy = 404;
        static final int TRANSACTION_getContentProtectionPolicy = 405;
        static final int TRANSACTION_getSubscriptionIds = 406;
        static final int TRANSACTION_setMaxPolicyStorageLimit = 407;
        static final int TRANSACTION_forceSetMaxPolicyStorageLimit = 408;
        static final int TRANSACTION_getMaxPolicyStorageLimit = 409;
        static final int TRANSACTION_getPolicySizeForAdmin = 410;
        static final int TRANSACTION_getHeadlessDeviceOwnerMode = 411;
        static final int TRANSACTION_setAppFunctionsPolicy = 412;
        static final int TRANSACTION_getAppFunctionsPolicy = 413;
        public Stub() { super(); }
