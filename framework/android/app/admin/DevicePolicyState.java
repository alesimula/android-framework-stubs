...
public final class DevicePolicyState implements android.os.Parcelable {
    ...
    private final java.util.Map<android.os.UserHandle, java.util.Map<android.app.admin.PolicyKey, android.app.admin.PolicyState<?>>> mPolicies = null;
    private DevicePolicyState(android.os.Parcel p0) {}
