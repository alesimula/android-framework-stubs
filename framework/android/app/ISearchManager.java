...
public interface ISearchManager extends android.os.IInterface {
    ...
    public void launchAssist(android.os.Bundle p0) throws android.os.RemoteException;
    public boolean launchLegacyAssist(java.lang.String p0, int p1, android.os.Bundle p2) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.ISearchManager {
        ...
        private static class Proxy implements android.app.ISearchManager {
            ...
            public void launchAssist(android.os.Bundle p0) throws android.os.RemoteException {}
            public boolean launchLegacyAssist(java.lang.String p0, int p1, android.os.Bundle p2) throws android.os.RemoteException { return false; }
        }
    }
