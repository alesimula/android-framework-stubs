...
public abstract class ActivityManagerInternal {
    ...
    public abstract boolean hasServiceBindingOrProviderUse(int p0, int p1);
    ...
    public abstract void inputDispatchingTimedOutWarning(int p0, int p1, int p2, long p3, long p4);
    ...
    public abstract boolean isDeviceDpc(int p0);
    ...
    public abstract void killApplicationSync(java.lang.String p0, int p1, int p2, java.lang.String p3, int p4, int p5);
    public abstract void killForegroundAppsForUser(int p0);
    public abstract void killProcess(int p0, int p1, int p2, java.lang.String p3);
    public abstract void killProcess(java.lang.String p0, int p1, java.lang.String p2, int p3);
    ...
    public abstract void startProcess(java.lang.String p0, android.content.pm.ApplicationInfo p1, boolean p2, boolean p3, java.lang.String p4, android.content.ComponentName p5, boolean p6, int p7, java.lang.String p8);
    ...
    public static enum ServiceNotificationPolicy {
        ...
        SHOW_IMMEDIATELY,
        UPDATE_ONLY;
        private static final android.app.ActivityManagerInternal.ServiceNotificationPolicy[] $VALUES = null;
