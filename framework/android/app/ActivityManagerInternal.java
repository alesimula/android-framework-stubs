...
public abstract class ActivityManagerInternal {
    ...
    public abstract android.app.IUnsafeIntentStrictModeCallback getRegisteredStrictModeCallback(int p0);
    public abstract void unregisterStrictModeCallback(int p0);
    ...
    public abstract android.util.StatsEvent getCachedAppsHighWatermarkStats(int p0, boolean p1);
