...
public abstract class ActivityManagerInternal {
    ...
    public abstract void setPendingIntentWhitelistDuration(android.content.IIntentSender p0, android.os.IBinder p1, long p2);
    ...
    public abstract void setDeviceIdleWhitelist(int[] p0, int[] p1);
    public abstract void updateDeviceIdleTempWhitelist(int[] p0, int p1, boolean p2);
    ...
    public abstract void tempWhitelistForPendingIntent(int p0, int p1, int p2, long p3, java.lang.String p4);
    public abstract int broadcastIntentInPackage(java.lang.String p0, java.lang.String p1, int p2, int p3, int p4, android.content.Intent p5, java.lang.String p6, android.content.IIntentReceiver p7, int p8, java.lang.String p9, android.os.Bundle p10, java.lang.String p11, android.os.Bundle p12, boolean p13, boolean p14, int p15, boolean p16);
    public abstract android.content.ComponentName startServiceInPackage(int p0, android.content.Intent p1, java.lang.String p2, boolean p3, java.lang.String p4, java.lang.String p5, int p6, boolean p7) throws android.os.TransactionTooLargeException;
    ...
    public abstract boolean isAppBad(android.content.pm.ApplicationInfo p0);
    ...
    public abstract int broadcastIntent(android.content.Intent p0, android.content.IIntentReceiver p1, java.lang.String[] p2, boolean p3, int p4, int[] p5);
