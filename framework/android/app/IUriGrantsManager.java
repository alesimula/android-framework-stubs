...
public interface IUriGrantsManager extends android.os.IInterface {
    ...
    public int checkGrantUriPermission_ignoreNonSystem(int p0, java.lang.String p1, android.net.Uri p2, int p3, int p4) throws android.os.RemoteException;
    ...
    public static class Default implements android.app.IUriGrantsManager {
        ...
        public int checkGrantUriPermission_ignoreNonSystem(int p0, java.lang.String p1, android.net.Uri p2, int p3, int p4) throws android.os.RemoteException { return 0; }
        public void clearGrantedUriPermissions(java.lang.String p0, int p1) throws android.os.RemoteException {}
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.IUriGrantsManager {
        ...
        private static final class Proxy implements android.app.IUriGrantsManager {
