...
public interface ITrustManager extends android.os.IInterface {
    ...
    @android.annotation.EnforcePermission("android.permission.ACCESS_FINE_LOCATION")
    public boolean isInSignificantPlace() throws android.os.RemoteException;
    @android.annotation.EnforcePermission("android.permission.SUBSCRIBE_TO_KEYGUARD_LOCKED_STATE")
    public void registerDeviceLockedStateListener(com.android.internal.policy.IDeviceLockedStateListener p0, int p1) throws android.os.RemoteException;
    @android.annotation.EnforcePermission("android.permission.SUBSCRIBE_TO_KEYGUARD_LOCKED_STATE")
    public void unregisterDeviceLockedStateListener(com.android.internal.policy.IDeviceLockedStateListener p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.trust.ITrustManager {
        ...
        protected void isInSignificantPlace_enforcePermission() throws java.lang.SecurityException {}
        protected void registerDeviceLockedStateListener_enforcePermission() throws java.lang.SecurityException {}
        protected void unregisterDeviceLockedStateListener_enforcePermission() throws java.lang.SecurityException {}
