...
public class NotificationManager {
    ...
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission(allOf={"android.permission.INTERACT_ACROSS_USERS", "android.permission.ACCESS_NOTIFICATIONS"})
    @android.annotation.FlaggedApi("android.service.notification.callstyle_callback_api")
    @android.annotation.SuppressLint("UserHandle")
    ...
    private static final record NotificationChannelQuery(java.lang.String callingPkg, java.lang.String targetPkg, int userId) {
    ...
    private static final record NotificationKey(android.os.UserHandle user, java.lang.String pkg, java.lang.String tag, int id) {
        public final java.lang.String toString() { return null; }
        public final int hashCode() { return 0; }
        public final boolean equals(java.lang.Object p0) { return false; }
        @android.annotation.NonNull
