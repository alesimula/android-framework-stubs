...
public final class AppPredictor {
    ...
    private void registerPredictionUpdatesLocked(java.util.concurrent.Executor p0, android.app.prediction.AppPredictor.Callback p1) {}
    private void unregisterPredictionUpdatesLocked(android.app.prediction.AppPredictor.Callback p0) {}
    public void destroy() {}
    ...
    public void requestServiceFeatures(java.util.concurrent.Executor p0, java.util.function.Consumer<android.os.Bundle> p1) {}
    ...
    static class RemoteCallbackWrapper extends android.os.IRemoteCallback.Stub {
        private final java.util.function.Consumer<android.os.Bundle> mCallback = null;
        private final java.util.concurrent.Executor mExecutor = null;
        RemoteCallbackWrapper(java.util.concurrent.Executor p0, java.util.function.Consumer<android.os.Bundle> p1) { super(); }
