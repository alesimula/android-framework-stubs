...
public interface IActivityManager extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.IActivityManager {
        ...
        static final int TRANSACTION_finishAttachApplication = 30;
        static final int TRANSACTION_getTasks = 31;
        static final int TRANSACTION_moveTaskToFront = 32;
        static final int TRANSACTION_getTaskForActivity = 33;
        static final int TRANSACTION_getContentProvider = 34;
        static final int TRANSACTION_publishContentProviders = 35;
        static final int TRANSACTION_refContentProvider = 36;
        static final int TRANSACTION_getRunningServiceControlPanel = 37;
        static final int TRANSACTION_startService = 38;
        static final int TRANSACTION_stopService = 39;
        static final int TRANSACTION_bindService = 40;
        static final int TRANSACTION_bindServiceInstance = 41;
        static final int TRANSACTION_updateServiceGroup = 42;
        static final int TRANSACTION_unbindService = 43;
        static final int TRANSACTION_publishService = 44;
        static final int TRANSACTION_setDebugApp = 45;
        static final int TRANSACTION_setAgentApp = 46;
        static final int TRANSACTION_setAlwaysFinish = 47;
        static final int TRANSACTION_startInstrumentation = 48;
        static final int TRANSACTION_addInstrumentationResults = 49;
        static final int TRANSACTION_finishInstrumentation = 50;
        static final int TRANSACTION_getConfiguration = 51;
        static final int TRANSACTION_updateConfiguration = 52;
        static final int TRANSACTION_updateMccMncConfiguration = 53;
        static final int TRANSACTION_stopServiceToken = 54;
        static final int TRANSACTION_setProcessLimit = 55;
        static final int TRANSACTION_getProcessLimit = 56;
        static final int TRANSACTION_checkUriPermission = 57;
        static final int TRANSACTION_checkContentUriPermissionFull = 58;
        static final int TRANSACTION_checkUriPermissions = 59;
        static final int TRANSACTION_grantUriPermission = 60;
        static final int TRANSACTION_revokeUriPermission = 61;
        static final int TRANSACTION_setActivityController = 62;
        static final int TRANSACTION_showWaitingForDebugger = 63;
        static final int TRANSACTION_signalPersistentProcesses = 64;
        static final int TRANSACTION_getRecentTasks = 65;
        static final int TRANSACTION_serviceDoneExecuting = 66;
        static final int TRANSACTION_getIntentSender = 67;
        static final int TRANSACTION_getIntentSenderWithFeature = 68;
        static final int TRANSACTION_cancelIntentSender = 69;
        static final int TRANSACTION_getInfoForIntentSender = 70;
        static final int TRANSACTION_registerIntentSenderCancelListenerEx = 71;
        static final int TRANSACTION_unregisterIntentSenderCancelListener = 72;
        static final int TRANSACTION_enterSafeMode = 73;
        static final int TRANSACTION_noteWakeupAlarm = 74;
        static final int TRANSACTION_removeContentProvider = 75;
        static final int TRANSACTION_setRequestedOrientation = 76;
        static final int TRANSACTION_unbindFinished = 77;
        static final int TRANSACTION_setProcessImportant = 78;
        static final int TRANSACTION_setServiceForeground = 79;
        static final int TRANSACTION_getForegroundServiceType = 80;
        static final int TRANSACTION_moveActivityTaskToBack = 81;
        static final int TRANSACTION_getMemoryInfo = 82;
        static final int TRANSACTION_getProcessesInErrorState = 83;
        static final int TRANSACTION_clearApplicationUserData = 84;
        static final int TRANSACTION_stopAppForUser = 85;
        static final int TRANSACTION_registerForegroundServiceObserver = 86;
        static final int TRANSACTION_forceStopPackage = 87;
        static final int TRANSACTION_forceStopPackageEvenWhenStopping = 88;
        static final int TRANSACTION_killPids = 89;
        static final int TRANSACTION_getServices = 90;
        static final int TRANSACTION_peekService = 91;
        static final int TRANSACTION_profileControl = 92;
        static final int TRANSACTION_shutdown = 93;
        static final int TRANSACTION_stopAppSwitches = 94;
        static final int TRANSACTION_resumeAppSwitches = 95;
        static final int TRANSACTION_bindBackupAgent = 96;
        static final int TRANSACTION_backupAgentCreated = 97;
        static final int TRANSACTION_unbindBackupAgent = 98;
        static final int TRANSACTION_handleIncomingUser = 99;
        static final int TRANSACTION_addPackageDependency = 100;
        static final int TRANSACTION_killApplication = 101;
        static final int TRANSACTION_closeSystemDialogs = 102;
        ...
        static final int TRANSACTION_dumpBitmapsProto = 117;
        static final int TRANSACTION_isUserRunning = 118;
        static final int TRANSACTION_setPackageScreenCompatMode = 119;
        static final int TRANSACTION_switchUser = 120;
        static final int TRANSACTION_getSwitchingFromUserMessage = 121;
        static final int TRANSACTION_getSwitchingToUserMessage = 122;
        static final int TRANSACTION_logoutUser = 123;
        static final int TRANSACTION_setStopUserOnSwitch = 124;
        static final int TRANSACTION_removeTask = 125;
        ...
        static final int TRANSACTION_setThemeOverlayReady = 184;
        static final int TRANSACTION_registerTaskStackListener = 185;
        static final int TRANSACTION_unregisterTaskStackListener = 186;
        static final int TRANSACTION_notifyCleartextNetwork = 187;
        static final int TRANSACTION_setTaskResizeable = 188;
        static final int TRANSACTION_resizeTask = 189;
        static final int TRANSACTION_getLockTaskModeState = 190;
        static final int TRANSACTION_setDumpHeapDebugLimit = 191;
        static final int TRANSACTION_dumpHeapFinished = 192;
        static final int TRANSACTION_updateLockTaskPackages = 193;
        static final int TRANSACTION_noteAlarmStart = 194;
        static final int TRANSACTION_noteAlarmFinish = 195;
        static final int TRANSACTION_getPackageProcessState = 196;
        static final int TRANSACTION_startBinderTracking = 197;
        static final int TRANSACTION_stopBinderTrackingAndDump = 198;
        static final int TRANSACTION_suppressResizeConfigChanges = 199;
        static final int TRANSACTION_unlockUser = 200;
        static final int TRANSACTION_unlockUser2 = 201;
        static final int TRANSACTION_killPackageDependents = 202;
        static final int TRANSACTION_makePackageIdle = 203;
        static final int TRANSACTION_setDeterministicUidIdle = 204;
        static final int TRANSACTION_getMemoryTrimLevel = 205;
        static final int TRANSACTION_isVrModePackageEnabled = 206;
        static final int TRANSACTION_notifyLockedProfile = 207;
        static final int TRANSACTION_startConfirmDeviceCredentialIntent = 208;
        static final int TRANSACTION_sendIdleJobTrigger = 209;
        static final int TRANSACTION_sendIntentSender = 210;
        static final int TRANSACTION_isBackgroundRestricted = 211;
        static final int TRANSACTION_setRenderThread = 212;
        static final int TRANSACTION_setHasTopUi = 213;
        static final int TRANSACTION_cancelTaskWindowTransition = 214;
        static final int TRANSACTION_scheduleApplicationInfoChanged = 215;
        static final int TRANSACTION_setPersistentVrThread = 216;
        static final int TRANSACTION_waitForNetworkStateUpdate = 217;
        static final int TRANSACTION_backgroundAllowlistUid = 218;
        static final int TRANSACTION_startUserInBackgroundWithListener = 219;
        static final int TRANSACTION_startDelegateShellPermissionIdentity = 220;
        static final int TRANSACTION_stopDelegateShellPermissionIdentity = 221;
        static final int TRANSACTION_getDelegatedShellPermissions = 222;
        static final int TRANSACTION_getLifeMonitor = 223;
        static final int TRANSACTION_startUserInForegroundWithListener = 224;
        static final int TRANSACTION_appNotResponding = 225;
        ...
        static final int TRANSACTION_startUserInBackgroundVisibleOnDisplay = 251;
        static final int TRANSACTION_startProfileWithListener = 252;
        static final int TRANSACTION_restartUserInBackground = 253;
        static final int TRANSACTION_getDisplayIdsForStartingVisibleBackgroundUsers = 254;
        static final int TRANSACTION_shouldServiceTimeOut = 255;
        static final int TRANSACTION_hasServiceTimeLimitExceeded = 256;
        static final int TRANSACTION_registerUidFrozenStateChangedCallback = 257;
        static final int TRANSACTION_unregisterUidFrozenStateChangedCallback = 258;
        static final int TRANSACTION_getUidFrozenState = 259;
        static final int TRANSACTION_checkPermissionForDevice = 260;
        static final int TRANSACTION_frozenBinderTransactionDetected = 261;
        static final int TRANSACTION_getBindingUidProcessState = 262;
        static final int TRANSACTION_getUidLastIdleElapsedTime = 263;
        static final int TRANSACTION_addOverridePermissionState = 264;
        static final int TRANSACTION_removeOverridePermissionState = 265;
        static final int TRANSACTION_clearOverridePermissionStates = 266;
        static final int TRANSACTION_clearAllOverridePermissionStates = 267;
        static final int TRANSACTION_noteAppRestrictionEnabled = 268;
        static final int TRANSACTION_refreshIntentCreatorToken = 269;
