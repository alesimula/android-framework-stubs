...
public final class JobProtoEnums {
    ...
    public static final int PENDING_JOB_REASON_CONSTRAINT_DEADLINE = 8;
    public static final int PENDING_JOB_REASON_CONSTRAINT_DEVICE_IDLE = 9;
    public static final int PENDING_JOB_REASON_CONSTRAINT_MINIMUM_LATENCY = 10;
    public static final int PENDING_JOB_REASON_CONSTRAINT_PREFETCH = 11;
    public static final int PENDING_JOB_REASON_CONSTRAINT_STORAGE_NOT_LOW = 12;
    public static final int PENDING_JOB_REASON_DEVICE_STATE = 13;
    ...
    public static final int PENDING_JOB_REASON_JOB_SCHEDULER_OPTIMIZATION = 14;
    public static final int PENDING_JOB_REASON_QUOTA = 15;
    public static final int PENDING_JOB_REASON_UNDEFINED = 0;
    public static final int PENDING_JOB_REASON_USER = 16;
