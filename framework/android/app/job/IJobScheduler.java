...
public interface IJobScheduler extends android.os.IInterface {
    ...
    public java.util.Map<java.lang.String, android.os.ParcelDuration> getPendingJobReasonStats(java.lang.String p0, int p1) throws android.os.RemoteException;
    ...
    public static class Default implements android.app.job.IJobScheduler {
        ...
        public java.util.Map<java.lang.String, android.os.ParcelDuration> getPendingJobReasonStats(java.lang.String p0, int p1) throws android.os.RemoteException { return null; }
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.job.IJobScheduler {
        ...
        static final int TRANSACTION_canRunUserInitiatedJobs = 14;
        ...
        static final int TRANSACTION_getAllJobSnapshots = 17;
        ...
        static final int TRANSACTION_getPendingJobReasonStats = 13;
        static final int TRANSACTION_getPendingJobReasons = 11;
        static final int TRANSACTION_getPendingJobReasonsHistory = 12;
        static final int TRANSACTION_getStartedJobs = 16;
        static final int TRANSACTION_hasRunUserInitiatedJobsPermission = 15;
        static final int TRANSACTION_notePendingUserRequestedAppStop = 20;
        static final int TRANSACTION_registerUserVisibleJobObserver = 18;
        static final int TRANSACTION_schedule = 1;
        static final int TRANSACTION_scheduleAsPackage = 3;
        static final int TRANSACTION_unregisterUserVisibleJobObserver = 19;
        ...
        private static final class Proxy implements android.app.job.IJobScheduler {
