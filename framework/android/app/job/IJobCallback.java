...
public interface IJobCallback extends android.os.IInterface {
    ...
    public void handleAbandonedJob(int p0) throws android.os.RemoteException;
    public void handleAbandonedJobAsync(int p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.job.IJobCallback {
        ...
        static final int TRANSACTION_handleAbandonedJobAsync = 12;
        ...
        private static final class Proxy implements android.app.job.IJobCallback {
