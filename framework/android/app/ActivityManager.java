...
public class ActivityManager {
    ...
    public void setApplicationStartInfoCompleteListener(java.util.concurrent.Executor p0, android.app.ActivityManager.ApplicationStartInfoCompleteListener p1) {}
    ...
    @android.annotation.RequiresPermission("android.permission.DUMP")
    public boolean isModernBroadcastQueueEnabled() { return false; }
    @android.annotation.RequiresPermission("android.permission.DUMP")
    ...
    public static interface ApplicationStartInfoCompleteListener {
        public void onApplicationStartInfoComplete(android.app.ApplicationStartInfo p0);
    }
