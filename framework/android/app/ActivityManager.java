...
public class ActivityManager {
    ...
    public static void init$ravenwood(int p0) {}
    ...
    public boolean isTaskMoveAllowedOnDisplay(int p0) { return false; }
    @java.lang.Deprecated
    ...
    @android.annotation.RequiresPermission("android.permission.GET_BINDING_UID_IMPORTANCE")
    ...
    @android.annotation.SystemApi
    @android.annotation.FlaggedApi("android.app.uid_importance_listener_for_uids")
    ...
    public static boolean isUserAMonkey$ravenwood() { return false; }
    @java.lang.Deprecated
    ...
    public static int getCurrentUser$ravenwood() { return 0; }
    ...
    public static boolean isSystemReady$ravenwood() { return false; }
    ...
    @android.annotation.RequiresPermission("android.permission.SET_THEME_OVERLAY_CONTROLLER_READY")
    ...
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission("android.permission.LOG_FOREGROUND_RESOURCE_USE")
    ...
    public static class TaskDescription implements android.os.Parcelable {
        ...
        public TaskDescription(java.lang.String p0, android.graphics.drawable.Icon p1, int p2, int p3, int p4, int p5, int p6, int p7, boolean p8, boolean p9, int p10, int p11, int p12, int p13) {}
