...
public class ActivityManager {
    ...
    public void registerHomeVisibilityObserver(android.app.HomeVisibilityObserver p0) {}
    public void unregisterHomeVisibilityObserver(android.app.HomeVisibilityObserver p0) {}
    ...
    public static class StackInfo implements android.os.Parcelable {
        ...
        @java.lang.Deprecated
        public int position;
        public android.window.WindowContainerToken stackToken;
    ...
    public static class TaskDescription implements android.os.Parcelable {
        ...
        public TaskDescription(java.lang.String p0, android.graphics.drawable.Icon p1, int p2, int p3, int p4, int p5, boolean p6, boolean p7, int p8, int p9, int p10) {}
        ...
        public void restoreFromXml(org.xmlpull.v1.XmlPullParser p0) {}
        public int describeContents() { return 0; }
        public void writeToParcel(android.os.Parcel p0, int p1) {}
        public void readFromParcel(android.os.Parcel p0) {}
        public java.lang.String toString() { return null; }
    ...
    public static class TaskSnapshot implements android.os.Parcelable {
        ...
        public TaskSnapshot(long p0, android.content.ComponentName p1, android.graphics.GraphicBuffer p2, android.graphics.ColorSpace p3, int p4, int p5, android.graphics.Point p6, android.graphics.Rect p7, boolean p8, boolean p9, int p10, int p11, boolean p12) {}
        ...
        public static final class Builder {
            ...
            private android.graphics.GraphicBuffer mSnapshot;
            ...
            public Builder() {}
            public android.app.ActivityManager.TaskSnapshot.Builder setId(long p0) { return null; }
            public android.app.ActivityManager.TaskSnapshot.Builder setTopActivityComponent(android.content.ComponentName p0) { return null; }
            public android.app.ActivityManager.TaskSnapshot.Builder setSnapshot(android.graphics.GraphicBuffer p0) { return null; }
            public android.app.ActivityManager.TaskSnapshot.Builder setColorSpace(android.graphics.ColorSpace p0) { return null; }
            public android.app.ActivityManager.TaskSnapshot.Builder setOrientation(int p0) { return null; }
            public android.app.ActivityManager.TaskSnapshot.Builder setRotation(int p0) { return null; }
            public android.app.ActivityManager.TaskSnapshot.Builder setTaskSize(android.graphics.Point p0) { return null; }
            public android.app.ActivityManager.TaskSnapshot.Builder setContentInsets(android.graphics.Rect p0) { return null; }
            public android.app.ActivityManager.TaskSnapshot.Builder setIsRealSnapshot(boolean p0) { return null; }
            public android.app.ActivityManager.TaskSnapshot.Builder setWindowingMode(int p0) { return null; }
            public android.app.ActivityManager.TaskSnapshot.Builder setSystemUiVisibility(int p0) { return null; }
            public android.app.ActivityManager.TaskSnapshot.Builder setIsTranslucent(boolean p0) { return null; }
            public int getPixelFormat() { return 0; }
            public android.app.ActivityManager.TaskSnapshot.Builder setPixelFormat(int p0) { return null; }
            public android.app.ActivityManager.TaskSnapshot build() { return null; }
        }
    }
