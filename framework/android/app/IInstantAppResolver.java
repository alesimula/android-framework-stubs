...
public interface IInstantAppResolver extends android.os.IInterface {
    public void getInstantAppResolveInfoList(android.content.Intent p0, int[] p1, int p2, java.lang.String p3, int p4, android.os.IRemoteCallback p5) throws android.os.RemoteException;
    public void getInstantAppIntentFilterList(android.content.Intent p0, int[] p1, int p2, java.lang.String p3, android.os.IRemoteCallback p4) throws android.os.RemoteException;
