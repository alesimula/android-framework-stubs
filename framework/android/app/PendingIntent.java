...
public final class PendingIntent implements android.os.Parcelable {
    ...
    private static final java.lang.ThreadLocal<java.util.List<android.app.PendingIntent.OnMarshaledListener>> sOnMarshaledListener = null;
    ...
    static void addOnMarshaledListener(android.app.PendingIntent.OnMarshaledListener p0) {}
    ...
    private static void checkPendingIntent(int p0, android.content.Intent p1, android.content.Context p2, boolean p3) {}
    ...
    public static boolean isNewMutableDisallowedImplicitPendingIntent(int p0, android.content.Intent p1, boolean p2) { return false; }
    ...
    static void removeOnMarshaledListener(android.app.PendingIntent.OnMarshaledListener p0) {}
    ...
    public void send(android.os.Bundle p0) throws android.app.PendingIntent.CanceledException {}
    ...
    private final class CancelListerInfo extends com.android.internal.os.IResultReceiver.Stub {
        private final android.util.ArraySet<android.util.Pair<java.util.concurrent.Executor, android.app.PendingIntent.CancelListener>> mCancelListeners = null;
