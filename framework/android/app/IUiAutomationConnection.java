...
public interface IUiAutomationConnection extends android.os.IInterface {
    ...
    public boolean takeScreenshot(android.graphics.Rect p0, android.window.ScreenCaptureInternal.ScreenCaptureListener p1, int p2) throws android.os.RemoteException;
    public boolean takeSurfaceControlScreenshot(android.view.SurfaceControl p0, android.window.ScreenCaptureInternal.ScreenCaptureListener p1) throws android.os.RemoteException;
    ...
    public static class Default implements android.app.IUiAutomationConnection {
        ...
        public void shutdown() throws android.os.RemoteException {}
        public void syncInputTransactions(boolean p0) throws android.os.RemoteException {}
        public boolean takeScreenshot(android.graphics.Rect p0, android.window.ScreenCaptureInternal.ScreenCaptureListener p1, int p2) throws android.os.RemoteException { return false; }
        public boolean takeSurfaceControlScreenshot(android.view.SurfaceControl p0, android.window.ScreenCaptureInternal.ScreenCaptureListener p1) throws android.os.RemoteException { return false; }
    }
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.IUiAutomationConnection {
        ...
        private static final class Proxy implements android.app.IUiAutomationConnection {
