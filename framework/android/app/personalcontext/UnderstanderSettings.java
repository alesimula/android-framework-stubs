...
public class UnderstanderSettings {
    ...
    private static java.util.List<android.app.personalcontext.UnderstanderSettings.EnabledUnderstander> deserializeUnderstanders(java.lang.String p0) { return null; }
    private static java.util.List<android.app.personalcontext.UnderstanderSettings.EnabledUnderstander> getUnderstandersFromSetting(java.lang.String p0) { return null; }
    private java.util.List<android.app.personalcontext.UnderstanderSettings.EnabledUnderstander> getUnderstandersFromSettings(java.lang.String p0) { return null; }
    private static java.lang.String serializeUnderstanders(java.util.List<android.app.personalcontext.UnderstanderSettings.EnabledUnderstander> p0) { return null; }
    ...
    public java.util.List<android.app.personalcontext.UnderstanderSettings.EnabledUnderstander> getEnabledUnderstanders() { return null; }
    public java.util.List<android.app.personalcontext.UnderstanderSettings.EnabledUnderstander> getPreviouslyEnabledUnderstanders() { return null; }
    @android.annotation.SystemApi
