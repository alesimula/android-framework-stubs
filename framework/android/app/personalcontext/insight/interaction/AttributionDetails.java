package android.app.personalcontext.insight.interaction;

public final class AttributionDetails implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.app.personalcontext.insight.interaction.AttributionDetails> CREATOR = null;
    private final java.util.List<android.app.personalcontext.insight.interaction.AttributionDetails.AttributionLine> mLines = null;
    private AttributionDetails(android.os.Parcel p0) {}
    public AttributionDetails(java.util.Collection<android.app.personalcontext.insight.interaction.AttributionDetails.AttributionLine> p0) {}
    public int describeContents() { return 0; }
    public java.util.List<android.app.personalcontext.insight.interaction.AttributionDetails.AttributionLine> getLines() { return null; }
    public void writeToParcel(android.os.Parcel p0, int p1) {}

    public static final class AttributionLine implements android.os.Parcelable {
        public static final android.os.Parcelable.Creator<android.app.personalcontext.insight.interaction.AttributionDetails.AttributionLine> CREATOR = null;
