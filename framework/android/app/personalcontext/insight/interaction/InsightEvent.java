...
public final class InsightEvent implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.app.personalcontext.insight.interaction.InsightEvent> CREATOR = null;
    ...
    private final android.app.personalcontext.insight.ContextInsight mContextInsight = null;
    private final int mEventType = 0;
    private final long mTimestamp = 0L;
    public InsightEvent(int p0, android.app.personalcontext.insight.ContextInsight p1, long p2) {}
    private InsightEvent(android.os.Parcel p0) {}
    public int describeContents() { return 0; }
    public android.app.personalcontext.insight.ContextInsight getContextInsight() { return null; }
    public int getEventType() { return 0; }
    public android.app.personalcontext.insight.PublishedContextInsight getInsight() { return null; }
    public android.app.personalcontext.RenderToken getRenderToken() { return null; }
