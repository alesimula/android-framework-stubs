...
public interface IActivityClientController extends android.os.IInterface {
    ...
    public void activityStopped(android.os.IBinder p0, android.os.Bundle p1, android.os.PersistableBundle p2, android.app.HandoffActivityData p3, java.lang.CharSequence p4) throws android.os.RemoteException;
    public void activityTopResumedStateLost(android.os.IBinder p0) throws android.os.RemoteException;
    public int checkActivityCallerContentUriPermission(android.os.IBinder p0, android.os.IBinder p1, android.net.Uri p2, int p3, int p4) throws android.os.RemoteException;
    ...
    public java.lang.String getActivityCallerPackage(android.os.IBinder p0, android.os.IBinder p1) throws android.os.RemoteException;
    public int getActivityCallerUid(android.os.IBinder p0, android.os.IBinder p1) throws android.os.RemoteException;
    ...
    public android.app.HandoffActivityParams getHandoffActivityParams(android.os.IBinder p0) throws android.os.RemoteException;
    ...
    public void setActivityRecordInputSinkEnabled(android.os.IBinder p0, boolean p1) throws android.os.RemoteException;
    ...
    public void setHandoffEnabled(android.os.IBinder p0, boolean p1, android.app.HandoffActivityParams p2) throws android.os.RemoteException;
    ...
    public static class Default implements android.app.IActivityClientController {
        ...
        public int checkActivityCallerContentUriPermission(android.os.IBinder p0, android.os.IBinder p1, android.net.Uri p2, int p3, int p4) throws android.os.RemoteException { return 0; }
        public void clearOverrideActivityTransition(android.os.IBinder p0, boolean p1) throws android.os.RemoteException {}
        ...
        public void finishSubActivity(android.os.IBinder p0, java.lang.String p1, int p2) throws android.os.RemoteException {}
        public java.lang.String getActivityCallerPackage(android.os.IBinder p0, android.os.IBinder p1) throws android.os.RemoteException { return null; }
        public int getActivityCallerUid(android.os.IBinder p0, android.os.IBinder p1) throws android.os.RemoteException { return 0; }
        ...
        public android.app.HandoffActivityParams getHandoffActivityParams(android.os.IBinder p0) throws android.os.RemoteException { return null; }
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.IActivityClientController {
        ...
        static final int TRANSACTION_clearOverrideActivityTransition = 59;
        static final int TRANSACTION_convertFromTranslucent = 34;
        static final int TRANSACTION_convertToTranslucent = 35;
        static final int TRANSACTION_dismissKeyguard = 64;
        static final int TRANSACTION_enableTaskLocaleOverride = 69;
        static final int TRANSACTION_enterPictureInPictureMode = 40;
        ...
        static final int TRANSACTION_getHandoffActivityParams = 38;
        ...
        static final int TRANSACTION_invalidateHomeTaskSnapshot = 63;
        static final int TRANSACTION_isImmersive = 36;
        static final int TRANSACTION_isRequestedToLaunchInTaskFragment = 70;
        static final int TRANSACTION_isRootVoiceInteraction = 50;
        ...
        static final int TRANSACTION_onBackPressed = 67;
        static final int TRANSACTION_overrideActivityTransition = 58;
        static final int TRANSACTION_overridePendingTransition = 60;
        static final int TRANSACTION_registerRemoteAnimations = 65;
        static final int TRANSACTION_releaseActivityInstance = 14;
        static final int TRANSACTION_reportActivityFullyDrawn = 57;
        static final int TRANSACTION_reportSizeConfigurations = 10;
        static final int TRANSACTION_requestMultiwindowFullscreen = 44;
        static final int TRANSACTION_setActivityRecordInputSinkEnabled = 71;
        static final int TRANSACTION_setAllowCrossUidActivitySwitchFromBelow = 56;
        static final int TRANSACTION_setForceSendResultForMediaProjection = 18;
        static final int TRANSACTION_setHandoffEnabled = 39;
        static final int TRANSACTION_setImmersive = 37;
        static final int TRANSACTION_setInheritShowWhenLocked = 54;
        static final int TRANSACTION_setPictureInPictureParams = 41;
        static final int TRANSACTION_setRecentsScreenshotEnabled = 62;
        static final int TRANSACTION_setRequestedOrientation = 32;
        static final int TRANSACTION_setShouldDockBigOverlays = 42;
        static final int TRANSACTION_setShowWhenLocked = 53;
        static final int TRANSACTION_setTaskDescription = 48;
        static final int TRANSACTION_setTurnScreenOn = 55;
        static final int TRANSACTION_setVrMode = 61;
        static final int TRANSACTION_shouldUpRecreateTask = 12;
        static final int TRANSACTION_showAssistFromActivity = 49;
        static final int TRANSACTION_showLockTaskEscapeMessage = 47;
        static final int TRANSACTION_splashScreenAttached = 68;
        static final int TRANSACTION_startLocalVoiceInteraction = 51;
        static final int TRANSACTION_startLockTaskModeByToken = 45;
        static final int TRANSACTION_stopLocalVoiceInteraction = 52;
        static final int TRANSACTION_stopLockTaskModeByToken = 46;
        static final int TRANSACTION_toggleFreeformWindowingMode = 43;
        static final int TRANSACTION_unregisterRemoteAnimations = 66;
        ...
        private static final class Proxy implements android.app.IActivityClientController {
