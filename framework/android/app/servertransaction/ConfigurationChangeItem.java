...
public class ConfigurationChangeItem extends android.app.servertransaction.ClientTransactionItem {
    ...
    private ConfigurationChangeItem() { super(); }
    public static android.app.servertransaction.ConfigurationChangeItem obtain(android.content.res.Configuration p0) { return null; }
    public void recycle() {}
