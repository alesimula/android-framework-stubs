...
public class DestroyActivityItem extends android.app.servertransaction.ActivityLifecycleItem {
    ...
    public DestroyActivityItem(android.os.IBinder p0, boolean p1) { super((android.os.IBinder)null); }
    private DestroyActivityItem(android.os.Parcel p0) { super((android.os.IBinder)null); }
