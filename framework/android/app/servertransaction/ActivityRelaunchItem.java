...
public class ActivityRelaunchItem extends android.app.servertransaction.ClientTransactionItem {
    ...
    private ActivityRelaunchItem() { super(); }
    ...
    private ActivityRelaunchItem(android.os.Parcel p0) { super(); }
