...
public class StartActivityItem extends android.app.servertransaction.ActivityLifecycleItem {
    ...
    private StartActivityItem() { super(); }
    public static android.app.servertransaction.StartActivityItem obtain(android.app.ActivityOptions p0) { return null; }
    public void recycle() {}
    public void writeToParcel(android.os.Parcel p0, int p1) {}
    private StartActivityItem(android.os.Parcel p0) { super(); }
