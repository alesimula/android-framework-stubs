...
public class ActivityConfigurationChangeItem extends android.app.servertransaction.ActivityTransactionItem {
    ...
    public ActivityConfigurationChangeItem(android.os.IBinder p0, android.content.res.Configuration p1, android.window.ActivityWindowInfo p2) { super((android.os.IBinder)null); }
