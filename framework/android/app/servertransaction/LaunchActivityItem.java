...
public class LaunchActivityItem extends android.app.servertransaction.ClientTransactionItem {
    ...
    public static android.app.servertransaction.LaunchActivityItem obtain(android.content.Intent p0, int p1, android.content.pm.ActivityInfo p2, android.content.res.Configuration p3, android.content.res.Configuration p4, android.content.res.CompatibilityInfo p5, java.lang.String p6, com.android.internal.app.IVoiceInteractor p7, int p8, android.os.Bundle p9, android.os.PersistableBundle p10, java.util.List<android.app.ResultInfo> p11, java.util.List<com.android.internal.content.ReferrerIntent> p12, boolean p13, android.app.ProfilerInfo p14, android.os.IBinder p15, android.view.DisplayAdjustments.FixedRotationAdjustments p16) { return null; }
    public void recycle() {}
    ...
    private static void setValues(android.app.servertransaction.LaunchActivityItem p0, android.content.Intent p1, int p2, android.content.pm.ActivityInfo p3, android.content.res.Configuration p4, android.content.res.Configuration p5, android.content.res.CompatibilityInfo p6, java.lang.String p7, com.android.internal.app.IVoiceInteractor p8, int p9, android.os.Bundle p10, android.os.PersistableBundle p11, java.util.List<android.app.ResultInfo> p12, java.util.List<com.android.internal.content.ReferrerIntent> p13, boolean p14, android.app.ProfilerInfo p15, android.os.IBinder p16, android.view.DisplayAdjustments.FixedRotationAdjustments p17) {}
}
