...
public class ResumeActivityItem extends android.app.servertransaction.ActivityLifecycleItem {
    ...
    @android.annotation.NonNull
    public static android.app.servertransaction.ResumeActivityItem obtain(android.os.IBinder p0, int p1, boolean p2, boolean p3) { return null; }
    @android.annotation.NonNull
    public static android.app.servertransaction.ResumeActivityItem obtain(android.os.IBinder p0, boolean p1, boolean p2) { return null; }
    public void recycle() {}
