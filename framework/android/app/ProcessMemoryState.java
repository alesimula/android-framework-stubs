...
public final class ProcessMemoryState implements android.os.Parcelable {
    ...
    public final long currentTimeInStateMs = 0L;
    public final boolean hasForegroundServices = false;
    public final int hostingZygoteVariant = 0;
    ...
    public final int procState = 0;
    public final java.lang.String processName = null;
    public final long totalProcessDurationMs = 0L;
    public final int uid = 0;
    public ProcessMemoryState(int p0, int p1, java.lang.String p2, int p3, int p4, boolean p5, int p6, int p7, long p8, long p9, int p10) {}
