...
class ContextImpl extends android.content.Context {
    ...
    private static java.io.File ensurePrivateDirExists(java.io.File p0) { return null; }
    private static java.io.File ensurePrivateCacheDirExists(java.io.File p0, java.lang.String p1) { return null; }
    private static java.io.File ensurePrivateDirExists(java.io.File p0, int p1, int p2, java.lang.String p3) { return null; }
    ...
    private boolean bindServiceCommon(android.content.Intent p0, android.content.ServiceConnection p1, int p2, java.lang.String p3, android.os.Handler p4, java.util.concurrent.Executor p5, android.os.UserHandle p6) { return false; }
    ...
    private boolean isSelfOrOuterUiContext() { return false; }
    public boolean isUiContext() { return false; }
    private static boolean isSystemOrSystemUI(android.content.Context p0) { return false; }
    private static boolean isUiComponent(java.lang.String p0) { return false; }
    ...
    private static android.content.res.Resources createResources(android.os.IBinder p0, android.app.LoadedApk p1, java.lang.String p2, int p3, android.content.res.Configuration p4, android.content.res.CompatibilityInfo p5, java.util.List<android.content.res.loader.ResourcesLoader> p6) { return null; }
    ...
    public android.app.WindowContext createWindowContext(int p0, android.os.Bundle p1) { return null; }
    android.app.ContextImpl createBaseWindowContext(android.os.IBinder p0) { return null; }
    android.content.res.Resources createWindowContextResources() { return null; }
    ...
    static android.app.ContextImpl createSystemUiContext(android.app.ContextImpl p0, int p1) { return null; }
    static android.app.ContextImpl createSystemUiContext(android.app.ContextImpl p0) { return null; }
    ...
    private ContextImpl(android.app.ContextImpl p0, android.app.ActivityThread p1, android.app.LoadedApk p2, java.lang.String p3, java.lang.String p4, android.os.IBinder p5, android.os.UserHandle p6, int p7, java.lang.ClassLoader p8, java.lang.String p9) { super(); }
