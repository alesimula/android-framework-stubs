...
class ContextImpl extends android.content.Context {
    ...
    private static android.content.res.Resources createResources(android.os.IBinder p0, android.app.LoadedApk p1, java.lang.String p2, int p3, android.content.res.Configuration p4, android.content.res.CompatibilityInfo p5) { return null; }
    ...
    private ContextImpl(android.app.ContextImpl p0, android.app.ActivityThread p1, android.app.LoadedApk p2, java.lang.String p3, android.os.IBinder p4, android.os.UserHandle p5, int p6, java.lang.ClassLoader p7, java.lang.String p8) { super(); }
    ...
    private java.io.File[] ensureExternalDirsExistOrFilter(java.io.File[] p0) { return null; }
