...
public interface ISearchUiManager extends android.os.IInterface {
    ...
    public void registerEmptyQueryResultUpdateCallback(android.app.search.SearchSessionId p0, android.app.search.ISearchCallback p1) throws android.os.RemoteException;
    public void unregisterEmptyQueryResultUpdateCallback(android.app.search.SearchSessionId p0, android.app.search.ISearchCallback p1) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.search.ISearchUiManager {
        ...
        private static final class Proxy implements android.app.search.ISearchUiManager {
