...
public final class WearServicesEnums {
    ...
    public static final int BUGREPORT_COMPONENT_LOCAL_FEEDBACK_APP = 6;
    ...
    public static final int BUGREPORT_COMPONENT_WEAR_SERVICES_API = 5;
    ...
    public static final int CALL_RESULT_DIALED_ON_WATCH = 4;
    ...
    public static final int EVENT_BUGREPORT_CANCELED = 12;
    public static final int EVENT_BUGREPORT_CROSS_STACK_LOGS_RECEIVED = 11;
    public static final int EVENT_BUGREPORT_CROSS_STACK_LOGS_REQUESTED = 10;
    ...
    public static final int EVENT_BUGREPORT_SENT = 13;
    ...
    public static final int EXCEPTION_TYPE_ILLEGAL_ARGUMENT = 5;
    public static final int EXCEPTION_TYPE_ILLEGAL_STATE = 3;
    public static final int EXCEPTION_TYPE_INDEX_OUT_OF_BOUNDS = 6;
    public static final int EXCEPTION_TYPE_INVALID_PARAMETER = 4;
    public static final int EXCEPTION_TYPE_NULL_POINTER = 2;
    public static final int EXCEPTION_TYPE_OTHER = 1;
    public static final int EXCEPTION_TYPE_SECURITY = 7;
    ...
    public static final int FAILURE_REASON_PLAY_STORE_INTENT_NULL = 1;
    ...
    public static final int LATENCY_ACTION_DIAL = 5;
    ...
    public static final int NOTIFICATION_API_NAME_SUBSCRIBE_FOR_NOTIFICATION_UPDATES = 20;
    ...
    public static final int NOTIFICATION_BLOCKING_TYPE_POSTED = 1;
    public static final int NOTIFICATION_BLOCKING_TYPE_PROMOTED = 2;
    public static final int NOTIFICATION_BLOCKING_TYPE_UNSPECIFIED = 0;
    ...
    public static final int NOTIFICATION_DB_OPERATION_OP_BATCHED_CHANGE = 9;
    public static final int NOTIFICATION_DB_OPERATION_OP_DISMISS_ALL = 1;
    public static final int NOTIFICATION_DB_OPERATION_OP_DISMISS_ITEM_FROM_MCU_UI = 8;
    public static final int NOTIFICATION_DB_OPERATION_OP_DISMISS_ITEM_FROM_UI = 3;
    public static final int NOTIFICATION_DB_OPERATION_OP_DISMISS_MULTIPLE_ITEMS_FROM_UI = 2;
    public static final int NOTIFICATION_DB_OPERATION_OP_FLUSH_NOTIFICATIONS = 12;
    public static final int NOTIFICATION_DB_OPERATION_OP_REMOVE_ITEM = 6;
    public static final int NOTIFICATION_DB_OPERATION_OP_SET_COLLECTED_ITEMS = 4;
    public static final int NOTIFICATION_DB_OPERATION_OP_SET_ITEM = 5;
    public static final int NOTIFICATION_DB_OPERATION_OP_UNKNOWN = 0;
    public static final int NOTIFICATION_DB_OPERATION_OP_UPDATE_ALL_ITEM_STATES = 10;
    public static final int NOTIFICATION_DB_OPERATION_OP_UPDATE_FILTERING = 7;
    public static final int NOTIFICATION_DB_OPERATION_OP_UPDATE_ITEM_STATES = 11;
    public static final int NOTIFICATION_DB_OPERATION_QUERY_DUMP_STATE = 103;
    public static final int NOTIFICATION_DB_OPERATION_QUERY_GET_ITEMS = 101;
    public static final int NOTIFICATION_DB_OPERATION_QUERY_GET_ITEM_BY_ID = 102;
    public static final int NOTIFICATION_DB_OPERATION_QUERY_GET_TOP_LEVEL_ITEMS = 100;
    ...
    public static final int NOTIFICATION_NOT_SHOWN = 2;
    public static final int NOTIFICATION_SHOWN = 1;
    public static final int NOTIFICATION_SHOWN_STATUS_UNSPECIFIED = 0;
    ...
    public static final int SUBSCRIPTION_CONTENT_TYPE_ALL = 1;
    public static final int SUBSCRIPTION_CONTENT_TYPE_STATUS_BAR_ICON = 2;
    public static final int SUBSCRIPTION_CONTENT_TYPE_STATUS_BAR_TEXT = 3;
    public static final int SUBSCRIPTION_CONTENT_TYPE_UNKNOWN = 0;
    public static final int SUBSCRIPTION_RESPONSE_TYPE_ALREADY_UP_TO_DATE = 1;
    public static final int SUBSCRIPTION_RESPONSE_TYPE_NOTIFICATION_NOT_FOUND = 3;
    public static final int SUBSCRIPTION_RESPONSE_TYPE_REFRESH_REQUESTED = 2;
    public static final int SUBSCRIPTION_RESPONSE_TYPE_UNKNOWN = 0;
