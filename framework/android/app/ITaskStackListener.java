...
public interface ITaskStackListener extends android.os.IInterface {
    ...
    public void onRecentTaskRemovedForAddTask(int p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.ITaskStackListener {
        ...
        static final int TRANSACTION_onActivityRotation = 22;
        static final int TRANSACTION_onActivityUnpinned = 3;
        static final int TRANSACTION_onBackPressedOnTaskRoot = 16;
        static final int TRANSACTION_onLockTaskModeChanged = 24;
        static final int TRANSACTION_onRecentTaskListFrozenChanged = 19;
        static final int TRANSACTION_onRecentTaskListUpdated = 18;
        static final int TRANSACTION_onRecentTaskRemovedForAddTask = 20;
        static final int TRANSACTION_onTaskCreated = 9;
        static final int TRANSACTION_onTaskDescriptionChanged = 12;
        static final int TRANSACTION_onTaskDisplayChanged = 17;
        static final int TRANSACTION_onTaskFocusChanged = 21;
        static final int TRANSACTION_onTaskMovedToBack = 23;
        ...
        private static final class Proxy implements android.app.ITaskStackListener {
