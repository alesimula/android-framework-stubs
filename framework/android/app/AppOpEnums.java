...
public final class AppOpEnums {
    ...
    public static final int APP_OP_ACCESS_HID = 178;
    public static final int APP_OP_ACCESS_LOCAL_NETWORK = 169;
    ...
    public static final int APP_OP_COMPUTER_CONTROL = 167;
    public static final int APP_OP_CONTINUE_ACROSS_DEVICES = 174;
    ...
    public static final int APP_OP_MANAGE_PERIPHERAL_CUSTOMIZATION = 179;
    ...
    public static final int APP_OP_READ_BLOOD_PRESSURE = 170;
    ...
    public static final int APP_OP_READ_HEART_RATE_VARIABILITY = 171;
    ...
    public static final int APP_OP_READ_OTP_SMS = 168;
    ...
    public static final int APP_OP_READ_RESPIRATORY_RATE = 172;
    public static final int APP_OP_READ_RESTRICTED_MESSAGES = 176;
    public static final int APP_OP_READ_SCREEN_CONTEXT = 175;
    ...
    public static final int APP_OP_READ_VO2_MAX = 173;
    ...
    public static final int APP_OP_WRITE_RESTRICTED_MESSAGES = 177;
