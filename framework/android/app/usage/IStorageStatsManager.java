...
public interface IStorageStatsManager extends android.os.IInterface {
    ...
    public android.app.usage.StorageStats queryArtManagedStats(java.lang.String p0, int p1, int p2) throws android.os.RemoteException;
    ...
    public static class Default implements android.app.usage.IStorageStatsManager {
        ...
        public android.app.usage.StorageStats queryArtManagedStats(java.lang.String p0, int p1, int p2) throws android.os.RemoteException { return null; }
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.usage.IStorageStatsManager {
        ...
        private static final class Proxy implements android.app.usage.IStorageStatsManager {
