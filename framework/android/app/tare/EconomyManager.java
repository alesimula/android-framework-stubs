...
public class EconomyManager {
    public static final long CAKE_IN_ARC = 1000000000L;
    ...
    public static final long DEFAULT_AM_MIN_SATIATED_BALANCE_EXEMPTED_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_MIN_SATIATED_BALANCE_HEADLESS_SYSTEM_APP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_MIN_SATIATED_BALANCE_OTHER_APP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_MAX_SATIATED_BALANCE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_INITIAL_CONSUMPTION_LIMIT_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_MIN_CONSUMPTION_LIMIT_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_MAX_CONSUMPTION_LIMIT_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_REWARD_TOP_ACTIVITY_INSTANT_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_REWARD_TOP_ACTIVITY_ONGOING_CAKES = 10000000L;
    public static final long DEFAULT_AM_REWARD_TOP_ACTIVITY_MAX_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_REWARD_NOTIFICATION_SEEN_INSTANT_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_REWARD_NOTIFICATION_SEEN_ONGOING_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_REWARD_NOTIFICATION_SEEN_MAX_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_REWARD_NOTIFICATION_SEEN_WITHIN_15_INSTANT_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_REWARD_NOTIFICATION_SEEN_WITHIN_15_ONGOING_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_REWARD_NOTIFICATION_SEEN_WITHIN_15_MAX_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_REWARD_NOTIFICATION_INTERACTION_INSTANT_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_REWARD_NOTIFICATION_INTERACTION_ONGOING_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_REWARD_NOTIFICATION_INTERACTION_MAX_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_REWARD_WIDGET_INTERACTION_INSTANT_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_REWARD_WIDGET_INTERACTION_ONGOING_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_REWARD_WIDGET_INTERACTION_MAX_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_REWARD_OTHER_USER_INTERACTION_INSTANT_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_REWARD_OTHER_USER_INTERACTION_ONGOING_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_REWARD_OTHER_USER_INTERACTION_MAX_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_ACTION_ALARM_ALLOW_WHILE_IDLE_EXACT_WAKEUP_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_ACTION_ALARM_ALLOW_WHILE_IDLE_INEXACT_WAKEUP_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_ACTION_ALARM_EXACT_WAKEUP_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_ACTION_ALARM_INEXACT_WAKEUP_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_ACTION_ALARM_ALLOW_WHILE_IDLE_EXACT_NONWAKEUP_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_ACTION_ALARM_EXACT_NONWAKEUP_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_ACTION_ALARM_ALLOW_WHILE_IDLE_INEXACT_NONWAKEUP_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_ACTION_ALARM_INEXACT_NONWAKEUP_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_ACTION_ALARM_ALARMCLOCK_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_ACTION_ALARM_ALLOW_WHILE_IDLE_EXACT_WAKEUP_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_ACTION_ALARM_ALLOW_WHILE_IDLE_INEXACT_WAKEUP_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_ACTION_ALARM_EXACT_WAKEUP_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_ACTION_ALARM_INEXACT_WAKEUP_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_ACTION_ALARM_ALLOW_WHILE_IDLE_EXACT_NONWAKEUP_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_ACTION_ALARM_EXACT_NONWAKEUP_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_ACTION_ALARM_ALLOW_WHILE_IDLE_INEXACT_NONWAKEUP_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_ACTION_ALARM_INEXACT_NONWAKEUP_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_AM_ACTION_ALARM_ALARMCLOCK_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_MIN_SATIATED_BALANCE_EXEMPTED_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_MIN_SATIATED_BALANCE_HEADLESS_SYSTEM_APP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_MIN_SATIATED_BALANCE_OTHER_APP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_MAX_SATIATED_BALANCE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_INITIAL_CONSUMPTION_LIMIT_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_MIN_CONSUMPTION_LIMIT_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_MAX_CONSUMPTION_LIMIT_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_REWARD_APP_INSTALL_INSTANT_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_REWARD_APP_INSTALL_ONGOING_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_REWARD_APP_INSTALL_MAX_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_REWARD_TOP_ACTIVITY_INSTANT_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_REWARD_TOP_ACTIVITY_ONGOING_CAKES = 500000000L;
    public static final long DEFAULT_JS_REWARD_TOP_ACTIVITY_MAX_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_REWARD_NOTIFICATION_SEEN_INSTANT_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_REWARD_NOTIFICATION_SEEN_ONGOING_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_REWARD_NOTIFICATION_SEEN_MAX_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_REWARD_NOTIFICATION_INTERACTION_INSTANT_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_REWARD_NOTIFICATION_INTERACTION_ONGOING_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_REWARD_NOTIFICATION_INTERACTION_MAX_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_REWARD_WIDGET_INTERACTION_INSTANT_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_REWARD_WIDGET_INTERACTION_ONGOING_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_REWARD_WIDGET_INTERACTION_MAX_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_REWARD_OTHER_USER_INTERACTION_INSTANT_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_REWARD_OTHER_USER_INTERACTION_ONGOING_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_REWARD_OTHER_USER_INTERACTION_MAX_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_MIN_SATIATED_BALANCE_INCREMENT_APP_UPDATER_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_MAX_START_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_MAX_RUNNING_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_HIGH_START_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_HIGH_RUNNING_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_DEFAULT_START_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_DEFAULT_RUNNING_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_LOW_START_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_LOW_RUNNING_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_MIN_START_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_MIN_RUNNING_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_TIMEOUT_PENALTY_CTP_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_MAX_START_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_MAX_RUNNING_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_HIGH_START_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_HIGH_RUNNING_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_DEFAULT_START_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_DEFAULT_RUNNING_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_LOW_START_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_LOW_RUNNING_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_MIN_START_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_MIN_RUNNING_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static final long DEFAULT_JS_ACTION_JOB_TIMEOUT_PENALTY_BASE_PRICE_CAKES = Long.valueOf(0L);
    public static long arcToCake(int p0) { return 0L; }
    public static long parseCreditValue(java.lang.String p0, long p1) { return 0L; }
    public static java.lang.String enabledModeToString(int p0) { return null; }
    public EconomyManager(android.app.tare.IEconomyManager p0) {}
    public int getEnabledMode() { return 0; }

    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
    public static @interface EnabledMode {
    }
}
