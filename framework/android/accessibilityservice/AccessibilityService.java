...
public abstract class AccessibilityService extends android.app.Service {
    ...
    @android.annotation.FlaggedApi("android.view.accessibility.global_action_menu")
    public static final int GLOBAL_ACTION_MENU = 21;
    @android.annotation.FlaggedApi("android.view.accessibility.global_action_media_play_pause")
    ...
    @android.annotation.FlaggedApi("android.view.accessibility.a11y_overlay_callbacks")
