...
public final class MediaStore {
    @android.annotation.FlaggedApi("com.android.providers.media.flags.access_media_owner_package_name_permission")
    ...
    @android.annotation.FlaggedApi("com.android.providers.media.flags.motion_photo_intent")
    ...
    @android.annotation.FlaggedApi("com.android.providers.media.flags.picker_pre_selection_extra")
    public static final java.lang.String EXTRA_PICKER_PRE_SELECTION_URIS = "android.provider.extra.PICKER_PRE_SELECTION_URIS";
    @android.annotation.FlaggedApi("com.android.providers.media.flags.picker_accent_color")
    ...
    @android.annotation.FlaggedApi("com.android.providers.media.flags.pick_ordered_images")
    public static final java.lang.String EXTRA_PICK_IMAGES_IN_ORDER = "android.provider.extra.PICK_IMAGES_IN_ORDER";
    @android.annotation.FlaggedApi("com.android.providers.media.flags.picker_default_tab")
    ...
    @android.annotation.FlaggedApi("com.android.providers.media.flags.picker_recent_selection")
    ...
    @android.annotation.FlaggedApi("com.android.providers.media.flags.inferred_media_date")
    ...
    @android.annotation.FlaggedApi("com.android.providers.media.flags.enable_oem_metadata_update")
    ...
    @android.annotation.NonNull
    public static android.os.ParcelFileDescriptor getOriginalMediaFormatFileDescriptor(android.content.Context p0, android.os.ParcelFileDescriptor p1) throws java.io.IOException { return null; }
    ...
    @android.annotation.NonNull
    public static java.util.List<android.net.Uri> getRedactedUri(android.content.ContentResolver p0, java.util.List<android.net.Uri> p1) { return null; }
    ...
    @android.annotation.FlaggedApi("com.android.providers.media.flags.enable_mark_is_favorite_status_api")
    public static void markIsFavoriteStatus(android.content.ContentResolver p0, java.util.Collection<android.net.Uri> p1, boolean p2) {}
    public static void notifyCloudMediaChangedEvent(android.content.ContentResolver p0, java.lang.String p1, java.lang.String p2) throws java.lang.SecurityException {}
    @android.annotation.FlaggedApi("com.android.providers.media.flags.media_store_open_file")
    @android.annotation.Nullable
    public static android.content.res.AssetFileDescriptor openAssetFileDescriptor(android.content.ContentResolver p0, android.net.Uri p1, java.lang.String p2, android.os.CancellationSignal p3) throws java.io.FileNotFoundException { return null; }
    @android.annotation.FlaggedApi("com.android.providers.media.flags.media_store_open_file")
    @android.annotation.Nullable
    public static android.os.ParcelFileDescriptor openFileDescriptor(android.content.ContentResolver p0, android.net.Uri p1, java.lang.String p2, android.os.CancellationSignal p3) throws java.io.FileNotFoundException { return null; }
    @android.annotation.FlaggedApi("com.android.providers.media.flags.media_store_open_file")
    @android.annotation.Nullable
    public static android.content.res.AssetFileDescriptor openTypedAssetFileDescriptor(android.content.ContentResolver p0, android.net.Uri p1, java.lang.String p2, android.os.Bundle p3, android.os.CancellationSignal p4) throws java.io.FileNotFoundException { return null; }
    @android.annotation.NonNull
    ...
    public static final class Audio {
        ...
        public static interface AudioColumns extends android.provider.MediaStore.MediaColumns {
            ...
            @java.lang.Deprecated
            public static final java.lang.String ARTIST_KEY = "artist_key";
            @android.annotation.FlaggedApi("com.android.providers.media.flags.audio_sample_columns")
            public static final java.lang.String BITS_PER_SAMPLE = "bits_per_sample";
            ...
            @android.annotation.FlaggedApi("com.android.providers.media.flags.audio_sample_columns")
            public static final java.lang.String SAMPLERATE = "samplerate";
            @java.lang.Deprecated
    ...
    public static interface MediaColumns extends android.provider.BaseColumns {
        ...
        public static final java.lang.String HEIGHT = "height";
        @android.annotation.FlaggedApi("com.android.providers.media.flags.inferred_media_date")
        public static final java.lang.String INFERRED_DATE = "inferred_date";
        ...
        @android.annotation.FlaggedApi("com.android.providers.media.flags.enable_oem_metadata")
        public static final java.lang.String OEM_METADATA = "oem_metadata";
