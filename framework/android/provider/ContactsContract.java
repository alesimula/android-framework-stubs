...
public final class ContactsContract {
    ...
    public static final java.lang.String COLOR_CYAN = "cyan";
    public static final java.lang.String COLOR_GREEN = "green";
    public static final java.lang.String COLOR_NONE = "none";
    public static final java.lang.String COLOR_PINK = "pink";
    public static final java.lang.String COLOR_PURPLE = "purple";
    public static final java.lang.String COLOR_RED = "red";
    public static final java.lang.String COLOR_TEAL = "teal";
    public static final java.lang.String COLOR_WHITE = "white";
    public static final java.lang.String COLOR_YELLOW = "yellow";
    ...
    public static final class RawContacts implements android.provider.BaseColumns, android.provider.ContactsContract.RawContactsColumns, android.provider.ContactsContract.ContactOptionsColumns, android.provider.ContactsContract.ContactNameColumns, android.provider.ContactsContract.SyncColumns {
        ...
        public static final class DefaultAccount {
            ...
            public static final java.lang.String ACTION_MOVE_CONTACTS_TO_DEFAULT_ACCOUNT = "android.provider.action.MOVE_CONTACTS_TO_DEFAULT_ACCOUNT";
            public static final java.lang.String GET_NUMBER_OF_MOVABLE_LOCAL_CONTACTS_METHOD = "getNumberOfMovableLocalContacts";
            public static final java.lang.String GET_NUMBER_OF_MOVABLE_SIM_CONTACTS_METHOD = "getNumberOfMovableSimContacts";
            public static final java.lang.String KEY_DEFAULT_ACCOUNT_STATE = "key_default_account_state";
            public static final java.lang.String KEY_ELIGIBLE_DEFAULT_ACCOUNTS = "key_eligible_default_accounts";
            public static final java.lang.String KEY_NUMBER_OF_MOVABLE_LOCAL_CONTACTS = "key_number_of_movable_local_contacts";
            public static final java.lang.String KEY_NUMBER_OF_MOVABLE_SIM_CONTACTS = "key_number_of_movable_sim_contacts";
            public static final java.lang.String MOVE_LOCAL_CONTACTS_TO_CLOUD_DEFAULT_ACCOUNT_METHOD = "moveLocalContactsToCloudDefaultAccount";
            public static final java.lang.String MOVE_SIM_CONTACTS_TO_CLOUD_DEFAULT_ACCOUNT_METHOD = "moveSimContactsToCloudDefaultAccount";
            public static final java.lang.String QUERY_DEFAULT_ACCOUNT_FOR_NEW_CONTACTS_METHOD = "queryDefaultAccountForNewContacts";
            public static final java.lang.String QUERY_ELIGIBLE_DEFAULT_ACCOUNTS_METHOD = "queryEligibleDefaultAccounts";
            public static final java.lang.String SET_DEFAULT_ACCOUNT_FOR_NEW_CONTACTS_METHOD = "setDefaultAccountForNewContacts";
            private DefaultAccount() {}
            public static android.provider.ContactsContract.RawContacts.DefaultAccount.DefaultAccountAndState getDefaultAccountForNewContacts(android.content.ContentResolver p0) { return null; }
            @android.annotation.SystemApi
            public static java.util.List<android.accounts.Account> getEligibleCloudAccounts(android.content.ContentResolver p0) { return null; }
            @android.annotation.SystemApi
            public static int getNumberOfMovableLocalContacts(android.content.ContentResolver p0) { return 0; }
            @android.annotation.SystemApi
            public static int getNumberOfMovableSimContacts(android.content.ContentResolver p0) { return 0; }
            @android.annotation.SystemApi
            public static void moveLocalContactsToCloudDefaultAccount(android.content.ContentResolver p0) {}
            @android.annotation.SystemApi
            public static void moveSimContactsToCloudDefaultAccount(android.content.ContentResolver p0) {}
            @android.annotation.SystemApi
            public static void setDefaultAccountForNewContacts(android.content.ContentResolver p0, android.provider.ContactsContract.RawContacts.DefaultAccount.DefaultAccountAndState p1) {}
            ...
            public static final class DefaultAccountAndState {
                ...
                private DefaultAccountAndState(int p0, android.accounts.Account p1) {}
                public static boolean isCloudOrSimAccount(int p0) { return false; }
                private static boolean isValidDefaultAccountState(int p0) { return false; }
                public static android.provider.ContactsContract.RawContacts.DefaultAccount.DefaultAccountAndState ofCloud(android.accounts.Account p0) { return null; }
                public static android.provider.ContactsContract.RawContacts.DefaultAccount.DefaultAccountAndState ofLocal() { return null; }
                public static android.provider.ContactsContract.RawContacts.DefaultAccount.DefaultAccountAndState ofNotSet() { return null; }
                public static android.provider.ContactsContract.RawContacts.DefaultAccount.DefaultAccountAndState ofSim(android.accounts.Account p0) { return null; }
                ...
                @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
                public static @interface DefaultAccountState {
                }
            }
        }
    ...
    public static final class SimAccount implements android.os.Parcelable {
        ...
        public static final android.os.Parcelable.Creator<android.provider.ContactsContract.SimAccount> CREATOR = null;
        ...
        private final int mEfType = 0;
        private final int mSimSlotIndex = 0;
        public SimAccount(java.lang.String p0, java.lang.String p1, int p2, int p3) {}
        public static java.util.Set<java.lang.Integer> getValidEfTypes() { return null; }
        public int describeContents() { return 0; }
        public boolean equals(java.lang.Object p0) { return false; }
        public java.lang.String getAccountName() { return null; }
        public java.lang.String getAccountType() { return null; }
        public int getEfType() { return 0; }
    ...
    public static final class SimContacts {
        ...
        private SimContacts() {}
        @android.annotation.SystemApi
        public static void addSimAccount(android.content.ContentResolver p0, java.lang.String p1, java.lang.String p2, int p3, int p4) {}
        public static java.util.List<android.provider.ContactsContract.SimAccount> getSimAccounts(android.content.ContentResolver p0) { return null; }
        @android.annotation.SystemApi
