...
public final class ContactsContract {
    ...
    public static final class RawContacts implements android.provider.BaseColumns, android.provider.ContactsContract.RawContactsColumns, android.provider.ContactsContract.ContactOptionsColumns, android.provider.ContactsContract.ContactNameColumns, android.provider.ContactsContract.SyncColumns {
        ...
        @android.annotation.FlaggedApi("android.provider.new_default_account_api_enabled")
        public static final class DefaultAccount {
            ...
            @android.annotation.SystemApi
            @android.annotation.RequiresPermission("android.permission.SET_DEFAULT_ACCOUNT_FOR_CONTACTS")
            @android.annotation.FlaggedApi("android.provider.new_default_account_api_enabled")
            ...
            @android.annotation.SystemApi
            @android.annotation.FlaggedApi("android.provider.new_default_account_api_enabled")
            @android.annotation.RequiresPermission(allOf={"android.permission.WRITE_CONTACTS", "android.permission.SET_DEFAULT_ACCOUNT_FOR_CONTACTS"})
            ...
            @android.annotation.SystemApi
            @android.annotation.FlaggedApi("android.provider.new_default_account_api_enabled")
            @android.annotation.RequiresPermission(allOf={"android.permission.READ_CONTACTS", "android.permission.SET_DEFAULT_ACCOUNT_FOR_CONTACTS"})
    ...
    public static final class SimContacts {
        ...
        @android.annotation.SystemApi
        @android.annotation.RequiresPermission("android.contacts.permission.MANAGE_SIM_ACCOUNTS")
