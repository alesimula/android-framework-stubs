...
public class VoicemailContract {
    ...
    public static final class Voicemails implements android.provider.BaseColumns, android.provider.OpenableColumns {
        ...
        private static android.content.ContentValues getContentValues(android.provider.Voicemail p0) { return null; }
        public static int insert(android.content.Context p0, java.util.List<android.provider.Voicemail> p1) { return 0; }
        public static android.net.Uri insert(android.content.Context p0, android.provider.Voicemail p1) { return null; }
    }
}
