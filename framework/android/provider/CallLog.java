...
public class CallLog {
    ...
    public static class AddCallParams {
        ...
        public static final class AddCallParametersBuilder {
            ...
            @android.annotation.NonNull
            public android.provider.CallLog.AddCallParams.AddCallParametersBuilder setIsBusinessCall(boolean p0) { return null; }
            @android.annotation.FlaggedApi("com.android.server.telecom.flags.business_call_composer")
            @android.annotation.NonNull
            public android.provider.CallLog.AddCallParams.AddCallParametersBuilder setAssertedDisplayName(java.lang.String p0) { return null; }
            @android.annotation.NonNull
    ...
    public static class Calls implements android.provider.BaseColumns {
        ...
        public static final long USER_MISSED_NOT_RUNNING = 16777216L;
