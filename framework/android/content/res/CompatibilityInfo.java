...
public class CompatibilityInfo implements android.os.Parcelable {
    ...
    public boolean isOverrideDisplayRotationRequired() { return false; }
    ...
    public static void applyDisplayRotationConfiguration(int p0, android.content.res.Configuration p1) {}
    public static void applyOverrideIfNeeded(android.content.res.Configuration p0) {}
    public static void applyOverrideIfNeeded(android.util.MergedConfiguration p0) {}
    public static void setOverrideInvertedScale(float p0) {}
    public static void setOverrideInvertedScale(float p0, float p1) {}
    public static float getOverrideInvertedScale() { return 0.0f; }
    public static float getOverrideDensityInvertedScale() { return 0.0f; }
    public static void setOverrideDisplayRotation(int p0) {}
    public static int getOverrideDisplayRotation() { return 0; }
