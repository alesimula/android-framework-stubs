...
public interface ContentInterface {
    ...
    public android.net.Uri insert(android.net.Uri p0, android.content.ContentValues p1) throws android.os.RemoteException;
    public int bulkInsert(android.net.Uri p0, android.content.ContentValues[] p1) throws android.os.RemoteException;
    public int delete(android.net.Uri p0, java.lang.String p1, java.lang.String[] p2) throws android.os.RemoteException;
    public int update(android.net.Uri p0, android.content.ContentValues p1, java.lang.String p2, java.lang.String[] p3) throws android.os.RemoteException;
