...
public abstract class ContentResolver implements android.content.ContentInterface {
    ...
    public static final int CONTENT_PROVIDER_PUBLISH_TIMEOUT_MILLIS = Integer.valueOf(0);
    public static final int CONTENT_PROVIDER_READY_TIMEOUT_MILLIS = Integer.valueOf(0);
    private static final int CONTENT_PROVIDER_TIMEOUT_MILLIS = Integer.valueOf(0);
    ...
    private static final int REMOTE_CONTENT_PROVIDER_TIMEOUT_MILLIS = Integer.valueOf(0);
    ...
    private static final int SLOW_THRESHOLD_MILLIS = Integer.valueOf(0);
    ...
    public final void registerContentObserverAsUser(android.net.Uri p0, boolean p1, android.database.ContentObserver p2, android.os.UserHandle p3) {}
