...
public class SyncAdaptersCache extends android.content.pm.RegisteredServicesCache<android.content.SyncAdapterType> {
    ...
    static class MySerializer implements android.content.pm.XmlSerializerAndParser<android.content.SyncAdapterType> {
        MySerializer() {}
        public void writeAsXml(android.content.SyncAdapterType p0, android.util.TypedXmlSerializer p1) throws java.io.IOException {}
        public android.content.SyncAdapterType createFromXml(android.util.TypedXmlPullParser p0) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException { return null; }
    }
}
