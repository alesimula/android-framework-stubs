...
public class Intent implements android.os.Parcelable, java.lang.Cloneable {
    ...
    @android.annotation.FlaggedApi("android.content.flags.stop_voice_command")
    ...
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission("android.permission.MASTER_CLEAR")
    ...
    @android.annotation.RequiresPermission("android.permission.LAUNCH_CAPTURE_CONTENT_ACTIVITY_FOR_NOTE")
    ...
    @android.annotation.FlaggedApi("android.security.prevent_intent_redirect")
    ...
    @android.annotation.FlaggedApi("android.security.enforce_intent_filter_match")
