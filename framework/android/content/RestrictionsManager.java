...
public class RestrictionsManager {
    ...
    private final android.content.IRestrictionsManager mService = null;
    public RestrictionsManager(android.content.Context p0, android.content.IRestrictionsManager p1) {}
    private static android.os.Bundle addRestrictionToBundle(android.os.Bundle p0, android.content.RestrictionEntry p1) { return null; }
    ...
    private java.util.List<android.content.RestrictionEntry> loadManifestRestrictions(java.lang.String p0, android.content.res.XmlResourceParser p1) { return null; }
    private android.content.RestrictionEntry loadRestriction(android.content.Context p0, android.content.res.TypedArray p1, android.content.res.XmlResourceParser p2) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException { return null; }
    private android.content.RestrictionEntry loadRestrictionElement(android.content.Context p0, android.content.res.XmlResourceParser p1) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException { return null; }
    ...
    public java.util.List<android.os.Bundle> getApplicationRestrictionsPerAdmin() { return null; }
