...
public interface IRollbackManager extends android.os.IInterface {
    ...
    public void blockRollbackManager(long p0) throws android.os.RemoteException;
    ...
    public int notifyStagedSession(int p0) throws android.os.RemoteException;
    public void reloadPersistedData() throws android.os.RemoteException;
    public void snapshotAndRestoreUserData(java.lang.String p0, int[] p1, int p2, int p3, long p4, java.lang.String p5, int p6) throws android.os.RemoteException;
    ...
    public static class Default implements android.content.rollback.IRollbackManager {
        ...
        public android.content.pm.ParceledListSlice getRecentlyCommittedRollbacks() throws android.os.RemoteException { return null; }
        public int notifyStagedSession(int p0) throws android.os.RemoteException { return 0; }
        public void reloadPersistedData() throws android.os.RemoteException {}
        public void snapshotAndRestoreUserData(java.lang.String p0, int[] p1, int p2, int p3, long p4, java.lang.String p5, int p6) throws android.os.RemoteException {}
    }
    ...
    public static abstract class Stub extends android.os.Binder implements android.content.rollback.IRollbackManager {
        ...
        private static final class Proxy implements android.content.rollback.IRollbackManager {
