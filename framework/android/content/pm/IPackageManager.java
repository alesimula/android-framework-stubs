...
public interface IPackageManager extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.content.pm.IPackageManager {
        ...
        static final int TRANSACTION_getMoveStatus = 110;
        static final int TRANSACTION_registerMoveCallback = 111;
        static final int TRANSACTION_unregisterMoveCallback = 112;
        static final int TRANSACTION_movePackage = 113;
        static final int TRANSACTION_movePrimaryStorage = 114;
        static final int TRANSACTION_setInstallLocation = 115;
        static final int TRANSACTION_getInstallLocation = 116;
        static final int TRANSACTION_installExistingPackageAsUser = 117;
        static final int TRANSACTION_verifyPendingInstall = 118;
        static final int TRANSACTION_extendVerificationTimeout = 119;
        static final int TRANSACTION_verifyIntentFilter = 120;
        static final int TRANSACTION_getIntentVerificationStatus = 121;
        static final int TRANSACTION_updateIntentVerificationStatus = 122;
        static final int TRANSACTION_getIntentFilterVerifications = 123;
        static final int TRANSACTION_getAllIntentFilters = 124;
        static final int TRANSACTION_getVerifierDeviceIdentity = 125;
        static final int TRANSACTION_isFirstBoot = 126;
        ...
        static final int TRANSACTION_getPropertyAsUser = 202;
        ...
        static final int TRANSACTION_waitForHandler = 206;
        public Stub() { super(); }
