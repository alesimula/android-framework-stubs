...
public abstract class PackageManager {
    ...
    @android.annotation.FlaggedApi("com.android.server.backup.enable_restricted_mode_changes")
    ...
    @android.annotation.SystemApi
    @android.annotation.FlaggedApi("android.content.pm.fix_duplicated_flags")
    ...
    @android.annotation.SystemApi
    @android.annotation.FlaggedApi("android.content.pm.asl_in_apk_app_metadata_source")
    ...
    @android.annotation.FlaggedApi("android.media.audio.feature_spatial_audio_headtracking_low_latency")
    ...
    public static final java.util.List<java.security.cert.Certificate> TRUST_ALL = null;
    @android.annotation.NonNull
    public static final java.util.List<java.security.cert.Certificate> TRUST_NONE = null;
    public static final android.app.PropertyInvalidatedCache<android.content.pm.PackageManager.ApplicationInfoQuery, android.content.pm.ApplicationInfo> sApplicationInfoCache = null;
    public static final int SDK_FEATURE_COUNT = Integer.valueOf(0);
    ...
    @android.annotation.NonNull
    @android.annotation.RequiresPermission("android.permission.INTERACT_ACROSS_USERS")
    public android.content.pm.ApplicationInfo getApplicationInfoAsUser(java.lang.String p0, android.content.pm.PackageManager.ApplicationInfoFlags p1, android.os.UserHandle p2) throws android.content.pm.PackageManager.NameNotFoundException { return null; }
    ...
    @android.annotation.SystemApi
    @android.annotation.NonNull
    @android.annotation.RequiresPermission("android.permission.GET_APP_METADATA")
    ...
    @android.annotation.FlaggedApi("android.content.pm.asl_in_apk_app_metadata_source")
    @android.annotation.RequiresPermission("android.permission.GET_APP_METADATA")
    public int getAppMetadataSource(java.lang.String p0) throws android.content.pm.PackageManager.NameNotFoundException { return 0; }
    @android.annotation.NonNull
    ...
    @java.lang.Deprecated
    @android.annotation.FlaggedApi("android.permission.flags.permission_tree_apis_deprecated")
    ...
    @android.annotation.SystemApi
    @android.annotation.NonNull
    @android.annotation.RequiresPermission("android.permission.ACCESS_SHARED_LIBRARIES")
    ...
    @android.annotation.NonNull
    @android.annotation.RequiresPermission("android.permission.INTERACT_ACROSS_USERS")
    public java.util.List<android.content.pm.ResolveInfo> queryIntentActivitiesAsUser(android.content.Intent p0, android.content.pm.PackageManager.ResolveInfoFlags p1, android.os.UserHandle p2) { return null; }
    @android.annotation.NonNull
    ...
    @android.annotation.NonNull
    @android.annotation.RequiresPermission("android.permission.INTERACT_ACROSS_USERS")
    public java.util.List<android.content.pm.ResolveInfo> queryBroadcastReceiversAsUser(android.content.Intent p0, android.content.pm.PackageManager.ResolveInfoFlags p1, android.os.UserHandle p2) { return null; }
    @android.annotation.NonNull
    ...
    @android.annotation.NonNull
    @android.annotation.RequiresPermission("android.permission.INTERACT_ACROSS_USERS")
    public java.util.List<android.content.pm.ResolveInfo> queryIntentServicesAsUser(android.content.Intent p0, android.content.pm.PackageManager.ResolveInfoFlags p1, android.os.UserHandle p2) { return null; }
    @android.annotation.NonNull
    ...
    @android.annotation.NonNull
    protected java.util.List<android.content.pm.ResolveInfo> queryIntentContentProvidersAsUser(android.content.Intent p0, android.content.pm.PackageManager.ResolveInfoFlags p1, int p2) { return null; }
    @android.annotation.SystemApi
    @android.annotation.NonNull
    @android.annotation.RequiresPermission("android.permission.INTERACT_ACROSS_USERS")
    ...
    @android.annotation.NonNull
    @android.annotation.RequiresPermission("android.permission.INTERACT_ACROSS_USERS")
    public java.util.List<android.content.pm.ResolveInfo> queryIntentContentProvidersAsUser(android.content.Intent p0, android.content.pm.PackageManager.ResolveInfoFlags p1, android.os.UserHandle p2) { return null; }
    @android.annotation.NonNull
    ...
    @android.annotation.RequiresPermission("android.permission.RESOLVE_COMPONENT_FOR_UID")
    ...
    @java.lang.Deprecated
    @android.annotation.RequiresPermission(anyOf={"com.android.permission.INSTALL_EXISTING_PACKAGES", "android.permission.INSTALL_PACKAGES", "android.permission.INTERACT_ACROSS_USERS_FULL"})
    ...
    @java.lang.Deprecated
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission("android.permission.INTENT_FILTER_VERIFICATION_AGENT")
    ...
    @java.lang.Deprecated
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission("android.permission.SET_PREFERRED_APPLICATIONS")
    ...
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission(allOf={"android.permission.SET_PREFERRED_APPLICATIONS", "android.permission.INTERACT_ACROSS_USERS_FULL"})
    ...
    @android.annotation.RequiresPermission(anyOf={"android.permission.DELETE_PACKAGES", "android.permission.INTERACT_ACROSS_USERS_FULL"})
    ...
    @android.annotation.FlaggedApi("android.content.pm.archiving")
    public boolean isAppArchivable(java.lang.String p0) throws android.content.pm.PackageManager.NameNotFoundException { return false; }
    ...
    @android.annotation.RequiresPermission(value="android.permission.CHANGE_COMPONENT_ENABLED_STATE", conditional=true)
    ...
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission("android.permission.SUSPEND_APPS")
    @android.annotation.NonNull
    ...
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission(value="android.permission.SUSPEND_APPS", conditional=true)
    @android.annotation.Nullable
    ...
    @android.annotation.SystemApi
    @android.annotation.FlaggedApi("android.content.pm.quarantined_enabled")
    @android.annotation.RequiresPermission(anyOf={"android.permission.SUSPEND_APPS", "android.permission.QUARANTINE_APPS"}, conditional=true)
    @android.annotation.SuppressLint("NullableCollection")
    @android.annotation.Nullable
    public java.lang.String[] setPackagesSuspended(java.lang.String[] p0, boolean p1, android.os.PersistableBundle p2, android.os.PersistableBundle p3, android.content.pm.SuspendDialogInfo p4, int p5) { return null; }
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission("android.permission.SUSPEND_APPS")
    @android.annotation.NonNull
    ...
    public boolean isPackageStopped(java.lang.String p0) throws android.content.pm.PackageManager.NameNotFoundException { return false; }
    @android.annotation.FlaggedApi("android.content.pm.quarantined_enabled")
    public boolean isPackageQuarantined(java.lang.String p0) throws android.content.pm.PackageManager.NameNotFoundException { return false; }
    ...
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission("android.permission.SET_HARMFUL_APP_WARNINGS")
    public void setHarmfulAppWarning(java.lang.String p0, java.lang.CharSequence p1) {}
    @android.annotation.FlaggedApi("android.content.pm.app_compat_option_16kb")
    ...
    @java.lang.Deprecated
    @android.annotation.Nullable
    public final java.lang.String getContentCaptureServicePackageName() { return null; }
    @android.annotation.SystemApi
    @android.annotation.Nullable
    ...
    @android.annotation.RequiresPermission("android.permission.KEEP_UNINSTALLED_PACKAGES")
    public void setKeepUninstalledPackages(java.util.List<java.lang.String> p0) {}
    @android.annotation.SystemApi
    @android.annotation.NonNull
    ...
    @android.annotation.FlaggedApi("android.content.pm.get_package_info")
    public <T extends java.lang.Object> T parseAndroidManifest(java.io.File p0, java.util.function.Function<android.content.res.XmlResourceParser, T> p1) throws java.io.IOException { return null; }
    @android.annotation.FlaggedApi("android.content.pm.get_package_info_with_fd")
    public <T extends java.lang.Object> T parseAndroidManifest(android.os.ParcelFileDescriptor p0, java.util.function.Function<android.content.res.XmlResourceParser, T> p1) throws java.io.IOException { return null; }
    ...
    @android.annotation.NonNull
    public static android.content.pm.SigningInfo getVerifiedSigningInfo(java.lang.String p0, int p1) throws android.content.pm.SigningInfoException { return null; }
    ...
    private static final class ApplicationInfoQuery {
        ...
        final long flags = 0L;
        final int userId = 0;
        ApplicationInfoQuery(java.lang.String p0, long p1, int p2) {}
    ...
    public static final class ComponentEnabledSetting implements android.os.Parcelable {
        @android.annotation.NonNull
        public static final android.os.Parcelable.Creator<android.content.pm.PackageManager.ComponentEnabledSetting> CREATOR = null;
        ...
        public int getEnabledFlags() { return 0; }
        public void writeToParcel(android.os.Parcel p0, int p1) {}
        public int describeContents() { return 0; }
        ComponentEnabledSetting(android.os.Parcel p0) {}
    }

    public static final class ComponentInfoFlags extends android.content.pm.PackageManager.Flags {
        ComponentInfoFlags() { super(0L); }
        @android.annotation.NonNull
        public static android.content.pm.PackageManager.ComponentInfoFlags of(long p0) { return null; }
    }
    ...
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
    public static @interface DevelopmentInstallFlags {
    }
    ...
    public static final class PackageInfoFlags extends android.content.pm.PackageManager.Flags {
        PackageInfoFlags() { super(0L); }
        @android.annotation.NonNull
        public static android.content.pm.PackageManager.PackageInfoFlags of(long p0) { return null; }
    }
    ...
    private static final class PackageInfoQuery {
        ...
        final long flags = 0L;
        final int userId = 0;
        PackageInfoQuery(java.lang.String p0, long p1, int p2) {}
        public java.lang.String toString() { return null; }
        public int hashCode() { return 0; }
        public boolean equals(java.lang.Object p0) { return false; }
    }
    ...
    public static final class Property implements android.os.Parcelable {
        @android.annotation.NonNull
        public static final android.os.Parcelable.Creator<android.content.pm.PackageManager.Property> CREATOR = null;
    ...
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
    public static @interface RollbackImpactLevel {
    }
    ...
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
    public static @interface SuspendedFlags {
    }
    ...
    public static final class UninstallCompleteCallback implements android.os.Parcelable {
        @android.annotation.NonNull
        public static final android.os.Parcelable.Creator<android.content.pm.PackageManager.UninstallCompleteCallback> CREATOR = null;
        ...
        @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
        public static @interface DeleteStatus {
        }
    }
    ...
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
    public static @interface UserMinAspectRatio {
    }
}
