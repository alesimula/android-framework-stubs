...
public interface ILauncherApps extends android.os.IInterface {
    ...
    public android.app.PendingIntent getActivityLaunchIntent(java.lang.String p0, android.content.ComponentName p1, android.os.UserHandle p2) throws android.os.RemoteException;
    public android.content.pm.ParceledListSlice getActivityLaunchIntentForAllApps(java.lang.String p0, android.os.UserHandle p1) throws android.os.RemoteException;
    public java.util.Map<java.lang.String, android.content.pm.LauncherActivityInfoInternal> getActivityOverrides(java.lang.String p0, int p1) throws android.os.RemoteException;
    public android.content.pm.ParceledListSlice getAllSessions(java.lang.String p0) throws android.os.RemoteException;
    public android.content.IntentSender getAppMarketActivityIntent(java.lang.String p0, java.lang.String p1, android.os.UserHandle p2) throws android.os.RemoteException;
    ...
    public android.content.pm.ParceledListSlice getAvailableShortcuts(java.lang.String p0, android.os.UserHandle p1) throws android.os.RemoteException;
    ...
    public android.content.pm.LauncherUserInfo getLauncherUserInfo(android.os.UserHandle p0) throws android.os.RemoteException;
    public java.util.List<java.lang.String> getPreInstalledSystemPackages(android.os.UserHandle p0) throws android.os.RemoteException;
    ...
    public void registerDumpCallback(android.window.IDumpCallback p0) throws android.os.RemoteException;
    ...
    public void setArchiveCompatibilityOptions(boolean p0, boolean p1) throws android.os.RemoteException;
    public boolean shouldHideFromSuggestions(java.lang.String p0, android.os.UserHandle p1) throws android.os.RemoteException;
    public void showAppDetailsAsUser(android.os.IBinder p0, android.app.IApplicationThread p1, java.lang.String p2, java.lang.String p3, android.content.ComponentName p4, android.graphics.Rect p5, android.os.Bundle p6, android.os.UserHandle p7) throws android.os.RemoteException;
    public void startActivityAsUser(android.os.IBinder p0, android.app.IApplicationThread p1, java.lang.String p2, java.lang.String p3, android.content.ComponentName p4, android.graphics.Rect p5, android.os.Bundle p6, android.os.UserHandle p7) throws android.os.RemoteException;
    public void startSessionDetailsActivityAsUser(android.os.IBinder p0, android.app.IApplicationThread p1, java.lang.String p2, java.lang.String p3, android.content.pm.PackageInstaller.SessionInfo p4, android.graphics.Rect p5, android.os.Bundle p6, android.os.UserHandle p7) throws android.os.RemoteException;
    public boolean startShortcut(android.os.IBinder p0, java.lang.String p1, java.lang.String p2, java.lang.String p3, java.lang.String p4, android.graphics.Rect p5, android.os.Bundle p6, int p7) throws android.os.RemoteException;
    public void unRegisterDumpCallback(android.window.IDumpCallback p0) throws android.os.RemoteException;
    ...
    public static class Default implements android.content.pm.ILauncherApps {
        ...
        public void cacheShortcuts(java.lang.String p0, java.lang.String p1, java.util.List<java.lang.String> p2, android.os.UserHandle p3, int p4) throws android.os.RemoteException {}
        public android.app.PendingIntent getActivityLaunchIntent(java.lang.String p0, android.content.ComponentName p1, android.os.UserHandle p2) throws android.os.RemoteException { return null; }
        public android.content.pm.ParceledListSlice getActivityLaunchIntentForAllApps(java.lang.String p0, android.os.UserHandle p1) throws android.os.RemoteException { return null; }
        public java.util.Map<java.lang.String, android.content.pm.LauncherActivityInfoInternal> getActivityOverrides(java.lang.String p0, int p1) throws android.os.RemoteException { return null; }
        ...
        public android.content.IntentSender getAppMarketActivityIntent(java.lang.String p0, java.lang.String p1, android.os.UserHandle p2) throws android.os.RemoteException { return null; }
        ...
        public android.content.pm.ParceledListSlice getAvailableShortcuts(java.lang.String p0, android.os.UserHandle p1) throws android.os.RemoteException { return null; }
        ...
        public android.content.pm.LauncherUserInfo getLauncherUserInfo(android.os.UserHandle p0) throws android.os.RemoteException { return null; }
        public java.util.List<java.lang.String> getPreInstalledSystemPackages(android.os.UserHandle p0) throws android.os.RemoteException { return null; }
        public android.content.IntentSender getPrivateSpaceSettingsIntent() throws android.os.RemoteException { return null; }
        ...
        public java.util.List<android.os.UserHandle> getUserProfiles() throws android.os.RemoteException { return null; }
        ...
        public void startActivityAsUser(android.os.IBinder p0, android.app.IApplicationThread p1, java.lang.String p2, java.lang.String p3, android.content.ComponentName p4, android.graphics.Rect p5, android.os.Bundle p6, android.os.UserHandle p7) throws android.os.RemoteException {}
        public void startSessionDetailsActivityAsUser(android.os.IBinder p0, android.app.IApplicationThread p1, java.lang.String p2, java.lang.String p3, android.content.pm.PackageInstaller.SessionInfo p4, android.graphics.Rect p5, android.os.Bundle p6, android.os.UserHandle p7) throws android.os.RemoteException {}
        public boolean startShortcut(android.os.IBinder p0, java.lang.String p1, java.lang.String p2, java.lang.String p3, java.lang.String p4, android.graphics.Rect p5, android.os.Bundle p6, int p7) throws android.os.RemoteException { return false; }
        public void unRegisterDumpCallback(android.window.IDumpCallback p0) throws android.os.RemoteException {}
        public void uncacheShortcuts(java.lang.String p0, java.lang.String p1, java.util.List<java.lang.String> p2, android.os.UserHandle p3, int p4) throws android.os.RemoteException {}
        public void unregisterShortcutChangeCallback(java.lang.String p0, android.content.pm.IShortcutChangeCallback p1) throws android.os.RemoteException {}
    }
    ...
    public static abstract class Stub extends android.os.Binder implements android.content.pm.ILauncherApps {
        ...
        static final int TRANSACTION_getActivityLaunchIntentForAllApps = 41;
        ...
        static final int TRANSACTION_getAvailableShortcuts = 40;
        ...
        private static final class Proxy implements android.content.pm.ILauncherApps {
