...
public final class InstantAppResolveInfo implements android.os.Parcelable {
    ...
    private static final byte[] EMPTY_DIGEST = null;
    private final android.content.pm.InstantAppResolveInfo.InstantAppDigest mDigest = null;
    private final java.lang.String mPackageName = null;
    private final java.util.List<android.content.pm.InstantAppIntentFilter> mFilters = null;
    private final long mVersionCode = 0L;
    private final android.os.Bundle mExtras = null;
    private final boolean mShouldLetInstallerDecide = false;
    ...
    private InstantAppResolveInfo(android.content.pm.InstantAppResolveInfo.InstantAppDigest p0, java.lang.String p1, java.util.List<android.content.pm.InstantAppIntentFilter> p2, long p3, android.os.Bundle p4, boolean p5) {}
    ...
    public static final class InstantAppDigest implements android.os.Parcelable {
        ...
        private final byte[][] mDigestBytes = null;
        private final int[] mDigestPrefix = null;
        ...
        private InstantAppDigest(byte[][] p0, int[] p1) {}
        private static byte[][] generateDigest(java.lang.String p0, int p1) { return null; }
