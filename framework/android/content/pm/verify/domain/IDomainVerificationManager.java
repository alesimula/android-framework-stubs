...
public interface IDomainVerificationManager extends android.os.IInterface {
    ...
    public java.util.List<android.content.pm.verify.domain.DomainOwner> getOwnersForDomain(java.lang.String p0, int p1, boolean p2) throws android.os.RemoteException;
    public android.os.Bundle getUriRelativeFilterGroups(java.lang.String p0, java.util.List<java.lang.String> p1) throws android.os.RemoteException;
    ...
    public void setUriRelativeFilterGroups(java.lang.String p0, android.os.Bundle p1) throws android.os.RemoteException;
    ...
    public static class Default implements android.content.pm.verify.domain.IDomainVerificationManager {
        ...
        public java.util.List<android.content.pm.verify.domain.DomainOwner> getOwnersForDomain(java.lang.String p0, int p1, boolean p2) throws android.os.RemoteException { return null; }
        public android.os.Bundle getUriRelativeFilterGroups(java.lang.String p0, java.util.List<java.lang.String> p1) throws android.os.RemoteException { return null; }
    ...
    public static abstract class Stub extends android.os.Binder implements android.content.pm.verify.domain.IDomainVerificationManager {
        ...
        private static final class Proxy implements android.content.pm.verify.domain.IDomainVerificationManager {
