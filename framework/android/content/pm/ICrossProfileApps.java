...
public interface ICrossProfileApps extends android.os.IInterface {
    public boolean canConfigureInteractAcrossProfiles(int p0, java.lang.String p1) throws android.os.RemoteException;
    ...
    public boolean canUserAttemptToConfigureInteractAcrossProfiles(int p0, java.lang.String p1) throws android.os.RemoteException;
    public void clearInteractAcrossProfilesAppOps(int p0) throws android.os.RemoteException;
    public java.util.List<android.os.UserHandle> getTargetUserProfiles(java.lang.String p0) throws android.os.RemoteException;
    public void resetInteractAcrossProfilesAppOps(int p0, java.util.List<java.lang.String> p1) throws android.os.RemoteException;
    public void setInteractAcrossProfilesAppOp(int p0, java.lang.String p1, int p2) throws android.os.RemoteException;
    public void startActivityAsUser(android.app.IApplicationThread p0, java.lang.String p1, java.lang.String p2, android.content.ComponentName p3, int p4, boolean p5, android.os.IBinder p6, android.os.Bundle p7) throws android.os.RemoteException;
    ...
    public static class Default implements android.content.pm.ICrossProfileApps {
        ...
        public boolean canConfigureInteractAcrossProfiles(int p0, java.lang.String p1) throws android.os.RemoteException { return false; }
        ...
        public boolean canUserAttemptToConfigureInteractAcrossProfiles(int p0, java.lang.String p1) throws android.os.RemoteException { return false; }
        public void clearInteractAcrossProfilesAppOps(int p0) throws android.os.RemoteException {}
    ...
    public static abstract class Stub extends android.os.Binder implements android.content.pm.ICrossProfileApps {
        ...
        private static final class Proxy implements android.content.pm.ICrossProfileApps {
