...
public interface IOnAppsChangedListener extends android.os.IInterface {
    ...
    public void onPackageLoadingProgressChanged(android.os.UserHandle p0, java.lang.String p1, float p2) throws android.os.RemoteException;
    ...
    public void onUserConfigChanged(android.content.pm.LauncherUserInfo p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.content.pm.IOnAppsChangedListener {
        ...
        private static final class Proxy implements android.content.pm.IOnAppsChangedListener {
