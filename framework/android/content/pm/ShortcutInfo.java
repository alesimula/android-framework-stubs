...
public final class ShortcutInfo implements android.os.Parcelable {
    ...
    private static android.util.ArraySet<java.lang.String> cloneCategories(java.util.Set<java.lang.String> p0) { return null; }
    private static android.content.Intent[] cloneIntents(android.content.Intent[] p0) { return null; }
    private static android.os.PersistableBundle[] clonePersistableBundle(android.os.PersistableBundle[] p0) { return null; }
    private static android.app.Person[] clonePersons(android.app.Person[] p0) { return null; }
    public void enforceMandatoryFields(boolean p0) {}
    private ShortcutInfo(android.content.pm.ShortcutInfo p0, int p1) {}
    private java.lang.CharSequence getResourceString(android.content.res.Resources p0, int p1, java.lang.CharSequence p2) { return null; }
    ...
    private java.lang.String toStringInner(boolean p0, boolean p1, java.lang.String p2) { return null; }
    public ShortcutInfo(int p0, java.lang.String p1, java.lang.String p2, android.content.ComponentName p3, android.graphics.drawable.Icon p4, java.lang.CharSequence p5, int p6, java.lang.String p7, java.lang.CharSequence p8, int p9, java.lang.String p10, java.lang.CharSequence p11, int p12, java.lang.String p13, java.util.Set<java.lang.String> p14, android.content.Intent[] p15, int p16, android.os.PersistableBundle p17, long p18, int p19, int p20, java.lang.String p21, java.lang.String p22, java.lang.String p23, int p24, android.app.Person[] p25, android.content.LocusId p26, java.lang.String p27) {}
