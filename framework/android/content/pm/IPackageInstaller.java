...
public interface IPackageInstaller extends android.os.IInterface {
    ...
    public android.content.pm.PackageInstaller.RegisteredAppStoreInfo getRegisteredAppStoreInfo(java.lang.String p0, android.content.pm.SigningDetails p1) throws android.os.RemoteException;
    public java.util.List<java.lang.String> getRegisteredAppStores(int p0) throws android.os.RemoteException;
    ...
    public boolean isInstallingRegisteredAppStore(int p0) throws android.os.RemoteException;
    public boolean isInstallingRegisteredAppStorePackage(java.lang.String p0, android.content.pm.SigningDetails p1) throws android.os.RemoteException;
    ...
    public void retryRegisteredAppStoreAllowlist(int p0, android.os.RemoteCallback p1) throws android.os.RemoteException;
    ...
    public void setSessionAllowedForUnknownSources(int p0) throws android.os.RemoteException;
    ...
    public static class Default implements android.content.pm.IPackageInstaller {
        ...
        public android.content.pm.PackageInstaller.RegisteredAppStoreInfo getRegisteredAppStoreInfo(java.lang.String p0, android.content.pm.SigningDetails p1) throws android.os.RemoteException { return null; }
        public java.util.List<java.lang.String> getRegisteredAppStores(int p0) throws android.os.RemoteException { return null; }
        ...
        public void installExistingPackage(java.lang.String p0, int p1, int p2, android.content.IntentSender p3, int p4, java.util.List<java.lang.String> p5) throws android.os.RemoteException {}
        public void installPackageArchived(android.content.pm.ArchivedPackageParcel p0, android.content.pm.PackageInstaller.SessionParams p1, android.content.IntentSender p2, java.lang.String p3, android.os.UserHandle p4) throws android.os.RemoteException {}
        public boolean isInstallingRegisteredAppStore(int p0) throws android.os.RemoteException { return false; }
        public boolean isInstallingRegisteredAppStorePackage(java.lang.String p0, android.content.pm.SigningDetails p1) throws android.os.RemoteException { return false; }
    ...
    public static abstract class Stub extends android.os.Binder implements android.content.pm.IPackageInstaller {
        ...
        static final int TRANSACTION_addDeveloperVerificationExperiment = 34;
        static final int TRANSACTION_bypassNextAllowedApexUpdateCheck = 18;
        static final int TRANSACTION_bypassNextStagedInstallerCheck = 17;
        static final int TRANSACTION_checkInstallConstraints = 22;
        static final int TRANSACTION_clearDeveloperVerificationExperiment = 35;
        static final int TRANSACTION_createSession = 1;
        static final int TRANSACTION_disableVerificationForUid = 19;
        static final int TRANSACTION_getAllSessions = 8;
        static final int TRANSACTION_getDeveloperVerificationPolicy = 28;
        static final int TRANSACTION_getDeveloperVerificationPolicyDelegatePackage = 31;
        static final int TRANSACTION_getDeveloperVerificationServiceProvider = 30;
        static final int TRANSACTION_getDeveloperVerificationUserConfirmationInfo = 33;
        static final int TRANSACTION_getMySessions = 9;
        static final int TRANSACTION_getRegisteredAppStoreInfo = 38;
        static final int TRANSACTION_getRegisteredAppStores = 39;
        static final int TRANSACTION_getSessionInfo = 7;
        static final int TRANSACTION_getStagedSessions = 10;
        static final int TRANSACTION_installExistingPackage = 15;
        static final int TRANSACTION_installPackageArchived = 26;
        static final int TRANSACTION_isInstallingRegisteredAppStore = 36;
        static final int TRANSACTION_isInstallingRegisteredAppStorePackage = 37;
        static final int TRANSACTION_openSession = 6;
        static final int TRANSACTION_registerCallback = 11;
        static final int TRANSACTION_reportUnarchivalStatus = 27;
        static final int TRANSACTION_requestArchive = 24;
        static final int TRANSACTION_requestUnarchive = 25;
        static final int TRANSACTION_retryRegisteredAppStoreAllowlist = 40;
        static final int TRANSACTION_setAllowUnlimitedSilentUpdates = 20;
        static final int TRANSACTION_setDeveloperVerificationPolicy = 29;
        static final int TRANSACTION_setDeveloperVerificationUserResponse = 32;
        static final int TRANSACTION_setPermissionsResult = 16;
        static final int TRANSACTION_setSessionAllowedForUnknownSources = 5;
        static final int TRANSACTION_setSilentUpdatesThrottleTime = 21;
        static final int TRANSACTION_uninstall = 13;
        static final int TRANSACTION_uninstallExistingPackage = 14;
        ...
        static final int TRANSACTION_waitForInstallConstraints = 23;
        ...
        protected void getRegisteredAppStoreInfo_enforcePermission() throws java.lang.SecurityException {}
        protected void getRegisteredAppStores_enforcePermission() throws java.lang.SecurityException {}
        public java.lang.String getTransactionName(int p0) { return null; }
        protected void isInstallingRegisteredAppStorePackage_enforcePermission() throws java.lang.SecurityException {}
        protected void isInstallingRegisteredAppStore_enforcePermission() throws java.lang.SecurityException {}
        public boolean onTransact(int p0, android.os.Parcel p1, android.os.Parcel p2, int p3) throws android.os.RemoteException { return false; }
        protected void retryRegisteredAppStoreAllowlist_enforcePermission() throws java.lang.SecurityException {}
        ...
        protected void setSessionAllowedForUnknownSources_enforcePermission() throws java.lang.SecurityException {}
