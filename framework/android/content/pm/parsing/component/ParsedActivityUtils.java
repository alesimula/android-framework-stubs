...
public class ParsedActivityUtils {
    ...
    private static android.content.pm.parsing.result.ParseResult<android.content.pm.ActivityInfo.WindowLayout> resolveActivityWindowLayout(android.content.pm.parsing.component.ParsedActivity p0, android.content.pm.parsing.result.ParseInput p1) { return null; }
    static int getActivityConfigChanges(int p0, int p1) { return 0; }
}
