...
public class PackageInfoWithoutStateUtils {
    public static final java.lang.String SYSTEM_DATA_PATH = null;
    ...
    public static android.content.pm.ApplicationInfo generateApplicationInfoUnchecked(android.content.pm.parsing.ParsingPackageRead p0, int p1, android.content.pm.PackageUserState p2, int p3, boolean p4) { return null; }
    ...
    public static android.content.pm.ActivityInfo generateActivityInfoUnchecked(android.content.pm.parsing.component.ParsedActivity p0, int p1, android.content.pm.ApplicationInfo p2) { return null; }
    ...
    public static android.content.pm.ServiceInfo generateServiceInfoUnchecked(android.content.pm.parsing.component.ParsedService p0, int p1, android.content.pm.ApplicationInfo p2) { return null; }
    ...
    public static android.content.pm.InstrumentationInfo generateInstrumentationInfo(android.content.pm.parsing.component.ParsedInstrumentation p0, android.content.pm.parsing.ParsingPackageRead p1, int p2, int p3, boolean p4) { return null; }
    ...
    public static android.content.pm.Attribution generateAttribution(android.content.pm.parsing.component.ParsedAttribution p0) { return null; }
    ...
    public static int appInfoPrivateFlagsExt(android.content.pm.parsing.ParsingPackageRead p0) { return 0; }
    ...
    private static void assignUserFields(android.content.pm.parsing.ParsingPackageRead p0, android.content.pm.ApplicationInfo p1, int p2) {}
    private static void assignUserFields(android.content.pm.parsing.ParsingPackageRead p0, android.content.pm.InstrumentationInfo p1, int p2) {}
}
