...
public interface IDataLoaderManager extends android.os.IInterface {
    ...
    public boolean bindToDataLoader(int p0, android.content.pm.DataLoaderParamsParcel p1, long p2, android.content.pm.IDataLoaderStatusListener p3) throws android.os.RemoteException;
    ...
    public static class Default implements android.content.pm.IDataLoaderManager {
        ...
        public boolean bindToDataLoader(int p0, android.content.pm.DataLoaderParamsParcel p1, long p2, android.content.pm.IDataLoaderStatusListener p3) throws android.os.RemoteException { return false; }
    ...
    public static abstract class Stub extends android.os.Binder implements android.content.pm.IDataLoaderManager {
        ...
        private static final class Proxy implements android.content.pm.IDataLoaderManager {
