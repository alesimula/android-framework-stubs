...
public final class ThermalDynamicProperties {
    private ThermalDynamicProperties() {}
    ...
    public static java.util.Optional<android.sysprop.ThermalDynamicProperties.reload_thermal_dynamic_config_profile_values> reload_thermal_dynamic_config_profile() { return null; }
    ...
    public static enum reload_thermal_dynamic_config_profile_values {
        DEFAULT,
        KIDS,
        KIDS_SETUP,
        SETUP;
