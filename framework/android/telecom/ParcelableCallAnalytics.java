...
public class ParcelableCallAnalytics implements android.os.Parcelable {
    ...
    private final long callDurationMillis = 0L;
    private final int callType = 0;
    private final boolean isAdditionalCall = false;
    private final boolean isInterrupted = false;
    private final int callTechnologies = 0;
    private final int callTerminationCode = 0;
    private final boolean isEmergencyCall = false;
    private final java.lang.String connectionService = null;
    private final boolean isCreatedFromExistingConnection = false;
    private final java.util.List<android.telecom.ParcelableCallAnalytics.AnalyticsEvent> analyticsEvents = null;
    private final java.util.List<android.telecom.ParcelableCallAnalytics.EventTiming> eventTimings = null;
    ...
    private static void writeBooleanAsByte(android.os.Parcel p0, boolean p1) {}
    private static boolean readByteAsBoolean(android.os.Parcel p0) { return false; }
    ...
    public static final class EventTiming implements android.os.Parcelable {
        ...
        private EventTiming(android.os.Parcel p0) {}
