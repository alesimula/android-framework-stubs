...
public final class Phone {
    private final java.util.Map<java.lang.String, android.telecom.Call> mCallByTelecomCallId = null;
    private final java.util.List<android.telecom.Call> mCalls = null;
    private final java.util.List<android.telecom.Call> mUnmodifiableCalls = null;
    private final android.telecom.InCallAdapter mInCallAdapter = null;
    private android.telecom.CallAudioState mCallAudioState;
    private final java.util.List<android.telecom.Phone.Listener> mListeners = null;
    ...
    private void fireCallAdded(android.telecom.Call p0) {}
    private void fireCallRemoved(android.telecom.Call p0) {}
    private void fireCallAudioStateChanged(android.telecom.CallAudioState p0) {}
    private void fireBringToForeground(boolean p0) {}
    private void fireCanAddCallChanged(boolean p0) {}
    private void fireSilenceRinger() {}
    private void checkCallTree(android.telecom.ParcelableCall p0) {}
