...
public final class ParcelableConnection implements android.os.Parcelable {
    ...
    public ParcelableConnection(android.telecom.PhoneAccountHandle p0, int p1, int p2, int p3, int p4, android.net.Uri p5, int p6, java.lang.String p7, int p8, com.android.internal.telecom.IVideoProvider p9, int p10, boolean p11, boolean p12, long p13, long p14, android.telecom.StatusHints p15, android.telecom.DisconnectCause p16, java.util.List<java.lang.String> p17, android.os.Bundle p18, java.lang.String p19, int p20) {}
    public ParcelableConnection(android.telecom.PhoneAccountHandle p0, int p1, int p2, int p3, int p4, android.net.Uri p5, int p6, java.lang.String p7, int p8, com.android.internal.telecom.IVideoProvider p9, int p10, boolean p11, boolean p12, long p13, long p14, android.telecom.StatusHints p15, android.telecom.DisconnectCause p16, java.util.List<java.lang.String> p17, android.os.Bundle p18) {}
