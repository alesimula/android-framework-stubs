...
public final class ParcelableCall implements android.os.Parcelable {
    ...
    public ParcelableCall(java.lang.String p0, int p1, android.telecom.DisconnectCause p2, java.util.List<java.lang.String> p3, int p4, int p5, int p6, long p7, android.net.Uri p8, int p9, java.lang.String p10, int p11, android.telecom.GatewayInfo p12, android.telecom.PhoneAccountHandle p13, boolean p14, com.android.internal.telecom.IVideoProvider p15, boolean p16, android.telecom.ParcelableRttCall p17, java.lang.String p18, java.util.List<java.lang.String> p19, android.telecom.StatusHints p20, int p21, java.util.List<java.lang.String> p22, android.os.Bundle p23, android.os.Bundle p24, long p25, int p26, int p27, java.lang.String p28, java.lang.String p29, android.net.Uri p30, android.os.UserHandle p31) {}
    ...
    @android.annotation.NonNull
    public android.os.UserHandle getAssociatedUser() { return null; }
    @android.annotation.Nullable
    ...
    public static class ParcelableCallBuilder {
        ...
        public android.telecom.ParcelableCall.ParcelableCallBuilder setContactPhotoUri(android.net.Uri p0) { return null; }
        public android.telecom.ParcelableCall.ParcelableCallBuilder setAssociatedUser(android.os.UserHandle p0) { return null; }
