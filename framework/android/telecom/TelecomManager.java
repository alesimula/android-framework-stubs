...
public class TelecomManager {
    ...
    @android.annotation.FlaggedApi("com.android.server.telecom.flags.integrated_call_logs")
    public static final java.lang.String ACTION_CALL_BACK = "android.telecom.action.CALL_BACK";
    ...
    @android.annotation.FlaggedApi("com.android.server.telecom.flags.integrated_call_logs")
    public static final java.lang.String EXTRA_UUID = "android.telecom.extra.UUID";
    ...
    @android.annotation.FlaggedApi("com.android.server.telecom.flags.add_call_uri_for_missed_calls")
    ...
    @android.annotation.SystemApi
    @android.annotation.FlaggedApi("com.android.server.telecom.flags.call_connected_indicator_preference")
    public static final int CALL_CONNECTED_INDICATOR_NONE = 0;
    @android.annotation.SystemApi
    @android.annotation.FlaggedApi("com.android.server.telecom.flags.call_connected_indicator_preference")
    public static final int CALL_CONNECTED_INDICATOR_TONE = 1;
    @android.annotation.SystemApi
    @android.annotation.FlaggedApi("com.android.server.telecom.flags.call_connected_indicator_preference")
    public static final int CALL_CONNECTED_INDICATOR_VIBRATION = 2;
    ...
    @android.annotation.FlaggedApi("com.android.internal.telephony.flags.work_profile_api_split")
    @android.annotation.RequiresPermission(allOf={"android.permission.READ_PHONE_STATE", "android.permission.INTERACT_ACROSS_PROFILES"})
    @android.annotation.NonNull
    public java.util.List<android.telecom.PhoneAccountHandle> getCallCapablePhoneAccountsAcrossProfiles() { return null; }
    @android.annotation.RequiresPermission("android.permission.READ_PHONE_STATE")
    @android.annotation.NonNull
    ...
    @android.annotation.FlaggedApi("com.android.server.telecom.flags.get_registered_phone_accounts")
    @android.annotation.NonNull
    public java.util.List<android.telecom.PhoneAccount> getRegisteredPhoneAccounts() { return null; }
    @android.annotation.SystemApi
    ...
    @android.annotation.SystemApi
    @android.annotation.FlaggedApi("com.android.internal.telephony.flags.work_profile_api_split")
    @android.annotation.RequiresPermission(allOf={"android.permission.READ_PRIVILEGED_PHONE_STATE", "android.permission.INTERACT_ACROSS_PROFILES"})
    @android.annotation.NonNull
    public java.util.List<android.telecom.PhoneAccountHandle> getCallCapablePhoneAccountsAcrossProfiles(boolean p0) { return null; }
    @android.annotation.SystemApi
    @java.lang.Deprecated
    @android.annotation.SuppressLint("RequiresPermission")
    ...
    public boolean hasForegroundServiceDelegation(android.telecom.PhoneAccountHandle p0) { return false; }
    @java.lang.Deprecated
    ...
    @android.annotation.RequiresPermission(allOf={"android.permission.READ_PRIVILEGED_PHONE_STATE", "android.permission.INTERACT_ACROSS_USERS"}, conditional=true)
    ...
    public void addCall(android.telecom.CallAttributes p0, java.util.concurrent.Executor p1, android.os.OutcomeReceiver<android.telecom.CallControl, android.telecom.CallException> p2, android.telecom.CallControlCallback p3, android.telecom.CallEventCallback p4) {}
    public void handleCallIntent(android.content.Intent p0, java.lang.String p1) {}
    @android.annotation.SystemApi
    @android.annotation.FlaggedApi("com.android.server.telecom.flags.call_connected_indicator_preference")
    @android.annotation.RequiresPermission("android.permission.READ_PRIVILEGED_PHONE_STATE")
    public int getCallConnectedIndicatorPreference() { return 0; }
    @android.annotation.SystemApi
    @android.annotation.FlaggedApi("com.android.server.telecom.flags.call_connected_indicator_preference")
    @android.annotation.RequiresPermission("android.permission.MODIFY_PHONE_STATE")
    public void setCallConnectedIndicatorPreference(int p0) {}

    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
    @android.annotation.FlaggedApi("com.android.server.telecom.flags.call_connected_indicator_preference")
    public static @interface CallConnectedIndicator {
    }
