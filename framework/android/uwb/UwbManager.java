...
public final class UwbManager {
    ...
    public void getUwbActivityEnergyInfoAsync(java.util.concurrent.Executor p0, java.util.function.Consumer<android.uwb.UwbActivityEnergyInfo> p1) {}
    public boolean isUwbEnabled() { return false; }
    @android.annotation.FlaggedApi("com.android.uwb.flags.hw_state")
    public boolean isUwbHwEnableRequested() { return false; }
    @android.annotation.FlaggedApi("com.android.uwb.flags.hw_state")
    public boolean isUwbHwIdleTurnOffEnabled() { return false; }
    @android.annotation.NonNull
    ...
    @android.annotation.FlaggedApi("com.android.uwb.flags.query_timestamp_micros")
    @android.annotation.NonNull
    public long queryUwbsTimestampMicros() { return 0L; }
    public void registerAdapterStateCallback(java.util.concurrent.Executor p0, android.uwb.UwbManager.AdapterStateCallback p1) {}
    @android.annotation.FlaggedApi("com.android.uwb.flags.uwb_fira_3_0_25q4")
    public void registerChannelUsageCallback(java.util.concurrent.Executor p0, android.uwb.UwbManager.ChannelUsageCallback p1) {}
    public void registerUwbOemExtensionCallback(java.util.concurrent.Executor p0, android.uwb.UwbManager.UwbOemExtensionCallback p1) {}
    ...
    @android.annotation.FlaggedApi("com.android.uwb.flags.hw_state")
    public void requestUwbHwEnabled(boolean p0) {}
    @android.annotation.NonNull
    public int sendVendorUciMessage(int p0, int p1, byte[] p2) { return 0; }
    @android.annotation.NonNull
    public int sendVendorUciMessage(int p0, int p1, int p2, byte[] p3) { return 0; }
    ...
    @android.annotation.FlaggedApi("com.android.uwb.flags.uwb_fira_3_0_25q4")
    public void unregisterChannelUsageCallback(android.uwb.UwbManager.ChannelUsageCallback p0) {}
    public void unregisterUwbOemExtensionCallback(android.uwb.UwbManager.UwbOemExtensionCallback p0) {}
    ...
    @android.annotation.FlaggedApi("com.android.uwb.flags.uwb_fira_3_0_25q4")
    public static interface ChannelUsageCallback {
        public void onChanged(java.util.Map<java.lang.Integer, java.lang.Boolean> p0);
    }

    public static interface UwbOemExtensionCallback {
        public boolean onCheckPointedTarget(android.os.PersistableBundle p0);
        public void onDeviceStatusNotificationReceived(android.os.PersistableBundle p0);
        @android.annotation.NonNull
        public android.uwb.RangingReport onRangingReportReceived(android.uwb.RangingReport p0);
        @android.annotation.NonNull
        public int onSessionConfigurationComplete(android.os.PersistableBundle p0);
        public void onSessionStatusNotificationReceived(android.os.PersistableBundle p0);
    }
