...
abstract class AndroidKeyStoreCipherSpiBase extends javax.crypto.CipherSpi implements android.security.keystore.KeyStoreCryptoOperation {
    ...
    private android.security.keystore2.KeyStoreCryptoOperationStreamer mAdditionalAuthenticationDataStreamer;
    ...
    private android.security.keystore2.KeyStoreCryptoOperationStreamer mMainDataStreamer;
    ...
    private void ensureKeystoreOperationInitialized(android.system.keystore2.Authorization[] p0) throws java.security.InvalidKeyException, java.security.InvalidAlgorithmParameterException {}
    private void flushAAD() throws android.security.KeyStoreException {}
    private android.system.keystore2.Authorization[] getKeyCharacteristics(java.security.Key p0) { return null; }
