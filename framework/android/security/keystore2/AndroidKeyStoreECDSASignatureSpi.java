...
abstract class AndroidKeyStoreECDSASignatureSpi extends android.security.keystore2.AndroidKeyStoreSignatureSpiBase {
    private static final java.util.Set<java.lang.String> ACCEPTED_SIGNING_SCHEMES = null;
    private int mGroupSizeBits;
    private final int mKeymasterDigest = 0;
    AndroidKeyStoreECDSASignatureSpi(int p0) { super(); }
    protected final void addAlgorithmSpecificParametersToBegin(android.security.keystore2.AndroidKeyStoreKey p0, java.util.List<android.hardware.security.keymint.KeyParameter> p1) {}
    ...
    public static final class NONE extends android.security.keystore2.AndroidKeyStoreECDSASignatureSpi {
        ...
        private static class TruncateToFieldSizeMessageStreamer implements android.security.keystore2.KeyStoreCryptoOperationStreamer {
            ...
            private TruncateToFieldSizeMessageStreamer(android.security.keystore2.KeyStoreCryptoOperationStreamer p0, int p1) {}
