...
public interface IKeystoreMetrics extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.security.metrics.IKeystoreMetrics {
        ...
        public static boolean setDefaultImpl(android.security.metrics.IKeystoreMetrics p0) { return false; }
        public static android.security.metrics.IKeystoreMetrics getDefaultImpl() { return null; }
