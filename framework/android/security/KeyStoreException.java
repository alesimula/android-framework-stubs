...
public class KeyStoreException extends java.lang.Exception {
    ...
    private static final android.security.KeyStoreException.PublicErrorInformation GENERAL_KEYMINT_ERROR = null;
    private static final android.security.KeyStoreException.PublicErrorInformation GENERAL_KEYSTORE_ERROR = null;
    private static final int IS_SYSTEM_ERROR = 2;
    private static final int IS_TRANSIENT_ERROR = 4;
    private static final android.security.KeyStoreException.PublicErrorInformation KEYMINT_INCORRECT_USAGE_ERROR = null;
    private static final android.security.KeyStoreException.PublicErrorInformation KEYMINT_RETRYABLE_ERROR = null;
    private static final android.security.KeyStoreException.PublicErrorInformation KEYMINT_TEMPORAL_VALIDITY_ERROR = null;
    private static final android.security.KeyStoreException.PublicErrorInformation KEYMINT_UNIMPLEMENTED_ERROR = null;
    ...
    private static final java.util.Map<java.lang.Integer, android.security.KeyStoreException.PublicErrorInformation> sErrorCodeToFailureInfo = null;
    private final int mErrorCode = 0;
    private final int mRkpStatus = 0;
    ...
    private static android.security.KeyStoreException.PublicErrorInformation getErrorInformation(int p0) { return null; }
    public static boolean hasFailureInfoForError(int p0) { return false; }
    private static int initializeRkpStatusForRegularErrors(int p0) { return 0; }
