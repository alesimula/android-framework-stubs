...
public interface ITrustTokenManager extends android.os.IInterface {
    ...
    public boolean canVerifyTokens() throws android.os.RemoteException;
    public void updatePreparedIdentities(java.util.List<java.lang.String> p0) throws android.os.RemoteException;
    public android.security.trusttoken.TrustTokenVerificationResult[] verifyIdentityTokens(android.security.trusttoken.TrustToken p0, android.security.trusttoken.TrustToken[] p1) throws android.os.RemoteException;
    public android.security.trusttoken.TrustTokenVerificationResult verifyTrustTokenAndChallenge(android.security.trusttoken.TrustToken p0, byte[] p1, byte[] p2) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.security.trusttoken.ITrustTokenManager {
        ...
        static final int TRANSACTION_canVerifyTokens = 6;
        ...
        private static final class Proxy implements android.security.trusttoken.ITrustTokenManager {
            ...
            public android.os.IBinder asBinder() { return null; }
            public boolean canVerifyTokens() throws android.os.RemoteException { return false; }
            public final java.lang.String getInterfaceDescriptor() { return null; }
            public void updatePreparedIdentities(java.util.List<java.lang.String> p0) throws android.os.RemoteException {}
            public android.security.trusttoken.TrustTokenVerificationResult[] verifyIdentityTokens(android.security.trusttoken.TrustToken p0, android.security.trusttoken.TrustToken[] p1) throws android.os.RemoteException { return null; }
            public android.security.trusttoken.TrustTokenVerificationResult verifyTrustTokenAndChallenge(android.security.trusttoken.TrustToken p0, byte[] p1, byte[] p2) throws android.os.RemoteException { return null; }
        }
    }
