...
public interface IKeystoreService extends android.os.IInterface {
    ...
    public int finish(android.security.keystore.IKeystoreOperationResultCallback p0, android.os.IBinder p1, android.security.keymaster.KeymasterArguments p2, byte[] p3, byte[] p4, byte[] p5) throws android.os.RemoteException;
    ...
    public void getTokensForCredstore(long p0, long p1, int p2, android.security.keystore.ICredstoreTokenCallback p3) throws android.os.RemoteException;
    ...
    public static class Default implements android.security.keystore.IKeystoreService {
        ...
        public int finish(android.security.keystore.IKeystoreOperationResultCallback p0, android.os.IBinder p1, android.security.keymaster.KeymasterArguments p2, byte[] p3, byte[] p4, byte[] p5) throws android.os.RemoteException { return 0; }
