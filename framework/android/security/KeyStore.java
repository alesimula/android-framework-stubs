...
public class KeyStore {
    ...
    private int generateKeyInternal(java.lang.String p0, android.security.keymaster.KeymasterArguments p1, byte[] p2, int p3, int p4, android.security.keymaster.KeyCharacteristics p5) throws android.os.RemoteException, java.util.concurrent.ExecutionException { return 0; }
    ...
    private int importKeyInternal(java.lang.String p0, android.security.keymaster.KeymasterArguments p1, int p2, byte[] p3, int p4, int p5, android.security.keymaster.KeyCharacteristics p6) throws android.os.RemoteException, java.util.concurrent.ExecutionException { return 0; }
    ...
    private int importWrappedKeyInternal(java.lang.String p0, byte[] p1, java.lang.String p2, byte[] p3, android.security.keymaster.KeymasterArguments p4, long p5, long p6, android.security.keymaster.KeyCharacteristics p7) throws android.os.RemoteException, java.util.concurrent.ExecutionException { return 0; }
    ...
    public android.security.keymaster.OperationResult finish(android.os.IBinder p0, android.security.keymaster.KeymasterArguments p1, byte[] p2, byte[] p3, byte[] p4) { return null; }
    ...
    public void onUserLockedStateChanged(int p0, boolean p1) {}
    ...
    private static <R extends java.lang.Object> R interruptedPreservingGet(java.util.concurrent.CompletableFuture<R> p0) throws java.util.concurrent.ExecutionException { return null; }
