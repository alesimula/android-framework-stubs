...
public interface ICredential extends android.os.IInterface {
    ...
    public android.security.identity.GetEntriesResultParcel getEntries(byte[] p0, android.security.identity.RequestNamespaceParcel[] p1, byte[] p2, byte[] p3, boolean p4, boolean p5, boolean p6) throws android.os.RemoteException;
    public byte[] proveOwnership(byte[] p0) throws android.os.RemoteException;
    public long selectAuthKey(boolean p0, boolean p1, boolean p2) throws android.os.RemoteException;
    public void setAvailableAuthenticationKeys(int p0, int p1, long p2) throws android.os.RemoteException;
    ...
    public static class Default implements android.security.identity.ICredential {
        ...
        public long[] getAuthenticationDataExpirations() throws android.os.RemoteException { return null; }
        ...
        public android.security.identity.GetEntriesResultParcel getEntries(byte[] p0, android.security.identity.RequestNamespaceParcel[] p1, byte[] p2, byte[] p3, boolean p4, boolean p5, boolean p6) throws android.os.RemoteException { return null; }
        public byte[] proveOwnership(byte[] p0) throws android.os.RemoteException { return null; }
        public long selectAuthKey(boolean p0, boolean p1, boolean p2) throws android.os.RemoteException { return 0L; }
        public void setAvailableAuthenticationKeys(int p0, int p1, long p2) throws android.os.RemoteException {}
        public void setReaderEphemeralPublicKey(byte[] p0) throws android.os.RemoteException {}
        public void storeStaticAuthenticationData(android.security.identity.AuthKeyParcel p0, byte[] p1) throws android.os.RemoteException {}
        public void storeStaticAuthenticationDataWithExpiration(android.security.identity.AuthKeyParcel p0, long p1, byte[] p2) throws android.os.RemoteException {}
    ...
    public static abstract class Stub extends android.os.Binder implements android.security.identity.ICredential {
        ...
        private static final class Proxy implements android.security.identity.ICredential {
