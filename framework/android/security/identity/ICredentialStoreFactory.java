...
public interface ICredentialStoreFactory extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.security.identity.ICredentialStoreFactory {
        private static final java.lang.String DESCRIPTOR = "android.security.identity.ICredentialStoreFactory";
        ...
        public static boolean setDefaultImpl(android.security.identity.ICredentialStoreFactory p0) { return false; }
        public static android.security.identity.ICredentialStoreFactory getDefaultImpl() { return null; }

        private static class Proxy implements android.security.identity.ICredentialStoreFactory {
            private android.os.IBinder mRemote;
            public static android.security.identity.ICredentialStoreFactory sDefaultImpl;
