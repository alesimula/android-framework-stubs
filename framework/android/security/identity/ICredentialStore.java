...
public interface ICredentialStore extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.security.identity.ICredentialStore {
        private static final java.lang.String DESCRIPTOR = "android.security.identity.ICredentialStore";
        ...
        public static boolean setDefaultImpl(android.security.identity.ICredentialStore p0) { return false; }
        public static android.security.identity.ICredentialStore getDefaultImpl() { return null; }

        private static class Proxy implements android.security.identity.ICredentialStore {
            private android.os.IBinder mRemote;
            public static android.security.identity.ICredentialStore sDefaultImpl;
