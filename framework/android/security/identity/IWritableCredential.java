...
public interface IWritableCredential extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.security.identity.IWritableCredential {
        private static final java.lang.String DESCRIPTOR = "android.security.identity.IWritableCredential";
        ...
        public static boolean setDefaultImpl(android.security.identity.IWritableCredential p0) { return false; }
        public static android.security.identity.IWritableCredential getDefaultImpl() { return null; }

        private static class Proxy implements android.security.identity.IWritableCredential {
            private android.os.IBinder mRemote;
            public static android.security.identity.IWritableCredential sDefaultImpl;
