...
class CalendarViewMaterialDelegate extends android.widget.CalendarView.AbstractCalendarViewDelegate {
    private final android.widget.DayPickerView mDayPickerView = null;
    ...
    public CalendarViewMaterialDelegate(android.widget.CalendarView p0, android.content.Context p1, android.util.AttributeSet p2, int p3, int p4) { super(null, null); }
