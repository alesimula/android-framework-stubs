...
public class TextView extends android.view.View implements android.view.ViewTreeObserver.OnPreDrawListener {
    ...
    @android.annotation.UnsupportedAppUsage(trackingBug=124050217L)
    ...
    @android.annotation.UnsupportedAppUsage(trackingBug=123769451L)
    ...
    private boolean shouldAdvanceFocusOnTab() { return false; }
    ...
    private void applySingleLine(boolean p0, boolean p1, boolean p2) {}
    ...
    void replaceSelectionWithText(java.lang.CharSequence p0) {}
    private void paste(int p0, int p1, boolean p2) {}
