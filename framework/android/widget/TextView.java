...
public class TextView extends android.view.View implements android.view.ViewTreeObserver.OnPreDrawListener {
    private static final int ACCESSIBILITY_ACTION_LOOK_UP = 268500992;
    ...
    public static final long USE_BOUNDS_FOR_WIDTH = 63938206L;
    ...
    private android.os.UserHandle mEnforceImePolicyUser;
    ...
    private final java.util.List<android.graphics.Path> mPathRecyclePool = null;
    ...
    private int[] adjustHandwritingDeleteGestureRange(int[] p0) { return null; }
    ...
    private android.graphics.PointF convertFromScreenToContentCoordinates(android.graphics.PointF p0) { return null; }
    private android.graphics.RectF convertFromScreenToContentCoordinates(android.graphics.RectF p0) { return null; }
    private void convertFromViewportToContentCoordinates(android.graphics.Rect p0) {}
    private void createEditorIfNeeded() {}
    private android.content.Intent createLookUpTextIntent(java.lang.String p0) { return null; }
    private static int desired(android.text.Layout p0, boolean p1) { return 0; }
    ...
    private int getActionIdForEnterEvent() { return 0; }
    private int getBottomVerticalOffset(boolean p0) { return 0; }
    private int getBoxHeight(android.text.Layout p0) { return 0; }
    private float[] getCharacterBounds(int p0, int p1, float p2, float p3) { return null; }
    private boolean getContentVisibleRect(android.graphics.Rect p0) { return false; }
    private boolean getContentVisibleRect(android.graphics.RectF p0) { return false; }
    ...
    private android.util.DisplayMetrics getDisplayMetricsOrSystem() { return null; }
    private boolean getEditorAndHandwritingBounds(android.graphics.RectF p0, android.graphics.RectF p1) { return false; }
    ...
    private int getLineForHandwritingGesture(android.graphics.PointF p0) { return 0; }
    private int[] getRangeForRect(android.graphics.RectF p0, int p1) { return null; }
    private android.graphics.Paint.FontMetrics getResolvedMinimumFontMetrics() { return null; }
    ...
    private boolean getViewVisibleRect(android.graphics.Rect p0) { return false; }
    private java.util.regex.Pattern getWhitespacePattern() { return null; }
    private int handleGestureFailure(android.view.inputmethod.HandwritingGesture p0) { return 0; }
    private int handleGestureFailure(android.view.inputmethod.HandwritingGesture p0, boolean p1) { return 0; }
    private boolean hasEditorInFocusSearchDirection(int p0) { return false; }
    ...
    private boolean isFallbackLineSpacingForBoringLayout() { return false; }
    ...
    private int performHandwritingDeleteGesture(android.view.inputmethod.DeleteGesture p0, boolean p1) { return 0; }
    private int performHandwritingDeleteGesture(int[] p0, int p1, boolean p2) { return 0; }
    private int performHandwritingDeleteRangeGesture(android.view.inputmethod.DeleteRangeGesture p0, boolean p1) { return 0; }
    ...
    private void setDeleteGesturePreviewHighlight(int p0, int p1) {}
    private void setFilters(android.text.Editable p0, android.text.InputFilter[] p1) {}
    private void setGesturePreviewHighlight(int p0, int p1, int p2) {}
    ...
    private void setLineHeightPx(float p0) {}
    ...
    private void setSelectGesturePreviewHighlight(int p0, int p1) {}
    ...
    private boolean shouldStartHandwritingForEndOfLineTap(android.view.MotionEvent p0) { return false; }
    private boolean showAutofillDialog() { return false; }
    ...
    private int tryInsertTextForHandwritingGesture(int p0, java.lang.String p1, android.view.inputmethod.HandwritingGesture p2) { return 0; }
    private void unregisterForPreDraw() {}
    private void updateCursorVisibleInternal() {}
    private void updateLineBreakConfigFromTextAppearance(boolean p0, boolean p1, int p2, int p3) {}
    ...
    public boolean bringPointIntoView(int p0, boolean p1) { return false; }
    public boolean canCopy() { return false; }
    public boolean canCut() { return false; }
    boolean canLookUpText() { return false; }
    public boolean canPaste() { return false; }
    public boolean canPasteAsPlainText() { return false; }
    boolean canProcessText() { return false; }
    public boolean canRedo() { return false; }
    boolean canReplace() { return false; }
    public boolean canRequestAutofill() { return false; }
    public boolean canSelectAllText() { return false; }
    ...
    public android.view.inputmethod.CursorAnchorInfo getCursorAnchorInfo(int p0, android.view.inputmethod.CursorAnchorInfo.Builder p1, android.graphics.Matrix p2) { return null; }
    ...
    public int getFocusedSearchResultHighlightColor() { return 0; }
    public int getFocusedSearchResultIndex() { return 0; }
    ...
    public android.text.Highlights getHighlights() { return null; }
    ...
    public int getLineAtCoordinate(float p0) { return 0; }
    ...
    public int getSearchResultHighlightColor() { return 0; }
    public int[] getSearchResultHighlights() { return null; }
    public java.lang.String getSelectedText() { return null; }
    public void getSelection(int p0, int p1, android.text.Layout.SelectionRectangleConsumer p2) {}
    @android.view.ViewDebug.ExportedProperty(category="text")
    public int getSelectionEnd() { return 0; }
    int getSelectionEndTransformed() { return 0; }
    @android.view.ViewDebug.ExportedProperty(category="text")
    public int getSelectionStart() { return 0; }
    int getSelectionStartTransformed() { return 0; }
    ...
    public android.view.inputmethod.TextBoundsInfo getTextBoundsInfo(android.graphics.RectF p0) { return null; }
    ...
    public boolean hasComposingText() { return false; }
    boolean hasGesturePreviewHighlight() { return false; }
    ...
    public boolean isCommittingText() { return false; }
    public boolean isConversionSuggestionSelected() { return false; }
    ...
    public boolean isOffsetMappingAvailable() { return false; }
    ...
    boolean isTextAutofillable() { return false; }
    ...
    public int performHandwritingDeleteGesture(android.view.inputmethod.DeleteGesture p0) { return 0; }
    public int performHandwritingDeleteRangeGesture(android.view.inputmethod.DeleteRangeGesture p0) { return 0; }
    public int performHandwritingInsertGesture(android.view.inputmethod.InsertGesture p0) { return 0; }
    public int performHandwritingInsertModeGesture(android.view.inputmethod.InsertModeGesture p0) { return 0; }
    public int performHandwritingJoinOrSplitGesture(android.view.inputmethod.JoinOrSplitGesture p0) { return 0; }
    public int performHandwritingRemoveSpaceGesture(android.view.inputmethod.RemoveSpaceGesture p0) { return 0; }
    public int performHandwritingSelectGesture(android.view.inputmethod.SelectGesture p0) { return 0; }
    public int performHandwritingSelectRangeGesture(android.view.inputmethod.SelectRangeGesture p0) { return 0; }
    ...
    public final void setEnforceImePolicyUser(android.os.UserHandle p0) {}
    @android.view.RemotableViewMethod
    ...
    public void setFocusedSearchResultHighlightColor(int p0) {}
    public void setFocusedSearchResultIndex(int p0) {}
    @android.view.RemotableViewMethod
    ...
    public void setHighlights(android.text.Highlights p0) {}
    @android.view.RemotableViewMethod
    ...
    public void setLocalePreferredLineHeightForMinimumUsed(boolean p0) {}
    ...
    public void setMinimumFontMetrics(android.graphics.Paint.FontMetrics p0) {}
    ...
    public void setSearchResultHighlightColor(int p0) {}
    public void setSearchResultHighlights(int... p0) {}
    @android.view.RemotableViewMethod
    ...
    public void setShiftDrawingOffsetForStartOverhang(boolean p0) {}
    @android.view.RemotableViewMethod
    ...
    public void setSuggestionSelection(boolean p0) {}
    @android.view.RemotableViewMethod
    ...
    public java.lang.Runnable setTextAsync(java.lang.CharSequence p0) { return null; }
    void setTextChangeTypes(android.view.accessibility.AccessibilityEvent p0) {}
    ...
    void setTransformationMethodInternal(android.text.method.TransformationMethod p0, boolean p1) {}
    ...
    public void setUseBoundsForWidth(boolean p0) {}
    @android.view.RemotableViewMethod
    ...
    public final boolean showUIForTouchScreen() { return false; }
    ...
    public static enum BufferType {
        ...
        NORMAL,
        SPANNABLE;
        private static final android.widget.TextView.BufferType[] $VALUES = null;
        private BufferType() {}
    }
