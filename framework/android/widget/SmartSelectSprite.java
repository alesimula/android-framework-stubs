...
final class SmartSelectSprite {
    ...
    private final android.view.animation.Interpolator mCornerInterpolator = null;
    ...
    private android.animation.Animator createAnimator(android.widget.SmartSelectSprite.RectangleList p0, float p1, float p2, java.util.List<android.animation.Animator> p3, android.animation.ValueAnimator.AnimatorUpdateListener p4, java.lang.Runnable p5) { return null; }
    private void setUpAnimatorListener(android.animation.Animator p0, java.lang.Runnable p1) {}
    private android.animation.ObjectAnimator createCornerAnimator(android.widget.SmartSelectSprite.RoundedRectangleShape p0, android.animation.ValueAnimator.AnimatorUpdateListener p1) { return null; }
