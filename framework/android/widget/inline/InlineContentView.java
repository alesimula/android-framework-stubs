...
public class InlineContentView extends android.view.ViewGroup {
    ...
    private final android.view.SurfaceHolder.Callback mSurfaceCallback = null;
    private final android.view.SurfaceControl.OnReparentListener mOnReparentListener = null;
    private final android.view.ViewTreeObserver.OnDrawListener mOnDrawListener = null;
