...
public interface IKeystoreService extends android.os.IInterface {
    ...
    public int getNumberOfEntries(int p0, long p1) throws android.os.RemoteException;
    public android.system.keystore2.KeyDescriptor[] listEntriesBatched(int p0, long p1, java.lang.String p2) throws android.os.RemoteException;
    public byte[] getSupplementaryAttestationInfo(int p0) throws android.os.RemoteException;
    ...
    public static class Default implements android.system.keystore2.IKeystoreService {
        ...
        public void ungrant(android.system.keystore2.KeyDescriptor p0, int p1) throws android.os.RemoteException {}
        public int getNumberOfEntries(int p0, long p1) throws android.os.RemoteException { return 0; }
        public android.system.keystore2.KeyDescriptor[] listEntriesBatched(int p0, long p1, java.lang.String p2) throws android.os.RemoteException { return null; }
        public byte[] getSupplementaryAttestationInfo(int p0) throws android.os.RemoteException { return null; }
