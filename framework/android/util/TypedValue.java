...
public class TypedValue {
    ...
    private static final java.lang.String[] DIMENSION_UNIT_STRS = null;
    private static final java.lang.String[] FRACTION_UNIT_STRS = null;
    private static final float INCHES_PER_MM = 0.03937007859349251f;
    private static final float INCHES_PER_PT = 0.013888888992369175f;
    ...
    public int type;
    public boolean usesFeatureFlags;
    public TypedValue() {}
    ...
    public static float convertDimensionToPixels(int p0, float p1, android.util.DisplayMetrics p2) { return 0.0f; }
    public static float convertPixelsToDimension(int p0, float p1, android.util.DisplayMetrics p2) { return 0.0f; }
    private static int createComplex(int p0, int p1) { return 0; }
    ...
    public static float deriveDimension(int p0, float p1, android.util.DisplayMetrics p2) { return 0.0f; }
    public static int floatToComplex(float p0) { return 0; }
    public static int getUnitFromComplexDimension(int p0) { return 0; }
    public static int intToComplex(int p0) { return 0; }
    private static boolean isValidMantissa(int p0) { return false; }
    ...
    void setFields(int p0, int p1, int p2, int p3, int p4, int p5, boolean p6) {}
