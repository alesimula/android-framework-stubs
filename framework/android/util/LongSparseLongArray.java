...
public class LongSparseLongArray implements java.lang.Cloneable {
    ...
    public LongSparseLongArray(int p0) {}
    ...
    public void put(long p0, long p1) {}
    public int size() { return 0; }
    public long keyAt(int p0) { return 0L; }
    public long valueAt(int p0) { return 0L; }
    ...
    public static class Parcelling implements com.android.internal.util.Parcelling<android.util.LongSparseLongArray> {
        public Parcelling() {}
        public void parcel(android.util.LongSparseLongArray p0, android.os.Parcel p1, int p2) {}
        public android.util.LongSparseLongArray unparcel(android.os.Parcel p0) { return null; }
    }
}
