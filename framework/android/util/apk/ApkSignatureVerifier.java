...
public class ApkSignatureVerifier {
    ...
    private static java.io.FileDescriptor dupFd(java.io.FileDescriptor p0) throws java.io.IOException { return null; }
    ...
    public static android.content.pm.parsing.result.ParseResult<android.content.pm.SigningDetails> unsafeGetCertsWithoutVerification(android.content.pm.parsing.result.ParseInput p0, java.io.FileDescriptor p1, java.lang.String p2, int p3) { return null; }
    ...
    public static android.content.pm.parsing.result.ParseResult<android.content.pm.SigningDetails> verify(android.content.pm.parsing.result.ParseInput p0, java.io.FileDescriptor p1, java.lang.String p2, int p3) { return null; }
    public static android.content.pm.parsing.result.ParseResult<android.content.pm.SigningDetails> verify(android.content.pm.parsing.result.ParseInput p0, java.io.FileDescriptor p1, java.lang.String p2, int p3, java.util.function.Supplier<java.io.File> p4) { return null; }
    public static android.content.pm.parsing.result.ParseResult<android.content.pm.SigningDetails> verify(android.content.pm.parsing.result.ParseInput p0, java.io.FileDescriptor p1, java.lang.String p2, int p3, java.util.function.Supplier<java.io.File> p4, android.util.apk.InitAppScanMetrics p5) { return null; }
    ...
    private static android.content.pm.parsing.result.ParseResult<android.content.pm.SigningDetails> verifySignatures(android.content.pm.parsing.result.ParseInput p0, java.io.FileDescriptor p1, java.lang.String p2, int p3, boolean p4, java.util.function.Supplier<java.io.File> p5, android.util.apk.InitAppScanMetrics p6) { return null; }
    ...
    public static android.content.pm.parsing.result.ParseResult<android.util.apk.ApkSignatureVerifier.SigningDetailsWithDigests> verifySignaturesInternal(android.content.pm.parsing.result.ParseInput p0, java.io.FileDescriptor p1, java.lang.String p2, int p3, boolean p4) { return null; }
    public static android.content.pm.parsing.result.ParseResult<android.util.apk.ApkSignatureVerifier.SigningDetailsWithDigests> verifySignaturesInternal(android.content.pm.parsing.result.ParseInput p0, java.io.FileDescriptor p1, java.lang.String p2, int p3, boolean p4, java.util.function.Supplier<java.io.File> p5, android.util.apk.InitAppScanMetrics p6) { return null; }
    ...
    private static android.content.pm.parsing.result.ParseResult<android.util.apk.ApkSignatureVerifier.SigningDetailsWithDigests> verifyV1Signature(android.content.pm.parsing.result.ParseInput p0, java.io.FileDescriptor p1, java.lang.String p2, boolean p3, android.util.apk.InitAppScanMetrics p4) { return null; }
    ...
    private static android.content.pm.parsing.result.ParseResult<android.util.apk.ApkSignatureVerifier.SigningDetailsWithDigests> verifyV2Signature(android.content.pm.parsing.result.ParseInput p0, java.io.FileDescriptor p1, java.lang.String p2, boolean p3, android.util.apk.InitAppScanMetrics p4) throws android.util.apk.SignatureNotFoundException { return null; }
    ...
    private static android.content.pm.parsing.result.ParseResult<android.util.apk.ApkSignatureVerifier.SigningDetailsWithDigests> verifyV3AndBelowSignatures(android.content.pm.parsing.result.ParseInput p0, java.io.FileDescriptor p1, java.lang.String p2, int p3, boolean p4, android.util.apk.InitAppScanMetrics p5) { return null; }
    private static android.content.pm.parsing.result.ParseResult<android.util.apk.ApkSignatureVerifier.SigningDetailsWithDigests> verifyV3Signature(android.content.pm.parsing.result.ParseInput p0, java.io.FileDescriptor p1, java.lang.String p2, boolean p3, android.util.apk.InitAppScanMetrics p4) throws android.util.apk.SignatureNotFoundException { return null; }
