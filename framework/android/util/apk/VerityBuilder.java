...
public abstract class VerityBuilder {
    ...
    private static void generateApkVerityDigestAtLeafLevel(android.util.apk.ApkChannel p0, android.util.apk.SignatureInfo p1, byte[] p2, java.nio.ByteBuffer p3) throws java.io.IOException, java.security.NoSuchAlgorithmException, java.security.DigestException {}
    ...
    static android.util.apk.VerityBuilder.VerityResult generateApkVerityTree(android.util.apk.ApkChannel p0, android.util.apk.SignatureInfo p1, android.util.apk.ByteBufferFactory p2) throws java.io.IOException, java.lang.SecurityException, java.security.NoSuchAlgorithmException, java.security.DigestException { return null; }
    ...
    public static android.util.apk.VerityBuilder.VerityResult generateApkVerityTree(java.nio.channels.FileChannel p0, java.io.FileDescriptor p1, android.util.apk.SignatureInfo p2, android.util.apk.ByteBufferFactory p3) throws java.io.IOException, java.lang.SecurityException, java.security.NoSuchAlgorithmException, java.security.DigestException { return null; }
    private static void generateFsVerityDigestAtLeafLevel(java.io.RandomAccessFile p0, byte[] p1, java.nio.ByteBuffer p2) throws java.io.IOException, java.security.NoSuchAlgorithmException, java.security.DigestException {}
    ...
    private static byte[] generateFsVerityTreeInternal(java.io.RandomAccessFile p0, byte[] p1, int[] p2, java.nio.ByteBuffer p3) throws java.io.IOException, java.security.NoSuchAlgorithmException, java.security.DigestException { return null; }
    private static android.util.apk.VerityBuilder.VerityResult generateVerityTreeInternal(android.util.apk.ApkChannel p0, android.util.apk.ByteBufferFactory p1, android.util.apk.SignatureInfo p2) throws java.io.IOException, java.lang.SecurityException, java.security.NoSuchAlgorithmException, java.security.DigestException { return null; }
    private static byte[] generateVerityTreeInternal(android.util.apk.ApkChannel p0, android.util.apk.SignatureInfo p1, byte[] p2, int[] p3, java.nio.ByteBuffer p4) throws java.io.IOException, java.security.NoSuchAlgorithmException, java.security.DigestException { return null; }
