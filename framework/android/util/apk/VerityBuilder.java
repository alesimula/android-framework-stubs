...
public abstract class VerityBuilder {
    ...
    public static android.util.apk.VerityBuilder.VerityResult generateFsVerityTree(java.io.RandomAccessFile p0, android.util.apk.ByteBufferFactory p1) throws java.io.IOException, java.lang.SecurityException, java.security.NoSuchAlgorithmException, java.security.DigestException { return null; }
    ...
    private static android.util.apk.VerityBuilder.VerityResult generateVerityTreeInternal(java.io.RandomAccessFile p0, android.util.apk.ByteBufferFactory p1, android.util.apk.SignatureInfo p2, boolean p3) throws java.io.IOException, java.lang.SecurityException, java.security.NoSuchAlgorithmException, java.security.DigestException { return null; }
    ...
    private static byte[] generateVerityTreeInternal(java.io.RandomAccessFile p0, android.util.apk.SignatureInfo p1, byte[] p2, int[] p3, java.nio.ByteBuffer p4, boolean p5) throws java.io.IOException, java.security.NoSuchAlgorithmException, java.security.DigestException { return null; }
