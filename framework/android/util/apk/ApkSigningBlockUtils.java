...
public final class ApkSigningBlockUtils {
    ...
    private static final java.lang.String OID_ML_DSA_65 = "2.16.840.1.101.3.4.3.18";
    private static final java.lang.String OID_ML_DSA_87 = "2.16.840.1.101.3.4.3.19";
    ...
    static final int SIGNATURE_ML_DSA = 1281;
    ...
    static android.util.Pair<java.nio.ByteBuffer, java.lang.Long> findApkSigningBlock(java.nio.channels.FileChannel p0, long p1) throws java.io.IOException, android.util.apk.SignatureNotFoundException { return null; }
    static android.util.apk.SignatureInfo findSignature(android.util.apk.ApkChannel p0, int p1) throws java.io.IOException, android.util.apk.SignatureNotFoundException { return null; }
    ...
    static android.util.apk.SignatureInfo findSignature(java.nio.channels.FileChannel p0, int p1) throws java.io.IOException, android.util.apk.SignatureNotFoundException { return null; }
    ...
    static android.util.Pair<java.nio.ByteBuffer, java.lang.Long> getEocd(java.nio.channels.FileChannel p0) throws java.io.IOException, android.util.apk.SignatureNotFoundException { return null; }
    ...
    static boolean isCertificatePqc(java.security.cert.X509Certificate p0) { return false; }
    ...
    static void verifyIntegrity(java.util.Map<java.lang.Integer, byte[]> p0, android.util.apk.ApkChannel p1, android.util.apk.SignatureInfo p2) throws java.lang.SecurityException {}
    ...
    static void verifyIntegrity(java.util.Map<java.lang.Integer, byte[]> p0, java.nio.channels.FileChannel p1, java.io.FileDescriptor p2, android.util.apk.SignatureInfo p3) throws java.lang.SecurityException {}
    ...
    private static void verifyIntegrityForVerityBasedAlgorithm(byte[] p0, android.util.apk.ApkChannel p1, android.util.apk.SignatureInfo p2) throws java.lang.SecurityException {}
    ...
    public static class VerifiedProofOfRotation {
        public static final int DEFAULT_FLAGS = 23;
