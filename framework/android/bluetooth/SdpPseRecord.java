...
public class SdpPseRecord implements android.os.Parcelable {
    ...
    private final int mSupportedRepositories = 0;
    private final java.lang.String mServiceName = null;
    public static final android.os.Parcelable.Creator CREATOR = null;
    public SdpPseRecord(int p0, int p1, int p2, int p3, int p4, java.lang.String p5) {}
    public SdpPseRecord(android.os.Parcel p0) {}
    public int describeContents() { return 0; }
    public int getL2capPsm() { return 0; }
    public int getRfcommChannelNumber() { return 0; }
    ...
    public int getSupportedRepositories() { return 0; }
