...
public final class BluetoothGatt implements android.bluetooth.BluetoothProfile {
    ...
    BluetoothGatt(android.bluetooth.IBluetoothGatt p0, android.bluetooth.BluetoothDevice p1, int p2, boolean p3, int p4, android.content.AttributionSource p5) {}
    ...
    @android.annotation.RequiresPermission("android.permission.BLUETOOTH_CONNECT")
    private boolean registerApp(android.bluetooth.BluetoothGattCallback p0, android.os.Handler p1, boolean p2) { return false; }
    @android.annotation.RequiresPermission("android.permission.BLUETOOTH_CONNECT")
