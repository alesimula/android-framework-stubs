...
public final class BluetoothDevice implements android.os.Parcelable {
    ...
    @android.annotation.UnsupportedAppUsage
    public java.lang.String getAliasName() { return null; }
    @android.annotation.UnsupportedAppUsage
    ...
    @android.annotation.UnsupportedAppUsage
    public boolean setPasskey(int p0) { return false; }
    public boolean setPairingConfirmation(boolean p0) { return false; }
    public boolean setRemoteOutOfBandData() { return false; }
    @android.annotation.UnsupportedAppUsage
    public boolean cancelPairingUserInput() { return false; }
    @android.annotation.UnsupportedAppUsage
    public boolean isBluetoothDock() { return false; }
    ...
    public android.bluetooth.BluetoothSocket createL2capCocSocket(int p0, int p1) throws java.io.IOException { return null; }
    public android.bluetooth.BluetoothSocket createInsecureL2capChannel(int p0) throws java.io.IOException { return null; }
    public android.bluetooth.BluetoothSocket createInsecureL2capCocSocket(int p0, int p1) throws java.io.IOException { return null; }
    @android.annotation.SystemApi
