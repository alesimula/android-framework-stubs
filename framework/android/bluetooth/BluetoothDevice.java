...
public final class BluetoothDevice implements android.os.Parcelable, android.content.Attributable {
    ...
    @android.annotation.RequiresPermission("android.permission.BLUETOOTH_CONNECT")
    private boolean createBondInternal(int p0, android.bluetooth.OobData p1, android.bluetooth.OobData p2) { return false; }
    @android.annotation.RequiresPermission("android.permission.BLUETOOTH_CONNECT")
    ...
    public static int getMaxMetadataKey() { return 0; }
