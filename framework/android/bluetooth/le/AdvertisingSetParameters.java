...
public final class AdvertisingSetParameters implements android.os.Parcelable {
    ...
    @android.annotation.FlaggedApi("com.android.bluetooth.flags.directed_advertising_api")
    @android.annotation.Nullable
    public java.lang.String getPeerAddress() { return null; }
    @android.annotation.FlaggedApi("com.android.bluetooth.flags.directed_advertising_api")
    public int getPeerAddressType() { return 0; }
    ...
    @android.annotation.FlaggedApi("com.android.bluetooth.flags.directed_advertising_api")
    public boolean isHighDutyCycle() { return false; }
    ...
    public static final class Builder {
        ...
        @android.annotation.FlaggedApi("com.android.bluetooth.flags.directed_advertising_api")
        @android.annotation.NonNull
        public android.bluetooth.le.AdvertisingSetParameters.Builder setDirected(boolean p0) { return null; }
        @android.annotation.NonNull
        public android.bluetooth.le.AdvertisingSetParameters.Builder setDiscoverable(boolean p0) { return null; }
        @android.annotation.FlaggedApi("com.android.bluetooth.flags.directed_advertising_api")
        @android.annotation.NonNull
        public android.bluetooth.le.AdvertisingSetParameters.Builder setHighDutyCycle(boolean p0) { return null; }
        ...
        @android.annotation.FlaggedApi("com.android.bluetooth.flags.directed_advertising_api")
        @android.annotation.NonNull
        public android.bluetooth.le.AdvertisingSetParameters.Builder setPeerAddress(java.lang.String p0) { return null; }
        @android.annotation.FlaggedApi("com.android.bluetooth.flags.directed_advertising_api")
        @android.annotation.NonNull
        public android.bluetooth.le.AdvertisingSetParameters.Builder setPeerAddressType(int p0) { return null; }
