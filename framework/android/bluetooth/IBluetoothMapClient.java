...
public interface IBluetoothMapClient extends android.os.IInterface {
    ...
    public boolean sendMessage(android.bluetooth.BluetoothDevice p0, android.net.Uri[] p1, java.lang.String p2, android.app.PendingIntent p3, android.app.PendingIntent p4, android.content.AttributionSource p5) throws android.os.RemoteException;
    @android.annotation.RequiresPermission(allOf={"android.permission.BLUETOOTH_CONNECT", "android.permission.READ_SMS"})
    public boolean getUnreadMessages(android.bluetooth.BluetoothDevice p0, android.content.AttributionSource p1) throws android.os.RemoteException;
    @android.annotation.RequiresPermission("android.permission.BLUETOOTH_CONNECT")
    public int getSupportedFeatures(android.bluetooth.BluetoothDevice p0, android.content.AttributionSource p1) throws android.os.RemoteException;
    @android.annotation.RequiresPermission(allOf={"android.permission.BLUETOOTH_CONNECT", "android.permission.READ_SMS"})
    public boolean setMessageStatus(android.bluetooth.BluetoothDevice p0, java.lang.String p1, int p2, android.content.AttributionSource p3) throws android.os.RemoteException;
    ...
    public static class Default implements android.bluetooth.IBluetoothMapClient {
        ...
        public boolean sendMessage(android.bluetooth.BluetoothDevice p0, android.net.Uri[] p1, java.lang.String p2, android.app.PendingIntent p3, android.app.PendingIntent p4, android.content.AttributionSource p5) throws android.os.RemoteException { return false; }
        public boolean getUnreadMessages(android.bluetooth.BluetoothDevice p0, android.content.AttributionSource p1) throws android.os.RemoteException { return false; }
        public int getSupportedFeatures(android.bluetooth.BluetoothDevice p0, android.content.AttributionSource p1) throws android.os.RemoteException { return 0; }
        public boolean setMessageStatus(android.bluetooth.BluetoothDevice p0, java.lang.String p1, int p2, android.content.AttributionSource p3) throws android.os.RemoteException { return false; }
        public android.os.IBinder asBinder() { return null; }
    }

    public static abstract class Stub extends android.os.Binder implements android.bluetooth.IBluetoothMapClient {
        public static final java.lang.String DESCRIPTOR = "android.bluetooth.IBluetoothMapClient";
