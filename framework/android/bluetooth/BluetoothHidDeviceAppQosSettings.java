...
public final class BluetoothHidDeviceAppQosSettings implements android.os.Parcelable {
    private final int mServiceType = 0;
    private final int mTokenRate = 0;
    private final int mTokenBucketSize = 0;
    private final int mPeakBandwidth = 0;
    private final int mLatency = 0;
    private final int mDelayVariation = 0;
