...
public final class BluetoothLeAudioCodecConfig implements android.os.Parcelable {
    ...
    @android.annotation.FlaggedApi("com.android.bluetooth.flags.leaudio_add_opus_codec_type")
    public static final int SOURCE_CODEC_TYPE_OPUS = 1;
    @android.annotation.FlaggedApi("com.android.bluetooth.flags.leaudio_add_opus_hi_res_codec_type_api")
