...
public interface IBluetoothHidDevice extends android.os.IInterface {
    ...
    public boolean registerApp(android.bluetooth.BluetoothHidDeviceAppSdpSettings p0, android.bluetooth.BluetoothHidDeviceAppQosSettings p1, android.bluetooth.BluetoothHidDeviceAppQosSettings p2, android.bluetooth.IBluetoothHidDeviceCallback p3, android.content.AttributionSource p4) throws android.os.RemoteException;
    @android.annotation.RequiresPermission("android.permission.BLUETOOTH_CONNECT")
    public boolean unregisterApp(android.content.AttributionSource p0) throws android.os.RemoteException;
    @android.annotation.RequiresPermission("android.permission.BLUETOOTH_CONNECT")
    public boolean sendReport(android.bluetooth.BluetoothDevice p0, int p1, byte[] p2, android.content.AttributionSource p3) throws android.os.RemoteException;
    @android.annotation.RequiresPermission("android.permission.BLUETOOTH_CONNECT")
    public boolean replyReport(android.bluetooth.BluetoothDevice p0, byte p1, byte p2, byte[] p3, android.content.AttributionSource p4) throws android.os.RemoteException;
    @android.annotation.RequiresPermission("android.permission.BLUETOOTH_CONNECT")
    public boolean reportError(android.bluetooth.BluetoothDevice p0, byte p1, android.content.AttributionSource p2) throws android.os.RemoteException;
    @android.annotation.RequiresPermission("android.permission.BLUETOOTH_CONNECT")
    public boolean unplug(android.bluetooth.BluetoothDevice p0, android.content.AttributionSource p1) throws android.os.RemoteException;
    @android.annotation.RequiresPermission("android.permission.BLUETOOTH_CONNECT")
    ...
    @android.annotation.RequiresPermission("android.permission.BLUETOOTH_CONNECT")
    public java.lang.String getUserAppName(android.content.AttributionSource p0) throws android.os.RemoteException;
    ...
    public static class Default implements android.bluetooth.IBluetoothHidDevice {
        public Default() {}
        public boolean registerApp(android.bluetooth.BluetoothHidDeviceAppSdpSettings p0, android.bluetooth.BluetoothHidDeviceAppQosSettings p1, android.bluetooth.BluetoothHidDeviceAppQosSettings p2, android.bluetooth.IBluetoothHidDeviceCallback p3, android.content.AttributionSource p4) throws android.os.RemoteException { return false; }
        public boolean unregisterApp(android.content.AttributionSource p0) throws android.os.RemoteException { return false; }
        public boolean sendReport(android.bluetooth.BluetoothDevice p0, int p1, byte[] p2, android.content.AttributionSource p3) throws android.os.RemoteException { return false; }
        public boolean replyReport(android.bluetooth.BluetoothDevice p0, byte p1, byte p2, byte[] p3, android.content.AttributionSource p4) throws android.os.RemoteException { return false; }
        public boolean reportError(android.bluetooth.BluetoothDevice p0, byte p1, android.content.AttributionSource p2) throws android.os.RemoteException { return false; }
        public boolean unplug(android.bluetooth.BluetoothDevice p0, android.content.AttributionSource p1) throws android.os.RemoteException { return false; }
        ...
        public java.lang.String getUserAppName(android.content.AttributionSource p0) throws android.os.RemoteException { return null; }
    ...
    public static abstract class Stub extends android.os.Binder implements android.bluetooth.IBluetoothHidDevice {
        public static final java.lang.String DESCRIPTOR = "android.bluetooth.IBluetoothHidDevice";
