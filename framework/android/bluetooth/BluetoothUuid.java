...
public final class BluetoothUuid {
    ...
    @android.annotation.NonNull
    public static final android.os.ParcelUuid AVRCP = null;
    @android.annotation.NonNull
    ...
    @android.annotation.NonNull
    public static final android.os.ParcelUuid BASS = null;
    @android.annotation.NonNull
    public static final android.os.ParcelUuid BNEP = null;
    @android.annotation.NonNull
    public static final android.os.ParcelUuid CAP = null;
    @android.annotation.NonNull
    public static final android.os.ParcelUuid COORDINATED_SET = null;
    @android.annotation.NonNull
    public static final android.os.ParcelUuid DIP = null;
    @android.annotation.NonNull
    public static final android.os.ParcelUuid GENERIC_MEDIA_CONTROL = null;
    @android.annotation.NonNull
    public static final android.os.ParcelUuid HAS = null;
    @android.annotation.NonNull
    ...
    @android.annotation.NonNull
    public static final android.os.ParcelUuid LE_AUDIO = null;
    @android.annotation.NonNull
    public static final android.os.ParcelUuid MAP = null;
    @android.annotation.NonNull
    public static final android.os.ParcelUuid MAS = null;
    @android.annotation.NonNull
    public static final android.os.ParcelUuid MEDIA_CONTROL = null;
    @android.annotation.NonNull
    public static final android.os.ParcelUuid MFI_HAS = null;
    @android.annotation.NonNull
    ...
    @android.annotation.NonNull
    public static final android.os.ParcelUuid VOLUME_CONTROL = null;
    BluetoothUuid() {}
