...
public interface IBluetoothHidHost extends android.os.IInterface {
    ...
    public boolean getProtocolMode(android.bluetooth.BluetoothDevice p0) throws android.os.RemoteException;
    public boolean virtualUnplug(android.bluetooth.BluetoothDevice p0) throws android.os.RemoteException;
    public boolean setProtocolMode(android.bluetooth.BluetoothDevice p0, int p1) throws android.os.RemoteException;
    public boolean getReport(android.bluetooth.BluetoothDevice p0, byte p1, byte p2, int p3) throws android.os.RemoteException;
    public boolean setReport(android.bluetooth.BluetoothDevice p0, byte p1, java.lang.String p2) throws android.os.RemoteException;
    public boolean sendData(android.bluetooth.BluetoothDevice p0, java.lang.String p1) throws android.os.RemoteException;
    public boolean getIdleTime(android.bluetooth.BluetoothDevice p0) throws android.os.RemoteException;
    public boolean setIdleTime(android.bluetooth.BluetoothDevice p0, byte p1) throws android.os.RemoteException;
    ...
    public static class Default implements android.bluetooth.IBluetoothHidHost {
        ...
        public boolean getProtocolMode(android.bluetooth.BluetoothDevice p0) throws android.os.RemoteException { return false; }
        public boolean virtualUnplug(android.bluetooth.BluetoothDevice p0) throws android.os.RemoteException { return false; }
        public boolean setProtocolMode(android.bluetooth.BluetoothDevice p0, int p1) throws android.os.RemoteException { return false; }
        public boolean getReport(android.bluetooth.BluetoothDevice p0, byte p1, byte p2, int p3) throws android.os.RemoteException { return false; }
        public boolean setReport(android.bluetooth.BluetoothDevice p0, byte p1, java.lang.String p2) throws android.os.RemoteException { return false; }
        public boolean sendData(android.bluetooth.BluetoothDevice p0, java.lang.String p1) throws android.os.RemoteException { return false; }
        public boolean getIdleTime(android.bluetooth.BluetoothDevice p0) throws android.os.RemoteException { return false; }
        public boolean setIdleTime(android.bluetooth.BluetoothDevice p0, byte p1) throws android.os.RemoteException { return false; }
        public android.os.IBinder asBinder() { return null; }
    }

    public static abstract class Stub extends android.os.Binder implements android.bluetooth.IBluetoothHidHost {
        private static final java.lang.String DESCRIPTOR = "android.bluetooth.IBluetoothHidHost";
