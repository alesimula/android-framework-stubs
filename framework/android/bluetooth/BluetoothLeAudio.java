...
public final class BluetoothLeAudio implements java.lang.AutoCloseable, android.bluetooth.BluetoothProfile {
    ...
    @android.annotation.FlaggedApi("com.android.bluetooth.flags.leaudio_mono_location_errata_api")
    ...
    @android.annotation.FlaggedApi("com.android.bluetooth.flags.leaudio_mono_location_errata_api")
    public static final int AUDIO_LOCATION_UNKNOWN = -2147483648;
    ...
    @android.annotation.FlaggedApi("com.android.bluetooth.flags.leaudio_broadcast_api_manage_primary_group")
    public int getBroadcastToUnicastFallbackGroup() { return 0; }
    ...
    @android.annotation.FlaggedApi("com.android.bluetooth.flags.leaudio_broadcast_api_manage_primary_group")
    public void setBroadcastToUnicastFallbackGroup(int p0) {}
    ...
    public static interface Callback {
        @android.annotation.FlaggedApi("com.android.bluetooth.flags.leaudio_broadcast_api_manage_primary_group")
        default public void onBroadcastToUnicastFallbackGroupChanged(int p0) {}
        ...
        default public void onGroupStreamStatusChanged(int p0, int p1) {}
    }
}
