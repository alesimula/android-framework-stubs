...
public final class BluetoothHciProtoEnums {
    ...
    public static final int BQR_ID_BT_SCHEDULING_TRACE = 18;
    public static final int BQR_ID_CONNECT_FAIL = 8;
    public static final int BQR_ID_CONTROLLER_DBG_INFO = 19;
    public static final int BQR_ID_ENERGY_MONITOR = 6;
    public static final int BQR_ID_LE_AUDIO_CHOPPY = 7;
    public static final int BQR_ID_LMP_LL_MESSAGE_TRACE = 17;
    public static final int BQR_ID_MONITOR_MODE = 1;
    public static final int BQR_ID_RF_STATS = 9;
    public static final int BQR_ID_ROOT_INFLAMMATION = 5;
    public static final int BQR_ID_SCO_VOICE_CHOPPY = 4;
    public static final int BQR_ID_UNKNOWN = 0;
    public static final int BQR_ID_VENDOR_SPECIFIC_QUALITY = 16;
    public static final int BQR_ID_VENDOR_SPECIFIC_TRACE = 32;
    ...
    public static final int STATUS_INSUFFICIENT_SECURITY = 47;
