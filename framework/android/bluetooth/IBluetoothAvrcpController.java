...
public interface IBluetoothAvrcpController extends android.os.IInterface {
    ...
    @android.annotation.RequiresPermission("android.permission.BLUETOOTH_CONNECT")
    public android.bluetooth.BluetoothAvrcpPlayerSettings getPlayerSettings(android.bluetooth.BluetoothDevice p0, android.content.AttributionSource p1) throws android.os.RemoteException;
    @android.annotation.RequiresPermission("android.permission.BLUETOOTH_CONNECT")
    public boolean setPlayerApplicationSetting(android.bluetooth.BluetoothAvrcpPlayerSettings p0, android.content.AttributionSource p1) throws android.os.RemoteException;
    @android.annotation.RequiresPermission("android.permission.BLUETOOTH_CONNECT")
    public void sendGroupNavigationCmd(android.bluetooth.BluetoothDevice p0, int p1, int p2, android.content.AttributionSource p3) throws android.os.RemoteException;
    ...
    public static class Default implements android.bluetooth.IBluetoothAvrcpController {
        ...
        public android.bluetooth.BluetoothAvrcpPlayerSettings getPlayerSettings(android.bluetooth.BluetoothDevice p0, android.content.AttributionSource p1) throws android.os.RemoteException { return null; }
        public boolean setPlayerApplicationSetting(android.bluetooth.BluetoothAvrcpPlayerSettings p0, android.content.AttributionSource p1) throws android.os.RemoteException { return false; }
        public void sendGroupNavigationCmd(android.bluetooth.BluetoothDevice p0, int p1, int p2, android.content.AttributionSource p3) throws android.os.RemoteException {}
    ...
    public static abstract class Stub extends android.os.Binder implements android.bluetooth.IBluetoothAvrcpController {
        public static final java.lang.String DESCRIPTOR = "android.bluetooth.IBluetoothAvrcpController";
