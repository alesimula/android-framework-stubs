...
public final class BluetoothHeadsetClient implements android.bluetooth.BluetoothProfile {
    ...
    @android.annotation.RequiresPermission("android.permission.BLUETOOTH_CONNECT")
    public static final java.lang.String ACTION_VENDOR_SPECIFIC_HEADSETCLIENT_EVENT = "android.bluetooth.headsetclient.profile.action.VENDOR_SPECIFIC_EVENT";
    @android.annotation.RequiresPermission("android.permission.BLUETOOTH_CONNECT")
    ...
    public static final java.lang.String EXTRA_VENDOR_ID = "android.bluetooth.headsetclient.extra.VENDOR_ID";
    public static final java.lang.String EXTRA_VENDOR_EVENT_CODE = "android.bluetooth.headsetclient.extra.VENDOR_EVENT_CODE";
    public static final java.lang.String EXTRA_VENDOR_EVENT_FULL_ARGS = "android.bluetooth.headsetclient.extra.VENDOR_EVENT_FULL_ARGS";
    ...
    BluetoothHeadsetClient(android.content.Context p0, android.bluetooth.BluetoothProfile.ServiceListener p1, android.bluetooth.BluetoothAdapter p2) {}
    void close() {}
    ...
    @android.annotation.RequiresPermission("android.permission.BLUETOOTH_CONNECT")
    public boolean sendVendorAtCommand(android.bluetooth.BluetoothDevice p0, int p1, java.lang.String p2) { return false; }
    @android.annotation.RequiresPermission("android.permission.BLUETOOTH_CONNECT")
