...
public final class LocationStatsEnums {
    ...
    public static final int LOCATION_PERMISSION_LEVEL_ALWAYS_ON = 4;
    public static final int LOCATION_PERMISSION_LEVEL_NONE = 1;
    public static final int LOCATION_PERMISSION_LEVEL_ONLY_THIS_TIME = 2;
    public static final int LOCATION_PERMISSION_LEVEL_UNKNOWN = 0;
    public static final int LOCATION_PERMISSION_LEVEL_WHILE_IN_USE = 3;
