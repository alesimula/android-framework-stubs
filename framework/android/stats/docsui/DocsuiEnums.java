...
public final class DocsuiEnums {
    ...
    public static final int AI_CONSENT_ACCEPTED = 2;
    public static final int AI_CONSENT_DEFERRED = 3;
    public static final int AI_CONSENT_NOT_SEEN = 1;
    public static final int AI_CONSENT_REJECTED = 4;
    public static final int AI_CONSENT_UNKNOWN = 0;
    ...
    public static final int ROOT_GOOGLE_DRIVE = 13;
    public static final int ROOT_HOME = 6;
    public static final int ROOT_HOME_SCREEN = 14;
    ...
    public static final int SUMMARY_STATE_AVAILABLE_AND_DISABLED = 4;
    public static final int SUMMARY_STATE_AVAILABLE_AND_ENABLED = 5;
    public static final int SUMMARY_STATE_FLAG_DISABLED = 2;
    public static final int SUMMARY_STATE_INITIALIZING = 1;
    public static final int SUMMARY_STATE_PROVIDER_UNAVAILABLE = 3;
    public static final int SUMMARY_STATE_UNKNOWN = 0;
