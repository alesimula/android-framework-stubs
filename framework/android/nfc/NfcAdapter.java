...
public final class NfcAdapter {
    ...
    private final android.nfc.NfcControllerAlwaysOnListener mControllerAlwaysOnListener = null;
    ...
    @android.annotation.RequiresPermission("android.permission.NFC_TRANSACTION_EVENT")
    public static final java.lang.String ACTION_TRANSACTION_DETECTED = "android.nfc.action.TRANSACTION_DETECTED";
    @android.annotation.RequiresPermission("android.permission.NFC_PREFERRED_PAYMENT_INFO")
    ...
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission("android.permission.NFC_SET_CONTROLLER_ALWAYS_ON")
