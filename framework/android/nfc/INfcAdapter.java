...
public interface INfcAdapter extends android.os.IInterface {
    ...
    public android.nfc.NfcAntennaInfo getNfcAntennaInfo() throws android.os.RemoteException;
    ...
    public boolean isTagIntentAppPreferenceSupported() throws android.os.RemoteException;
    @android.annotation.RequiresPermission("android.permission.WRITE_SECURE_SETTINGS")
    public java.util.Map getTagIntentAppPreferenceForUser(int p0) throws android.os.RemoteException;
    @android.annotation.RequiresPermission("android.permission.WRITE_SECURE_SETTINGS")
    public int setTagIntentAppPreferenceForUser(int p0, java.lang.String p1, boolean p2) throws android.os.RemoteException;
    ...
    public static class Default implements android.nfc.INfcAdapter {
        ...
        public android.nfc.NfcAntennaInfo getNfcAntennaInfo() throws android.os.RemoteException { return null; }
        ...
        public void registerControllerAlwaysOnListener(android.nfc.INfcControllerAlwaysOnListener p0) throws android.os.RemoteException {}
        public void unregisterControllerAlwaysOnListener(android.nfc.INfcControllerAlwaysOnListener p0) throws android.os.RemoteException {}
        public boolean isTagIntentAppPreferenceSupported() throws android.os.RemoteException { return false; }
        public java.util.Map getTagIntentAppPreferenceForUser(int p0) throws android.os.RemoteException { return null; }
        public int setTagIntentAppPreferenceForUser(int p0, java.lang.String p1, boolean p2) throws android.os.RemoteException { return 0; }
