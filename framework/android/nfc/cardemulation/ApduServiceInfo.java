...
public final class ApduServiceInfo implements android.os.Parcelable {
    @android.annotation.SystemApi
    @android.annotation.FlaggedApi("android.permission.flags.wallet_role_icon_property_enabled")
    ...
    @android.annotation.SystemApi
    @android.annotation.FlaggedApi("android.nfc.nfc_apdu_service_info_constructor")
    ...
    @android.annotation.FlaggedApi("android.nfc.screen_state_attribute_toggle")
