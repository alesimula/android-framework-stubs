...
public class MtpDatabase implements java.lang.AutoCloseable {
    ...
    private int beginSendObject(java.lang.String p0, int p1, int p2, int p3) { return 0; }
    ...
    private int getNumObjects(int p0, int p1, int p2) { return 0; }
    ...
    private int findInMedia(android.mtp.MtpStorageManager.MtpObject p0, java.nio.file.Path p1) { return 0; }
