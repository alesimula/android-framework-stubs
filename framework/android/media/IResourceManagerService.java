...
public interface IResourceManagerService extends android.os.IInterface {
    ...
    public boolean checkResourceAvailability(android.media.MediaResourceParcel[] p0) throws android.os.RemoteException;
    ...
    public void registerSystemResource(android.media.MediaResourceParcel[] p0) throws android.os.RemoteException;
    ...
    public void setClientHandle(android.media.ClientInfoParcel p0, android.os.IBinder p1) throws android.os.RemoteException;
    ...
    public static class Default implements android.media.IResourceManagerService {
        ...
        public boolean checkResourceAvailability(android.media.MediaResourceParcel[] p0) throws android.os.RemoteException { return false; }
        public void config(android.media.MediaResourcePolicyParcel[] p0) throws android.os.RemoteException {}
        public void getMediaResourceUsageReport(android.media.MediaResourceParcel[] p0) throws android.os.RemoteException {}
        public void markClientForPendingRemoval(android.media.ClientInfoParcel p0) throws android.os.RemoteException {}
        public void notifyClientConfigChanged(android.media.ClientConfigParcel p0) throws android.os.RemoteException {}
    ...
    public static abstract class Stub extends android.os.Binder implements android.media.IResourceManagerService {
        ...
        static final int TRANSACTION_checkResourceAvailability = 18;
        static final int TRANSACTION_config = 1;
        static final int TRANSACTION_getMediaResourceUsageReport = 16;
        static final int TRANSACTION_markClientForPendingRemoval = 9;
        static final int TRANSACTION_notifyClientConfigChanged = 15;
        static final int TRANSACTION_notifyClientCreated = 12;
        static final int TRANSACTION_notifyClientStarted = 13;
        static final int TRANSACTION_notifyClientStopped = 14;
        ...
        static final int TRANSACTION_registerSystemResource = 17;
        static final int TRANSACTION_removeClient = 5;
        static final int TRANSACTION_removeResource = 4;
        static final int TRANSACTION_setClientHandle = 11;
        ...
        private static final class Proxy implements android.media.IResourceManagerService {
