...
public class AudioTrack extends android.media.PlayerBase implements android.media.AudioRouting, android.media.VolumeAutomation {
    ...
    private AudioTrack(android.media.AudioAttributes p0, android.media.AudioFormat p1, int p2, int p3, int p4, boolean p5) throws java.lang.IllegalArgumentException { super(null, 0); }
    ...
    private static boolean isMultichannelConfigSupported(int p0) { return false; }
    ...
    @android.annotation.UnsupportedAppUsage(trackingBug=130237544L)
    ...
    private final native int native_setup(java.lang.Object p0, java.lang.Object p1, int[] p2, int p3, int p4, int p5, int p6, int p7, int[] p8, long p9, boolean p10);
