...
public class AudioTrack extends android.media.PlayerBase implements android.media.AudioRouting, android.media.VolumeAutomation {
    ...
    private static final java.util.Map<java.lang.String, java.lang.Integer> CHANNEL_PAIR_MAP = null;
    ...
    public static final int FLUSH_WRITTEN_FRAMES_SUPPORTED = 1;
    ...
    private static final int SUPPORTED_OUT_CHANNELS = 1073741820;
    ...
    private java.lang.String mCodecProvenance;
    ...
    private AudioTrack(android.content.Context p0, android.media.AudioAttributes p1, android.media.AudioFormat p2, int p3, int p4, int p5, boolean p6, int p7, android.media.AudioTrack.TunerConfiguration p8, java.lang.String p9) throws java.lang.IllegalArgumentException { super(null, 0); }
    ...
    private void audioParamCheck(int p0, int p1, int p2, int p3, int p4, int p5) {}
    ...
    public static int getFlushWrittenFramesFromPositionSupport(android.media.AudioFormat p0, android.media.AudioAttributes p1) { return 0; }
    ...
    private native long native_flushFromFrame(int p0, long p1);
    private static native int native_getFlushWrittenFramesFromPositionSupport(int p0, int p1, android.media.AudioFormat.ChannelMasks p2, android.media.AudioAttributes p3);
    ...
    private static native boolean native_is_direct_output_supported(int p0, int p1, java.lang.Object p2, int p3, int p4, int p5);
    ...
    private final native int native_setup(java.lang.Object p0, java.lang.Object p1, int[] p2, java.lang.Object p3, int p4, int p5, int p6, int[] p7, android.os.Parcel p8, long p9, boolean p10, int p11, java.lang.Object p12, java.lang.String p13, java.lang.String p14);
    ...
    private static void validateCodecProvenance(java.lang.String p0) {}
    ...
    public void flush() {}
    public long flushWrittenFramesFromPosition(long p0, int p1) { return 0L; }
    ...
    public java.lang.String getCodecProvenance() { return null; }
    ...
    public long getWrittenFramesCount() { return 0L; }
    ...
    public static class Builder {
        ...
        private java.lang.String mCodecMediaType;
        ...
        public Builder() {}
        private android.media.AudioTrack buildCallInjectionTrack() { return null; }
        ...
        public android.media.AudioTrack.Builder setCodecProvenance(java.lang.String p0) { return null; }
    ...
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
    public static @interface FlushFromAccuracy {
    }
