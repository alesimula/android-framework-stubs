...
public class ExifInterface {
    ...
    private static final byte[] HEIF_BRAND_AVIF = null;
    private static final byte[] HEIF_BRAND_AVIS = null;
    ...
    public ExifInterface(java.io.InputStream p0, int p1) throws java.io.IOException {}
    private ExifInterface(java.io.InputStream p0, boolean p1) throws java.io.IOException {}
    ...
    private void copyChunksUpToGivenChunkType(android.media.ExifInterface.ByteOrderedDataInputStream p0, android.media.ExifInterface.ByteOrderedDataOutputStream p1, byte[] p2, byte[] p3) throws java.io.IOException {}
    private void copyWebPChunk(android.media.ExifInterface.ByteOrderedDataInputStream p0, android.media.ExifInterface.ByteOrderedDataOutputStream p1, byte[] p2) throws java.io.IOException {}
    ...
    private void getPngAttributes(android.media.ExifInterface.ByteOrderedDataInputStream p0) throws java.io.IOException {}
    ...
    private void getStandaloneAttributes(android.media.ExifInterface.ByteOrderedDataInputStream p0) throws java.io.IOException {}
    private void getWebpAttributes(android.media.ExifInterface.ByteOrderedDataInputStream p0) throws java.io.IOException {}
    ...
    private static boolean isExifDataOnly(java.io.BufferedInputStream p0) throws java.io.IOException { return false; }
    ...
    private boolean isPngFormat(byte[] p0) throws java.io.IOException { return false; }
    ...
    private static boolean isSeekableFD(java.io.FileDescriptor p0) { return false; }
    private boolean isSupportedDataType(java.util.HashMap p0) throws java.io.IOException { return false; }
    private boolean isSupportedFormatForSavingAttributes() { return false; }
    ...
    private boolean isWebpFormat(byte[] p0) throws java.io.IOException { return false; }
    private void loadAttributes(java.io.InputStream p0) {}
    ...
    private void replaceInvalidTags(int p0, java.lang.String p1, java.lang.String p2) {}
    ...
    private void savePngAttributes(java.io.InputStream p0, java.io.OutputStream p1) throws java.io.IOException {}
    private void saveWebpAttributes(java.io.InputStream p0, java.io.OutputStream p1) throws java.io.IOException {}
    ...
    private int writeExifSegment(android.media.ExifInterface.ByteOrderedDataOutputStream p0) throws java.io.IOException { return 0; }
    ...
    private static class ByteOrderedDataInputStream extends java.io.InputStream implements java.io.DataInput {
        ...
        ByteOrderedDataInputStream(java.io.InputStream p0, java.nio.ByteOrder p1) throws java.io.IOException { super(); }
