...
public interface IRingtonePlayer extends android.os.IInterface {
    ...
    public void playAsync(android.net.Uri p0, android.os.UserHandle p1, boolean p2, android.media.AudioAttributes p3, float p4) throws android.os.RemoteException;
    ...
    public void setPlaybackProperties(android.os.IBinder p0, float p1, boolean p2, boolean p3) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.media.IRingtonePlayer {
        ...
        private static final class Proxy implements android.media.IRingtonePlayer {
