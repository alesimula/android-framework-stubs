...
public interface IMediaProjectionCallback extends android.os.IInterface {
    public void onCapturedContentResize(int p0, int p1) throws android.os.RemoteException;
    public void onCapturedContentVisibilityChanged(boolean p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.media.projection.IMediaProjectionCallback {
        ...
        private static final class Proxy implements android.media.projection.IMediaProjectionCallback {
