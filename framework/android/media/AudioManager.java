...
public class AudioManager {
    ...
    private android.media.AudioManager.StrategyPreferredDevicesDispatcherStub mPrefDevDispatcherStub;
    ...
    private final java.lang.Object mModeListenerLock = null;
    private java.util.ArrayList<android.media.AudioManager.ModeListenerInfo> mModeListeners;
    private android.media.AudioManager.ModeDispatcherStub mModeDispatcherStub;
    ...
    private final java.lang.Object mCommDevListenerLock = null;
    private java.util.ArrayList<android.media.AudioManager.CommDevListenerInfo> mCommDevListeners;
    private android.media.AudioManager.CommunicationDeviceDispatcherStub mCommDevDispatcherStub;
    ...
    private android.media.AudioManager.PrefDevListenerInfo getPrefDevListenerInfo(android.media.AudioManager.OnPreferredDevicesForStrategyChangedListener p0) { return null; }
    private boolean hasPrefDevListener(android.media.AudioManager.OnPreferredDevicesForStrategyChangedListener p0) { return false; }
    private boolean removePrefDevListener(android.media.AudioManager.OnPreferredDevicesForStrategyChangedListener p0) { return false; }
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission("android.permission.MODIFY_AUDIO_ROUTING")
    ...
    private boolean hasModeListener(android.media.AudioManager.OnModeChangedListener p0) { return false; }
    private android.media.AudioManager.ModeListenerInfo getModeListenerInfo(android.media.AudioManager.OnModeChangedListener p0) { return null; }
    private boolean removeModeListener(android.media.AudioManager.OnModeChangedListener p0) { return false; }
    ...
    private android.media.AudioManager.CommDevListenerInfo getCommDevListenerInfo(android.media.AudioManager.OnCommunicationDeviceChangedListener p0) { return null; }
    private boolean hasCommDevListener(android.media.AudioManager.OnCommunicationDeviceChangedListener p0) { return false; }
    private boolean removeCommDevListener(android.media.AudioManager.OnCommunicationDeviceChangedListener p0) { return false; }
    ...
    private static class CommDevListenerInfo {
        final android.media.AudioManager.OnCommunicationDeviceChangedListener mListener = null;
        final java.util.concurrent.Executor mExecutor = null;
        CommDevListenerInfo(android.media.AudioManager.OnCommunicationDeviceChangedListener p0, java.util.concurrent.Executor p1) {}
    }

    private final class CommunicationDeviceDispatcherStub extends android.media.ICommunicationDeviceDispatcher.Stub {
    ...
    private final class ModeDispatcherStub extends android.media.IAudioModeDispatcher.Stub {
        private ModeDispatcherStub(android.media.AudioManager p0) { super(); }
        public void dispatchAudioModeChanged(int p0) {}
    }

    private static class ModeListenerInfo {
        final android.media.AudioManager.OnModeChangedListener mListener = null;
        final java.util.concurrent.Executor mExecutor = null;
        ModeListenerInfo(android.media.AudioManager.OnModeChangedListener p0, java.util.concurrent.Executor p1) {}
    }
