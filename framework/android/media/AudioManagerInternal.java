...
public abstract class AudioManagerInternal {
    ...
    public abstract void adjustSuggestedStreamVolumeForUid(int p0, int p1, int p2, java.lang.String p3, int p4);
    public abstract void adjustStreamVolumeForUid(int p0, int p1, int p2, java.lang.String p3, int p4);
    public abstract void setStreamVolumeForUid(int p0, int p1, int p2, java.lang.String p3, int p4);
