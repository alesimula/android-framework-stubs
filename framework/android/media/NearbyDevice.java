...
public final class NearbyDevice implements android.os.Parcelable {
    ...
    private static final java.util.List<java.lang.Integer> RANGE_WEIGHT_LIST = null;
    public static final int RANGE_WITHIN_REACH = 4;
    private final java.lang.String mMediaRoute2Id = null;
    private final int mRangeZone = 0;
    private NearbyDevice(android.os.Parcel p0) {}
