...
public final class MediaDrm implements java.lang.AutoCloseable {
    ...
    private final java.util.Map<java.nio.ByteBuffer, android.media.MediaDrm.PlaybackComponent> mPlaybackComponentMap = null;
    ...
    private native void closeSessionNative(byte[] p0);
    ...
    private static byte[] getDigestBytes(byte[] p0, java.lang.String p1) { return null; }
    private native android.media.MediaDrm.KeyRequest getKeyRequestNative(byte[] p0, byte[] p1, java.lang.String p2, int p3, java.util.HashMap<java.lang.String, java.lang.String> p4) throws android.media.NotProvisionedException;
    public static final int getMaxSecurityLevel() { return 0; }
    private native android.os.PersistableBundle getMetricsNative();
    private byte[] getNewestAvailablePackageCertificateRawBytes() { return null; }
    private native android.media.MediaDrm.ProvisionRequest getProvisionRequestNative(int p0, java.lang.String p1);
    private native java.util.List<byte[]> getSecureStopIdsNative();
    private native byte[] getSecureStopNative(byte[] p0);
    private native java.util.List<byte[]> getSecureStopsNative();
    ...
    private native byte[] openSessionNative(int p0) throws android.media.NotProvisionedException, android.media.ResourceBusyException;
    ...
    private native void releaseSecureStopsNative(byte[] p0);
    private native void removeAllSecureStopsNative();
    private native void removeSecureStopNative(byte[] p0);
    ...
    private native void setPlaybackId(byte[] p0, java.lang.String p1);
    ...
    public byte[] getSecureStop(byte[] p0) { return null; }
    public java.util.List<byte[]> getSecureStopIds() { return null; }
    public java.util.List<byte[]> getSecureStops() { return null; }
