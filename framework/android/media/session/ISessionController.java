...
public interface ISessionController extends android.os.IInterface {
    public void sendCommand(java.lang.String p0, android.media.session.ISessionControllerCallback p1, java.lang.String p2, android.os.Bundle p3, android.os.ResultReceiver p4) throws android.os.RemoteException;
    public boolean sendMediaButton(java.lang.String p0, android.media.session.ISessionControllerCallback p1, android.view.KeyEvent p2) throws android.os.RemoteException;
    ...
    public void adjustVolume(java.lang.String p0, java.lang.String p1, android.media.session.ISessionControllerCallback p2, int p3, int p4) throws android.os.RemoteException;
    public void setVolumeTo(java.lang.String p0, java.lang.String p1, android.media.session.ISessionControllerCallback p2, int p3, int p4) throws android.os.RemoteException;
    public void prepare(java.lang.String p0, android.media.session.ISessionControllerCallback p1) throws android.os.RemoteException;
    public void prepareFromMediaId(java.lang.String p0, android.media.session.ISessionControllerCallback p1, java.lang.String p2, android.os.Bundle p3) throws android.os.RemoteException;
    public void prepareFromSearch(java.lang.String p0, android.media.session.ISessionControllerCallback p1, java.lang.String p2, android.os.Bundle p3) throws android.os.RemoteException;
    public void prepareFromUri(java.lang.String p0, android.media.session.ISessionControllerCallback p1, android.net.Uri p2, android.os.Bundle p3) throws android.os.RemoteException;
    public void play(java.lang.String p0, android.media.session.ISessionControllerCallback p1) throws android.os.RemoteException;
    public void playFromMediaId(java.lang.String p0, android.media.session.ISessionControllerCallback p1, java.lang.String p2, android.os.Bundle p3) throws android.os.RemoteException;
    public void playFromSearch(java.lang.String p0, android.media.session.ISessionControllerCallback p1, java.lang.String p2, android.os.Bundle p3) throws android.os.RemoteException;
    public void playFromUri(java.lang.String p0, android.media.session.ISessionControllerCallback p1, android.net.Uri p2, android.os.Bundle p3) throws android.os.RemoteException;
    public void skipToQueueItem(java.lang.String p0, android.media.session.ISessionControllerCallback p1, long p2) throws android.os.RemoteException;
    public void pause(java.lang.String p0, android.media.session.ISessionControllerCallback p1) throws android.os.RemoteException;
    public void stop(java.lang.String p0, android.media.session.ISessionControllerCallback p1) throws android.os.RemoteException;
    public void next(java.lang.String p0, android.media.session.ISessionControllerCallback p1) throws android.os.RemoteException;
    public void previous(java.lang.String p0, android.media.session.ISessionControllerCallback p1) throws android.os.RemoteException;
    public void fastForward(java.lang.String p0, android.media.session.ISessionControllerCallback p1) throws android.os.RemoteException;
    public void rewind(java.lang.String p0, android.media.session.ISessionControllerCallback p1) throws android.os.RemoteException;
    public void seekTo(java.lang.String p0, android.media.session.ISessionControllerCallback p1, long p2) throws android.os.RemoteException;
    public void rate(java.lang.String p0, android.media.session.ISessionControllerCallback p1, android.media.Rating p2) throws android.os.RemoteException;
    public void setPlaybackSpeed(java.lang.String p0, android.media.session.ISessionControllerCallback p1, float p2) throws android.os.RemoteException;
    public void sendCustomAction(java.lang.String p0, android.media.session.ISessionControllerCallback p1, java.lang.String p2, android.os.Bundle p3) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.media.session.ISessionController {
        ...
        private static class Proxy implements android.media.session.ISessionController {
            ...
            public void sendCommand(java.lang.String p0, android.media.session.ISessionControllerCallback p1, java.lang.String p2, android.os.Bundle p3, android.os.ResultReceiver p4) throws android.os.RemoteException {}
            public boolean sendMediaButton(java.lang.String p0, android.media.session.ISessionControllerCallback p1, android.view.KeyEvent p2) throws android.os.RemoteException { return false; }
            public void registerCallback(java.lang.String p0, android.media.session.ISessionControllerCallback p1) throws android.os.RemoteException {}
            public void unregisterCallback(android.media.session.ISessionControllerCallback p0) throws android.os.RemoteException {}
