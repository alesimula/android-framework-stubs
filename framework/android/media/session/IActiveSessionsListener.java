...
public interface IActiveSessionsListener extends android.os.IInterface {
    public void onActiveSessionsChanged(java.util.List<android.media.session.MediaSession.Token> p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.media.session.IActiveSessionsListener {
        ...
        public Stub() { super(); }
        public static android.media.session.IActiveSessionsListener asInterface(android.os.IBinder p0) { return null; }
        public android.os.IBinder asBinder() { return null; }
        public static java.lang.String getDefaultTransactionName(int p0) { return null; }
        public java.lang.String getTransactionName(int p0) { return null; }
        public boolean onTransact(int p0, android.os.Parcel p1, android.os.Parcel p2, int p3) throws android.os.RemoteException { return false; }
        public static boolean setDefaultImpl(android.media.session.IActiveSessionsListener p0) { return false; }
        public static android.media.session.IActiveSessionsListener getDefaultImpl() { return null; }
