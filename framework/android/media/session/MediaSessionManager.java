...
public final class MediaSessionManager {
    ...
    private void addOnActiveSessionsChangedListenerInternal(android.media.session.MediaSessionManager.OnActiveSessionsChangedListener p0, android.content.ComponentName p1, int p2, java.util.concurrent.Executor p3, java.lang.String p4) throws android.os.RemoteException {}
    ...
    private java.util.List<android.media.session.MediaController> getActiveControllersForUser(android.content.ComponentName p0, int p1) { return null; }
    private java.util.List<android.media.session.MediaSession.Token> getActiveSessionsForUser(android.content.ComponentName p0, int p1, java.lang.String p2) throws android.os.RemoteException { return null; }
    private void removeSessionsListenerInternal(android.media.session.MediaSessionManager.OnActiveSessionsChangedListener p0, boolean p1) throws android.os.RemoteException {}
    @android.annotation.SystemApi(client=android.annotation.SystemApi.Client.MODULE_LIBRARIES)
    ...
    public void addOnActiveSessionsForPackageChangedListener(java.lang.String p0, java.util.concurrent.Executor p1, android.content.ComponentName p2, android.media.session.MediaSessionManager.OnActiveSessionsChangedListener p3) {}
    public void addOnActiveSessionsForPackageChangedListener(java.lang.String p0, java.util.concurrent.Executor p1, android.media.session.MediaSessionManager.OnActiveSessionsChangedListener p2) {}
    ...
    public android.media.session.ISession createSession(android.media.session.MediaSession.CallbackStub p0, java.lang.String p1, android.os.Bundle p2, java.lang.String p3) { return null; }
    ...
    public java.util.List<android.media.session.MediaSession.Token> getActiveSessionsForPackage(java.lang.String p0) { return null; }
    public java.util.List<android.media.session.MediaSession.Token> getActiveSessionsForPackage(java.lang.String p0, android.content.ComponentName p1) { return null; }
    @android.annotation.SystemApi(client=android.annotation.SystemApi.Client.MODULE_LIBRARIES)
    ...
    public void removeOnActiveSessionsForPackageChangedListener(android.media.session.MediaSessionManager.OnActiveSessionsChangedListener p0) {}
    @android.annotation.SystemApi
