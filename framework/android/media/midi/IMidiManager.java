...
public interface IMidiManager extends android.os.IInterface {
    ...
    public android.media.midi.MidiDeviceInfo[] getDevicesForTransport(int p0) throws android.os.RemoteException;
    ...
    public android.media.midi.MidiDeviceInfo registerDeviceServer(android.media.midi.IMidiDeviceServer p0, int p1, int p2, java.lang.String[] p3, java.lang.String[] p4, android.os.Bundle p5, int p6, int p7) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.media.midi.IMidiManager {
        ...
        private static final class Proxy implements android.media.midi.IMidiManager {
