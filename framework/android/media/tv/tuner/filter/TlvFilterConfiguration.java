...
public final class TlvFilterConfiguration extends android.media.tv.tuner.filter.FilterConfiguration {
    ...
    private final boolean mIsCompressedIpPacket = false;
    private final boolean mPassthrough = false;
    private TlvFilterConfiguration(android.media.tv.tuner.filter.Settings p0, int p1, boolean p2, boolean p3) { super(null); }
