...
public class Atsc3FrontendSettings extends android.media.tv.tuner.frontend.FrontendSettings {
    ...
    private final int mDemodOutputFormat = 0;
    private final android.media.tv.tuner.frontend.Atsc3PlpSettings[] mPlpSettings = null;
    private Atsc3FrontendSettings(long p0, int p1, int p2, android.media.tv.tuner.frontend.Atsc3PlpSettings[] p3) { super(0L); }
