...
public class DvbtFrontendSettings extends android.media.tv.tuner.frontend.FrontendSettings {
    ...
    private DvbtFrontendSettings(long p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, boolean p8, int p9, boolean p10, int p11, int p12, int p13) { super(0L); }
    public static android.media.tv.tuner.frontend.DvbtFrontendSettings.Builder builder() { return null; }
    private static boolean isExtendedConstellation(int p0) { return false; }
    private static boolean isExtendedTransmissionMode(int p0) { return false; }
