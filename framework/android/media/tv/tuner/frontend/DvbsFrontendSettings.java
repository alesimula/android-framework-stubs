...
public class DvbsFrontendSettings extends android.media.tv.tuner.frontend.FrontendSettings {
    ...
    private DvbsFrontendSettings(long p0, int p1, android.media.tv.tuner.frontend.DvbsCodeRate p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, boolean p10) { super(0L); }
    ...
    public static class Builder {
        ...
        public android.media.tv.tuner.frontend.DvbsFrontendSettings.Builder setFrequencyLong(long p0) { return null; }
