...
public class Tuner implements java.lang.AutoCloseable {
    ...
    @android.annotation.FlaggedApi("android.media.tv.flags.set_resource_holder_retain")
    @android.annotation.RequiresPermission("android.permission.TUNER_RESOURCE_ACCESS")
    ...
    @android.annotation.RequiresPermission(allOf={"android.permission.TUNER_RESOURCE_ACCESS", "android.permission.ACCESS_TV_TUNER"})
