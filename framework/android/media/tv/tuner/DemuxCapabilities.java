...
public class DemuxCapabilities {
    ...
    private final int[] mFilterCapsList = null;
    ...
    private DemuxCapabilities(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, long p9, int p10, int[] p11, int[] p12, boolean p13) {}
