...
public final class TvInputServiceExtensionManager {
    ...
    public static final java.lang.String ICAM_HOST_CONTROL_ASK_RELEASE_REPLY_CALLBACK = "android.media.tv.extension.cam.ICamHostControlAskReleaseReplyCallback";
    public static final java.lang.String ICAM_HOST_CONTROL_INFO_LISTENER = "android.media.tv.extension.cam.ICamHostControlInfoListener";
    public static final java.lang.String ICAM_HOST_CONTROL_SERVICE = "android.media.tv.extension.cam.ICamHostControlService";
    public static final java.lang.String ICAM_HOST_CONTROL_TUNE_QUIETLY_FLAG = "android.media.tv.extension.cam.ICamHostControlTuneQuietlyFlag";
    public static final java.lang.String ICAM_HOST_CONTROL_TUNE_QUIETLY_FLAG_LISTENER = "android.media.tv.extension.cam.ICamHostControlTuneQuietlyFlagListener";
    public static final java.lang.String ICAM_INFO_LISTENER = "android.media.tv.extension.cam.ICamInfoListener";
    public static final java.lang.String ICAM_MONITORING_SERVICE = "android.media.tv.extension.cam.ICamMonitoringService";
    public static final java.lang.String ICAM_PIN_CAPABILITY_LISTENER = "android.media.tv.extension.cam.ICamPinCapabilityListener";
    ...
    public static final java.lang.String ICONTENT_CONTROL_SERVICE = "android.media.tv.extension.cam.IContentControlService";
    ...
    public static final java.lang.String IEVENT_DOWNLOAD_SESSION = "android.media.tv.extension.event.IEventDownloadSession";
    public static final java.lang.String IEVENT_MONITOR = "android.media.tv.extension.event.IEventMonitor";
    public static final java.lang.String IEVENT_MONITOR_LISTENER = "android.media.tv.extension.event.IEventMonitorListener";
    public static final java.lang.String IFAVORITE_NETWORK = "android.media.tv.extension.scan.IFavoriteNetwork";
    public static final java.lang.String IFAVORITE_NETWORK_LISTENER = "android.media.tv.extension.scan.IFavoriteNetworkListener";
    public static final java.lang.String IGET_INFO_RECORDED_CONTENTS_CALLBACK = "android.media.tv.extension.pvr.IGetInfoRecordedContentsCallback";
    public static final java.lang.String IHDMI_SIGNAL_INFO_LISTENER = "android.media.tv.extension.signal.IHdmiSignalInfoListener";
    public static final java.lang.String IHDMI_SIGNAL_INTERFACE = "android.media.tv.extension.signal.IHdmiSignalInterface";
    public static final java.lang.String IHDPLUS_INFO = "android.media.tv.extension.scan.IHDPlusInfo";
    public static final java.lang.String ILCNV2_CHANNEL_LIST = "android.media.tv.extension.scan.ILcnV2ChannelList";
    public static final java.lang.String ILCNV2_CHANNEL_LIST_LISTENER = "android.media.tv.extension.scan.ILcnV2ChannelListListener";
    public static final java.lang.String ILCN_CONFLICT = "android.media.tv.extension.scan.ILcnConflict";
    public static final java.lang.String ILCN_CONFLICT_LISTENER = "android.media.tv.extension.scan.ILcnConflictListener";
    ...
    public static final java.lang.String ISERVICE_LIST_EXPORT_LISTENER = "android.media.tv.extension.servicedb.IServiceListExportListener";
    public static final java.lang.String ISERVICE_LIST_EXPORT_SESSION = "android.media.tv.extension.servicedb.IServiceListExportSession";
    public static final java.lang.String ISERVICE_LIST_IMPORT_LISTENER = "android.media.tv.extension.servicedb.IServiceListImportListener";
    public static final java.lang.String ISERVICE_LIST_IMPORT_SESSION = "android.media.tv.extension.servicedb.IServiceListImportSession";
    public static final java.lang.String ISERVICE_LIST_SET_CHANNEL_LIST_LISTENER = "android.media.tv.extension.servicedb.IServiceListSetChannelListListener";
    public static final java.lang.String ISERVICE_LIST_SET_CHANNEL_LIST_SESSION = "android.media.tv.extension.servicedb.IServiceListSetChannelListSession";
    public static final java.lang.String ISERVICE_LIST_TRANSFER_INTERFACE = "android.media.tv.extension.servicedb.IServiceListTransferInterface";
    public static final java.lang.String ITARGET_REGION = "android.media.tv.extension.scan.ITargetRegion";
    public static final java.lang.String ITARGET_REGION_LISTENER = "android.media.tv.extension.scan.ITargetRegionListener";
    public static final java.lang.String ITELETEXT_PAGE_SUB_CODE = "android.media.tv.extension.teletext.ITeletextPageSubCode";
    public static final java.lang.String ITKGS_INFO = "android.media.tv.extension.scan.ITkgsInfo";
    public static final java.lang.String ITKGS_INFO_LISTENER = "android.media.tv.extension.scan.ITkgsInfoListener";
    public static final java.lang.String ITUNER_FRONTEND_SIGNAL_INFO_INTERFACE = "android.media.tv.extension.signal.ITunerFrontendSignalInfoInterface";
    public static final java.lang.String ITUNER_FRONTEND_SIGNAL_INFO_LISTENER = "android.media.tv.extension.signal.ITunerFrontendSignalInfoListener";
    public static final java.lang.String IVBI_RATING_INTERFACE = "android.media.tv.extension.rating.IVbiRatingInterface";
    public static final java.lang.String IVBI_RATING_LISTENER = "android.media.tv.extension.rating.IVbiRatingListener";
    public static final java.lang.String IVIDEO_SIGNAL_INFO = "android.media.tv.extension.signal.IVideoSignalInfo";
    public static final java.lang.String IVIDEO_SIGNAL_INFO_LISTENER = "android.media.tv.extension.signal.IVideoSignalInfoListener";
    ...
    static boolean checkIsStandardizedInterfaces(java.lang.String p0) { return false; }
    public static java.util.List<java.lang.String> getStandardExtensionInterfaceNames() { return null; }

    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
    public static @interface StandardizedExtensionName {
    }
}
