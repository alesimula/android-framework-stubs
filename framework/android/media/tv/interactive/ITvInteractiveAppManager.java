...
public interface ITvInteractiveAppManager extends android.os.IInterface {
    ...
    public void cancelOngoingOperatorAppPackageOperation(java.lang.String p0, android.media.tv.interactive.OperatorAppServiceInfo p1, int p2) throws android.os.RemoteException;
    ...
    public void createSession(android.media.tv.interactive.ITvInteractiveAppClient p0, java.lang.String p1, int p2, int p3, int p4, int p5) throws android.os.RemoteException;
    ...
    public void installOperatorApp(java.lang.String p0, android.media.tv.interactive.OperatorAppServiceInfo p1, int p2) throws android.os.RemoteException;
    ...
    public void notifyInteractiveAppFocusChanged(android.os.IBinder p0, boolean p1, int p2) throws android.os.RemoteException;
    ...
    public void notifyVideoFreezeUpdated(android.os.IBinder p0, boolean p1, int p2) throws android.os.RemoteException;
    ...
    public void searchOperatorApp(java.lang.String p0, android.media.tv.interactive.OperatorAppServiceInfo p1, int p2, android.os.Bundle p3, int p4) throws android.os.RemoteException;
    public void selectInteractiveAppStreamingTrack(android.os.IBinder p0, int p1, java.lang.String p2, int p3) throws android.os.RemoteException;
    ...
    public void sendCertificate(android.os.IBinder p0, java.lang.String p1, int p2, android.os.Bundle p3, int p4) throws android.os.RemoteException;
    ...
    public void sendParentalControlApprovalResult(android.os.IBinder p0, int p1, boolean p2, int p3) throws android.os.RemoteException;
    public void sendParentalControlPinLength(android.os.IBinder p0, int p1, int p2) throws android.os.RemoteException;
    public void sendSelectedTrackInfo(android.os.IBinder p0, java.util.List<android.media.tv.TvTrackInfo> p1, int p2) throws android.os.RemoteException;
    public void sendSetParentalControlPinResult(android.os.IBinder p0, int p1, int p2) throws android.os.RemoteException;
    ...
    public void sendVerifyParentalControlPinResult(android.os.IBinder p0, int p1, int p2, int p3) throws android.os.RemoteException;
    ...
    public void startInteractiveAppWithHandle(android.os.IBinder p0, int p1, int p2) throws android.os.RemoteException;
    public void startOperatorApp(android.os.IBinder p0, android.media.tv.interactive.OperatorAppServiceInfo p1, java.lang.String p2, java.lang.String p3, android.os.Bundle p4, int p5) throws android.os.RemoteException;
    public void stopInteractiveApp(android.os.IBinder p0, int p1) throws android.os.RemoteException;
    public void stopInteractiveAppWithHandle(android.os.IBinder p0, int p1, int p2) throws android.os.RemoteException;
    public void stopOperatorApp(android.os.IBinder p0, android.media.tv.interactive.OperatorAppServiceInfo p1, int p2) throws android.os.RemoteException;
    public void switchOperatorAppState(android.os.IBinder p0, android.media.tv.interactive.OperatorAppServiceInfo p1, int p2, int p3) throws android.os.RemoteException;
    public void uninstallOperatorApp(java.lang.String p0, android.media.tv.interactive.OperatorAppServiceInfo p1, int p2, java.lang.String p3, int p4) throws android.os.RemoteException;
    ...
    public void updateOperatorApp(java.lang.String p0, android.media.tv.interactive.OperatorAppServiceInfo p1, int p2, android.os.Bundle p3, int p4) throws android.os.RemoteException;
    public void updateWebServiceClientState(android.os.IBinder p0, int p1, int p2, int p3) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.media.tv.interactive.ITvInteractiveAppManager {
        static final int TRANSACTION_cancelOngoingOperatorAppPackageOperation = 70;
        static final int TRANSACTION_createBiInteractiveApp = 11;
        static final int TRANSACTION_createMediaView = 61;
        static final int TRANSACTION_createSession = 36;
        static final int TRANSACTION_destroyBiInteractiveApp = 12;
        static final int TRANSACTION_dispatchSurfaceChanged = 52;
        static final int TRANSACTION_getAppLinkInfoList = 2;
        static final int TRANSACTION_getTvInteractiveAppServiceList = 1;
        static final int TRANSACTION_installOperatorApp = 67;
        static final int TRANSACTION_notifyAdBufferConsumed = 55;
        static final int TRANSACTION_notifyAdResponse = 54;
        static final int TRANSACTION_notifyBroadcastInfoResponse = 53;
        static final int TRANSACTION_notifyContentAllowed = 44;
        static final int TRANSACTION_notifyContentBlocked = 45;
        static final int TRANSACTION_notifyError = 26;
        static final int TRANSACTION_notifyInteractiveAppFocusChanged = 49;
        static final int TRANSACTION_notifyRecordingConnectionFailed = 31;
        static final int TRANSACTION_notifyRecordingDisconnected = 32;
        static final int TRANSACTION_notifyRecordingError = 34;
        static final int TRANSACTION_notifyRecordingScheduled = 35;
        static final int TRANSACTION_notifyRecordingStarted = 47;
        static final int TRANSACTION_notifyRecordingStopped = 48;
        static final int TRANSACTION_notifyRecordingTuned = 33;
        static final int TRANSACTION_notifySignalStrength = 46;
        static final int TRANSACTION_notifyTimeShiftCurrentPositionChanged = 30;
        static final int TRANSACTION_notifyTimeShiftPlaybackParams = 27;
        static final int TRANSACTION_notifyTimeShiftStartPositionChanged = 29;
        static final int TRANSACTION_notifyTimeShiftStatusChanged = 28;
        static final int TRANSACTION_notifyTrackSelected = 39;
        static final int TRANSACTION_notifyTracksChanged = 40;
        static final int TRANSACTION_notifyTuned = 38;
        static final int TRANSACTION_notifyTvMessage = 50;
        static final int TRANSACTION_notifyVideoAvailable = 41;
        ...
        static final int TRANSACTION_sendAvailableSpeeds = 21;
        static final int TRANSACTION_sendCertificate = 23;
        static final int TRANSACTION_sendCurrentChannelLcn = 16;
        static final int TRANSACTION_sendCurrentChannelUri = 15;
        static final int TRANSACTION_sendCurrentTvInputId = 19;
        static final int TRANSACTION_sendCurrentVideoBounds = 14;
        static final int TRANSACTION_sendParentalControlApprovalResult = 57;
        static final int TRANSACTION_sendParentalControlPinLength = 59;
        static final int TRANSACTION_sendSelectedTrackInfo = 56;
        static final int TRANSACTION_sendSetParentalControlPinResult = 60;
        static final int TRANSACTION_sendSigningResult = 22;
        static final int TRANSACTION_sendStreamVolume = 17;
        static final int TRANSACTION_sendTimeShiftMode = 20;
        static final int TRANSACTION_sendTrackInfoList = 18;
        static final int TRANSACTION_sendTvRecordingInfo = 24;
        static final int TRANSACTION_sendTvRecordingInfoList = 25;
        static final int TRANSACTION_sendVerifyParentalControlPinResult = 58;
        static final int TRANSACTION_setSurface = 51;
        ...
        private static final class Proxy implements android.media.tv.interactive.ITvInteractiveAppManager {
