...
public interface IScanSession extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.media.tv.extension.scan.IScanSession {
        ...
        static final int TRANSACTION_getCountryRegionData = 19;
        static final int TRANSACTION_getExtensionInterface = 5;
        static final int TRANSACTION_getPackageData = 17;
        static final int TRANSACTION_getRegionData = 21;
        ...
        static final int TRANSACTION_getServiceLists = 15;
        static final int TRANSACTION_getSessionToken = 13;
        static final int TRANSACTION_release = 14;
        static final int TRANSACTION_resetScan = 2;
        static final int TRANSACTION_setCountryRegion = 20;
        static final int TRANSACTION_setPackage = 18;
        static final int TRANSACTION_setRegion = 22;
        static final int TRANSACTION_setServiceList = 16;
        ...
        private static final class Proxy implements android.media.tv.extension.scan.IScanSession {
