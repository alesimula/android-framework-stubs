...
public interface IEventMonitor extends android.os.IInterface {
    ...
    public void setBackgroundMonitorList(android.net.Uri[] p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.media.tv.extension.event.IEventMonitor {
        ...
        static final int TRANSACTION_setBackgroundMonitorList = 8;
        public Stub() { super(); }
        ...
        private static final class Proxy implements android.media.tv.extension.event.IEventMonitor {
