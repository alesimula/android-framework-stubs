...
public interface ITvInputManager extends android.os.IInterface {
    ...
    public void startRecording(android.os.IBinder p0, android.net.Uri p1, int p2) throws android.os.RemoteException;
    ...
    public android.media.tv.ITvInputHardware acquireTvInputHardware(int p0, android.media.tv.ITvInputHardwareCallback p1, android.media.tv.TvInputInfo p2, int p3) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.media.tv.ITvInputManager {
        ...
        private static class Proxy implements android.media.tv.ITvInputManager {
            ...
            public android.media.tv.ITvInputHardware acquireTvInputHardware(int p0, android.media.tv.ITvInputHardwareCallback p1, android.media.tv.TvInputInfo p2, int p3) throws android.os.RemoteException { return null; }
            public void releaseTvInputHardware(int p0, android.media.tv.ITvInputHardware p1, int p2) throws android.os.RemoteException {}
