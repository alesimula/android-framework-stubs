...
public interface ITvInputManager extends android.os.IInterface {
    ...
    public void setVideoBounds(android.os.IBinder p0, android.graphics.Rect p1, android.graphics.Rect p2, int p3) throws android.os.RemoteException;
    ...
    public void timeShiftStop(android.os.IBinder p0, int p1) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.media.tv.ITvInputManager {
        ...
        static final int TRANSACTION_acquireTvInputHardware = 57;
        static final int TRANSACTION_addBlockedRating = 14;
        static final int TRANSACTION_addHardwareDevice = 66;
        static final int TRANSACTION_captureFrame = 60;
        ...
        static final int TRANSACTION_getAvailableTvStreamConfigList = 59;
        ...
        static final int TRANSACTION_getCurrentTunedInfos = 43;
        static final int TRANSACTION_getDvbDeviceList = 62;
        static final int TRANSACTION_getExtensionInterface = 6;
        static final int TRANSACTION_getHardwareList = 56;
        ...
        static final int TRANSACTION_isSingleSessionActive = 61;
        static final int TRANSACTION_notifyAdBufferReady = 53;
        static final int TRANSACTION_notifyTvAdSessionData = 70;
        static final int TRANSACTION_notifyTvMessage = 54;
        static final int TRANSACTION_openDvbDevice = 63;
        static final int TRANSACTION_pauseRecording = 46;
        ...
        static final int TRANSACTION_releaseTvInputHardware = 58;
        static final int TRANSACTION_removeBlockedRating = 15;
        static final int TRANSACTION_removeBroadcastInfo = 51;
        static final int TRANSACTION_removeHardwareDevice = 67;
        static final int TRANSACTION_removeOverlayView = 33;
        static final int TRANSACTION_requestAd = 52;
        static final int TRANSACTION_requestBroadcastInfo = 50;
        static final int TRANSACTION_requestChannelBrowsable = 65;
        static final int TRANSACTION_resumePlayback = 48;
        static final int TRANSACTION_resumeRecording = 47;
        ...
        static final int TRANSACTION_sendTvInputNotifyIntent = 64;
        ...
        static final int TRANSACTION_setTvMessageEnabled = 55;
        static final int TRANSACTION_setVideoBounds = 69;
        static final int TRANSACTION_setVideoFrozen = 68;
        static final int TRANSACTION_setVolume = 24;
        static final int TRANSACTION_startRecording = 44;
        static final int TRANSACTION_stopPlayback = 49;
        static final int TRANSACTION_stopRecording = 45;
        ...
        static final int TRANSACTION_timeShiftStop = 42;
        ...
        private static final class Proxy implements android.media.tv.ITvInputManager {
