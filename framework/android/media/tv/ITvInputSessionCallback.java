...
public interface ITvInputSessionCallback extends android.os.IInterface {
    public void onAdBufferConsumed(android.media.tv.AdBuffer p0) throws android.os.RemoteException;
    ...
    public void onAudioPresentationSelected(int p0, int p1) throws android.os.RemoteException;
    public void onAudioPresentationsChanged(java.util.List<android.media.AudioPresentation> p0) throws android.os.RemoteException;
    public void onAvailableSpeeds(float[] p0) throws android.os.RemoteException;
    ...
    public void onChannelRetunedWithExtraInfo(android.net.Uri p0, android.os.Bundle p1) throws android.os.RemoteException;
    ...
    public void onCueingMessageAvailability(boolean p0) throws android.os.RemoteException;
    ...
    public void onTimeShiftMode(int p0) throws android.os.RemoteException;
    ...
    public void onTvInputSessionData(java.lang.String p0, android.os.Bundle p1) throws android.os.RemoteException;
    public void onTvMessage(int p0, android.os.Bundle p1) throws android.os.RemoteException;
    public void onVideoAvailable() throws android.os.RemoteException;
    public void onVideoFreezeUpdated(boolean p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.media.tv.ITvInputSessionCallback {
        ...
        static final int TRANSACTION_onChannelRetunedWithExtraInfo = 4;
        ...
        static final int TRANSACTION_onTvMessage = 29;
        ...
        private static final class Proxy implements android.media.tv.ITvInputSessionCallback {
