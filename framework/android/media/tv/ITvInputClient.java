...
public interface ITvInputClient extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.media.tv.ITvInputClient {
        ...
        static final int TRANSACTION_onAdResponse = 29;
        static final int TRANSACTION_onAitInfoUpdated = 19;
        static final int TRANSACTION_onAudioPresentationSelected = 7;
        static final int TRANSACTION_onAudioPresentationsChanged = 6;
        static final int TRANSACTION_onAvailableSpeeds = 23;
        static final int TRANSACTION_onBroadcastInfoResponse = 28;
        static final int TRANSACTION_onChannelRetuned = 4;
        static final int TRANSACTION_onChannelRetunedWithExtraInfo = 5;
        static final int TRANSACTION_onContentAllowed = 13;
        static final int TRANSACTION_onContentBlocked = 14;
        static final int TRANSACTION_onCueingMessageAvailability = 21;
        static final int TRANSACTION_onError = 27;
        static final int TRANSACTION_onLayoutSurface = 15;
        static final int TRANSACTION_onRecordingStopped = 26;
        static final int TRANSACTION_onSessionCreated = 1;
        static final int TRANSACTION_onSessionEvent = 3;
        static final int TRANSACTION_onSessionReleased = 2;
        static final int TRANSACTION_onSignalStrength = 20;
        static final int TRANSACTION_onTimeShiftCurrentPositionChanged = 18;
        static final int TRANSACTION_onTimeShiftMode = 22;
        static final int TRANSACTION_onTimeShiftStartPositionChanged = 17;
        static final int TRANSACTION_onTimeShiftStatusChanged = 16;
        static final int TRANSACTION_onTrackSelected = 9;
        static final int TRANSACTION_onTracksChanged = 8;
        static final int TRANSACTION_onTuned = 25;
        static final int TRANSACTION_onTvInputSessionData = 31;
        static final int TRANSACTION_onTvMessage = 24;
        static final int TRANSACTION_onVideoAvailable = 10;
        static final int TRANSACTION_onVideoFreezeUpdated = 12;
        static final int TRANSACTION_onVideoUnavailable = 11;
        public Stub() { super(); }
        ...
        private static final class Proxy implements android.media.tv.ITvInputClient {
