...
public interface ITvInputSession extends android.os.IInterface {
    ...
    public void setVideoBounds(android.graphics.Rect p0, android.graphics.Rect p1) throws android.os.RemoteException;
    ...
    public void timeShiftStop() throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.media.tv.ITvInputSession {
        ...
        static final int TRANSACTION_notifyAdBufferReady = 33;
        static final int TRANSACTION_notifyTvAdSessionData = 38;
        static final int TRANSACTION_notifyTvMessage = 34;
        static final int TRANSACTION_pauseRecording = 28;
        static final int TRANSACTION_relayoutOverlayView = 13;
        static final int TRANSACTION_release = 1;
        static final int TRANSACTION_removeBroadcastInfo = 31;
        static final int TRANSACTION_removeOverlayView = 14;
        static final int TRANSACTION_requestAd = 32;
        static final int TRANSACTION_requestBroadcastInfo = 30;
        static final int TRANSACTION_resumePlayback = 24;
        static final int TRANSACTION_resumeRecording = 29;
        ...
        static final int TRANSACTION_setTvMessageEnabled = 35;
        static final int TRANSACTION_setVideoBounds = 37;
        static final int TRANSACTION_setVideoFrozen = 36;
        static final int TRANSACTION_setVolume = 5;
        static final int TRANSACTION_startRecording = 26;
        static final int TRANSACTION_stopPlayback = 25;
        static final int TRANSACTION_stopRecording = 27;
        ...
        static final int TRANSACTION_timeShiftStop = 23;
        ...
        private static final class Proxy implements android.media.tv.ITvInputSession {
