...
public final class Enums {
    public static final int AUDIO_API_BLUETOOTH_A2DP = 10;
    public static final int AUDIO_API_BLUETOOTH_SCO = 8;
    public static final int AUDIO_API_CATEGORY_UNKNOWN = 0;
    public static final int AUDIO_API_COMMUNICATION_DEVICE = 6;
    public static final int AUDIO_API_MICROPHONE_MUTE = 12;
    public static final int AUDIO_API_MODE = 5;
    public static final int AUDIO_API_MUTE_STREAM = 2;
    public static final int AUDIO_API_PARAMETERS = 13;
    public static final int AUDIO_API_PREFERRED_DEVICE = 15;
    public static final int AUDIO_API_RINGER_MODE = 3;
    public static final int AUDIO_API_SPEAKERPHONE = 7;
    public static final int AUDIO_API_START_BLUETOOTH_SCO = 9;
    public static final int AUDIO_API_SURROUND_FORMAT = 14;
    public static final int AUDIO_API_VIBRATE_SETTING = 4;
    public static final int AUDIO_API_VOLUME = 1;
    public static final int AUDIO_API_WIRED_HEADSET = 11;
    ...
    public static final int AUDIO_HARDENING_API_TYPE_FOCUS = 2;
    public static final int AUDIO_HARDENING_API_TYPE_PLAYBACK = 1;
    public static final int AUDIO_HARDENING_API_TYPE_RINGER = 4;
    public static final int AUDIO_HARDENING_API_TYPE_UNSPECIFIED = 0;
    public static final int AUDIO_HARDENING_API_TYPE_VOLUME = 3;
    public static final int AUDIO_MODE_ASSISTANT_CONVERSATION = 8;
    public static final int AUDIO_MODE_CALL_REDIRECT = 6;
    public static final int AUDIO_MODE_CALL_SCREENING = 5;
    public static final int AUDIO_MODE_COMMUNICATION_REDIRECT = 7;
    public static final int AUDIO_MODE_IN_CALL = 3;
    public static final int AUDIO_MODE_IN_COMMUNICATION = 4;
    public static final int AUDIO_MODE_NORMAL = 1;
    public static final int AUDIO_MODE_RINGTONE = 2;
    public static final int AUDIO_MODE_UNSPECIFIED = 0;
    ...
    public static final int AUDIO_ROUTING_API_METHOD_UNSPECIFIED = 0;
    ...
    public static final int HARDENING_EXEMPTION_ALARM = 4;
    public static final int HARDENING_EXEMPTION_FLAG_DISABLED = 3;
    public static final int HARDENING_EXEMPTION_NONE = 0;
    public static final int HARDENING_EXEMPTION_OVERRIDE = 5;
    public static final int HARDENING_EXEMPTION_PRIVILEGED_APP = 2;
    public static final int HARDENING_EXEMPTION_SYSTEM_USAGE = 1;
    public static final int HARDENING_EXEMPTION_TARGET_SDK = 6;
    ...
    public static final int HFP_AUDIO_DISCONNECT_REASON_CODEC_NEGOTIATION_FAILED = 2;
    public static final int HFP_AUDIO_DISCONNECT_REASON_INTERNAL_ERROR = 4;
    public static final int HFP_AUDIO_DISCONNECT_REASON_PRECONDITION_FAILED = 3;
    public static final int HFP_AUDIO_DISCONNECT_REASON_REMOTE_INITIATED = 1;
    public static final int HFP_AUDIO_DISCONNECT_REASON_UNKNOWN = 0;
