...
public class Visualizer {
    ...
    private class NativeEventHandler extends android.os.Handler {
        ...
        public NativeEventHandler(android.media.audiofx.Visualizer p0, android.media.audiofx.Visualizer p1, android.os.Looper p2) { super(); }
        private void handleCaptureMessage(android.os.Message p0) {}
        private void handleServerDiedMessage(android.os.Message p0) {}
