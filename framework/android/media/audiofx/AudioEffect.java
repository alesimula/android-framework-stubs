...
public class AudioEffect {
    ...
    private AudioEffect(java.util.UUID p0, java.util.UUID p1, int p2, int p3, android.media.AudioDeviceAttributes p4) throws java.lang.IllegalArgumentException, java.lang.UnsupportedOperationException, java.lang.RuntimeException {}
    private AudioEffect(java.util.UUID p0, java.util.UUID p1, int p2, int p3, android.media.AudioDeviceAttributes p4, boolean p5) throws java.lang.IllegalArgumentException, java.lang.UnsupportedOperationException, java.lang.RuntimeException {}
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission("android.permission.MODIFY_DEFAULT_AUDIO_EFFECTS")
    ...
    private final native int native_setup(java.lang.Object p0, java.lang.String p1, java.lang.String p2, int p3, int p4, int p5, java.lang.String p6, int[] p7, java.lang.Object[] p8, android.os.Parcel p9, boolean p10);
    ...
    private final native int native_setParameter(int p0, byte[] p1, int p2, byte[] p3);
    private final native int native_getParameter(int p0, byte[] p1, int p2, byte[] p3);
    private final native int native_command(int p0, int p1, byte[] p2, int p3, byte[] p4);
    private static native java.lang.Object[] native_query_effects();
    private static native java.lang.Object[] native_query_pre_processing(int p0);
