...
public final class RouteListingPreference implements android.os.Parcelable {
    public static final java.lang.String ACTION_RESOLVE_MISSING_PERMISSIONS = "android.media.action.RESOLVE_MISSING_PERMISSIONS";
    ...
    public static final java.lang.String EXTRA_MISSING_PERMISSIONS = "android.media.extra.MISSING_PERMISSIONS";
    public static final java.lang.String EXTRA_ROUTE_ID = "android.media.extra.ROUTE_ID";
    private final java.util.List<android.media.RouteListingPreference.Item> mItems = null;
    private final android.content.ComponentName mLinkedItemComponentName = null;
    private final android.content.ComponentName mMissingPermissionsComponentName = null;
    private final boolean mUseSystemOrdering = false;
    private RouteListingPreference(android.media.RouteListingPreference.Builder p0) {}
    private RouteListingPreference(android.os.Parcel p0) {}
    ...
    public android.content.ComponentName getMissingPermissionsComponentName() { return null; }
    ...
    public static final class Item implements android.os.Parcelable {
        ...
        private final java.lang.CharSequence mCustomSubtextMessage = null;
        private final int mFlags = 0;
        private final java.lang.String mRouteId = null;
        private final int mSelectionBehavior = 0;
        private final int mSubText = 0;
        private Item(android.media.RouteListingPreference.Item.Builder p0) {}
        private Item(android.os.Parcel p0) {}
        private static java.lang.String getFlagsString(int p0) { return null; }
        private static java.lang.String getSelectionBehaviorString(int p0) { return null; }
