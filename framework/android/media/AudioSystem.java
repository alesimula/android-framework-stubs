...
public class AudioSystem {
    ...
    public static final java.lang.String DEVICE_OUT_HDMI_EARC_NAME = "hmdi_earc";
    ...
    public static int bluetoothCodecToAudioFormat(int p0) { return 0; }
    ...
    public static java.util.ArrayList<android.media.AudioDeviceAttributes> getDevicesForAttributes(android.media.AudioAttributes p0) { return null; }
    private static native int getDevicesForAttributes(android.media.AudioAttributes p0, android.media.AudioDeviceAttributes[] p1);
    ...
    private static native int native_get_offload_support(int p0, int p1, int p2, int p3, int p4);
    ...
    public static native int setHotwordDetectionServiceUid(int p0);
    ...
    public static native int removeDevicesRoleForStrategy(int p0, int p1);
    ...
    public static java.util.Set<java.lang.Integer> generateAudioDeviceTypesSet(int p0) { return null; }
    public static java.util.Set<java.lang.Integer> intersectionAudioDeviceTypes(java.util.Set<java.lang.Integer> p0, java.util.Set<java.lang.Integer> p1) { return null; }
