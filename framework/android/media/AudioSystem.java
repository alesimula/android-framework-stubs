...
public class AudioSystem {
    ...
    public static final java.util.Set<java.lang.Integer> DEVICE_ALL_BLE_HA_SET = null;
    ...
    public static final java.util.Set<java.lang.Integer> DEVICE_IN_ALL_BLE_CENTRAL_BROADCAST_SET = null;
    public static final java.util.Set<java.lang.Integer> DEVICE_IN_ALL_BLE_CENTRAL_SET = null;
    public static final java.util.Set<java.lang.Integer> DEVICE_IN_ALL_BLE_CENTRAL_UNICAST_SET = null;
    ...
    public static final java.lang.String DEVICE_IN_BLE_CENTRAL_BROADCAST_NAME = "ble_central_broadcast";
    public static final java.lang.String DEVICE_IN_BLE_CENTRAL_NAME = "ble_central";
    ...
    public static final java.lang.String DEVICE_IN_BLE_HEARING_AID_NAME = "ble_hearing_aid";
    ...
    public static final java.util.Set<java.lang.Integer> DEVICE_OUT_ALL_BLE_CENTRAL_SET = null;
    public static final java.util.Set<java.lang.Integer> DEVICE_OUT_ALL_BLE_SET = null;
    public static final java.util.Set<java.lang.Integer> DEVICE_OUT_ALL_BLE_UNICAST_SET = null;
    ...
    public static final java.lang.String DEVICE_OUT_BLE_CENTRAL_NAME = "ble_central";
    ...
    public static final java.lang.String DEVICE_OUT_BLE_HEARING_AID_NAME = "ble_hearing_aid";
    ...
    public static final int FORCE_BT_ASHA = 17;
    ...
    private static native int addDevicesRoleForCapturePreset(int p0, int p1, int[] p2, java.lang.String[] p3);
    public static long audioFormatToBluetoothA2dpSourceCodec(int p0) { return 0L; }
    ...
    public static int bluetoothA2dpCodecToAudioFormat(long p0) { return 0; }
    ...
    private static native int getDevicesForAttributes(android.media.AudioAttributes p0, int p1, boolean p2, android.media.AudioDeviceAttributes[] p3);
    ...
    public static java.util.List<android.media.AudioDeviceAttributes> getDevicesForAttributes(android.media.AudioAttributes p0, int p1, boolean p2) { return null; }
    ...
    public static native int getDirectPlaybackSupport(android.media.AudioFormat p0, android.media.AudioAttributes p1, int p2);
    public static native int getDirectProfilesForAttributes(android.media.AudioAttributes p0, int p1, java.util.List<android.media.AudioProfile> p2);
    ...
    public static native int getPreferredMixerAttributes(android.media.AudioAttributes p0, int p1, int p2, java.util.List<android.media.AudioMixerAttributes> p3);
    ...
    public static boolean isBluetoothLeCentralBroadcastDevice(int p0) { return false; }
    public static boolean isBluetoothLeCentralDevice(int p0) { return false; }
    public static boolean isBluetoothLeDevice(int p0) { return false; }
    public static boolean isBluetoothLeHearingAidDevice(int p0) { return false; }
    public static boolean isBluetoothLeInCentralDevice(int p0) { return false; }
    public static boolean isBluetoothLeInCentralUnicastDevice(int p0) { return false; }
    public static boolean isBluetoothLeInDevice(int p0) { return false; }
    public static boolean isBluetoothLeOutCentralDevice(int p0) { return false; }
    public static boolean isBluetoothLeOutDevice(int p0) { return false; }
    public static boolean isBluetoothLeOutUnicastDevice(int p0) { return false; }
    ...
    public static native int listAudioPorts(java.util.ArrayList<android.media.AudioPort> p0, int[] p1, int p2);
    ...
    private static native android.os.IBinder nativeGetSoundDose(android.media.ISoundDoseCallback p0);
    private static native android.os.IBinder nativeGetSpatializer(android.media.INativeSpatializerCallback p0);
    private static native int native_getMaxChannelCount();
    private static int native_getMaxChannelCount$ravenwood() { return 0; }
    private static native int native_getMaxSampleRate();
    private static int native_getMaxSampleRate$ravenwood() { return 0; }
    private static native int native_getMinSampleRate();
    private static int native_getMinSampleRate$ravenwood() { return 0; }
    private static native int native_get_offload_support(int p0, int p1, java.lang.Object p2, int p3);
    ...
    private static android.util.Pair<int[], java.lang.String[]> populateInputDevicesTypeAndAddress(java.util.List<android.media.AudioDeviceAttributes> p0) { return null; }
    ...
    private static native int removeDevicesRoleForCapturePreset(int p0, int p1, int[] p2, java.lang.String[] p3);
    ...
    public static native int resetProductStrategiesZoneIdForUserId(int p0);
    ...
    private static native int setDevicesRoleForCapturePreset(int p0, int p1, int[] p2, java.lang.String[] p3);
    public static int setDevicesRoleForStrategy(int p0, int p1, java.util.List<android.media.AudioDeviceAttributes> p2) { return 0; }
    private static native int setDevicesRoleForStrategy(int p0, int p1, int[] p2, java.lang.String[] p3);
    ...
    public static int setParameters$ravenwood(java.lang.String p0) { return 0; }
    ...
    public static native int setProductStrategiesZoneIdForUserId(int p0, int p1);
    ...
    private static native int setStreamVolumeIndex(int p0, int p1, boolean p2, int p3);
    ...
    public static native int setVolumeIndexForGroup(int p0, int p1, int p2, boolean p3, int p4);
