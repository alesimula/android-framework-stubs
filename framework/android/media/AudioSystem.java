...
public class AudioSystem {
    ...
    public static int setPreferredDeviceForStrategy(int p0, android.media.AudioDeviceAttributes p1) { return 0; }
    private static native int setPreferredDeviceForStrategy(int p0, int p1, java.lang.String p2);
    public static native int removePreferredDeviceForStrategy(int p0);
    public static native int getPreferredDeviceForStrategy(int p0, android.media.AudioDeviceAttributes[] p1);
