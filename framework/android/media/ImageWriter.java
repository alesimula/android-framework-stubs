...
public class ImageWriter implements java.lang.AutoCloseable {
    ...
    protected ImageWriter(android.view.Surface p0, int p1, int p2, int p3, int p4) {}
    ...
    private synchronized native long nativeInit(java.lang.Object p0, android.view.Surface p1, int p2, int p3, int p4, int p5);
    ...
    private synchronized native int nativeAttachAndQueueGraphicBuffer(long p0, android.graphics.GraphicBuffer p1, int p2, long p3, int p4, int p5, int p6, int p7, int p8, int p9);
