...
public interface IMediaRouter2Manager extends android.os.IInterface {
    ...
    public void notifyRoutesUpdated(java.util.List<android.media.MediaRoute2Info> p0, java.util.List<java.lang.String> p1) throws android.os.RemoteException;
    ...
    public void notifySessionUpdated(android.media.RoutingSessionInfo p0, boolean p1) throws android.os.RemoteException;
    public void notifySystemSessionOverridesChanged(java.util.List<android.media.AppId> p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.media.IMediaRouter2Manager {
        static final int TRANSACTION_invalidateInstance = 11;
        ...
        static final int TRANSACTION_notifySystemSessionOverridesChanged = 10;
        public Stub() { super(); }
        ...
        private static final class Proxy implements android.media.IMediaRouter2Manager {
