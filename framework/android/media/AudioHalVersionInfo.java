...
public final class AudioHalVersionInfo implements android.os.Parcelable, java.lang.Comparable<android.media.AudioHalVersionInfo> {
    ...
    private AudioHalVersionInfo(int p0, int p1, int p2) {}
    private AudioHalVersionInfo(android.os.Parcel p0) {}
    private static java.lang.String toString(int p0, int p1, int p2) { return null; }
