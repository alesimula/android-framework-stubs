...
public class AudioDevicePort extends android.media.AudioPort {
    ...
    AudioDevicePort(android.media.AudioHandle p0, java.lang.String p1, int[] p2, int[] p3, int[] p4, int[] p5, android.media.AudioGain[] p6, int p7, java.lang.String p8) { super(null, 0, null, null, null, null, null, null); }
    @android.annotation.UnsupportedAppUsage
