...
public interface ISoundTriggerCallback extends android.os.IInterface {
    ...
    public void onRecognition(int p0, android.media.soundtrigger.RecognitionEvent p1, int p2) throws android.os.RemoteException;
    public void onPhraseRecognition(int p0, android.media.soundtrigger.PhraseRecognitionEvent p1, int p2) throws android.os.RemoteException;
