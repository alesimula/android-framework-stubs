...
public interface ISoundTriggerModule extends android.os.IInterface {
    public int loadModel(android.media.soundtrigger_middleware.SoundModel p0) throws android.os.RemoteException;
    public int loadPhraseModel(android.media.soundtrigger_middleware.PhraseSoundModel p0) throws android.os.RemoteException;
    public void unloadModel(int p0) throws android.os.RemoteException;
    public void startRecognition(int p0, android.media.soundtrigger_middleware.RecognitionConfig p1) throws android.os.RemoteException;
    ...
    public android.media.soundtrigger_middleware.ModelParameterRange queryModelParameterSupport(int p0, int p1) throws android.os.RemoteException;
    ...
    public static class Default implements android.media.soundtrigger_middleware.ISoundTriggerModule {
        public Default() {}
        public int loadModel(android.media.soundtrigger_middleware.SoundModel p0) throws android.os.RemoteException { return 0; }
        public int loadPhraseModel(android.media.soundtrigger_middleware.PhraseSoundModel p0) throws android.os.RemoteException { return 0; }
        public void unloadModel(int p0) throws android.os.RemoteException {}
        public void startRecognition(int p0, android.media.soundtrigger_middleware.RecognitionConfig p1) throws android.os.RemoteException {}
        public void stopRecognition(int p0) throws android.os.RemoteException {}
        public void forceRecognitionEvent(int p0) throws android.os.RemoteException {}
        ...
        public android.media.soundtrigger_middleware.ModelParameterRange queryModelParameterSupport(int p0, int p1) throws android.os.RemoteException { return null; }
        public void detach() throws android.os.RemoteException {}
    ...
    public static abstract class Stub extends android.os.Binder implements android.media.soundtrigger_middleware.ISoundTriggerModule {
        private static final java.lang.String DESCRIPTOR = "android.media.soundtrigger_middleware.ISoundTriggerModule";
        ...
        public static boolean setDefaultImpl(android.media.soundtrigger_middleware.ISoundTriggerModule p0) { return false; }
        public static android.media.soundtrigger_middleware.ISoundTriggerModule getDefaultImpl() { return null; }
