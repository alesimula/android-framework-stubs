...
public final class VolumeShaper implements java.lang.AutoCloseable {
    ...
    public static final class Configuration implements android.os.Parcelable {
        ...
        private android.media.InterpolatorConfig toInterpolatorParcelable() { return null; }
        ...
        private static int interpolatorTypeFromAidl(int p0) { return 0; }
        @android.media.InterpolatorType
        private static int interpolatorTypeToAidl(int p0) { return 0; }
        private static int typeFromAidl(int p0) { return 0; }
        @android.media.VolumeShaperConfigurationType
        private static int typeToAidl(int p0) { return 0; }
        private static int optionFlagsFromAidl(int p0) { return 0; }
        private static int optionFlagsToAidl(int p0) { return 0; }
