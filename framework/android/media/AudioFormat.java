...
public final class AudioFormat implements android.os.Parcelable {
    public static final int AUDIO_FORMAT_HAS_PROPERTY_CHANNEL_ACN_MASK = 16;
    ...
    public static final int CHANNEL_ACN_HORIZONTAL = 512;
    public static final int CHANNEL_ACN_ORDER_0 = 1;
    public static final int CHANNEL_ACN_ORDER_0_HRZ = 513;
    public static final int CHANNEL_ACN_ORDER_1 = 4;
    public static final int CHANNEL_ACN_ORDER_10 = 121;
    public static final int CHANNEL_ACN_ORDER_10_HRZ = 533;
    public static final int CHANNEL_ACN_ORDER_11 = 144;
    public static final int CHANNEL_ACN_ORDER_11_HRZ = 535;
    public static final int CHANNEL_ACN_ORDER_12 = 169;
    public static final int CHANNEL_ACN_ORDER_12_HRZ = 537;
    public static final int CHANNEL_ACN_ORDER_13 = 196;
    public static final int CHANNEL_ACN_ORDER_13_HRZ = 539;
    public static final int CHANNEL_ACN_ORDER_14 = 225;
    public static final int CHANNEL_ACN_ORDER_14_HRZ = 541;
    public static final int CHANNEL_ACN_ORDER_1_HRZ = 515;
    public static final int CHANNEL_ACN_ORDER_2 = 9;
    public static final int CHANNEL_ACN_ORDER_2_HRZ = 517;
    public static final int CHANNEL_ACN_ORDER_3 = 16;
    public static final int CHANNEL_ACN_ORDER_3_HRZ = 519;
    public static final int CHANNEL_ACN_ORDER_4 = 25;
    public static final int CHANNEL_ACN_ORDER_4_HRZ = 521;
    public static final int CHANNEL_ACN_ORDER_5 = 36;
    public static final int CHANNEL_ACN_ORDER_5_HRZ = 523;
    public static final int CHANNEL_ACN_ORDER_6 = 49;
    public static final int CHANNEL_ACN_ORDER_6_HRZ = 525;
    public static final int CHANNEL_ACN_ORDER_7 = 64;
    public static final int CHANNEL_ACN_ORDER_7_HRZ = 527;
    public static final int CHANNEL_ACN_ORDER_8 = 81;
    public static final int CHANNEL_ACN_ORDER_8_HRZ = 529;
    public static final int CHANNEL_ACN_ORDER_9 = 100;
    public static final int CHANNEL_ACN_ORDER_9_HRZ = 531;
    ...
    private AudioFormat(int p0, int p1, int p2, int p3, int p4, int p5) {}
    private AudioFormat(android.os.Parcel p0) {}
    public static int channelCountFromAcnChannelMask(int p0) { return 0; }
    ...
    public int getChannelAcnMask() { return 0; }
    public int getChannelCount() { return 0; }
    public int getChannelIndexMask() { return 0; }
    public int getChannelMask() { return 0; }
    public android.media.AudioFormat.ChannelMasks getChannelMasks() { return null; }
    ...
    public static class Builder {
        ...
        public android.media.AudioFormat.Builder setChannelAcnMask(int p0) { return null; }
    ...
    public static class ChannelMasksArray {
        private final int[] mAcnMasks = null;
        private final int[] mIndexMasks = null;
        private final int[] mPositionMasks = null;
        public ChannelMasksArray() {}
        public ChannelMasksArray(int[] p0, int[] p1) {}
        public ChannelMasksArray(int[] p0, int[] p1, int[] p2) {}
        private void addChannelCounts(java.util.Set<java.lang.Integer> p0, boolean p1) {}
        public static android.media.AudioFormat.ChannelMasksArray mergeLists(java.util.List<android.media.AudioFormat.ChannelMasksArray> p0) { return null; }
        private static java.lang.String toHexString(int[] p0) { return null; }
        public boolean equals(java.lang.Object p0) { return false; }
        public int[] getAcnMasks() { return null; }
        public int[] getChannelCounts(boolean p0) { return null; }
        public int[] getIndexMasks() { return null; }
        public int[] getPositionMasks() { return null; }
        public int hashCode() { return 0; }
        public java.lang.String toString() { return null; }
    }
