...
public final class Enums {
    public static final int ENTRY_POINT_LOCAL_ROUTER = 3;
    public static final int ENTRY_POINT_PROXY_ROUTER = 4;
    ...
    public static final int TRANSFER_REASON_APP = 3;
    public static final int TRANSFER_REASON_FALLBACK = 1;
    public static final int TRANSFER_REASON_SYSTEM_REQUEST = 2;
    public static final int TRANSFER_REASON_UNSPECIFIED = 0;
    public Enums() {}
}
