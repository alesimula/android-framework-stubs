...
public class AudioMixPort extends android.media.AudioPort {
    ...
    AudioMixPort(android.media.AudioHandle p0, int p1, int p2, java.lang.String p3, int[] p4, int[] p5, int[] p6, int[] p7, android.media.AudioGain[] p8) { super(null, 0, null, null, null, null, null, null); }
