...
public class AudioMixPort extends android.media.AudioPort {
    ...
    AudioMixPort(android.media.AudioHandle p0, int p1, int p2, java.lang.String p3, int[] p4, android.media.AudioFormat.ChannelMasksArray p5, int[] p6, android.media.AudioGain[] p7) { super((android.media.AudioHandle)null, 0, (java.lang.String)null, (java.util.List)null, (android.media.AudioGain[])null, (java.util.List)null); }
    ...
    public android.media.AudioMixPortConfig buildConfig(int p0, android.media.AudioFormat.ChannelMasks p1, int p2, android.media.AudioGainConfig p3) { return null; }
