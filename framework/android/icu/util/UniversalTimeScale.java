...
public final class UniversalTimeScale {
    ...
    public static long from(long p0, int p1) { return 0L; }
    public static android.icu.math.BigDecimal bigDecimalFrom(double p0, int p1) { return null; }
    public static android.icu.math.BigDecimal bigDecimalFrom(long p0, int p1) { return null; }
    public static android.icu.math.BigDecimal bigDecimalFrom(android.icu.math.BigDecimal p0, int p1) { return null; }
    public static long toLong(long p0, int p1) { return 0L; }
    public static android.icu.math.BigDecimal toBigDecimal(long p0, int p1) { return null; }
    public static android.icu.math.BigDecimal toBigDecimal(android.icu.math.BigDecimal p0, int p1) { return null; }
    public static long getTimeScaleValue(int p0, int p1) { return 0L; }
}
