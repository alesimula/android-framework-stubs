...
public final class UScript {
    ...
    UScript() {}
    public static int[] getCode(java.util.Locale p0) { return null; }
    public static int[] getCode(android.icu.util.ULocale p0) { return null; }
    public static int[] getCode(java.lang.String p0) { return null; }
    public static int getCodeFromName(java.lang.String p0) { return 0; }
    public static int getScript(int p0) { return 0; }
    public static boolean hasScript(int p0, int p1) { return false; }
    public static int getScriptExtensions(int p0, java.util.BitSet p1) { return 0; }
    public static java.lang.String getName(int p0) { return null; }
    public static java.lang.String getShortName(int p0) { return null; }
    public static java.lang.String getSampleString(int p0) { return null; }
    public static android.icu.lang.UScript.ScriptUsage getUsage(int p0) { return null; }
    public static boolean isRightToLeft(int p0) { return false; }
    public static boolean breaksBetweenLetters(int p0) { return false; }
    public static boolean isCased(int p0) { return false; }
