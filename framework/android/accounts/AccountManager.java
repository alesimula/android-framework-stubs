...
public class AccountManager {
    ...
    private final android.accounts.IAccountManager mService = null;
    ...
    private final java.util.HashMap<android.accounts.OnAccountsUpdateListener, android.os.Handler> mAccountsUpdatedListeners = null;
    private final java.util.HashMap<android.accounts.OnAccountsUpdateListener, java.util.Set<java.lang.String>> mAccountsUpdatedListenersTypes = null;
    private final android.content.BroadcastReceiver mAccountsChangedBroadcastReceiver = null;
    @android.annotation.UnsupportedAppUsage
    ...
    public android.accounts.AccountManagerFuture<java.lang.Boolean> copyAccountToUser(android.accounts.Account p0, android.os.UserHandle p1, android.os.UserHandle p2, android.accounts.AccountManagerCallback<java.lang.Boolean> p3, android.os.Handler p4) { return null; }
    public boolean removeSharedAccount(android.accounts.Account p0, android.os.UserHandle p1) { return false; }
    public android.accounts.Account[] getSharedAccounts(android.os.UserHandle p0) { return null; }
    ...
    private void postToHandler(android.os.Handler p0, android.accounts.AccountManagerCallback<android.os.Bundle> p1, android.accounts.AccountManagerFuture<android.os.Bundle> p2) {}
    private void postToHandler(android.os.Handler p0, android.accounts.OnAccountsUpdateListener p1, android.accounts.Account[] p2) {}
    private java.lang.Exception convertErrorToException(int p0, java.lang.String p1) { return null; }
    private void getAccountByTypeAndFeatures(java.lang.String p0, java.lang.String[] p1, android.accounts.AccountManagerCallback<android.os.Bundle> p2, android.os.Handler p3) {}
    ...
    private abstract class Future2Task<T extends java.lang.Object> extends android.accounts.AccountManager.BaseFutureTask<T> implements android.accounts.AccountManagerFuture<T> {
        ...
        private T internalGetResult(java.lang.Long p0, java.util.concurrent.TimeUnit p1) throws android.accounts.OperationCanceledException, java.io.IOException, android.accounts.AuthenticatorException { return null; }
    ...
    private abstract class AmsTask extends java.util.concurrent.FutureTask<android.os.Bundle> implements android.accounts.AccountManagerFuture<android.os.Bundle> {
        ...
        public abstract void doWork() throws android.os.RemoteException;
        private android.os.Bundle internalGetResult(java.lang.Long p0, java.util.concurrent.TimeUnit p1) throws android.accounts.OperationCanceledException, java.io.IOException, android.accounts.AuthenticatorException { return null; }
        ...
        private class Response extends android.accounts.IAccountManagerResponse.Stub {
            private Response(android.accounts.AccountManager.AmsTask p0) { super(); }
            public void onResult(android.os.Bundle p0) {}
            public void onError(int p0, java.lang.String p1) {}
        }
    }
