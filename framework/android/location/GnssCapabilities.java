...
public final class GnssCapabilities implements android.os.Parcelable {
    ...
    private final int mTopFlags = 0;
    private final int mMeasurementCorrectionsFlags = 0;
    private final int mPowerFlags = 0;
    ...
    private GnssCapabilities(int p0, int p1, int p2) {}
    ...
    public static final class Builder {
        ...
        private static int setFlag(int p0, int p1, boolean p2) { return 0; }
    }
