...
public final class ProviderProperties implements android.os.Parcelable {
    ...
    private final boolean mHasNetworkRequirement = false;
    private final boolean mHasSatelliteRequirement = false;
    private final boolean mHasCellRequirement = false;
    private final boolean mHasMonetaryCost = false;
    private final boolean mHasAltitudeSupport = false;
    private final boolean mHasSpeedSupport = false;
    private final boolean mHasBearingSupport = false;
    private final int mPowerUsage = 0;
    private final int mAccuracy = 0;
    public static final android.os.Parcelable.Creator<android.location.provider.ProviderProperties> CREATOR = null;
    private ProviderProperties(boolean p0, boolean p1, boolean p2, boolean p3, boolean p4, boolean p5, boolean p6, int p7, int p8) {}
