...
public class EGL14 {
    ...
    public static native android.opengl.EGLDisplay eglGetDisplay(int p0);
    public static native android.opengl.EGLDisplay eglGetDisplay(long p0);
    public static native boolean eglInitialize(android.opengl.EGLDisplay p0, int[] p1, int p2, int[] p3, int p4);
    public static native boolean eglTerminate(android.opengl.EGLDisplay p0);
    public static native java.lang.String eglQueryString(android.opengl.EGLDisplay p0, int p1);
    public static native boolean eglGetConfigs(android.opengl.EGLDisplay p0, android.opengl.EGLConfig[] p1, int p2, int p3, int[] p4, int p5);
    public static native boolean eglChooseConfig(android.opengl.EGLDisplay p0, int[] p1, int p2, android.opengl.EGLConfig[] p3, int p4, int p5, int[] p6, int p7);
    public static native boolean eglGetConfigAttrib(android.opengl.EGLDisplay p0, android.opengl.EGLConfig p1, int p2, int[] p3, int p4);
    private static native android.opengl.EGLSurface _eglCreateWindowSurface(android.opengl.EGLDisplay p0, android.opengl.EGLConfig p1, java.lang.Object p2, int[] p3, int p4);
    private static native android.opengl.EGLSurface _eglCreateWindowSurfaceTexture(android.opengl.EGLDisplay p0, android.opengl.EGLConfig p1, java.lang.Object p2, int[] p3, int p4);
    public static android.opengl.EGLSurface eglCreateWindowSurface(android.opengl.EGLDisplay p0, android.opengl.EGLConfig p1, java.lang.Object p2, int[] p3, int p4) { return null; }
    public static native android.opengl.EGLSurface eglCreatePbufferSurface(android.opengl.EGLDisplay p0, android.opengl.EGLConfig p1, int[] p2, int p3);
    @java.lang.Deprecated
    public static native android.opengl.EGLSurface eglCreatePixmapSurface(android.opengl.EGLDisplay p0, android.opengl.EGLConfig p1, int p2, int[] p3, int p4);
    public static native boolean eglDestroySurface(android.opengl.EGLDisplay p0, android.opengl.EGLSurface p1);
    public static native boolean eglQuerySurface(android.opengl.EGLDisplay p0, android.opengl.EGLSurface p1, int p2, int[] p3, int p4);
    public static native boolean eglBindAPI(int p0);
    ...
    public static native android.opengl.EGLSurface eglCreatePbufferFromClientBuffer(android.opengl.EGLDisplay p0, int p1, int p2, android.opengl.EGLConfig p3, int[] p4, int p5);
    public static native android.opengl.EGLSurface eglCreatePbufferFromClientBuffer(android.opengl.EGLDisplay p0, int p1, long p2, android.opengl.EGLConfig p3, int[] p4, int p5);
    public static native boolean eglSurfaceAttrib(android.opengl.EGLDisplay p0, android.opengl.EGLSurface p1, int p2, int p3);
    public static native boolean eglBindTexImage(android.opengl.EGLDisplay p0, android.opengl.EGLSurface p1, int p2);
    public static native boolean eglReleaseTexImage(android.opengl.EGLDisplay p0, android.opengl.EGLSurface p1, int p2);
    public static native boolean eglSwapInterval(android.opengl.EGLDisplay p0, int p1);
    public static native android.opengl.EGLContext eglCreateContext(android.opengl.EGLDisplay p0, android.opengl.EGLConfig p1, android.opengl.EGLContext p2, int[] p3, int p4);
    public static native boolean eglDestroyContext(android.opengl.EGLDisplay p0, android.opengl.EGLContext p1);
    public static native boolean eglMakeCurrent(android.opengl.EGLDisplay p0, android.opengl.EGLSurface p1, android.opengl.EGLSurface p2, android.opengl.EGLContext p3);
    public static native android.opengl.EGLContext eglGetCurrentContext();
    public static native android.opengl.EGLSurface eglGetCurrentSurface(int p0);
    public static native android.opengl.EGLDisplay eglGetCurrentDisplay();
    public static native boolean eglQueryContext(android.opengl.EGLDisplay p0, android.opengl.EGLContext p1, int p2, int[] p3, int p4);
    public static native boolean eglWaitGL();
    public static native boolean eglWaitNative(int p0);
    public static native boolean eglSwapBuffers(android.opengl.EGLDisplay p0, android.opengl.EGLSurface p1);
    public static native boolean eglCopyBuffers(android.opengl.EGLDisplay p0, android.opengl.EGLSurface p1, int p2);
}
