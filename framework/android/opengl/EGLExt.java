...
public class EGLExt {
    ...
    private static native int eglDupNativeFenceFDANDROIDImpl(android.opengl.EGLDisplay p0, android.opengl.EGLSync p1);
    public static native long eglGetNativeClientBufferANDROID(android.hardware.HardwareBuffer p0);
