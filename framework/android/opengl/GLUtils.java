...
public final class GLUtils {
    ...
    private static native int native_getInternalFormat(long p0);
    private static native int native_getType(long p0);
    private static native int native_texImage2D(int p0, int p1, int p2, long p3, int p4, int p5);
    private static native int native_texSubImage2D(int p0, int p1, int p2, int p3, long p4, int p5, int p6);
}
