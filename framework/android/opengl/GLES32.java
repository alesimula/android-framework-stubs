...
public class GLES32 extends android.opengl.GLES31 {
    ...
    private GLES32() { super(); }
    public static native void glBlendBarrier();
    public static native void glCopyImageSubData(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, int p10, int p11, int p12, int p13, int p14);
    public static native void glDebugMessageControl(int p0, int p1, int p2, int p3, int[] p4, int p5, boolean p6);
    public static native void glDebugMessageControl(int p0, int p1, int p2, int p3, java.nio.IntBuffer p4, boolean p5);
    public static native void glDebugMessageInsert(int p0, int p1, int p2, int p3, int p4, java.lang.String p5);
    public static native void glDebugMessageCallback(android.opengl.GLES32.DebugProc p0);
    public static native int glGetDebugMessageLog(int p0, int p1, int[] p2, int p3, int[] p4, int p5, int[] p6, int p7, int[] p8, int p9, int[] p10, int p11, byte[] p12, int p13);
    public static native int glGetDebugMessageLog(int p0, java.nio.IntBuffer p1, java.nio.IntBuffer p2, java.nio.IntBuffer p3, java.nio.IntBuffer p4, java.nio.IntBuffer p5, java.nio.ByteBuffer p6);
    public static native java.lang.String[] glGetDebugMessageLog(int p0, int[] p1, int p2, int[] p3, int p4, int[] p5, int p6, int[] p7, int p8);
    public static native java.lang.String[] glGetDebugMessageLog(int p0, java.nio.IntBuffer p1, java.nio.IntBuffer p2, java.nio.IntBuffer p3, java.nio.IntBuffer p4);
    public static native void glPushDebugGroup(int p0, int p1, int p2, java.lang.String p3);
    public static native void glPopDebugGroup();
    public static native void glObjectLabel(int p0, int p1, int p2, java.lang.String p3);
    public static native java.lang.String glGetObjectLabel(int p0, int p1);
    public static native void glObjectPtrLabel(long p0, java.lang.String p1);
    public static native java.lang.String glGetObjectPtrLabel(long p0);
    public static native long glGetPointerv(int p0);
    public static native void glEnablei(int p0, int p1);
    public static native void glDisablei(int p0, int p1);
    public static native void glBlendEquationi(int p0, int p1);
    public static native void glBlendEquationSeparatei(int p0, int p1, int p2);
    public static native void glBlendFunci(int p0, int p1, int p2);
    public static native void glBlendFuncSeparatei(int p0, int p1, int p2, int p3, int p4);
    public static native void glColorMaski(int p0, boolean p1, boolean p2, boolean p3, boolean p4);
    public static native boolean glIsEnabledi(int p0, int p1);
    public static native void glDrawElementsBaseVertex(int p0, int p1, int p2, java.nio.Buffer p3, int p4);
    public static native void glDrawRangeElementsBaseVertex(int p0, int p1, int p2, int p3, int p4, java.nio.Buffer p5, int p6);
    public static native void glDrawElementsInstancedBaseVertex(int p0, int p1, int p2, java.nio.Buffer p3, int p4, int p5);
    public static native void glDrawElementsInstancedBaseVertex(int p0, int p1, int p2, int p3, int p4, int p5);
    public static native void glFramebufferTexture(int p0, int p1, int p2, int p3);
    public static native void glPrimitiveBoundingBox(float p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7);
    public static native int glGetGraphicsResetStatus();
    public static native void glReadnPixels(int p0, int p1, int p2, int p3, int p4, int p5, int p6, java.nio.Buffer p7);
    public static native void glGetnUniformfv(int p0, int p1, int p2, float[] p3, int p4);
    public static native void glGetnUniformfv(int p0, int p1, int p2, java.nio.FloatBuffer p3);
    public static native void glGetnUniformiv(int p0, int p1, int p2, int[] p3, int p4);
    public static native void glGetnUniformiv(int p0, int p1, int p2, java.nio.IntBuffer p3);
    public static native void glGetnUniformuiv(int p0, int p1, int p2, int[] p3, int p4);
    public static native void glGetnUniformuiv(int p0, int p1, int p2, java.nio.IntBuffer p3);
    public static native void glMinSampleShading(float p0);
    public static native void glPatchParameteri(int p0, int p1);
    public static native void glTexParameterIiv(int p0, int p1, int[] p2, int p3);
    public static native void glTexParameterIiv(int p0, int p1, java.nio.IntBuffer p2);
    public static native void glTexParameterIuiv(int p0, int p1, int[] p2, int p3);
    public static native void glTexParameterIuiv(int p0, int p1, java.nio.IntBuffer p2);
    public static native void glGetTexParameterIiv(int p0, int p1, int[] p2, int p3);
    public static native void glGetTexParameterIiv(int p0, int p1, java.nio.IntBuffer p2);
    public static native void glGetTexParameterIuiv(int p0, int p1, int[] p2, int p3);
    public static native void glGetTexParameterIuiv(int p0, int p1, java.nio.IntBuffer p2);
    public static native void glSamplerParameterIiv(int p0, int p1, int[] p2, int p3);
    public static native void glSamplerParameterIiv(int p0, int p1, java.nio.IntBuffer p2);
    public static native void glSamplerParameterIuiv(int p0, int p1, int[] p2, int p3);
    public static native void glSamplerParameterIuiv(int p0, int p1, java.nio.IntBuffer p2);
    public static native void glGetSamplerParameterIiv(int p0, int p1, int[] p2, int p3);
    public static native void glGetSamplerParameterIiv(int p0, int p1, java.nio.IntBuffer p2);
    public static native void glGetSamplerParameterIuiv(int p0, int p1, int[] p2, int p3);
    public static native void glGetSamplerParameterIuiv(int p0, int p1, java.nio.IntBuffer p2);
    public static native void glTexBuffer(int p0, int p1, int p2);
    public static native void glTexBufferRange(int p0, int p1, int p2, int p3, int p4);
    public static native void glTexStorage3DMultisample(int p0, int p1, int p2, int p3, int p4, int p5, boolean p6);

    public static interface DebugProc {
        public void onMessage(int p0, int p1, int p2, int p3, java.lang.String p4);
    }
}
