...
public class Matrix {
    private static final java.lang.ThreadLocal<float[]> ThreadTmp = null;
    ...
    public static void multiplyMM(float[] p0, int p1, float[] p2, int p3, float[] p4, int p5) {}
    public static void multiplyMV(float[] p0, int p1, float[] p2, int p3, float[] p4, int p5) {}
    public static void orthoM(float[] p0, int p1, float p2, float p3, float p4, float p5, float p6, float p7) {}
    private static boolean overlap(float[] p0, int p1, int p2, float[] p3, int p4, int p5) { return false; }
    ...
    public static void setRotateEulerM2(float[] p0, int p1, float p2, float p3, float p4) {}
