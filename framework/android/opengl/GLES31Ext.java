...
public class GLES31Ext {
    ...
    public static native void glDebugMessageControlKHR(int p0, int p1, int p2, int p3, int[] p4, int p5, boolean p6);
    public static native void glDebugMessageControlKHR(int p0, int p1, int p2, int p3, java.nio.IntBuffer p4, boolean p5);
    public static native void glDebugMessageInsertKHR(int p0, int p1, int p2, int p3, java.lang.String p4);
    public static native void glDebugMessageCallbackKHR(android.opengl.GLES31Ext.DebugProcKHR p0);
    public static native int glGetDebugMessageLogKHR(int p0, int p1, int[] p2, int p3, int[] p4, int p5, int[] p6, int p7, int[] p8, int p9, int[] p10, int p11, byte[] p12, int p13);
    public static native int glGetDebugMessageLogKHR(int p0, java.nio.IntBuffer p1, java.nio.IntBuffer p2, java.nio.IntBuffer p3, java.nio.IntBuffer p4, java.nio.IntBuffer p5, java.nio.ByteBuffer p6);
    public static native java.lang.String[] glGetDebugMessageLogKHR(int p0, int[] p1, int p2, int[] p3, int p4, int[] p5, int p6, int[] p7, int p8);
    public static native java.lang.String[] glGetDebugMessageLogKHR(int p0, java.nio.IntBuffer p1, java.nio.IntBuffer p2, java.nio.IntBuffer p3, java.nio.IntBuffer p4);
    public static native void glPushDebugGroupKHR(int p0, int p1, int p2, java.lang.String p3);
    public static native void glPopDebugGroupKHR();
    public static native void glObjectLabelKHR(int p0, int p1, int p2, java.lang.String p3);
    public static native java.lang.String glGetObjectLabelKHR(int p0, int p1);
    public static native void glObjectPtrLabelKHR(long p0, java.lang.String p1);
    public static native java.lang.String glGetObjectPtrLabelKHR(long p0);
    public static native android.opengl.GLES31Ext.DebugProcKHR glGetDebugMessageCallbackKHR();
    public static native void glMinSampleShadingOES(float p0);
    public static native void glTexStorage3DMultisampleOES(int p0, int p1, int p2, int p3, int p4, int p5, boolean p6);
    public static native void glCopyImageSubDataEXT(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, int p10, int p11, int p12, int p13, int p14);
    public static native void glEnableiEXT(int p0, int p1);
    public static native void glDisableiEXT(int p0, int p1);
    public static native void glBlendEquationiEXT(int p0, int p1);
    public static native void glBlendEquationSeparateiEXT(int p0, int p1, int p2);
    public static native void glBlendFunciEXT(int p0, int p1, int p2);
    public static native void glBlendFuncSeparateiEXT(int p0, int p1, int p2, int p3, int p4);
    public static native void glColorMaskiEXT(int p0, boolean p1, boolean p2, boolean p3, boolean p4);
    public static native boolean glIsEnablediEXT(int p0, int p1);
    public static native void glFramebufferTextureEXT(int p0, int p1, int p2, int p3);
    public static native void glPrimitiveBoundingBoxEXT(float p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7);
    public static native void glPatchParameteriEXT(int p0, int p1);
    public static native void glTexParameterIivEXT(int p0, int p1, int[] p2, int p3);
    public static native void glTexParameterIivEXT(int p0, int p1, java.nio.IntBuffer p2);
    public static native void glTexParameterIuivEXT(int p0, int p1, int[] p2, int p3);
    public static native void glTexParameterIuivEXT(int p0, int p1, java.nio.IntBuffer p2);
    public static native void glGetTexParameterIivEXT(int p0, int p1, int[] p2, int p3);
    public static native void glGetTexParameterIivEXT(int p0, int p1, java.nio.IntBuffer p2);
    public static native void glGetTexParameterIuivEXT(int p0, int p1, int[] p2, int p3);
    public static native void glGetTexParameterIuivEXT(int p0, int p1, java.nio.IntBuffer p2);
    public static native void glSamplerParameterIivEXT(int p0, int p1, int[] p2, int p3);
    public static native void glSamplerParameterIivEXT(int p0, int p1, java.nio.IntBuffer p2);
    public static native void glSamplerParameterIuivEXT(int p0, int p1, int[] p2, int p3);
    public static native void glSamplerParameterIuivEXT(int p0, int p1, java.nio.IntBuffer p2);
    public static native void glGetSamplerParameterIivEXT(int p0, int p1, int[] p2, int p3);
    public static native void glGetSamplerParameterIivEXT(int p0, int p1, java.nio.IntBuffer p2);
    public static native void glGetSamplerParameterIuivEXT(int p0, int p1, int[] p2, int p3);
    public static native void glGetSamplerParameterIuivEXT(int p0, int p1, java.nio.IntBuffer p2);
    public static native void glTexBufferEXT(int p0, int p1, int p2);
    public static native void glTexBufferRangeEXT(int p0, int p1, int p2, int p3, int p4);
