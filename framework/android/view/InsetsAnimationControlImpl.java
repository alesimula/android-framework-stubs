...
public class InsetsAnimationControlImpl implements android.view.WindowInsetsAnimationController, android.view.InsetsAnimationControlRunner {
    ...
    private final int mLayoutInsetsDuringAnimation = 0;
    ...
    private void updateLeashesForSide(int p0, int p1, int p2, java.util.ArrayList<android.view.SyncRtSurfaceTransactionApplier.SurfaceParams> p3, android.view.InsetsState p4, float p5) {}
