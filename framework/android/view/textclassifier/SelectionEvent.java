...
public final class SelectionEvent implements android.os.Parcelable {
    ...
    private final int mAbsoluteStart = 0;
    private final int mAbsoluteEnd = 0;
    ...
    private SelectionEvent(android.os.Parcel p0) {}
    ...
    private static void checkActionType(int p0) throws java.lang.IllegalArgumentException {}
