...
public class View implements android.graphics.drawable.Drawable.Callback, android.view.KeyEvent.Callback, android.view.accessibility.AccessibilityEventSource {
    ...
    private android.graphics.RenderNode mBackgroundRenderNode;
    @android.annotation.UnsupportedAppUsage
    ...
    private android.view.contentcapture.ContentCaptureSession mCachedContentCaptureSession;
    ...
    @android.annotation.UnsupportedAppUsage
    View() {}
    final boolean debugDraw() { return false; }
    ...
    void clearFocusInternal(android.view.View p0, boolean p1, boolean p2) {}
    ...
    private void notifyFocusChangeToInputMethodManager(boolean p0) {}
    ...
    private void notifyAppearedOrDisappearedForContentCaptureIfNeededNoTrace(boolean p0) {}
    ...
    private void populateVirtualStructure(android.view.ViewStructure p0, android.view.accessibility.AccessibilityNodeProvider p1, android.view.accessibility.AccessibilityNodeInfo p2, boolean p3) {}
    ...
    public void setWindowInsetsAnimationListener(android.view.WindowInsetsAnimationListener p0) {}
    void dispatchWindowInsetsAnimationStarted(android.view.WindowInsetsAnimationListener.InsetsAnimation p0) {}
    android.view.WindowInsets dispatchWindowInsetsAnimationProgress(android.view.WindowInsets p0) { return null; }
    void dispatchWindowInsetsAnimationFinished(android.view.WindowInsetsAnimationListener.InsetsAnimation p0) {}
    ...
    public void getOutsets(android.graphics.Rect p0) {}
    ...
    public void setAutofilled(boolean p0) {}
    ...
    @android.annotation.UnsupportedAppUsage(maxTargetSdk=28, trackingBug=123768435L)
    ...
    private void getRoundVerticalScrollBarBounds(android.graphics.Rect p0) {}
    ...
    private final void debugDrawFocus(android.graphics.Canvas p0) {}
    ...
    @android.annotation.UnsupportedAppUsage(maxTargetSdk=28, trackingBug=123768420L)
    ...
    @android.annotation.UnsupportedAppUsage
    private void cancel(android.view.View.SendViewScrolledAccessibilityEvent p0) {}
    ...
    private class SendViewScrolledAccessibilityEvent implements java.lang.Runnable {
        public volatile boolean mIsPending;
        public int mDeltaX;
        public int mDeltaY;
        private SendViewScrolledAccessibilityEvent(android.view.View p0) {}
    ...
    static class ListenerInfo {
        ...
        private java.util.List<android.graphics.Rect> mSystemGestureExclusionRects;
    ...
    static final class AttachInfo {
        ...
        final android.graphics.Point mLocationInParentDisplay = null;
        ...
        static interface Callbacks {
            public void playSoundEffect(int p0);
            public boolean performHapticFeedback(int p0, boolean p1);
        }
    }
