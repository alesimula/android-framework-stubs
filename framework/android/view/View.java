...
public class View implements android.graphics.drawable.Drawable.Callback, android.view.KeyEvent.Callback, android.view.accessibility.AccessibilityEventSource {
    ...
    @android.annotation.FlaggedApi("com.android.window.flags.supports_drag_assistant_to_multiwindow")
    ...
    @java.lang.Deprecated
    @android.annotation.FlaggedApi("android.view.accessibility.deprecate_accessibility_announcement_apis")
    ...
    static final class NoPreloadHolder {
        NoPreloadHolder() {}
        static int[][] parseFrameRateMapping(java.lang.String p0) { return null; }
    }
