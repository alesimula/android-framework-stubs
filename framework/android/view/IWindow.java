...
public interface IWindow extends android.os.IInterface {
    ...
    public void resized(android.graphics.Rect p0, android.graphics.Rect p1, android.graphics.Rect p2, android.graphics.Rect p3, boolean p4, android.util.MergedConfiguration p5, android.graphics.Rect p6, boolean p7, boolean p8, int p9, android.view.DisplayCutout.ParcelableWrapper p10) throws android.os.RemoteException;
    ...
    public void requestScrollCapture(android.view.IScrollCaptureController p0) throws android.os.RemoteException;
