...
public interface IWindow extends android.os.IInterface {
    ...
    public void resized(android.window.ClientWindowFrames p0, boolean p1, android.util.MergedConfiguration p2, android.view.InsetsState p3, boolean p4, boolean p5, int p6, int p7, boolean p8, android.window.ActivityWindowInfo p9) throws android.os.RemoteException;
