...
public interface IWindow extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.view.IWindow {
        ...
        static final int TRANSACTION_requestAccessibilityEmbeddedConnection = 19;
        static final int TRANSACTION_requestAppKeyboardShortcuts = 13;
        static final int TRANSACTION_requestHardwareRendererOutputDisabled = 16;
        static final int TRANSACTION_requestScrollCapture = 14;
        static final int TRANSACTION_requestViewAnimationsDisabled = 17;
        ...
        private static final class Proxy implements android.view.IWindow {
