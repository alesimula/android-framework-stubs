...
public final class ViewRootImpl implements android.view.ViewParent, android.view.View.AttachInfo.Callbacks, android.view.ThreadedRenderer.DrawCallbacks, android.view.AttachedSurfaceControl {
    ...
    private final android.view.SurfaceControl.Transaction mRtBLASTSyncTransaction = null;
    ...
    public static void computeWindowBounds(android.view.WindowManager.LayoutParams p0, android.view.InsetsState p1, android.graphics.Rect p2, android.graphics.Rect p3) {}
    ...
    private void handleResized(int p0, com.android.internal.os.SomeArgs p1) {}
    ...
    android.view.Surface getOrCreateBLASTSurface() { return null; }
    ...
    private android.graphics.HardwareRenderer.FrameCompleteCallback createFrameCompleteCallback(android.os.Handler p0, boolean p1, java.util.ArrayList<java.lang.Runnable> p2) { return null; }
    public boolean isHardwareEnabled() { return false; }
    private boolean addFrameCompleteCallbackIfNeeded() { return false; }
    ...
    private void updateColorModeIfNeeded(int p0) {}
    ...
    private void updateOpacity(android.view.WindowManager.LayoutParams p0, boolean p1) {}
    ...
    private void dispatchResized(android.window.ClientWindowFrames p0, boolean p1, android.util.MergedConfiguration p2, boolean p3, boolean p4, int p5) {}
    private void dispatchInsetsChanged(android.view.InsetsState p0, boolean p1, boolean p2) {}
    private void dispatchInsetsControlChanged(android.view.InsetsState p0, android.view.InsetsSourceControl[] p1, boolean p2, boolean p3) {}
    ...
    int getSurfaceTransformHint() { return 0; }
