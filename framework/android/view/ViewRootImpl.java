...
public final class ViewRootImpl implements android.view.ViewParent, android.view.View.AttachInfo.Callbacks, android.view.ThreadedRenderer.DrawCallbacks, android.view.AttachedSurfaceControl {
    ...
    public static final boolean CLIENT_IMMERSIVE_CONFIRMATION = Boolean.valueOf(false);
    ...
    public void notifyInsetsAnimationRunningStateChanged(boolean p0) {}
    ...
    void processingBackKey(boolean p0) {}
    ...
    static class W extends android.view.IWindow.Stub implements android.app.servertransaction.WindowStateTransactionItem.TransactionListener {
        W(android.view.ViewRootImpl p0) { super(); }
        public void onExecutingWindowStateTransactionItem() {}
        public void resized(android.window.ClientWindowFrames p0, boolean p1, android.util.MergedConfiguration p2, android.view.InsetsState p3, boolean p4, boolean p5, int p6, int p7, boolean p8, android.window.ActivityWindowInfo p9) {}
