...
public final class ViewRootImpl implements android.view.ViewParent, android.view.View.AttachInfo.Callbacks, android.view.ThreadedRenderer.DrawCallbacks, android.view.AttachedSurfaceControl {
    ...
    public final android.window.SurfaceSyncer.SyncTarget mSyncTarget = null;
    ...
    void addToSync(android.window.SurfaceSyncer.SyncTarget p0) {}
    public boolean isInLocalSync() { return false; }
    ...
    void mergeSync(int p0, android.window.SurfaceSyncer p1) {}
    ...
    public static interface SurfaceChangedCallback {
        ...
        default public void surfaceSyncStarted() {}
    }
    ...
    static class W extends android.view.IWindow.Stub {
        ...
        public void resized(android.window.ClientWindowFrames p0, boolean p1, android.util.MergedConfiguration p2, android.view.InsetsState p3, boolean p4, boolean p5, int p6, int p7, int p8) {}
