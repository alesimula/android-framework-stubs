...
public final class ViewRootImpl implements android.view.ViewParent, android.view.View.AttachInfo.Callbacks, android.view.ThreadedRenderer.DrawCallbacks {
    ...
    public final android.view.Surface mBoundsSurface = null;
    ...
    final android.graphics.Rect mPendingOverscanInsets = null;
    final android.graphics.Rect mPendingVisibleInsets = null;
    final android.graphics.Rect mPendingStableInsets = null;
    final android.graphics.Rect mPendingContentInsets = null;
    final android.graphics.Rect mPendingOutsets = null;
    ...
    private android.view.InsetsState mTempInsets;
    final android.view.ViewTreeObserver.InternalInsetsInfo mLastGivenInsets = null;
    final android.graphics.Rect mDispatchContentInsets = null;
    final android.graphics.Rect mDispatchStableInsets = null;
    ...
    private final java.util.ArrayList<android.view.ViewRootImpl.WindowStoppedCallback> mWindowStoppedCallbacks = null;
    ...
    private void setTag() {}
    private boolean isInLocalFocusMode() { return false; }
    @android.annotation.UnsupportedAppUsage
    ...
    void addWindowStoppedCallback(android.view.ViewRootImpl.WindowStoppedCallback p0) {}
    void removeWindowStoppedCallback(android.view.ViewRootImpl.WindowStoppedCallback p0) {}
    void setWindowStopped(boolean p0) {}
    public void createBoundsSurface(int p0) {}
    ...
    private android.graphics.Rect ensureInsetsNonNegative(android.graphics.Rect p0, java.lang.String p1) { return null; }
    void dispatchApplyInsets(android.view.View p0) {}
    android.view.InsetsController getInsetsController() { return null; }
    ...
    public void handleDispatchSystemUiVisibilityChanged(android.view.ViewRootImpl.SystemUiVisibilityInfo p0) {}
    ...
    public void dumpGfxInfo(int[] p0) {}
    private static void getGfxInfo(android.view.View p0, int[] p1) {}
    ...
    @android.annotation.UnsupportedAppUsage
    private void dispatchResized(android.graphics.Rect p0, android.graphics.Rect p1, android.graphics.Rect p2, android.graphics.Rect p3, android.graphics.Rect p4, android.graphics.Rect p5, boolean p6, android.util.MergedConfiguration p7, android.graphics.Rect p8, boolean p9, boolean p10, int p11, android.view.DisplayCutout.ParcelableWrapper p12) {}
