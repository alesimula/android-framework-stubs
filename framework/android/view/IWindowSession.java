...
public interface IWindowSession extends android.os.IInterface {
    ...
    public void performHapticFeedbackAsync(int p0, boolean p1) throws android.os.RemoteException;
    ...
    public void grantInputChannel(int p0, android.view.SurfaceControl p1, android.view.IWindow p2, android.os.IBinder p3, int p4, int p5, int p6, int p7, android.os.IBinder p8, android.os.IBinder p9, java.lang.String p10, android.view.InputChannel p11) throws android.os.RemoteException;
    ...
    public boolean transferEmbeddedTouchFocusToHost(android.view.IWindow p0) throws android.os.RemoteException;
    ...
    public static class Default implements android.view.IWindowSession {
        ...
        public boolean transferEmbeddedTouchFocusToHost(android.view.IWindow p0) throws android.os.RemoteException { return false; }
    ...
    public static abstract class Stub extends android.os.Binder implements android.view.IWindowSession {
        ...
        static final int TRANSACTION_transferEmbeddedTouchFocusToHost = 42;
        public Stub() { super(); }
