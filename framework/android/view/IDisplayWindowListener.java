...
public interface IDisplayWindowListener extends android.os.IInterface {
    ...
    public void onDesktopModeEligibleChanged(int p0) throws android.os.RemoteException;
    ...
    public void onDisplayAnimationsDisabledChanged(int p0, boolean p1) throws android.os.RemoteException;
    ...
    public void onKeepClearAreasChanged(int p0, java.util.List<android.graphics.Rect> p1, java.util.List<android.graphics.Rect> p2) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.view.IDisplayWindowListener {
        ...
        static final int TRANSACTION_onDisplayAddSystemDecorations = 8;
        static final int TRANSACTION_onDisplayAdded = 1;
        static final int TRANSACTION_onDisplayAnimationsDisabledChanged = 10;
        static final int TRANSACTION_onDisplayConfigurationChanged = 2;
        static final int TRANSACTION_onDisplayRemoveSystemDecorations = 9;
        ...
        private static final class Proxy implements android.view.IDisplayWindowListener {
