...
public interface IWindowManager extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.view.IWindowManager {
        ...
        static final int TRANSACTION_attachWindowContextToDisplayArea = 128;
        static final int TRANSACTION_attachWindowContextToDisplayContent = 130;
        static final int TRANSACTION_attachWindowContextToWindowToken = 129;
        static final int TRANSACTION_captureDisplay = 144;
        ...
        static final int TRANSACTION_detachWindowContext = 131;
        static final int TRANSACTION_disableKeyguard = 27;
        static final int TRANSACTION_dismissKeyguard = 32;
        static final int TRANSACTION_dispatchScrollToTop = 123;
        ...
        static final int TRANSACTION_getApplicationLaunchKeyboardShortcuts = 166;
        ...
        static final int TRANSACTION_getDisplayEngagementMode = 158;
        ...
        static final int TRANSACTION_getIgnoreOrientationRequest = 167;
        static final int TRANSACTION_getImeDisplayId = 136;
        static final int TRANSACTION_getInitialDisplayDensity = 9;
        static final int TRANSACTION_getInitialDisplaySize = 5;
        static final int TRANSACTION_getLetterboxBackgroundColorInArgb = 142;
        static final int TRANSACTION_getPossibleDisplayInfo = 118;
        ...
        static final int TRANSACTION_getSupportedDisplayHashAlgorithms = 125;
        static final int TRANSACTION_getWindowContentFrameStats = 78;
        static final int TRANSACTION_getWindowInsets = 117;
        ...
        static final int TRANSACTION_holdLock = 124;
        static final int TRANSACTION_isDisplayRotationFrozen = 61;
        static final int TRANSACTION_isEligibleForDesktopMode = 106;
        ...
        static final int TRANSACTION_isLetterboxBackgroundMultiColored = 143;
        static final int TRANSACTION_isRotationFrozen = 57;
        static final int TRANSACTION_isSafeModeEnabled = 76;
        static final int TRANSACTION_isTaskSnapshotSupported = 135;
        ...
        static final int TRANSACTION_isWindowTraceEnabled = 95;
        ...
        static final int TRANSACTION_onNotificationShadeExpanded = 109;
        ...
        static final int TRANSACTION_registerCrossWindowBlurEnabledListener = 133;
        static final int TRANSACTION_registerDecorViewGestureListener = 151;
        static final int TRANSACTION_registerDisplayEngagementModeCallback = 159;
        static final int TRANSACTION_registerDisplayFoldListener = 88;
        static final int TRANSACTION_registerDisplayWindowListener = 90;
        static final int TRANSACTION_registerEngagementControlRequestConsumer = 162;
        ...
        static final int TRANSACTION_registerTaskFpsCallback = 138;
        ...
        static final int TRANSACTION_reparentWindowContextToDisplayArea = 132;
        static final int TRANSACTION_replaceContentOnDisplay = 150;
        static final int TRANSACTION_requestAppKeyboardShortcuts = 81;
        static final int TRANSACTION_requestEngagementControlState = 161;
        static final int TRANSACTION_requestImeKeyboardShortcuts = 82;
        static final int TRANSACTION_requestScrollCapture = 122;
        static final int TRANSACTION_saveWindowTraceToFile = 94;
        static final int TRANSACTION_screenCapture = 145;
        static final int TRANSACTION_screenshotWallpaper = 64;
        static final int TRANSACTION_setActiveTransactionTracing = 121;
        ...
        static final int TRANSACTION_setDisplayEngagementMode = 157;
        static final int TRANSACTION_setDisplayHashThrottlingEnabled = 127;
        ...
        static final int TRANSACTION_setGlobalDragListener = 164;
        ...
        static final int TRANSACTION_setLayerTracingFlags = 120;
        static final int TRANSACTION_setNavBarVirtualKeyHapticFeedbackEnabled = 73;
        static final int TRANSACTION_setRecentsAppBehindSystemBars = 141;
        ...
        static final int TRANSACTION_setTaskSnapshotEnabled = 137;
        ...
        static final int TRANSACTION_showGlobalActions = 119;
        static final int TRANSACTION_showStrictModeViolation = 45;
        static final int TRANSACTION_snapshotTaskForRecents = 140;
        ...
        static final int TRANSACTION_transferTouchGesture = 165;
        static final int TRANSACTION_unregisterCrossWindowBlurEnabledListener = 134;
        static final int TRANSACTION_unregisterDecorViewGestureListener = 152;
        static final int TRANSACTION_unregisterDisplayEngagementModeCallback = 160;
        ...
        static final int TRANSACTION_unregisterEngagementControlRequestConsumer = 163;
        ...
        static final int TRANSACTION_unregisterTaskFpsCallback = 139;
        ...
        static final int TRANSACTION_updateDisplayWindowAnimatingTypes = 116;
        ...
        static final int TRANSACTION_verifyDisplayHash = 126;
