...
public interface IWindowManager extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.view.IWindowManager {
        ...
        static final int TRANSACTION_requestImeKeyboardShortcuts = 81;
        ...
        static final int TRANSACTION_startTransitionTrace = 95;
        static final int TRANSACTION_stopTransitionTrace = 96;
        static final int TRANSACTION_isTransitionTraceEnabled = 97;
        ...
        static final int TRANSACTION_getDisplayImePolicy = 106;
        static final int TRANSACTION_setDisplayImePolicy = 107;
        static final int TRANSACTION_syncInputTransactions = 108;
        static final int TRANSACTION_isLayerTracing = 109;
        static final int TRANSACTION_setLayerTracing = 110;
        static final int TRANSACTION_mirrorDisplay = 111;
        static final int TRANSACTION_setDisplayWindowInsetsController = 112;
        static final int TRANSACTION_updateDisplayWindowRequestedVisibleTypes = 113;
        ...
        static final int TRANSACTION_holdLock = 120;
        static final int TRANSACTION_getSupportedDisplayHashAlgorithms = 121;
        static final int TRANSACTION_verifyDisplayHash = 122;
        static final int TRANSACTION_setDisplayHashThrottlingEnabled = 123;
        static final int TRANSACTION_attachWindowContextToDisplayArea = 124;
        static final int TRANSACTION_attachWindowContextToWindowToken = 125;
        static final int TRANSACTION_attachWindowContextToDisplayContent = 126;
        static final int TRANSACTION_detachWindowContext = 127;
        static final int TRANSACTION_registerCrossWindowBlurEnabledListener = 128;
        static final int TRANSACTION_unregisterCrossWindowBlurEnabledListener = 129;
        static final int TRANSACTION_isTaskSnapshotSupported = 130;
        static final int TRANSACTION_getImeDisplayId = 131;
        static final int TRANSACTION_setTaskSnapshotEnabled = 132;
        ...
        static final int TRANSACTION_getLetterboxBackgroundColorInArgb = 137;
        static final int TRANSACTION_isLetterboxBackgroundMultiColored = 138;
        static final int TRANSACTION_captureDisplay = 139;
        static final int TRANSACTION_isGlobalKey = 140;
        static final int TRANSACTION_addToSurfaceSyncGroup = 141;
        static final int TRANSACTION_markSurfaceSyncGroupReady = 142;
        static final int TRANSACTION_notifyScreenshotListeners = 143;
        static final int TRANSACTION_replaceContentOnDisplay = 144;
        static final int TRANSACTION_registerDecorViewGestureListener = 145;
        static final int TRANSACTION_unregisterDecorViewGestureListener = 146;
        static final int TRANSACTION_registerTrustedPresentationListener = 147;
        static final int TRANSACTION_unregisterTrustedPresentationListener = 148;
        static final int TRANSACTION_registerScreenRecordingCallback = 149;
        static final int TRANSACTION_unregisterScreenRecordingCallback = 150;
        static final int TRANSACTION_setGlobalDragListener = 151;
        static final int TRANSACTION_transferTouchGesture = 152;
