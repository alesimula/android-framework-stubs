...
public interface WindowManager extends android.view.ViewManager {
    ...
    @android.annotation.FlaggedApi("com.android.window.flags.app_compat_properties_api")
    ...
    @android.annotation.FlaggedApi("com.android.window.flags.enable_camera_compat_for_desktop_windowing_opt_out_api")
    ...
    @android.annotation.FlaggedApi("com.android.window.flags.supports_multi_instance_system_ui")
    ...
    @android.annotation.FlaggedApi("com.android.window.flags.cover_display_opt_in")
    ...
    @android.annotation.SystemApi
    @android.annotation.FlaggedApi("android.companion.virtualdevice.flags.status_bar_and_insets")
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams implements android.os.Parcelable {
        ...
        @android.view.ViewDebug.ExportedProperty(flagMapping={@android.view.ViewDebug.FlagToString(mask=2, equals=2, name="FORCE_HARDWARE_ACCELERATED"), @android.view.ViewDebug.FlagToString(mask=4, equals=4, name="WANTS_OFFSET_NOTIFICATIONS"), @android.view.ViewDebug.FlagToString(mask=16, equals=16, name="SHOW_FOR_ALL_USERS"), @android.view.ViewDebug.FlagToString(mask=32, equals=32, name="UNRESTRICTED_GESTURE_EXCLUSION"), @android.view.ViewDebug.FlagToString(mask=64, equals=64, name="NO_MOVE_ANIMATION"), @android.view.ViewDebug.FlagToString(mask=256, equals=256, name="SYSTEM_ERROR"), @android.view.ViewDebug.FlagToString(mask=512, equals=512, name="OPTIMIZE_MEASURE"), @android.view.ViewDebug.FlagToString(mask=1024, equals=1024, name="DISABLE_WALLPAPER_TOUCH_EVENTS"), @android.view.ViewDebug.FlagToString(mask=2048, equals=2048, name="EDGE_TO_EDGE_ENFORCED"), @android.view.ViewDebug.FlagToString(mask=4096, equals=4096, name="LAYOUT_SIZE_EXTENDED_BY_CUTOUT"), @android.view.ViewDebug.FlagToString(mask=8192, equals=8192, name="FORCE_DECOR_VIEW_VISIBILITY"), @android.view.ViewDebug.FlagToString(mask=16384, equals=16384, name="LAYOUT_CHILD_WINDOW_IN_PARENT_FRAME"), @android.view.ViewDebug.FlagToString(mask=32768, equals=32768, name="FORCE_DRAW_STATUS_BAR_BACKGROUND"), @android.view.ViewDebug.FlagToString(mask=65536, equals=65536, name="SUSTAINED_PERFORMANCE_MODE"), @android.view.ViewDebug.FlagToString(mask=131072, equals=131072, name="IMMERSIVE_CONFIRMATION_WINDOW"), @android.view.ViewDebug.FlagToString(mask=262144, equals=262144, name="OVERRIDE_LAYOUT_IN_DISPLAY_CUTOUT_MODE"), @android.view.ViewDebug.FlagToString(mask=524288, equals=524288, name="HIDE_NON_SYSTEM_OVERLAY_WINDOWS"), @android.view.ViewDebug.FlagToString(mask=1048576, equals=1048576, name="IS_ROUNDED_CORNERS_OVERLAY"), @android.view.ViewDebug.FlagToString(mask=2097152, equals=2097152, name="EXCLUDE_FROM_SCREEN_MAGNIFICATION"), @android.view.ViewDebug.FlagToString(mask=134217728, equals=134217728, name="INPUT_METHOD_WINDOW"), @android.view.ViewDebug.FlagToString(mask=4194304, equals=4194304, name="NOT_MAGNIFIABLE"), @android.view.ViewDebug.FlagToString(mask=16777216, equals=16777216, name="COLOR_SPACE_AGNOSTIC"), @android.view.ViewDebug.FlagToString(mask=33554432, equals=33554432, name="CONSUME_IME_INSETS"), @android.view.ViewDebug.FlagToString(mask=67108864, equals=67108864, name="OPTOUT_EDGE_TO_EDGE"), @android.view.ViewDebug.FlagToString(mask=268435456, equals=268435456, name="FIT_INSETS_CONTROLLED"), @android.view.ViewDebug.FlagToString(mask=536870912, equals=536870912, name="TRUSTED_OVERLAY"), @android.view.ViewDebug.FlagToString(mask=1073741824, equals=1073741824, name="INSET_PARENT_FRAME_BY_IME"), @android.view.ViewDebug.FlagToString(mask=-2147483648, equals=-2147483648, name="INTERCEPT_GLOBAL_DRAG_AND_DROP"), @android.view.ViewDebug.FlagToString(mask=8, equals=8, name="SYSTEM_APPLICATION_OVERLAY")})
