...
public abstract class ViewGroup extends android.view.View implements android.view.ViewParent, android.view.ViewManager {
    ...
    @android.annotation.UnsupportedAppUsage(maxTargetSdk=28, trackingBug=123768704L)
    ...
    @android.annotation.UnsupportedAppUsage(maxTargetSdk=28, trackingBug=123769411L)
    ...
    @android.annotation.UnsupportedAppUsage(maxTargetSdk=28, trackingBug=123769377L)
    protected static final int FLAG_USE_CHILD_DRAWING_ORDER = 1024;
    @android.annotation.UnsupportedAppUsage(maxTargetSdk=28, trackingBug=123769647L)
    ...
    @android.annotation.UnsupportedAppUsage(maxTargetSdk=28, trackingBug=123983692L)
    ...
    private float[] getTempPoint() { return null; }
    @android.annotation.UnsupportedAppUsage
