...
public final class Display {
    ...
    private java.util.Optional<java.lang.Boolean> mIsRecentsComponent;
    ...
    boolean isRecentsComponent() { return false; }
    ...
    public static final class Mode implements android.os.Parcelable {
        ...
        public Mode(int p0, int p1, int p2, float p3, float[] p4) {}
