...
public final class Choreographer {
    ...
    void doCallbacks(int p0, android.view.Choreographer.FrameData p1, long p2) {}
    ...
    public static class FrameData {
        static final android.view.Choreographer.FrameTimeline[] INVALID_FRAME_TIMELINES = null;
        FrameData() {}
        FrameData(long p0, android.view.DisplayEventReceiver.VsyncEventData p1) {}
        void updateFrameData(long p0) {}
        public long getFrameTimeNanos() { return 0L; }
    ...
    public static class FrameTimeline {
        static final android.view.Choreographer.FrameTimeline INVALID_FRAME_TIMELINE = null;
