...
public class InsetsState implements android.os.Parcelable {
    ...
    private final android.view.InsetsSource[] mSources = null;
    ...
    private android.view.RoundedCorners calculateRelativeRoundedCorners(android.graphics.Rect p0) { return null; }
    private android.view.PrivacyIndicatorBounds calculateRelativePrivacyIndicatorBounds(android.graphics.Rect p0) { return null; }
    public android.graphics.Rect calculateInsets(android.graphics.Rect p0, int p1, boolean p2) { return null; }
    ...
    public static boolean clearCompatInsets(int p0, int p1, int p2) { return false; }
    ...
    public java.lang.String toSourceVisibilityString() { return null; }
