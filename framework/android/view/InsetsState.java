...
public class InsetsState implements android.os.Parcelable {
    ...
    public android.view.WindowInsets calculateInsets(android.graphics.Rect p0, android.view.InsetsState p1, boolean p2, int p3, int p4, int p5, int p6, int p7, android.util.SparseIntArray p8) { return null; }
