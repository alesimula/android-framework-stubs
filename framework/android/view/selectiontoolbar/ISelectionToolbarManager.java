...
public interface ISelectionToolbarManager extends android.os.IInterface {
    ...
    public void showToolbar(android.view.selectiontoolbar.ShowInfo p0, android.view.selectiontoolbar.ISelectionToolbarCallback p1, int p2) throws android.os.RemoteException;
    public void hideToolbar(long p0, int p1) throws android.os.RemoteException;
    public void dismissToolbar(long p0, int p1) throws android.os.RemoteException;
