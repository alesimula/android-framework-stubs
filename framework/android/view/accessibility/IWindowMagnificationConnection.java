...
public interface IWindowMagnificationConnection extends android.os.IInterface {
    public void enableWindowMagnification(int p0, float p1, float p2, float p3) throws android.os.RemoteException;
    public void setScale(int p0, float p1) throws android.os.RemoteException;
    public void disableWindowMagnification(int p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.view.accessibility.IWindowMagnificationConnection {
        private static final java.lang.String DESCRIPTOR = "android.view.accessibility.IWindowMagnificationConnection";
        ...
        public static boolean setDefaultImpl(android.view.accessibility.IWindowMagnificationConnection p0) { return false; }
        public static android.view.accessibility.IWindowMagnificationConnection getDefaultImpl() { return null; }

        private static class Proxy implements android.view.accessibility.IWindowMagnificationConnection {
            private android.os.IBinder mRemote;
            public static android.view.accessibility.IWindowMagnificationConnection sDefaultImpl;
