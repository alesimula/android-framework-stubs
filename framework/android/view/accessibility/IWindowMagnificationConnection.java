...
public interface IWindowMagnificationConnection extends android.os.IInterface {
    ...
    public void enableWindowMagnification(int p0, float p1, float p2, float p3, android.view.accessibility.IRemoteMagnificationAnimationCallback p4) throws android.os.RemoteException;
