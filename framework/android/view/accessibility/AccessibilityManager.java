...
public final class AccessibilityManager {
    ...
    private final android.util.ArrayMap<android.view.accessibility.AccessibilityManager.HighContrastTextStateChangeListener, java.util.concurrent.Executor> mHighContrastTextStateChangeListeners = null;
    ...
    private final android.util.ArrayMap<android.view.accessibility.AccessibilityManager.AccessibilityServicesStateChangeListener, java.util.concurrent.Executor> mServicesStateChangeListeners = null;
    ...
    private void updateAccessibilityTracingState(int p0) {}
    ...
    public boolean isAccessibilityServiceTargetAllowed(android.accessibilityservice.AccessibilityServiceInfo p0, int p1) { return false; }
    ...
    public boolean sendRestrictedDialogIntent(android.accessibilityservice.AccessibilityServiceInfo p0, int p1) { return false; }
