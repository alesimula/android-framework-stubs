...
public class AccessibilityNodeInfo implements android.os.Parcelable {
    ...
    @android.annotation.FlaggedApi("android.view.accessibility.a11y_selection_api")
    ...
    @android.annotation.FlaggedApi("android.view.accessibility.a11y_expansion_state_api")
    ...
    @android.annotation.FlaggedApi("android.view.accessibility.a11y_character_in_window_api")
    ...
    @android.annotation.FlaggedApi("android.view.accessibility.tri_state_checked")
    ...
    @android.annotation.FlaggedApi("android.view.accessibility.a11y_is_required_api")
    ...
    @android.annotation.FlaggedApi("android.view.accessibility.supplemental_description")
    @android.annotation.Nullable
    ...
    @java.lang.Deprecated
    @android.annotation.FlaggedApi("android.view.accessibility.deprecate_ani_label_for_apis")
    ...
    @android.annotation.FlaggedApi("android.view.accessibility.support_multiple_labeledby")
    ...
    public static final class CollectionItemInfo {
        @android.annotation.FlaggedApi("android.view.accessibility.a11y_sort_direction_api")
    ...
    public static final class RangeInfo {
        ...
        @android.annotation.FlaggedApi("android.view.accessibility.indeterminate_range_info")
