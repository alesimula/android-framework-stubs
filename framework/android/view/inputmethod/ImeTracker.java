...
public interface ImeTracker {
    ...
    public static final int ORIGIN_SHELL = 8;
    ...
    public static final int PHASE_CLIENT_INSETS_CONTROLLER_DISPATCH = 80;
    ...
    public static final int PHASE_IME_NOTIFY_IME_VISIBILITY_CHANGED = 52;
    ...
    public static final int PHASE_SERVER_ABORT_SHOW_IME_POST_LAYOUT = 43;
    ...
    public static final int PHASE_SERVER_DISPATCH_IME_REQUESTED_CHANGED = 60;
    public static final int PHASE_SERVER_GET_CONTROL_WITH_LEASH = 55;
    ...
    public static final int PHASE_SERVER_INVOKING_IME_REQUESTED_LISTENER = 64;
    public static final int PHASE_SERVER_NOTIFY_HIDE_ANIMATION_FINISHED = 74;
    public static final int PHASE_SERVER_NOTIFY_IME_VISIBILITY_CHANGED_FROM_CLIENT = 62;
    public static final int PHASE_SERVER_NO_IME_INSETS_SOURCE_PROVIDER = 81;
    public static final int PHASE_SERVER_POSTING_CHANGED_IME_VISIBILITY = 63;
    public static final int PHASE_SERVER_POST_LAYOUT_NOTIFY_CONTROLS_CHANGED = 50;
    public static final int PHASE_SERVER_REMOTE_INSETS_CONTROL_TARGET_SHOW_INSETS = 23;
    public static final int PHASE_SERVER_REQUESTED_VISIBLE_TYPES_NOT_CHANGED = 70;
    public static final int PHASE_SERVER_SET_REMOTE_TARGET_IME_VISIBILITY = 49;
    ...
    public static final int PHASE_SERVER_UPDATE_ANIMATING_TYPES = 72;
    public static final int PHASE_SERVER_UPDATE_CLIENT_VISIBILITY = 67;
    public static final int PHASE_SERVER_UPDATE_DISPLAY_WINDOW_ANIMATING_TYPES = 75;
    public static final int PHASE_SERVER_UPDATE_DISPLAY_WINDOW_REQUESTED_VISIBLE_TYPES = 69;
    public static final int PHASE_SERVER_UPDATE_REQUESTED_VISIBLE_TYPES = 56;
    public static final int PHASE_SERVER_WAIT_IME = 8;
    public static final int PHASE_SERVER_WINDOW_ANIMATING_TYPES_CHANGED = 73;
    public static final int PHASE_SERVER_WINDOW_INSETS_CONTROL_TARGET_HIDE_INSETS = 22;
    public static final int PHASE_SERVER_WINDOW_INSETS_CONTROL_TARGET_SHOW_INSETS = 21;
    public static final int PHASE_SHELL_ANIMATION_CREATE = 26;
    public static final int PHASE_SHELL_ANIMATION_RUNNING = 27;
    ...
    public static final class ImeLatencyTracker {
        ...
        private boolean shouldMonitorLatency(int p0) { return false; }
    ...
    public static final class Token implements android.os.Parcelable {
        ...
        public Token(long p0, java.lang.String p1) {}
        private Token(android.os.Parcel p0) {}
        private static java.lang.String createTag(java.lang.String p0) { return null; }
        private static android.view.inputmethod.ImeTracker.Token createToken(java.lang.String p0) { return null; }
