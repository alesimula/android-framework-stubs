...
public final class CursorAnchorInfo implements android.os.Parcelable {
    ...
    private CursorAnchorInfo(int p0, int p1, int p2, java.lang.CharSequence p3, int p4, float p5, float p6, float p7, float p8, android.view.inputmethod.SparseRectFArray p9, float[] p10) {}
