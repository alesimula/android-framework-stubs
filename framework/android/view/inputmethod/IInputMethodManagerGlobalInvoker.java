...
final class IInputMethodManagerGlobalInvoker {
    ...
    static void removeImeSurface(java.util.function.Consumer<android.os.RemoteException> p0) {}
    ...
    static boolean showSoftInput(com.android.internal.inputmethod.IInputMethodClient p0, android.os.IBinder p1, android.view.inputmethod.ImeTracker.Token p2, int p3, int p4, android.os.ResultReceiver p5, int p6) { return false; }
    static boolean hideSoftInput(com.android.internal.inputmethod.IInputMethodClient p0, android.os.IBinder p1, android.view.inputmethod.ImeTracker.Token p2, int p3, android.os.ResultReceiver p4, int p5) { return false; }
    @android.annotation.RequiresPermission(value="android.permission.INTERACT_ACROSS_USERS_FULL", conditional=true)
    static com.android.internal.inputmethod.InputBindResult startInputOrWindowGainedFocus(int p0, com.android.internal.inputmethod.IInputMethodClient p1, android.os.IBinder p2, int p3, int p4, int p5, android.view.inputmethod.EditorInfo p6, com.android.internal.inputmethod.IRemoteInputConnection p7, com.android.internal.inputmethod.IRemoteAccessibilityInputConnection p8, int p9, int p10, android.window.ImeOnBackInvokedDispatcher p11) { return null; }
    ...
    static void reportVirtualDisplayGeometryAsync(com.android.internal.inputmethod.IInputMethodClient p0, int p1, float[] p2) {}
    ...
    static boolean acceptStylusHandwritingDelegation(com.android.internal.inputmethod.IInputMethodClient p0, int p1, java.lang.String p2, java.lang.String p3) { return false; }
    @android.annotation.RequiresPermission(value="android.permission.INTERACT_ACROSS_USERS_FULL", conditional=true)
    static boolean isStylusHandwritingAvailableAsUser(int p0) { return false; }
    @android.annotation.RequiresPermission("android.permission.TEST_INPUT_METHOD")
    ...
    static android.view.inputmethod.ImeTracker.Token onRequestShow(java.lang.String p0, int p1, int p2, int p3) { return null; }
    static android.view.inputmethod.ImeTracker.Token onRequestHide(java.lang.String p0, int p1, int p2, int p3) { return null; }
