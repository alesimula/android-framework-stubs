...
public class InsetsController implements android.view.WindowInsetsController, android.view.InsetsAnimationControlCallbacks, android.view.InsetsAnimationControlRunner.SurfaceParamsApplier {
    ...
    public static class InternalAnimationControlListener implements android.view.WindowInsetsAnimationControlListener, android.view.InsetsAnimationSpec {
    ...
    private static class PendingControlRequest {
        ...
        PendingControlRequest(int p0, android.view.WindowInsetsAnimationControlListener p1, android.view.InsetsAnimationSpec p2, int p3, int p4, android.os.CancellationSignal p5, boolean p6) {}
    }
