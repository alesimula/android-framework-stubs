...
public class InsetsController implements android.view.WindowInsetsController, android.view.InsetsAnimationControlCallbacks {
    ...
    public static final android.view.animation.Interpolator SYSTEM_BARS_INTERPOLATOR = null;
    ...
    private final java.util.ArrayList<android.view.WindowInsetsAnimation> mTmpRunningAnims = null;
    private final java.util.List<android.view.WindowInsetsAnimation> mUnmodifiableTmpRunningAnims = null;
    ...
    public android.view.WindowInsets calculateInsets(boolean p0, boolean p1, android.view.DisplayCutout p2, int p3, int p4, int p5) { return null; }
    ...
    private void hideDirectly(int p0, boolean p1, int p2) {}
    ...
    public static class InternalAnimationControlListener implements android.view.WindowInsetsAnimationControlListener {
        ...
        public InternalAnimationControlListener(boolean p0, boolean p1, int p2, boolean p3, int p4) {}
        ...
        android.view.animation.Interpolator getInterpolator() { return null; }
