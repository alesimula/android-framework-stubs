...
public class InsetsController implements android.view.WindowInsetsController, android.view.InsetsAnimationControlCallbacks {
    ...
    public InsetsController(android.view.InsetsController.Host p0, com.android.internal.util.function.TriFunction<android.view.InsetsController, java.lang.Integer, java.lang.Integer, android.view.InsetsSourceConsumer> p1, android.os.Handler p2) {}
    ...
    boolean isPredictiveBackImeHideAnimInProgress() { return false; }
    public void show(int p0) {}
    public void show(int p0, boolean p1, android.view.inputmethod.ImeTracker.Token p2) {}
    public void hide(int p0) {}
    public void hide(int p0, boolean p1, android.view.inputmethod.ImeTracker.Token p2) {}
    ...
    public void controlWindowInsetsAnimation(int p0, android.os.CancellationSignal p1, android.view.WindowInsetsAnimationControlListener p2, boolean p3, long p4, android.view.animation.Interpolator p5, int p6, boolean p7) {}
    ...
    public android.view.InsetsSourceConsumer getSourceConsumer(int p0, int p1) { return null; }
    @android.annotation.NonNull
    ...
    public static interface Host {
        ...
        default public void notifyAnimationRunningStateChanged(boolean p0) {}
    ...
    public static class InternalAnimationControlListener implements android.view.WindowInsetsAnimationControlListener {
        public InternalAnimationControlListener(boolean p0, boolean p1, int p2, int p3, boolean p4, int p5, android.view.WindowInsetsAnimationControlListener p6, android.view.inputmethod.ImeTracker.InputMethodJankContext p7) {}
