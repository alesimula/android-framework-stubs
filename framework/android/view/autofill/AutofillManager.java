...
public final class AutofillManager {
    ...
    private void authenticate(int p0, int p1, android.content.IntentSender p2, android.content.Intent p3) {}
    ...
    private void setAutofilledIfValuesIs(android.view.View p0, android.view.autofill.AutofillValue p1) {}
    private void autofill(int p0, java.util.List<android.view.autofill.AutofillId> p1, java.util.List<android.view.autofill.AutofillValue> p2) {}
    ...
    private static final class AutofillManagerClient extends android.view.autofill.IAutoFillManagerClient.Stub {
        ...
        public void autofill(int p0, java.util.List<android.view.autofill.AutofillId> p1, java.util.List<android.view.autofill.AutofillValue> p2) {}
        public void authenticate(int p0, int p1, android.content.IntentSender p2, android.content.Intent p3) {}
    ...
    public static interface AutofillClient {
        public void autofillClientAuthenticate(int p0, android.content.IntentSender p1, android.content.Intent p2);
