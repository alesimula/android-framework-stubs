...
public interface IAutoFillManager extends android.os.IInterface {
    ...
    public void autofillRemoteApp(android.os.IBinder p0, int p1, android.view.autofill.AutofillId p2, android.view.autofill.AutofillValue p3, int p4) throws android.os.RemoteException;
    ...
    public void getNoiseInjectionMasterSeed(com.android.internal.os.IResultReceiver p0) throws android.os.RemoteException;
    ...
    public void notifyImeAnimationEnd(int p0, long p1, int p2) throws android.os.RemoteException;
    public void notifyImeAnimationStart(int p0, long p1, int p2) throws android.os.RemoteException;
    public void notifyNotExpiringResponseDuringAuth(int p0, int p1) throws android.os.RemoteException;
    public void notifySystemInlineSuggestions(int p0, java.util.List<android.service.autofill.Dataset> p1, int p2) throws android.os.RemoteException;
    public void notifyViewEnteredIgnoredDuringAuthCount(int p0, int p1) throws android.os.RemoteException;
    ...
    public void setAutofillFailure(int p0, java.util.List<android.view.autofill.AutofillId> p1, boolean p2, int p3) throws android.os.RemoteException;
    public void setAutofillIdsAttemptedForRefill(int p0, java.util.List<android.view.autofill.AutofillId> p1, int p2) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.view.autofill.IAutoFillManager {
        ...
        static final int TRANSACTION_autofillRemoteApp = 31;
        ...
        static final int TRANSACTION_getNoiseInjectionMasterSeed = 32;
        ...
        static final int TRANSACTION_notifySystemInlineSuggestions = 30;
        ...
        private static final class Proxy implements android.view.autofill.IAutoFillManager {
