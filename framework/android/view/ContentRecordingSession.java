...
public final class ContentRecordingSession implements android.os.Parcelable {
    ...
    public static android.view.ContentRecordingSession createOverlaySession(int p0, int p1) { return null; }
    ...
    ContentRecordingSession(int p0, int p1, int p2, int p3, int p4, android.os.IBinder p5, boolean p6, int p7) {}
