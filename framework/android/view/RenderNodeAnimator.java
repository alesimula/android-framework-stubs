...
public class RenderNodeAnimator extends android.animation.Animator {
    ...
    private static final android.util.SparseIntArray sViewPropertyAnimatorMap = null;
    ...
    private static java.lang.ThreadLocal<android.view.RenderNodeAnimator.DelayedAnimationHelper> sAnimationHelper;
    @android.annotation.UnsupportedAppUsage
    public static int mapViewPropertyToRenderProperty(int p0) { return 0; }
    @android.annotation.UnsupportedAppUsage
    ...
    public void setTarget(android.graphics.RecordingCanvas p0) {}
    @android.annotation.UnsupportedAppUsage
    public void setTarget(android.view.DisplayListCanvas p0) {}
    private void setTarget(android.graphics.RenderNode p0) {}
    @android.annotation.UnsupportedAppUsage
    public void setStartValue(float p0) {}
    public void setStartDelay(long p0) {}
    public long getStartDelay() { return 0L; }
    @android.annotation.UnsupportedAppUsage
    public android.view.RenderNodeAnimator setDuration(long p0) { return null; }
    ...
    private static android.view.RenderNodeAnimator.DelayedAnimationHelper getHelper() { return null; }
    @android.annotation.UnsupportedAppUsage
    private static void callOnFinished(android.view.RenderNodeAnimator p0) {}
    ...
    private static native void nSetListener(long p0, android.view.RenderNodeAnimator p1);
    ...
    private static class DelayedAnimationHelper implements java.lang.Runnable {
        private java.util.ArrayList<android.view.RenderNodeAnimator> mDelayedAnims;
        private final android.view.Choreographer mChoreographer = null;
        private boolean mCallbackScheduled;
        public DelayedAnimationHelper() {}
        public void addDelayedAnimation(android.view.RenderNodeAnimator p0) {}
        public void removeDelayedAnimation(android.view.RenderNodeAnimator p0) {}
