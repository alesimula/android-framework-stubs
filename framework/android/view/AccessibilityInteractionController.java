...
public final class AccessibilityInteractionController {
    ...
    public void attachAccessibilityOverlayToWindowClientThread(android.view.SurfaceControl p0) {}
    ...
    private abstract class PrefetchDeque<E extends android.view.AccessibilityInteractionController.DequeNode> extends java.util.ArrayDeque<E> {
        int mStrategy;
