...
public final class AccessibilityInteractionController {
    ...
    private void updateInfosForViewPort(java.util.List<android.view.accessibility.AccessibilityNodeInfo> p0, android.view.MagnificationSpec p1, android.graphics.Region p2) {}
    private void updateInfoForViewPort(android.view.accessibility.AccessibilityNodeInfo p0, android.view.MagnificationSpec p1, android.graphics.Region p2) {}
    ...
    private class AccessibilityNodePrefetcher {
        ...
        public void prefetchAccessibilityNodeInfos(android.view.View p0, android.view.accessibility.AccessibilityNodeInfo p1, int p2, int p3, java.util.List<android.view.accessibility.AccessibilityNodeInfo> p4) {}
        private boolean shouldStopPrefetching(java.util.List p0) { return false; }
