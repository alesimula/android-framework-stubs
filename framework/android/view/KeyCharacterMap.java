...
public class KeyCharacterMap implements android.os.Parcelable {
    ...
    private static final int ACCENT_CIRCUMFLEX_FALLBACK = 94;
    ...
    private static final int ACCENT_GRAVE_FALLBACK = 96;
    ...
    private static final int ACCENT_TILDE_FALLBACK = 126;
    ...
    private static final android.util.SparseIntArray sAccentToFallback = null;
    ...
    private static void addCombining(int p0, int p1, int p2) {}
    ...
    public static int getCombiningChar(int p0) { return 0; }
    public static int getDeadChar(int p0, int p1) { return 0; }
    public static android.view.KeyCharacterMap load(int p0) { return null; }
    public static android.view.KeyCharacterMap load(java.lang.String p0, java.lang.String p1) { return null; }
    ...
    private static native int nativeGetMappedKey(long p0, int p1);
    ...
    private static native android.view.KeyCharacterMap nativeObtainEmptyKeyCharacterMap(int p0);
    private static native android.view.KeyCharacterMap nativeObtainMapWithOverlay(long p0, java.lang.String p1, java.lang.String p2);
    ...
    public int getMappedKeyOrDefault(int p0, int p1) { return 0; }
