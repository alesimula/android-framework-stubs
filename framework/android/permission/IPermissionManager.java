...
public interface IPermissionManager extends android.os.IInterface {
    ...
    public int getPermissionRequestState(java.lang.String p0, java.lang.String p1, int p2) throws android.os.RemoteException;
    public int getRegisteredAttributionSourceCount(int p0) throws android.os.RemoteException;
    public java.util.List<android.content.pm.permission.SplitPermissionInfoParcelable> getSplitPermissions(boolean p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.permission.IPermissionManager {
        ...
        private static final class Proxy implements android.permission.IPermissionManager {
