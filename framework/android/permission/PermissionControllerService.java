...
public abstract class PermissionControllerService extends android.app.Service {
    ...
    public void onOneTimePermissionSessionTimeout(java.lang.String p0, int p1) {}
    ...
    @java.lang.Deprecated
    public void onRevokeSelfPermissionsOnKill(java.lang.String p0, java.util.List<java.lang.String> p1, java.lang.Runnable p2) {}
    @android.annotation.FlaggedApi("android.permission.flags.device_aware_permission_apis_enabled")
    public void onRevokeSelfPermissionsOnKill(java.lang.String p0, java.util.List<java.lang.String> p1, int p2, java.lang.Runnable p3) {}
    @java.lang.Deprecated
    @android.annotation.SystemApi
    ...
    @android.annotation.NonNull
    public void onGetUnusedAppCount(java.util.function.IntConsumer p0) {}
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission("android.permission.MANAGE_APP_HIBERNATION")
    public void onGetHibernationEligibility(java.lang.String p0, java.util.function.IntConsumer p1) {}
    @android.annotation.NonNull
