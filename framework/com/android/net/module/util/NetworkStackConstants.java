...
public final class NetworkStackConstants {
    public static final java.net.Inet6Address ALL_DHCP_RELAY_AGENTS_AND_SERVERS = null;
    ...
    public static final int ETHER_TYPE_WAKE_ON_LAN = 2114;
    ...
    public static final java.net.Inet4Address IPV4_ADDR_ALL = null;
    public static final java.net.Inet4Address IPV4_ADDR_ALL_HOST_MULTICAST = null;
    public static final java.net.Inet4Address IPV4_ADDR_ANY = null;
    ...
    public static final java.util.List<android.net.IpPrefix> IPV4_LOCAL_PREFIXES = null;
    ...
    public static final java.net.Inet6Address IPV6_ADDR_ALL_HOSTS_MULTICAST = null;
    public static final java.net.Inet6Address IPV6_ADDR_ALL_NODES_MULTICAST = null;
    public static final java.net.Inet6Address IPV6_ADDR_ALL_ROUTERS_MULTICAST = null;
    public static final java.net.Inet6Address IPV6_ADDR_ANY = null;
    public static final int IPV6_ADDR_LEN = 16;
    public static final java.net.Inet6Address IPV6_ADDR_NODE_LOCAL_ALL_NODES_MULTICAST = null;
    ...
    public static final java.util.List<android.net.IpPrefix> MULTICAST_AND_BROADCAST_PREFIXES = null;
    public static final int NEIGHBOR_ADVERTISEMENT_FLAG_OVERRIDE = 536870912;
    public static final int NEIGHBOR_ADVERTISEMENT_FLAG_ROUTER = -2147483648;
    ...
    public static final int TCPHDR_ACK = 16;
    public static final int TCPHDR_AE = 256;
    public static final int TCPHDR_CWR = 128;
    public static final int TCPHDR_DOFF_MASK = 61440;
    public static final int TCPHDR_ECE = 64;
    public static final int TCPHDR_FIN = 1;
    public static final int TCPHDR_FLAGS_MASK = 4095;
    public static final int TCPHDR_PSH = 8;
    public static final int TCPHDR_RST = 4;
    public static final int TCPHDR_SYN = 2;
    public static final int TCPHDR_SYNACK = 18;
    public static final int TCPHDR_URG = 32;
    public static final int TCP_CHECKSUM_OFFSET = 16;
    public static final int TCP_HEADER_MIN_LEN = 20;
    public static final java.lang.String TEST_CAPTIVE_PORTAL_FALLBACK_URL = "test_captive_portal_fallback_url";
    ...
    private static java.net.Inet4Address makeInet4Address(byte p0, byte p1, byte p2, byte p3) { return null; }
    private static java.net.Inet6Address makeInet6Address(byte[] p0) { return null; }
}
