...
public interface IImsServiceFeatureCallback extends android.os.IInterface {
    public void imsFeatureCreated(int p0, int p1) throws android.os.RemoteException;
    public void imsFeatureRemoved(int p0, int p1) throws android.os.RemoteException;
    public void imsStatusChanged(int p0, int p1, int p2) throws android.os.RemoteException;
