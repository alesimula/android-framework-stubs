...
public class ChooserActivity extends com.android.internal.app.ResolverActivity implements com.android.internal.app.ChooserListAdapter.ChooserListCommunicator, com.android.internal.app.chooser.SelectableTargetInfo.SelectableTargetInfoCommunicator {
    ...
    private boolean mChooserTargetRankingEnabled;
    ...
    private android.content.ComponentName getNearbySharingComponent() { return null; }
    private com.android.internal.app.chooser.TargetInfo getNearbySharingTarget(android.content.Intent p0) { return null; }
    ...
    private java.util.List<com.android.internal.app.chooser.DisplayResolveInfo> getDisplayResolveInfos(com.android.internal.app.ChooserListAdapter p0) { return null; }
    ...
    private void sendChooserTargetRankingScore(java.util.List<android.app.prediction.AppTarget> p0, android.os.UserHandle p1) {}
    private void sendShareShortcutInfoList(java.util.List<android.content.pm.ShortcutManager.ShareShortcutInfo> p0, java.util.List<com.android.internal.app.chooser.DisplayResolveInfo> p1, java.util.List<android.app.prediction.AppTarget> p2, android.os.UserHandle p3) {}
    ...
    private class ChooserHandler extends android.os.Handler {
        ...
        private int mDirectShareTimeout;
    ...
    static final class EmptyTargetInfo extends com.android.internal.app.chooser.NotSelectableTargetInfo {
        EmptyTargetInfo() { super(); }
