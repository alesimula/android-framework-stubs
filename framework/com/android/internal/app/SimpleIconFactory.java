...
public class SimpleIconFactory {
    ...
    private static boolean sPoolEnabled;
    ...
    private android.graphics.Bitmap createIconBitmap(android.graphics.drawable.Drawable p0, float p1, int p2, boolean p3, boolean p4) { return null; }
    private android.graphics.Bitmap createIconBitmapNoInsetOrMask(android.graphics.drawable.Drawable p0, float p1) { return null; }
    private static int getAttrDimFromContext(android.content.Context p0, int p1, java.lang.String p2) { return 0; }
    private static int getBadgeSizeFromContext(android.content.Context p0) { return 0; }
    private static android.graphics.drawable.Drawable getFullResDefaultActivityIcon(int p0) { return null; }
    private static int getIconSizeFromContext(android.content.Context p0) { return 0; }
    private float getScale(android.graphics.drawable.Drawable p0, android.graphics.RectF p1) { return 0.0f; }
    ...
    private void recreateIcon(android.graphics.Bitmap p0, android.graphics.BlurMaskFilter p1, int p2, int p3, android.graphics.Canvas p4) {}
    private void recreateIcon(android.graphics.Bitmap p0, android.graphics.Canvas p1) {}
    public static void setPoolEnabled(boolean p0) {}
    @java.lang.Deprecated
