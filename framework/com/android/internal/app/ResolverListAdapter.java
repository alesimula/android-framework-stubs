...
public class ResolverListAdapter extends android.widget.BaseAdapter {
    ...
    private final java.util.Map<com.android.internal.app.chooser.DisplayResolveInfo, com.android.internal.app.ResolverListAdapter.LoadIconTask> mIconLoaders = null;
    ...
    private final java.util.Map<com.android.internal.app.chooser.DisplayResolveInfo, com.android.internal.app.ResolverListAdapter.LoadLabelTask> mLabelLoaders = null;
    ...
    private <T extends android.os.AsyncTask> void cancelTasks(java.util.Collection<T> p0) {}
    private static com.android.internal.app.ResolverActivity.ResolvedComponentInfo getFirstNonCurrentUserResolvedComponentInfo(java.util.List<com.android.internal.app.ResolverActivity.ResolvedComponentInfo> p0) { return null; }
    private static android.graphics.ColorMatrixColorFilter getSuspendedColorMatrix() { return null; }
    private void loadLabel(com.android.internal.app.chooser.DisplayResolveInfo p0) {}
    private static com.android.internal.app.chooser.DisplayResolveInfo makeOtherProfileDisplayResolveInfo(android.content.Context p0, com.android.internal.app.ResolverActivity.ResolvedComponentInfo p1, android.content.pm.PackageManager p2, com.android.internal.app.ResolverListAdapter.ResolverListCommunicator p3, int p4) { return null; }
