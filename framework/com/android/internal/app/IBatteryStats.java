...
public interface IBatteryStats extends android.os.IInterface {
    ...
    public void noteJobStart(java.lang.String p0, int p1, int p2, int p3) throws android.os.RemoteException;
    public void noteJobFinish(java.lang.String p0, int p1, int p2, int p3, int p4) throws android.os.RemoteException;
    ...
    public void notePhoneDataConnectionState(int p0, boolean p1) throws android.os.RemoteException;
    ...
    public void setBatteryState(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7) throws android.os.RemoteException;
    @android.annotation.UnsupportedAppUsage
    ...
    public void noteWifiControllerActivity(android.net.wifi.WifiActivityEnergyInfo p0) throws android.os.RemoteException;
