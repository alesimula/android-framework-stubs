...
public interface IConnectionServiceAdapter extends android.os.IInterface {
    ...
    public void addConferenceCallFromConnection(java.lang.String p0, android.telecom.ParcelableConference p1, android.telecom.Logging.Session.Info p2) throws android.os.RemoteException;
    ...
    public void requestCallEndpointChange(java.lang.String p0, android.telecom.CallEndpoint p1, android.os.ResultReceiver p2, android.telecom.Logging.Session.Info p3) throws android.os.RemoteException;
    ...
    public void queryLocation(java.lang.String p0, long p1, java.lang.String p2, android.os.ResultReceiver p3, android.telecom.Logging.Session.Info p4) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements com.android.internal.telecom.IConnectionServiceAdapter {
        ...
        static final int TRANSACTION_addConferenceCallFromConnection = 15;
        static final int TRANSACTION_removeCall = 16;
        static final int TRANSACTION_onPostDialWait = 17;
        static final int TRANSACTION_onPostDialChar = 18;
        static final int TRANSACTION_queryRemoteConnectionServices = 19;
        static final int TRANSACTION_setVideoProvider = 20;
        static final int TRANSACTION_setVideoState = 21;
        static final int TRANSACTION_setIsVoipAudioMode = 22;
        static final int TRANSACTION_setStatusHints = 23;
        static final int TRANSACTION_setAddress = 24;
        static final int TRANSACTION_setCallerDisplayName = 25;
        static final int TRANSACTION_setConferenceableConnections = 26;
        static final int TRANSACTION_addExistingConnection = 27;
        static final int TRANSACTION_putExtras = 28;
        static final int TRANSACTION_removeExtras = 29;
        static final int TRANSACTION_setAudioRoute = 30;
        static final int TRANSACTION_requestCallEndpointChange = 31;
        static final int TRANSACTION_onConnectionEvent = 32;
        static final int TRANSACTION_onRttInitiationSuccess = 33;
        static final int TRANSACTION_onRttInitiationFailure = 34;
        static final int TRANSACTION_onRttSessionRemotelyTerminated = 35;
        static final int TRANSACTION_onRemoteRttRequest = 36;
        static final int TRANSACTION_onPhoneAccountChanged = 37;
        static final int TRANSACTION_onConnectionServiceFocusReleased = 38;
        static final int TRANSACTION_resetConnectionTime = 39;
        static final int TRANSACTION_setConferenceState = 40;
        static final int TRANSACTION_setCallDirection = 41;
        static final int TRANSACTION_queryLocation = 42;
        public Stub() { super(); }
