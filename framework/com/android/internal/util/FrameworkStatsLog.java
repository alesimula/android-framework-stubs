...
public final class FrameworkStatsLog {
    ...
    public static final int ACCESSIBILITY_SHORTCUT_REPORTED__SHORTCUT_TYPE__KEY_GESTURE = 12;
    public static final int ACCESSIBILITY_SHORTCUT_REPORTED__SHORTCUT_TYPE__QUICK_ACCESS = 11;
    public static final int ACCESSIBILITY_SHORTCUT_REPORTED__SHORTCUT_TYPE__QUICK_SETTINGS = 9;
    public static final int ACCESSIBILITY_SHORTCUT_REPORTED__SHORTCUT_TYPE__TOP_ROW_KEY = 10;
    ...
    public static final int ACCESSIBILITY_SHORTCUT_STATS__GESTURE_SHORTCUT_TYPE__KEY_GESTURE = 12;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__GESTURE_SHORTCUT_TYPE__QUICK_ACCESS = 11;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__GESTURE_SHORTCUT_TYPE__QUICK_SETTINGS = 9;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__GESTURE_SHORTCUT_TYPE__TOP_ROW_KEY = 10;
    ...
    public static final int ACCESSIBILITY_SHORTCUT_STATS__HARDWARE_SHORTCUT_TYPE__KEY_GESTURE = 12;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__HARDWARE_SHORTCUT_TYPE__QUICK_ACCESS = 11;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__HARDWARE_SHORTCUT_TYPE__QUICK_SETTINGS = 9;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__HARDWARE_SHORTCUT_TYPE__TOP_ROW_KEY = 10;
    ...
    public static final int ACCESSIBILITY_SHORTCUT_STATS__QS_SHORTCUT_TYPE__KEY_GESTURE = 12;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__QS_SHORTCUT_TYPE__QUICK_ACCESS = 11;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__QS_SHORTCUT_TYPE__QUICK_SETTINGS = 9;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__QS_SHORTCUT_TYPE__TOP_ROW_KEY = 10;
    ...
    public static final int ACCESSIBILITY_SHORTCUT_STATS__SOFTWARE_SHORTCUT_TYPE__KEY_GESTURE = 12;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__SOFTWARE_SHORTCUT_TYPE__QUICK_ACCESS = 11;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__SOFTWARE_SHORTCUT_TYPE__QUICK_SETTINGS = 9;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__SOFTWARE_SHORTCUT_TYPE__TOP_ROW_KEY = 10;
    ...
    public static final int ACCESSIBILITY_SHORTCUT_STATS__TOP_ROW_KEY_TYPE__A11Y_BUTTON = 1;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__TOP_ROW_KEY_TYPE__A11Y_BUTTON_LONG_PRESS = 4;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__TOP_ROW_KEY_TYPE__A11Y_FLOATING_MENU = 5;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__TOP_ROW_KEY_TYPE__A11Y_GESTURE = 6;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__TOP_ROW_KEY_TYPE__A11Y_WEAR_TRIPLE_PRESS_GESTURE = 7;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__TOP_ROW_KEY_TYPE__KEY_GESTURE = 12;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__TOP_ROW_KEY_TYPE__QUICK_ACCESS = 11;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__TOP_ROW_KEY_TYPE__QUICK_SETTINGS = 9;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__TOP_ROW_KEY_TYPE__TOP_ROW_KEY = 10;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__TOP_ROW_KEY_TYPE__TRIPLE_TAP = 3;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__TOP_ROW_KEY_TYPE__TWO_FINGER_TRIPLE_TAP = 8;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__TOP_ROW_KEY_TYPE__UNKNOWN_TYPE = 0;
    public static final int ACCESSIBILITY_SHORTCUT_STATS__TOP_ROW_KEY_TYPE__VOLUME_KEY = 2;
    ...
    public static final int ACQUIRE_TRUST_TOKEN_CALLED = 1282;
    public static final int ACQUIRE_TRUST_TOKEN_CALLED__OUTCOME__OUTCOME_ANCHOR_UNAVAILABLE = 2;
    public static final int ACQUIRE_TRUST_TOKEN_CALLED__OUTCOME__OUTCOME_SUCCESS = 1;
    public static final int ACQUIRE_TRUST_TOKEN_CALLED__OUTCOME__OUTCOME_TOKEN_EXHAUSTED = 3;
    public static final int ACQUIRE_TRUST_TOKEN_CALLED__OUTCOME__OUTCOME_TOKEN_INVALID = 4;
    public static final int ACQUIRE_TRUST_TOKEN_CALLED__OUTCOME__OUTCOME_UNKNOWN = 0;
    public static final int ACQUIRE_TRUST_TOKEN_CALLED__TOKEN_TYPE__TRUST_TOKEN_TYPE_DEVICE = 1;
    public static final int ACQUIRE_TRUST_TOKEN_CALLED__TOKEN_TYPE__TRUST_TOKEN_TYPE_IDENTITIES = 2;
    public static final int ACQUIRE_TRUST_TOKEN_CALLED__TOKEN_TYPE__TRUST_TOKEN_TYPE_UNKNOWN = 0;
    ...
    public static final int ADAPTIVE_SUSPEND_STATS = 10259;
    public static final int ADB_CONNECTION_CHANGED = 144;
    public static final int ADB_CONNECTION_CHANGED__STATE__ADB_WIFI_ALLOW_NETWORK = 12;
    public static final int ADB_CONNECTION_CHANGED__STATE__ADB_WIFI_ALWAYS_ALLOW_NETWORK = 13;
    public static final int ADB_CONNECTION_CHANGED__STATE__ADB_WIFI_AUTO_DISABLED = 11;
    public static final int ADB_CONNECTION_CHANGED__STATE__ADB_WIFI_AUTO_ENABLED = 9;
    public static final int ADB_CONNECTION_CHANGED__STATE__ADB_WIFI_DENY_NETWORK = 14;
    public static final int ADB_CONNECTION_CHANGED__STATE__ADB_WIFI_DEVICE_CONNECTED = 16;
    public static final int ADB_CONNECTION_CHANGED__STATE__ADB_WIFI_DEVICE_DISCONNECTED = 17;
    public static final int ADB_CONNECTION_CHANGED__STATE__ADB_WIFI_DISABLED = 10;
    public static final int ADB_CONNECTION_CHANGED__STATE__ADB_WIFI_ENABLED = 8;
    public static final int ADB_CONNECTION_CHANGED__STATE__ADB_WIFI_PAIRING_CANCELLED = 22;
    public static final int ADB_CONNECTION_CHANGED__STATE__ADB_WIFI_PAIRING_CODE_PAIRING_FAILED = 27;
    public static final int ADB_CONNECTION_CHANGED__STATE__ADB_WIFI_PAIRING_CODE_PAIRING_SUCCEEDED = 26;
    public static final int ADB_CONNECTION_CHANGED__STATE__ADB_WIFI_PAIRING_CODE_STARTED = 19;
    public static final int ADB_CONNECTION_CHANGED__STATE__ADB_WIFI_PAIRING_FAILED = 21;
    public static final int ADB_CONNECTION_CHANGED__STATE__ADB_WIFI_PAIRING_SUCCEEDED = 20;
    public static final int ADB_CONNECTION_CHANGED__STATE__ADB_WIFI_QR_CODE_PAIRING_FAILED = 25;
    public static final int ADB_CONNECTION_CHANGED__STATE__ADB_WIFI_QR_CODE_PAIRING_SUCCEEDED = 24;
    public static final int ADB_CONNECTION_CHANGED__STATE__ADB_WIFI_QR_PAIRING_STARTED = 18;
    public static final int ADB_CONNECTION_CHANGED__STATE__ADB_WIFI_UNPAIR_DEVICE = 15;
    public static final int ADB_CONNECTION_CHANGED__STATE__AUTOMATICALLY_ALLOWED = 4;
    public static final int ADB_CONNECTION_CHANGED__STATE__AUTO_SETUP_ADB_OVER_WIFI = 28;
    ...
    public static final int ADB_CONNECTION_CHANGED__STATE__USER_ALWAYS_ALLOWED = 23;
    ...
    public static final int ADPFSYSTEM_COMPONENT_INFO__FMQ_SUPPORTED__OTHER_STATUS = 4;
    public static final int ADPFSYSTEM_COMPONENT_INFO__FMQ_SUPPORTED__SUPPORTED = 1;
    public static final int ADPFSYSTEM_COMPONENT_INFO__FMQ_SUPPORTED__UNKNOWN_FMQ_STATUS = 0;
    ...
    public static final int ADPF_SESSION_SNAPSHOT__SESSION_TAG__UNKNOWN_SESSION_TAG = 0;
    public static final int ADPF_SUPPORT_INFO = 10237;
    ...
    public static final int ADVANCED_PROTECTION_STATE_CHANGED__LAST_DIALOGUE_TYPE__DIALOGUE_TYPE_BLOCKED_INTERACTION_SILENT = 3;
    ...
    public static final int ADVANCED_PROTECTION_STATE_CHANGED__LAST_DIALOG_FEATURE_ID__FEATURE_ID_DISALLOW_DEBUGGING_FEATURES = 8;
    public static final int ADVANCED_PROTECTION_STATE_CHANGED__LAST_DIALOG_FEATURE_ID__FEATURE_ID_DISALLOW_INSECURE_WIFI_AUTOJOIN = 6;
    ...
    public static final int ADVANCED_PROTECTION_STATE_CHANGED__LAST_DIALOG_FEATURE_ID__FEATURE_ID_DISALLOW_STATE_CHANGE_VIA_ADB = 9;
    ...
    public static final int ADVANCED_PROTECTION_STATE_CHANGED__LAST_DIALOG_FEATURE_ID__FEATURE_ID_RESTRICT_NON_TOOL_A11Y_SERVICES = 7;
    ...
    public static final int ADVANCED_PROTECTION_SUPPORT_DIALOG_DISPLAYED__DIALOGUE_TYPE__DIALOGUE_TYPE_BLOCKED_INTERACTION_SILENT = 3;
    ...
    public static final int ADVANCED_PROTECTION_SUPPORT_DIALOG_DISPLAYED__FEATURE_ID__FEATURE_ID_DISALLOW_DEBUGGING_FEATURES = 8;
    public static final int ADVANCED_PROTECTION_SUPPORT_DIALOG_DISPLAYED__FEATURE_ID__FEATURE_ID_DISALLOW_INSECURE_WIFI_AUTOJOIN = 6;
    ...
    public static final int ADVANCED_PROTECTION_SUPPORT_DIALOG_DISPLAYED__FEATURE_ID__FEATURE_ID_DISALLOW_STATE_CHANGE_VIA_ADB = 9;
    ...
    public static final int ADVANCED_PROTECTION_SUPPORT_DIALOG_DISPLAYED__FEATURE_ID__FEATURE_ID_RESTRICT_NON_TOOL_A11Y_SERVICES = 7;
    public static final int ADVANCED_PROTECTION_SUPPORT_DIALOG_DISPLAYED__FEATURE_ID__FEATURE_ID_UNKNOWN = 0;
    public static final int ADVANCED_PROTECTION_USB_EVENT_REPORTED = 1193;
    public static final int ADVANCED_PROTECTION_USB_EVENT_REPORTED__USB_EVENT__USB_EVENT_UNKNOWN = 0;
    public static final int ADVANCED_PROTECTION_USB_EVENT_REPORTED__USB_EVENT__USB_EVENT_USB_AUTO_CONNECTED = 1;
    public static final int ADVANCED_PROTECTION_USB_EVENT_REPORTED__USB_EVENT__USB_EVENT_USB_AUTO_DISCONNECTED = 2;
    public static final int ADVANCED_PROTECTION_USB_NOTIFICATION_DISPLAYED = 1141;
    public static final int ADVANCED_PROTECTION_USB_NOTIFICATION_DISPLAYED__NOTIFICATION_TYPE__USB_NOTIFICATION_TYPE_CHARGE = 1;
    public static final int ADVANCED_PROTECTION_USB_NOTIFICATION_DISPLAYED__NOTIFICATION_TYPE__USB_NOTIFICATION_TYPE_CHARGE_DATA = 3;
    public static final int ADVANCED_PROTECTION_USB_NOTIFICATION_DISPLAYED__NOTIFICATION_TYPE__USB_NOTIFICATION_TYPE_DATA = 2;
    public static final int ADVANCED_PROTECTION_USB_NOTIFICATION_DISPLAYED__NOTIFICATION_TYPE__USB_NOTIFICATION_TYPE_SILENCE = 4;
    public static final int ADVANCED_PROTECTION_USB_NOTIFICATION_DISPLAYED__NOTIFICATION_TYPE__USB_NOTIFICATION_TYPE_UNKNOWN = 0;
    public static final int ADVANCED_PROTECTION_USB_STATE_CHANGE_ERROR_REPORTED = 1054;
    public static final int ADVANCED_PROTECTION_USB_STATE_CHANGE_ERROR_REPORTED__ERROR_TYPE__USB_ERROR_TYPE_CHANGE_DATA_STATUS_FAILED = 1;
    public static final int ADVANCED_PROTECTION_USB_STATE_CHANGE_ERROR_REPORTED__ERROR_TYPE__USB_ERROR_TYPE_UNEXPECTED_ACCESSORY_ATTACHED = 4;
    public static final int ADVANCED_PROTECTION_USB_STATE_CHANGE_ERROR_REPORTED__ERROR_TYPE__USB_ERROR_TYPE_UNEXPECTED_ACCESSORY_DETACHED = 5;
    public static final int ADVANCED_PROTECTION_USB_STATE_CHANGE_ERROR_REPORTED__ERROR_TYPE__USB_ERROR_TYPE_UNEXPECTED_DEVICE_ATTACHED = 2;
    public static final int ADVANCED_PROTECTION_USB_STATE_CHANGE_ERROR_REPORTED__ERROR_TYPE__USB_ERROR_TYPE_UNEXPECTED_DEVICE_DETACHED = 3;
    public static final int ADVANCED_PROTECTION_USB_STATE_CHANGE_ERROR_REPORTED__ERROR_TYPE__USB_ERROR_TYPE_UNKNOWN = 0;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED = 1103;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_ACCEPT_HANDOVER = 74;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_ACCESS_ACCESSIBILITY = 88;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_ACCESS_HID = 178;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_ACCESS_LOCAL_NETWORK = 169;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_ACCESS_MEDIA_LOCATION = 90;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_ACCESS_NOTIFICATIONS = 25;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_ACCESS_RESTRICTED_SETTINGS = 119;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_ACTIVATE_PLATFORM_VPN = 94;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_ACTIVATE_VPN = 47;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_ACTIVITY_RECOGNITION = 79;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_ACTIVITY_RECOGNITION_SOURCE = 113;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_ADD_VOICEMAIL = 52;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_ANSWER_PHONE_CALLS = 69;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_ARCHIVE_ICON_OVERLAY = 145;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_ASSIST_SCREENSHOT = 50;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_ASSIST_STRUCTURE = 49;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_AUDIO_ACCESSIBILITY_VOLUME = 64;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_AUDIO_ALARM_VOLUME = 37;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_AUDIO_BLUETOOTH_VOLUME = 39;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_AUDIO_MASTER_VOLUME = 33;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_AUDIO_MEDIA_VOLUME = 36;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_AUDIO_NOTIFICATION_VOLUME = 38;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_AUDIO_RING_VOLUME = 35;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_AUDIO_VOICE_VOLUME = 34;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_AUTO_REVOKE_MANAGED_BY_INSTALLER = 98;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_AUTO_REVOKE_PERMISSIONS_IF_UNUSED = 97;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_BIND_ACCESSIBILITY_SERVICE = 73;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_BLUETOOTH_ADVERTISE = 114;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_BLUETOOTH_CONNECT = 111;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_BLUETOOTH_SCAN = 77;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_BODY_SENSORS = 56;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_BODY_SENSORS_WRIST_TEMPERATURE = 132;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_CALL_PHONE = 13;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_CAMERA = 26;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_CAMERA_SANDBOXED = 134;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_CAPTURE_CONSENTLESS_BUGREPORT_ON_USERDEBUG_BUILD = 131;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_CHANGE_WIFI_STATE = 71;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_COARSE_LOCATION = 0;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_COARSE_LOCATION_SOURCE = 109;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_COMPUTER_CONTROL = 167;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_CONTINUE_ACROSS_DEVICES = 174;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_CONTROL_AUDIO = 154;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_CONTROL_AUDIO_PARTIAL = 155;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_CREATE_ACCESSIBILITY_OVERLAY = 138;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_DEPRECATED_1 = 96;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_EMERGENCY_LOCATION = 147;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_ENABLE_MOBILE_DATA_BY_USER = 140;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_ESTABLISH_VPN_MANAGER = 118;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_ESTABLISH_VPN_SERVICE = 117;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_EYE_TRACKING_COARSE = 156;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_EYE_TRACKING_FINE = 157;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_FACE_TRACKING = 158;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_FINE_LOCATION = 1;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_FINE_LOCATION_SOURCE = 108;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_FOREGROUND_SERVICE_SPECIAL_USE = 127;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_GET_ACCOUNTS = 62;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_GET_USAGE_STATS = 43;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_GPS = 2;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_HAND_TRACKING = 159;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_HEAD_TRACKING = 160;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_INSTANT_APP_START_FOREGROUND = 68;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_INTERACT_ACROSS_PROFILES = 93;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_LEGACY_STORAGE = 87;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_LOADER_USAGE_STATS = 95;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_MANAGE_ASSISTANT_AUDIO = 181;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_MANAGE_CONTACTS = 180;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_MANAGE_CREDENTIALS = 104;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_MANAGE_EXTERNAL_STORAGE = 92;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_MANAGE_IPSEC_TUNNELS = 75;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_MANAGE_MEDIA = 110;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_MANAGE_ONGOING_CALLS = 103;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_MANAGE_PERIPHERAL_CUSTOMIZATION = 179;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_MEDIA_ROUTING_CONTROL = 139;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_MOCK_LOCATION = 58;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_MONITOR_HIGH_POWER_LOCATION = 42;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_MONITOR_LOCATION = 41;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_MUTE_MICROPHONE = 44;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_NEARBY_WIFI_DEVICES = 116;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_NEIGHBORING_CELLS = 12;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_NONE = -1;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_NO_ISOLATED_STORAGE = 99;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_PHONE_CALL_CAMERA = 101;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_PHONE_CALL_MICROPHONE = 100;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_PICTURE_IN_PICTURE = 67;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_PLAY_AUDIO = 28;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_POST_NOTIFICATION = 11;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_POST_PROMOTED_NOTIFICATIONS = 163;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_PROCESS_OUTGOING_CALLS = 54;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_PROJECT_MEDIA = 46;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_QUERY_ALL_PACKAGES = 91;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RANGING = 151;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RAPID_CLEAR_NOTIFICATIONS_BY_LISTENER = 142;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_BLOOD_PRESSURE = 170;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_CALENDAR = 8;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_CALL_LOG = 6;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_CELL_BROADCASTS = 57;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_CELL_IDENTITY = 165;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_CELL_INFO = 166;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_CLIPBOARD = 29;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_CONTACTS = 4;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_DEVICE_IDENTIFIERS = 89;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_EXTERNAL_STORAGE = 59;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_HEART_RATE = 149;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_HEART_RATE_VARIABILITY = 171;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_ICC_SMS = 21;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_MEDIA_AUDIO = 81;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_MEDIA_IMAGES = 85;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_MEDIA_VIDEO = 83;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_MEDIA_VISUAL_USER_SELECTED = 123;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_OTP_SMS = 168;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_OXYGEN_SATURATION = 152;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_PHONE_NUMBERS = 65;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_PHONE_STATE = 51;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_RESPIRATORY_RATE = 172;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_RESTRICTED_MESSAGES = 176;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_SCREEN_CONTEXT = 175;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_SKIN_TEMPERATURE = 150;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_SMS = 14;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_SYSTEM_GRAMMATICAL_GENDER = 143;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_VO2_MAX = 173;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_READ_WRITE_HEALTH_DATA = 126;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RECEIVE_AMBIENT_TRIGGER_AUDIO = 120;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RECEIVE_EMERGENCY_SMS = 17;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RECEIVE_EXPLICIT_USER_INTERACTION_AUDIO = 121;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RECEIVE_MMS = 18;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RECEIVE_SANDBOXED_DETECTION_TRAINING_DATA = 137;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RECEIVE_SANDBOX_TRIGGER_AUDIO = 136;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RECEIVE_SENSITIVE_NOTIFICATIONS = 148;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RECEIVE_SMS = 16;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RECEIVE_WAP_PUSH = 19;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RECORD_AUDIO = 27;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RECORD_AUDIO_HOTWORD = 102;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RECORD_AUDIO_OUTPUT = 106;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RECORD_AUDIO_SANDBOXED = 135;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RECORD_INCOMING_PHONE_AUDIO = 115;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_REQUEST_DELETE_PACKAGES = 72;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_REQUEST_INSTALL_PACKAGES = 66;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RESERVED_FOR_TESTING = 141;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RUN_ANY_IN_BACKGROUND = 70;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RUN_BACKUP_JOBS = 144;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RUN_IN_BACKGROUND = 63;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_RUN_USER_INITIATED_JOBS = 122;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_SCENE_UNDERSTANDING_COARSE = 161;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_SCENE_UNDERSTANDING_FINE = 162;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_SCHEDULE_EXACT_ALARM = 107;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_SEND_SMS = 20;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_SMS_FINANCIAL_TRANSACTIONS = 80;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_START_ACTIVITIES_ON_LOGIN_SCREEN = 182;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_START_FOREGROUND = 76;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_SYSTEM_ALERT_WINDOW = 24;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_SYSTEM_APPLICATION_OVERLAY = 164;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_SYSTEM_EXEMPT_FROM_ACTIVITY_BG_START_RESTRICTION = 130;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_SYSTEM_EXEMPT_FROM_DISMISSIBLE_NOTIFICATIONS = 125;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_SYSTEM_EXEMPT_FROM_HIBERNATION = 129;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_SYSTEM_EXEMPT_FROM_POWER_RESTRICTIONS = 128;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_SYSTEM_EXEMPT_FROM_SUSPENSION = 124;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_TAKE_AUDIO_FOCUS = 32;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_TAKE_MEDIA_BUTTONS = 31;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_TOAST_WINDOW = 45;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_TURN_SCREEN_ON = 61;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_UNARCHIVAL_CONFIRMATION = 146;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_USE_BIOMETRIC = 78;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_USE_FINGERPRINT = 55;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_USE_FULL_SCREEN_INTENT = 133;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_USE_ICC_AUTH_WITH_DEVICE_IDENTIFIER = 105;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_USE_SIP = 53;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_UWB_RANGING = 112;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_VIBRATE = 3;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_WAKE_LOCK = 40;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_WIFI_SCAN = 10;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_WRITE_CALENDAR = 9;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_WRITE_CALL_LOG = 7;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_WRITE_CLIPBOARD = 30;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_WRITE_CONTACTS = 5;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_WRITE_EXTERNAL_STORAGE = 60;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_WRITE_ICC_SMS = 22;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_WRITE_MEDIA_AUDIO = 82;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_WRITE_MEDIA_IMAGES = 86;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_WRITE_MEDIA_VIDEO = 84;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_WRITE_RESTRICTED_MESSAGES = 177;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_WRITE_SETTINGS = 23;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_WRITE_SMS = 15;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_WRITE_SYSTEM_PREFERENCES = 153;
    public static final int AGGREGATED_APP_OP_ACCESS_EVENT_REPORTED__OP__APP_OP_WRITE_WALLPAPER = 48;
    public static final int AGGREGATED_KERNEL_WAKELOCK_INFO = 10253;
    ...
    public static final int ALARM_SCHEDULED__CALLING_PROCESS_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int AMBIENT_CUE_EVENT_REPORTED = 1119;
    ...
    public static final int ANR_WARNING_API_REPORTED = 1344;
    public static final int ANR_WARNING_API_REPORTED__ACTION__NOTIFY = 3;
    public static final int ANR_WARNING_API_REPORTED__ACTION__REGISTER = 1;
    public static final int ANR_WARNING_API_REPORTED__ACTION__UNKNOWN = 0;
    public static final int ANR_WARNING_API_REPORTED__ACTION__UNREGISTER = 2;
    public static final int ANR_WARNING_API_REPORTED__NOTIFY_RESULT__NOTIFY_FAILURE = 2;
    public static final int ANR_WARNING_API_REPORTED__NOTIFY_RESULT__NOTIFY_SUCCESS = 1;
    public static final int ANR_WARNING_API_REPORTED__NOTIFY_RESULT__NOTIFY_UNKNOWN = 0;
    ...
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED = 1298;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_DUPLICATE_POR = 19;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_INCONSISTENT_DIGESTS = 13;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_INTEGRITY_MISMATCH = 6;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_MALFORMED_ATTRIBUTES = 18;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_MALFORMED_BLOCK = 2;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_MALFORMED_CERTIFICATE = 14;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_MALFORMED_POR = 20;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_MALFORMED_SIGNATURE = 10;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_MALFORMED_SIGNER = 3;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_MISSING_SIGNATURE_ALGORITHM = 9;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_NO_CERTIFICATES = 15;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_NO_CONTENT_DIGESTS = 5;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_NO_SIGNATURES = 7;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_NO_SUPPORTED_SIGNATURES = 8;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_POR_CERT_MISMATCH = 22;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_POR_INTEGRITY_FAILURE = 21;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_PQC_SINGLE_SIGNER = 23;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_PUBLIC_KEY_MISMATCH = 16;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_SIGNATURE_ALGORITHM_MISMATCH = 12;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_SIGNATURE_VERIFICATION_FAILED = 11;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_SIGNER_SDK_MISMATCH = 17;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_SUCCESS = 1;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_TOO_MANY_SIGNERS = 4;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_UNSPECIFIED = 0;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_V32_ALGO_TYPE_COLLISION = 31;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_V32_BLOCK_STRIPPED = 36;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_V32_CLASSICAL_KEY_MISMATCH = 48;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_V32_INVALID_SIGNER_COUNT = 30;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_V32_KEY_REUSE = 40;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_V32_KEY_REUSE_INSTALLED_DATA = 38;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_V32_KEY_REUSE_ROLLBACK = 39;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_V32_MAX_ATTR_WITHOUT_MIN_ATTR = 44;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_V32_MISSING_CLASSICAL = 43;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_V32_MISSING_CLASSICAL_INSTALLED_DATA = 41;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_V32_MISSING_CLASSICAL_ROLLBACK = 42;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_V32_POR_CAPABILITY_MISMATCH = 34;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_V32_POR_MISMATCH = 33;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_V32_POR_MISSING = 32;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_V32_PQC_KEY_MISMATCH = 47;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_V32_SDK_ATTR_MISMATCH = 37;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_V32_SDK_RANGE_MISMATCH = 35;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_V32_SIGNATURE_SCHEME_MISMATCH = 46;
    public static final int APK_SIGNATURE_VERIFICATION_REPORTED__VERIFICATION_RESULT__VERIFICATION_V32_UPDATE_SIGNATURE_MISMATCH = 45;
    ...
    public static final int APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_DEVICE_DPC = 55;
    ...
    public static final int APP_BACKGROUND_RESTRICTIONS_INFO__EXEMPTION_REASON__REASON_USER_DPC = 56;
    ...
    public static final int APP_COMPACTED_V2__OOM_CHANGE_REASON__OOM_ADJ_REASON_BATCH_UPDATE_REQUEST = 26;
    ...
    public static final int APP_COMPACTED_V2__OOM_CHANGE_REASON__OOM_ADJ_REASON_SERVICE_BINDER_CALL = 25;
    ...
    public static final int APP_COMPACTED__PROCESS_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int APP_FREEZE_CHANGED__UNFREEZE_REASON_V2__UFR_OOM_ADJ_REASON_BATCH_UPDATE_REQUEST = 33;
    public static final int APP_FREEZE_CHANGED__UNFREEZE_REASON_V2__UFR_OOM_ADJ_REASON_SERVICE_BINDER_CALL = 32;
    ...
    public static final int APP_LOCK_DAILY_SNAPSHOT = 10274;
    public static final int APP_LOCK_ENABLED_STATE_CHANGED = 1392;
    public static final int APP_LOCK_ENABLED_STATE_CHANGED__CHANGE_REASON__CHANGE_REASON_DEVICE_CREDENTIAL_CHANGED = 3;
    public static final int APP_LOCK_ENABLED_STATE_CHANGED__CHANGE_REASON__CHANGE_REASON_DEVICE_UPDATES = 2;
    public static final int APP_LOCK_ENABLED_STATE_CHANGED__CHANGE_REASON__CHANGE_REASON_LOCKED_APP_REINSTALLED = 4;
    public static final int APP_LOCK_ENABLED_STATE_CHANGED__CHANGE_REASON__CHANGE_REASON_UNKNOWN = 0;
    public static final int APP_LOCK_ENABLED_STATE_CHANGED__CHANGE_REASON__CHANGE_REASON_USER_SETTINGS = 1;
    ...
    public static final int APP_OPS__OP_ID__APP_OP_ACCESS_HID = 178;
    public static final int APP_OPS__OP_ID__APP_OP_ACCESS_LOCAL_NETWORK = 169;
    ...
    public static final int APP_OPS__OP_ID__APP_OP_COMPUTER_CONTROL = 167;
    public static final int APP_OPS__OP_ID__APP_OP_CONTINUE_ACROSS_DEVICES = 174;
    ...
    public static final int APP_OPS__OP_ID__APP_OP_MANAGE_ASSISTANT_AUDIO = 181;
    public static final int APP_OPS__OP_ID__APP_OP_MANAGE_CONTACTS = 180;
    ...
    public static final int APP_OPS__OP_ID__APP_OP_MANAGE_PERIPHERAL_CUSTOMIZATION = 179;
    ...
    public static final int APP_OPS__OP_ID__APP_OP_READ_BLOOD_PRESSURE = 170;
    ...
    public static final int APP_OPS__OP_ID__APP_OP_READ_CELL_IDENTITY = 165;
    public static final int APP_OPS__OP_ID__APP_OP_READ_CELL_INFO = 166;
    ...
    public static final int APP_OPS__OP_ID__APP_OP_READ_HEART_RATE_VARIABILITY = 171;
    ...
    public static final int APP_OPS__OP_ID__APP_OP_READ_OTP_SMS = 168;
    ...
    public static final int APP_OPS__OP_ID__APP_OP_READ_RESPIRATORY_RATE = 172;
    public static final int APP_OPS__OP_ID__APP_OP_READ_RESTRICTED_MESSAGES = 176;
    public static final int APP_OPS__OP_ID__APP_OP_READ_SCREEN_CONTEXT = 175;
    ...
    public static final int APP_OPS__OP_ID__APP_OP_READ_VO2_MAX = 173;
    ...
    public static final int APP_OPS__OP_ID__APP_OP_START_ACTIVITIES_ON_LOGIN_SCREEN = 182;
    ...
    public static final int APP_OPS__OP_ID__APP_OP_WRITE_RESTRICTED_MESSAGES = 177;
    ...
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_ACCESS_HID = 178;
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_ACCESS_LOCAL_NETWORK = 169;
    ...
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_COMPUTER_CONTROL = 167;
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_CONTINUE_ACROSS_DEVICES = 174;
    ...
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_MANAGE_ASSISTANT_AUDIO = 181;
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_MANAGE_CONTACTS = 180;
    ...
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_MANAGE_PERIPHERAL_CUSTOMIZATION = 179;
    ...
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_READ_BLOOD_PRESSURE = 170;
    ...
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_READ_CELL_IDENTITY = 165;
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_READ_CELL_INFO = 166;
    ...
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_READ_HEART_RATE_VARIABILITY = 171;
    ...
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_READ_OTP_SMS = 168;
    ...
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_READ_RESPIRATORY_RATE = 172;
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_READ_RESTRICTED_MESSAGES = 176;
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_READ_SCREEN_CONTEXT = 175;
    ...
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_READ_VO2_MAX = 173;
    ...
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_START_ACTIVITIES_ON_LOGIN_SCREEN = 182;
    ...
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_WRITE_RESTRICTED_MESSAGES = 177;
    ...
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_ACCESS_HID = 178;
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_ACCESS_LOCAL_NETWORK = 169;
    ...
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_COMPUTER_CONTROL = 167;
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_CONTINUE_ACROSS_DEVICES = 174;
    ...
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_MANAGE_ASSISTANT_AUDIO = 181;
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_MANAGE_CONTACTS = 180;
    ...
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_MANAGE_PERIPHERAL_CUSTOMIZATION = 179;
    ...
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_READ_BLOOD_PRESSURE = 170;
    ...
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_READ_CELL_IDENTITY = 165;
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_READ_CELL_INFO = 166;
    ...
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_READ_HEART_RATE_VARIABILITY = 171;
    ...
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_READ_OTP_SMS = 168;
    ...
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_READ_RESPIRATORY_RATE = 172;
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_READ_RESTRICTED_MESSAGES = 176;
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_READ_SCREEN_CONTEXT = 175;
    ...
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_READ_VO2_MAX = 173;
    ...
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_START_ACTIVITIES_ON_LOGIN_SCREEN = 182;
    ...
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_WRITE_RESTRICTED_MESSAGES = 177;
    ...
    public static final int APP_PROCESS_DIED__REASON__REASON_MEMORY_LIMITER = 17;
    ...
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_ACTIVITY_LAUNCH_FAILURE = 57;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_ANR_TYPE_APP_TRIGGERED = 33;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_ANR_TYPE_BIND_APPLICATION = 34;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_ANR_TYPE_BROADCAST_OF_INTENT = 35;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_ANR_TYPE_CONTENT_PROVIDER_NOT_RESPONDING = 36;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_ANR_TYPE_EXECUTING_SERVICE = 37;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_ANR_TYPE_FOREGROUND_SHORT_SERVICE_TIMEOUT = 39;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_ANR_TYPE_INPUT_DISPATCHING_TIMEOUT = 41;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_ANR_TYPE_INPUT_DISPATCHING_TIMEOUT_NO_FOCUSED_WINDOW = 42;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_ANR_TYPE_JOB_SERVICE_START = 45;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_ANR_TYPE_START_FOREGROUND_SERVICE = 47;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_APP_DATA_CLEARED = 55;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_CACHED_IDLE_FORCED_APP_STANDBY = 18;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_CONFIG_RESET_RESTART = 60;
    ...
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_EXCESSIVE_ENQUEUED_BROADCASTS_COUNT = 49;
    ...
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_PACKAGE_DELETED = 53;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_PACKAGE_HIDDEN = 52;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_PACKAGE_MOVED = 54;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_PACKAGE_UPDATE = 25;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_PROVIDER_CLIENT_REPORTED_DEATH = 61;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_RAPID_ACTIVITY_LAUNCH = 59;
    ...
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_RESTART_ACTIVITY_PROCESS_TIMEOUT = 58;
    ...
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_STORAGE_SESSION_RESET = 56;
    ...
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_VOLUME_MOUNT = 50;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_VOLUME_UNMOUNT = 51;
    public static final int APP_PROCESS_DIED__SUB_REASON__SUBREASON_WAIT_FOR_DEBUGGER = 1;
    public static final int APP_RESTART_OCCURRED = 1089;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_IMPORTANCE__IMPORTANCE_BACKGROUND = 400;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_IMPORTANCE__IMPORTANCE_CANT_SAVE_STATE = 350;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_IMPORTANCE__IMPORTANCE_CANT_SAVE_STATE_PRE_26 = 170;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_IMPORTANCE__IMPORTANCE_EMPTY = 500;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_IMPORTANCE__IMPORTANCE_FOREGROUND = 100;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_IMPORTANCE__IMPORTANCE_FOREGROUND_SERVICE = 125;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_IMPORTANCE__IMPORTANCE_GONE = 1000;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_IMPORTANCE__IMPORTANCE_PERCEPTIBLE = 230;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_IMPORTANCE__IMPORTANCE_PERCEPTIBLE_PRE_26 = 130;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_IMPORTANCE__IMPORTANCE_SERVICE = 300;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_IMPORTANCE__IMPORTANCE_TOP_SLEEPING = 325;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_IMPORTANCE__IMPORTANCE_TOP_SLEEPING_PRE_28 = 150;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_IMPORTANCE__IMPORTANCE_VISIBLE = 200;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_REASON__REASON_ANR = 6;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_REASON__REASON_CRASH = 4;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_REASON__REASON_CRASH_NATIVE = 5;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_REASON__REASON_DEPENDENCY_DIED = 12;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_REASON__REASON_EXCESSIVE_RESOURCE_USAGE = 9;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_REASON__REASON_EXIT_SELF = 1;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_REASON__REASON_FREEZER = 14;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_REASON__REASON_INITIALIZATION_FAILURE = 7;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_REASON__REASON_LOW_MEMORY = 3;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_REASON__REASON_MEMORY_LIMITER = 17;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_REASON__REASON_OTHER = 13;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_REASON__REASON_PACKAGE_STATE_CHANGE = 15;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_REASON__REASON_PACKAGE_UPDATED = 16;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_REASON__REASON_PERMISSION_CHANGE = 8;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_REASON__REASON_SIGNALED = 2;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_REASON__REASON_UNKNOWN = 0;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_REASON__REASON_USER_REQUESTED = 10;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_REASON__REASON_USER_STOPPED = 11;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_ACTIVITY_LAUNCH_FAILURE = 57;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_ANR_TYPE_APP_TRIGGERED = 33;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_ANR_TYPE_BIND_APPLICATION = 34;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_ANR_TYPE_BROADCAST_OF_INTENT = 35;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_ANR_TYPE_CONTENT_PROVIDER_NOT_RESPONDING = 36;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_ANR_TYPE_EXECUTING_SERVICE = 37;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_ANR_TYPE_FOREGROUND_SHORT_SERVICE_TIMEOUT = 39;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_ANR_TYPE_INPUT_DISPATCHING_TIMEOUT = 41;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_ANR_TYPE_INPUT_DISPATCHING_TIMEOUT_NO_FOCUSED_WINDOW = 42;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_ANR_TYPE_JOB_SERVICE_START = 45;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_ANR_TYPE_START_FOREGROUND_SERVICE = 47;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_APP_DATA_CLEARED = 55;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_CACHED_IDLE_FORCED_APP_STANDBY = 18;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_CONFIG_RESET_RESTART = 60;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_EXCESSIVE_BINDER_OBJECTS = 29;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_EXCESSIVE_CPU = 7;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_EXCESSIVE_ENQUEUED_BROADCASTS_COUNT = 49;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_EXCESSIVE_OUTGOING_BROADCASTS_WHILE_CACHED = 32;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_FORCE_STOP = 21;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_FREEZER_BINDER_ASYNC_FULL = 31;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_FREEZER_BINDER_IOCTL = 19;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_FREEZER_BINDER_TRANSACTION = 20;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_IMPERCEPTIBLE = 15;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_INVALID_START = 13;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_INVALID_STATE = 14;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_ISOLATED_NOT_NEEDED = 17;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_KILL_ALL_BG_EXCEPT = 10;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_KILL_ALL_FG = 9;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_KILL_BACKGROUND = 24;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_KILL_PID = 12;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_KILL_UID = 11;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_LARGE_CACHED = 5;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_MEMORY_PRESSURE = 6;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_OOM_KILL = 30;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_PACKAGE_DELETED = 53;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_PACKAGE_HIDDEN = 52;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_PACKAGE_MOVED = 54;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_PACKAGE_UPDATE = 25;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_PROVIDER_CLIENT_REPORTED_DEATH = 61;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_RAPID_ACTIVITY_LAUNCH = 59;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_REMOVE_LRU = 16;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_REMOVE_TASK = 22;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_RESTART_ACTIVITY_PROCESS_TIMEOUT = 58;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_SDK_SANDBOX_DIED = 27;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_SDK_SANDBOX_NOT_NEEDED = 28;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_STOP_APP = 23;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_STORAGE_SESSION_RESET = 56;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_SYSTEM_UPDATE_DONE = 8;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_TOO_MANY_CACHED = 2;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_TOO_MANY_EMPTY = 3;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_TRIM_EMPTY = 4;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_UNDELIVERED_BROADCAST = 26;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_UNKNOWN = 0;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_VOLUME_MOUNT = 50;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_VOLUME_UNMOUNT = 51;
    public static final int APP_RESTART_OCCURRED__LAST_EXIT_SUB_REASON__SUBREASON_WAIT_FOR_DEBUGGER = 1;
    public static final int APP_RESTART_OCCURRED__TYPE__COLD = 1;
    public static final int APP_RESTART_OCCURRED__TYPE__UNKNOWN = 0;
    public static final int APP_RESTART_OCCURRED__TYPE__WARM = 2;
    ...
    public static final int APP_START_OCCURRED__SOURCE_TYPE__COMPLICATION = 8;
    public static final int APP_START_OCCURRED__SOURCE_TYPE__DESKTOP_ANIMATION = 5;
    ...
    public static final int APP_START_OCCURRED__SOURCE_TYPE__QSS = 6;
    public static final int APP_START_OCCURRED__SOURCE_TYPE__RECENTS_ANIMATION = 4;
    public static final int APP_START_OCCURRED__SOURCE_TYPE__TILE = 7;
    ...
    public static final int APP_USAGE_QUERY_EVENT_STATS = 1312;
    public static final int APP_USAGE_QUERY_EVENT_STATS__INTERVAL_TYPE__CONTINUOUS = 2;
    public static final int APP_USAGE_QUERY_EVENT_STATS__INTERVAL_TYPE__FIRST_QUERY = 1;
    public static final int APP_USAGE_QUERY_EVENT_STATS__INTERVAL_TYPE__OVERLAP = 3;
    public static final int APP_USAGE_QUERY_EVENT_STATS__INTERVAL_TYPE__UNSPECIFIED = 0;
    ...
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_ACCESS_HID = 178;
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_ACCESS_LOCAL_NETWORK = 169;
    ...
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_COMPUTER_CONTROL = 167;
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_CONTINUE_ACROSS_DEVICES = 174;
    ...
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_MANAGE_ASSISTANT_AUDIO = 181;
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_MANAGE_CONTACTS = 180;
    ...
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_MANAGE_PERIPHERAL_CUSTOMIZATION = 179;
    ...
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_READ_BLOOD_PRESSURE = 170;
    ...
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_READ_CELL_IDENTITY = 165;
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_READ_CELL_INFO = 166;
    ...
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_READ_HEART_RATE_VARIABILITY = 171;
    ...
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_READ_OTP_SMS = 168;
    ...
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_READ_RESPIRATORY_RATE = 172;
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_READ_RESTRICTED_MESSAGES = 176;
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_READ_SCREEN_CONTEXT = 175;
    ...
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_READ_VO2_MAX = 173;
    ...
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_START_ACTIVITIES_ON_LOGIN_SCREEN = 182;
    ...
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_WRITE_RESTRICTED_MESSAGES = 177;
    ...
    public static final int AUTOCLICK_ENABLED_REPORTED = 1068;
    public static final int AUTOCLICK_EVENT_REPORTED = 1067;
    public static final int AUTOCLICK_EVENT_REPORTED__CLICK_TYPE__AUTOCLICK_TYPE_DOUBLE_CLICK = 3;
    public static final int AUTOCLICK_EVENT_REPORTED__CLICK_TYPE__AUTOCLICK_TYPE_DRAG = 4;
    public static final int AUTOCLICK_EVENT_REPORTED__CLICK_TYPE__AUTOCLICK_TYPE_LEFT_CLICK = 1;
    public static final int AUTOCLICK_EVENT_REPORTED__CLICK_TYPE__AUTOCLICK_TYPE_LONG_PRESS = 6;
    public static final int AUTOCLICK_EVENT_REPORTED__CLICK_TYPE__AUTOCLICK_TYPE_RIGHT_CLICK = 2;
    public static final int AUTOCLICK_EVENT_REPORTED__CLICK_TYPE__AUTOCLICK_TYPE_SCROLL = 5;
    public static final int AUTOCLICK_EVENT_REPORTED__CLICK_TYPE__AUTOCLICK_TYPE_UNKNOWN = 0;
    public static final int AUTOCLICK_SESSION_DURATION_REPORTED = 1069;
    public static final int AUTOCLICK_SETTINGS_STATE_REPORTED = 1079;
    ...
    public static final int AUTOMATIC_TIME_ZONE_CHANGE_REVERTED_BY_USER_REPORTED = 1253;
    public static final int AUTOMATIC_TIME_ZONE_CHANGE_REVERTED_BY_USER_REPORTED__SOURCE__TIME_ZONE_SOURCE_FUSED_SIGNALS = 3;
    public static final int AUTOMATIC_TIME_ZONE_CHANGE_REVERTED_BY_USER_REPORTED__SOURCE__TIME_ZONE_SOURCE_LOCATION = 1;
    public static final int AUTOMATIC_TIME_ZONE_CHANGE_REVERTED_BY_USER_REPORTED__SOURCE__TIME_ZONE_SOURCE_TELEPHONY = 2;
    public static final int AUTOMATIC_TIME_ZONE_CHANGE_REVERTED_BY_USER_REPORTED__SOURCE__UNSPECIFIED = 0;
    ...
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_ACTIVE_IME = 19;
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_AFFILIATED_PROFILE_OWNER = 22;
    ...
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_COMPANION_APP = 23;
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_DEFAULT = 1;
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_DEVICE_OWNER = 21;
    ...
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_HOME_APP = 18;
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_INSTRUMENTATION = 30;
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_NFC_UID = 26;
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_NON_APP_VISIBLE_WINDOW = 11;
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_NOTIFICATION_TOKEN = 14;
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_PCC = 16;
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_PENDING_INTENT = 5;
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_PERSISTENT_SYSTEM_PROCESS = 28;
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_RECENTS_COMPONENT = 20;
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_ROOT_UID = 24;
    ...
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_SHELL_UID = 27;
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_SYSTEM_EXEMPT_APPOP = 29;
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_SYSTEM_UID = 25;
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_TOKEN = 12;
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_VISIBLE_SYSTEM_WINDOW = 17;
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_VISIBLE_WINDOW = 4;
    public static final int BAL_ALLOWED__ALLOWED_REASON__BAL_ALLOW_WALLPAPER = 15;
    ...
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_ACTIVE_IME = 19;
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_AFFILIATED_PROFILE_OWNER = 22;
    ...
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_COMPANION_APP = 23;
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_DEFAULT = 1;
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_DEVICE_OWNER = 21;
    ...
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_HOME_APP = 18;
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_INSTRUMENTATION = 30;
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_NFC_UID = 26;
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_NON_APP_VISIBLE_WINDOW = 11;
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_NOTIFICATION_TOKEN = 14;
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_PCC = 16;
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_PENDING_INTENT = 5;
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_PERSISTENT_SYSTEM_PROCESS = 28;
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_RECENTS_COMPONENT = 20;
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_ROOT_UID = 24;
    ...
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_SHELL_UID = 27;
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_SYSTEM_EXEMPT_APPOP = 29;
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_SYSTEM_UID = 25;
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_TOKEN = 12;
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_VISIBLE_SYSTEM_WINDOW = 17;
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_VISIBLE_WINDOW = 4;
    public static final int BAL_ALLOWED__CALLER_ALLOWED_REASON__BAL_ALLOW_WALLPAPER = 15;
    ...
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_ACTIVE_IME = 19;
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_AFFILIATED_PROFILE_OWNER = 22;
    ...
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_COMPANION_APP = 23;
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_DEFAULT = 1;
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_DEVICE_OWNER = 21;
    ...
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_HOME_APP = 18;
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_INSTRUMENTATION = 30;
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_NFC_UID = 26;
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_NON_APP_VISIBLE_WINDOW = 11;
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_NOTIFICATION_TOKEN = 14;
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_PCC = 16;
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_PENDING_INTENT = 5;
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_PERSISTENT_SYSTEM_PROCESS = 28;
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_RECENTS_COMPONENT = 20;
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_ROOT_UID = 24;
    ...
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_SHELL_UID = 27;
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_SYSTEM_EXEMPT_APPOP = 29;
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_SYSTEM_UID = 25;
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_TOKEN = 12;
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_VISIBLE_SYSTEM_WINDOW = 17;
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_VISIBLE_WINDOW = 4;
    public static final int BAL_ALLOWED__REAL_CALLER_ALLOWED_REASON__BAL_ALLOW_WALLPAPER = 15;
    ...
    public static final int BATTERY_LIFE = 10245;
    ...
    public static final int BINDER_CALLS_REPORTED = 1090;
    public static final int BINDER_CALLS_REPORTED__CLIENT_PROCESS_STATE__BACKGROUND = 3;
    public static final int BINDER_CALLS_REPORTED__CLIENT_PROCESS_STATE__CACHED = 4;
    public static final int BINDER_CALLS_REPORTED__CLIENT_PROCESS_STATE__FOREGROUND = 2;
    public static final int BINDER_CALLS_REPORTED__CLIENT_PROCESS_STATE__PERSISTENT = 1;
    public static final int BINDER_CALLS_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    public static final int BINDER_LATENCY_REPORTED = 342;
    public static final int BINDER_SPAM_REPORTED = 1064;
    public static final int BINDER_STATS_METADATA_REPORTED = 1378;
    ...
    public static final int BIOMETRIC_PROPERTIES_COLLECTED__SENSOR_TYPE__SENSOR_FP_STANDALONE = 8;
    ...
    public static final int BOOT_COMPLETED_BROADCAST_COMPLETION_LATENCY_REPORTED__USER_TYPE__PROFILE_SUPERVISING = 10;
    ...
    public static final int BOOT_TIME_EVENT_DURATION__EVENT__BOOTLOADER_SPLASH = 20;
    ...
    public static final int BOOT_TIME_EVENT_ELAPSED_TIME__EVENT__ANDROID_INIT_ON_BOOT = 33;
    public static final int BOOT_TIME_EVENT_ELAPSED_TIME__EVENT__ANDROID_INIT_ON_EARLY_BOOT = 32;
    public static final int BOOT_TIME_EVENT_ELAPSED_TIME__EVENT__ANDROID_INIT_ON_EARLY_FS = 26;
    public static final int BOOT_TIME_EVENT_ELAPSED_TIME__EVENT__ANDROID_INIT_ON_EARLY_INIT = 23;
    public static final int BOOT_TIME_EVENT_ELAPSED_TIME__EVENT__ANDROID_INIT_ON_FS = 27;
    public static final int BOOT_TIME_EVENT_ELAPSED_TIME__EVENT__ANDROID_INIT_ON_INIT = 24;
    public static final int BOOT_TIME_EVENT_ELAPSED_TIME__EVENT__ANDROID_INIT_ON_LATE_FS = 29;
    public static final int BOOT_TIME_EVENT_ELAPSED_TIME__EVENT__ANDROID_INIT_ON_LATE_INIT = 25;
    public static final int BOOT_TIME_EVENT_ELAPSED_TIME__EVENT__ANDROID_INIT_ON_POST_FS = 28;
    public static final int BOOT_TIME_EVENT_ELAPSED_TIME__EVENT__ANDROID_INIT_ON_POST_FS_DATA = 30;
    public static final int BOOT_TIME_EVENT_ELAPSED_TIME__EVENT__ANDROID_INIT_ON_ZYGOTE_START = 31;
    ...
    public static final int BROADCAST_DELIVERY_EVENT_REPORTED__RECEIVER_PROCESS_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int BROADCAST_DELIVERY_EVENT_REPORTED__SENDER_PROC_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int BROADCAST_PROCESSED__BROADCAST_TYPES__BROADCAST_TYPE_CROSS_APP_PENDING_INTENT = 16384;
    ...
    public static final int BROADCAST_PROCESSED__BROADCAST_TYPES__BROADCAST_TYPE_MANIFEST_RECEIVER = 8192;
    ...
    public static final int BROADCAST_PROCESSED__BROADCAST_TYPES__BROADCAST_TYPE_REGISTERED_RECEIVER_ONLY = 4096;
    ...
    public static final int BROADCAST_SENT__BROADCAST_TYPES__BROADCAST_TYPE_CROSS_APP_PENDING_INTENT = 16384;
    ...
    public static final int BROADCAST_SENT__BROADCAST_TYPES__BROADCAST_TYPE_MANIFEST_RECEIVER = 8192;
    ...
    public static final int BROADCAST_SENT__BROADCAST_TYPES__BROADCAST_TYPE_REGISTERED_RECEIVER_ONLY = 4096;
    ...
    public static final int BROADCAST_SENT__SENDER_PROC_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int BROADCAST_SENT__SENDER_UID_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int CAMERA1_ACCESS_REPORTED = 1365;
    public static final int CAMERA1_ACCESS_REPORTED__TRIGGER__GET_NUMBER_OF_CAMERAS = 1;
    public static final int CAMERA1_ACCESS_REPORTED__TRIGGER__OPEN = 2;
    public static final int CAMERA1_ACCESS_REPORTED__TRIGGER__UNKNOWN = 0;
    ...
    public static final int CAMERA_ACTION_EVENT__ERROR_STATE__CAMERA_HAL_CALLBACK_ERROR = 5;
    public static final int CAMERA_ACTION_EVENT__ERROR_STATE__CAMERA_HAL_DEVICE_ERROR = 4;
    public static final int CAMERA_ACTION_EVENT__ERROR_STATE__CAMERA_HAL_REQUEST_ERROR = 2;
    public static final int CAMERA_ACTION_EVENT__ERROR_STATE__CAMERA_PERMISSION_DENIED = 1;
    public static final int CAMERA_ACTION_EVENT__ERROR_STATE__CAMERA_SERVICE_INTERNAL_ERROR = 3;
    public static final int CAMERA_ACTION_EVENT__ERROR_STATE__CAMERA_UNKNOWN = 0;
    public static final int CAMERA_ACTION_EVENT__ERROR_STATE__CAMERA_WATCHDOG_ERROR = 6;
    ...
    public static final int CAMERA_ACTION_EVENT__MRIR_TYPE__MRIR_CONCURRENT = 3;
    public static final int CAMERA_ACTION_EVENT__MRIR_TYPE__MRIR_OFF = 1;
    public static final int CAMERA_ACTION_EVENT__MRIR_TYPE__MRIR_SINGLE = 2;
    public static final int CAMERA_ACTION_EVENT__MRIR_TYPE__MRIR_UNKNOWN = 0;
    ...
    public static final int CDM_ASSOCIATION_ACTION__DEVICE_PROFILE__DEVICE_PROFILE_FITNESS_TRACKER = 9;
    ...
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    public static final int CMA_ALLOCATION_LATENCY = 10279;
    public static final int COMPACTION_DURATION = 10280;
    ...
    public static final int CPU_HEADROOM_REPORTED = 1052;
    public static final int CPU_HEADROOM_REPORTED__STATUS__HAL_ERROR = 5;
    public static final int CPU_HEADROOM_REPORTED__STATUS__INCONSISTENT_THREAD_CORE_AFFINITY = 4;
    public static final int CPU_HEADROOM_REPORTED__STATUS__INSUFFICIENT_USER_MODE_TIME = 3;
    public static final int CPU_HEADROOM_REPORTED__STATUS__INVALID_TID = 2;
    public static final int CPU_HEADROOM_REPORTED__STATUS__SUCCESS = 1;
    public static final int CPU_HEADROOM_REPORTED__STATUS__UNKNOWN_STATUS = 0;
    public static final int CPU_HEADROOM_REPORTED__TYPE__AVERAGE = 2;
    public static final int CPU_HEADROOM_REPORTED__TYPE__MIN = 1;
    public static final int CPU_HEADROOM_REPORTED__TYPE__UNKNOWN_CALCULATION_TYPE = 0;
    ...
    public static final int CREDENTIAL_MANAGER_SETTINGS_EVENT_REPORTED = 1271;
    public static final int CREDENTIAL_MANAGER_SETTINGS_EVENT_REPORTED__EVENT_TYPE__ADD_PREFERRED_SERVICE = 3;
    public static final int CREDENTIAL_MANAGER_SETTINGS_EVENT_REPORTED__EVENT_TYPE__DISABLE_ADDITIONAL_SERVICE = 5;
    public static final int CREDENTIAL_MANAGER_SETTINGS_EVENT_REPORTED__EVENT_TYPE__EDIT_PREFERRED_SERVICE = 2;
    public static final int CREDENTIAL_MANAGER_SETTINGS_EVENT_REPORTED__EVENT_TYPE__ENABLE_ADDITIONAL_SERVICE = 4;
    public static final int CREDENTIAL_MANAGER_SETTINGS_EVENT_REPORTED__EVENT_TYPE__HIT_ADDITIONAL_SERVICE_LIMIT = 6;
    public static final int CREDENTIAL_MANAGER_SETTINGS_EVENT_REPORTED__EVENT_TYPE__RETURN_FROM_ADDITIONAL_SERVICE = 7;
    public static final int CREDENTIAL_MANAGER_SETTINGS_EVENT_REPORTED__EVENT_TYPE__RETURN_FROM_PREFERRED_SERVICE = 1;
    public static final int CREDENTIAL_MANAGER_SETTINGS_EVENT_REPORTED__EVENT_TYPE__UNKNOWN_EVENT = 0;
    public static final int CREDENTIAL_MANAGER_SETTINGS_SNAPSHOT = 10265;
    ...
    public static final int CROSS_DEVICE_SYNC_EVENT = 1273;
    public static final int CROSS_DEVICE_SYNC_EVENT__EVENT__EVENT_INBOUND_MESSAGE_DROPPED = 4;
    public static final int CROSS_DEVICE_SYNC_EVENT__EVENT__EVENT_INBOUND_MESSAGE_RECEIVED = 3;
    public static final int CROSS_DEVICE_SYNC_EVENT__EVENT__EVENT_INBOUND_SYNC_NOT_CHANGING_LOCAL_STATE = 2;
    public static final int CROSS_DEVICE_SYNC_EVENT__EVENT__EVENT_INBOUND_SYNC_UPDATES_LOCAL_STATE = 1;
    public static final int CROSS_DEVICE_SYNC_EVENT__EVENT__EVENT_MESSAGE_QUEUE_FAILED = 7;
    public static final int CROSS_DEVICE_SYNC_EVENT__EVENT__EVENT_MESSAGE_QUEUE_FINISHED = 6;
    public static final int CROSS_DEVICE_SYNC_EVENT__EVENT__EVENT_MESSAGE_QUEUE_STARTED = 5;
    public static final int CROSS_DEVICE_SYNC_EVENT__EVENT__EVENT_MESSAGE_SEND_FAILED = 10;
    public static final int CROSS_DEVICE_SYNC_EVENT__EVENT__EVENT_MESSAGE_SEND_FINISHED = 9;
    public static final int CROSS_DEVICE_SYNC_EVENT__EVENT__EVENT_MESSAGE_SEND_STARTED = 8;
    public static final int CROSS_DEVICE_SYNC_EVENT__EVENT__EVENT_UNSPECIFIED = 0;
    public static final int CROSS_DEVICE_SYNC_EVENT__FEATURE__FEATURE_AIRPLANE_MODE_SYNC = 2;
    public static final int CROSS_DEVICE_SYNC_EVENT__FEATURE__FEATURE_CONTEXTUAL_MODE_SYNC = 3;
    public static final int CROSS_DEVICE_SYNC_EVENT__FEATURE__FEATURE_METADATA = 1;
    public static final int CROSS_DEVICE_SYNC_EVENT__FEATURE__FEATURE_UNSPECIFIED = 0;
    public static final int CUSTOM_VIBRATION_PATTERN_REPORTED = 1173;
    public static final int CUSTOM_VIBRATION_PATTERN_REPORTED__EVENT_TYPE__UNKNOWN = 0;
    public static final int CUSTOM_VIBRATION_PATTERN_REPORTED__EVENT_TYPE__VIBRATION_PATTERN_PLAYED = 2;
    public static final int CUSTOM_VIBRATION_PATTERN_REPORTED__EVENT_TYPE__VIBRATION_PATTERN_SAVED = 1;
    public static final int DANGEROUS_PERMISSION_STATE = 10050;
    public static final int DANGEROUS_PERMISSION_STATE_SAMPLED = 10067;
    public static final int DATA_LEAK_PREVENTION_EVALUATION_LATENCY_REPORTED = 1412;
    public static final int DATA_LEAK_PREVENTION_EVALUATION_LATENCY_REPORTED__ACTION_TYPE__ACTION_TYPE_DATA_TRANSFER = 1;
    public static final int DATA_LEAK_PREVENTION_EVALUATION_LATENCY_REPORTED__ACTION_TYPE__ACTION_TYPE_UNKNOWN = 0;
    public static final int DATA_LEAK_PREVENTION_EVALUATION_LATENCY_REPORTED__CACHE_STATUS__CACHE_STATUS_BYPASSED = 3;
    public static final int DATA_LEAK_PREVENTION_EVALUATION_LATENCY_REPORTED__CACHE_STATUS__CACHE_STATUS_HIT_CACHE = 1;
    public static final int DATA_LEAK_PREVENTION_EVALUATION_LATENCY_REPORTED__CACHE_STATUS__CACHE_STATUS_MISS_CACHE = 2;
    public static final int DATA_LEAK_PREVENTION_EVALUATION_LATENCY_REPORTED__CACHE_STATUS__CACHE_STATUS_UNKNOWN = 0;
    public static final int DATA_LEAK_PREVENTION_EVALUATION_LATENCY_REPORTED__ENFORCEMENT_ACTION__ENFORCEMENT_ACTION_ALLOW = 1;
    public static final int DATA_LEAK_PREVENTION_EVALUATION_LATENCY_REPORTED__ENFORCEMENT_ACTION__ENFORCEMENT_ACTION_BLOCK = 2;
    public static final int DATA_LEAK_PREVENTION_EVALUATION_LATENCY_REPORTED__ENFORCEMENT_ACTION__ENFORCEMENT_ACTION_UNKNOWN = 0;
    public static final int DATA_LEAK_PREVENTION_EVALUATION_LATENCY_REPORTED__ENFORCEMENT_ACTION__ENFORCEMENT_ACTION_WARN = 3;
    public static final int DATA_LEAK_PREVENTION_STATE = 10275;
    ...
    public static final int DESKTOP_MODE_SESSION_TASK_UPDATE__MINIMIZE_REASON__MINIMIZE_HOME_GESTURE = 6;
    public static final int DESKTOP_MODE_SESSION_TASK_UPDATE__MINIMIZE_REASON__MINIMIZE_KEY_GESTURE = 3;
    public static final int DESKTOP_MODE_SESSION_TASK_UPDATE__MINIMIZE_REASON__MINIMIZE_MULTI_ACTIVITY_PIP = 4;
    public static final int DESKTOP_MODE_SESSION_TASK_UPDATE__MINIMIZE_REASON__MINIMIZE_TASKBAR_ICON_TAP = 5;
    ...
    public static final int DESKTOP_MODE_TASK_SIZE_UPDATED__INPUT_METHOD__ACCESSIBILITY_INPUT_METHOD = 6;
    ...
    public static final int DESKTOP_MODE_UICHANGED__ENTER_REASON__ADB_COMMAND = 8;
    ...
    public static final int DESKTOP_MODE_UICHANGED__ENTER_REASON__APP_SELF_REPOSITION = 13;
    public static final int DESKTOP_MODE_UICHANGED__ENTER_REASON__CLIENT_REQUEST_EXIT_FULLSCREEN = 16;
    public static final int DESKTOP_MODE_UICHANGED__ENTER_REASON__DESK_REPARENT = 12;
    public static final int DESKTOP_MODE_UICHANGED__ENTER_REASON__DISPLAY_CONNECT = 11;
    public static final int DESKTOP_MODE_UICHANGED__ENTER_REASON__EXIT_PIP = 10;
    ...
    public static final int DESKTOP_MODE_UICHANGED__ENTER_REASON__OVERVIEW_TASK_MENU = 7;
    public static final int DESKTOP_MODE_UICHANGED__ENTER_REASON__RECENTS = 9;
    public static final int DESKTOP_MODE_UICHANGED__ENTER_REASON__SCREEN_ON = 6;
    public static final int DESKTOP_MODE_UICHANGED__ENTER_REASON__TASKBAR_ICON = 14;
    public static final int DESKTOP_MODE_UICHANGED__ENTER_REASON__TASK_LAUNCH = 15;
    ...
    public static final int DESKTOP_MODE_UICHANGED__EXIT_REASON__ADB_COMMAND_EXIT = 11;
    public static final int DESKTOP_MODE_UICHANGED__EXIT_REASON__APP_HANDLE_MENU_BUTTON_EXIT = 2;
    public static final int DESKTOP_MODE_UICHANGED__EXIT_REASON__CLIENT_REQUEST_ENTER_FULLSCREEN = 16;
    public static final int DESKTOP_MODE_UICHANGED__EXIT_REASON__DISPLAY_DISCONNECTED = 9;
    public static final int DESKTOP_MODE_UICHANGED__EXIT_REASON__DRAG_TO_EXIT = 1;
    public static final int DESKTOP_MODE_UICHANGED__EXIT_REASON__ENTER_BUBBLE = 15;
    public static final int DESKTOP_MODE_UICHANGED__EXIT_REASON__ENTER_PIP = 14;
    public static final int DESKTOP_MODE_UICHANGED__EXIT_REASON__ENTER_SPLIT = 17;
    public static final int DESKTOP_MODE_UICHANGED__EXIT_REASON__FULLSCREEN_LAUNCH = 10;
    public static final int DESKTOP_MODE_UICHANGED__EXIT_REASON__KEYBOARD_SHORTCUT_EXIT = 3;
    public static final int DESKTOP_MODE_UICHANGED__EXIT_REASON__RECENTS_DISMISS = 13;
    ...
    public static final int DESKTOP_MODE_UICHANGED__EXIT_REASON__TASK_MOVED_FROM_DESK = 12;
    ...
    public static final int DEVICE_PRESENCE_CHANGED = 1080;
    public static final int DEVICE_PRESENCE_CHANGED__DEVICE_PRESENCE_STATUS__NOTIFY_BLE_APPEARED = 1;
    public static final int DEVICE_PRESENCE_CHANGED__DEVICE_PRESENCE_STATUS__NOTIFY_BLE_DISAPPEARED = 2;
    public static final int DEVICE_PRESENCE_CHANGED__DEVICE_PRESENCE_STATUS__NOTIFY_BT_CONNECTED = 3;
    public static final int DEVICE_PRESENCE_CHANGED__DEVICE_PRESENCE_STATUS__NOTIFY_BT_DISCONNECTED = 4;
    public static final int DEVICE_PRESENCE_CHANGED__DEVICE_PRESENCE_STATUS__NOTIFY_SELF_MANAGED_APPEARED = 5;
    public static final int DEVICE_PRESENCE_CHANGED__DEVICE_PRESENCE_STATUS__NOTIFY_SELF_MANAGED_DISAPPEARED = 6;
    public static final int DEVICE_PRESENCE_CHANGED__DEVICE_PRESENCE_STATUS__NOTIFY_UNKNOWN = 0;
    public static final int DEVICE_PRESENCE_CHANGED__DEVICE_PROFILE__DEVICE_PROFILE_APP_STREAMING = 4;
    public static final int DEVICE_PRESENCE_CHANGED__DEVICE_PROFILE__DEVICE_PROFILE_AUTO_PROJECTION = 5;
    public static final int DEVICE_PRESENCE_CHANGED__DEVICE_PROFILE__DEVICE_PROFILE_COMPUTER = 6;
    public static final int DEVICE_PRESENCE_CHANGED__DEVICE_PROFILE__DEVICE_PROFILE_FITNESS_TRACKER = 11;
    public static final int DEVICE_PRESENCE_CHANGED__DEVICE_PROFILE__DEVICE_PROFILE_GLASSES = 7;
    public static final int DEVICE_PRESENCE_CHANGED__DEVICE_PROFILE__DEVICE_PROFILE_NEARBY_DEVICE_STREAMING = 8;
    public static final int DEVICE_PRESENCE_CHANGED__DEVICE_PROFILE__DEVICE_PROFILE_NULL = 2;
    public static final int DEVICE_PRESENCE_CHANGED__DEVICE_PROFILE__DEVICE_PROFILE_UNKNOWN = 0;
    public static final int DEVICE_PRESENCE_CHANGED__DEVICE_PROFILE__DEVICE_PROFILE_UUID = 1;
    public static final int DEVICE_PRESENCE_CHANGED__DEVICE_PROFILE__DEVICE_PROFILE_VIRTUAL_DEVICE = 9;
    public static final int DEVICE_PRESENCE_CHANGED__DEVICE_PROFILE__DEVICE_PROFILE_WATCH = 3;
    public static final int DEVICE_PRESENCE_CHANGED__DEVICE_PROFILE__DEVICE_PROFILE_WEARABLE_SENSING = 10;
    ...
    public static final int DIRECT_RECLAIM_LATENCY = 10278;
    public static final int DIRECT_RECLAIM_LATENCY__PROCESS_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    public static final int DIRECT_RECLAIM_LATENCY__PROCESS_STATE__STATE_CACHED = 8;
    public static final int DIRECT_RECLAIM_LATENCY__PROCESS_STATE__STATE_FOREGROUND = 4;
    public static final int DIRECT_RECLAIM_LATENCY__PROCESS_STATE__STATE_NATIVE = 1;
    public static final int DIRECT_RECLAIM_LATENCY__PROCESS_STATE__STATE_PERCEPTIBLE = 6;
    public static final int DIRECT_RECLAIM_LATENCY__PROCESS_STATE__STATE_PERSISTENT = 3;
    public static final int DIRECT_RECLAIM_LATENCY__PROCESS_STATE__STATE_SERVICE_BACKGROUND = 7;
    public static final int DIRECT_RECLAIM_LATENCY__PROCESS_STATE__STATE_SYSTEM = 2;
    public static final int DIRECT_RECLAIM_LATENCY__PROCESS_STATE__STATE_VISIBLE = 5;
    ...
    public static final int DISPLAY_BRIGHTNESS_CHANGED__BRIGHTNESS_DIRECTION__DIRECTION_DECREASE = 2;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__BRIGHTNESS_DIRECTION__DIRECTION_INCREASE = 1;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__BRIGHTNESS_DIRECTION__DIRECTION_UNKNOWN = 0;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__BUCKET_INDEX__RANGE_0_1 = 1;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__BUCKET_INDEX__RANGE_0_MIN = 100;
    ...
    public static final int DISPLAY_BRIGHTNESS_CHANGED__DISPLAY_POLICY__DISPLAY_POLICY_BRIGHT = 4;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__DISPLAY_POLICY__DISPLAY_POLICY_DIM = 3;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__DISPLAY_POLICY__DISPLAY_POLICY_DOZE = 2;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__DISPLAY_POLICY__DISPLAY_POLICY_OFF = 1;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__DISPLAY_POLICY__DISPLAY_POLICY_UNKNOWN = 0;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__DISPLAY_STATE_REASON__STATE_REASON_DEFAULT_POLICY = 1;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__DISPLAY_STATE_REASON__STATE_REASON_DRAW_WAKE_LOCK = 2;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__DISPLAY_STATE_REASON__STATE_REASON_DREAM_MANAGER = 5;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__DISPLAY_STATE_REASON__STATE_REASON_KEY = 6;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__DISPLAY_STATE_REASON__STATE_REASON_MOTION = 7;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__DISPLAY_STATE_REASON__STATE_REASON_OFFLOAD = 3;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__DISPLAY_STATE_REASON__STATE_REASON_TILT = 4;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__DISPLAY_STATE_REASON__STATE_REASON_UNKNOWN = 0;
    ...
    public static final int DISPLAY_BRIGHTNESS_CHANGED__LUX_BUCKET__LUX_RANGE_01_03 = 2;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__LUX_BUCKET__LUX_RANGE_03_1 = 3;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__LUX_BUCKET__LUX_RANGE_0_01 = 1;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__LUX_BUCKET__LUX_RANGE_100000_INF = 14;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__LUX_BUCKET__LUX_RANGE_10000_30000 = 12;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__LUX_BUCKET__LUX_RANGE_1000_3000 = 10;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__LUX_BUCKET__LUX_RANGE_100_300 = 8;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__LUX_BUCKET__LUX_RANGE_10_30 = 6;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__LUX_BUCKET__LUX_RANGE_1_3 = 4;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__LUX_BUCKET__LUX_RANGE_30000_100000 = 13;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__LUX_BUCKET__LUX_RANGE_3000_10000 = 11;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__LUX_BUCKET__LUX_RANGE_300_1000 = 9;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__LUX_BUCKET__LUX_RANGE_30_100 = 7;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__LUX_BUCKET__LUX_RANGE_3_10 = 5;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__LUX_BUCKET__LUX_RANGE_UNKNOWN = 0;
    ...
    public static final int DISPLAY_BRIGHTNESS_CHANGED__THERMAL_STATUS__THERMAL_STATUS_CRITICAL = 4;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__THERMAL_STATUS__THERMAL_STATUS_EMERGENCY = 5;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__THERMAL_STATUS__THERMAL_STATUS_LIGHT = 1;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__THERMAL_STATUS__THERMAL_STATUS_MODERATE = 2;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__THERMAL_STATUS__THERMAL_STATUS_SEVERE = 3;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__THERMAL_STATUS__THERMAL_STATUS_SHUTDOWN = 6;
    public static final int DISPLAY_BRIGHTNESS_CHANGED__THERMAL_STATUS__THERMAL_STATUS_UNKNOWN = 0;
    public static final int DISPLAY_COMPAT_RESTART_MENU_EVENT_REPORTED = 1134;
    public static final int DISPLAY_COMPAT_RESTART_MENU_EVENT_REPORTED__EVENT__RESTART_MENU_EVENT_APPEARED = 1;
    public static final int DISPLAY_COMPAT_RESTART_MENU_EVENT_REPORTED__EVENT__RESTART_MENU_EVENT_CLICKED = 2;
    public static final int DISPLAY_COMPAT_RESTART_MENU_EVENT_REPORTED__EVENT__RESTART_MENU_EVENT_UNKNOWN = 0;
    public static final int DISPLAY_EVENT_CALLBACK_OCCURRED = 1149;
    public static final int DISPLAY_EVENT_CALLBACK_OCCURRED__EVENT_TYPE__TYPE_DISPLAY_ADDED = 1;
    public static final int DISPLAY_EVENT_CALLBACK_OCCURRED__EVENT_TYPE__TYPE_DISPLAY_BRIGHTNESS_CHANGED = 6;
    public static final int DISPLAY_EVENT_CALLBACK_OCCURRED__EVENT_TYPE__TYPE_DISPLAY_CHANGED = 3;
    public static final int DISPLAY_EVENT_CALLBACK_OCCURRED__EVENT_TYPE__TYPE_DISPLAY_REFRESH_RATE_CHANGED = 4;
    public static final int DISPLAY_EVENT_CALLBACK_OCCURRED__EVENT_TYPE__TYPE_DISPLAY_REMOVED = 2;
    public static final int DISPLAY_EVENT_CALLBACK_OCCURRED__EVENT_TYPE__TYPE_DISPLAY_STATE_CHANGED = 5;
    public static final int DISPLAY_EVENT_CALLBACK_OCCURRED__EVENT_TYPE__TYPE_UNKNOWN = 0;
    ...
    public static final int DISPLAY_INFO_CHANGED = 1174;
    public static final int DISPLAY_INFO_CHANGED__EVENT_SOURCE__EVENT_SOURCE_DISPLAY_MANAGER = 2;
    public static final int DISPLAY_INFO_CHANGED__EVENT_SOURCE__EVENT_SOURCE_DISPLAY_SWAP = 1;
    public static final int DISPLAY_INFO_CHANGED__EVENT_SOURCE__EVENT_SOURCE_OTHER = 4;
    public static final int DISPLAY_INFO_CHANGED__EVENT_SOURCE__EVENT_SOURCE_UNKNOWN = 0;
    public static final int DISPLAY_INFO_CHANGED__EVENT_SOURCE__EVENT_SOURCE_WINDOW_MANAGER = 3;
    ...
    public static final int DISPLAY_OFFLOAD_CYCLE_STATS = 1163;
    public static final int DISPLAY_OFFLOAD_CYCLE_STATS__EXPERIENCE_TYPES__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_FITNESS_TRACKER = 3;
    public static final int DISPLAY_OFFLOAD_CYCLE_STATS__EXPERIENCE_TYPES__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_STATUS_INDICATOR = 2;
    public static final int DISPLAY_OFFLOAD_CYCLE_STATS__EXPERIENCE_TYPES__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_UNSPECIFIED = 0;
    public static final int DISPLAY_OFFLOAD_CYCLE_STATS__EXPERIENCE_TYPES__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_VOICE_INDICATOR = 4;
    public static final int DISPLAY_OFFLOAD_CYCLE_STATS__EXPERIENCE_TYPES__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_WATCHFACE = 1;
    public static final int DISPLAY_OFFLOAD_CYCLE_STATS__RENDERER_TYPES__DISPLAY_OFFLOAD_RENDERER_TYPE_BRIGHTNESS_ONLY = 4;
    public static final int DISPLAY_OFFLOAD_CYCLE_STATS__RENDERER_TYPES__DISPLAY_OFFLOAD_RENDERER_TYPE_CUSTOM = 3;
    public static final int DISPLAY_OFFLOAD_CYCLE_STATS__RENDERER_TYPES__DISPLAY_OFFLOAD_RENDERER_TYPE_PELE = 2;
    public static final int DISPLAY_OFFLOAD_CYCLE_STATS__RENDERER_TYPES__DISPLAY_OFFLOAD_RENDERER_TYPE_REMOTE_COMPOSE = 1;
    public static final int DISPLAY_OFFLOAD_CYCLE_STATS__RENDERER_TYPES__DISPLAY_OFFLOAD_RENDERER_TYPE_TEST = 5;
    public static final int DISPLAY_OFFLOAD_CYCLE_STATS__RENDERER_TYPES__DISPLAY_OFFLOAD_RENDERER_TYPE_UNSPECIFIED = 0;
    public static final int DISPLAY_OFFLOAD_RESET_OCCURRED = 1387;
    public static final int DISPLAY_OFFLOAD_RESET_OCCURRED__RESET_TYPE__DISPLAY_OFFLOAD_RESET_TYPE_HAL_CONNECTED = 1;
    public static final int DISPLAY_OFFLOAD_RESET_OCCURRED__RESET_TYPE__DISPLAY_OFFLOAD_RESET_TYPE_HAL_REQUEST_FAILURE = 2;
    public static final int DISPLAY_OFFLOAD_RESET_OCCURRED__RESET_TYPE__DISPLAY_OFFLOAD_RESET_TYPE_RENDER_SESSION_FAILURE = 3;
    public static final int DISPLAY_OFFLOAD_RESET_OCCURRED__RESET_TYPE__DISPLAY_OFFLOAD_RESET_TYPE_UNSPECIFIED = 0;
    public static final int DISPLAY_OFFLOAD_SESSION_STATS = 1164;
    public static final int DISPLAY_OFFLOAD_SESSION_STATS__EXPERIENCE_TYPE__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_FITNESS_TRACKER = 3;
    public static final int DISPLAY_OFFLOAD_SESSION_STATS__EXPERIENCE_TYPE__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_STATUS_INDICATOR = 2;
    public static final int DISPLAY_OFFLOAD_SESSION_STATS__EXPERIENCE_TYPE__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_UNSPECIFIED = 0;
    public static final int DISPLAY_OFFLOAD_SESSION_STATS__EXPERIENCE_TYPE__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_VOICE_INDICATOR = 4;
    public static final int DISPLAY_OFFLOAD_SESSION_STATS__EXPERIENCE_TYPE__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_WATCHFACE = 1;
    public static final int DISPLAY_OFFLOAD_SESSION_STATS__RENDERER_TYPE__DISPLAY_OFFLOAD_RENDERER_TYPE_BRIGHTNESS_ONLY = 4;
    public static final int DISPLAY_OFFLOAD_SESSION_STATS__RENDERER_TYPE__DISPLAY_OFFLOAD_RENDERER_TYPE_CUSTOM = 3;
    public static final int DISPLAY_OFFLOAD_SESSION_STATS__RENDERER_TYPE__DISPLAY_OFFLOAD_RENDERER_TYPE_PELE = 2;
    public static final int DISPLAY_OFFLOAD_SESSION_STATS__RENDERER_TYPE__DISPLAY_OFFLOAD_RENDERER_TYPE_REMOTE_COMPOSE = 1;
    public static final int DISPLAY_OFFLOAD_SESSION_STATS__RENDERER_TYPE__DISPLAY_OFFLOAD_RENDERER_TYPE_TEST = 5;
    public static final int DISPLAY_OFFLOAD_SESSION_STATS__RENDERER_TYPE__DISPLAY_OFFLOAD_RENDERER_TYPE_UNSPECIFIED = 0;
    public static final int DISPLAY_OFFLOAD_STATE_CHANGED = 1161;
    public static final int DISPLAY_OFFLOAD_STATE_CHANGED__EXPERIENCE_TYPES__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_FITNESS_TRACKER = 3;
    public static final int DISPLAY_OFFLOAD_STATE_CHANGED__EXPERIENCE_TYPES__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_STATUS_INDICATOR = 2;
    public static final int DISPLAY_OFFLOAD_STATE_CHANGED__EXPERIENCE_TYPES__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_UNSPECIFIED = 0;
    public static final int DISPLAY_OFFLOAD_STATE_CHANGED__EXPERIENCE_TYPES__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_VOICE_INDICATOR = 4;
    public static final int DISPLAY_OFFLOAD_STATE_CHANGED__EXPERIENCE_TYPES__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_WATCHFACE = 1;
    public static final int DISPLAY_OFFLOAD_STATE_CHANGED__OFFLOAD_STATE__DISPLAY_OFFLOAD_STATE_BRIGHTNESS_OFFLOADED = 3;
    public static final int DISPLAY_OFFLOAD_STATE_CHANGED__OFFLOAD_STATE__DISPLAY_OFFLOAD_STATE_DEOFFLOADED = 1;
    public static final int DISPLAY_OFFLOAD_STATE_CHANGED__OFFLOAD_STATE__DISPLAY_OFFLOAD_STATE_OFFLOADED = 2;
    public static final int DISPLAY_OFFLOAD_STATE_CHANGED__OFFLOAD_STATE__DISPLAY_OFFLOAD_STATE_UNSPECIFIED = 0;
    public static final int DISPLAY_OFFLOAD_STATE_CHANGED__RENDERER_TYPES__DISPLAY_OFFLOAD_RENDERER_TYPE_BRIGHTNESS_ONLY = 4;
    public static final int DISPLAY_OFFLOAD_STATE_CHANGED__RENDERER_TYPES__DISPLAY_OFFLOAD_RENDERER_TYPE_CUSTOM = 3;
    public static final int DISPLAY_OFFLOAD_STATE_CHANGED__RENDERER_TYPES__DISPLAY_OFFLOAD_RENDERER_TYPE_PELE = 2;
    public static final int DISPLAY_OFFLOAD_STATE_CHANGED__RENDERER_TYPES__DISPLAY_OFFLOAD_RENDERER_TYPE_REMOTE_COMPOSE = 1;
    public static final int DISPLAY_OFFLOAD_STATE_CHANGED__RENDERER_TYPES__DISPLAY_OFFLOAD_RENDERER_TYPE_TEST = 5;
    public static final int DISPLAY_OFFLOAD_STATE_CHANGED__RENDERER_TYPES__DISPLAY_OFFLOAD_RENDERER_TYPE_UNSPECIFIED = 0;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED = 1162;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__AGGREGATION_LEVEL__DISPLAY_OFFLOAD_AGGREGATION_LEVEL_PER_OFFLOAD_CYCLE = 1;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__AGGREGATION_LEVEL__DISPLAY_OFFLOAD_AGGREGATION_LEVEL_PER_RENDER_SESSION = 2;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__AGGREGATION_LEVEL__DISPLAY_OFFLOAD_AGGREGATION_LEVEL_UNSPECIFIED = 0;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__EXPERIENCE_TYPES__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_FITNESS_TRACKER = 3;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__EXPERIENCE_TYPES__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_STATUS_INDICATOR = 2;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__EXPERIENCE_TYPES__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_UNSPECIFIED = 0;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__EXPERIENCE_TYPES__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_VOICE_INDICATOR = 4;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__EXPERIENCE_TYPES__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_WATCHFACE = 1;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__EXPERIENCE_TYPE__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_FITNESS_TRACKER = 3;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__EXPERIENCE_TYPE__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_STATUS_INDICATOR = 2;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__EXPERIENCE_TYPE__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_UNSPECIFIED = 0;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__EXPERIENCE_TYPE__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_VOICE_INDICATOR = 4;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__EXPERIENCE_TYPE__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_WATCHFACE = 1;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__RENDERER_TYPES__DISPLAY_OFFLOAD_RENDERER_TYPE_BRIGHTNESS_ONLY = 4;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__RENDERER_TYPES__DISPLAY_OFFLOAD_RENDERER_TYPE_CUSTOM = 3;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__RENDERER_TYPES__DISPLAY_OFFLOAD_RENDERER_TYPE_PELE = 2;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__RENDERER_TYPES__DISPLAY_OFFLOAD_RENDERER_TYPE_REMOTE_COMPOSE = 1;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__RENDERER_TYPES__DISPLAY_OFFLOAD_RENDERER_TYPE_TEST = 5;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__RENDERER_TYPES__DISPLAY_OFFLOAD_RENDERER_TYPE_UNSPECIFIED = 0;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__RENDERER_TYPE__DISPLAY_OFFLOAD_RENDERER_TYPE_BRIGHTNESS_ONLY = 4;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__RENDERER_TYPE__DISPLAY_OFFLOAD_RENDERER_TYPE_CUSTOM = 3;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__RENDERER_TYPE__DISPLAY_OFFLOAD_RENDERER_TYPE_PELE = 2;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__RENDERER_TYPE__DISPLAY_OFFLOAD_RENDERER_TYPE_REMOTE_COMPOSE = 1;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__RENDERER_TYPE__DISPLAY_OFFLOAD_RENDERER_TYPE_TEST = 5;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__RENDERER_TYPE__DISPLAY_OFFLOAD_RENDERER_TYPE_UNSPECIFIED = 0;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__TRANSITION_RESULT__DISPLAY_OFFLOAD_TRANSITION_RESULT_ABORTED = 2;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__TRANSITION_RESULT__DISPLAY_OFFLOAD_TRANSITION_RESULT_COMPLETE = 1;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__TRANSITION_RESULT__DISPLAY_OFFLOAD_TRANSITION_RESULT_UNSPECIFIED = 0;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__TRANSITION_TYPE__DISPLAY_OFFLOAD_TRANSITION_TYPE_DEOFFLOAD_FINALIZATION = 3;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__TRANSITION_TYPE__DISPLAY_OFFLOAD_TRANSITION_TYPE_OFFLOAD_FINALIZATION = 2;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__TRANSITION_TYPE__DISPLAY_OFFLOAD_TRANSITION_TYPE_OFFLOAD_STATE_TRANSMISSION = 1;
    public static final int DISPLAY_OFFLOAD_TRANSITION_REPORTED__TRANSITION_TYPE__DISPLAY_OFFLOAD_TRANSITION_TYPE_UNSPECIFIED = 0;
    public static final int DISPLAY_SWITCH_TO_AP_ISSUED = 1245;
    public static final int DISPLAY_WAKE_REPORTED = 282;
    public static final int DMABUF_REQUEST_SIZES = 10281;
    public static final int DMABUF_STATS = 10256;
    ...
    public static final int DNDMODE_PROTO__RULE_TYPE__TYPE_TRANSIT = 8;
    ...
    public static final int DNDSTATE_CHANGED__ACTIVE_RULE_TYPES__TYPE_TRANSIT = 8;
    ...
    public static final int ETHERNET_BYTES_TRANSFER = 10249;
    ...
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_ACCESS_HID = 178;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_ACCESS_LOCAL_NETWORK = 169;
    ...
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_COMPUTER_CONTROL = 167;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_CONTINUE_ACROSS_DEVICES = 174;
    ...
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_MANAGE_ASSISTANT_AUDIO = 181;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_MANAGE_CONTACTS = 180;
    ...
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_MANAGE_PERIPHERAL_CUSTOMIZATION = 179;
    ...
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_BLOOD_PRESSURE = 170;
    ...
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_CELL_IDENTITY = 165;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_CELL_INFO = 166;
    ...
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_HEART_RATE_VARIABILITY = 171;
    ...
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_OTP_SMS = 168;
    ...
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_RESPIRATORY_RATE = 172;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_RESTRICTED_MESSAGES = 176;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_SCREEN_CONTEXT = 175;
    ...
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_READ_VO2_MAX = 173;
    ...
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_START_ACTIVITIES_ON_LOGIN_SCREEN = 182;
    ...
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_WRITE_RESTRICTED_MESSAGES = 177;
    ...
    public static final int FOREGROUND_SERVICE_STATE_CHANGED__CALLING_UID_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    public static final int FOREGROUND_SERVICE_STATE_CHANGED__FGS_NOTIFICATION_PERMISSION_STATE__FGS_NOTIFICATION_PERMISSION_DECLARED_AND_GRANTED = 3;
    public static final int FOREGROUND_SERVICE_STATE_CHANGED__FGS_NOTIFICATION_PERMISSION_STATE__FGS_NOTIFICATION_PERMISSION_DECLARED_BUT_DENIED = 2;
    public static final int FOREGROUND_SERVICE_STATE_CHANGED__FGS_NOTIFICATION_PERMISSION_STATE__FGS_NOTIFICATION_PERMISSION_NOT_DECLARED = 1;
    public static final int FOREGROUND_SERVICE_STATE_CHANGED__FGS_NOTIFICATION_PERMISSION_STATE__FGS_NOTIFICATION_PERMISSION_UNKNOWN = 0;
    ...
    public static final int FOREGROUND_SERVICE_STATE_CHANGED__SERVICE_UID_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int FRAMEWORK_WAKELOCK_INFO__TYPE__PARTIAL_SLEEP_WAKE_LOCK = 512;
    ...
    public static final int FULL_BATTERY_DESIGN_CAPACITY = 10246;
    ...
    public static final int GPU_HEADROOM_REPORTED = 1053;
    public static final int GPU_HEADROOM_REPORTED__STATUS__HAL_ERROR = 5;
    public static final int GPU_HEADROOM_REPORTED__STATUS__SUCCESS = 1;
    public static final int GPU_HEADROOM_REPORTED__STATUS__UNKNOWN_STATUS = 0;
    public static final int GPU_HEADROOM_REPORTED__TYPE__AVERAGE = 2;
    public static final int GPU_HEADROOM_REPORTED__TYPE__MIN = 1;
    public static final int GPU_HEADROOM_REPORTED__TYPE__UNKNOWN_CALCULATION_TYPE = 0;
    public static final int HALF_ANR_OCCURRED = 1366;
    public static final int HANDOFF_REQUESTED = 1242;
    public static final int HANDOFF_REQUEST_FINISHED = 1243;
    public static final int HANDOFF_REQUEST_FINISHED__STATUS_CODE__STATUS_CODE_FAILURE_NO_DATA_PROVIDED_BY_TASK = 2;
    public static final int HANDOFF_REQUEST_FINISHED__STATUS_CODE__STATUS_CODE_FAILURE_TASK_NOT_FOUND = 3;
    public static final int HANDOFF_REQUEST_FINISHED__STATUS_CODE__STATUS_CODE_FAILURE_TIMEOUT = 4;
    public static final int HANDOFF_REQUEST_FINISHED__STATUS_CODE__STATUS_CODE_SUCCESS = 1;
    public static final int HANDOFF_REQUEST_FINISHED__STATUS_CODE__STATUS_CODE_UNKNOWN = 0;
    ...
    public static final int HDR_CAPABILITIES__FORCE_HDR_FORMAT__HDR_TYPE_HLG_PLUS = 6;
    ...
    public static final int IME_REQUEST_FINISHED__ORIGIN__ORIGIN_SHELL = 8;
    ...
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_CLIENT_INSETS_CONTROLLER_DISPATCH = 80;
    ...
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_IME_NOTIFY_IME_VISIBILITY_CHANGED = 52;
    ...
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_ABORT_SHOW_IME_POST_LAYOUT = 43;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_ACCESSIBILITY = 4;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_ALREADY_VISIBLE = 79;
    ...
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_DISPATCH_IME_REQUESTED_CHANGED = 60;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_GET_CONTROL_WITH_LEASH = 55;
    ...
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_INVOKING_IME_REQUESTED_LISTENER = 64;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_NOTIFY_HIDE_ANIMATION_FINISHED = 74;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_NOTIFY_IME_VISIBILITY_CHANGED_FROM_CLIENT = 62;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_NO_IME_INSETS_SOURCE_PROVIDER = 81;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_POSTING_CHANGED_IME_VISIBILITY = 63;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_POST_LAYOUT_NOTIFY_CONTROLS_CHANGED = 50;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_REMOTE_INSETS_CONTROL_TARGET_SHOW_INSETS = 23;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_REQUESTED_VISIBLE_TYPES_NOT_CHANGED = 70;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_SET_REMOTE_TARGET_IME_VISIBILITY = 49;
    ...
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_UPDATE_ANIMATING_TYPES = 72;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_UPDATE_CLIENT_VISIBILITY = 67;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_UPDATE_DISPLAY_WINDOW_ANIMATING_TYPES = 75;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_UPDATE_DISPLAY_WINDOW_REQUESTED_VISIBLE_TYPES = 69;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_UPDATE_REQUESTED_VISIBLE_TYPES = 56;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_WAIT_IME = 8;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_WINDOW_ANIMATING_TYPES_CHANGED = 73;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_WINDOW_INSETS_CONTROL_TARGET_HIDE_INSETS = 22;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_WINDOW_INSETS_CONTROL_TARGET_SHOW_INSETS = 21;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SHELL_ANIMATION_CREATE = 26;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SHELL_ANIMATION_RUNNING = 27;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SHELL_DISPLAY_IME_CONTROLLER_SET_IME_REQUESTED_VISIBLE = 68;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SHELL_REMOTE_INSETS_CONTROLLER = 25;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SHELL_REMOTE_INSETS_CONTROL_TARGET_HIDE_INSETS = 24;
    ...
    public static final int IME_REQUEST_FINISHED__REASON__REASON_HIDE_FOR_BUBBLES_WHEN_LOCKED = 60;
    ...
    public static final int IMPLICIT_URI_GRANT_EVENT_REPORTED = 1088;
    public static final int IMPLICIT_URI_GRANT_EVENT_REPORTED__ACCESS_TYPE__ACCESS_TYPE_UNKNOWN = 0;
    public static final int IMPLICIT_URI_GRANT_EVENT_REPORTED__ACCESS_TYPE__READ = 1;
    public static final int IMPLICIT_URI_GRANT_EVENT_REPORTED__ACCESS_TYPE__WRITE = 2;
    public static final int IMPLICIT_URI_GRANT_EVENT_REPORTED__ACTION_TYPE__ACTION_TYPE_UNKNOWN = 0;
    public static final int IMPLICIT_URI_GRANT_EVENT_REPORTED__ACTION_TYPE__IMAGE_CAPTURE = 3;
    public static final int IMPLICIT_URI_GRANT_EVENT_REPORTED__ACTION_TYPE__SEND = 1;
    public static final int IMPLICIT_URI_GRANT_EVENT_REPORTED__ACTION_TYPE__SEND_MULTIPLE = 2;
    public static final int IMPLICIT_URI_GRANT_EVENT_REPORTED__GRANT_TYPE__GRANTED = 1;
    public static final int IMPLICIT_URI_GRANT_EVENT_REPORTED__GRANT_TYPE__GRANT_TYPE_UNKNOWN = 0;
    public static final int IMPLICIT_URI_GRANT_EVENT_REPORTED__GRANT_TYPE__RESTRICTED = 2;
    public static final int INIT_APP_SCAN_REPORTED = 1171;
    public static final int INIT_APP_SCAN_REPORTED__FAST_TRACK_STATUS__FAST_TRACK_STATUS_FAILURE_DIGEST_MISMATCH = 3;
    public static final int INIT_APP_SCAN_REPORTED__FAST_TRACK_STATUS__FAST_TRACK_STATUS_FAILURE_MISSING_SIDECAR = 2;
    public static final int INIT_APP_SCAN_REPORTED__FAST_TRACK_STATUS__FAST_TRACK_STATUS_FAILURE_READ_ERROR = 4;
    public static final int INIT_APP_SCAN_REPORTED__FAST_TRACK_STATUS__FAST_TRACK_STATUS_SUCCESS = 1;
    public static final int INIT_APP_SCAN_REPORTED__FAST_TRACK_STATUS__FAST_TRACK_STATUS_UNSPECIFIED = 0;
    public static final int INIT_APP_SCAN_REPORTED__INIT_APP_SCAN_OUTCOME__FAILURE_CERTIFICATE_ENCODING = 6;
    public static final int INIT_APP_SCAN_REPORTED__INIT_APP_SCAN_OUTCOME__FAILURE_INCONSISTENT_CERTIFICATES = 5;
    public static final int INIT_APP_SCAN_REPORTED__INIT_APP_SCAN_OUTCOME__FAILURE_NO_CERTIFICATES = 2;
    public static final int INIT_APP_SCAN_REPORTED__INIT_APP_SCAN_OUTCOME__FAILURE_OTHER = 8;
    public static final int INIT_APP_SCAN_REPORTED__INIT_APP_SCAN_OUTCOME__FAILURE_SCAN_VALIDATION = 7;
    public static final int INIT_APP_SCAN_REPORTED__INIT_APP_SCAN_OUTCOME__FAILURE_UPDATE_INCOMPATIBLE = 4;
    public static final int INIT_APP_SCAN_REPORTED__INIT_APP_SCAN_OUTCOME__FAILURE_VERIFICATION = 3;
    public static final int INIT_APP_SCAN_REPORTED__INIT_APP_SCAN_OUTCOME__SUCCESS = 1;
    public static final int INIT_APP_SCAN_REPORTED__INIT_APP_SCAN_OUTCOME__UNSPECIFIED = 0;
    public static final int INIT_APP_SCAN_REPORTED__SIGNATURE_SCHEME_VERSION__JAR = 1;
    public static final int INIT_APP_SCAN_REPORTED__SIGNATURE_SCHEME_VERSION__UNKNOWN = 0;
    public static final int INIT_APP_SCAN_REPORTED__SIGNATURE_SCHEME_VERSION__V2 = 2;
    public static final int INIT_APP_SCAN_REPORTED__SIGNATURE_SCHEME_VERSION__V3 = 3;
    public static final int INIT_APP_SCAN_REPORTED__SIGNATURE_SCHEME_VERSION__V4 = 4;
    ...
    public static final int INPUT_DEVICE_USAGE_REPORTED__DEVICE_BUS__VIRTUAL = 4;
    ...
    public static final int INPUT_UNFINISHED_MOTION_EVENT_REPORTED = 1278;
    ...
    public static final int KERNEL_WAKEUP_ATTRIBUTED__PROCESS_STATES__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int KEYBOARD_CONFIGURED__DEVICE_BUS__VIRTUAL = 4;
    ...
    public static final int KEYBOARD_SYSTEMS_EVENT_REPORTED__DEVICE_BUS__VIRTUAL = 4;
    ...
    public static final int KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__QUIT_FOCUSED_DESKTOP_TASK = 58;
    ...
    public static final int KEYBOARD_SYSTEMS_EVENT_REPORTED__KEYBOARD_SYSTEM_EVENT__TOGGLE_FULLSCREEN = 59;
    ...
    public static final int KEYSTORE2_KEYS_PER_UID = 10248;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID = 10267;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__ALGORITHM__ALGORITHM_AES = 32;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__ALGORITHM__ALGORITHM_EC = 3;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__ALGORITHM__ALGORITHM_HMAC = 128;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__ALGORITHM__ALGORITHM_ML_DSA65 = 5;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__ALGORITHM__ALGORITHM_ML_DSA87 = 6;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__ALGORITHM__ALGORITHM_RSA = 1;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__ALGORITHM__ALGORITHM_TRIPLE_DES = 33;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__ALGORITHM__ALGORITHM_UNSPECIFIED = 0;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__AUTH_TIMEOUT__AUTH_TIMEOUT_NONE = 1;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__AUTH_TIMEOUT__AUTH_TIMEOUT_OVER_ONE_DAY = 9;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__AUTH_TIMEOUT__AUTH_TIMEOUT_PER_OP = 2;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__AUTH_TIMEOUT__AUTH_TIMEOUT_UNSPECIFIED = 0;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__AUTH_TIMEOUT__AUTH_TIMEOUT_WITHIN_FIVE_MIN = 6;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__AUTH_TIMEOUT__AUTH_TIMEOUT_WITHIN_ONE_DAY = 8;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__AUTH_TIMEOUT__AUTH_TIMEOUT_WITHIN_ONE_HOUR = 7;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__AUTH_TIMEOUT__AUTH_TIMEOUT_WITHIN_ONE_MIN = 5;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__AUTH_TIMEOUT__AUTH_TIMEOUT_WITHIN_ONE_SEC = 3;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__AUTH_TIMEOUT__AUTH_TIMEOUT_WITHIN_TEN_SEC = 4;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__SECURITY_LEVEL__SECURITY_LEVEL_KEYSTORE = 4;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__SECURITY_LEVEL__SECURITY_LEVEL_SOFTWARE = 1;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__SECURITY_LEVEL__SECURITY_LEVEL_STRONGBOX = 3;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__SECURITY_LEVEL__SECURITY_LEVEL_TRUSTED_ENVIRONMENT = 2;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__SECURITY_LEVEL__SECURITY_LEVEL_UNSPECIFIED = 0;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__USER_AUTH_TYPE__AUTH_ANY = 5;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__USER_AUTH_TYPE__AUTH_FINGERPRINT = 3;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__USER_AUTH_TYPE__AUTH_NONE = 1;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__USER_AUTH_TYPE__AUTH_NO_TYPE = 6;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__USER_AUTH_TYPE__AUTH_PASSWORD = 2;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__USER_AUTH_TYPE__AUTH_PASSWORD_OR_FINGERPRINT = 4;
    public static final int KEYSTORE2_KEY_CREATION_PER_UID__USER_AUTH_TYPE__AUTH_TYPE_UNSPECIFIED = 0;
    ...
    public static final int KEYSTORE2_KEY_CREATION_WITH_GENERAL_INFO__ALGORITHM__ALGORITHM_AES = 32;
    public static final int KEYSTORE2_KEY_CREATION_WITH_GENERAL_INFO__ALGORITHM__ALGORITHM_EC = 3;
    public static final int KEYSTORE2_KEY_CREATION_WITH_GENERAL_INFO__ALGORITHM__ALGORITHM_HMAC = 128;
    public static final int KEYSTORE2_KEY_CREATION_WITH_GENERAL_INFO__ALGORITHM__ALGORITHM_ML_DSA65 = 5;
    public static final int KEYSTORE2_KEY_CREATION_WITH_GENERAL_INFO__ALGORITHM__ALGORITHM_ML_DSA87 = 6;
    public static final int KEYSTORE2_KEY_CREATION_WITH_GENERAL_INFO__ALGORITHM__ALGORITHM_RSA = 1;
    public static final int KEYSTORE2_KEY_CREATION_WITH_GENERAL_INFO__ALGORITHM__ALGORITHM_TRIPLE_DES = 33;
    public static final int KEYSTORE2_KEY_CREATION_WITH_GENERAL_INFO__ALGORITHM__ALGORITHM_UNSPECIFIED = 0;
    public static final int KEYSTORE2_KEY_CREATION_WITH_GENERAL_INFO__EC_CURVE__EC_CURVE_25519 = 5;
    public static final int KEYSTORE2_KEY_CREATION_WITH_GENERAL_INFO__EC_CURVE__EC_CURVE_P_224 = 1;
    public static final int KEYSTORE2_KEY_CREATION_WITH_GENERAL_INFO__EC_CURVE__EC_CURVE_P_256 = 2;
    public static final int KEYSTORE2_KEY_CREATION_WITH_GENERAL_INFO__EC_CURVE__EC_CURVE_P_384 = 3;
    public static final int KEYSTORE2_KEY_CREATION_WITH_GENERAL_INFO__EC_CURVE__EC_CURVE_P_521 = 4;
    ...
    public static final int KEYSTORE2_KEY_CREATION_WITH_PURPOSE_AND_MODES_INFO__ALGORITHM__ALGORITHM_AES = 32;
    public static final int KEYSTORE2_KEY_CREATION_WITH_PURPOSE_AND_MODES_INFO__ALGORITHM__ALGORITHM_EC = 3;
    public static final int KEYSTORE2_KEY_CREATION_WITH_PURPOSE_AND_MODES_INFO__ALGORITHM__ALGORITHM_HMAC = 128;
    public static final int KEYSTORE2_KEY_CREATION_WITH_PURPOSE_AND_MODES_INFO__ALGORITHM__ALGORITHM_ML_DSA65 = 5;
    public static final int KEYSTORE2_KEY_CREATION_WITH_PURPOSE_AND_MODES_INFO__ALGORITHM__ALGORITHM_ML_DSA87 = 6;
    public static final int KEYSTORE2_KEY_CREATION_WITH_PURPOSE_AND_MODES_INFO__ALGORITHM__ALGORITHM_RSA = 1;
    public static final int KEYSTORE2_KEY_CREATION_WITH_PURPOSE_AND_MODES_INFO__ALGORITHM__ALGORITHM_TRIPLE_DES = 33;
    public static final int KEYSTORE2_KEY_CREATION_WITH_PURPOSE_AND_MODES_INFO__ALGORITHM__ALGORITHM_UNSPECIFIED = 0;
    public static final int KEYSTORE2_KEY_OPERATION_PER_UID = 10268;
    public static final int KEYSTORE2_KEY_OPERATION_PER_UID__SECURITY_LEVEL__SECURITY_LEVEL_KEYSTORE = 4;
    public static final int KEYSTORE2_KEY_OPERATION_PER_UID__SECURITY_LEVEL__SECURITY_LEVEL_SOFTWARE = 1;
    public static final int KEYSTORE2_KEY_OPERATION_PER_UID__SECURITY_LEVEL__SECURITY_LEVEL_STRONGBOX = 3;
    public static final int KEYSTORE2_KEY_OPERATION_PER_UID__SECURITY_LEVEL__SECURITY_LEVEL_TRUSTED_ENVIRONMENT = 2;
    public static final int KEYSTORE2_KEY_OPERATION_PER_UID__SECURITY_LEVEL__SECURITY_LEVEL_UNSPECIFIED = 0;
    public static final int KEYSTORE2_KEY_OPERATION_STREAMING_STATS = 10271;
    public static final int KEYSTORE2_KEY_OPERATION_STREAMING_STATS__ALGORITHM__ALGORITHM_AES = 32;
    public static final int KEYSTORE2_KEY_OPERATION_STREAMING_STATS__ALGORITHM__ALGORITHM_EC = 3;
    public static final int KEYSTORE2_KEY_OPERATION_STREAMING_STATS__ALGORITHM__ALGORITHM_HMAC = 128;
    public static final int KEYSTORE2_KEY_OPERATION_STREAMING_STATS__ALGORITHM__ALGORITHM_ML_DSA65 = 5;
    public static final int KEYSTORE2_KEY_OPERATION_STREAMING_STATS__ALGORITHM__ALGORITHM_ML_DSA87 = 6;
    public static final int KEYSTORE2_KEY_OPERATION_STREAMING_STATS__ALGORITHM__ALGORITHM_RSA = 1;
    public static final int KEYSTORE2_KEY_OPERATION_STREAMING_STATS__ALGORITHM__ALGORITHM_TRIPLE_DES = 33;
    public static final int KEYSTORE2_KEY_OPERATION_STREAMING_STATS__ALGORITHM__ALGORITHM_UNSPECIFIED = 0;
    ...
    public static final int KEYSTORE2_OPERATION_LATENCY = 10270;
    public static final int KEYSTORE2_OPERATION_LATENCY__ALGORITHM__ALGORITHM_AES = 32;
    public static final int KEYSTORE2_OPERATION_LATENCY__ALGORITHM__ALGORITHM_EC = 3;
    public static final int KEYSTORE2_OPERATION_LATENCY__ALGORITHM__ALGORITHM_HMAC = 128;
    public static final int KEYSTORE2_OPERATION_LATENCY__ALGORITHM__ALGORITHM_ML_DSA65 = 5;
    public static final int KEYSTORE2_OPERATION_LATENCY__ALGORITHM__ALGORITHM_ML_DSA87 = 6;
    public static final int KEYSTORE2_OPERATION_LATENCY__ALGORITHM__ALGORITHM_RSA = 1;
    public static final int KEYSTORE2_OPERATION_LATENCY__ALGORITHM__ALGORITHM_TRIPLE_DES = 33;
    public static final int KEYSTORE2_OPERATION_LATENCY__ALGORITHM__ALGORITHM_UNSPECIFIED = 0;
    public static final int KEYSTORE2_OPERATION_LATENCY__EC_CURVE__EC_CURVE_25519 = 5;
    public static final int KEYSTORE2_OPERATION_LATENCY__EC_CURVE__EC_CURVE_P_224 = 1;
    public static final int KEYSTORE2_OPERATION_LATENCY__EC_CURVE__EC_CURVE_P_256 = 2;
    public static final int KEYSTORE2_OPERATION_LATENCY__EC_CURVE__EC_CURVE_P_384 = 3;
    public static final int KEYSTORE2_OPERATION_LATENCY__EC_CURVE__EC_CURVE_P_521 = 4;
    public static final int KEYSTORE2_OPERATION_LATENCY__EC_CURVE__EC_CURVE_UNSPECIFIED = 0;
    public static final int KEYSTORE2_OPERATION_LATENCY__OPERATION_TYPE__CREATE_OPERATION = 4;
    public static final int KEYSTORE2_OPERATION_LATENCY__OPERATION_TYPE__ENTIRE_OPERATION = 5;
    public static final int KEYSTORE2_OPERATION_LATENCY__OPERATION_TYPE__GENERATE_KEY = 1;
    public static final int KEYSTORE2_OPERATION_LATENCY__OPERATION_TYPE__IMPORT_KEY = 2;
    public static final int KEYSTORE2_OPERATION_LATENCY__OPERATION_TYPE__IMPORT_WRAPPED_KEY = 3;
    public static final int KEYSTORE2_OPERATION_LATENCY__OPERATION_TYPE__UNSPECIFIED = 0;
    public static final int KEYSTORE2_OPERATION_LATENCY__SECURITY_LEVEL__SECURITY_LEVEL_KEYSTORE = 4;
    public static final int KEYSTORE2_OPERATION_LATENCY__SECURITY_LEVEL__SECURITY_LEVEL_SOFTWARE = 1;
    public static final int KEYSTORE2_OPERATION_LATENCY__SECURITY_LEVEL__SECURITY_LEVEL_STRONGBOX = 3;
    public static final int KEYSTORE2_OPERATION_LATENCY__SECURITY_LEVEL__SECURITY_LEVEL_TRUSTED_ENVIRONMENT = 2;
    public static final int KEYSTORE2_OPERATION_LATENCY__SECURITY_LEVEL__SECURITY_LEVEL_UNSPECIFIED = 0;
    public static final int KEYSTORE2_POST_PROCESSOR_INFO = 10266;
    public static final int KEYSTORE2_POST_PROCESSOR_INFO__RESULT__RESULT_DECODE_ERROR = 4;
    public static final int KEYSTORE2_POST_PROCESSOR_INFO__RESULT__RESULT_NON_FATAL_FAILURE = 2;
    public static final int KEYSTORE2_POST_PROCESSOR_INFO__RESULT__RESULT_SERVER_ERROR = 3;
    public static final int KEYSTORE2_POST_PROCESSOR_INFO__RESULT__RESULT_SUCCESS = 1;
    public static final int KEYSTORE2_POST_PROCESSOR_INFO__RESULT__RESULT_UNKNOWN = 0;
    ...
    public static final int KSWAPD_LATENCY = 10277;
    ...
    public static final int LMK_KILL_OCCURRED__REASON__VENDOR_KILL_REASON1 = 1000;
    public static final int LMK_KILL_OCCURRED__REASON__VENDOR_KILL_REASON10 = 1009;
    public static final int LMK_KILL_OCCURRED__REASON__VENDOR_KILL_REASON2 = 1001;
    public static final int LMK_KILL_OCCURRED__REASON__VENDOR_KILL_REASON3 = 1002;
    public static final int LMK_KILL_OCCURRED__REASON__VENDOR_KILL_REASON4 = 1003;
    public static final int LMK_KILL_OCCURRED__REASON__VENDOR_KILL_REASON5 = 1004;
    public static final int LMK_KILL_OCCURRED__REASON__VENDOR_KILL_REASON6 = 1005;
    public static final int LMK_KILL_OCCURRED__REASON__VENDOR_KILL_REASON7 = 1006;
    public static final int LMK_KILL_OCCURRED__REASON__VENDOR_KILL_REASON8 = 1007;
    public static final int LMK_KILL_OCCURRED__REASON__VENDOR_KILL_REASON9 = 1008;
    ...
    public static final int LOCATION_MLS_VIOLATION_OBSERVED = 1349;
    ...
    public static final int LSKF_AUTHENTICATION_ATTEMPTED = 1099;
    public static final int LSKF_AUTHENTICATION_ATTEMPTED__CREDENTIAL_TYPE__PASSWORD = 2;
    public static final int LSKF_AUTHENTICATION_ATTEMPTED__CREDENTIAL_TYPE__PATTERN = 1;
    public static final int LSKF_AUTHENTICATION_ATTEMPTED__CREDENTIAL_TYPE__PIN = 3;
    public static final int LSKF_AUTHENTICATION_ATTEMPTED__CREDENTIAL_TYPE__UNIFIED_PROFILE_PASSWORD = 4;
    public static final int LSKF_AUTHENTICATION_ATTEMPTED__CREDENTIAL_TYPE__UNKNOWN_TYPE = 0;
    public static final int LSKF_AUTHENTICATION_ATTEMPTED__HARDWARE_RATE_LIMITER__GATEKEEPER = 1;
    public static final int LSKF_AUTHENTICATION_ATTEMPTED__HARDWARE_RATE_LIMITER__UNSPECIFIED_RATELIMITER = 0;
    public static final int LSKF_AUTHENTICATION_ATTEMPTED__HARDWARE_RATE_LIMITER__WEAVER = 2;
    ...
    public static final int MEDIA_PROJECTION_STATE_CHANGED__PREVIOUS_STATE__MEDIA_PROJECTION_STATE_DISPLAY_SELECTED = 9;
    ...
    public static final int MEDIA_PROJECTION_STATE_CHANGED__STATE__MEDIA_PROJECTION_STATE_DISPLAY_SELECTED = 9;
    ...
    public static final int MEDIA_PROJECTION_TARGET_CHANGED__TARGET_TYPE__TARGET_TYPE_APP_CONTENT = 4;
    ...
    public static final int MEMCG_MEMORY_EXCEED_THRESHOLD_EVENT = 1231;
    public static final int MEMCG_MEMORY_HIGH_WATER_MARK_SNAPSHOT = 10252;
    public static final int MEMCG_MEMORY_PROCESS_KILL_EVENT = 1256;
    public static final int MEMCG_MEMORY_PROCESS_KILL_EVENT__KILL_REASON__ANON_MEMORY_BREACH = 1;
    public static final int MEMCG_MEMORY_PROCESS_KILL_EVENT__KILL_REASON__TOTAL_MEMCG_MEMORY_BREACH = 2;
    public static final int MEMCG_MEMORY_PROCESS_KILL_EVENT__KILL_REASON__UNKNOWN_BREACH = 0;
    public static final int MEMCG_MEMORY_SNAPSHOT = 10251;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT = 10257;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_BACKUP = 1008;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE = 1004;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_BOUND_TOP = 1020;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY = 1015;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT = 1016;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_CACHED_EMPTY = 1018;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_CACHED_RECENT = 1017;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_FOREGROUND_SERVICE = 1003;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_HEAVY_WEIGHT = 1012;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_HOME = 1013;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND = 1006;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND = 1005;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_LAST_ACTIVITY = 1014;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_NONEXISTENT = 1019;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_PERSISTENT = 1000;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_PERSISTENT_UI = 1001;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_RECEIVER = 1010;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_SERVICE = 1009;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_TOP = 1002;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_TOP_SLEEPING = 1011;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND = 1007;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_UNKNOWN = 999;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_UNKNOWN_TO_PROTO = 998;
    public static final int MEMCG_MEMORY_STAT_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT = 10276;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_BACKUP = 1008;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE = 1004;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_BOUND_TOP = 1020;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY = 1015;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT = 1016;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_CACHED_EMPTY = 1018;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_CACHED_RECENT = 1017;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_FOREGROUND_SERVICE = 1003;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_HEAVY_WEIGHT = 1012;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_HOME = 1013;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND = 1006;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND = 1005;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_LAST_ACTIVITY = 1014;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_NONEXISTENT = 1019;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_PERSISTENT = 1000;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_PERSISTENT_UI = 1001;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_RECEIVER = 1010;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_SERVICE = 1009;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_TOP = 1002;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_TOP_SLEEPING = 1011;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND = 1007;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_UNKNOWN = 999;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_UNKNOWN_TO_PROTO = 998;
    public static final int MEMCG_UID_MEMORY_SNAPSHOT__UID_PROCESS_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int MEMORY_LIMITER_OVER_LIMIT_EVENT = 1272;
    public static final int MEMORY_LIMITER_OVER_LIMIT_EVENT__TYPE__HIGH = 1;
    public static final int MEMORY_LIMITER_OVER_LIMIT_EVENT__TYPE__LIMIT_TYPE_ANON_SWAP = 4;
    public static final int MEMORY_LIMITER_OVER_LIMIT_EVENT__TYPE__LIMIT_TYPE_HIGH = 2;
    public static final int MEMORY_LIMITER_OVER_LIMIT_EVENT__TYPE__LIMIT_TYPE_SWAP = 3;
    public static final int MEMORY_LIMITER_OVER_LIMIT_EVENT__TYPE__UNKNOWN = 0;
    ...
    public static final int MOBILE_BYTES_TRANSFER_BY_PROC_STATE__PROC_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int NATIVE_RELRO_RESERVATION_REPORTED = 1391;
    public static final int NATIVE_SUBSPECIES_ZYGOTE_FORKED = 1356;
    public static final int NATIVE_ZYGOTE_STARTED = 1267;
    ...
    public static final int NOTIFICATION_ADJUSTMENT_PREFERENCES = 10231;
    public static final int NOTIFICATION_ADJUSTMENT_PREFERENCES__ALLOWED_BUNDLE_TYPES__TYPE_CONTENT_RECOMMENDATION = 4;
    public static final int NOTIFICATION_ADJUSTMENT_PREFERENCES__ALLOWED_BUNDLE_TYPES__TYPE_NEWS = 3;
    public static final int NOTIFICATION_ADJUSTMENT_PREFERENCES__ALLOWED_BUNDLE_TYPES__TYPE_OTHER = 0;
    public static final int NOTIFICATION_ADJUSTMENT_PREFERENCES__ALLOWED_BUNDLE_TYPES__TYPE_PROMOTION = 1;
    public static final int NOTIFICATION_ADJUSTMENT_PREFERENCES__ALLOWED_BUNDLE_TYPES__TYPE_SOCIAL_MEDIA = 2;
    public static final int NOTIFICATION_ADJUSTMENT_PREFERENCES__KEY__FEATURE_INTELLIGENCE = 3;
    public static final int NOTIFICATION_ADJUSTMENT_PREFERENCES__KEY__KEY_NOTIFICATION_RULES = 4;
    public static final int NOTIFICATION_ADJUSTMENT_PREFERENCES__KEY__KEY_SUMMARIZATION = 2;
    public static final int NOTIFICATION_ADJUSTMENT_PREFERENCES__KEY__KEY_TYPE = 1;
    public static final int NOTIFICATION_ADJUSTMENT_PREFERENCES__KEY__KEY_UNKNOWN = 0;
    public static final int NOTIFICATION_ADJUSTMENT_PREFERENCES__KEY__RULE_IMPORTANT_NOTIFICATIONS = 5;
    ...
    public static final int NOTIFICATION_CHANNEL_MODIFIED__IMPORTANCE__IMPORTANCE_MAX = 6;
    ...
    public static final int NOTIFICATION_CHANNEL_MODIFIED__OLD_IMPORTANCE__IMPORTANCE_MAX = 6;
    ...
    public static final int NOTIFICATION_REPORTED__IMPORTANCE_ASST__IMPORTANCE_MAX = 6;
    ...
    public static final int NOTIFICATION_REPORTED__IMPORTANCE_INITIAL__IMPORTANCE_MAX = 6;
    ...
    public static final int NOTIFICATION_REPORTED__IMPORTANCE__IMPORTANCE_MAX = 6;
    ...
    public static final int NOTIFY_CHANGE_CALL_REPORTED = 1388;
    ...
    public static final int PACKAGE_CHANGED_BROADCAST_REPORTED = 1129;
    public static final int PACKAGE_CHANGED_BROADCAST_REPORTED__REASON__PACKAGE_CHANGED_REASON_COMPONENT_LABEL_ICON_CHANGED = 3;
    public static final int PACKAGE_CHANGED_BROADCAST_REPORTED__REASON__PACKAGE_CHANGED_REASON_COMPONENT_STATE_CHANGED = 1;
    public static final int PACKAGE_CHANGED_BROADCAST_REPORTED__REASON__PACKAGE_CHANGED_REASON_COMPONENT_STATE_RESET = 4;
    public static final int PACKAGE_CHANGED_BROADCAST_REPORTED__REASON__PACKAGE_CHANGED_REASON_MIME_GROUP_CHANGED = 5;
    public static final int PACKAGE_CHANGED_BROADCAST_REPORTED__REASON__PACKAGE_CHANGED_REASON_OVERLAY_CHANGED = 6;
    public static final int PACKAGE_CHANGED_BROADCAST_REPORTED__REASON__PACKAGE_CHANGED_REASON_PACKAGE_STATE_CHANGED = 2;
    public static final int PACKAGE_CHANGED_BROADCAST_REPORTED__REASON__PACKAGE_CHANGED_REASON_STATIC_SHARED_LIBRARY_CHANGED = 7;
    public static final int PACKAGE_CHANGED_BROADCAST_REPORTED__REASON__PACKAGE_CHANGED_REASON_TEST = 8;
    public static final int PACKAGE_CHANGED_BROADCAST_REPORTED__REASON__PACKAGE_CHANGED_REASON_UNSPECIFIED = 0;
    public static final int PACKAGE_INSTALLATION_SESSION_REPORTED = 524;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED = 1101;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_SESSION_POLICY_OVERRIDE_VALUE__POLICY_FAIL_CLOSED = 4;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_SESSION_POLICY_OVERRIDE_VALUE__POLICY_FAIL_OPEN = 2;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_SESSION_POLICY_OVERRIDE_VALUE__POLICY_FAIL_WARN = 3;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_SESSION_POLICY_OVERRIDE_VALUE__POLICY_NONE = 1;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_SESSION_POLICY_OVERRIDE_VALUE__POLICY_UNSPECIFIED = 0;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_USER_ACTION_REQUIRED_REASON__USER_ACTION_REQUIRED_REASON_DEVELOPER_BLOCKED = 2;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_USER_ACTION_REQUIRED_REASON__USER_ACTION_REQUIRED_REASON_LITE_VERIFICATION = 3;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_USER_ACTION_REQUIRED_REASON__USER_ACTION_REQUIRED_REASON_NETWORK_UNAVAILABLE = 1;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_USER_ACTION_REQUIRED_REASON__USER_ACTION_REQUIRED_REASON_UNKNOWN = 4;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_USER_ACTION_REQUIRED_REASON__USER_ACTION_REQUIRED_REASON_UNSPECIFIED = 0;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_USER_RESPONSE__USER_RESPONSE_ABORT = 2;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_USER_RESPONSE__USER_RESPONSE_ERROR = 1;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_USER_RESPONSE__USER_RESPONSE_INSTALL_ANYWAY = 4;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_USER_RESPONSE__USER_RESPONSE_RETRY = 3;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_USER_RESPONSE__USER_RESPONSE_UNSPECIFIED = 0;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_VERIFICATION_FAILED_REASON__DEVELOPER_VERIFICATION_FAILED_REASON_DEVELOPER_BLOCKED = 2;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_VERIFICATION_FAILED_REASON__DEVELOPER_VERIFICATION_FAILED_REASON_NETWORK_UNAVAILABLE = 1;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_VERIFICATION_FAILED_REASON__DEVELOPER_VERIFICATION_FAILED_REASON_UNSPECIFIED = 0;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_VERIFICATION_POLICY__POLICY_FAIL_CLOSED = 4;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_VERIFICATION_POLICY__POLICY_FAIL_OPEN = 2;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_VERIFICATION_POLICY__POLICY_FAIL_WARN = 3;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_VERIFICATION_POLICY__POLICY_NONE = 1;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_VERIFICATION_POLICY__POLICY_UNSPECIFIED = 0;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_VERIFIER_RESPONSE__RESPONSE_COMPLETE_WITH_PASS = 1;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_VERIFIER_RESPONSE__RESPONSE_COMPLETE_WITH_REJECT = 2;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_VERIFIER_RESPONSE__RESPONSE_INCOMPLETE_NETWORK_UNAVAILABLE = 4;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_VERIFIER_RESPONSE__RESPONSE_INCOMPLETE_UNKNOWN = 3;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_VERIFIER_RESPONSE__RESPONSE_MODULE_DISCONNECTED = 6;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_VERIFIER_RESPONSE__RESPONSE_OTHER = 7;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_VERIFIER_RESPONSE__RESPONSE_TIMEOUT = 5;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ADI_VERIFIER_RESPONSE__RESPONSE_UNSPECIFIED = 0;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ASL_STATUS__ASL_STATUS_BAD = 2;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ASL_STATUS__ASL_STATUS_GOOD = 1;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ASL_STATUS__ASL_STATUS_UNSPECIFIED = 0;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__DATA_LOADER_TYPE__DATA_LOADER_TYPE_INCREMENTAL = 2;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__DATA_LOADER_TYPE__DATA_LOADER_TYPE_STREAMING = 1;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__DATA_LOADER_TYPE__DATA_LOADER_TYPE_UNSPECIFIED = 0;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__INSTALL_LOCATION__INSTALL_LOCATION_INTERNAL_ONLY = 1;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__INSTALL_LOCATION__INSTALL_LOCATION_PREFER_EXTERNAL = 2;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__INSTALL_LOCATION__INSTALL_LOCATION_UNSPECIFIED = 0;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__INSTALL_REASON__INSTALL_REASON_DEVICE_RESTORE = 2;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__INSTALL_REASON__INSTALL_REASON_DEVICE_SETUP = 3;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__INSTALL_REASON__INSTALL_REASON_POLICY = 1;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__INSTALL_REASON__INSTALL_REASON_ROLLBACK = 5;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__INSTALL_REASON__INSTALL_REASON_UNSPECIFIED = 0;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__INSTALL_REASON__INSTALL_REASON_USER = 4;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__INSTALL_SENARIO__INSTALL_SCENARIO_BULK = 2;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__INSTALL_SENARIO__INSTALL_SCENARIO_BULK_SECONDARY = 3;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__INSTALL_SENARIO__INSTALL_SCENARIO_FAST = 1;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__INSTALL_SENARIO__INSTALL_SCENARIO_UNSPECIFIED = 0;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__MODE__MODE_FULL_INSTALL = 2;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__MODE__MODE_INHERIT_EXISTING = 3;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__MODE__MODE_INVALID = 1;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__MODE__MODE_UNSPECIFIED = 0;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ROLLBACK_DATA_POLICY__ROLLBACK_DATA_POLICY_RESTORE = 1;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ROLLBACK_DATA_POLICY__ROLLBACK_DATA_POLICY_RETAIN = 4;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ROLLBACK_DATA_POLICY__ROLLBACK_DATA_POLICY_UNSPECIFIED = 0;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ROLLBACK_DATA_POLICY__ROLLBACK_DATA_POLICY_WIPE = 3;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ROLLBACK_IMPACT_LEVEL__ROLLBACK_USER_IMPACT_HIGH = 2;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ROLLBACK_IMPACT_LEVEL__ROLLBACK_USER_IMPACT_LOW = 1;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ROLLBACK_IMPACT_LEVEL__ROLLBACK_USER_IMPACT_ONLY_MANUAL = 3;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__ROLLBACK_IMPACT_LEVEL__ROLLBACK_USER_IMPACT_UNSPECIFIED = 0;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__STATUS_CODE__STATUS_FAILURE = 4;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__STATUS_CODE__STATUS_FAILURE_ABORTED = 6;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__STATUS_CODE__STATUS_FAILURE_BLOCKED = 5;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__STATUS_CODE__STATUS_FAILURE_CONFLICT = 8;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__STATUS_CODE__STATUS_FAILURE_INCOMPATIBLE = 10;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__STATUS_CODE__STATUS_FAILURE_INVALID = 7;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__STATUS_CODE__STATUS_FAILURE_STORAGE = 9;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__STATUS_CODE__STATUS_FAILURE_TIMEOUT = 11;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__STATUS_CODE__STATUS_PENDING_STREAMING = 1;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__STATUS_CODE__STATUS_PENDING_USER_ACTION = 2;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__STATUS_CODE__STATUS_SUCCESS = 3;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__STATUS_CODE__STATUS_UNSPECIFIED = 0;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__USER_ACTION_REQUIREMENT__USER_ACTION_NOT_REQUIRED = 2;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__USER_ACTION_REQUIREMENT__USER_ACTION_REQUIRED = 1;
    public static final int PACKAGE_INSTALLER_SESSION_REPORTED__USER_ACTION_REQUIREMENT__USER_ACTION_UNSPECIFIED = 0;
    ...
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED = 1135;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__CACHE_TYPE__CACHE_TYPE_APPLICATION_AND_PACKAGE_INFO = 1;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__CACHE_TYPE__CACHE_TYPE_GET_PACKAGES_FOR_UID = 2;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__CACHE_TYPE__CACHE_TYPE_UNSPECIFIED = 0;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_ADD_OVERRIDE_PERMISSION_STATE = 19;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_APP_FILTER_CHANGE = 4;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_CLEAR_ALL_OVERRIDE_PERMISSION_STATE = 22;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_CLEAR_OVERRIDE_PERMISSION_STATE = 21;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_DELETE_PACKAGE = 2;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_DISABLE_PACKAGE_CACHES = 13;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_ENABLE_OVERLAY_PACKAGES = 12;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_GRANT_IMPLICIT_ACCESS = 7;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_INSTALL_APEX_PACKAGE = 1;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_INSTALL_PACKAGE = 3;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_PACKAGE_MANAGER_SERVICE_INIT = 8;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_PERMISSION_FLAG_CHANGED = 16;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_PERMISSION_MANAGER_SERVICE_INIT = 15;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_PERMISSION_SERVICE_INIT = 14;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_REMOVE_OVERRIDE_PERMISSION_STATE = 20;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_REMOVE_SHELL_PERMISSION_DELEGATE = 18;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_SCHEDULE_WRITE_PACKAGE_LIST = 10;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_SCHEDULE_WRITE_PACKAGE_RESTRICTIONS = 11;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_SCHEDULE_WRITE_SETTINGS = 9;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_SET_SHELL_PERMISSION_DELEGATE = 17;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_UNSPECIFIED = 0;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_WRITE_PACKAGE_RESTRICTIONS = 5;
    public static final int PACKAGE_MANAGER_CACHE_INVALIDATION_REPORTED__INVALIDATION_REASON__INVALIDATION_REASON_WRITE_SETTINGS = 6;
    ...
    public static final int PACKAGE_NOTIFICATION_PREFERENCES__DENIED_ADJUSTMENTS__FEATURE_INTELLIGENCE = 3;
    public static final int PACKAGE_NOTIFICATION_PREFERENCES__DENIED_ADJUSTMENTS__KEY_NOTIFICATION_RULES = 4;
    public static final int PACKAGE_NOTIFICATION_PREFERENCES__DENIED_ADJUSTMENTS__KEY_SUMMARIZATION = 2;
    public static final int PACKAGE_NOTIFICATION_PREFERENCES__DENIED_ADJUSTMENTS__KEY_TYPE = 1;
    public static final int PACKAGE_NOTIFICATION_PREFERENCES__DENIED_ADJUSTMENTS__KEY_UNKNOWN = 0;
    public static final int PACKAGE_NOTIFICATION_PREFERENCES__DENIED_ADJUSTMENTS__RULE_IMPORTANT_NOTIFICATIONS = 5;
    ...
    public static final int PCC_BINDER_INTERCEPTOR_REPORTED = 1410;
    public static final int PENDING_ALARM_INFO = 10106;
    public static final int PENDING_BROADCAST_UPDATED = 1377;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_BACKUP = 1008;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE = 1004;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_BOUND_TOP = 1020;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY = 1015;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT = 1016;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_CACHED_EMPTY = 1018;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_CACHED_RECENT = 1017;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_FOREGROUND_SERVICE = 1003;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_HEAVY_WEIGHT = 1012;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_HOME = 1013;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND = 1006;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND = 1005;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_LAST_ACTIVITY = 1014;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_NONEXISTENT = 1019;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_PERSISTENT = 1000;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_PERSISTENT_UI = 1001;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_RECEIVER = 1010;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_SERVICE = 1009;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_TOP = 1002;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_TOP_SLEEPING = 1011;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND = 1007;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_UNKNOWN = 999;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_UNKNOWN_TO_PROTO = 998;
    public static final int PENDING_BROADCAST_UPDATED__SENDER_PROCESS_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int PERFORMANCE_HINT_SESSION_REPORTED__SESSION_TAG__UNKNOWN_SESSION_TAG = 0;
    public static final int PERMISSION_ONE_TIME_SESSION_EVENT_REPORTED = 1100;
    ...
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED = 1395;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_BACKUP = 1008;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE = 1004;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_BOUND_TOP = 1020;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY = 1015;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT = 1016;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_CACHED_EMPTY = 1018;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_CACHED_RECENT = 1017;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_FOREGROUND_SERVICE = 1003;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_HEAVY_WEIGHT = 1012;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_HOME = 1013;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND = 1006;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND = 1005;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_LAST_ACTIVITY = 1014;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_NONEXISTENT = 1019;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_PERSISTENT = 1000;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_PERSISTENT_UI = 1001;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_RECEIVER = 1010;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_SERVICE = 1009;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_TOP = 1002;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_TOP_SLEEPING = 1011;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND = 1007;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_UNKNOWN = 999;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_UNKNOWN_TO_PROTO = 998;
    public static final int POST_GC_NATIVE_CLASS_ALLOCATION_REPORTED__PROCESS_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    public static final int POWER_PROFILE = 10033;
    public static final int POWER_SAVE_TEMP_ALLOWLIST_CHANGED = 926;
    public static final int POWER_STATS_ENERGY_CONSUMED_REPORTED = 1355;
    public static final int POWER_STATS_ENERGY_CONSUMED_REPORTED__RESULTS_TYPE__ANOMALOUS = 3;
    public static final int POWER_STATS_ENERGY_CONSUMED_REPORTED__RESULTS_TYPE__NULL = 1;
    public static final int POWER_STATS_ENERGY_CONSUMED_REPORTED__RESULTS_TYPE__SUCCESS = 2;
    public static final int POWER_STATS_ENERGY_CONSUMED_REPORTED__RESULTS_TYPE__UNKNOWN = 0;
    ...
    public static final int PRIMARY_VIBRATOR_ROUTING_BOOT_REPORTED = 1407;
    ...
    public static final int PROCESS_MEMORY_SNAPSHOT__HOSTING_ZYGOTE_VARIANT__HOSTING_ZYGOTE_VARIANT_LEGACY = 1;
    public static final int PROCESS_MEMORY_SNAPSHOT__HOSTING_ZYGOTE_VARIANT__HOSTING_ZYGOTE_VARIANT_NATIVE = 2;
    public static final int PROCESS_MEMORY_SNAPSHOT__HOSTING_ZYGOTE_VARIANT__HOSTING_ZYGOTE_VARIANT_UNKNOWN = 0;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_BACKUP = 1008;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE = 1004;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_BOUND_TOP = 1020;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY = 1015;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT = 1016;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_CACHED_EMPTY = 1018;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_CACHED_RECENT = 1017;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_FOREGROUND_SERVICE = 1003;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_HEAVY_WEIGHT = 1012;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_HOME = 1013;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND = 1006;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND = 1005;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_LAST_ACTIVITY = 1014;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_NONEXISTENT = 1019;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_PERSISTENT = 1000;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_PERSISTENT_UI = 1001;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_RECEIVER = 1010;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_SERVICE = 1009;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_TOP = 1002;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_TOP_SLEEPING = 1011;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND = 1007;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_UNKNOWN = 999;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_UNKNOWN_TO_PROTO = 998;
    public static final int PROCESS_MEMORY_SNAPSHOT__PROCESS_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int PROCESS_START_TIME__HOSTING_TYPE_ID__HOSTING_TYPE_BOUND_SERVICE = 16;
    ...
    public static final int PROCESS_START_TIME__HOSTING_TYPE_ID__HOSTING_TYPE_STARTED_SERVICE = 15;
    ...
    public static final int PROCESS_START_TIME__HOSTING_ZYGOTE_VARIANT__HOSTING_ZYGOTE_VARIANT_LEGACY = 1;
    public static final int PROCESS_START_TIME__HOSTING_ZYGOTE_VARIANT__HOSTING_ZYGOTE_VARIANT_NATIVE = 2;
    public static final int PROCESS_START_TIME__HOSTING_ZYGOTE_VARIANT__HOSTING_ZYGOTE_VARIANT_UNKNOWN = 0;
    public static final int PROCESS_START_TIME__HOSTING_ZYGOTE__HOSTING_ZYGOTE_APP = 3;
    public static final int PROCESS_START_TIME__HOSTING_ZYGOTE__HOSTING_ZYGOTE_REGULAR = 1;
    public static final int PROCESS_START_TIME__HOSTING_ZYGOTE__HOSTING_ZYGOTE_UNKNOWN = 0;
    public static final int PROCESS_START_TIME__HOSTING_ZYGOTE__HOSTING_ZYGOTE_WEBVIEW = 2;
    ...
    public static final int PROCESS_STATE_CHANGED__STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int PROVIDER_ACQUISITION_EVENT_REPORTED__CLIENT_PROCESS_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int PROVIDER_ACQUISITION_EVENT_REPORTED__PROVIDER_PROCESS_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int REFRESH_TRUST_TOKEN_FINISHED = 1285;
    public static final int REFRESH_TRUST_TOKEN_FINISHED__OUTCOME__OUTCOME_PROVIDER_UNAVAILABLE = 2;
    public static final int REFRESH_TRUST_TOKEN_FINISHED__OUTCOME__OUTCOME_SERVER_ERROR = 4;
    public static final int REFRESH_TRUST_TOKEN_FINISHED__OUTCOME__OUTCOME_SERVICE_ERROR = 3;
    public static final int REFRESH_TRUST_TOKEN_FINISHED__OUTCOME__OUTCOME_SUCCESS = 1;
    public static final int REFRESH_TRUST_TOKEN_FINISHED__OUTCOME__OUTCOME_UNKNOWN = 0;
    public static final int REFRESH_TRUST_TOKEN_FINISHED__REFRESH_TYPE__TRUST_TOKEN_REFRESH_TYPE_LOW_INVENTORY = 3;
    public static final int REFRESH_TRUST_TOKEN_FINISHED__REFRESH_TYPE__TRUST_TOKEN_REFRESH_TYPE_REGULAR = 1;
    public static final int REFRESH_TRUST_TOKEN_FINISHED__REFRESH_TYPE__TRUST_TOKEN_REFRESH_TYPE_UNKNOWN = 0;
    public static final int REFRESH_TRUST_TOKEN_FINISHED__REFRESH_TYPE__TRUST_TOKEN_REFRESH_TYPE_URGENT = 2;
    public static final int REFRESH_TRUST_TOKEN_STARTED = 1284;
    public static final int REFRESH_TRUST_TOKEN_STARTED__REFRESH_TYPE__TRUST_TOKEN_REFRESH_TYPE_LOW_INVENTORY = 3;
    public static final int REFRESH_TRUST_TOKEN_STARTED__REFRESH_TYPE__TRUST_TOKEN_REFRESH_TYPE_REGULAR = 1;
    public static final int REFRESH_TRUST_TOKEN_STARTED__REFRESH_TYPE__TRUST_TOKEN_REFRESH_TYPE_UNKNOWN = 0;
    public static final int REFRESH_TRUST_TOKEN_STARTED__REFRESH_TYPE__TRUST_TOKEN_REFRESH_TYPE_URGENT = 2;
    public static final int REMAINING_BATTERY_CAPACITY = 10019;
    public static final int RENDER_SESSION_STATE_CHANGED = 1386;
    public static final int RENDER_SESSION_STATE_CHANGED__EVENT_TYPE__RENDER_SESSION_EVENT_TYPE_CLOSED = 3;
    public static final int RENDER_SESSION_STATE_CHANGED__EVENT_TYPE__RENDER_SESSION_EVENT_TYPE_CONNECTED = 2;
    public static final int RENDER_SESSION_STATE_CHANGED__EVENT_TYPE__RENDER_SESSION_EVENT_TYPE_FAILED_OOM = 5;
    public static final int RENDER_SESSION_STATE_CHANGED__EVENT_TYPE__RENDER_SESSION_EVENT_TYPE_FAILED_UNKNOWN = 4;
    public static final int RENDER_SESSION_STATE_CHANGED__EVENT_TYPE__RENDER_SESSION_EVENT_TYPE_REQUESTED = 1;
    public static final int RENDER_SESSION_STATE_CHANGED__EVENT_TYPE__RENDER_SESSION_EVENT_TYPE_UNSPECIFIED = 0;
    public static final int RENDER_SESSION_STATE_CHANGED__EXPERIENCE_TYPE__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_FITNESS_TRACKER = 3;
    public static final int RENDER_SESSION_STATE_CHANGED__EXPERIENCE_TYPE__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_STATUS_INDICATOR = 2;
    public static final int RENDER_SESSION_STATE_CHANGED__EXPERIENCE_TYPE__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_UNSPECIFIED = 0;
    public static final int RENDER_SESSION_STATE_CHANGED__EXPERIENCE_TYPE__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_VOICE_INDICATOR = 4;
    public static final int RENDER_SESSION_STATE_CHANGED__EXPERIENCE_TYPE__DISPLAY_OFFLOAD_EXPERIENCE_TYPE_WATCHFACE = 1;
    public static final int RENDER_SESSION_STATE_CHANGED__RENDERER_TYPE__DISPLAY_OFFLOAD_RENDERER_TYPE_BRIGHTNESS_ONLY = 4;
    public static final int RENDER_SESSION_STATE_CHANGED__RENDERER_TYPE__DISPLAY_OFFLOAD_RENDERER_TYPE_CUSTOM = 3;
    public static final int RENDER_SESSION_STATE_CHANGED__RENDERER_TYPE__DISPLAY_OFFLOAD_RENDERER_TYPE_PELE = 2;
    public static final int RENDER_SESSION_STATE_CHANGED__RENDERER_TYPE__DISPLAY_OFFLOAD_RENDERER_TYPE_REMOTE_COMPOSE = 1;
    public static final int RENDER_SESSION_STATE_CHANGED__RENDERER_TYPE__DISPLAY_OFFLOAD_RENDERER_TYPE_TEST = 5;
    public static final int RENDER_SESSION_STATE_CHANGED__RENDERER_TYPE__DISPLAY_OFFLOAD_RENDERER_TYPE_UNSPECIFIED = 0;
    ...
    public static final int RINGTONE_RESTORE_REPORTED = 1368;
    public static final int RINGTONE_RESTORE_REPORTED__RESULT__RESTORE_RESULT_FAIL_CANONICALIZE = 6;
    public static final int RINGTONE_RESTORE_REPORTED__RESULT__RESTORE_RESULT_FAIL_QUERY_MULTIPLE_ITEMS = 5;
    public static final int RINGTONE_RESTORE_REPORTED__RESULT__RESTORE_RESULT_FAIL_QUERY_NO_ITEM = 4;
    public static final int RINGTONE_RESTORE_REPORTED__RESULT__RESTORE_RESULT_IDLE_NULL_INPUT = 3;
    public static final int RINGTONE_RESTORE_REPORTED__RESULT__RESTORE_RESULT_SUCCESS_QUERY = 2;
    public static final int RINGTONE_RESTORE_REPORTED__RESULT__RESTORE_RESULT_SUCCESS_UNCANONICALIZE = 1;
    public static final int RINGTONE_RESTORE_REPORTED__RESULT__RESTORE_RESULT_UNKNOWN = 0;
    public static final int RINGTONE_RESTORE_REPORTED__RINGTONE_TYPE__RINGTONE_TYPE_ALARM = 3;
    public static final int RINGTONE_RESTORE_REPORTED__RINGTONE_TYPE__RINGTONE_TYPE_NOTIFICATION = 2;
    public static final int RINGTONE_RESTORE_REPORTED__RINGTONE_TYPE__RINGTONE_TYPE_RINGTONE = 1;
    public static final int RINGTONE_RESTORE_REPORTED__RINGTONE_TYPE__RINGTONE_TYPE_UNKNOWN = 0;
    ...
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_ACCESS_HID = 178;
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_ACCESS_LOCAL_NETWORK = 169;
    ...
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_COMPUTER_CONTROL = 167;
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_CONTINUE_ACROSS_DEVICES = 174;
    ...
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_MANAGE_ASSISTANT_AUDIO = 181;
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_MANAGE_CONTACTS = 180;
    ...
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_MANAGE_PERIPHERAL_CUSTOMIZATION = 179;
    ...
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_READ_BLOOD_PRESSURE = 170;
    ...
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_READ_CELL_IDENTITY = 165;
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_READ_CELL_INFO = 166;
    ...
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_READ_HEART_RATE_VARIABILITY = 171;
    ...
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_READ_OTP_SMS = 168;
    ...
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_READ_RESPIRATORY_RATE = 172;
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_READ_RESTRICTED_MESSAGES = 176;
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_READ_SCREEN_CONTEXT = 175;
    ...
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_READ_VO2_MAX = 173;
    ...
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_START_ACTIVITIES_ON_LOGIN_SCREEN = 182;
    ...
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_WRITE_RESTRICTED_MESSAGES = 177;
    ...
    public static final int SATELLITE_BYTES_TRANSFER = 10250;
    ...
    public static final int SCHEDULED_JOB_STATE_CHANGED__INTERNAL_STOP_REASON__INTERNAL_STOP_REASON_DEVICE_STATE_BATTERY_SAVER = 14;
    ...
    public static final int SCHEDULED_JOB_STATE_CHANGED__PENDING_JOB_REASONS__PENDING_JOB_REASON_APP = 1;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PENDING_JOB_REASONS__PENDING_JOB_REASON_APP_STANDBY = 2;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PENDING_JOB_REASONS__PENDING_JOB_REASON_BACKGROUND_RESTRICTION = 3;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PENDING_JOB_REASONS__PENDING_JOB_REASON_CONSTRAINT_BATTERY_NOT_LOW = 4;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PENDING_JOB_REASONS__PENDING_JOB_REASON_CONSTRAINT_CHARGING = 5;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PENDING_JOB_REASONS__PENDING_JOB_REASON_CONSTRAINT_CONNECTIVITY = 6;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PENDING_JOB_REASONS__PENDING_JOB_REASON_CONSTRAINT_CONTENT_TRIGGER = 7;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PENDING_JOB_REASONS__PENDING_JOB_REASON_CONSTRAINT_DEADLINE = 8;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PENDING_JOB_REASONS__PENDING_JOB_REASON_CONSTRAINT_DEVICE_IDLE = 9;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PENDING_JOB_REASONS__PENDING_JOB_REASON_CONSTRAINT_MINIMUM_LATENCY = 10;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PENDING_JOB_REASONS__PENDING_JOB_REASON_CONSTRAINT_PREFETCH = 11;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PENDING_JOB_REASONS__PENDING_JOB_REASON_CONSTRAINT_STORAGE_NOT_LOW = 12;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PENDING_JOB_REASONS__PENDING_JOB_REASON_DEVICE_STATE = 13;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PENDING_JOB_REASONS__PENDING_JOB_REASON_DEVICE_STATE_BATTERY_SAVER = 18;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PENDING_JOB_REASONS__PENDING_JOB_REASON_DEVICE_STATE_THERMAL = 17;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PENDING_JOB_REASONS__PENDING_JOB_REASON_JOB_SCHEDULER_OPTIMIZATION = 14;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PENDING_JOB_REASONS__PENDING_JOB_REASON_QUOTA = 15;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PENDING_JOB_REASONS__PENDING_JOB_REASON_UNDEFINED = 0;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PENDING_JOB_REASONS__PENDING_JOB_REASON_USER = 16;
    ...
    public static final int SCHEDULED_JOB_STATE_CHANGED__PROC_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int SCHEDULED_JOB_STATE_CHANGED__PUBLIC_STOP_REASON__STOP_REASON_DEVICE_STATE_BATTERY_SAVER = 18;
    public static final int SCHEDULED_JOB_STATE_CHANGED__PUBLIC_STOP_REASON__STOP_REASON_DEVICE_STATE_THERMAL = 17;
    ...
    public static final int SCREEN_STATE_CHANGED_V2__REASON__DISPLAY_STATE_REASON_ACCESSIBILITY = 8;
    ...
    public static final int SECURE_LOCK_DEVICE_STATE_CHANGED = 1192;
    public static final int SECURE_LOCK_DEVICE_STATE_CHANGED__EVENT_TYPE__DISABLED_MANUALLY = 1;
    public static final int SECURE_LOCK_DEVICE_STATE_CHANGED__EVENT_TYPE__DISABLED_TWO_FACTOR_AUTHENTICATION = 2;
    public static final int SECURE_LOCK_DEVICE_STATE_CHANGED__EVENT_TYPE__ENABLED = 3;
    public static final int SECURE_LOCK_DEVICE_STATE_CHANGED__EVENT_TYPE__UNKNOWN = 0;
    public static final int SELF_BROADCAST_REDIRECTED = 1409;
    public static final int SELF_BROADCAST_REDIRECTED__DELIVERY_GROUP_POLICY__BROADCAST_DELIVERY_GROUP_POLICY_ALL = 0;
    public static final int SELF_BROADCAST_REDIRECTED__DELIVERY_GROUP_POLICY__BROADCAST_DELIVERY_GROUP_POLICY_MERGED = 2;
    public static final int SELF_BROADCAST_REDIRECTED__DELIVERY_GROUP_POLICY__BROADCAST_DELIVERY_GROUP_POLICY_MOST_RECENT = 1;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_BACKUP = 1008;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE = 1004;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_BOUND_TOP = 1020;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_CACHED_ACTIVITY = 1015;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT = 1016;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_CACHED_EMPTY = 1018;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_CACHED_RECENT = 1017;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_FOREGROUND_SERVICE = 1003;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_HEAVY_WEIGHT = 1012;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_HOME = 1013;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND = 1006;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND = 1005;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_LAST_ACTIVITY = 1014;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_NONEXISTENT = 1019;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_PERSISTENT = 1000;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_PERSISTENT_UI = 1001;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_RECEIVER = 1010;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_SERVICE = 1009;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_TOP = 1002;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_TOP_SLEEPING = 1011;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND = 1007;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_UNKNOWN = 999;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_UNKNOWN_TO_PROTO = 998;
    public static final int SELF_BROADCAST_REDIRECTED__PROC_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int SERVICE_REQUEST_EVENT_REPORTED__REQUESTER_PROCESS_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int SERVICE_REQUEST_EVENT_REPORTED__SERVICE_PROCESS_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int SIGN_IN_DURATION = 1281;
    public static final int SIGN_IN_DURATION__TYPE__LOCKSCREEN_UNLOCKING_TO_LAUNCHER_SHOWN = 1;
    public static final int SIGN_IN_DURATION__TYPE__SIGN_IN_DURATION_TYPE_UNKNOWN = 0;
    ...
    public static final int SLAB_INFO = 10272;
    ...
    public static final int SPLITSCREEN_UICHANGED__EXIT_REASON__APP_LAUNCH_ABORTED_BY_SYSTEM = 17;
    public static final int SPLITSCREEN_UICHANGED__EXIT_REASON__CHILD_TASK_ENTER_BUBBLE = 14;
    ...
    public static final int SPLITSCREEN_UICHANGED__EXIT_REASON__DRAG_TO_FULLSCREEN = 15;
    ...
    public static final int SPLITSCREEN_UICHANGED__EXIT_REASON__SHELL_COMMAND = 16;
    public static final int SPLITSCREEN_UICHANGED__EXIT_REASON__TRANSITION_CANCELLED = 18;
    ...
    public static final int SQLITE_APP_OP_EVENT_REPORTED = 1098;
    public static final int SQLITE_APP_OP_EVENT_REPORTED__DATABASE_TYPE__DB_LONG_INTERVAL = 2;
    public static final int SQLITE_APP_OP_EVENT_REPORTED__DATABASE_TYPE__DB_SHORT_INTERVAL = 1;
    public static final int SQLITE_APP_OP_EVENT_REPORTED__DATABASE_TYPE__DB_UNKNOWN = 0;
    public static final int SQLITE_APP_OP_EVENT_REPORTED__WRITE_TYPE__WRITE_CACHE_FULL = 1;
    public static final int SQLITE_APP_OP_EVENT_REPORTED__WRITE_TYPE__WRITE_MIGRATION = 5;
    public static final int SQLITE_APP_OP_EVENT_REPORTED__WRITE_TYPE__WRITE_PERIODIC = 2;
    public static final int SQLITE_APP_OP_EVENT_REPORTED__WRITE_TYPE__WRITE_READ = 4;
    public static final int SQLITE_APP_OP_EVENT_REPORTED__WRITE_TYPE__WRITE_SHUTDOWN = 3;
    public static final int SQLITE_APP_OP_EVENT_REPORTED__WRITE_TYPE__WRITE_UNKNOWN = 0;
    public static final int SQLITE_DISCRETE_OP_EVENT_REPORTED = 1009;
    public static final int STORAGE_HEALTH = 10239;
    public static final int SUBSYSTEM_SLEEP_STATE = 10005;
    public static final int SUPERVISION_STATE = 10258;
    ...
    public static final int TASK_CONTINUITY_MESSAGE_RECEIVED = 1241;
    public static final int TASK_CONTINUITY_MESSAGE_RECEIVED__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_HANDOFF_REQUEST = 2;
    public static final int TASK_CONTINUITY_MESSAGE_RECEIVED__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_HANDOFF_REQUEST_RESULT = 3;
    public static final int TASK_CONTINUITY_MESSAGE_RECEIVED__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_TASK_STACK_BROADCAST = 1;
    public static final int TASK_CONTINUITY_MESSAGE_RECEIVED__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_UNIVERSAL_CLIPBOARD_CHUNK = 5;
    public static final int TASK_CONTINUITY_MESSAGE_RECEIVED__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_UNIVERSAL_CLIPBOARD_CLIP_ACCESSED = 6;
    public static final int TASK_CONTINUITY_MESSAGE_RECEIVED__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_UNIVERSAL_CLIPBOARD_CLIP_CHANGED = 7;
    public static final int TASK_CONTINUITY_MESSAGE_RECEIVED__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_UNIVERSAL_CLIPBOARD_CLIP_CHANGE_SUBSCRIPTION_UPDATE = 10;
    public static final int TASK_CONTINUITY_MESSAGE_RECEIVED__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_UNIVERSAL_CLIPBOARD_CLIP_ITEM_REQUEST = 8;
    public static final int TASK_CONTINUITY_MESSAGE_RECEIVED__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_UNIVERSAL_CLIPBOARD_CLIP_ITEM_REQUEST_RESPONSE = 9;
    public static final int TASK_CONTINUITY_MESSAGE_RECEIVED__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_UNIVERSAL_CLIPBOARD_METADATA = 4;
    public static final int TASK_CONTINUITY_MESSAGE_RECEIVED__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_UNKNOWN = 0;
    public static final int TASK_CONTINUITY_MESSAGE_SENT = 1240;
    public static final int TASK_CONTINUITY_MESSAGE_SENT__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_HANDOFF_REQUEST = 2;
    public static final int TASK_CONTINUITY_MESSAGE_SENT__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_HANDOFF_REQUEST_RESULT = 3;
    public static final int TASK_CONTINUITY_MESSAGE_SENT__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_TASK_STACK_BROADCAST = 1;
    public static final int TASK_CONTINUITY_MESSAGE_SENT__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_UNIVERSAL_CLIPBOARD_CHUNK = 5;
    public static final int TASK_CONTINUITY_MESSAGE_SENT__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_UNIVERSAL_CLIPBOARD_CLIP_ACCESSED = 6;
    public static final int TASK_CONTINUITY_MESSAGE_SENT__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_UNIVERSAL_CLIPBOARD_CLIP_CHANGED = 7;
    public static final int TASK_CONTINUITY_MESSAGE_SENT__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_UNIVERSAL_CLIPBOARD_CLIP_CHANGE_SUBSCRIPTION_UPDATE = 10;
    public static final int TASK_CONTINUITY_MESSAGE_SENT__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_UNIVERSAL_CLIPBOARD_CLIP_ITEM_REQUEST = 8;
    public static final int TASK_CONTINUITY_MESSAGE_SENT__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_UNIVERSAL_CLIPBOARD_CLIP_ITEM_REQUEST_RESPONSE = 9;
    public static final int TASK_CONTINUITY_MESSAGE_SENT__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_UNIVERSAL_CLIPBOARD_METADATA = 4;
    public static final int TASK_CONTINUITY_MESSAGE_SENT__MESSAGE_TYPE__TASK_CONTINUITY_MESSAGE_TYPE_UNKNOWN = 0;
    public static final int TASK_CONTINUITY_MESSAGE_SENT__RESULT__TASK_CONTINUITY_MESSAGE_SENT_RESULT_FAILURE_ASSOCIATION_NOT_FOUND = 4;
    public static final int TASK_CONTINUITY_MESSAGE_SENT__RESULT__TASK_CONTINUITY_MESSAGE_SENT_RESULT_FAILURE_INTERNAL_ERROR = 2;
    public static final int TASK_CONTINUITY_MESSAGE_SENT__RESULT__TASK_CONTINUITY_MESSAGE_SENT_RESULT_FAILURE_MESSAGE_SERIALIZATION_FAILED = 3;
    public static final int TASK_CONTINUITY_MESSAGE_SENT__RESULT__TASK_CONTINUITY_MESSAGE_SENT_RESULT_SUCCESS = 1;
    public static final int TASK_CONTINUITY_MESSAGE_SENT__RESULT__TASK_CONTINUITY_MESSAGE_SENT_RESULT_UNKNOWN = 0;
    ...
    public static final int THERMAL_HEADROOM_LISTENER_DATA_REPORTED = 1051;
    public static final int THERMAL_HEADROOM_LISTENER_DATA_REPORTED__CALLBACK_TYPE__LISTENER_REGISTRATION = 3;
    public static final int THERMAL_HEADROOM_LISTENER_DATA_REPORTED__CALLBACK_TYPE__TEMP_CHANGED = 1;
    public static final int THERMAL_HEADROOM_LISTENER_DATA_REPORTED__CALLBACK_TYPE__THRESHOLD_CHANGED = 2;
    public static final int THERMAL_HEADROOM_LISTENER_DATA_REPORTED__CALLBACK_TYPE__UNKNOWN_CALLBACK_TYPE = 0;
    public static final int THERMAL_HEADROOM_LISTENER_INFO = 10238;
    ...
    public static final int THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__PREV_SEVERITY__CRITICAL = 4;
    public static final int THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__PREV_SEVERITY__EMERGENCY = 5;
    public static final int THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__PREV_SEVERITY__LIGHT = 1;
    public static final int THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__PREV_SEVERITY__MODERATE = 2;
    public static final int THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__PREV_SEVERITY__NONE = 0;
    public static final int THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__PREV_SEVERITY__SEVERE = 3;
    public static final int THERMAL_THROTTLING_SEVERITY_STATE_CHANGED__PREV_SEVERITY__SHUTDOWN = 6;
    ...
    public static final int TIME_ZONE_DETECTION_DISCREPANCY_REPORTED = 1254;
    ...
    public static final int TIME_ZONE_TRANSITION_STATE_CHANGED = 1255;
    ...
    public static final int TOUCHPAD_USAGE__DEVICE_BUS__VIRTUAL = 4;
    ...
    public static final int TOUCH_GESTURE_CLASSIFIED__CLASSIFICATION__FLING = 6;
    ...
    public static final int TRUST_TOKEN_STATE = 10263;
    ...
    public static final int UIACTION_LATENCY_REPORTED__ACTION__ACTION_A11Y_SERVICE_STARTUP_CLIENT_INIT = 42;
    public static final int UIACTION_LATENCY_REPORTED__ACTION__ACTION_A11Y_SERVICE_STARTUP_CLIENT_UI = 43;
    public static final int UIACTION_LATENCY_REPORTED__ACTION__ACTION_A11Y_SERVICE_STARTUP_FRAMEWORK = 41;
    ...
    public static final int UIACTION_LATENCY_REPORTED__ACTION__ACTION_DESKTOP_MODE_EXIT_MODE_ON_LAST_WINDOW_CLOSE = 37;
    ...
    public static final int UIACTION_LATENCY_REPORTED__ACTION__ACTION_LOCATION_BUTTON_OPEN_SESSION = 40;
    ...
    public static final int UIACTION_LATENCY_REPORTED__ACTION__ACTION_SWITCH_DISPLAY_FOLD = 38;
    ...
    public static final int UIACTION_LATENCY_REPORTED__ACTION__ACTION_UDFPS_OVERLAY_ATTACHED_AFTER_GOING_TO_SLEEP = 39;
    ...
    public static final int UID_PROCESS_STATE_CHANGED__STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__AGENT_ICON_ANIMATION = 183;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__AGENT_ICON_WHISPER_BG_ANIMATION = 184;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__AGENT_ICON_WHISPER_SHORT_ENTER = 181;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__AGENT_ICON_WHISPER_SHORT_EXIT = 182;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__AMBIENT_CUE_COLLAPSE = 148;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__AMBIENT_CUE_EXPAND = 147;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__AMBIENT_CUE_HIDE = 146;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__AMBIENT_CUE_SHOW = 145;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__APP_UPDATE = 165;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__BOUNCER_SECURE_LOCK_DEVICE_BIOMETRIC_AUTH_APPEAR = 149;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__BOUNCER_SECURE_LOCK_DEVICE_BIOMETRIC_AUTH_DISAPPEAR = 150;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__CLIENT_DRAG_RESIZING = 161;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_CROSS_DISPLAY_DRAG_WINDOW = 174;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_CROSS_DISPLAY_DRAG_WINDOW_RELEASE = 175;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_DESK_SWITCH = 153;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_DESK_TO_FULLSCREEN_SLIDE = 172;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_DRAG_WINDOW = 110;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_DRAG_WINDOW_RELEASE = 171;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_ENTER_MODE_KEYBOARD_SHORTCUT = 185;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_EXIT_MODE = 108;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_EXIT_MODE_KEYBOARD_SHORTCUT = 186;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_FULLSCREEN_TO_DESK_SLIDE = 180;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_HOME_SCREEN_PEEK = 167;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_HOME_SCREEN_UNPEEK = 168;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_MOVE_FROM_SPLIT_SCREEN = 144;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_MOVE_TO_SPLIT_SCREEN = 143;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_SHADE_WINDOW_DISPLAY_CHANGE = 138;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_SNAP_RESIZE = 118;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_TASKBAR_INDICATOR_UPDATE = 162;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_TASKBAR_MULTI_INSTANCE_MENU_OPEN = 163;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_TILE_RESIZING = 140;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_UNMAXIMIZE_WINDOW = 119;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DREAM_SWITCHER_EDGE_SWIPE = 173;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__FACE_AUTH_LOW_LIGHT_ANIMATION = 195;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__FOLD_ANIM = 105;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__HUN_TO_DUAL_SHADE_NOTIF_OVERLAY = 152;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__KEYGUARD_TRANSITION_GONE_TO_DOZING = 160;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__KEYGUARD_TRANSITION_LOCKSCREEN_TO_DOZING = 159;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_OVERVIEW_CLEAR_ALL = 139;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_RECENTS_TO_HOME = 166;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_WIDGET_PICKER_APP_EXPAND = 142;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_WIDGET_PICKER_CLOSE_BACK = 98;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LAUNCHER_WIDGET_PICKER_OPEN = 141;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__LPP_ASSIST_INVOCATION_EFFECT = 132;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__NOTIFICATIONS_ANIMATED_ACTION = 131;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__QS_SHADE_OVERLAY_FROM_DEFAULT_TO_EDIT = 187;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__QS_SHADE_OVERLAY_FROM_DEFAULT_TO_TILE_DETAILS = 189;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__QS_SHADE_OVERLAY_FROM_EDIT_TO_DEFAULT = 188;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__QS_SHADE_OVERLAY_FROM_TILE_DETAILS_TO_DEFAULT = 190;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_BLUETOOTH_DETAILS_OPEN = 177;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_INTERNET_DETAILS_OPEN = 176;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_TILE_DETAILS_OPEN = 178;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__STATUS_BAR_APP_RETURN_TO_ONGOING_CHIP = 151;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__STATUS_BAR_HEADLINE_COLLAPSE = 192;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__STATUS_BAR_HEADLINE_EXPAND = 191;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__STATUS_BAR_HEADLINE_SWIPE = 193;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__STATUS_BAR_HEADLINE_SYSTEM_TRANSITION = 194;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__TASKBAR_ICON_APPEAR = 164;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__UNLOCK_AUTH_RIPPLE = 179;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__WEAR_ALERT_NOTIFICATION_DIALOG = 158;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__WEAR_APP_LAUNCH_TRANSITION = 170;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__WEAR_BOUNCER_EXIT_ANIMATION = 154;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__WEAR_BOUNCER_PATTERN_ENTRY = 157;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__WEAR_BOUNCER_PIN_DOT_ADDED = 156;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__WEAR_BOUNCER_PIN_PAD_ENTRY = 155;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__WEAR_CAROUSEL_FLING_JANK = 134;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__WEAR_CAROUSEL_SCROLL_JANK = 133;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__WEAR_CAROUSEL_SWIPE_JANK = 135;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__WEAR_NOTIFICATION_TRAY_OPEN = 137;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__WEAR_ORIGIN_TRANSITION_OPEN = 169;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__WEAR_QSS_TRAY_OPEN = 136;
    ...
    public static final int USAGE_EVENT_REPORTED_STATS = 1313;
    public static final int USAGE_EVENT_REPORTED_STATS__EVENT_TYPE__ACTIVITY_STOPPED = 23;
    public static final int USAGE_EVENT_REPORTED_STATS__EVENT_TYPE__CHOOSER_ACTION = 9;
    public static final int USAGE_EVENT_REPORTED_STATS__EVENT_TYPE__CONFIGURATION_CHANGE = 5;
    public static final int USAGE_EVENT_REPORTED_STATS__EVENT_TYPE__FOREGROUND_SERVICE_START = 19;
    public static final int USAGE_EVENT_REPORTED_STATS__EVENT_TYPE__FOREGROUND_SERVICE_STOP = 20;
    public static final int USAGE_EVENT_REPORTED_STATS__EVENT_TYPE__KEYGUARD_HIDDEN = 18;
    public static final int USAGE_EVENT_REPORTED_STATS__EVENT_TYPE__KEYGUARD_SHOWN = 17;
    public static final int USAGE_EVENT_REPORTED_STATS__EVENT_TYPE__LOCUS_ID_SET = 30;
    public static final int USAGE_EVENT_REPORTED_STATS__EVENT_TYPE__MOVE_TO_BACKGROUND = 2;
    public static final int USAGE_EVENT_REPORTED_STATS__EVENT_TYPE__MOVE_TO_FOREGROUND = 1;
    public static final int USAGE_EVENT_REPORTED_STATS__EVENT_TYPE__NONE = 0;
    public static final int USAGE_EVENT_REPORTED_STATS__EVENT_TYPE__NOTIFICATION_INTERRUPTION = 12;
    public static final int USAGE_EVENT_REPORTED_STATS__EVENT_TYPE__NOTIFICATION_SEEN = 10;
    public static final int USAGE_EVENT_REPORTED_STATS__EVENT_TYPE__SCREEN_INTERACTIVE = 15;
    public static final int USAGE_EVENT_REPORTED_STATS__EVENT_TYPE__SCREEN_NON_INTERACTIVE = 16;
    public static final int USAGE_EVENT_REPORTED_STATS__EVENT_TYPE__SHORTCUT_INVOCATION = 8;
    public static final int USAGE_EVENT_REPORTED_STATS__EVENT_TYPE__SLICE_PINNED = 14;
    public static final int USAGE_EVENT_REPORTED_STATS__EVENT_TYPE__STANDBY_BUCKET_CHANGED = 11;
    public static final int USAGE_EVENT_REPORTED_STATS__EVENT_TYPE__USER_INTERACTION = 7;
    public static final int USB_ACCESSORY_HANDSHAKE_REPORTED = 1379;
    public static final int USB_ACCESSORY_HANDSHAKE_REPORTED__INITIATOR_TYPE__AOA_INITIATOR_ANDROID_AUTO = 1;
    public static final int USB_ACCESSORY_HANDSHAKE_REPORTED__INITIATOR_TYPE__AOA_INITIATOR_BACKUP_RESTORE = 3;
    public static final int USB_ACCESSORY_HANDSHAKE_REPORTED__INITIATOR_TYPE__AOA_INITIATOR_CTS_VERIFIER = 2;
    public static final int USB_ACCESSORY_HANDSHAKE_REPORTED__INITIATOR_TYPE__AOA_INITIATOR_OTHER = 4;
    public static final int USB_ACCESSORY_HANDSHAKE_REPORTED__INITIATOR_TYPE__AOA_INITIATOR_UNSPECIFIED = 0;
    public static final int USB_ACCESSORY_HANDSHAKE_REPORTED__RESULT__HANDSHAKE_RESULT_DISCONNECTED = 5;
    public static final int USB_ACCESSORY_HANDSHAKE_REPORTED__RESULT__HANDSHAKE_RESULT_ERR_MALFORMED_GET_PROTOCOL = 8;
    public static final int USB_ACCESSORY_HANDSHAKE_REPORTED__RESULT__HANDSHAKE_RESULT_ERR_MALFORMED_SEND_STRING = 9;
    public static final int USB_ACCESSORY_HANDSHAKE_REPORTED__RESULT__HANDSHAKE_RESULT_ERR_MALFORMED_START = 10;
    public static final int USB_ACCESSORY_HANDSHAKE_REPORTED__RESULT__HANDSHAKE_RESULT_ERR_READ_CONTROL_EVENT_FAILED = 7;
    public static final int USB_ACCESSORY_HANDSHAKE_REPORTED__RESULT__HANDSHAKE_RESULT_ERR_UNRECOGNIZED_REQUEST = 12;
    public static final int USB_ACCESSORY_HANDSHAKE_REPORTED__RESULT__HANDSHAKE_RESULT_ERR_WRITE_CONTROL_DATA_FAILED = 11;
    public static final int USB_ACCESSORY_HANDSHAKE_REPORTED__RESULT__HANDSHAKE_RESULT_MISSING_MANDATORY_STRINGS = 6;
    public static final int USB_ACCESSORY_HANDSHAKE_REPORTED__RESULT__HANDSHAKE_RESULT_SUCCESS = 1;
    public static final int USB_ACCESSORY_HANDSHAKE_REPORTED__RESULT__HANDSHAKE_RESULT_TIMEOUT_WAITING_FOR_CONFIGURATION = 4;
    public static final int USB_ACCESSORY_HANDSHAKE_REPORTED__RESULT__HANDSHAKE_RESULT_TIMEOUT_WAITING_FOR_SEND_STRING = 2;
    public static final int USB_ACCESSORY_HANDSHAKE_REPORTED__RESULT__HANDSHAKE_RESULT_TIMEOUT_WAITING_FOR_START = 3;
    public static final int USB_ACCESSORY_HANDSHAKE_REPORTED__RESULT__HANDSHAKE_RESULT_UNSPECIFIED = 0;
    public static final int USB_ACCESSORY_OPENED = 1380;
    public static final int USB_ACCESSORY_OPENED__API_TYPE__ACCESSORY_API_TYPE_OPEN_ACCESSORY = 1;
    public static final int USB_ACCESSORY_OPENED__API_TYPE__ACCESSORY_API_TYPE_OPEN_ACCESSORY_INPUT_STREAM = 2;
    public static final int USB_ACCESSORY_OPENED__API_TYPE__ACCESSORY_API_TYPE_OPEN_ACCESSORY_OUTPUT_STREAM = 3;
    public static final int USB_ACCESSORY_OPENED__API_TYPE__ACCESSORY_API_TYPE_UNSPECIFIED = 0;
    public static final int USB_ACCESSORY_OPENED__OPEN_RESULT__ACCESSORY_OPEN_RESULT_ERROR_ACCESSORY_MISMATCH = 3;
    public static final int USB_ACCESSORY_OPENED__OPEN_RESULT__ACCESSORY_OPEN_RESULT_ERROR_NATIVE_FAILURE = 5;
    public static final int USB_ACCESSORY_OPENED__OPEN_RESULT__ACCESSORY_OPEN_RESULT_ERROR_NO_ACCESSORY = 2;
    public static final int USB_ACCESSORY_OPENED__OPEN_RESULT__ACCESSORY_OPEN_RESULT_ERROR_PERMISSION_DENIED = 4;
    public static final int USB_ACCESSORY_OPENED__OPEN_RESULT__ACCESSORY_OPEN_RESULT_SUCCESS = 1;
    public static final int USB_ACCESSORY_OPENED__OPEN_RESULT__ACCESSORY_OPEN_RESULT_UNSPECIFIED = 0;
    ...
    public static final int USB_USERSPACE_AOA_ENABLED = 1211;
    public static final int USB_USERSPACE_AOA_ENABLED__OPEN_CONTROL_RESULT__NOT_CALLED = 6;
    public static final int USB_USERSPACE_AOA_ENABLED__OPEN_CONTROL_RESULT__OPEN_ACCESSORY_FAILED = 1;
    public static final int USB_USERSPACE_AOA_ENABLED__OPEN_CONTROL_RESULT__SELINUX_PERMISSION_FAILED = 4;
    public static final int USB_USERSPACE_AOA_ENABLED__OPEN_CONTROL_RESULT__SUCCESS = 5;
    public static final int USB_USERSPACE_AOA_ENABLED__OPEN_CONTROL_RESULT__UNSPECIFIED = 0;
    public static final int USB_USERSPACE_AOA_ENABLED__OPEN_CONTROL_RESULT__WRITE_DESC_FAILED = 2;
    public static final int USB_USERSPACE_AOA_ENABLED__OPEN_CONTROL_RESULT__WRITE_STRING_FAILED = 3;
    public static final int USB_USERSPACE_AOA_ENABLED__STATE__USERSPACE_AOA_STATE_DISABLED = 1;
    public static final int USB_USERSPACE_AOA_ENABLED__STATE__USERSPACE_AOA_STATE_ENABLED = 2;
    public static final int USB_USERSPACE_AOA_ENABLED__STATE__USERSPACE_AOA_STATE_UNSPECIFIED = 0;
    ...
    public static final int USER_INFO__USER_TYPE__PROFILE_SUPERVISING = 10;
    ...
    public static final int USER_LIFECYCLE_JOURNEY_REPORTED__JOURNEY__DEMOTE_MAIN_USER = 10;
    public static final int USER_LIFECYCLE_JOURNEY_REPORTED__JOURNEY__GRANT_ADMIN = 7;
    public static final int USER_LIFECYCLE_JOURNEY_REPORTED__JOURNEY__PROMOTE_MAIN_USER = 11;
    ...
    public static final int USER_LIFECYCLE_JOURNEY_REPORTED__JOURNEY__USER_LOGOUT = 12;
    ...
    public static final int USER_LIFECYCLE_JOURNEY_REPORTED__USER_TYPE__PROFILE_SUPERVISING = 10;
    ...
    public static final int VERIFY_TRUST_TOKEN_CALLED = 1283;
    public static final int VERIFY_TRUST_TOKEN_CALLED__OUTCOME__OUTCOME_ANCHOR_UNAVAILABLE = 2;
    public static final int VERIFY_TRUST_TOKEN_CALLED__OUTCOME__OUTCOME_CHALLENGE_INCORRECT = 4;
    public static final int VERIFY_TRUST_TOKEN_CALLED__OUTCOME__OUTCOME_FAILURE_UNKNOWN = 6;
    public static final int VERIFY_TRUST_TOKEN_CALLED__OUTCOME__OUTCOME_INVALID_POLICY = 5;
    public static final int VERIFY_TRUST_TOKEN_CALLED__OUTCOME__OUTCOME_SIGNATURE_INVALID = 3;
    public static final int VERIFY_TRUST_TOKEN_CALLED__OUTCOME__OUTCOME_SUCCESS = 1;
    public static final int VERIFY_TRUST_TOKEN_CALLED__OUTCOME__OUTCOME_UNKNOWN = 0;
    public static final int VERIFY_TRUST_TOKEN_CALLED__POLICY__POLICY_UNKNOWN = 0;
    public static final int VERIFY_TRUST_TOKEN_CALLED__POLICY__POLICY_VERIFIED_DEVICE = 3;
    public static final int VERIFY_TRUST_TOKEN_CALLED__POLICY__POLICY_VERIFIED_DEVICE_STRONG = 4;
    public static final int VERIFY_TRUST_TOKEN_CALLED__POLICY__POLICY_VERIFIED_IDENTITY = 1;
    public static final int VERIFY_TRUST_TOKEN_CALLED__POLICY__POLICY_VERIFIED_IDENTITY_STRONG = 2;
    ...
    public static final int WAKELOCK_STATE_CHANGED__PROCESS_STATE__PROCESS_STATE_UNSPECIFIED = 0;
    ...
    public static final int WAKELOCK_STATE_CHANGED__TYPE__PARTIAL_SLEEP_WAKE_LOCK = 512;
    ...
    public static final int WEAR_GESTURE_DETECTION_STATE_CHANGED = 1097;
    public static final int WEAR_GESTURE_DETECTION_STATE_CHANGED__STATE__STATE_ACTIVE = 1;
    public static final int WEAR_GESTURE_DETECTION_STATE_CHANGED__STATE__STATE_INACTIVE = 2;
    public static final int WEAR_GESTURE_DETECTION_STATE_CHANGED__STATE__STATE_UNSPECIFIED = 0;
    public static final int WEAR_GESTURE_DETECTION_STATE_CHANGED__SUBSCRIBED_ACTIONS__ACTION_DISMISS = 2;
    public static final int WEAR_GESTURE_DETECTION_STATE_CHANGED__SUBSCRIBED_ACTIONS__ACTION_INVOKE_AI = 5;
    public static final int WEAR_GESTURE_DETECTION_STATE_CHANGED__SUBSCRIBED_ACTIONS__ACTION_PAGE_BACKWARD = 8;
    public static final int WEAR_GESTURE_DETECTION_STATE_CHANGED__SUBSCRIBED_ACTIONS__ACTION_PAGE_FORWARD = 7;
    public static final int WEAR_GESTURE_DETECTION_STATE_CHANGED__SUBSCRIBED_ACTIONS__ACTION_PRIMARY = 1;
    public static final int WEAR_GESTURE_DETECTION_STATE_CHANGED__SUBSCRIBED_ACTIONS__ACTION_SELECT = 6;
    public static final int WEAR_GESTURE_DETECTION_STATE_CHANGED__SUBSCRIBED_ACTIONS__ACTION_SLEEP = 4;
    public static final int WEAR_GESTURE_DETECTION_STATE_CHANGED__SUBSCRIBED_ACTIONS__ACTION_UNSPECIFIED = 0;
    public static final int WEAR_GESTURE_DETECTION_STATE_CHANGED__SUBSCRIBED_ACTIONS__ACTION_WAKE = 3;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED = 1304;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED__ACTION__ACTION_DISMISS = 2;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED__ACTION__ACTION_INVOKE_AI = 5;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED__ACTION__ACTION_PAGE_BACKWARD = 8;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED__ACTION__ACTION_PAGE_FORWARD = 7;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED__ACTION__ACTION_PRIMARY = 1;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED__ACTION__ACTION_SELECT = 6;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED__ACTION__ACTION_SLEEP = 4;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED__ACTION__ACTION_UNSPECIFIED = 0;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED__ACTION__ACTION_WAKE = 3;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED__DISPLAY_STATE__DISPLAY_STATE_DOZE = 3;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED__DISPLAY_STATE__DISPLAY_STATE_DOZE_SUSPEND = 4;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED__DISPLAY_STATE__DISPLAY_STATE_OFF = 1;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED__DISPLAY_STATE__DISPLAY_STATE_ON = 2;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED__DISPLAY_STATE__DISPLAY_STATE_ON_SUSPEND = 6;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED__DISPLAY_STATE__DISPLAY_STATE_UNKNOWN = 0;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED__DISPLAY_STATE__DISPLAY_STATE_VR = 5;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED__EVENT__GESTURE_EXPERIENCE_EVENT_GESTURE_CONSUMED = 2;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED__EVENT__GESTURE_EXPERIENCE_EVENT_HINT_SHOWN = 1;
    public static final int WEAR_GESTURE_EXPERIENCE_EVENT_REPORTED__EVENT__GESTURE_EXPERIENCE_EVENT_UNSPECIFIED = 0;
    public static final int WEAR_GESTURE_REPORTED = 1096;
    public static final int WEAR_GESTURE_REPORTED__ACTION__ACTION_DISMISS = 2;
    public static final int WEAR_GESTURE_REPORTED__ACTION__ACTION_INVOKE_AI = 5;
    public static final int WEAR_GESTURE_REPORTED__ACTION__ACTION_PAGE_BACKWARD = 8;
    public static final int WEAR_GESTURE_REPORTED__ACTION__ACTION_PAGE_FORWARD = 7;
    public static final int WEAR_GESTURE_REPORTED__ACTION__ACTION_PRIMARY = 1;
    public static final int WEAR_GESTURE_REPORTED__ACTION__ACTION_SELECT = 6;
    public static final int WEAR_GESTURE_REPORTED__ACTION__ACTION_SLEEP = 4;
    public static final int WEAR_GESTURE_REPORTED__ACTION__ACTION_UNSPECIFIED = 0;
    public static final int WEAR_GESTURE_REPORTED__ACTION__ACTION_WAKE = 3;
    public static final int WEAR_GESTURE_REPORTED__DISPLAY_STATE__DISPLAY_STATE_DOZE = 3;
    public static final int WEAR_GESTURE_REPORTED__DISPLAY_STATE__DISPLAY_STATE_DOZE_SUSPEND = 4;
    public static final int WEAR_GESTURE_REPORTED__DISPLAY_STATE__DISPLAY_STATE_OFF = 1;
    public static final int WEAR_GESTURE_REPORTED__DISPLAY_STATE__DISPLAY_STATE_ON = 2;
    public static final int WEAR_GESTURE_REPORTED__DISPLAY_STATE__DISPLAY_STATE_ON_SUSPEND = 6;
    public static final int WEAR_GESTURE_REPORTED__DISPLAY_STATE__DISPLAY_STATE_UNKNOWN = 0;
    public static final int WEAR_GESTURE_REPORTED__DISPLAY_STATE__DISPLAY_STATE_VR = 5;
    public static final int WEAR_GESTURE_REPORTED__EFFECTIVE_DISPLAY_STATE__DISPLAY_STATE_DOZE = 3;
    public static final int WEAR_GESTURE_REPORTED__EFFECTIVE_DISPLAY_STATE__DISPLAY_STATE_DOZE_SUSPEND = 4;
    public static final int WEAR_GESTURE_REPORTED__EFFECTIVE_DISPLAY_STATE__DISPLAY_STATE_OFF = 1;
    public static final int WEAR_GESTURE_REPORTED__EFFECTIVE_DISPLAY_STATE__DISPLAY_STATE_ON = 2;
    public static final int WEAR_GESTURE_REPORTED__EFFECTIVE_DISPLAY_STATE__DISPLAY_STATE_ON_SUSPEND = 6;
    public static final int WEAR_GESTURE_REPORTED__EFFECTIVE_DISPLAY_STATE__DISPLAY_STATE_UNKNOWN = 0;
    public static final int WEAR_GESTURE_REPORTED__EFFECTIVE_DISPLAY_STATE__DISPLAY_STATE_VR = 5;
    public static final int WEAR_GESTURE_REPORTED__GESTURE__GESTURE_BLOOM = 7;
    public static final int WEAR_GESTURE_REPORTED__GESTURE__GESTURE_CLENCH = 8;
    public static final int WEAR_GESTURE_REPORTED__GESTURE__GESTURE_DOUBLE_KNOCK = 14;
    public static final int WEAR_GESTURE_REPORTED__GESTURE__GESTURE_DOUBLE_PINCH = 1;
    public static final int WEAR_GESTURE_REPORTED__GESTURE__GESTURE_DOUBLE_SHAKE = 16;
    public static final int WEAR_GESTURE_REPORTED__GESTURE__GESTURE_DOUBLE_WRIST_TURN = 6;
    public static final int WEAR_GESTURE_REPORTED__GESTURE__GESTURE_KNOCK = 13;
    public static final int WEAR_GESTURE_REPORTED__GESTURE__GESTURE_PALM_UP_CLENCH = 9;
    public static final int WEAR_GESTURE_REPORTED__GESTURE__GESTURE_PALM_UP_DOUBLE_PINCH = 5;
    public static final int WEAR_GESTURE_REPORTED__GESTURE__GESTURE_PALM_UP_SINGLE_PINCH = 4;
    public static final int WEAR_GESTURE_REPORTED__GESTURE__GESTURE_PINCH_AND_FLICK_BACKWARD = 11;
    public static final int WEAR_GESTURE_REPORTED__GESTURE__GESTURE_PINCH_AND_FLICK_FORWARD = 10;
    public static final int WEAR_GESTURE_REPORTED__GESTURE__GESTURE_PINCH_AND_HOLD = 12;
    public static final int WEAR_GESTURE_REPORTED__GESTURE__GESTURE_SHAKE = 15;
    public static final int WEAR_GESTURE_REPORTED__GESTURE__GESTURE_SINGLE_PINCH = 3;
    public static final int WEAR_GESTURE_REPORTED__GESTURE__GESTURE_UNSPECIFIED = 0;
    public static final int WEAR_GESTURE_REPORTED__GESTURE__GESTURE_WRIST_TURN = 2;
    public static final int WEAR_GESTURE_REPORTED__REMOTE_ACTION__ACTION_DISMISS = 2;
    public static final int WEAR_GESTURE_REPORTED__REMOTE_ACTION__ACTION_INVOKE_AI = 5;
    public static final int WEAR_GESTURE_REPORTED__REMOTE_ACTION__ACTION_PAGE_BACKWARD = 8;
    public static final int WEAR_GESTURE_REPORTED__REMOTE_ACTION__ACTION_PAGE_FORWARD = 7;
    public static final int WEAR_GESTURE_REPORTED__REMOTE_ACTION__ACTION_PRIMARY = 1;
    public static final int WEAR_GESTURE_REPORTED__REMOTE_ACTION__ACTION_SELECT = 6;
    public static final int WEAR_GESTURE_REPORTED__REMOTE_ACTION__ACTION_SLEEP = 4;
    public static final int WEAR_GESTURE_REPORTED__REMOTE_ACTION__ACTION_UNSPECIFIED = 0;
    public static final int WEAR_GESTURE_REPORTED__REMOTE_ACTION__ACTION_WAKE = 3;
    public static final int WEAR_GESTURE_REPORTED__SYSTEM_ACTION__SYSTEM_ACTION_BACK = 2;
    public static final int WEAR_GESTURE_REPORTED__SYSTEM_ACTION__SYSTEM_ACTION_HOME = 1;
    public static final int WEAR_GESTURE_REPORTED__SYSTEM_ACTION__SYSTEM_ACTION_MEDIA = 3;
    public static final int WEAR_GESTURE_REPORTED__SYSTEM_ACTION__SYSTEM_ACTION_UNSPECIFIED = 0;
    public static final int WEAR_GESTURE_SUBSCRIPTION_CHANGED = 1095;
    public static final int WEAR_GESTURE_SUBSCRIPTION_CHANGED__ACTIONS__ACTION_DISMISS = 2;
    public static final int WEAR_GESTURE_SUBSCRIPTION_CHANGED__ACTIONS__ACTION_INVOKE_AI = 5;
    public static final int WEAR_GESTURE_SUBSCRIPTION_CHANGED__ACTIONS__ACTION_PAGE_BACKWARD = 8;
    public static final int WEAR_GESTURE_SUBSCRIPTION_CHANGED__ACTIONS__ACTION_PAGE_FORWARD = 7;
    public static final int WEAR_GESTURE_SUBSCRIPTION_CHANGED__ACTIONS__ACTION_PRIMARY = 1;
    public static final int WEAR_GESTURE_SUBSCRIPTION_CHANGED__ACTIONS__ACTION_SELECT = 6;
    public static final int WEAR_GESTURE_SUBSCRIPTION_CHANGED__ACTIONS__ACTION_SLEEP = 4;
    public static final int WEAR_GESTURE_SUBSCRIPTION_CHANGED__ACTIONS__ACTION_UNSPECIFIED = 0;
    public static final int WEAR_GESTURE_SUBSCRIPTION_CHANGED__ACTIONS__ACTION_WAKE = 3;
    public static final int WEAR_HARDWARE_BUTTON_INTERACTION_REPORTED = 1244;
    public static final int WEAR_HARDWARE_BUTTON_INTERACTION_REPORTED__HARDWARE_BUTTON_INTERACTION_TYPE__HARDWARE_BUTTON_INTERACTION_DOUBLE_PRESSED = 2;
    public static final int WEAR_HARDWARE_BUTTON_INTERACTION_REPORTED__HARDWARE_BUTTON_INTERACTION_TYPE__HARDWARE_BUTTON_INTERACTION_LONG_PRESSED = 3;
    public static final int WEAR_HARDWARE_BUTTON_INTERACTION_REPORTED__HARDWARE_BUTTON_INTERACTION_TYPE__HARDWARE_BUTTON_INTERACTION_PRESSED = 1;
    public static final int WEAR_HARDWARE_BUTTON_INTERACTION_REPORTED__HARDWARE_BUTTON_INTERACTION_TYPE__HARDWARE_BUTTON_INTERACTION_UNSPECIFIED = 0;
    public static final int WEAR_HARDWARE_BUTTON_INTERACTION_REPORTED__HARDWARE_BUTTON_INTERACTION_TYPE__HARDWARE_BUTTON_VERY_LONG_PRESSED = 4;
    public static final int WEAR_HARDWARE_BUTTON_INTERACTION_REPORTED__HARDWARE_BUTTON_TYPE__HARDWARE_BUTTON_CROWN = 1;
    public static final int WEAR_HARDWARE_BUTTON_INTERACTION_REPORTED__HARDWARE_BUTTON_TYPE__HARDWARE_BUTTON_STEM_PRIMARY = 2;
    public static final int WEAR_HARDWARE_BUTTON_INTERACTION_REPORTED__HARDWARE_BUTTON_TYPE__HARDWARE_BUTTON_UNSPECIFIED = 0;
    public static final int WEAR_KEYGUARD_LOCK_STATE = 10264;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED = 1218;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_REASON__LOCK_REASON_AUTH_CHANGED = 3;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_REASON__LOCK_REASON_GOING_TO_SLEEP = 4;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_REASON__LOCK_REASON_KEYGUARD_DISABLED = 2;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_REASON__LOCK_REASON_KEYGUARD_ENABLED = 10;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_REASON__LOCK_REASON_KEYGUARD_ENTRY_BLOCKED = 11;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_REASON__LOCK_REASON_KEYGUARD_ENTRY_UNBLOCKED = 12;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_REASON__LOCK_REASON_KEYGUARD_REMOVED = 1;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_REASON__LOCK_REASON_LOCK_REQUEST = 7;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_REASON__LOCK_REASON_LOCK_REQUEST_OFFBODY = 8;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_REASON__LOCK_REASON_LOCK_SYS_READY = 9;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_REASON__LOCK_REASON_STARTING_EXIT_ANIMATION = 6;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_REASON__LOCK_REASON_TRUST_CHANGED = 14;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_REASON__LOCK_REASON_UNKNOWN = 0;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_REASON__LOCK_REASON_UNLOCK_SYS_READY = 13;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_REASON__LOCK_REASON_USER_UNLOCK = 5;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_STATE__STATE_LOCKED = 4;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_STATE__STATE_LOCKING = 3;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_STATE__STATE_LOCK_PENDING = 2;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_STATE__STATE_UNKNOWN = 0;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_STATE__STATE_UNLOCKED = 1;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__LOCK_STATE__STATE_UNLOCKING = 5;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__NEXT_LOCK_STATE__STATE_LOCKED = 4;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__NEXT_LOCK_STATE__STATE_LOCKING = 3;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__NEXT_LOCK_STATE__STATE_LOCK_PENDING = 2;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__NEXT_LOCK_STATE__STATE_UNKNOWN = 0;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__NEXT_LOCK_STATE__STATE_UNLOCKED = 1;
    public static final int WEAR_KEYGUARD_LOCK_STATE_CHANGED__NEXT_LOCK_STATE__STATE_UNLOCKING = 5;
    ...
    public static final int WEAR_MODE_STATE_CHANGED__MODE_ID__DOWNTIME_MODE = 9;
    ...
    public static final int WEAR_SCREEN_ON_REQUEST_ISSUED = 1201;
    public static final int WEAR_WAKEUP_MEMORY_COUNTERS = 1246;
    public static final int WEBVIEW_PIN_QUOTA = 10269;
    public static final int WIDGET_INTERACTION_EVENT = 1175;
    ...
    public static final int ZRAM_IO_STAT_MMD = 10240;
    ...
    public static final int ZRAM_MAINTENANCE_EXECUTED__RECOMPRESSION_RESULT__RECOMPRESSION_TRY_MARK_IDLE_AGAIN = 7;
    ...
    public static final int ZRAM_MAINTENANCE_EXECUTED__WRITEBACK_RESULT__WRITEBACK_TRY_MARK_IDLE_AGAIN = 11;
    ...
    public static final int ZRAM_SETUP_EXECUTED__WRITEBACK_SETUP_RESULT__WRITEBACK_SETUP_SUCCESS_LOOPBACK_FALLBACK = 13;
    public static final int ZRAM_SETUP_EXECUTED__WRITEBACK_SETUP_RESULT__WRITEBACK_SETUP_SUCCESS_PARTITION = 12;
    ...
    public static final int ZRAM_WRITEBACK_EVENT = 1202;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__CANCELED_TOKEN_MISMATCH = 18;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__CANCELED_UNFROZEN = 19;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__DISABLED_BY_FLAG = 8;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__FAILED_DEVICE_FULL = 11;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__FAILED_OTHER = 13;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__FAILED_UNSUPPORTED = 12;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__PREFETCHED = 14;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__QUEUED = 17;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__SKIPPED_DMA_BUF_TOO_HIGH = 16;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__SKIPPED_GPU_MEMORY_TOO_HIGH = 15;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__SKIPPED_HAS_DMA_BUF = 7;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__SKIPPED_HAS_GPU_MEMORY = 6;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__SKIPPED_MMD_SERVICE_UNAVAILABLE = 3;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__SKIPPED_NO_ACTIVITY = 1;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__SKIPPED_OTHER_REASONS = 5;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__SKIPPED_RSS_SWAP_TOO_HIGH = 2;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__SKIPPED_UNSUPPORTED_BY_MMD = 4;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__STARTED = 9;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__SUCCEEDED = 10;
    public static final int ZRAM_WRITEBACK_EVENT__EVENT_TYPE__UNKNOWN = 0;
    public FrameworkStatsLog() {}
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, float p2, float p3, float p4, long p5, float p6, float p7, float p8, long p9) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, int p10) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, boolean p8, int p9, int p10) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, int p4, int p5, boolean p6, int p7, int p8) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, int p4, int p5, long[] p6, int p7, int p8) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, int p4, boolean p5, int p6, boolean p7, int[] p8, int[] p9) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, long p4, long p5, int p6, long p7, long p8, int p9, int p10, long p11, int[] p12, int[] p13, int p14, int p15, int p16) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, long p3, long p4, long p5, long p6) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, boolean p3) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, boolean p3, float p4) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, boolean p3, int p4, int p5, boolean p6) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, boolean p3, long p4, long p5, long p6, long p7, long p8, boolean p9, boolean p10, int p11, boolean p12, boolean p13, boolean p14, int p15, int p16, int p17, int p18, int p19, int p20, int p21) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, boolean p3, boolean p4, long p5, long p6, long p7, long p8) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, boolean p3, boolean p4, long p5, long p6, long p7, long p8, java.lang.String p9) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, long p2, long p3, long p4) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, java.lang.String p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, int p10, long p11, long p12) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, java.lang.String p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, boolean p10, int p11, int p12, int p13, int p14, int p15, long p16, long p17, int p18) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, java.lang.String p2, int p3, long p4, long p5) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, java.lang.String p2, long p3, int p4, int p5) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, boolean p2, int p3, long p4, int p5) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, boolean p2, int p3, long p4, long p5, long p6, long p7, int p8) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, boolean p2, boolean p3, int p4, java.lang.String p5, int p6, byte[] p7, int p8, int p9, int p10, int p11) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, boolean p2, int[] p3, int p4, int p5) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, byte[] p2, long p3) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int[] p2) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int[] p2, int[] p3) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int[] p2, int[] p3, int[] p4) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, long p1, long p2, long p3) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, long p1, long p2, long p3, int p4, long p5, int p6, int p7, long p8, java.lang.String p9, float p10, float p11, long p12) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, java.lang.String p1, int p2) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, java.lang.String p1, int[] p2) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, boolean p1, int p2) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, boolean p1, java.lang.String p2, int p3, boolean p4, boolean p5) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, boolean p1, boolean p2) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, boolean p1, boolean p2, int p3) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, boolean p1, boolean p2, int p3, int p4) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, boolean p1, boolean p2, boolean p3, int p4, int p5, boolean p6) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, boolean p1, boolean p2, boolean p3, boolean p4, boolean p5, int p6, int p7, byte[] p8, byte[] p9, byte[] p10, boolean p11, java.lang.String p12, boolean p13, boolean p14, int p15) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, byte[] p1, long p2) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, float[] p1) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int[] p1) { return null; }
    public static com.android.internal.util.FrameworkStatsLog.StatsHistogram createAdaptiveSuspendStats_ConsecutiveBadSuspendBinsHistogram() { return null; }
    public static com.android.internal.util.FrameworkStatsLog.StatsHistogram createAdaptiveSuspendStats_SuspendDurationMillisBinsHistogram() { return null; }
    public static com.android.internal.util.FrameworkStatsLog.StatsHistogram createBinderCallsReported_DurationHistogramMicrosHistogram() { return null; }
    public static com.android.internal.util.FrameworkStatsLog.StatsHistogram createCmaAllocationLatency_DurationLog2BucketsMicrosHistogram() { return null; }
    public static com.android.internal.util.FrameworkStatsLog.StatsHistogram createCompactionDuration_DurationLog2BucketsMicrosHistogram() { return null; }
    public static com.android.internal.util.FrameworkStatsLog.StatsHistogram createDirectReclaimLatency_DurationLog2BucketsMicrosHistogram() { return null; }
    public static com.android.internal.util.FrameworkStatsLog.StatsHistogram createDisplayOffloadCycleStats_AlwaysOnDisplayCpuAndGpuDrawTimePerFrameMsHistogram() { return null; }
    public static com.android.internal.util.FrameworkStatsLog.StatsHistogram createDisplayOffloadCycleStats_AlwaysOnDisplayCpuDrawTimePerFrameMsHistogram() { return null; }
    public static com.android.internal.util.FrameworkStatsLog.StatsHistogram createDisplayOffloadCycleStats_FalseInteractiveCpuAndGpuDrawTimePerFrameMsHistogram() { return null; }
    public static com.android.internal.util.FrameworkStatsLog.StatsHistogram createDisplayOffloadCycleStats_FalseInteractiveCpuDrawTimePerFrameMsHistogram() { return null; }
    public static com.android.internal.util.FrameworkStatsLog.StatsHistogram createDisplayOffloadSessionStats_AlwaysOnDisplayExpressionEvaluationTimePerFrameMsHistogram() { return null; }
    public static com.android.internal.util.FrameworkStatsLog.StatsHistogram createDisplayOffloadSessionStats_AlwaysOnDisplayRendererDrawTimePerFrameMsHistogram() { return null; }
    public static com.android.internal.util.FrameworkStatsLog.StatsHistogram createDisplayOffloadSessionStats_FalseInteractiveExpressionEvaluationTimePerFrameMsHistogram() { return null; }
    public static com.android.internal.util.FrameworkStatsLog.StatsHistogram createDisplayOffloadSessionStats_FalseInteractiveRendererDrawTimePerFrameMsHistogram() { return null; }
    public static com.android.internal.util.FrameworkStatsLog.StatsHistogram createDmabufRequestSizes_SizeLog2BucketsBytesHistogram() { return null; }
    public static com.android.internal.util.FrameworkStatsLog.StatsHistogram createKswapdLatency_DurationLog2BucketsMicrosHistogram() { return null; }
    public static void write(int p0) {}
    public static void write(int p0, float p1, float p2, float p3, java.lang.String p4, boolean p5, float p6, int p7, float p8, float p9, boolean p10, int p11, int p12, int p13, boolean p14, boolean p15, boolean p16, boolean p17, int p18, boolean p19, boolean p20, boolean p21, boolean p22, boolean p23, boolean p24, boolean p25, int p26, int p27, float p28, int p29, int p30, int p31) {}
    ...
    public static void write(int p0, int p1, int p2, float p3, float p4, int p5, float[] p6) {}
    ...
    public static void write(int p0, int p1, int p2, float p3, int p4, boolean p5, boolean p6) {}
    ...
    public static void write(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8) {}
    ...
    public static void write(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, int p10, int p11, float p12) {}
    public static void write(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, int p10, int p11, int p12) {}
    public static void write(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, int p10, int p11, boolean p12, int p13, int p14, int p15, int p16, int p17, boolean p18, boolean p19, boolean p20, int p21, int p22, long p23, long p24, int p25, int p26, int p27, int p28, int p29, int p30, boolean p31, boolean p32, long p33, long p34, int p35, long p36, long p37, int p38, int p39, int p40, int p41, int p42, int p43, int p44, int p45, long p46, int p47, int p48, int p49, int p50, int p51, int p52, long p53, long p54) {}
    public static void write(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, boolean p8) {}
    public static void write(int p0, int p1, int p2, int p3, int p4, int p5, int p6, java.lang.String p7, int p8) {}
    public static void write(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int[] p7, boolean p8, int p9) {}
    ...
    public static void write(int p0, int p1, int p2, int p3, int p4, int p5, java.lang.String p6, java.lang.String p7) {}
    public static void write(int p0, int p1, int p2, int p3, int p4, int p5, boolean p6, int p7, int p8, int p9, int p10, int p11, int p12, int p13, int p14, int p15, int p16, int[] p17, int[] p18, int[] p19, int[] p20) {}
    public static void write(int p0, int p1, int p2, int p3, int p4, int p5, boolean p6, int p7, byte[] p8, boolean p9, int[] p10, int p11) {}
    public static void write(int p0, int p1, int p2, int p3, int p4, int p5, int[] p6, int[] p7, int[] p8, int[] p9) {}
    public static void write(int p0, int p1, int p2, int p3, int p4, long p5, int p6, java.lang.String[] p7, int[] p8, boolean p9, int p10, int p11, boolean p12) {}
    public static void write(int p0, int p1, int p2, int p3, int p4, long p5, long p6) {}
    public static void write(int p0, int p1, int p2, int p3, int p4, java.lang.String p5, java.lang.String p6, int p7, int p8, boolean p9, long p10) {}
    ...
    public static void write(int p0, int p1, int p2, int p3, int p4, boolean p5) {}
    public static void write(int p0, int p1, int p2, int p3, int p4, boolean p5, float p6) {}
    ...
    public static void write(int p0, int p1, int p2, int p3, int p4, byte[] p5, byte[] p6) {}
    ...
    public static void write(int p0, int p1, int p2, int p3, long p4, long p5, float p6, long p7, int p8, int p9, java.lang.String p10) {}
    public static void write(int p0, int p1, int p2, int p3, long p4, long p5, boolean p6, int p7, int p8, boolean p9, boolean p10, boolean p11, boolean p12, long p13, long p14, long p15, boolean p16, int p17) {}
    public static void write(int p0, int p1, int p2, int p3, long p4, java.lang.String p5, long p6, long p7, long p8, long p9, long p10) {}
    ...
    public static void write(int p0, int p1, int p2, int p3, boolean p4) {}
    public static void write(int p0, int p1, int p2, int p3, boolean p4, boolean p5, int p6) {}
    ...
    public static void write(int p0, int p1, int p2, int p3, int[] p4, int p5, int p6) {}
    public static void write(int p0, int p1, int p2, int p3, int[] p4, int p5, int p6, int p7, int p8, int p9, int p10, int p11, boolean p12, long p13, int p14, int p15, long p16, int p17, boolean p18, boolean p19, boolean p20, boolean p21, boolean p22, boolean p23, long p24, int p25, boolean p26, boolean p27, long p28, long p29, long p30, long p31, long p32, long p33, int p34, int p35, int p36, boolean p37, boolean p38, boolean p39, int p40, int p41, int p42, boolean p43, int p44, int p45, int p46, boolean p47, int p48, java.lang.String p49, boolean p50, long p51, long p52, long p53, long p54, boolean p55, boolean p56, int p57, long p58, boolean p59, boolean p60, boolean p61, boolean p62, boolean p63, boolean p64) {}
    public static void write(int p0, int p1, int p2, int p3, int[] p4, int p5, boolean p6, boolean p7, boolean p8) {}
    public static void write(int p0, int p1, int p2, int p3, int[] p4, int[] p5) {}
    public static void write(int p0, int p1, int p2, int p3, int[] p4, int[] p5, int[] p6, int p7, int p8, int p9, int p10) {}
    public static void write(int p0, int p1, int p2, int p3, java.lang.String[] p4, int[] p5) {}
    ...
    public static void write(int p0, int p1, int p2, long p3, int p4, long p5, int p6, int p7, int p8, boolean p9) {}
    public static void write(int p0, int p1, int p2, long p3, int p4, long p5, long p6) {}
    public static void write(int p0, int p1, int p2, long p3, int p4, java.lang.String p5) {}
    public static void write(int p0, int p1, int p2, long p3, long p4) {}
    public static void write(int p0, int p1, int p2, long p3, boolean p4, int p5, float p6, int p7, int p8) {}
    public static void write(int p0, int p1, int p2, long p3, boolean p4, int p5, long p6) {}
    public static void write(int p0, int p1, int p2, java.lang.String p3) {}
    public static void write(int p0, int p1, int p2, java.lang.String p3, int p4, int p5, int p6, int p7, int p8, boolean p9, java.lang.String p10, int p11, int p12, int p13, int p14, int p15, int p16, int p17, int p18, int p19, int p20, float p21, boolean p22, boolean p23, long p24, boolean p25, long p26, int p27, boolean p28, int p29, boolean p30, boolean p31, boolean p32) {}
    ...
    public static void write(int p0, int p1, int p2, java.lang.String p3, int p4, int p5, long p6, long p7, long p8, int p9, java.lang.String p10, java.lang.String p11, int p12, int p13, int p14, int p15, int p16, int p17, boolean p18, long p19, java.lang.String p20, java.lang.String p21, boolean p22, int p23) {}
    public static void write(int p0, int p1, int p2, java.lang.String p3, int p4, int p5, boolean p6) {}
    public static void write(int p0, int p1, int p2, java.lang.String p3, int p4, long p5, int p6, int p7, java.lang.String p8, java.lang.String p9, java.lang.String p10, int p11, int p12, int p13, java.lang.String p14, java.lang.String p15, boolean p16, int p17, int p18) {}
    public static void write(int p0, int p1, int p2, java.lang.String p3, int p4, java.lang.String p5) {}
    public static void write(int p0, int p1, int p2, java.lang.String p3, int p4, boolean p5, int p6, java.lang.String p7, java.lang.String p8, int p9, java.lang.String p10, java.lang.String p11, int p12, int p13, boolean p14, long p15) {}
    public static void write(int p0, int p1, int p2, java.lang.String p3, long p4, int p5, int p6, int p7) {}
    ...
    public static void write(int p0, int p1, int p2, java.lang.String p3, java.lang.String p4, long p5, long p6, int p7, int p8, long p9, long p10, long p11, long p12, int p13, int p14, int[] p15, boolean p16, int p17, long p18, int p19, int p20) {}
    ...
    public static void write(int p0, int p1, int p2, java.lang.String p3, boolean p4, long p5, long p6, boolean p7, boolean p8, long p9, long p10, long p11, int p12) {}
    public static void write(int p0, int p1, int p2, boolean p3) {}
    public static void write(int p0, int p1, int p2, boolean p3, int p4) {}
    public static void write(int p0, int p1, int p2, boolean p3, int p4, float p5) {}
    public static void write(int p0, int p1, int p2, boolean p3, int p4, int p5, int p6, int p7, int p8, int p9, int p10, boolean p11, int[] p12, int p13, int p14, int p15, int p16, int p17, int[] p18, int[] p19, int p20, int[] p21, int[] p22, java.lang.String[] p23, int[] p24, java.lang.String p25, boolean p26, java.lang.String p27) {}
    public static void write(int p0, int p1, int p2, boolean p3, int p4, int p5, int p6, int p7, int p8, int p9, boolean p10, int[] p11, int[] p12, java.lang.String[] p13, int[] p14, java.lang.String p15, int[] p16, int[] p17, int p18, boolean p19, int p20, int p21, int p22, java.lang.String p23) {}
    ...
    public static void write(int p0, int p1, int p2, boolean p3, int p4, int p5, int p6, int p7, boolean p8, long p9, int p10, int p11, int p12, boolean p13, boolean p14, int p15, int p16, int p17, int p18, int p19, int[] p20, boolean p21) {}
    ...
    public static void write(int p0, int p1, int p2, boolean p3, int p4, java.lang.String p5, long p6, int p7) {}
    public static void write(int p0, int p1, int p2, boolean p3, int p4, boolean p5, int p6, long p7, boolean p8, int p9, float p10, int p11, int p12, boolean p13, boolean p14, int p15, int p16, int p17, int p18, int p19, int[] p20, boolean p21) {}
    ...
    public static void write(int p0, int p1, int p2, boolean p3, int[] p4, int[] p5, int[] p6, int[] p7, boolean[] p8, int[] p9, int[] p10, int[] p11, int[] p12, int[] p13, int[] p14, java.lang.String[] p15, boolean p16, java.lang.String[] p17, int[] p18, int p19, boolean[] p20, boolean p21) {}
    public static void write(int p0, int p1, int p2, int[] p3, int p4, int p5, int p6, int[] p7) {}
    public static void write(int p0, int p1, int p2, int[] p3, int p4, int p5, int p6, int[] p7, int[] p8, int p9) {}
    public static void write(int p0, int p1, int p2, int[] p3, long p4, int[] p5) {}
    public static void write(int p0, int p1, int p2, int[] p3, int[] p4, boolean p5, boolean p6, boolean p7) {}
    public static void write(int p0, int p1, int p2, int[] p3, int[] p4, int[] p5) {}
    ...
    public static void write(int p0, int p1, long p2, int p3, int p4, int p5, int p6, int p7, boolean p8, int p9, int p10) {}
    public static void write(int p0, int p1, long p2, int p3, int p4, long p5, int p6, int p7, long p8, int p9, int p10, long p11, long p12, int p13, int p14, long p15) {}
    public static void write(int p0, int p1, long p2, long p3) {}
    public static void write(int p0, int p1, long p2, long p3, int p4) {}
    public static void write(int p0, int p1, long p2, long p3, int p4, int p5, boolean p6, boolean p7, boolean p8) {}
    public static void write(int p0, int p1, long p2, long p3, long p4) {}
    public static void write(int p0, int p1, long p2, long p3, long p4, long p5, long p6, long p7, int p8, int p9, long p10, float p11, float p12, float p13) {}
    public static void write(int p0, int p1, long p2, long p3, long p4, long p5, long p6, long p7, long p8, long p9, int p10, long p11, long p12) {}
    public static void write(int p0, int p1, long p2, boolean p3) {}
    ...
    public static void write(int p0, int p1, java.lang.String p2, int p3, int p4, int p5) {}
    public static void write(int p0, int p1, java.lang.String p2, int p3, int p4, int p5, int p6) {}
    public static void write(int p0, int p1, java.lang.String p2, int p3, int p4, int p5, int p6, int p7, int p8, java.lang.String[] p9, long[] p10, long[] p11, long[] p12, long[] p13, long p14, long p15, long p16) {}
    public static void write(int p0, int p1, java.lang.String p2, int p3, int p4, int p5, int p6, int p7, boolean p8, int p9, int p10) {}
    public static void write(int p0, int p1, java.lang.String p2, int p3, int p4, int p5, int p6, java.lang.String p7, int p8, int p9) {}
    public static void write(int p0, int p1, java.lang.String p2, int p3, int p4, java.lang.String p5, int p6, int p7, int p8, int p9, int p10) {}
    public static void write(int p0, int p1, java.lang.String p2, int p3, int p4, java.lang.String p5, byte[] p6) {}
    public static void write(int p0, int p1, java.lang.String p2, int p3, int p4, boolean p5, int p6) {}
    public static void write(int p0, int p1, java.lang.String p2, int p3, int p4, boolean p5, boolean p6) {}
    public static void write(int p0, int p1, java.lang.String p2, int p3, long p4, int p5) {}
    public static void write(int p0, int p1, java.lang.String p2, int p3, long p4, long p5, long p6, long p7, long p8, long p9, int p10, int p11, int p12, int p13, int p14, int p15, int p16, int p17, long p18, long p19) {}
    ...
    public static void write(int p0, int p1, java.lang.String p2, int p3, java.lang.String p4, int p5, int p6, boolean p7, int p8, int p9, int p10, boolean p11, boolean p12, boolean p13) {}
    public static void write(int p0, int p1, java.lang.String p2, int p3, java.lang.String p4, int p5, java.lang.String p6, boolean p7, java.lang.String p8, java.lang.String p9, java.lang.String p10) {}
    ...
    public static void write(int p0, int p1, java.lang.String p2, int p3, java.lang.String p4, java.lang.String p5, boolean p6, long p7, int p8, int p9, int p10, int p11, int p12, java.lang.String p13, int p14, int p15, int p16, int p17, boolean p18, boolean p19, boolean p20, int p21, long p22, int p23, int p24, int p25, boolean p26, boolean p27, long p28, int p29, int p30) {}
    public static void write(int p0, int p1, java.lang.String p2, int p3, java.lang.String p4, boolean p5, int p6, java.lang.String p7, java.lang.String p8, int p9, int p10, int p11, boolean p12, int p13, java.lang.String p14, boolean p15) {}
    ...
    public static void write(int p0, int p1, java.lang.String p2, int p3, boolean p4, int p5, int p6, int p7, int p8, int p9, boolean p10, boolean p11, int p12, int p13, int p14, boolean p15, int p16, int p17, boolean p18, int p19, int p20, int p21, int[] p22, long[] p23, int p24, int p25, int p26, int p27, long p28, long p29, int p30, int p31, int p32, int p33, int p34, int p35, int p36, boolean p37, int p38) {}
    public static void write(int p0, int p1, java.lang.String p2, int p3, boolean p4, long p5, byte[] p6) {}
    public static void write(int p0, int p1, java.lang.String p2, int p3, int[] p4, int[] p5, int[] p6, int[] p7, int p8, int p9, long p10, long p11, int[] p12, long[] p13, long p14, int p15, int p16, int p17, int p18, int p19, boolean p20, boolean p21, boolean p22, boolean p23, boolean p24, boolean p25, boolean p26, boolean p27, int p28, int p29, boolean p30) {}
    public static void write(int p0, int p1, java.lang.String p2, long p3) {}
    public static void write(int p0, int p1, java.lang.String p2, long p3, long p4, long p5, int p6, int p7, int p8, int p9) {}
    ...
    public static void write(int p0, int p1, java.lang.String p2, java.lang.String p3, int p4, int p5, int p6, long p7, long p8, int[] p9) {}
    public static void write(int p0, int p1, java.lang.String p2, java.lang.String p3, int p4, int p5, java.lang.String p6, java.lang.String p7, java.lang.String p8, java.lang.String p9, java.lang.String p10, int p11) {}
    ...
    public static void write(int p0, int p1, java.lang.String p2, java.lang.String p3, java.lang.String p4, int p5, int p6, int p7, java.lang.String p8, boolean p9, float p10, long p11, int p12, int p13, boolean p14, long p15, long p16, int p17, int p18, int p19, long p20, int p21, long p22, int p23) {}
    ...
    public static void write(int p0, int p1, boolean p2, int p3, int p4) {}
    public static void write(int p0, int p1, boolean p2, long p3, int p4, int p5, java.lang.String p6, int p7) {}
    public static void write(int p0, int p1, boolean p2, java.lang.String p3, int p4, boolean p5, boolean p6, int p7) {}
    public static void write(int p0, int p1, boolean p2, boolean p3, int p4, boolean p5, boolean p6) {}
    public static void write(int p0, int p1, boolean p2, boolean p3, boolean p4, boolean p5, boolean p6, int p7, boolean p8, int p9, boolean p10) {}
    public static void write(int p0, int p1, byte[] p2) {}
    public static void write(int p0, int p1, int[] p2) {}
    public static void write(int p0, int p1, int[] p2, int p3) {}
    public static void write(int p0, int p1, int[] p2, int[] p3, int[] p4, int[] p5, int p6, int p7) {}
    public static void write(int p0, int p1, int[] p2, int[] p3, int[] p4, int[] p5, int p6, int p7, int p8, int p9, int p10, int p11) {}
    public static void write(int p0, int p1, int[] p2, int[] p3, int[] p4, int[] p5, int p6, int p7, boolean p8, boolean p9) {}
    public static void write(int p0, int p1, int[] p2, int[] p3, int[] p4, int[] p5, int p6, int[] p7, int[] p8, int[] p9, int[] p10, float p11, float p12, int p13, int p14, int p15, int p16, int p17, int p18, int p19, int p20, int p21, int p22, int p23, int p24, int p25, int p26, int p27, int p28, int p29, int p30, int p31) {}
    public static void write(int p0, int p1, java.lang.String[] p2, long p3) {}
    ...
    public static void write(int p0, long p1, int p2, int p3, int p4) {}
    ...
    public static void write(int p0, long p1, int p2, int p3, int p4, int p5, int p6, int p7, boolean p8) {}
    public static void write(int p0, long p1, int p2, java.lang.String p3, int p4, java.lang.String p5, int p6, boolean p7, int p8, int p9, int p10, long p11, long p12, boolean p13, int p14, byte[] p15, byte[] p16, byte[] p17, byte[] p18, byte[] p19, java.lang.String p20, int p21, long p22, int p23, int p24, boolean p25, boolean p26, boolean p27, int p28, int p29, int p30, int p31, boolean p32, int p33, boolean p34, int p35, int p36, int p37) {}
    public static void write(int p0, long p1, int p2, boolean p3, int p4, int p5) {}
    public static void write(int p0, long p1, int p2, boolean p3, boolean p4) {}
    ...
    public static void write(int p0, long p1, long p2, long p3) {}
    public static void write(int p0, long p1, long p2, long p3, int p4, int p5) {}
    public static void write(int p0, long p1, long p2, long p3, long p4, int p5, int p6, boolean p7, boolean p8, boolean p9, boolean p10, int p11) {}
    ...
    public static void write(int p0, android.os.WorkSource p1, int p2, int p3, int p4, boolean p5, int p6, int p7, int p8, long p9, long p10, long p11, long p12, int p13, int p14, int p15, int p16, int p17, int p18, int p19, int[] p20, int[] p21, int[] p22, int[] p23, int p24, int p25, float p26, int p27) {}
    ...
    public static void write(int p0, java.lang.String p1, int p2, int p3, float p4, float p5) {}
    ...
    public static void write(int p0, java.lang.String p1, int p2, int p3, int p4, int p5, boolean p6, boolean p7, int p8, int p9, int p10, int p11, int p12, int[] p13) {}
    public static void write(int p0, java.lang.String p1, int p2, int p3, int p4, int p5, boolean p6, boolean p7, int p8, boolean p9, boolean p10, int p11, int p12) {}
    public static void write(int p0, java.lang.String p1, int p2, int p3, int p4, java.lang.String p5, long p6, long p7, int[] p8) {}
    ...
    public static void write(int p0, java.lang.String p1, java.lang.String p2, int p3, long p4, long p5, long p6, long p7, long p8, long p9) {}
    public static void write(int p0, java.lang.String p1, java.lang.String p2, long p3, long p4, long p5, boolean p6, java.lang.String p7, java.lang.String p8, int p9, int p10, java.lang.String p11, java.lang.String p12, int p13) {}
    ...
    public static void write(int p0, java.lang.String p1, java.lang.String p2, java.lang.String p3, int p4, int p5, boolean p6, int p7, int p8, boolean p9, boolean p10, boolean p11, boolean p12, int p13, boolean p14, boolean p15, boolean p16, float p17) {}
    public static void write(int p0, java.lang.String p1, java.lang.String p2, java.lang.String p3, java.lang.String p4, int p5, int p6, java.lang.String p7, java.lang.String p8, int p9, java.lang.String p10) {}
    ...
    public static void write(int p0, boolean p1, int p2) {}
    ...
    public static void write(int p0, boolean p1, int p2, int p3, int p4, boolean p5, int p6) {}
    public static void write(int p0, boolean p1, int p2, int p3, int p4, boolean p5, int p6, int p7, int p8) {}
    public static void write(int p0, boolean p1, int p2, int p3, long p4, int p5, java.lang.String p6, int p7) {}
    public static void write(int p0, boolean p1, int p2, int p3, byte[] p4, int p5) {}
    public static void write(int p0, boolean p1, int p2, long p3) {}
    public static void write(int p0, boolean p1, int p2, java.lang.String p3, int p4, int p5) {}
    ...
    public static void write(int p0, boolean p1, boolean p2) {}
    public static void write(int p0, boolean p1, boolean p2, int p3) {}
    public static void write(int p0, boolean p1, boolean p2, int p3, int p4, int p5) {}
    public static void write(int p0, boolean p1, boolean p2, int p3, int p4, int p5, int p6, int p7) {}
    public static void write(int p0, boolean p1, boolean p2, boolean p3, boolean p4, int p5) {}
    public static void write(int p0, boolean p1, java.lang.String[] p2, java.lang.String p3, int[] p4, java.lang.String p5, int[] p6, java.lang.String p7, java.lang.String p8, boolean p9) {}
    ...
    public static void write(int p0, int[] p1, java.lang.String[] p2, int p3) {}
    public static void write(int p0, int[] p1, java.lang.String[] p2, int p3, int p4) {}
    public static void write(int p0, int[] p1, java.lang.String[] p2, int p3, int p4, int p5, boolean p6, int p7, int p8, int p9, long p10, long p11, long p12, long p13, int p14, int p15, int p16, int p17, int p18, int p19, int p20, int[] p21, int[] p22, int[] p23, int[] p24, int p25, int p26, float p27, int p28) {}
    ...
    public static void write(int p0, int[] p1, java.lang.String[] p2, java.lang.String p3, int p4) {}
    public static void write(int p0, int[] p1, java.lang.String[] p2, java.lang.String p3, int p4, int p5) {}
    public static void write(int p0, int[] p1, java.lang.String[] p2, java.lang.String p3, int p4, int p5, int p6, long p7, boolean p8, boolean p9, boolean p10, boolean p11, boolean p12, boolean p13, boolean p14, boolean p15, boolean p16, boolean p17, int p18, boolean p19, int p20, int p21, int p22, long p23, boolean p24, boolean p25, boolean p26, boolean p27, boolean p28, boolean p29, boolean p30, boolean p31, long p32, boolean p33, boolean p34, boolean p35, long p36, long p37, long p38, int p39, int p40, java.lang.String p41, long p42, long p43, long p44, long p45, long p46, long p47, boolean p48, boolean p49, boolean p50, int p51, int p52, java.lang.String p53, java.lang.String[] p54, int p55, int p56, boolean p57, int[] p58, long[] p59) {}
    ...
    public static void write_non_chained(int p0, int p1, java.lang.String p2, int p3, int p4, int p5, boolean p6, int p7, int p8, int p9, long p10, long p11, long p12, long p13, int p14, int p15, int p16, int p17, int p18, int p19, int p20, int[] p21, int[] p22, int[] p23, int[] p24, int p25, int p26, float p27, int p28) {}
    ...
    public static final class StatsHistogram {
        public static final float UNDERFLOW = -3.4028234663852886e+38f;
        private final int[] mBinCounts = null;
        private final float[] mBins = null;
        private StatsHistogram(float[] p0) {}
        public static com.android.internal.util.FrameworkStatsLog.StatsHistogram createExplicitBins(float... p0) { return null; }
        public static com.android.internal.util.FrameworkStatsLog.StatsHistogram createExponentialBins(float p0, float p1, int p2) { return null; }
        public static com.android.internal.util.FrameworkStatsLog.StatsHistogram createLinearBins(float p0, float p1, int p2) { return null; }
        public void addValue(float p0) {}
        public void clear() {}
        public int[] getBinCounts() { return null; }
        public float[] getBins() { return null; }
    }
}
