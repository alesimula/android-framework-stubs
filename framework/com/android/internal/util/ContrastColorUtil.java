...
public class ContrastColorUtil {
    ...
    public static int ensureContrast(int p0, int p1, double p2) { return 0; }
    ...
    public static int invertColorLightness(int p0) { return 0; }
    public static boolean isAdaptiveIconDrawableIcon(android.content.Context p0, android.graphics.drawable.Icon p1) { return false; }
