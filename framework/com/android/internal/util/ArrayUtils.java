...
public class ArrayUtils {
    ...
    public static boolean[] appendBooleanDuplicatesAllowed(boolean[] p0, boolean p1) { return null; }
    ...
    public static byte[] copyOfArrayNonMovable(byte[] p0, int p1) { return null; }
    private static <T extends java.lang.Object> T[] createEmptyArray(java.lang.Class<T> p0) { return null; }
    ...
    public static byte[] newNonMovableByteArray(int p0) { return null; }
    public static char[] newNonMovableCharArray(int p0) { return null; }
    ...
    public static native void zeroize(byte[] p0);
    public static native void zeroize(char[] p0);
    public static void zeroize$ravenwood(byte[] p0) {}
    public static void zeroize$ravenwood(char[] p0) {}
}
