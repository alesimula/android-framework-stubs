...
public class ArrayUtils {
    ...
    public static byte[] newUnpaddedByteArray$ravenwood(int p0) { return null; }
    public static char[] newUnpaddedCharArray$ravenwood(int p0) { return null; }
    public static int[] newUnpaddedIntArray$ravenwood(int p0) { return null; }
    public static boolean[] newUnpaddedBooleanArray$ravenwood(int p0) { return null; }
    public static long[] newUnpaddedLongArray$ravenwood(int p0) { return null; }
    public static float[] newUnpaddedFloatArray$ravenwood(int p0) { return null; }
    public static java.lang.Object[] newUnpaddedObjectArray$ravenwood(int p0) { return null; }
    public static <T extends java.lang.Object> T[] newUnpaddedArray$ravenwood(java.lang.Class<T> p0, int p1) { return null; }
    ...
    public static <T extends java.lang.Object> T[] emptyIfNull(T[] p0, java.lang.Class<T> p1) { return null; }
    ...
    @android.annotation.NonNull
    public static int[] convertToIntArray(android.util.ArraySet<java.lang.Integer> p0) { return null; }
    @android.annotation.Nullable
    public static long[] convertToLongArray(int[] p0) { return null; }
    @android.annotation.NonNull
    public static <T extends java.lang.Object> T[] concat(java.lang.Class<T> p0, T[]... p1) { return null; }
    @android.annotation.NonNull
    public static byte[] concat(byte[]... p0) { return null; }
    @android.annotation.NonNull
    ...
    public static boolean[] appendBoolean(boolean[] p0, boolean p1) { return null; }
    @android.annotation.NonNull
    ...
    @android.annotation.NonNull
    public static <T extends java.lang.Object> android.util.ArraySet<T> addAll(android.util.ArraySet<T> p0, java.util.Collection<T> p1) { return null; }
    @android.annotation.Nullable
    ...
    @android.annotation.NonNull
    public static <T extends java.lang.Object> java.util.ArrayList<T> add(java.util.ArrayList<T> p0, int p1, T p2) { return null; }
    @android.annotation.Nullable
    ...
    public static void throwsIfOutOfBounds(int p0, int p1, int p2) {}
    public static <T extends java.lang.Object> T[] filterNotNull(T[] p0, java.util.function.IntFunction<T[]> p1) { return null; }
    @android.annotation.Nullable
    public static <T extends java.lang.Object> T[] filter(T[] p0, java.util.function.IntFunction<T[]> p1, java.util.function.Predicate<T> p2) { return null; }
    ...
    @android.annotation.Nullable
    public static <T extends java.lang.Object> T getOrNull(T[] p0, int p1) { return null; }
    @android.annotation.Nullable
    public static <T extends java.lang.Object> T firstOrNull(T[] p0) { return null; }
    public static <T extends java.lang.Object> java.util.List<T> toList(T[] p0) { return null; }
}
