...
public class TraceBuffer<P extends java.lang.Object, S extends P, T extends P> {
    ...
    public synchronized int getAvailableSpace() { return 0; }
    public synchronized int size() { return 0; }
    public synchronized void setCapacity(int p0) {}
    public synchronized void add(T p0) {}
    public synchronized boolean contains(byte[] p0) { return false; }
    public synchronized void writeTraceToFile(java.io.File p0, S p1) throws java.io.IOException {}
    public synchronized void resetBuffer() {}
    public synchronized int getBufferSize() { return 0; }
    public synchronized java.lang.String getStatus() { return null; }
