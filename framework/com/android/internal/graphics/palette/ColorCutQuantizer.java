...
final class ColorCutQuantizer implements com.android.internal.graphics.palette.Quantizer {
    ...
    private boolean shouldIgnoreColor(int p0) { return false; }
    private boolean shouldIgnoreColor(com.android.internal.graphics.palette.Palette.Swatch p0) { return false; }
    private boolean shouldIgnoreColor(int p0, float[] p1) { return false; }
