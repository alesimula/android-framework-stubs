...
public class ChangeReporter {
    ...
    public void reportChange(int p0, long p1, int p2, boolean p3, boolean p4, boolean p5) {}
    public void reportChange(int p0, long p1, int p2, boolean p3) {}
    public void startDebugLogAll() {}
    public void stopDebugLogAll() {}
    boolean shouldWriteToStatsLog(boolean p0, boolean p1) { return false; }
    ...
    boolean isAlreadyReported(int p0, long p1, int p2) { return false; }
