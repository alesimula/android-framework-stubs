...
public class KMeans {
    ...
    private final java.util.Random mRandomState = null;
    private final int mMaxIterations = 0;
    ...
    private boolean step(java.util.ArrayList<com.android.internal.ml.clustering.KMeans.Mean> p0, float[][] p1) { return false; }
