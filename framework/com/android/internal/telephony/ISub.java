...
public interface ISub extends android.os.IInterface {
    ...
    public boolean canManageSubscriptionAsUser(android.telephony.SubscriptionInfo p0, java.lang.String p1, android.os.UserHandle p2) throws android.os.RemoteException;
    ...
    public android.telephony.SubscriptionPlan[] getEnrollableSubscriptionPlans(int p0, java.lang.String p1) throws android.os.RemoteException;
    public java.lang.String getEnrollableSubscriptionPlansOwner(int p0) throws android.os.RemoteException;
    public java.lang.String getLastKnownPhoneNumberFromFirstAvailableSource(int p0, java.lang.String p1, java.lang.String p2) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements com.android.internal.telephony.ISub {
        ...
        static final int TRANSACTION_canManageSubscriptionAsUser = 53;
        ...
        static final int TRANSACTION_getEnrollableSubscriptionPlans = 64;
        static final int TRANSACTION_getEnrollableSubscriptionPlansOwner = 65;
        static final int TRANSACTION_getLastKnownPhoneNumberFromFirstAvailableSource = 52;
        ...
        static final int TRANSACTION_getSubscriptionInfoListAssociatedWithUser = 60;
        ...
        static final int TRANSACTION_restoreAllSimSpecificSettingsFromBackup = 61;
        static final int TRANSACTION_restorePlatformManagedSimPins = 67;
        ...
        static final int TRANSACTION_setEnrollableSubscriptionPlans = 63;
        static final int TRANSACTION_setGroupOwner = 55;
        ...
        static final int TRANSACTION_setSubscriptionUserHandle = 56;
        static final int TRANSACTION_setTransferStatus = 62;
        ...
        private static final class Proxy implements com.android.internal.telephony.ISub {
