...
public final class TelephonyStatsLog {
    ...
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_ERROR_NONE = 0;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_ERROR = 1;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_SERVER_ERROR = 2;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_SERVICE_ERROR = 3;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_MODEM_ERROR = 4;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_NETWORK_ERROR = 5;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_INVALID_TELEPHONY_STATE = 6;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_INVALID_MODEM_STATE = 7;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_INVALID_ARGUMENTS = 8;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_REQUEST_FAILED = 9;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_RADIO_NOT_AVAILABLE = 10;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_REQUEST_NOT_SUPPORTED = 11;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_NO_RESOURCES = 12;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_SERVICE_NOT_PROVISIONED = 13;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_SERVICE_PROVISION_IN_PROGRESS = 14;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_REQUEST_ABORTED = 15;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_ACCESS_BARRED = 16;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_NETWORK_TIMEOUT = 17;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_NOT_REACHABLE = 18;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_NOT_AUTHORIZED = 19;
    public static final int SATELLITE_ACCESS_CONTROLLER__RESULT_CODE__SATELLITE_NOT_SUPPORTED = 20;
    ...
    public static void write(int p0, int p1, int p2, int p3, int p4, boolean p5, boolean p6, int p7, boolean p8, int p9, int p10, int p11, int p12, int p13, boolean p14, int p15, int p16, int p17, int p18, int p19) {}
    @android.annotation.SuppressLint("ObsoleteSdkInt")
    public static void write(int p0, int p1, int p2, int p3, int p4, int p5, int p6, boolean p7, boolean p8) {}
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, boolean p1, boolean p2, int p3, boolean p4, int p5) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, boolean p1, int p2, boolean p3, int p4, int p5, boolean p6, int p7, boolean p8) { return null; }
    @android.annotation.SuppressLint("ObsoleteSdkInt")
    public static android.util.StatsEvent buildStatsEvent(int p0, boolean p1, int p2, int p3, java.lang.String p4, java.lang.String p5, java.lang.String p6, int p7, java.lang.String[] p8, int[] p9, int[] p10) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1) { return null; }
    @android.annotation.SuppressLint("ObsoleteSdkInt")
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, boolean p2, boolean p3, int p4, int p5, int p6, boolean p7, int p8, boolean p9, long p10, boolean p11, int p12, boolean p13, int p14, int p15, int p16, long p17, boolean p18, int p19, int[] p20, int[] p21, boolean p22, boolean p23, boolean p24, boolean p25, boolean p26) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, boolean p2, int p3, boolean p4, int p5, int p6, java.lang.String p7, int p8, boolean p9) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, boolean p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, int p10, int p11, int p12, int p13, int p14, int p15, int p16) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, boolean p3, boolean p4) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, boolean p4, int p5) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, int p4, boolean p5, int p6, boolean p7, int p8, int p9, boolean p10, boolean p11, int p12, boolean p13, boolean p14, boolean p15, boolean p16) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, int p4, boolean p5, int p6, int p7, java.lang.String p8, int p9, int p10, long p11, long p12, int p13, int p14, int p15, boolean p16, boolean p17, int p18, boolean p19, long p20, long p21, boolean p22, boolean p23, boolean p24, int p25, int p26, int p27, int p28, int p29, boolean p30, int p31, boolean p32, int p33, int p34, int p35, long p36, boolean p37, boolean p38, boolean p39, boolean p40, boolean p41, boolean p42, boolean p43, int p44) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, int p4, int p5, boolean p6, boolean p7, int p8, boolean p9, boolean p10, int p11, long p12, int p13, long p14, int p15, int p16, int p17, boolean p18, boolean p19, boolean p20) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, int p4, int p5, boolean p6, boolean p7, int p8, int p9, boolean p10, boolean p11, long p12, boolean p13, boolean p14, int p15, int p16, long p17, boolean p18, boolean p19) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, int p4, int p5, int p6) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, int p4, int p5, int p6, boolean p7, int p8, boolean p9, int p10, boolean p11, boolean p12, int p13, long p14, int p15, boolean p16, boolean p17, boolean p18) { return null; }
    ...
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, int p10, int p11, int p12, int p13, int p14, boolean p15, int p16) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, int p10, int p11, int p12, int p13, int p14, int p15, int p16, int p17, int p18, int p19, int p20, int p21, int p22, int p23, int p24, int p25, int p26, int p27, int p28) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, int p4, long p5, boolean p6, int p7) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, int p4, long p5, long p6, int p7, int p8, int p9, int p10, int p11, boolean p12, int p13) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, long p4, boolean p5) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, int p3, float p4, int p5, int p6) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, long p3, boolean p4) { return null; }
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, int p2, long p3, long p4) { return null; }
    @android.annotation.SuppressLint("ObsoleteSdkInt")
    public static android.util.StatsEvent buildStatsEvent(int p0, int p1, long p2, long p3, long p4, boolean p5, boolean p6, int p7, java.lang.String[] p8, int p9) { return null; }
