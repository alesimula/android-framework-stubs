...
public interface ITelephony extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements com.android.internal.telephony.ITelephony {
        ...
        static final int TRANSACTION_setCtsMode = 388;
        static final int TRANSACTION_setSatelliteServicePackageName = 389;
        static final int TRANSACTION_setSatelliteGatewayServicePackageName = 390;
        static final int TRANSACTION_setSatelliteListeningTimeoutDuration = 391;
        static final int TRANSACTION_setSatelliteIgnoreCellularServiceState = 392;
        static final int TRANSACTION_setSupportDisableSatelliteWhileEnableInProgress = 393;
        static final int TRANSACTION_setSatellitePointingUiClassName = 394;
        static final int TRANSACTION_setDatagramControllerTimeoutDuration = 395;
        static final int TRANSACTION_setSatelliteControllerTimeoutDuration = 396;
        static final int TRANSACTION_setEmergencyCallToSatelliteHandoverType = 397;
        static final int TRANSACTION_setCountryCodes = 398;
        static final int TRANSACTION_setSatelliteAccessControlOverlayConfigs = 399;
        static final int TRANSACTION_setSatelliteAccessAllowedForSubscriptions = 400;
        static final int TRANSACTION_setTnScanningSupport = 401;
        static final int TRANSACTION_setOemEnabledSatelliteProvisionStatus = 402;
        static final int TRANSACTION_overrideConfigDataVersion = 403;
        static final int TRANSACTION_getShaIdFromAllowList = 404;
        static final int TRANSACTION_addAttachRestrictionForCarrier = 405;
        static final int TRANSACTION_removeAttachRestrictionForCarrier = 406;
        static final int TRANSACTION_getAttachRestrictionReasonsForCarrier = 407;
        static final int TRANSACTION_requestNtnSignalStrength = 408;
        static final int TRANSACTION_registerForNtnSignalStrengthChanged = 409;
        static final int TRANSACTION_unregisterForNtnSignalStrengthChanged = 410;
        static final int TRANSACTION_registerForCapabilitiesChanged = 411;
        static final int TRANSACTION_unregisterForCapabilitiesChanged = 412;
        static final int TRANSACTION_setShouldSendDatagramToModemInDemoMode = 413;
        static final int TRANSACTION_setDomainSelectionServiceOverride = 414;
        static final int TRANSACTION_clearDomainSelectionServiceOverride = 415;
        static final int TRANSACTION_isAospDomainSelectionService = 416;
        static final int TRANSACTION_setEnableCellularIdentifierDisclosureNotifications = 417;
        static final int TRANSACTION_isCellularIdentifierDisclosureNotificationsEnabled = 418;
        static final int TRANSACTION_setNullCipherNotificationsEnabled = 419;
        static final int TRANSACTION_isNullCipherNotificationsEnabled = 420;
        static final int TRANSACTION_getSatellitePlmnsForCarrier = 421;
        static final int TRANSACTION_registerForSatelliteSupportedStateChanged = 422;
        static final int TRANSACTION_unregisterForSatelliteSupportedStateChanged = 423;
        static final int TRANSACTION_registerForCommunicationAccessStateChanged = 424;
        static final int TRANSACTION_unregisterForCommunicationAccessStateChanged = 425;
        static final int TRANSACTION_setDatagramControllerBooleanConfig = 426;
        static final int TRANSACTION_setIsSatelliteCommunicationAllowedForCurrentLocationCache = 427;
        static final int TRANSACTION_overrideSatelliteEntilementStatusResponseForCtsTest = 428;
        static final int TRANSACTION_overrideSatelliteEntilementQueryConditions = 429;
        static final int TRANSACTION_setMaxAllowedSatelliteDataModeForCtsTest = 430;
        static final int TRANSACTION_requestSatelliteSessionStats = 431;
        static final int TRANSACTION_requestSatelliteSubscriberProvisionStatus = 432;
        static final int TRANSACTION_requestSatelliteDisplayName = 433;
        static final int TRANSACTION_provisionSatellite = 434;
        static final int TRANSACTION_setSatelliteSubscriberIdListChangedIntentComponent = 435;
        static final int TRANSACTION_setTestEuiccUiComponent = 436;
        static final int TRANSACTION_getTestEuiccUiComponent = 437;
        static final int TRANSACTION_overrideCarrierRoamingNtnEligibilityChanged = 438;
        static final int TRANSACTION_deprovisionSatellite = 439;
        static final int TRANSACTION_setNtnSmsSupported = 440;
        static final int TRANSACTION_getCarrierIdFromIdentifier = 441;
        static final int TRANSACTION_getSatelliteDataOptimizedApps = 442;
        static final int TRANSACTION_getSatelliteDataSupportMode = 443;
        static final int TRANSACTION_setSatelliteIgnorePlmnListFromStorage = 444;
        public Stub() { super(); }
