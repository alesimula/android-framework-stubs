...
public interface IPhoneStateListener extends android.os.IInterface {
    ...
    public void onCallbackModeRestarted(int p0, long p1, int p2) throws android.os.RemoteException;
    public void onCallbackModeStarted(int p0, long p1, int p2) throws android.os.RemoteException;
    public void onCallbackModeStopped(int p0, int p1, int p2) throws android.os.RemoteException;
    public void onCarrierNetworkChange(boolean p0) throws android.os.RemoteException;
    public void onCarrierRoamingNtnAvailableServicesChanged(int[] p0) throws android.os.RemoteException;
    public void onCarrierRoamingNtnEligibleStateChanged(boolean p0) throws android.os.RemoteException;
    public void onCarrierRoamingNtnModeChanged(boolean p0) throws android.os.RemoteException;
    public void onCarrierRoamingNtnSignalStrengthChanged(android.telephony.satellite.NtnSignalStrength p0) throws android.os.RemoteException;
    ...
    public void onCellularIdentifierDisclosedChanged(android.telephony.CellularIdentifierDisclosure p0) throws android.os.RemoteException;
    ...
    public void onDomainSelectionEmergencyModeEntered(int p0, int p1, int p2) throws android.os.RemoteException;
    public void onDomainSelectionEmergencyModeExited(int p0, int p1, int p2) throws android.os.RemoteException;
    ...
    public void onNetworkSecurityEvents(java.util.List<android.telephony.NetworkSecurityEvent> p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements com.android.internal.telephony.IPhoneStateListener {
        ...
        static final int TRANSACTION_onDomainSelectionEmergencyModeEntered = 48;
        static final int TRANSACTION_onDomainSelectionEmergencyModeExited = 49;
        ...
        static final int TRANSACTION_onNetworkSecurityEvents = 50;
        ...
        private static final class Proxy implements com.android.internal.telephony.IPhoneStateListener {
