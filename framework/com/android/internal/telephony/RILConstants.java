...
public interface RILConstants {
    ...
    public static final int PREFERRED_NETWORK_MODE = Integer.valueOf(0);
    ...
    public static final int RIL_REQUEST_GET_SIM_TYPE_INFO = 259;
    ...
    public static final int RIL_REQUEST_GET_SUPPORTED_NETWORK_ALERT_CATEGORIES = 260;
    ...
    public static final int RIL_REQUEST_NOTIFY_IMS_DATA_NETWORK = 257;
    ...
    public static final int RIL_REQUEST_REBOOT_MODEM = 264;
    ...
    public static final int RIL_REQUEST_SET_SATELLITE_NETWORK_INFO = 261;
    ...
    public static final int RIL_REQUEST_SET_SIM_TYPE = 258;
    ...
    public static final int RIL_REQUEST_SET_USER_DATA_ENABLED = 254;
    public static final int RIL_REQUEST_SET_USER_DATA_ROAMING_ENABLED = 255;
    ...
    public static final int RIL_REQUEST_START_PRIORITIZED_NETWORK_SCAN = 262;
    ...
    public static final int RIL_REQUEST_STOP_PRIORITIZED_NETWORK_SCAN = 263;
    ...
    public static final int RIL_REQUEST_UPDATE_ALLOWED_IMS_SERVICES = 256;
    ...
    public static final int RIL_UNSOL_DATA_CALL_LIST_UPDATED = 1112;
    public static final int RIL_UNSOL_DC_RT_INFO_CHANGED = 1041;
    public static final int RIL_UNSOL_DISPLAY_NETWORK_TYPE_CHANGED = 1058;
    ...
    public static final int RIL_UNSOL_NETWORK_SECURITY_EVENTS = 1059;
    ...
    public static final int RIL_UNSOL_PRIORITIZED_SCAN_MODE_CHANGED = 1060;
    ...
    public static final int RIL_UNSOL_RESPONSE_NEW_SECURE_SMS = 1061;
