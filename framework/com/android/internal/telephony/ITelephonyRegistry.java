...
public interface ITelephonyRegistry extends android.os.IInterface {
    public void addCarrierConfigChangeListener(com.android.internal.telephony.ICarrierConfigChangeListener p0, java.lang.String p1, java.lang.String p2) throws android.os.RemoteException;
    ...
    public void addSatelliteStateChangeListener(com.android.internal.telephony.ISatelliteStateChangeListener p0, java.lang.String p1, java.lang.String p2) throws android.os.RemoteException;
    ...
    public void notifyCallbackModeRestarted(int p0, int p1, int p2, long p3) throws android.os.RemoteException;
    public void notifyCallbackModeStarted(int p0, int p1, int p2, long p3) throws android.os.RemoteException;
    public void notifyCallbackModeStopped(int p0, int p1, int p2, int p3) throws android.os.RemoteException;
    public void notifyCarrierConfigChanged(int p0, int p1, int p2, int p3) throws android.os.RemoteException;
    public void notifyCarrierNetworkChange(boolean p0) throws android.os.RemoteException;
    public void notifyCarrierNetworkChangeForPhoneAndSubId(int p0, int p1, boolean p2) throws android.os.RemoteException;
    ...
    public void notifyCarrierRoamingNtnAvailableServicesChanged(int p0, int[] p1) throws android.os.RemoteException;
    public void notifyCarrierRoamingNtnEligibleStateChanged(int p0, boolean p1) throws android.os.RemoteException;
    public void notifyCarrierRoamingNtnModeChanged(int p0, boolean p1) throws android.os.RemoteException;
    public void notifyCarrierRoamingNtnSignalStrengthChanged(int p0, android.telephony.satellite.NtnSignalStrength p1) throws android.os.RemoteException;
    ...
    public void notifyCellularIdentifierDisclosedChanged(int p0, int p1, android.telephony.CellularIdentifierDisclosure p2) throws android.os.RemoteException;
    public void notifyDataActivityForSubscriber(int p0, int p1) throws android.os.RemoteException;
    public void notifyDataActivityForSubscriberWithSlot(int p0, int p1, int p2) throws android.os.RemoteException;
    ...
    public void notifyDomainSelectionEmergencyModeChanged(int p0, int p1, int p2, boolean p3) throws android.os.RemoteException;
    ...
    public void notifyMediaQualityStatusChanged(int p0, int p1, android.telephony.ims.MediaQualityStatus p2) throws android.os.RemoteException;
    public void notifyMessageWaitingChangedForPhoneId(int p0, int p1, boolean p2) throws android.os.RemoteException;
    public void notifyNetworkSecurityEvents(int p0, int p1, java.util.List<android.telephony.NetworkSecurityEvent> p2) throws android.os.RemoteException;
    ...
    public void notifySimultaneousCellularCallingSubscriptionsChanged(int[] p0) throws android.os.RemoteException;
    ...
    public void removeCarrierConfigChangeListener(com.android.internal.telephony.ICarrierConfigChangeListener p0, java.lang.String p1) throws android.os.RemoteException;
    ...
    public void removeSatelliteStateChangeListener(com.android.internal.telephony.ISatelliteStateChangeListener p0, java.lang.String p1) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements com.android.internal.telephony.ITelephonyRegistry {
        ...
        static final int TRANSACTION_notifyDomainSelectionEmergencyModeChanged = 64;
        ...
        static final int TRANSACTION_notifyNetworkSecurityEvents = 65;
        ...
        private static final class Proxy implements com.android.internal.telephony.ITelephonyRegistry {
