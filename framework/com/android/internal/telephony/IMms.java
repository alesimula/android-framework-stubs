...
public interface IMms extends android.os.IInterface {
    public void sendMessage(int p0, java.lang.String p1, android.net.Uri p2, java.lang.String p3, android.os.Bundle p4, android.app.PendingIntent p5) throws android.os.RemoteException;
    public void downloadMessage(int p0, java.lang.String p1, java.lang.String p2, android.net.Uri p3, android.os.Bundle p4, android.app.PendingIntent p5) throws android.os.RemoteException;
    public android.os.Bundle getCarrierConfigValues(int p0) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements com.android.internal.telephony.IMms {
        ...
        private static class Proxy implements com.android.internal.telephony.IMms {
            ...
            public void sendMessage(int p0, java.lang.String p1, android.net.Uri p2, java.lang.String p3, android.os.Bundle p4, android.app.PendingIntent p5) throws android.os.RemoteException {}
            public void downloadMessage(int p0, java.lang.String p1, java.lang.String p2, android.net.Uri p3, android.os.Bundle p4, android.app.PendingIntent p5) throws android.os.RemoteException {}
            public android.os.Bundle getCarrierConfigValues(int p0) throws android.os.RemoteException { return null; }
