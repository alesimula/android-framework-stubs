...
public interface IAppWidgetService extends android.os.IInterface {
    ...
    public boolean isRequestPinAppWidgetSupported(java.lang.String p0) throws android.os.RemoteException;
    ...
    public android.content.pm.ParceledListSlice queryAppWidgetEvents(java.lang.String p0, long p1, long p2) throws android.os.RemoteException;
    ...
    public static class Default implements com.android.internal.appwidget.IAppWidgetService {
        ...
        public boolean isRequestPinAppWidgetSupported(java.lang.String p0) throws android.os.RemoteException { return false; }
        public void noteAppWidgetTapped(java.lang.String p0, int p1) throws android.os.RemoteException {}
        public void notifyProviderInheritance(android.content.ComponentName[] p0) throws android.os.RemoteException {}
        public void partiallyUpdateAppWidgetIds(java.lang.String p0, int[] p1, android.widget.RemoteViews p2) throws android.os.RemoteException {}
        public android.content.pm.ParceledListSlice queryAppWidgetEvents(java.lang.String p0, long p1, long p2) throws android.os.RemoteException { return null; }
        public void removeWidgetPreview(android.content.ComponentName p0, int p1) throws android.os.RemoteException {}
        public void reportWidgetEvents(java.lang.String p0, android.appwidget.AppWidgetEvent[] p1) throws android.os.RemoteException {}
    ...
    public static abstract class Stub extends android.os.Binder implements com.android.internal.appwidget.IAppWidgetService {
        ...
        static final int TRANSACTION_getAppWidgetIds = 24;
        ...
        static final int TRANSACTION_getMaxBitmapMemory = 23;
        static final int TRANSACTION_getWidgetPreview = 30;
        static final int TRANSACTION_hasBindAppWidgetPermission = 19;
        static final int TRANSACTION_isBoundWidgetPackage = 25;
        static final int TRANSACTION_isFirstConfigActivityPending = 34;
        static final int TRANSACTION_isRequestPinAppWidgetSupported = 27;
        static final int TRANSACTION_noteAppWidgetTapped = 28;
        static final int TRANSACTION_notifyProviderInheritance = 22;
        static final int TRANSACTION_partiallyUpdateAppWidgetIds = 14;
        static final int TRANSACTION_queryAppWidgetEvents = 33;
        static final int TRANSACTION_removeWidgetPreview = 31;
        static final int TRANSACTION_reportWidgetEvents = 32;
        static final int TRANSACTION_requestPinAppWidget = 26;
        static final int TRANSACTION_setAppWidgetHidden = 9;
        static final int TRANSACTION_setBindAppWidgetPermission = 20;
        static final int TRANSACTION_setConfigActivityComplete = 35;
        static final int TRANSACTION_setWidgetPreview = 29;
        ...
        private static final class Proxy implements com.android.internal.appwidget.IAppWidgetService {
