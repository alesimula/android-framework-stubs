...
public interface ILockSettings extends android.os.IInterface {
    ...
    public android.os.ParcelDuration getLockoutEndTime(int p0) throws android.os.RemoteException;
    ...
    public boolean isUseOneLockSettingEnabled(int p0) throws android.os.RemoteException;
    ...
    public void prepareToVerifyCredential(int p0) throws android.os.RemoteException;
    ...
    public boolean writeRepairModeCredential(int p0) throws android.os.RemoteException;
    ...
    public static class Default implements com.android.internal.widget.ILockSettings {
        ...
        public android.os.ParcelDuration getLockoutEndTime(int p0) throws android.os.RemoteException { return null; }
        ...
        public void initRecoveryServiceWithSigFile(java.lang.String p0, byte[] p1, byte[] p2) throws android.os.RemoteException {}
        public boolean isUseOneLockSettingEnabled(int p0) throws android.os.RemoteException { return false; }
        ...
        public boolean writeRepairModeCredential(int p0) throws android.os.RemoteException { return false; }
    }
    ...
    public static abstract class Stub extends android.os.Binder implements com.android.internal.widget.ILockSettings {
        ...
        static final int TRANSACTION_addWeakEscrowToken = 55;
        static final int TRANSACTION_checkCredential = 10;
        static final int TRANSACTION_closeSession = 47;
        static final int TRANSACTION_generateKey = 33;
        static final int TRANSACTION_generateKeyWithMetadata = 34;
        static final int TRANSACTION_getBoolean = 4;
        static final int TRANSACTION_getCredentialType = 15;
        static final int TRANSACTION_getHashFactor = 18;
        static final int TRANSACTION_getKey = 37;
        static final int TRANSACTION_getKeyChainSnapshot = 32;
        static final int TRANSACTION_getLockoutEndTime = 30;
        static final int TRANSACTION_getLong = 5;
        static final int TRANSACTION_getPinLength = 16;
        static final int TRANSACTION_getRecoverySecretTypes = 44;
        static final int TRANSACTION_getRecoveryStatus = 42;
        static final int TRANSACTION_getString = 6;
        static final int TRANSACTION_getStrongAuthForUser = 28;
        static final int TRANSACTION_hasPendingEscrowToken = 29;
        static final int TRANSACTION_hasSecureLockScreen = 50;
        static final int TRANSACTION_importKey = 35;
        static final int TRANSACTION_importKeyWithMetadata = 36;
        static final int TRANSACTION_initRecoveryServiceWithSigFile = 31;
        static final int TRANSACTION_isUseOneLockSettingEnabled = 20;
        static final int TRANSACTION_isWeakEscrowTokenActive = 57;
        static final int TRANSACTION_isWeakEscrowTokenValid = 58;
        static final int TRANSACTION_prepareToVerifyCredential = 9;
        static final int TRANSACTION_recoverKeyChainSnapshot = 46;
        static final int TRANSACTION_refreshStoredPinLength = 17;
        static final int TRANSACTION_registerStrongAuthTracker = 21;
        static final int TRANSACTION_registerWeakEscrowTokenRemovedListener = 53;
        static final int TRANSACTION_removeCachedUnifiedChallenge = 52;
        static final int TRANSACTION_removeGatekeeperPasswordHandle = 14;
        static final int TRANSACTION_removeKey = 38;
        static final int TRANSACTION_removeWeakEscrowToken = 56;
        static final int TRANSACTION_reportSuccessfulBiometricUnlock = 24;
        static final int TRANSACTION_requireStrongAuth = 23;
        static final int TRANSACTION_resetKeyStore = 8;
        static final int TRANSACTION_scheduleNonStrongBiometricIdleTimeout = 25;
        ...
        static final int TRANSACTION_setRecoverySecretTypes = 43;
        static final int TRANSACTION_setRecoveryStatus = 41;
        static final int TRANSACTION_setSeparateProfileChallengeEnabled = 19;
        static final int TRANSACTION_setServerParams = 40;
        static final int TRANSACTION_setSnapshotCreatedPendingIntent = 39;
        static final int TRANSACTION_setString = 3;
        static final int TRANSACTION_startRecoverySessionWithCertPath = 45;
        static final int TRANSACTION_startRemoteLockscreenValidation = 48;
        static final int TRANSACTION_systemReady = 26;
        static final int TRANSACTION_tryUnlockWithCachedUnifiedChallenge = 51;
        static final int TRANSACTION_unlockUserKeyIfUnsecured = 59;
        static final int TRANSACTION_unregisterStrongAuthTracker = 22;
        static final int TRANSACTION_unregisterWeakEscrowTokenRemovedListener = 54;
        static final int TRANSACTION_userPresent = 27;
        static final int TRANSACTION_validateRemoteLockscreen = 49;
        static final int TRANSACTION_verifyCredential = 11;
        static final int TRANSACTION_verifyGatekeeperPasswordHandle = 13;
        static final int TRANSACTION_verifyTiedProfileChallenge = 12;
        static final int TRANSACTION_writeRepairModeCredential = 60;
        public Stub() { super(); }
        ...
        private static final class Proxy implements com.android.internal.widget.ILockSettings {
