...
public class MessagingPropertyAnimator implements android.view.View.OnLayoutChangeListener {
    ...
    public static final android.view.animation.Interpolator ALPHA_IN = null;
    public static final android.view.animation.Interpolator ALPHA_OUT = null;
    private static final int TAG_TOP_ANIMATOR = 16909522;
    private static final int TAG_TOP = 16909523;
    private static final int TAG_LAYOUT_TOP = 16909519;
    private static final int TAG_FIRST_LAYOUT = 16909517;
    private static final int TAG_ALPHA_ANIMATOR = 16909516;
