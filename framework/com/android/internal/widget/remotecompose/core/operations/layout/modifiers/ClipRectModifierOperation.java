...
public class ClipRectModifierOperation extends com.android.internal.widget.remotecompose.core.operations.layout.modifiers.DecoratorModifierOperation {
    public static final java.lang.String CLASS_NAME = "ClipRectModifierOperation";
    private static final int OP_CODE = 108;
    float mHeight;
    float mWidth;
    public ClipRectModifierOperation() { super(); }
