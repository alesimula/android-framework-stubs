...
public class PaintBundle implements com.android.internal.widget.remotecompose.core.serialize.Serializable {
    ...
    private int mLastShaderSet;
    int[] mOutArray;
    int mPos;
    public PaintBundle() {}
    private static java.lang.String asFloatStr(int p0) { return null; }
    public static java.lang.String blendModeString(int p0) { return null; }
    private static java.lang.String colorInt(int p0) { return null; }
    private static java.lang.String colorInt(int[] p0) { return null; }
    private int fixColor(int p0, com.android.internal.widget.remotecompose.core.RemoteContext p1) { return 0; }
    ...
    public void setTextAxis(int[] p0, float[] p1) {}
    public void setTextSize(float p0) {}
    public void setTextStyle(int p0, int p1, boolean p2) {}
    public void setTextStyle(int p0, int p1, boolean p2, boolean p3) {}
