...
public class PathExpression extends com.android.internal.widget.remotecompose.core.Operation implements com.android.internal.widget.remotecompose.core.VariableSupport, com.android.internal.widget.remotecompose.core.serialize.Serializable, com.android.internal.widget.remotecompose.core.VariableProvider, com.android.internal.widget.remotecompose.core.operations.ComponentData {
    private static final java.lang.String CLASS_NAME = "PathExpression";
    public static final int CLOSE = 15;
    public static final float CLOSE_NAN = Float.NaN;
    public static final int CONIC = 13;
    public static final float CONIC_NAN = Float.NaN;
    public static final int CUBIC = 14;
    public static final float CUBIC_NAN = Float.NaN;
    public static final int DONE = 16;
    public static final float DONE_NAN = Float.NaN;
    public static final int LINE = 11;
    public static final int LINEAR = 4;
    public static final float LINE_NAN = Float.NaN;
    public static final int LOOP = 1;
    private static final int MASK = -8388608;
    public static final int MONOTONIC = 2;
    public static final int MOVE = 10;
    public static final float MOVE_NAN = Float.NaN;
    private static final int OP_CODE = 193;
    public static final int POLAR = 8;
    public static final int QUADRATIC = 12;
    public static final float QUADRATIC_NAN = Float.NaN;
