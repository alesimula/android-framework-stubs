...
public class DrawTextRun extends com.android.internal.widget.remotecompose.core.PaintOperation {
    public static final com.android.internal.widget.remotecompose.core.operations.DrawTextRun.Companion COMPANION = null;
    int mTextID;
    int mStart;
    int mEnd;
    int mContextStart;
    ...
    float mY;
    boolean mRtl;
    public DrawTextRun(int p0, int p1, int p2, int p3, int p4, float p5, float p6, boolean p7) { super(); }
