...
public class CollapsibleRowLayout extends com.android.internal.widget.remotecompose.core.operations.layout.managers.RowLayout {
    public CollapsibleRowLayout(com.android.internal.widget.remotecompose.core.operations.layout.Component p0, int p1, int p2, float p3, float p4, float p5, float p6, int p7, int p8, float p9) { super((com.android.internal.widget.remotecompose.core.operations.layout.Component)null, 0, 0, 0, 0, 0.0f); }
    public CollapsibleRowLayout(com.android.internal.widget.remotecompose.core.operations.layout.Component p0, int p1, int p2, int p3, int p4, float p5) { super((com.android.internal.widget.remotecompose.core.operations.layout.Component)null, 0, 0, 0, 0, 0.0f); }
    ...
    private void computeVisibleChildren(com.android.internal.widget.remotecompose.core.PaintContext p0, float p1, float p2, boolean p3, com.android.internal.widget.remotecompose.core.operations.layout.measure.MeasurePass p4, com.android.internal.widget.remotecompose.core.operations.layout.measure.Size p5) {}
    ...
    public boolean hasHorizontalIntrinsicDimension() { return false; }
