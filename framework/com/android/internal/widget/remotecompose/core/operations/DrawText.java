...
public class DrawText extends com.android.internal.widget.remotecompose.core.PaintOperation implements com.android.internal.widget.remotecompose.core.VariableSupport, com.android.internal.widget.remotecompose.core.operations.ComponentData {
    private static final java.lang.String CLASS_NAME = "DrawText";
    private static final int OP_CODE = 43;
    public int mContextEnd;
    public int mContextStart;
    public int mEnd;
    public float mOutX;
    public float mOutY;
    public boolean mRtl;
