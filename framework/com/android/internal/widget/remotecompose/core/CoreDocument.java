...
public class CoreDocument implements com.android.internal.widget.remotecompose.core.serialize.Serializable {
    ...
    private static final int DEFAULT_FEATURE_MEASURE_VERSION = 4;
    private static final int DEFAULT_FEATURE_OPTIMIZATION_LEVEL = 15;
    ...
    public static final int DOCUMENT_API_LEVEL = 10;
    ...
    private int mClickReentrancyDepth;
    ...
    public final com.android.internal.widget.remotecompose.core.operations.loom.LoomManager mLoomManager = null;
    int mMeasureVersion;
    ...
    float mOriginX;
    float mOriginY;
    public com.android.internal.widget.remotecompose.core.operations.loom.PatternCallback mPatternCallback;
    public int mProfileMask;
    public final java.util.HashMap<java.lang.Integer, com.android.internal.widget.remotecompose.core.operations.ReferencedOperations> mReferencedOperations = null;
    ...
    private com.android.internal.widget.remotecompose.core.operations.utilities.IntMap<byte[]> mSoundDataPreloadCache;
    private com.android.internal.widget.remotecompose.core.CoreDocument.SoundEngine mSoundEngine;
    public final java.util.HashMap<java.lang.Integer, java.lang.String> mTextData = null;
    ...
    private void collectCollections(java.util.ArrayList<com.android.internal.widget.remotecompose.core.Operation> p0, com.android.internal.widget.remotecompose.core.RemoteComposeState p1) {}
    private void collectExpressionsRecursive(java.util.ArrayList<com.android.internal.widget.remotecompose.core.Operation> p0) {}
    private void computeTranslate(float p0, float p1, float p2, float p3, float[] p4) {}
    private java.util.ArrayList<com.android.internal.widget.remotecompose.core.Operation> expandMacros(java.util.ArrayList<com.android.internal.widget.remotecompose.core.Operation> p0) { return null; }
    private boolean finishInflation(java.util.ArrayList<com.android.internal.widget.remotecompose.core.Operation> p0, com.android.internal.widget.remotecompose.core.operations.layout.Component p1, com.android.internal.widget.remotecompose.core.operations.layout.LayoutComponent p2) { return false; }
    ...
    private java.util.ArrayList<com.android.internal.widget.remotecompose.core.Operation> nestContainers(java.util.ArrayList<com.android.internal.widget.remotecompose.core.Operation> p0, boolean p1) { return null; }
    public static java.util.ArrayList<com.android.internal.widget.remotecompose.core.Operation> nestContainers(java.util.ArrayList<com.android.internal.widget.remotecompose.core.Operation> p0, boolean p1, com.android.internal.widget.remotecompose.core.CoreDocument p2) { return null; }
    ...
    public int assignLayoutIndex(com.android.internal.widget.remotecompose.core.operations.layout.Component p0) { return 0; }
    public int assignLayoutIndices(com.android.internal.widget.remotecompose.core.operations.layout.Component p0, int p1) { return 0; }
    public long bitmapMemory() { return 0L; }
    ...
    java.util.HashMap<java.lang.Long, com.android.internal.widget.remotecompose.core.operations.IntegerExpression> getIntegerExpressions() { return null; }
    ...
    public int getOptimizationLevel() { return 0; }
    public float getOriginX() { return 0.0f; }
    public float getOriginY() { return 0.0f; }
    public int getProfileMask() { return 0; }
    public java.lang.Object getProperty(short p0) { return null; }
    public com.android.internal.widget.remotecompose.core.Operation getReferencedOperationsObject(int p0) { return null; }
    ...
    public boolean isConstraintsCacheEnabled() { return false; }
    public boolean isFlatMeasurePassEnabled() { return false; }
    public boolean isMeasureCacheEnabled() { return false; }
    public boolean isRelayoutBoundaryEnabled() { return false; }
    ...
    public void onComponentId(int p0) {}
    ...
    public void onMacroFound(java.lang.String p0, com.android.internal.widget.remotecompose.core.RemoteComposeBuffer p1) {}
    public void onReferencedOperations(com.android.internal.widget.remotecompose.core.operations.ReferencedOperations p0) {}
    ...
    public static interface SoundEngine {
        public void loadSound(int p0, byte[] p1);
        public void playSound(int p0);
    }
