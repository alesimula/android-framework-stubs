...
public final class FloatingToolbar {
    ...
    private java.util.List<android.view.MenuItem> mShowingMenuItems;
    ...
    private void doShow() {}
    private boolean isCurrentlyShowing(java.util.List<android.view.MenuItem> p0) { return false; }
    private java.util.List<android.view.MenuItem> getVisibleAndEnabledMenuItems(android.view.Menu p0) { return null; }
