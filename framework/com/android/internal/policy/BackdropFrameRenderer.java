...
public class BackdropFrameRenderer extends java.lang.Thread implements android.view.Choreographer.FrameCallback {
    ...
    private final android.graphics.Rect mOldSystemInsets = null;
    private final android.graphics.Rect mOldStableInsets = null;
    private final android.graphics.Rect mSystemInsets = null;
    private final android.graphics.Rect mStableInsets = null;
    private final android.graphics.Rect mTmpRect = null;
    public BackdropFrameRenderer(com.android.internal.policy.DecorView p0, android.view.ThreadedRenderer p1, android.graphics.Rect p2, android.graphics.drawable.Drawable p3, android.graphics.drawable.Drawable p4, android.graphics.drawable.Drawable p5, int p6, int p7, boolean p8, android.graphics.Rect p9, android.graphics.Rect p10) { super(); }
    ...
    public void setTargetRect(android.graphics.Rect p0, boolean p1, android.graphics.Rect p2, android.graphics.Rect p3) {}
    ...
    private void redrawLocked(android.graphics.Rect p0, boolean p1, android.graphics.Rect p2, android.graphics.Rect p3) {}
    private void drawColorViews(int p0, int p1, int p2, int p3, boolean p4, android.graphics.Rect p5, android.graphics.Rect p6) {}
