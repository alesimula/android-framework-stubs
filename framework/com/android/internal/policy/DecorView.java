...
public class DecorView extends android.widget.FrameLayout implements com.android.internal.view.RootViewSurfaceTaker, android.view.WindowCallbacks {
    ...
    public static int getColorViewTopInset(int p0, int p1) { return 0; }
    public static int getColorViewBottomInset(int p0, int p1) { return 0; }
    public static int getColorViewRightInset(int p0, int p1) { return 0; }
    public static int getColorViewLeftInset(int p0, int p1) { return 0; }
    ...
    public static void getNavigationBarRect(int p0, int p1, android.graphics.Rect p2, android.graphics.Rect p3, android.graphics.Rect p4, float p5) {}
    ...
    private int calculateStatusBarColor() { return 0; }
    private int calculateNavigationBarColor() { return 0; }
    ...
    private void updateColorViewInt(com.android.internal.policy.DecorView.ColorViewState p0, int p1, int p2, int p3, int p4, boolean p5, boolean p6, int p7, boolean p8, boolean p9) {}
    ...
    private void setDecorCaptionShade(android.content.Context p0, com.android.internal.widget.DecorCaptionView p1) {}
    ...
    public static class ColorViewAttributes {
        ...
        final int hideWindowFlag = 0;
        private ColorViewAttributes(int p0, int p1, int p2, int p3, int p4, java.lang.String p5, int p6, int p7) {}
        public boolean isPresent(int p0, int p1, boolean p2) { return false; }
