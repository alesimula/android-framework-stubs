...
public class DecorView extends android.widget.FrameLayout implements com.android.internal.view.RootViewSurfaceTaker, android.view.WindowCallbacks {
    ...
    private void updateColorViewInt(com.android.internal.policy.DecorView.ColorViewState p0, int p1, int p2, int p3, int p4, boolean p5, boolean p6, int p7, boolean p8, boolean p9, android.view.WindowInsetsController p10) {}
    ...
    public static class ColorViewAttributes {
        ...
        private ColorViewAttributes(int p0, int p1, int p2, int p3, int p4, java.lang.String p5, int p6, int p7, int p8) {}
