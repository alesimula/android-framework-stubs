...
public class ComponentParseUtils {
    ...
    public static int getIcon(com.android.internal.pm.pkg.component.ParsedComponent p0) { return 0; }
    public static java.lang.CharSequence getNonLocalizedLabel(com.android.internal.pm.pkg.component.ParsedComponent p0) { return null; }
    public static boolean isImplicitlyExposedIntent(com.android.internal.pm.pkg.component.ParsedIntentInfo p0) { return false; }
    ...
    private static android.content.pm.parsing.result.ParseResult<com.android.internal.pm.pkg.component.ParsedValidGeneralPurpose> parseValidGeneralPurpose(android.content.res.Resources p0, android.content.res.XmlResourceParser p1, android.content.pm.parsing.result.ParseInput p2) { return null; }
    private static android.content.pm.parsing.result.ParseResult<com.android.internal.pm.pkg.component.ParsedValidPurpose> parseValidPurpose(android.content.res.Resources p0, android.content.res.XmlResourceParser p1, android.content.pm.parsing.result.ParseInput p2) { return null; }
}
