...
public interface FeatureFlags {
    ...
    public boolean enablePccFrameworkSupport();
    public boolean encryptedClientHelloModes();
    public boolean hpkePublicApi();
    public boolean hpkeVApis();
    public boolean nativeMetrics();
    public boolean networkSecurityPolicyEchApi();
    public boolean networkSecurityPolicyReasonCtEnabledApi();
    public boolean nicenessApis();
    ...
    public boolean virtualThreadApiV1();
}
