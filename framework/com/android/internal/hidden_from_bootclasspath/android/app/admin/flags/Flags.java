...
public final class Flags {
    ...
    public static final java.lang.String FLAG_APP_FUNCTIONS_IN_ENGINE_V2 = "android.app.admin.flags.app_functions_in_engine_v2";
    public static final java.lang.String FLAG_APP_RESTRICTIONS_COEXISTENCE = "android.app.admin.flags.app_restrictions_coexistence";
    ...
    public static final java.lang.String FLAG_AUDIT_LOGGING_IN_ENGINE_V2 = "android.app.admin.flags.audit_logging_in_engine_v2";
    ...
    public static final java.lang.String FLAG_CHECK_PERSONAL_SUSPENSION_FOR_ALL_PROFILES = "android.app.admin.flags.check_personal_suspension_for_all_profiles";
    public static final java.lang.String FLAG_COEXISTENCE_MIGRATION_FOR_SUPERVISION_ENABLED = "android.app.admin.flags.coexistence_migration_for_supervision_enabled";
    public static final java.lang.String FLAG_COMMON_CRITERIA_MODE_COEXISTENCE = "android.app.admin.flags.common_criteria_mode_coexistence";
    public static final java.lang.String FLAG_COMMON_CRITERIA_MODE_IN_ENGINE_V2 = "android.app.admin.flags.common_criteria_mode_in_engine_v2";
    public static final java.lang.String FLAG_CONTENT_PROTECTION_IN_ENGINE_V2 = "android.app.admin.flags.content_protection_in_engine_v2";
    public static final java.lang.String FLAG_CROSS_PROFILE_WIDGET_PROVIDER_BULK_APIS = "android.app.admin.flags.cross_profile_widget_provider_bulk_apis";
    public static final java.lang.String FLAG_CROSS_PROFILE_WIDGET_PROVIDER_IN_ENGINE_V2 = "android.app.admin.flags.cross_profile_widget_provider_in_engine_v2";
    public static final java.lang.String FLAG_CROSS_USER_SUSPENSION_ENABLED_RO = "android.app.admin.flags.cross_user_suspension_enabled_ro";
    ...
    public static final java.lang.String FLAG_HEADLESS_SINGLE_MIN_TARGET_SDK = "android.app.admin.flags.headless_single_min_target_sdk";
    public static final java.lang.String FLAG_INCREASE_WATCH_STRONG_AUTH_TIMEOUT = "android.app.admin.flags.increase_watch_strong_auth_timeout";
    public static final java.lang.String FLAG_INTRODUCE_GENERIC_PROVISIONING_ERROR = "android.app.admin.flags.introduce_generic_provisioning_error";
    public static final java.lang.String FLAG_IS_MTE_POLICY_ENFORCED = "android.app.admin.flags.is_mte_policy_enforced";
    public static final java.lang.String FLAG_IS_RECURSIVE_REQUIRED_APP_MERGING_ENABLED = "android.app.admin.flags.is_recursive_required_app_merging_enabled";
    public static final java.lang.String FLAG_KEYCHAIN_SUPPRESS_CERTIFICATE_SELECTIONS = "android.app.admin.flags.keychain_suppress_certificate_selections";
    public static final java.lang.String FLAG_KEYGUARD_DISABLED_FEATURES_IN_ENGINE_V2 = "android.app.admin.flags.keyguard_disabled_features_in_engine_v2";
    public static final java.lang.String FLAG_LOCKSCREEN_INFO_COEXISTENCE = "android.app.admin.flags.lockscreen_info_coexistence";
    public static final java.lang.String FLAG_LOCK_NOW_COEXISTENCE = "android.app.admin.flags.lock_now_coexistence";
    public static final java.lang.String FLAG_LOCK_TASK_IN_ENGINE_V2 = "android.app.admin.flags.lock_task_in_engine_v2";
    public static final java.lang.String FLAG_MANAGED_DEVICE_DEFINITION_EXTENDED = "android.app.admin.flags.managed_device_definition_extended";
    public static final java.lang.String FLAG_MANAGED_ESIM_OUTGOING_TRANSFER_POLICY = "android.app.admin.flags.managed_esim_outgoing_transfer_policy";
    public static final java.lang.String FLAG_MANAGEMENT_MODE_POLICY_METRICS = "android.app.admin.flags.management_mode_policy_metrics";
    public static final java.lang.String FLAG_MEMORY_TAGGING_IN_ENGINE_V2 = "android.app.admin.flags.memory_tagging_in_engine_v2";
    ...
    public static final java.lang.String FLAG_PERMITTED_INPUT_METHODS_IN_ENGINE_V2 = "android.app.admin.flags.permitted_input_methods_in_engine_v2";
    public static final java.lang.String FLAG_PERSISTENT_PREFERRED_ACTIVITY_IN_ENGINE_V2 = "android.app.admin.flags.persistent_preferred_activity_in_engine_v2";
    public static final java.lang.String FLAG_PERSONAL_APPS_SUSPENDED_IN_ENGINE_V2 = "android.app.admin.flags.personal_apps_suspended_in_engine_v2";
    public static final java.lang.String FLAG_PHYSICAL_SIM_POLICY = "android.app.admin.flags.physical_sim_policy";
    ...
    public static final java.lang.String FLAG_POLICY_ENGINE_V2 = "android.app.admin.flags.policy_engine_v2";
    public static final java.lang.String FLAG_POLICY_STREAMLINING = "android.app.admin.flags.policy_streamlining";
    public static final java.lang.String FLAG_POLICY_STREAMLINING_APP_INSTALL = "android.app.admin.flags.policy_streamlining_app_install";
    public static final java.lang.String FLAG_POLICY_STREAMLINING_APP_UNINSTALL = "android.app.admin.flags.policy_streamlining_app_uninstall";
    public static final java.lang.String FLAG_POLICY_STREAMLINING_ASSIST_CONTENT = "android.app.admin.flags.policy_streamlining_assist_content";
    public static final java.lang.String FLAG_POLICY_STREAMLINING_AUTO_TIME = "android.app.admin.flags.policy_streamlining_auto_time";
    ...
    public static final java.lang.String FLAG_PUSH_DPC_PACKAGES_TO_SYSTEM_SERVICES = "android.app.admin.flags.push_dpc_packages_to_system_services";
    ...
    public static final java.lang.String FLAG_REMOVE_HACK_IN_POLICY_ENGINE = "android.app.admin.flags.remove_hack_in_policy_engine";
    public static final java.lang.String FLAG_REMOVE_MANAGED_ESIM_ON_WORK_PROFILE_DELETION = "android.app.admin.flags.remove_managed_esim_on_work_profile_deletion";
    public static final java.lang.String FLAG_REMOVE_MANAGED_PROFILE_ENABLED = "android.app.admin.flags.remove_managed_profile_enabled";
    public static final java.lang.String FLAG_RESET_PASSWORD_TOKEN_IN_ENGINE_V2 = "android.app.admin.flags.reset_password_token_in_engine_v2";
    public static final java.lang.String FLAG_RESET_PASSWORD_WITH_TOKEN_COEXISTENCE = "android.app.admin.flags.reset_password_with_token_coexistence";
    public static final java.lang.String FLAG_SCREEN_CAPTURE_DISABLED_IN_ENGINE_V2 = "android.app.admin.flags.screen_capture_disabled_in_engine_v2";
    public static final java.lang.String FLAG_SECONDARY_LOCKSCREEN_API_ENABLED = "android.app.admin.flags.secondary_lockscreen_api_enabled";
    public static final java.lang.String FLAG_SECURE_ADB_ROLE_BYPASSING = "android.app.admin.flags.secure_adb_role_bypassing";
    public static final java.lang.String FLAG_SECURITY_LOGGING_IN_ENGINE_V2 = "android.app.admin.flags.security_logging_in_engine_v2";
    public static final java.lang.String FLAG_SECURITY_LOG_V2_ENABLED = "android.app.admin.flags.security_log_v2_enabled";
    public static final java.lang.String FLAG_SET_APPLICATION_RESTRICTIONS_COEXISTENCE = "android.app.admin.flags.set_application_restrictions_coexistence";
    public static final java.lang.String FLAG_SET_AUTO_TIME_ENABLED_COEXISTENCE = "android.app.admin.flags.set_auto_time_enabled_coexistence";
    public static final java.lang.String FLAG_SET_AUTO_TIME_ZONE_ENABLED_COEXISTENCE = "android.app.admin.flags.set_auto_time_zone_enabled_coexistence";
    public static final java.lang.String FLAG_SET_BACKUP_SERVICE_ENABLED_COEXISTENCE = "android.app.admin.flags.set_backup_service_enabled_coexistence";
    public static final java.lang.String FLAG_SET_KEYGUARD_DISABLED_FEATURES_COEXISTENCE = "android.app.admin.flags.set_keyguard_disabled_features_coexistence";
    ...
    public static boolean applicationRestrictionsInEngineV2() { return false; }
    public static boolean assistContentUserRestrictionEnabled() { return false; }
    public static boolean auditLoggingInEngineV2() { return false; }
    public static boolean backupServiceSecurityLogEventEnabled() { return false; }
    public static boolean checkPersonalSuspensionForAllProfiles() { return false; }
    public static boolean coexistenceMigrationForSupervisionEnabled() { return false; }
    public static boolean commonCriteriaModeCoexistence() { return false; }
    public static boolean commonCriteriaModeInEngineV2() { return false; }
    public static boolean contentProtectionInEngineV2() { return false; }
    public static boolean crossProfileWidgetProviderBulkApis() { return false; }
    public static boolean crossProfileWidgetProviderInEngineV2() { return false; }
    public static boolean crossUserSuspensionEnabledRo() { return false; }
    public static boolean dedicatedDeviceControlApiEnabled() { return false; }
    public static boolean defaultSmsPersonalAppSuspensionFixEnabled() { return false; }
    public static boolean devicePolicySizeTrackingEnabled() { return false; }
    public static boolean deviceTheftApiEnabled() { return false; }
    ...
    public static boolean headlessDeviceOwnerSingleUserEnabled() { return false; }
    public static boolean headlessSingleMinTargetSdk() { return false; }
    public static boolean increaseWatchStrongAuthTimeout() { return false; }
    public static boolean introduceGenericProvisioningError() { return false; }
    public static boolean isMtePolicyEnforced() { return false; }
    public static boolean isRecursiveRequiredAppMergingEnabled() { return false; }
    public static boolean keychainSuppressCertificateSelections() { return false; }
    public static boolean keyguardDisabledFeaturesInEngineV2() { return false; }
    public static boolean lockNowCoexistence() { return false; }
    public static boolean lockTaskInEngineV2() { return false; }
    public static boolean lockscreenInfoCoexistence() { return false; }
    public static boolean managedDeviceDefinitionExtended() { return false; }
    public static boolean managedEsimOutgoingTransferPolicy() { return false; }
    public static boolean managementModePolicyMetrics() { return false; }
    public static boolean memoryTaggingInEngineV2() { return false; }
    ...
    public static boolean permissionGrantInEngineV2() { return false; }
    public static boolean permissionMigrationForZeroTrustApiEnabled() { return false; }
    public static boolean permittedInputMethodsInEngineV2() { return false; }
    public static boolean persistentPreferredActivityInEngineV2() { return false; }
    public static boolean personalAppsSuspendedInEngineV2() { return false; }
    public static boolean physicalSimPolicy() { return false; }
    public static boolean policyEngineMigrationV2Enabled() { return false; }
    public static boolean policyEngineV2() { return false; }
    public static boolean policyStreamlining() { return false; }
    public static boolean policyStreamliningAppInstall() { return false; }
    public static boolean policyStreamliningAppUninstall() { return false; }
    public static boolean policyStreamliningAssistContent() { return false; }
    public static boolean policyStreamliningAutoTime() { return false; }
    ...
    public static boolean pushDpcPackagesToSystemServices() { return false; }
    public static boolean quietModeCredentialBugFix() { return false; }
    public static boolean removeHackInPolicyEngine() { return false; }
    public static boolean removeManagedEsimOnWorkProfileDeletion() { return false; }
    public static boolean removeManagedProfileEnabled() { return false; }
    public static boolean resetPasswordTokenInEngineV2() { return false; }
    public static boolean resetPasswordWithTokenCoexistence() { return false; }
    public static boolean screenCaptureDisabledInEngineV2() { return false; }
    public static boolean secondaryLockscreenApiEnabled() { return false; }
    public static boolean secureAdbRoleBypassing() { return false; }
    public static boolean securityLogV2Enabled() { return false; }
    public static boolean securityLoggingInEngineV2() { return false; }
    public static boolean setApplicationRestrictionsCoexistence() { return false; }
    public static boolean setAutoTimeEnabledCoexistence() { return false; }
    public static boolean setAutoTimeZoneEnabledCoexistence() { return false; }
    public static boolean setBackupServiceEnabledCoexistence() { return false; }
    public static boolean setKeyguardDisabledFeaturesCoexistence() { return false; }
    ...
    public static boolean unmanagedModeMigration() { return false; }
