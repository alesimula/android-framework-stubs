...
public final class Flags {
    ...
    public Flags() {}
    public static boolean crossDeviceClipboard() { return false; }
    public static boolean dynamicPolicy() { return false; }
    public static boolean persistentDeviceIdApi() { return false; }
    public static boolean vdmCustomHome() { return false; }
    public static boolean vdmCustomIme() { return false; }
    public static boolean vdmPublicApis() { return false; }
    public static boolean virtualCamera() { return false; }
    public static boolean virtualStylus() { return false; }
}
