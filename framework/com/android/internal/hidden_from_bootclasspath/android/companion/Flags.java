...
public final class Flags {
    ...
    public static final java.lang.String FLAG_ASSOCIATION_VERIFICATION = "android.companion.association_verification";
    public static final java.lang.String FLAG_BAND_DEVICE_PROFILE = "android.companion.band_device_profile";
    public static final java.lang.String FLAG_CMD_OPTIONS = "android.companion.cmd_options";
    public static final java.lang.String FLAG_DEVICE_PRESENCE = "android.companion.device_presence";
    public static final java.lang.String FLAG_ENABLE_DATA_SYNC = "android.companion.enable_data_sync";
    ...
    public static final java.lang.String FLAG_TRUSTED_DEVICES = "android.companion.trusted_devices";
    public static final java.lang.String FLAG_TRUST_PAIRING = "android.companion.trust_pairing";
    public static final java.lang.String FLAG_UNIVERSAL_CLIPBOARD = "android.companion.universal_clipboard";
    public static final java.lang.String FLAG_UNIVERSAL_CLIPBOARD_FILE_TRANSFER = "android.companion.universal_clipboard_file_transfer";
    ...
    public static boolean associationVerification() { return false; }
    public static boolean bandDeviceProfile() { return false; }
    public static boolean cmdOptions() { return false; }
    public static boolean devicePresence() { return false; }
    public static boolean enableDataSync() { return false; }
    ...
    public static boolean trustPairing() { return false; }
    public static boolean trustedDevices() { return false; }
    public static boolean universalClipboard() { return false; }
    public static boolean universalClipboardFileTransfer() { return false; }
    public static boolean unpairAssociatedDevice() { return false; }
    public static boolean useTalismanAttestation() { return false; }
}
