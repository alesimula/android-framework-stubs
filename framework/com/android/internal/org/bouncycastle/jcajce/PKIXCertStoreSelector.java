...
public class PKIXCertStoreSelector<T extends java.security.cert.Certificate> implements com.android.internal.org.bouncycastle.util.Selector<T> {
    private final java.security.cert.CertSelector baseSelector = null;
    private PKIXCertStoreSelector(java.security.cert.CertSelector p0) {}
    ...
    private static class SelectorClone extends java.security.cert.X509CertSelector {
        private final com.android.internal.org.bouncycastle.jcajce.PKIXCertStoreSelector selector = null;
