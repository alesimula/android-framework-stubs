...
public abstract class BaseAgreementSpi extends javax.crypto.KeyAgreementSpi {
    ...
    private com.android.internal.org.bouncycastle.jcajce.spec.HybridValueParameterSpec hybridSpec;
    ...
    private byte[] calcSecret() { return null; }
    ...
    protected abstract void doInitFromKey(java.security.Key p0, java.security.spec.AlgorithmParameterSpec p1, java.security.SecureRandom p2) throws java.security.InvalidKeyException, java.security.InvalidAlgorithmParameterException;
