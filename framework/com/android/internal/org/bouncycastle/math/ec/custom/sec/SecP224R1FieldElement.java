...
public class SecP224R1FieldElement extends com.android.internal.org.bouncycastle.math.ec.ECFieldElement.AbstractFp {
    ...
    protected int[] x;
    public SecP224R1FieldElement() { super(); }
    public SecP224R1FieldElement(java.math.BigInteger p0) { super(); }
    protected SecP224R1FieldElement(int[] p0) { super(); }
    private static void RM(int[] p0, int[] p1, int[] p2, int[] p3, int[] p4, int[] p5, int[] p6) {}
    private static void RP(int[] p0, int[] p1, int[] p2, int[] p3, int[] p4) {}
    private static void RS(int[] p0, int[] p1, int[] p2, int[] p3) {}
    private static boolean isSquare(int[] p0) { return false; }
    private static boolean trySqrt(int[] p0, int[] p1, int[] p2) { return false; }
