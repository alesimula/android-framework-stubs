...
public final class RegisterStatusBarResult implements android.os.Parcelable {
    ...
    public final android.view.InsetsVisibilities mRequestedVisibilities = null;
    ...
    public RegisterStatusBarResult(android.util.ArrayMap<java.lang.String, com.android.internal.statusbar.StatusBarIcon> p0, int p1, int p2, com.android.internal.view.AppearanceRegion[] p3, int p4, int p5, boolean p6, int p7, android.os.IBinder p8, boolean p9, int p10, android.view.InsetsVisibilities p11, java.lang.String p12, int[] p13) {}
