...
public final class RegisterStatusBarResult implements android.os.Parcelable {
    ...
    public final boolean mShowImeSwitcherButton = false;
    public final int mTransientBarTypes = 0;
    public RegisterStatusBarResult(android.util.ArrayMap<java.lang.String, com.android.internal.statusbar.StatusBarIcon> p0, int p1, int p2, com.android.internal.view.AppearanceRegion[] p3, int p4, int p5, boolean p6, int p7, boolean p8, int p9, int p10, java.lang.String p11, int p12, com.android.internal.statusbar.LetterboxDetails[] p13) {}
