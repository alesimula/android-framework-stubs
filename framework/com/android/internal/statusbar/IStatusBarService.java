...
public interface IStatusBarService extends android.os.IInterface {
    ...
    public boolean canSetAgentTask(java.lang.String p0, int p1) throws android.os.RemoteException;
    ...
    public boolean doesAgentTaskSupportLaunching() throws android.os.RemoteException;
    ...
    public void getAgentStateScreenLocation(java.lang.String p0, int p1, int p2, com.android.internal.infra.AndroidFuture p3) throws android.os.RemoteException;
    public int[] getDisableFlags(android.os.IBinder p0, int p1) throws android.os.RemoteException;
    public int getIcon(java.lang.String p0) throws android.os.RemoteException;
    ...
    public boolean isAgentTaskFeatureSupported() throws android.os.RemoteException;
    ...
    public void onNotificationClear(java.lang.String p0, int p1, java.lang.String p2, int p3, int p4, com.android.internal.statusbar.NotificationVisibility p5, boolean p6) throws android.os.RemoteException;
    ...
    public void onNotificationSmartSuggestionsAdded(java.lang.String p0, int p1, int p2, int p3, int p4, boolean p5, boolean p6) throws android.os.RemoteException;
    ...
    public java.util.Map<java.lang.String, com.android.internal.statusbar.RegisterStatusBarResult> registerStatusBarForAllDisplays(com.android.internal.statusbar.IStatusBar p0) throws android.os.RemoteException;
    ...
    public void setAgentTask(java.lang.String p0, android.agenticon.AgentTaskUpdate p1, com.android.internal.statusbar.IAgentTaskCallback p2, int p3) throws android.os.RemoteException;
    ...
    public void showGlobalActionsFromApp(com.android.internal.infra.AndroidFuture p0) throws android.os.RemoteException;
    ...
    public void startMotionCuesSession(android.content.ComponentName p0, android.app.motioncues.MotionCuesSettings p1) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements com.android.internal.statusbar.IStatusBarService {
        ...
        static final java.lang.String[] PERMISSIONS_showGlobalActionsFromApp = null;
        static final int TRANSACTION_addTile = 43;
        static final int TRANSACTION_canSetAgentTask = 75;
        static final int TRANSACTION_cancelRequestAddTile = 60;
        static final int TRANSACTION_clearInlineReplyUriPermissions = 35;
        static final int TRANSACTION_clearNotificationEffects = 19;
        static final int TRANSACTION_clickTile = 45;
        ...
        static final int TRANSACTION_doesAgentTaskSupportLaunching = 77;
        static final int TRANSACTION_endMotionCuesSession = 73;
        static final int TRANSACTION_expandNotificationsPanel = 1;
        static final int TRANSACTION_expandSettingsPanel = 14;
        static final int TRANSACTION_getAgentStateScreenLocation = 78;
        static final int TRANSACTION_getDisableFlags = 8;
        static final int TRANSACTION_getIcon = 11;
        static final int TRANSACTION_getLastSystemKey = 47;
        static final int TRANSACTION_getNavBarMode = 62;
        static final int TRANSACTION_grantInlineReplyUriPermission = 34;
        static final int TRANSACTION_handleSystemKey = 46;
        static final int TRANSACTION_hideCurrentInputMethodForBubbles = 33;
        static final int TRANSACTION_isAgentTaskFeatureSupported = 76;
        static final int TRANSACTION_isTracing = 56;
        static final int TRANSACTION_onBubbleMetadataFlagChanged = 32;
        static final int TRANSACTION_onClearAllNotifications = 23;
        static final int TRANSACTION_onGlobalActionsHidden = 38;
        static final int TRANSACTION_onGlobalActionsShown = 37;
        static final int TRANSACTION_onNotificationActionClick = 21;
        static final int TRANSACTION_onNotificationBubbleChanged = 31;
        static final int TRANSACTION_onNotificationClear = 24;
        static final int TRANSACTION_onNotificationClick = 20;
        static final int TRANSACTION_onNotificationDirectReplied = 27;
        static final int TRANSACTION_onNotificationError = 22;
        static final int TRANSACTION_onNotificationExpansionChanged = 26;
        static final int TRANSACTION_onNotificationFeedbackReceived = 36;
        static final int TRANSACTION_onNotificationSettingsViewed = 30;
        static final int TRANSACTION_onNotificationSmartReplySent = 29;
        static final int TRANSACTION_onNotificationSmartSuggestionsAdded = 28;
        static final int TRANSACTION_onNotificationVisibilityChanged = 25;
        static final int TRANSACTION_onPanelHidden = 18;
        static final int TRANSACTION_onPanelRevealed = 17;
        static final int TRANSACTION_onSessionEnded = 66;
        static final int TRANSACTION_onSessionStarted = 65;
        static final int TRANSACTION_reboot = 41;
        static final int TRANSACTION_registerNearbyMediaDevicesProvider = 69;
        static final int TRANSACTION_registerSessionListener = 63;
        static final int TRANSACTION_registerStatusBar = 15;
        static final int TRANSACTION_registerStatusBarForAllDisplays = 16;
        static final int TRANSACTION_remTile = 44;
        static final int TRANSACTION_removeIcon = 12;
        static final int TRANSACTION_requestAddTile = 59;
        static final int TRANSACTION_requestTileServiceListeningState = 58;
        static final int TRANSACTION_restart = 42;
        static final int TRANSACTION_setAgentTask = 74;
        static final int TRANSACTION_setBiometicContextListener = 50;
        ...
        static final int TRANSACTION_setNavBarMode = 61;
        static final int TRANSACTION_setUdfpsRefreshRateCallback = 51;
        static final int TRANSACTION_showGlobalActionsFromApp = 39;
        static final int TRANSACTION_showInattentiveSleepWarning = 52;
        static final int TRANSACTION_showPinningEnterExitToast = 48;
        static final int TRANSACTION_showPinningEscapeToast = 49;
        static final int TRANSACTION_showRearDisplayDialog = 71;
        static final int TRANSACTION_shutdown = 40;
        static final int TRANSACTION_startMotionCuesSession = 72;
        ...
        static final int TRANSACTION_unregisterNearbyMediaDevicesProvider = 70;
        static final int TRANSACTION_unregisterSessionListener = 64;
        static final int TRANSACTION_updateMediaTapToTransferReceiverDisplay = 68;
        static final int TRANSACTION_updateMediaTapToTransferSenderDisplay = 67;
        ...
        protected void showGlobalActionsFromApp_enforcePermission() throws java.lang.SecurityException {}

        private static final class Proxy implements com.android.internal.statusbar.IStatusBarService {
            private android.os.IBinder mRemote;
            Proxy(android.os.IBinder p0) {}
            public void addTile(android.content.ComponentName p0) throws android.os.RemoteException {}
            public android.os.IBinder asBinder() { return null; }
            public boolean canSetAgentTask(java.lang.String p0, int p1) throws android.os.RemoteException { return false; }
            public void cancelRequestAddTile(java.lang.String p0) throws android.os.RemoteException {}
            public void clearInlineReplyUriPermissions(java.lang.String p0) throws android.os.RemoteException {}
            public void clearNotificationEffects() throws android.os.RemoteException {}
            public void clickTile(android.content.ComponentName p0) throws android.os.RemoteException {}
            ...
            public void disableForUser(int p0, android.os.IBinder p1, java.lang.String p2, int p3) throws android.os.RemoteException {}
            public void dismissInattentiveSleepWarning(boolean p0) throws android.os.RemoteException {}
            public boolean doesAgentTaskSupportLaunching() throws android.os.RemoteException { return false; }
            public void endMotionCuesSession() throws android.os.RemoteException {}
            public void expandNotificationsPanel() throws android.os.RemoteException {}
            public void expandSettingsPanel(java.lang.String p0) throws android.os.RemoteException {}
            public void getAgentStateScreenLocation(java.lang.String p0, int p1, int p2, com.android.internal.infra.AndroidFuture p3) throws android.os.RemoteException {}
            public int[] getDisableFlags(android.os.IBinder p0, int p1) throws android.os.RemoteException { return null; }
            public int getIcon(java.lang.String p0) throws android.os.RemoteException { return 0; }
            ...
            public void handleSystemKey(android.view.KeyEvent p0) throws android.os.RemoteException {}
            public void hideCurrentInputMethodForBubbles(int p0) throws android.os.RemoteException {}
            public boolean isAgentTaskFeatureSupported() throws android.os.RemoteException { return false; }
            ...
            public java.util.Map<java.lang.String, com.android.internal.statusbar.RegisterStatusBarResult> registerStatusBarForAllDisplays(com.android.internal.statusbar.IStatusBar p0) throws android.os.RemoteException { return null; }
            public void remTile(android.content.ComponentName p0) throws android.os.RemoteException {}
            public void removeIcon(java.lang.String p0) throws android.os.RemoteException {}
            public void requestAddTile(android.content.ComponentName p0, java.lang.CharSequence p1, android.graphics.drawable.Icon p2, int p3, com.android.internal.statusbar.IAddTileResultCallback p4) throws android.os.RemoteException {}
            public void requestTileServiceListeningState(android.content.ComponentName p0, int p1) throws android.os.RemoteException {}
