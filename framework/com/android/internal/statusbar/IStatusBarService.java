...
public interface IStatusBarService extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements com.android.internal.statusbar.IStatusBarService {
        ...
        static final int TRANSACTION_canSetAgentTask = 80;
        ...
        static final int TRANSACTION_dismissInattentiveSleepWarning = 58;
        static final int TRANSACTION_endMotionCuesSession = 78;
        ...
        static final int TRANSACTION_getNavBarMode = 67;
        static final int TRANSACTION_grantInlineReplyUriPermission = 34;
        static final int TRANSACTION_handleSystemKey = 46;
        static final int TRANSACTION_hideAuthenticationDialog = 54;
        static final int TRANSACTION_hideCurrentInputMethodForBubbles = 33;
        static final int TRANSACTION_isAgentTaskFeatureSupported = 81;
        static final int TRANSACTION_isTracing = 61;
        static final int TRANSACTION_onBiometricAuthenticated = 51;
        static final int TRANSACTION_onBiometricError = 53;
        static final int TRANSACTION_onBiometricHelp = 52;
        ...
        static final int TRANSACTION_onSessionEnded = 71;
        static final int TRANSACTION_onSessionStarted = 70;
        static final int TRANSACTION_reboot = 41;
        static final int TRANSACTION_registerNearbyMediaDevicesProvider = 74;
        static final int TRANSACTION_registerSessionListener = 68;
        ...
        static final int TRANSACTION_setAgentTask = 79;
        static final int TRANSACTION_setBiometicContextListener = 55;
        ...
        static final int TRANSACTION_setNavBarMode = 66;
        static final int TRANSACTION_setUdfpsRefreshRateCallback = 56;
        static final int TRANSACTION_showAuthenticationDialog = 50;
        static final int TRANSACTION_showGlobalActionsFromApp = 39;
        static final int TRANSACTION_showInattentiveSleepWarning = 57;
        static final int TRANSACTION_showPinningEnterExitToast = 48;
        static final int TRANSACTION_showPinningEscapeToast = 49;
        static final int TRANSACTION_showRearDisplayDialog = 76;
        static final int TRANSACTION_shutdown = 40;
        static final int TRANSACTION_startMotionCuesSession = 77;
        static final int TRANSACTION_startTracing = 59;
        static final int TRANSACTION_stopTracing = 60;
        ...
        static final int TRANSACTION_unregisterSessionListener = 69;
