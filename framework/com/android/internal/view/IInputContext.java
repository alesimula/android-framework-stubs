...
public interface IInputContext extends android.os.IInterface {
    public void getTextBeforeCursor(int p0, int p1, int p2, com.android.internal.view.IInputContextCallback p3) throws android.os.RemoteException;
    public void getTextAfterCursor(int p0, int p1, int p2, com.android.internal.view.IInputContextCallback p3) throws android.os.RemoteException;
    public void getCursorCapsMode(int p0, int p1, com.android.internal.view.IInputContextCallback p2) throws android.os.RemoteException;
    public void getExtractedText(android.view.inputmethod.ExtractedTextRequest p0, int p1, int p2, com.android.internal.view.IInputContextCallback p3) throws android.os.RemoteException;
    ...
    public void getSelectedText(int p0, int p1, com.android.internal.view.IInputContextCallback p2) throws android.os.RemoteException;
    public void requestUpdateCursorAnchorInfo(int p0, int p1, com.android.internal.view.IInputContextCallback p2) throws android.os.RemoteException;
    public void commitContent(android.view.inputmethod.InputContentInfo p0, int p1, android.os.Bundle p2, int p3, com.android.internal.view.IInputContextCallback p4) throws android.os.RemoteException;
