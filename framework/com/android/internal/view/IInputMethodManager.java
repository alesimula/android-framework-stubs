...
public interface IInputMethodManager extends android.os.IInterface {
    ...
    public java.util.List<android.view.inputmethod.InputMethodInfo> getAwareLockedInputMethodList(int p0, int p1) throws android.os.RemoteException;
    ...
    public boolean showSoftInput(com.android.internal.view.IInputMethodClient p0, android.os.IBinder p1, int p2, android.os.ResultReceiver p3, int p4) throws android.os.RemoteException;
    public boolean hideSoftInput(com.android.internal.view.IInputMethodClient p0, android.os.IBinder p1, int p2, android.os.ResultReceiver p3, int p4) throws android.os.RemoteException;
    public com.android.internal.inputmethod.InputBindResult startInputOrWindowGainedFocus(int p0, com.android.internal.view.IInputMethodClient p1, android.os.IBinder p2, int p3, int p4, int p5, android.view.inputmethod.EditorInfo p6, com.android.internal.view.IInputContext p7, com.android.internal.inputmethod.IRemoteAccessibilityInputConnection p8, int p9, android.window.ImeOnBackInvokedDispatcher p10) throws android.os.RemoteException;
    ...
    public int getInputMethodWindowVisibleHeight(com.android.internal.view.IInputMethodClient p0) throws android.os.RemoteException;
    public void reportVirtualDisplayGeometryAsync(com.android.internal.view.IInputMethodClient p0, int p1, float[] p2) throws android.os.RemoteException;
    ...
    public void startStylusHandwriting(com.android.internal.view.IInputMethodClient p0) throws android.os.RemoteException;
    ...
    public static class Default implements com.android.internal.view.IInputMethodManager {
        ...
        public java.util.List<android.view.inputmethod.InputMethodInfo> getAwareLockedInputMethodList(int p0, int p1) throws android.os.RemoteException { return null; }
        ...
        public boolean showSoftInput(com.android.internal.view.IInputMethodClient p0, android.os.IBinder p1, int p2, android.os.ResultReceiver p3, int p4) throws android.os.RemoteException { return false; }
        public boolean hideSoftInput(com.android.internal.view.IInputMethodClient p0, android.os.IBinder p1, int p2, android.os.ResultReceiver p3, int p4) throws android.os.RemoteException { return false; }
        public com.android.internal.inputmethod.InputBindResult startInputOrWindowGainedFocus(int p0, com.android.internal.view.IInputMethodClient p1, android.os.IBinder p2, int p3, int p4, int p5, android.view.inputmethod.EditorInfo p6, com.android.internal.view.IInputContext p7, com.android.internal.inputmethod.IRemoteAccessibilityInputConnection p8, int p9, android.window.ImeOnBackInvokedDispatcher p10) throws android.os.RemoteException { return null; }
        public void showInputMethodPickerFromClient(com.android.internal.view.IInputMethodClient p0, int p1) throws android.os.RemoteException {}
        public void showInputMethodPickerFromSystem(com.android.internal.view.IInputMethodClient p0, int p1, int p2) throws android.os.RemoteException {}
        public void showInputMethodAndSubtypeEnablerFromClient(com.android.internal.view.IInputMethodClient p0, java.lang.String p1) throws android.os.RemoteException {}
        ...
        public void setAdditionalInputMethodSubtypes(java.lang.String p0, android.view.inputmethod.InputMethodSubtype[] p1) throws android.os.RemoteException {}
        public int getInputMethodWindowVisibleHeight(com.android.internal.view.IInputMethodClient p0) throws android.os.RemoteException { return 0; }
        public void reportVirtualDisplayGeometryAsync(com.android.internal.view.IInputMethodClient p0, int p1, float[] p2) throws android.os.RemoteException {}
        public void reportPerceptibleAsync(android.os.IBinder p0, boolean p1) throws android.os.RemoteException {}
        public void removeImeSurface() throws android.os.RemoteException {}
        public void removeImeSurfaceFromWindowAsync(android.os.IBinder p0) throws android.os.RemoteException {}
