...
public interface IInputMethodManager extends android.os.IInterface {
    ...
    public boolean showSoftInput(com.android.internal.view.IInputMethodClient p0, int p1, android.os.ResultReceiver p2) throws android.os.RemoteException;
    public boolean hideSoftInput(com.android.internal.view.IInputMethodClient p0, int p1, android.os.ResultReceiver p2) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements com.android.internal.view.IInputMethodManager {
        ...
        private static class Proxy implements com.android.internal.view.IInputMethodManager {
            ...
            public boolean showSoftInput(com.android.internal.view.IInputMethodClient p0, int p1, android.os.ResultReceiver p2) throws android.os.RemoteException { return false; }
            public boolean hideSoftInput(com.android.internal.view.IInputMethodClient p0, int p1, android.os.ResultReceiver p2) throws android.os.RemoteException { return false; }
