...
public class BrightnessSynchronizer {
    ...
    public BrightnessSynchronizer(android.content.Context p0, android.os.Looper p1, boolean p2) {}
    public BrightnessSynchronizer(android.content.Context p0, android.os.Looper p1, com.android.internal.display.BrightnessSynchronizer.Clock p2, boolean p3) {}
    ...
    public static float brightnessIntSettingToFloat(android.content.Context p0, int p1) { return 0.0f; }
    @android.annotation.RequiresPermission("android.permission.CONTROL_DISPLAY_BRIGHTNESS")
    public static int brightnessFloatToIntSetting(android.content.Context p0, float p1) { return 0; }
