...
public class InteractionJankMonitor {
    ...
    private com.android.internal.jank.InteractionJankMonitor.RunningTracker putTrackerIfNoCurrent(int p0, java.util.function.Supplier<com.android.internal.jank.InteractionJankMonitor.RunningTracker> p1) { return null; }
    private boolean removeTrackerIfCurrent(int p0, com.android.internal.jank.FrameTracker p1, int p2) { return false; }
    private boolean removeTrackerIfCurrent(com.android.internal.jank.InteractionJankMonitor.RunningTracker p0, int p1) { return false; }
    public boolean begin(android.view.SurfaceControl p0, android.content.Context p1, android.os.Handler p2, int p3) { return false; }
    public boolean begin(android.view.SurfaceControl p0, android.content.Context p1, android.os.Handler p2, int p3, java.lang.String p4) { return false; }
    public boolean begin(android.view.View p0, int p1) { return false; }
    public boolean begin(android.view.View p0, int p1, java.lang.String p2) { return false; }
    ...
    public static class Configuration {
        ...
        private final boolean mDeferMonitor = false;
        private final android.os.Handler mHandler = null;
        private final java.lang.String mSessionName = null;
        private final android.view.SurfaceControl mSurfaceControl = null;
        private final boolean mSurfaceOnly = false;
        private final java.lang.String mTag = null;
        private final long mTimeout = 0L;
        private final android.view.View mView = null;
        private Configuration(int p0, android.view.View p1, java.lang.String p2, long p3, boolean p4, android.content.Context p5, android.view.SurfaceControl p6, boolean p7, android.os.Handler p8) {}
        ...
        public static class Builder {
            private android.content.Context mAttrContext;
            private final int mAttrCujType = 0;
            private boolean mAttrDeferMonitor;
            ...
            private com.android.internal.jank.InteractionJankMonitor.Configuration.Builder setContext(android.content.Context p0) { return null; }
            private com.android.internal.jank.InteractionJankMonitor.Configuration.Builder setSurfaceControl(android.view.SurfaceControl p0) { return null; }
            private com.android.internal.jank.InteractionJankMonitor.Configuration.Builder setSurfaceOnly(boolean p0) { return null; }
            private com.android.internal.jank.InteractionJankMonitor.Configuration.Builder setView(android.view.View p0) { return null; }
            public static com.android.internal.jank.InteractionJankMonitor.Configuration.Builder withSurface(int p0, android.content.Context p1, android.view.SurfaceControl p2, android.os.Handler p3) { return null; }
            ...
            public com.android.internal.jank.InteractionJankMonitor.Configuration.Builder setHandler(android.os.Handler p0) { return null; }
