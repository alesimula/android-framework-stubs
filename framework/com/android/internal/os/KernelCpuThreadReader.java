...
public class KernelCpuThreadReader {
    private static final java.nio.file.Path CPU0_TIME_IN_STATE_PATH = null;
    ...
    public static boolean isTimeInStateSupported() { return false; }
    public static boolean isTimeInStateSupported$ravenwood() { return false; }
    public final int[] getCpuFrequenciesKhz() { return null; }
