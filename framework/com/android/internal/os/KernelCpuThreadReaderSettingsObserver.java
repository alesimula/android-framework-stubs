...
public final class KernelCpuThreadReaderSettingsObserver extends android.database.ContentObserver {
    ...
    private KernelCpuThreadReaderSettingsObserver(android.content.Context p0) { super((android.os.Handler)null); }
    ...
    public static final class UidPredicate implements java.util.function.Predicate<java.lang.Integer> {
