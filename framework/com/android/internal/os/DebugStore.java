...
public class DebugStore {
    ...
    private static final java.lang.String TAG = "DebugStore";
    private static com.android.internal.os.DebugStore.DebugStoreNative sDebugStoreNative;
    public DebugStore() {}
    private static native long beginEventNative(java.lang.String p0, java.util.List<java.lang.String> p1);
    private static native void endEventNative(long p0, java.util.List<java.lang.String> p1);
    private static java.lang.String intentAct(android.content.Intent p0) { return null; }
    private static java.lang.String intentCmp(android.content.Intent p0) { return null; }
    ...
    private static native void recordEventNative(java.lang.String p0, java.util.List<java.lang.String> p1);
    ...
    public static void recordSendFinished(int p0) {}
