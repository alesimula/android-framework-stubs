...
public final class AccessibilityStatsLogUtils {
    ...
    private static int convertToLoggingMagnificationScale(float p0) { return 0; }
    ...
    private static boolean isAccessibilityFloatingMenuEnabled(android.content.Context p0) { return false; }
    private static boolean isAccessibilityGestureEnabled(android.content.Context p0) { return false; }
    ...
    public static void logMagnificationFollowTypingFocusSession(long p0) {}
    public static void logMagnificationModeWithImeOn(int p0) {}
    public static void logMagnificationTripleTap(boolean p0) {}
    public static void logMagnificationTripleTapAndHoldSession(long p0) {}
    public static void logMagnificationTwoFingerTripleTap(boolean p0) {}
    public static void logMagnificationUsageState(int p0, long p1, float p2) {}
    public static void logNonA11yToolServiceWarningReported(java.lang.String p0, int p1, long p2) {}
}
