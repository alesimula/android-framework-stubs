...
public final class AccessibilityUtils {
    ...
    public static final long MAGNIFICATION_HANDLE_UI_CHANGE_INTERVAL_MS = 300L;
    public static final int MAGNIFICATION_IGNORE_FOCUS_UPDATES_AFTER_CURSOR_MOVE_TIMEOUT_MS = 250;
    public static final long MAGNIFICATION_SHOW_BUTTON_DELAY_MS = 300L;
    ...
    private static java.util.Set<android.content.ComponentName> findA11yMenuComponentNames(android.content.pm.PackageManager p0, int p1) { return null; }
    ...
    public static android.content.ComponentName getInstalledAccessibilityServiceComponentNameByLabel(android.content.Context p0, java.lang.String p1) { return null; }
    public static int getMagnificationMagnifyKeyboardDefaultValue(android.content.Context p0) { return 0; }
    ...
    public static java.lang.CharSequence loadLabel(android.content.pm.PackageManager p0, android.content.pm.PackageItemInfo p1) { return null; }
    public static java.lang.CharSequence loadLabel(android.content.pm.PackageManager p0, android.content.pm.ResolveInfo p1) { return null; }
    private static java.lang.CharSequence makeSafeLabel(java.lang.CharSequence p0) { return null; }
    private static boolean parcelableSpansEquals(java.lang.CharSequence p0, java.lang.CharSequence p1) { return false; }
    public static void playNotificationTone(android.content.Context p0, android.media.Ringtone p1) {}
