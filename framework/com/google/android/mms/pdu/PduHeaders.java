...
public class PduHeaders {
    ...
    public PduHeaders() {}
    protected int getOctet(int p0) { return 0; }
    protected void setOctet(int p0, int p1) throws com.google.android.mms.InvalidHeaderValueException {}
    protected byte[] getTextString(int p0) { return null; }
    protected void setTextString(byte[] p0, int p1) {}
    protected com.google.android.mms.pdu.EncodedStringValue getEncodedStringValue(int p0) { return null; }
    protected com.google.android.mms.pdu.EncodedStringValue[] getEncodedStringValues(int p0) { return null; }
    protected void setEncodedStringValue(com.google.android.mms.pdu.EncodedStringValue p0, int p1) {}
    protected void setEncodedStringValues(com.google.android.mms.pdu.EncodedStringValue[] p0, int p1) {}
    protected void appendEncodedStringValue(com.google.android.mms.pdu.EncodedStringValue p0, int p1) {}
    protected long getLongInteger(int p0) { return 0L; }
    protected void setLongInteger(long p0, int p1) {}
}
