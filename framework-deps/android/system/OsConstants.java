...
public class OsConstants {
    ...
    public int ENOSPC = 0;
    public int _SC_PAGE_SIZE = 0;
    public int SOCK_STREAM = 0;
    public int F_DUPFD_CLOEXEC = 0;
    public int PROT_EXEC = 0;
    public int PROT_NONE = 0;
    public int F_GET_SEALS = 0;
    public int F_SEAL_WRITE = 0;
    public int F_SEAL_FUTURE_WRITE = 0;
    public int ASHMEM_GET_PROT_MASK = 0;
